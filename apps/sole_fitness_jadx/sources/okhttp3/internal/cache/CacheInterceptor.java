    ...
    public static final class Companion {
        ...
        public final Headers combine(Headers cachedHeaders, Headers networkHeaders) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if ((!StringsKt.equals(org.apache.http.HttpHeaders.WARNING, strName, true) || !StringsKt.startsWith$default(strValue, AppEventsConstants.EVENT_PARAM_VALUE_YES, false, 2, (Object) null)) && (isContentSpecificHeader(strName) || !isEndToEnd(strName) || networkHeaders.get(strName) == null)) {
        ...
        private final boolean isEndToEnd(String fieldName) {
            return (StringsKt.equals("Connection", fieldName, true) || StringsKt.equals(HTTP.CONN_KEEP_ALIVE, fieldName, true) || StringsKt.equals("Proxy-Authenticate", fieldName, true) || StringsKt.equals("Proxy-Authorization", fieldName, true) || StringsKt.equals(org.apache.http.HttpHeaders.TE, fieldName, true) || StringsKt.equals("Trailers", fieldName, true) || StringsKt.equals("Transfer-Encoding", fieldName, true) || StringsKt.equals(org.apache.http.HttpHeaders.UPGRADE, fieldName, true)) ? false : true;
        }
