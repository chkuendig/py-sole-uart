...
public final class Http2Reader implements Closeable {
    ...
    private final void readPriority(Handler handler, int streamId) throws IOException {
        ...
        handler.priority(streamId, i & Integer.MAX_VALUE, Util.and(this.source.readByte(), 255) + 1, (((int) 2147483648L) & i) != 0);
    }
        ...
        if (step < 0 ? first >= last : first <= last) {
            while (true) {
                ...
                if (iAnd != 2) {
                    ...
                    } else if (iAnd == 5 && (i < 16384 || i > 16777215)) {
                        break;
                    }
                } else if (i != 0 && i != 1) {
