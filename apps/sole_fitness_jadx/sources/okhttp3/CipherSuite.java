...
public final class CipherSuite {
    ...
    public static final class Companion {
        ...
        private final String secondaryName(String javaName) {
            if (StringsKt.startsWith$default(javaName, "TLS_", false, 2, (Object) null)) {
                ...
                sb.append("SSL_");
                Objects.requireNonNull(javaName, "null cannot be cast to non-null type java.lang.String");
    ...
    static {
        ...
        TLS_PSK_WITH_3DES_EDE_CBC_SHA = companion.init("TLS_PSK_WITH_3DES_EDE_CBC_SHA", R2.attr.carousel_infinite);
        TLS_PSK_WITH_AES_128_CBC_SHA = companion.init("TLS_PSK_WITH_AES_128_CBC_SHA", R2.attr.carousel_nextState);
        TLS_PSK_WITH_AES_256_CBC_SHA = companion.init("TLS_PSK_WITH_AES_256_CBC_SHA", R2.attr.carousel_previousState);
        TLS_RSA_WITH_SEED_CBC_SHA = companion.init("TLS_RSA_WITH_SEED_CBC_SHA", R2.attr.checkMarkTintMode);
        TLS_RSA_WITH_AES_128_GCM_SHA256 = companion.init("TLS_RSA_WITH_AES_128_GCM_SHA256", R2.attr.circularflow_defaultAngle);
        TLS_RSA_WITH_AES_256_GCM_SHA384 = companion.init("TLS_RSA_WITH_AES_256_GCM_SHA384", R2.attr.circularflow_defaultRadius);
        TLS_DHE_RSA_WITH_AES_128_GCM_SHA256 = companion.init("TLS_DHE_RSA_WITH_AES_128_GCM_SHA256", R2.attr.circularflow_radiusInDP);
        TLS_DHE_RSA_WITH_AES_256_GCM_SHA384 = companion.init("TLS_DHE_RSA_WITH_AES_256_GCM_SHA384", R2.attr.circularflow_viewCenter);
        ...
        TLS_AES_128_GCM_SHA256 = companion.init("TLS_AES_128_GCM_SHA256", R2.styleable.ActionBar_background);
        TLS_AES_256_GCM_SHA384 = companion.init("TLS_AES_256_GCM_SHA384", R2.styleable.ActionBar_backgroundSplit);
        TLS_CHACHA20_POLY1305_SHA256 = companion.init("TLS_CHACHA20_POLY1305_SHA256", R2.styleable.ActionBar_backgroundStacked);
        TLS_AES_128_CCM_SHA256 = companion.init("TLS_AES_128_CCM_SHA256", R2.styleable.ActionBar_contentInsetEnd);
        TLS_AES_128_CCM_8_SHA256 = companion.init("TLS_AES_128_CCM_8_SHA256", R2.styleable.ActionBar_contentInsetEndWithActions);
    }
}
