...
public final class Handshake {
    ...
    public final List<Certificate> m1553deprecated_peerCertificates() {
    ...
    public final Principal m1554deprecated_peerPrincipal() {
    ...
    public final List<Certificate> m1551deprecated_localCertificates() {
        return this.localCertificates;
    }
    ...
    public final Principal m1552deprecated_localPrincipal() {
    ...
    public int hashCode() {
        return ((((((R2.attr.quantizeMotionSteps + this.tlsVersion.hashCode()) * 31) + this.cipherSuite.hashCode()) * 31) + peerCertificates().hashCode()) * 31) + this.localCertificates.hashCode();
    }
    ...
    public static final class Companion {
        ...
        public final Handshake m1556deprecated_get(SSLSession sslSession) throws IOException {
