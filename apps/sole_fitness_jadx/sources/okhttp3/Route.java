...
public final class Route {
    ...
    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = IntegrityManager.INTEGRITY_TYPE_ADDRESS, imports = {}))
    ...
    public int hashCode() {
        return ((((R2.attr.quantizeMotionSteps + this.address.hashCode()) * 31) + this.proxy.hashCode()) * 31) + this.socketAddress.hashCode();
    }
