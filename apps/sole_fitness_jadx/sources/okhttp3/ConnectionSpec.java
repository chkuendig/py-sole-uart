...
public final class ConnectionSpec {
    ...
    public final List<CipherSuite> m1536deprecated_cipherSuites() {
        return cipherSuites();
    }
    ...
    public final List<TlsVersion> m1538deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    public int hashCode() {
        ...
        String[] strArr = this.cipherSuitesAsString;
        int iHashCode = (R2.attr.quantizeMotionSteps + (strArr != null ? Arrays.hashCode(strArr) : 0)) * 31;
