...
public final class Response implements Closeable {
    ...
    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = OAuthConstants.CODE, imports = {}))
    ...
    public final CacheControl m1627deprecated_cacheControl() {
        return cacheControl();
    }
