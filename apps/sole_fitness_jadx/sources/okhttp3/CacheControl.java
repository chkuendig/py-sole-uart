            ...
            while (i4 < size) {
                ...
                if (!StringsKt.equals(strName, "Cache-Control", z)) {
                    ...
                    while (i2 < strValue.length()) {
                        int iIndexOfElement = indexOfElement(strValue, "=,;", i2);
                        Objects.requireNonNull(strValue, "null cannot be cast to non-null type java.lang.String");
                        String strSubstring = strValue.substring(i2, iIndexOfElement);
                        ...
                        if (iIndexOfElement != strValue.length()) {
                            ...
                            if (strValue.charAt(iIndexOfElement) != ',' && strValue.charAt(iIndexOfElement) != ';') {
                                ...
                                if (iIndexOfNonWhitespace < strValue.length() && strValue.charAt(iIndexOfNonWhitespace) == '\"') {
                                    ...
                                    Objects.requireNonNull(strValue, "null cannot be cast to non-null type java.lang.String");
                                    string = strValue.substring(i6, iIndexOf$default);
                            ...
                            if (!StringsKt.equals("no-cache", string2, true)) {
                                ...
                                if (StringsKt.equals(ClientCookie.MAX_AGE_ATTR, string2, true)) {
