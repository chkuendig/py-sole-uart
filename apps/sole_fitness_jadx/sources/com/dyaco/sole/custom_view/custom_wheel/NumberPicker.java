...
public class NumberPicker extends LinearLayout {
    ...
    static /* synthetic */ boolean access$1480(NumberPicker numberPicker, int i) {
    ...
    private static class TwoDigitFormatter implements Formatter {
        ...
        @Override // com.dyaco.sole.custom_view.custom_wheel.NumberPicker.Formatter
    ...
    public NumberPicker(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, com.dyaco.sole.R.styleable.NumberPicker, i, 0);
        int resourceId = typedArrayObtainStyledAttributes.getResourceId(0, 0);
        boolean z = resourceId != 0;
        this.mHasSelectorWheel = z;
        this.mSolidColor = typedArrayObtainStyledAttributes.getColor(11, 0);
        int color = typedArrayObtainStyledAttributes.getColor(8, -12303292);
        Drawable drawable = typedArrayObtainStyledAttributes.getDrawable(7);
        this.mSelectionDivider = drawable == null ? new ColorDrawable(color) : drawable;
        this.mSelectionDividerHeight = typedArrayObtainStyledAttributes.getDimensionPixelSize(9, (int) TypedValue.applyDimension(1, 2.0f, getResources().getDisplayMetrics()));
        this.mSelectionDividersDistance = typedArrayObtainStyledAttributes.getDimensionPixelSize(10, (int) TypedValue.applyDimension(1, 38.0f, getResources().getDisplayMetrics()));
        ...
        int dimensionPixelSize3 = typedArrayObtainStyledAttributes.getDimensionPixelSize(4, -1);
        this.mMinWidth = dimensionPixelSize3;
        int dimensionPixelSize4 = typedArrayObtainStyledAttributes.getDimensionPixelSize(2, -1);
        this.mMaxWidth = dimensionPixelSize4;
        if (dimensionPixelSize3 != -1 && dimensionPixelSize4 != -1 && dimensionPixelSize3 > dimensionPixelSize4) {
            throw new IllegalArgumentException("minWidth > maxWidth");
        }
        this.mComputeMaxWidth = dimensionPixelSize4 == -1;
        this.mVirtualButtonPressedDrawable = typedArrayObtainStyledAttributes.getDrawable(12);
        int dimension = (int) typedArrayObtainStyledAttributes.getDimension(6, 20.0f);
        this.mTextSize = dimension;
        this.mVirtualButtonTextSize = (int) typedArrayObtainStyledAttributes.getDimension(14, 12.0f);
        int integer = typedArrayObtainStyledAttributes.getInteger(13, 180);
        this.mVirtualButtonTextAlpha = (integer < 0 || integer > 255) ? 180 : integer;
        int color2 = typedArrayObtainStyledAttributes.getColor(5, -12303292);
        typedArrayObtainStyledAttributes.recycle();
        this.mPressedStateHelper = new PressedStateHelper();
        setWillNotDraw(!z);
        ((LayoutInflater) getContext().getSystemService("layout_inflater")).inflate(resourceId, (ViewGroup) this, true);
        View.OnClickListener onClickListener = new View.OnClickListener() { // from class: com.dyaco.sole.custom_view.custom_wheel.NumberPicker.1
        ...
        View.OnLongClickListener onLongClickListener = new View.OnLongClickListener() { // from class: com.dyaco.sole.custom_view.custom_wheel.NumberPicker.2
        ...
        editText.setOnFocusChangeListener(new View.OnFocusChangeListener() { // from class: com.dyaco.sole.custom_view.custom_wheel.NumberPicker.3
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action != 1) {
            if (action == 2 && !this.mIngnoreMoveEvents) {
                float y = motionEvent.getY();
    ...
    */
    ...
    public void scrollBy(int i, int i2) {
        ...
        if (!z && i2 < 0 && iArr[2] >= this.mMaxValue) {
            this.mCurrentScrollOffset = this.mInitialScrollOffset;
            return;
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < iArr.length; i++) {
            ...
            if (i != 2 || this.mInputText.getVisibility() != 0) {
                setPaint(f, this.mSelectorWheelPaint);
    ...
    private void setPaint(float f, Paint paint) {
        float f2 = this.mVirtualButtonTextSize;
        int i = this.mVirtualButtonTextAlpha;
        int i2 = this.mSelectorElementHeight;
        int i3 = i2 * 1;
        int i4 = i2 * 2;
        int i5 = this.mInitialScrollOffset;
        if (f > i5 + i3 && f <= (i2 * 2) + i5) {
            float f3 = i3;
            f2 += (((f - i5) - f3) / i2) * (this.mTextSize - f2);
            i = (int) (i + ((((f - i5) - f3) / i2) * (255 - i)));
        } else if (f > i5 + i4 && f < i5 * i2 * 3) {
            int i6 = this.mTextSize;
            float f4 = i4;
            f2 = i6 - ((((f - i5) - f4) / i2) * (i6 - f2));
            i = (int) (255.0f - ((((f - i5) - f4) / i2) * (255 - i)));
        }
    ...
    private void initializeSelectorWheelIndices() {
        ...
        for (int i = 0; i < this.mSelectorIndices.length; i++) {
            int wrappedSelectorIndex = (i - 2) + value;
            if (this.mWrapSelectorWheel) {
    ...
    class InputTextFilter extends NumberKeyListener {
        ...
        public CharSequence filter(CharSequence charSequence, int i, int i2, Spanned spanned, int i3, int i4) {
            if (NumberPicker.this.mDisplayedValues == null) {
                ...
                return "".equals(str) ? str : NumberPicker.this.getSelectedPos(str) > NumberPicker.this.mMaxValue ? "" : charSequenceFilter;
            }
    ...
    class BeginSoftInputOnLongPressCommand implements Runnable {
        ...
        public void run() {
            ...
            NumberPicker.this.mIngnoreMoveEvents = true;
        }
    }
