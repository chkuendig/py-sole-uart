package com.spiritfitness.spirit.wxapi;
...
public class WXEntryActivity extends Activity implements IWXAPIEventHandler {
    ...
    /* renamed from: com.spiritfitness.spirit.wxapi.WXEntryActivity$1, reason: invalid class name */
    class AnonymousClass1 implements Callback {
        ...
        public void onFailure(Call call, final IOException iOException) {
            WXEntryActivity.this.runOnUiThread(new Runnable() { // from class: com.spiritfitness.spirit.wxapi.WXEntryActivity.1.1
        ...
        public void onResponse(Call call, Response response) throws IOException {
            ...
            if (str == null) {
                WXEntryActivity.this.runOnUiThread(new Runnable() { // from class: com.spiritfitness.spirit.wxapi.WXEntryActivity.1.2
                    @Override // java.lang.Runnable
                    public void run() {
            ...
            cloudApi.setMemberLoginListener(new MemberLoginListener() { // from class: com.spiritfitness.spirit.wxapi.WXEntryActivity.1.3
                ...
                public void onFail(final ResponseMessage responseMessage) {
                    WXEntryActivity.this.runOnUiThread(new Runnable() { // from class: com.spiritfitness.spirit.wxapi.WXEntryActivity.1.3.1
                        @Override // java.lang.Runnable
                        public void run() {
                ...
                public void onError(final String str3) {
                    WXEntryActivity.this.runOnUiThread(new Runnable() { // from class: com.spiritfitness.spirit.wxapi.WXEntryActivity.1.3.2
                        @Override // java.lang.Runnable
                        public void run() {
    ...
    public Map<String, String> parseWechatAccessTokenData(String str) {
        return (Map) new Gson().fromJson(str, new TypeToken<Map<String, String>>() { // from class: com.spiritfitness.spirit.wxapi.WXEntryActivity.2
        }.getType());
    }
}
