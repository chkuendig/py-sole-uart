...
public class b extends AsyncTask<Void, Void, a> {
    ...
    protected a doInBackground(Void[] voidArr) throws Throwable {
        ...
        String str = String.format("https://open.weixin.qq.com/connect/sdk/qrconnect?appid=%s&noncestr=%s&timestamp=%s&scope=%s&signature=%s", this.a, this.c, this.d, this.b, this.e);
        long jCurrentTimeMillis = System.currentTimeMillis();
        byte[] bArrA = com.tencent.mm.opensdk.channel.a.a.a(str, DateTimeConstants.MILLIS_PER_MINUTE);
