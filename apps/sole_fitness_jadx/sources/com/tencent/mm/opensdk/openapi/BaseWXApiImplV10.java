...
class BaseWXApiImplV10 implements IWXAPI {
    ...
    private String finderShareVideoJumpInfoToString(IWXChannelJumpInfo iWXChannelJumpInfo) throws JSONException {
        String str;
        String str2;
        try {
    ...
    private boolean sendFinderOpenFeed(Context context, BaseReq baseReq) throws PendingIntent.CanceledException {
        launchWXIfNeed();
    ...
    private boolean sendFinderOpenLive(Context context, BaseReq baseReq) throws PendingIntent.CanceledException {
        launchWXIfNeed();
    ...
    private boolean sendFinderOpenProfile(Context context, BaseReq baseReq) throws PendingIntent.CanceledException {
        launchWXIfNeed();
    ...
    private boolean sendFinderShareVideo(Context context, BaseReq baseReq) throws PendingIntent.CanceledException {
        launchWXIfNeed();
    ...
    private boolean sendOpenCustomerServiceChat(Context context, BaseReq baseReq) throws PendingIntent.CanceledException {
        launchWXIfNeed();
    ...
    private boolean sendQRCodePayReq(Context context, BaseReq baseReq) throws PendingIntent.CanceledException {
        launchWXIfNeed();
    ...
    private boolean sendToWxaRedirectingPage(Context context, BaseReq baseReq) throws PendingIntent.CanceledException {
        launchWXIfNeed();
    ...
    public boolean registerApp(String str, long j) {
        ...
        c0057a.a = "com.tencent.mm";
        c0057a.b = ConstantsAPI.ACTION_HANDLE_APP_REGISTER;
        c0057a.c = "weixin://registerapp?appid=" + this.appId;
        c0057a.d = j;
        return a.a(this.context, c0057a);
    }
    ...
    public void unregisterApp() {
        ...
        a.C0057a c0057a = new a.C0057a();
        c0057a.a = "com.tencent.mm";
        c0057a.b = ConstantsAPI.ACTION_HANDLE_APP_UNREGISTER;
        c0057a.c = "weixin://unregisterapp?appid=" + this.appId;
        a.a(this.context, c0057a);
    }
}
