    ...
    private static class EasingFunctions {
        ...
        public static final EasingFunction EaseInOutExpo = new EasingFunction() { // from class: com.github.mikephil.charting.animation.Easing.EasingFunctions.16
            ...
            public float getInterpolation(float f) {
                ...
                if (f / 0.5f < 1.0f) {
                    fPow = (float) Math.pow(2.0d, (r8 - 1.0f) * 10.0f);
                } else {
                    fPow = (-((float) Math.pow(2.0d, (r8 - 1.0f) * (-10.0f)))) + 2.0f;
                }
                return fPow * 0.5f;
            }
        };
        ...
        public static final EasingFunction EaseInOutElastic = new EasingFunction() { // from class: com.github.mikephil.charting.animation.Easing.EasingFunctions.22
            ...
            public float getInterpolation(float f) {
                ...
                if (f2 < 1.0f) {
                    float f3 = f2 - 1.0f;
                    return ((float) Math.pow(2.0d, 10.0f * f3)) * ((float) Math.sin((((f3 * 1.0f) - fAsin) * 6.283185307179586d) / 0.45000002f)) * (-0.5f);
                }
                float f4 = f2 - 1.0f;
                return (((float) Math.pow(2.0d, (-10.0f) * f4)) * ((float) Math.sin((((f4 * 1.0f) - fAsin) * 6.283185307179586d) / 0.45000002f)) * 0.5f) + 1.0f;
            }
        };
