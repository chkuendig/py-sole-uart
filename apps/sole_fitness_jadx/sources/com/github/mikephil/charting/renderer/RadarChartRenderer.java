...
public class RadarChartRenderer extends LineRadarRenderer {
    ...
    public RadarChartRenderer(RadarChart radarChart, ChartAnimator chartAnimator, ViewPortHandler viewPortHandler) {
        ...
        this.mHighlightPaint.setColor(Color.rgb(255, R2.attr.com_facebook_preset_size, 115));
            ...
            if (shouldDrawValues(dataSetByIndex)) {
                ...
                while (i5 < dataSetByIndex.getEntryCount()) {
                    ...
                    if (dataSetByIndex.isDrawValuesEnabled()) {
                        ...
                        f4 = sliceAngle;
                        mPPointF3 = mPPointF5;
                        drawValue(canvas, dataSetByIndex.getValueFormatter(), radarEntry.getY(), radarEntry, i4, mPPointF4.x, mPPointF4.y - fConvertDpToPixel, dataSetByIndex.getValueTextColor(i5));
                    } else {
                        i2 = i5;
                        iRadarDataSet = dataSetByIndex;
                        i3 = i4;
