...
public abstract class Utils {
    ...
    private static final int[] POW_10 = {1, 10, 100, 1000, 10000, 100000, DurationKt.NANOS_IN_MILLIS, 10000000, 100000000, Http2Connection.DEGRADED_PONG_TIMEOUT_NS};
    ...
    public static String formatNumber(float f, int i, boolean z) {
        return formatNumber(f, i, z, ClassUtils.PACKAGE_SEPARATOR_CHAR);
    }
    ...
    public static float roundToNextSignificant(double d) {
        ...
        return Math.round(d * r0) / ((float) Math.pow(10.0d, 1 - ((int) Math.ceil((float) Math.log10(d < 0.0d ? -d : d)))));
    }
