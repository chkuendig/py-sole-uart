...
public class ResponseGoalDataGet {
    ...
    public List<DCGoalWebData> getSys_response_data() {
        return this.sys_response_data;
    }

    public void setSys_response_data(List<DCGoalWebData> list) {
