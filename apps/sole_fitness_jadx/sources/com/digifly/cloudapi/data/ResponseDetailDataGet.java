...
public class ResponseDetailDataGet {
    ...
    public List<DCTrainingDetailData> getSys_response_data() {
        return this.sys_response_data;
    }

    public void setSys_response_data(List<DCTrainingDetailData> list) {
