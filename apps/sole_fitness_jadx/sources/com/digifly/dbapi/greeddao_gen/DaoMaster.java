...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database database, boolean z) throws SQLException {
        DCProgramGoalDataDao.createTable(database, z);
        DCTrainingDataDao.createTable(database, z);
        DCTrainingDetailDataDao.createTable(database, z);
        MemberDataDao.createTable(database, z);
    }

    public static void dropAllTables(Database database, boolean z) throws SQLException {
        DCProgramGoalDataDao.dropTable(database, z);
        DCTrainingDataDao.dropTable(database, z);
        DCTrainingDetailDataDao.dropTable(database, z);
        MemberDataDao.dropTable(database, z);
    }
    ...
    public DaoMaster(Database database) {
        super(database, 20);
        registerDaoClass(DCProgramGoalDataDao.class);
        registerDaoClass(DCTrainingDataDao.class);
        registerDaoClass(DCTrainingDetailDataDao.class);
