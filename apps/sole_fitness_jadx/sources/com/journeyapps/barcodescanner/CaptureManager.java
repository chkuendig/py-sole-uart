...
public class CaptureManager {
    ...
    public CaptureManager(Activity activity, DecoratedBarcodeView decoratedBarcodeView) {
        ...
        this.inactivityTimer = new InactivityTimer(activity, new Runnable() { // from class: com.journeyapps.barcodescanner.CaptureManager$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m114lambda$new$0$comjourneyappsbarcodescannerCaptureManager();
            }
        });
    ...
    /* synthetic */ void m114lambda$new$0$comjourneyappsbarcodescannerCaptureManager() {
    ...
    protected void displayFrameworkBugMessageAndExit(String str) {
        ...
        builder.setPositiveButton(R.string.zxing_button_ok, new DialogInterface.OnClickListener() { // from class: com.journeyapps.barcodescanner.CaptureManager$$ExternalSyntheticLambda1
            ...
            public final void onClick(DialogInterface dialogInterface, int i) {
                this.f$0.m112x170613e1(dialogInterface, i);
            }
        });
        builder.setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: com.journeyapps.barcodescanner.CaptureManager$$ExternalSyntheticLambda0
            ...
            public final void onCancel(DialogInterface dialogInterface) {
                this.f$0.m113x8c803a22(dialogInterface);
            }
        });
        builder.show();
    }
    ...
    /* synthetic */ void m112x170613e1(DialogInterface dialogInterface, int i) {
        finish();
    }
    ...
    /* synthetic */ void m113x8c803a22(DialogInterface dialogInterface) {
        finish();
    }
