...
public class CameraInstance {
    ...
    /* synthetic */ void m120xdd5ef35b(boolean z) {
    ...
    public void changeCameraParameters(final CameraParametersCallback cameraParametersCallback) {
        ...
        if (this.open) {
            this.cameraThread.enqueue(new Runnable() { // from class: com.journeyapps.barcodescanner.camera.CameraInstance$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m117x78173d15(cameraParametersCallback);
                }
            });
        }
    }
    ...
    /* synthetic */ void m117x78173d15(CameraParametersCallback cameraParametersCallback) {
    ...
    /* synthetic */ void m119xf1e80099(final PreviewCallback previewCallback) {
        if (!this.open) {
            ...
            this.cameraThread.enqueue(new Runnable() { // from class: com.journeyapps.barcodescanner.camera.CameraInstance$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m118xd7cc81fa(previewCallback);
                }
            });
        }
    }
    ...
    /* synthetic */ void m118xd7cc81fa(PreviewCallback previewCallback) {
