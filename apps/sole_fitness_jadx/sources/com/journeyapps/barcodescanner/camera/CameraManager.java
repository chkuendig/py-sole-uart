...
public final class CameraManager {
    ...
    public boolean isCameraRotated() {
        ...
        if (i != -1) {
            return i % R2.attr.com_facebook_foreground_color != 0;
        }
    ...
    private int calculateDisplayRotation() {
        ...
        if (rotation != 0) {
            if (rotation == 1) {
                ...
                i2 = R2.attr.firstBaselineToTopHeight;
            }
        }
        if (this.cameraInfo.facing == 1) {
            i = (360 - ((this.cameraInfo.orientation + i2) % R2.attr.layout_constraintCircle)) % R2.attr.layout_constraintCircle;
        } else {
            i = ((this.cameraInfo.orientation - i2) + R2.attr.layout_constraintCircle) % R2.attr.layout_constraintCircle;
        }
