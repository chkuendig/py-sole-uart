...
public class ValueAnimator extends Animator {
    ...
    @Override // com.nineoldandroids.animation.Animator
    /* renamed from: clone */
    public ValueAnimator mo121clone() {
        ValueAnimator valueAnimator = (ValueAnimator) super.mo121clone();
        ArrayList<AnimatorUpdateListener> arrayList = this.mUpdateListeners;
        if (arrayList != null) {
        ...
        if (propertyValuesHolderArr != null) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                PropertyValuesHolder propertyValuesHolderMo125clone = propertyValuesHolderArr[i2].mo125clone();
                valueAnimator.mValues[i2] = propertyValuesHolderMo125clone;
                valueAnimator.mValuesMap.put(propertyValuesHolderMo125clone.getPropertyName(), propertyValuesHolderMo125clone);
            }
        }
        return valueAnimator;
    }
