...
public final class AnimatorSet extends Animator {
    ...
    @Override // com.nineoldandroids.animation.Animator
    /* renamed from: clone */
    public AnimatorSet mo121clone() {
        AnimatorSet animatorSet = (AnimatorSet) super.mo121clone();
        ...
        while (it.hasNext()) {
            Node next = it.next();
            Node nodeM122clone = next.m122clone();
            map.put(next, nodeM122clone);
            animatorSet.mNodes.add(nodeM122clone);
            animatorSet.mNodeMap.put(nodeM122clone.animation, nodeM122clone);
            ArrayList arrayList = null;
            nodeM122clone.dependencies = null;
            nodeM122clone.tmpDependencies = null;
            nodeM122clone.nodeDependents = null;
            nodeM122clone.nodeDependencies = null;
            ArrayList<Animator.AnimatorListener> listeners = nodeM122clone.animation.getListeners();
            if (listeners != null) {
    ...
    private static class Node implements Cloneable {
        ...
        public Node m122clone() {
            try {
                Node node = (Node) super.clone();
                node.animation = this.animation.mo121clone();
                return node;
