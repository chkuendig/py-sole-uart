...
public final class Encoder {
    ...
    */
    public static QRCode encode(String str, ErrorCorrectionLevel errorCorrectionLevel, Map<EncodeHintType, ?> map) throws NumberFormatException, WriterException, UnsupportedEncodingException {
        ...
        if ((map != null && map.containsKey(EncodeHintType.GS1_FORMAT)) && Boolean.parseBoolean(map.get(EncodeHintType.GS1_FORMAT).toString())) {
    ...
    static void terminateBits(int i, BitArray bitArray) throws WriterException {
        ...
        for (int i4 = 0; i4 < sizeInBytes; i4++) {
            bitArray.appendBits((i4 & 1) == 0 ? R2.attr.dialogTheme : 17, 8);
        }
        if (bitArray.getSize() != i2) {
    ...
    static void appendKanjiBytes(String str, BitArray bitArray) throws WriterException, UnsupportedEncodingException {
        ...
        try {
            ...
            for (int i2 = 0; i2 < length; i2 += 2) {
                ...
                bitArray.appendBits(((i >> 8) * R2.attr.constraintSet) + (i & 255), 13);
            }
        } catch (UnsupportedEncodingException e) {
            throw new WriterException(e);
        }
