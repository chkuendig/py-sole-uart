...
final class FormatInformation {
    ...
    private static final int[][] FORMAT_INFO_DECODE_LOOKUP = {new int[]{FORMAT_INFO_MASK_QR, 0}, new int[]{20773, 1}, new int[]{24188, 2}, new int[]{23371, 3}, new int[]{17913, 4}, new int[]{16590, 5}, new int[]{20375, 6}, new int[]{19104, 7}, new int[]{30660, 8}, new int[]{29427, 9}, new int[]{32170, 10}, new int[]{30877, 11}, new int[]{26159, 12}, new int[]{25368, 13}, new int[]{27713, 14}, new int[]{26998, 15}, new int[]{R2.styleable.KeyCycle_waveShape, 16}, new int[]{R2.styleable.AppCompatTheme_ratingBarStyleIndicator, 17}, new int[]{7399, 18}, new int[]{6608, 19}, new int[]{R2.drawable.display_tt8_dashboard_a_table_l_n_4, 20}, new int[]{R2.attr.switchTextAppearance, 21}, new int[]{R2.id.sawtooth, 22}, new int[]{R2.drawable.register1_spirit_leftpic, 23}, new int[]{13663, 24}, new int[]{12392, 25}, new int[]{16177, 26}, new int[]{14854, 27}, new int[]{9396, 28}, new int[]{8579, 29}, new int[]{11994, 30}, new int[]{11245, 31}};
