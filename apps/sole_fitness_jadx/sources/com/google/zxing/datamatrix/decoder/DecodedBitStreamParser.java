...
final class DecodedBitStreamParser {
    ...
    static {
        char[] cArr = {'!', '\"', '#', '$', '%', Typography.amp, '\'', '(', ')', '*', '+', ',', '-', ClassUtils.PACKAGE_SEPARATOR_CHAR, '/', ':', ';', Typography.less, '=', Typography.greater, '?', '@', '[', TokenParser.ESCAPE, ']', '^', '_'};
            ...
            if (bits > 128) {
                if (bits != 129) {
                    if (bits <= 229) {
                        ...
                        switch (bits) {
                            case R2.attr.defaultState /* 230 */:
                                return Mode.C40_ENCODE;
                            case R2.attr.deltaPolarAngle /* 231 */:
                                return Mode.BASE256_ENCODE;
                            case R2.attr.deltaPolarRadius /* 232 */:
                                sb.append((char) 29);
                                break;
                            case R2.attr.deriveConstraintsFrom /* 233 */:
                            case R2.attr.dialogCornerRadius /* 234 */:
                            case R2.attr.dividerVertical /* 241 */:
                                break;
                            case R2.attr.dialogPreferredPadding /* 235 */:
                                z = true;
                                break;
                            case R2.attr.dialogTheme /* 236 */:
                                sb.append("[)>\u001e05\u001d");
                                sb2.insert(0, "\u001e\u0004");
                                break;
                            case R2.attr.displayOptions /* 237 */:
                                sb.append("[)>\u001e06\u001d");
                                sb2.insert(0, "\u001e\u0004");
                                break;
                            case R2.attr.divider /* 238 */:
                                return Mode.ANSIX12_ENCODE;
                            case R2.attr.dividerHorizontal /* 239 */:
                                return Mode.TEXT_ENCODE;
                            case R2.attr.dividerPadding /* 240 */:
                ...
                if (i != 0) {
                    if (i != 1) {
                        if (i == 2) {
                            ...
                            if (z) {
                                sb.append((char) (i3 + R2.attr.customPixelDimension));
                                z = false;
                                i = 0;
                            } else {
    ...
    private static void parseTwoBytes(int i, int i2, int[] iArr) {
        int i3 = ((i << 8) + i2) - 1;
        int i4 = i3 / R2.drawable.abc_btn_check_to_on_mtrl_015;
        iArr[0] = i4;
        int i5 = i3 - (i4 * R2.drawable.abc_btn_check_to_on_mtrl_015);
        int i6 = i5 / 40;
        iArr[1] = i6;
        iArr[2] = i5 - (i6 * 40);
    }
