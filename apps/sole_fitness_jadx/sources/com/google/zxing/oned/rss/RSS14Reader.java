...
public final class RSS14Reader extends AbstractRSSReader {
    ...
    private static final int[] OUTSIDE_GSUM = {0, 161, R2.color.lightyellow, R2.drawable.outdoor_button_b1, R2.id.calendar_week_view};
    private static final int[] INSIDE_GSUM = {0, R2.attr.keyPositionType, R2.color.secondary_text_disabled_material_dark, R2.dimen.s_display_track_time_text_size};
    ...
    private Pair decodePair(BitArray bitArray, boolean z, int i, Map<DecodeHintType, ?> map) {
        try {
            ...
            return new Pair((dataCharacterDecodeDataCharacter.getValue() * R2.drawable.abc_btn_check_material) + dataCharacterDecodeDataCharacter2.getValue(), dataCharacterDecodeDataCharacter.getChecksumPortion() + (dataCharacterDecodeDataCharacter2.getChecksumPortion() * 4), foundFinderPattern);
