    ...
    private DecodedChar decodeIsoIec646(int i) throws FormatException {
        ...
        switch (extractNumericValueFromBitArray(i, 8)) {
            ...
            case R2.attr.dividerVertical /* 241 */:
                c = ',';
                break;
            case R2.attr.dragDirection /* 242 */:
                c = '-';
                break;
            case R2.attr.dragScale /* 243 */:
                c = ClassUtils.PACKAGE_SEPARATOR_CHAR;
                break;
            case R2.attr.dragThreshold /* 244 */:
                c = '/';
                break;
            case R2.attr.drawPath /* 245 */:
                c = ':';
                break;
            case R2.attr.drawableBottomCompat /* 246 */:
                c = ';';
                break;
            case R2.attr.drawableEndCompat /* 247 */:
                c = Typography.less;
                break;
            case R2.attr.drawableLeftCompat /* 248 */:
                c = '=';
                break;
            case R2.attr.drawableRightCompat /* 249 */:
                c = Typography.greater;
                break;
            case 250:
                c = '?';
                break;
            case R2.attr.drawableStartCompat /* 251 */:
                c = '_';
                break;
            case R2.attr.drawableTint /* 252 */:
                c = TokenParser.SP;
                break;
            default:
