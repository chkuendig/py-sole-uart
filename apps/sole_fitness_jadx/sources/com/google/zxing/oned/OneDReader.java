    ...
    public Result decode(BinaryBitmap binaryBitmap, Map<DecodeHintType, ?> map) throws NotFoundException, FormatException {
        try {
            ...
            if ((map != null && map.containsKey(DecodeHintType.TRY_HARDER)) && binaryBitmap.isRotateSupported()) {
                ...
                int iIntValue = R2.attr.firstBaselineToTopHeight;
                if (resultMetadata != null && resultMetadata.containsKey(ResultMetadataType.ORIENTATION)) {
                    iIntValue = (((Integer) resultMetadata.get(ResultMetadataType.ORIENTATION)).intValue() + R2.attr.firstBaselineToTopHeight) % R2.attr.layout_constraintCircle;
                }
        ...
        while (i7 < i5) {
            ...
            try {
                ...
                while (i11 < 2) {
                    ...
                    try {
                        Result resultDecodeRow = decodeRow(i10, bitArray, map3);
                        if (i11 == i4) {
                            try {
                                resultDecodeRow.putMetadata(ResultMetadataType.ORIENTATION, Integer.valueOf(R2.attr.com_facebook_foreground_color));
