...
public final class Code39Reader extends OneDReader {
    ...
    static final int[] CHARACTER_ENCODINGS = {52, R2.attr.flow_wrapMode, 97, R2.attr.layout_constrainedWidth, 49, 304, 112, 37, R2.attr.fontProviderAuthority, 100, R2.attr.fastScrollEnabled, 73, R2.attr.insetTop, 25, R2.attr.flow_lastHorizontalStyle, 88, 13, R2.attr.fastScrollVerticalThumbDrawable, 76, 28, R2.attr.editTextBackground, 67, R2.attr.imageZoom, 19, R2.attr.flow_firstVerticalStyle, 82, 7, R2.attr.elevation, 70, 22, R2.attr.layout_constraintTag, R2.attr.constraintSetEnd, R2.attr.maxVelocity, 145, 400, R2.attr.contentPaddingLeft, 133, R2.attr.layout_constraintTop_toTopOf, R2.attr.constraint_referenced_tags, 168, 162, 138, 42};
