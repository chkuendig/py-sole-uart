        ...
        for (int i7 = 1; i7 <= barcodeColumnCount; i7++) {
            ...
            if (detectionResultMerge.getDetectionResultColumn(i8) == null) {
                ...
                while (minY <= boundingBox.getMaxY()) {
                    int startColumn = getStartColumn(detectionResultMerge, i8, minY, z2);
                    ...
                    int i11 = minY;
                    i5 = i9;
                    Codeword codewordDetectCodeword = detectCodeword(bitMatrix, boundingBox.getMinX(), boundingBox.getMaxX(), z2, i6, i11, iMin, iMax);
                    i4 = i11;
