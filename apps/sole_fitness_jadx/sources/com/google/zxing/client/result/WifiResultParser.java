...
public final class WifiResultParser extends ResultParser {
    ...
    public WifiParsedResult parse(Result result) {
        ...
        if (strMatchSinglePrefixedField5 == null) {
            ...
            if (strMatchSinglePrefixedField4 != null || ServerProtocol.DIALOG_RETURN_SCOPES_TRUE.equalsIgnoreCase(strMatchSinglePrefixedField5) || "false".equalsIgnoreCase(strMatchSinglePrefixedField5)) {
                str = strMatchSinglePrefixedField4;
