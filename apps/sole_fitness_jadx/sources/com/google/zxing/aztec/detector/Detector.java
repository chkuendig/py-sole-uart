...
public final class Detector {
    private static final int[] EXPECTED_CORNER_BITS = {R2.layout.s_fragment_programs_main, R2.attr.motionStagger, R2.drawable.register1_spirit_leftpic, R2.drawable.display_btn_a_cancel};
    ...
    private void extractParameters(ResultPoint[] resultPointArr) throws NotFoundException {
        ...
        for (int i2 = 0; i2 < 4; i2++) {
            ...
            if (this.compact) {
                ...
                j = j3 << 10;
                j2 = ((i3 >> 2) & R2.color.moccasin) + ((i3 >> 1) & 31);
            }
            j3 = j + j2;
        }
        ...
        if (this.compact) {
            ...
            this.nbDataBlocks = (correctedParameterData & R2.drawable.program_icon_custom_s) + 1;
        }
    }
