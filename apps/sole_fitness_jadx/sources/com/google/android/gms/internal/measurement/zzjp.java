...
public enum zzjp {
    ...
    static {
        zzjp[] zzjpVarArrValues = values();
        zzZ = new zzjp[zzjpVarArrValues.length];
        for (zzjp zzjpVar : zzjpVarArrValues) {
            zzZ[zzjpVar.zzac] = zzjpVar;
        }
    }

    zzjp(int i, int i2, zzki zzkiVar) {
        this.zzac = i;
        this.zzab = zzkiVar;
        zzki zzkiVar2 = zzki.VOID;
        int i3 = i2 - 1;
        if (i3 == 1 || i3 == 3) {
