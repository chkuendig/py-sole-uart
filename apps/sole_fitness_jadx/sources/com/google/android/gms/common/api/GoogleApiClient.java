...
public abstract class GoogleApiClient {
    ...
    public static final class Builder {
        ...
        public GoogleApiClient build() {
            ...
            Map<Api<?>, com.google.android.gms.common.internal.zab> mapZad = clientSettingsZaa.zad();
            ...
            for (Api<?> api2 : this.zaj.keySet()) {
                ...
                Api.Client clientBuildClient = abstractClientBuilder.buildClient(this.zai, this.zan, clientSettingsZaa, (ClientSettings) apiOptions, (ConnectionCallbacks) zatVar, (OnConnectionFailedListener) zatVar);
