...
public abstract class FastJsonResponse {
    ...
    private final <I, O> void zaE(Field<I, O> field, I i) {
        ...
        switch (i2) {
            case 0:
                if (oZae != null) {
                    setIntegerInternal(field, str, ((Integer) oZae).intValue());
                    return;
                } else {
                    zaG(str);
                    return;
            ...
            case 1:
                zaf(field, str, (BigInteger) oZae);
                return;
            case 2:
                if (oZae != null) {
                    setLongInternal(field, str, ((Long) oZae).longValue());
                    return;
                } else {
                    zaG(str);
                    return;
            ...
            case 4:
                if (oZae != null) {
                    zan(field, str, ((Double) oZae).doubleValue());
                    return;
                } else {
                    zaG(str);
                    return;
            ...
            case 5:
                zab(field, str, (BigDecimal) oZae);
                return;
            case 6:
                if (oZae != null) {
                    setBooleanInternal(field, str, ((Boolean) oZae).booleanValue());
                    return;
                } else {
                    zaG(str);
                    return;
            ...
            case 7:
                setStringInternal(field, str, (String) oZae);
                return;
            case 8:
            case 9:
                if (oZae != null) {
                    setDecodedBytesInternal(field, str, (byte[]) oZae);
                    return;
                } else {
                    zaG(str);
                    return;
