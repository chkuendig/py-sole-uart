...
public abstract class GoogleApi<O extends Api.ApiOptions> implements HasApiKey<O> {
    ...
    protected ClientSettings.Builder createClientSettingsBuilder() {
        ...
        builder.zab(account);
        O o3 = this.zae;
        Set<Scope> setEmptySet = (!(o3 instanceof Api.ApiOptions.HasGoogleSignInAccountOptions) || (googleSignInAccount = ((Api.ApiOptions.HasGoogleSignInAccountOptions) o3).getGoogleSignInAccount()) == null) ? Collections.emptySet() : googleSignInAccount.getRequestedScopes();
    ...
    public final Api.Client zab(Looper looper, zabq<O> zabqVar) {
        Api.Client clientBuildClient = ((Api.AbstractClientBuilder) Preconditions.checkNotNull(this.zad.zaa())).buildClient(this.zab, looper, createClientSettingsBuilder().build(), (ClientSettings) this.zae, (GoogleApiClient.ConnectionCallbacks) zabqVar, (GoogleApiClient.OnConnectionFailedListener) zabqVar);
    ...
    private GoogleApi(Context context, Activity activity, Api<O> api, O o, Settings settings) {
        ...
        ApiKey<O> apiKeyZaa = ApiKey.zaa(api, o, str);
        this.zaf = apiKeyZaa;
