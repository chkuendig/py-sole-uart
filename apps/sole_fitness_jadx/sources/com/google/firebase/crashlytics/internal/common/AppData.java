...
public class AppData {
    ...
    public static AppData create(Context context, IdManager idManager, String str, String str2, UnityVersionProvider unityVersionProvider) throws PackageManager.NameNotFoundException {
        ...
        return new AppData(str, str2, installerPackageName, packageName, Integer.toString(packageInfo.versionCode), packageInfo.versionName == null ? IdManager.DEFAULT_VERSION_NAME : packageInfo.versionName, unityVersionProvider);
    }
