...
class QueueFileLogStore implements FileLogStore {
    ...
    private void doWriteToLog(long j, String str) {
        ...
        try {
            ...
            this.logFile.add(String.format(Locale.US, "%d %s%n", Long.valueOf(j), str.replaceAll(StringUtils.CR, StringUtils.SPACE).replaceAll(StringUtils.LF, StringUtils.SPACE)).getBytes(UTF_8));
