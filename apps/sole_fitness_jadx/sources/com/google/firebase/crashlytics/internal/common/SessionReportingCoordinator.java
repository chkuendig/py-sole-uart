...
public class SessionReportingCoordinator implements CrashlyticsLifecycleEvents {
    ...
    public Task<Void> sendReports(Executor executor) {
        ...
        while (it.hasNext()) {
            arrayList.add(this.reportsSender.sendReport(it.next()).continueWith(executor, new Continuation() { // from class: com.google.firebase.crashlytics.internal.common.SessionReportingCoordinator$$ExternalSyntheticLambda0
