...
final class AutoValue_StaticSessionData_OsData extends StaticSessionData.OsData {
    ...
    public int hashCode() {
        return ((((this.osRelease.hashCode() ^ 1000003) * 1000003) ^ this.osCodeName.hashCode()) * 1000003) ^ (this.isRooted ? R2.dimen.compat_button_padding_horizontal_material : R2.dimen.connection_bg_width);
    }
}
