...
final class AutoValue_CrashlyticsReport_Session extends CrashlyticsReport.Session {
    ...
    public int hashCode() {
        ...
        Long l = this.endedAt;
        int iHashCode2 = (((((i ^ (l == null ? 0 : l.hashCode())) * 1000003) ^ (this.crashed ? R2.dimen.compat_button_padding_horizontal_material : R2.dimen.connection_bg_width)) * 1000003) ^ this.app.hashCode()) * 1000003;
