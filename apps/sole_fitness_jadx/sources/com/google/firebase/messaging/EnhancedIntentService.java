...
public abstract class EnhancedIntentService extends Service {
    ...
    public Task<Void> processIntent(final Intent intent) {
        ...
        this.executor.execute(new Runnable() { // from class: com.google.firebase.messaging.EnhancedIntentService$$ExternalSyntheticLambda1
            ...
            public final void run() {
                this.f$0.m85x624ce8b2(intent, taskCompletionSource);
            }
        });
    ...
    /* synthetic */ void m84x83fa35aa(Intent intent, Task task) {
        finishTask(intent);
    }

    /* renamed from: lambda$processIntent$0$com-google-firebase-messaging-EnhancedIntentService, reason: not valid java name */
    /* synthetic */ void m85x624ce8b2(Intent intent, TaskCompletionSource taskCompletionSource) {
        try {
            handleIntent(intent);
        } finally {
    ...
    public final int onStartCommand(final Intent intent, int i, int i2) {
        ...
        taskProcessIntent.addOnCompleteListener(new Executor() { // from class: com.google.firebase.messaging.EnhancedIntentService$$ExternalSyntheticLambda2
            ...
            public final void onComplete(Task task) {
                this.f$0.m84x83fa35aa(intent, task);
            }
        });
        return 3;
    }
