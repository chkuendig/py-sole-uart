...
public class MessagingAnalytics {
    ...
    static long getProjectNumber(Bundle bundle) {
        ...
        if (applicationId.startsWith("1:")) {
            String[] strArrSplit = applicationId.split(CertificateUtil.DELIMITER);
    ...
    static int getTtl(Bundle bundle) {
        ...
        try {
            ...
            Log.w(Constants.TAG, "Invalid TTL: ".concat(String.valueOf(strValueOf)));
            return 0;
        }
    }
    ...
    private static void logToFirelog(MessagingClientEvent.Event event, Intent intent, TransportFactory transportFactory) {
        ...
        try {
            Transport transport = transportFactory.getTransport(Constants.FirelogAnalytics.FCM_LOG_SOURCE, MessagingClientEventExtension.class, Encoding.of("proto"), new Transformer() { // from class: com.google.firebase.messaging.MessagingAnalytics$$ExternalSyntheticLambda0
