...
public class ActigraphySettingsJsonParser implements JsonParser<ActigraphySettings> {
    ...
    public ActigraphySettings parse(InputStream inputStream) throws UaException {
        return ActigraphySettingsTO.fromTransferObject((ActigraphySettingsTO) this.gson.fromJson(new JsonReader(new InputStreamReader(inputStream)), ActigraphySettingsTO.class));
    }
}
