...
public class RunCadenceSummaryDerivedDataSource extends DerivedDataSource {
    ...
    protected RunCadenceSummaryDerivedDataSource(DataSourceIdentifier dataSourceIdentifier, List<DataTypeRef> list) {
    ...
    public void deriveDataPoint(RecorderCalculator recorderCalculator, DataSourceIdentifier dataSourceIdentifier, DataTypeRef dataTypeRef, DataPoint dataPoint) {
        if (this.dataTypeRefTriggers.contains(dataTypeRef) && this.recordData) {
            ...
            DataField dataField = BaseDataTypes.FIELD_RUN_CADENCE_MAX;
            DataField dataField2 = BaseDataTypes.FIELD_RUN_CADENCE_MIN;
            DataField dataField3 = BaseDataTypes.FIELD_RUN_CADENCE_AVG;
            Double valueDouble = dataPoint.getValueDouble(BaseDataTypes.FIELD_RUN_CADENCE);
