...
public class HeartRateSummaryDerivedDataSource extends DerivedDataSource {
    ...
    protected HeartRateSummaryDerivedDataSource(DataSourceIdentifier dataSourceIdentifier, List<DataTypeRef> list) {
    ...
    public void deriveDataPoint(RecorderCalculator recorderCalculator, DataSourceIdentifier dataSourceIdentifier, DataTypeRef dataTypeRef, DataPoint dataPoint) {
        if (this.dataTypeRefTriggers.contains(dataTypeRef) && this.recordData) {
            ...
            DataField dataField = BaseDataTypes.FIELD_HEART_RATE_MAX;
            DataField dataField2 = BaseDataTypes.FIELD_HEART_RATE_MIN;
            DataField dataField3 = BaseDataTypes.FIELD_HEART_RATE_AVG;
