...
public class SpeedSummaryDerivedDataSource extends DerivedDataSource {
    ...
    protected SpeedSummaryDerivedDataSource(DataSourceIdentifier dataSourceIdentifier, List<DataTypeRef> list) {
    ...
    public void deriveDataPoint(RecorderCalculator recorderCalculator, DataSourceIdentifier dataSourceIdentifier, DataTypeRef dataTypeRef, DataPoint dataPoint) {
        if (this.dataTypeRefTriggers.contains(dataTypeRef) && this.recordData) {
            ...
            DataField dataField = BaseDataTypes.FIELD_SPEED_MAX;
            DataField dataField2 = BaseDataTypes.FIELD_SPEED_MIN;
            DataField dataField3 = BaseDataTypes.FIELD_SPEED_AVG;
            Double valueDouble = dataPoint.getValueDouble(BaseDataTypes.FIELD_SPEED);
