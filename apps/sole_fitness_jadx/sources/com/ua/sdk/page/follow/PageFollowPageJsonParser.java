...
public class PageFollowPageJsonParser implements JsonParser<EntityList<PageFollow>> {
    ...
    public EntityList<PageFollow> parse(InputStream inputStream) throws UaException {
        try {
            return PageFollowPageTransferObject.toPage((PageFollowPageTransferObject) this.gson.fromJson(new JsonReader(new InputStreamReader(inputStream)), PageFollowPageTransferObject.class));
