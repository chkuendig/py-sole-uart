package com.fuelfitness.fuel.wxapi;
...
public class WXEntryActivity extends Activity implements IWXAPIEventHandler {
    ...
    public void onResp(BaseResp baseResp) {
        ...
        if (i == -4) {
            Toast.makeText(this, "wechat access fail   ERR_AUTH_DENIED", 0).show();
            finish();
            return;
        }
        if (i == -2) {
            Toast.makeText(this, "wechat access fail   ERR_USER_CANCEL", 0).show();
            finish();
            return;
        }
        if (i == 0) {
        ...
        Toast.makeText(this, "wechat access fail   \u3000errCode:" + baseResp.errCode, 0).show();
        finish();
    }
    ...
    /* renamed from: com.fuelfitness.fuel.wxapi.WXEntryActivity$1, reason: invalid class name */
    class AnonymousClass1 implements Callback {
        ...
        public void onFailure(Call call, final IOException iOException) {
            WXEntryActivity.this.runOnUiThread(new Runnable() { // from class: com.fuelfitness.fuel.wxapi.WXEntryActivity.1.1
        ...
        public void onResponse(Call call, Response response) throws IOException {
            ...
            if (str == null) {
                WXEntryActivity.this.runOnUiThread(new Runnable() { // from class: com.fuelfitness.fuel.wxapi.WXEntryActivity.1.2
                    @Override // java.lang.Runnable
                    public void run() {
            ...
            cloudApi.setMemberLoginListener(new MemberLoginListener() { // from class: com.fuelfitness.fuel.wxapi.WXEntryActivity.1.3
                ...
                public void onFail(final ResponseMessage responseMessage) {
                    WXEntryActivity.this.runOnUiThread(new Runnable() { // from class: com.fuelfitness.fuel.wxapi.WXEntryActivity.1.3.1
                        @Override // java.lang.Runnable
                        public void run() {
                ...
                public void onError(final String str2) {
                    WXEntryActivity.this.runOnUiThread(new Runnable() { // from class: com.fuelfitness.fuel.wxapi.WXEntryActivity.1.3.2
                        @Override // java.lang.Runnable
                        public void run() {
            ...
            cloudApi.callMemberLogin(str + "@wechat", "", "WECHAT");
        }
    }
    ...
    public Map<String, String> parseWechatAccessTokenData(String str) {
        return (Map) new Gson().fromJson(str, new TypeToken<Map<String, String>>() { // from class: com.fuelfitness.fuel.wxapi.WXEntryActivity.2
        }.getType());
    }
}
