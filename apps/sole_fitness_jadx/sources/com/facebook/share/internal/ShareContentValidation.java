...
public class ShareContentValidation {
    ...
    public static void validateForMessage(ShareContent shareContent) throws FacebookException {
        validate(shareContent, getDefaultValidator());
    }

    public static void validateForNativeShare(ShareContent shareContent) throws FacebookException {
        validate(shareContent, getDefaultValidator());
    }

    public static void validateForWebShare(ShareContent shareContent) throws FacebookException {
        validate(shareContent, getWebShareValidator());
    }

    public static void validateForApiShare(ShareContent shareContent) throws FacebookException {
        validate(shareContent, getApiValidator());
    }

    public static void validateForStoryShare(ShareContent shareContent) throws FacebookException {
