...
public final class UserSettingsManager {
                    ...
                    FacebookSdk.getExecutor().execute(new Runnable() { // from class: com.facebook.UserSettingsManager.initializeCodelessSetupEnabledAsync.1
                        ...
                        public final void run() {
                            ...
                            try {
                                ...
                                try {
                                    if (UserSettingsManager.access$getAdvertiserIDCollectionEnabled$p(UserSettingsManager.INSTANCE).m38getValue() && (fetchedAppSettingsQueryAppSettings = FetchedAppSettingsManager.queryAppSettings(FacebookSdk.getApplicationId(), false)) != null && fetchedAppSettingsQueryAppSettings.getCodelessEventsEnabled()) {
                                        ...
                                        if (androidAdvertiserId != null) {
                                            ...
                                            bundle.putString(UserSettingsManager.ADVERTISER_ID_KEY, androidAdvertiserId);
                                            bundle.putString("fields", UserSettingsManager.EVENTS_CODELESS_SETUP_ENABLED);
                                            GraphRequest graphRequestNewGraphPathRequest = GraphRequest.INSTANCE.newGraphPathRequest(null, FacebookSdk.getApplicationId(), null);
                                            ...
                                            if (graphObject != null) {
                                                UserSettingsManager.access$getCodelessSetupEnabled$p(UserSettingsManager.INSTANCE).setValue(Boolean.valueOf(graphObject.optBoolean(UserSettingsManager.EVENTS_CODELESS_SETUP_ENABLED, false)));
                                                UserSettingsManager.access$getCodelessSetupEnabled$p(UserSettingsManager.INSTANCE).setLastTS(jCurrentTimeMillis);
    ...
    private final void logIfSDKSettingsChanged() {
        ...
        try {
            if (isInitialized.get() && FacebookSdk.isInitialized()) {
                Context applicationContext = FacebookSdk.getApplicationContext();
                int i3 = 0;
                int i4 = ((autoInitEnabled.m38getValue() ? 1 : 0) << 0) | 0 | ((autoLogAppEventsEnabled.m38getValue() ? 1 : 0) << 1) | ((advertiserIDCollectionEnabled.m38getValue() ? 1 : 0) << 2) | ((monitorEnabled.m38getValue() ? 1 : 0) << 3);
                SharedPreferences sharedPreferences = userSettingPref;
                if (sharedPreferences == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("userSettingPref");
                }
    ...
    public static final boolean getAutoInitEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return autoInitEnabled.m38getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
    ...
    public static final boolean getAutoLogAppEventsEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return autoLogAppEventsEnabled.m38getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
    ...
    public static final boolean getAdvertiserIDCollectionEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return advertiserIDCollectionEnabled.m38getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
    ...
    public static final boolean getCodelessSetupEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return codelessSetupEnabled.m38getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
    ...
    public static final boolean getMonitorEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return monitorEnabled.m38getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
    ...
    private static final class UserSetting {
        ...
        public final boolean m38getValue() {
