...
public final class EventBinding {
    ...
    public final List<PathComponent> getViewPath() {
        ...
        Intrinsics.checkNotNullExpressionValue(listUnmodifiableList, "Collections.unmodifiableList(path)");
    ...
    public final List<ParameterComponent> getViewParameters() {
        ...
        Intrinsics.checkNotNullExpressionValue(listUnmodifiableList, "Collections.unmodifiableList(parameters)");
        return listUnmodifiableList;
    }
