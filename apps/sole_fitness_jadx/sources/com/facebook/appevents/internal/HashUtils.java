...
public final class HashUtils {
    ...
    static {
        Intrinsics.checkNotNullExpressionValue("HashUtils", "HashUtils::class.java.simpleName");
        TAG = "HashUtils";
    ...
    public static final String computeChecksumWithPackageManager(Context context, Long nanosTimeout) throws CertificateException {
        ...
        try {
            ...
            Object objNewProxyInstance = Proxy.newProxyInstance(HashUtils.class.getClassLoader(), new Class[]{cls2}, new InvocationHandler() { // from class: com.facebook.appevents.internal.HashUtils$computeChecksumWithPackageManager$listener$1
