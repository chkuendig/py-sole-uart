...
public final class AppEventsLoggerImpl {
    ...
    public final void logPushNotificationOpen(Bundle payload, String action) {
        ...
        try {
            ...
            string2 = new JSONObject(string).getString("campaign");
            if (string2 == null) {
    ...
    public static final class Companion {
        ...
        public final void initializeLib(final Context context, String applicationId) {
            ...
            if (FacebookSdk.getAutoLogAppEventsEnabled()) {
                ...
                scheduledThreadPoolExecutorAccess$getBackgroundExecutor$cp.execute(new Runnable() { // from class: com.facebook.appevents.AppEventsLoggerImpl$Companion$initializeLib$1
        ...
        public final void augmentWebView(WebView webView, Context context) {
            ...
            int i = (strArr.length == 0) ^ true ? Integer.parseInt(strArr[0]) : 0;
            int i2 = strArr.length > 1 ? Integer.parseInt(strArr[1]) : 0;
            if (Build.VERSION.SDK_INT < 17 || i < 4 || (i == 4 && i2 <= 1)) {
        ...
        public final void initializeTimersIfNeeded() {
            synchronized (AppEventsLoggerImpl.access$getStaticLock$cp()) {
                ...
                scheduledThreadPoolExecutorAccess$getBackgroundExecutor$cp.scheduleAtFixedRate(appEventsLoggerImpl$Companion$initializeTimersIfNeeded$attributionRecheckRunnable$1, 0L, 86400, TimeUnit.SECONDS);
            }
        }
