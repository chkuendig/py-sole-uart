...
public final class InAppPurchaseBillingClientWrapper {
    ...
    public static final /* synthetic */ void access$querySkuDetailsAsync(InAppPurchaseBillingClientWrapper inAppPurchaseBillingClientWrapper, String str, List list, Runnable runnable) {
        if (CrashShieldHandler.isObjectCrashing(InAppPurchaseBillingClientWrapper.class)) {
            return;
        }
        try {
    ...
    public final void queryPurchaseHistory(String skuType, final Runnable queryPurchaseHistoryRunnable) {
        ...
        try {
            ...
            queryPurchaseHistoryAsync(skuType, new Runnable() { // from class: com.facebook.appevents.iap.InAppPurchaseBillingClientWrapper.queryPurchaseHistory.1
                ...
                public final void run() {
                    ...
                    try {
                        ...
                        try {
                            InAppPurchaseBillingClientWrapper.access$querySkuDetailsAsync(InAppPurchaseBillingClientWrapper.this, InAppPurchaseBillingClientWrapper.IN_APP, new ArrayList(InAppPurchaseBillingClientWrapper.access$getHistoryPurchaseSet$p(InAppPurchaseBillingClientWrapper.this)), queryPurchaseHistoryRunnable);
                        } catch (Throwable th) {
    ...
    public final void queryPurchase(String skuType, Runnable querySkuRunnable) {
        ...
        try {
            ...
            Object objInvokeMethod = InAppPurchaseUtils.invokeMethod(this.purchaseResultClazz, this.getPurchaseListMethod, InAppPurchaseUtils.invokeMethod(this.billingClientClazz, this.queryPurchasesMethod, this.billingClient, IN_APP), new Object[0]);
            if (!(objInvokeMethod instanceof List)) {
                objInvokeMethod = null;
            }
            List list = (List) objInvokeMethod;
            if (list != null) {
                try {
                    ArrayList arrayList = new ArrayList();
                    Iterator it = list.iterator();
                    while (it.hasNext()) {
                        Object objInvokeMethod2 = InAppPurchaseUtils.invokeMethod(this.purchaseClazz, this.getOriginalJsonMethod, it.next(), new Object[0]);
                        if (!(objInvokeMethod2 instanceof String)) {
                            objInvokeMethod2 = null;
                        }
                        String str = (String) objInvokeMethod2;
                        if (str != null) {
    ...
    private final void querySkuDetailsAsync(String skuType, List<String> skuIDs, Runnable runnable) {
        ...
        try {
            ...
            Intrinsics.checkNotNullExpressionValue(objNewProxyInstance, "Proxy.newProxyInstance(\n…istenerWrapper(runnable))");
            InAppPurchaseUtils.invokeMethod(this.billingClientClazz, this.querySkuDetailsAsyncMethod, this.billingClient, this.inAppPurchaseSkuDetailsWrapper.getSkuDetailsParams(skuType, skuIDs), objNewProxyInstance);
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, this);
        }
    }
    ...
    private final void queryPurchaseHistoryAsync(String skuType, Runnable runnable) {
        ...
        try {
            ...
            Intrinsics.checkNotNullExpressionValue(objNewProxyInstance, "Proxy.newProxyInstance(\n…istenerWrapper(runnable))");
            InAppPurchaseUtils.invokeMethod(this.billingClientClazz, this.queryPurchaseHistoryAsyncMethod, this.billingClient, skuType, objNewProxyInstance);
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, this);
        }
    }
    ...
    private final void startConnection() {
        ...
        try {
            ...
            Object objNewProxyInstance = Proxy.newProxyInstance(cls.getClassLoader(), new Class[]{cls}, new BillingClientStateListenerWrapper());
            Intrinsics.checkNotNullExpressionValue(objNewProxyInstance, "Proxy.newProxyInstance(\n…ntStateListenerWrapper())");
            InAppPurchaseUtils.invokeMethod(this.billingClientClazz, method, this.billingClient, objNewProxyInstance);
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, this);
        }
    }
    ...
    public final class PurchaseHistoryResponseListenerWrapper implements InvocationHandler {
        ...
        @Override // java.lang.reflect.InvocationHandler
        public Object invoke(Object proxy, Method method, Object[] args) throws JSONException {
            Intrinsics.checkNotNullParameter(proxy, "proxy");
        ...
        private final void getPurchaseHistoryRecord(List<?> purchaseHistoryRecordList) throws JSONException {
            Iterator<?> it = purchaseHistoryRecordList.iterator();
            while (it.hasNext()) {
                try {
                    Object objInvokeMethod = InAppPurchaseUtils.invokeMethod(InAppPurchaseBillingClientWrapper.access$getPurchaseHistoryRecordClazz$p(this.this$0), InAppPurchaseBillingClientWrapper.access$getGetOriginalJsonPurchaseHistoryMethod$p(this.this$0), it.next(), new Object[0]);
                    if (!(objInvokeMethod instanceof String)) {
                        objInvokeMethod = null;
                    }
                    String str = (String) objInvokeMethod;
                    if (str != null) {
                        JSONObject jSONObject = new JSONObject(str);
    ...
    public final class SkuDetailsResponseListenerWrapper implements InvocationHandler {
        ...
        @Override // java.lang.reflect.InvocationHandler
        public Object invoke(Object proxy, Method m, Object[] args) throws JSONException {
            Intrinsics.checkNotNullParameter(proxy, "proxy");
            Intrinsics.checkNotNullParameter(m, "m");
            Intrinsics.checkNotNullParameter(args, "args");
        ...
        public final void parseSkuDetails(List<?> skuDetailsObjectList) throws JSONException {
            Intrinsics.checkNotNullParameter(skuDetailsObjectList, "skuDetailsObjectList");
            Iterator<?> it = skuDetailsObjectList.iterator();
            while (it.hasNext()) {
                try {
                    Object objInvokeMethod = InAppPurchaseUtils.invokeMethod(InAppPurchaseBillingClientWrapper.access$getSkuDetailsClazz$p(this.this$0), InAppPurchaseBillingClientWrapper.access$getGetOriginalJsonSkuMethod$p(this.this$0), it.next(), new Object[0]);
                    if (!(objInvokeMethod instanceof String)) {
                        objInvokeMethod = null;
                    }
                    String str = (String) objInvokeMethod;
    ...
    public static final class Companion {
        ...
        private final void createInstance(Context context) {
            ...
            if (orCreateInstance != null) {
                ...
                if (method == null || method2 == null || method3 == null || method4 == null || method5 == null || method6 == null || method7 == null || (objCreateBillingClient = createBillingClient(context, cls)) == null) {
                    return;
                }
                ...
                Objects.requireNonNull(inAppPurchaseBillingClientWrapperAccess$getInstance$cp, "null cannot be cast to non-null type com.facebook.appevents.iap.InAppPurchaseBillingClientWrapper");
                InAppPurchaseBillingClientWrapper.access$startConnection(inAppPurchaseBillingClientWrapperAccess$getInstance$cp);
            }
        }

        private final Object createBillingClient(Context context, Class<?> billingClientClazz) throws IllegalArgumentException {
            ...
            if (method == null || method2 == null || method3 == null || method4 == null || (objInvokeMethod = InAppPurchaseUtils.invokeMethod(billingClientClazz, method, null, context)) == null) {
                return null;
            }
            Object objNewProxyInstance = Proxy.newProxyInstance(cls2.getClassLoader(), new Class[]{cls2}, new PurchasesUpdatedListenerWrapper());
            Intrinsics.checkNotNullExpressionValue(objNewProxyInstance, "Proxy.newProxyInstance(\n…UpdatedListenerWrapper())");
            Object objInvokeMethod3 = InAppPurchaseUtils.invokeMethod(cls, method3, objInvokeMethod, objNewProxyInstance);
            if (objInvokeMethod3 == null || (objInvokeMethod2 = InAppPurchaseUtils.invokeMethod(cls, method2, objInvokeMethod3, new Object[0])) == null) {
                return null;
            }
            return InAppPurchaseUtils.invokeMethod(cls, method4, objInvokeMethod2, new Object[0]);
        }
    }
}
