...
public final class AppEventsLogger {
    ...
    public static final class Companion {
        ...
        public final void activateApp(Context context, String str) {
            AppEventsLoggerImpl.INSTANCE.functionDEPRECATED("Please use activateApp(Application) or activateApp(Application, String), activateApp(Context) and activateApp(Context, String) will be removed since v12");
        }
        ...
        public final void deactivateApp(Context context, String str) {
            AppEventsLoggerImpl.INSTANCE.functionDEPRECATED("Deactivate app will be logged automatically, AppEventsLogger#deactivateApp will be removed since v12");
        }
        ...
        public final void setUserData(Bundle userData) {
            AppEventsLoggerImpl.INSTANCE.functionDEPRECATED("AppEventsLogger#setUserData(Bundle) is deprecated and it will be removed since v12");
        ...
        @Deprecated(message = "")
        @JvmStatic
        public final void updateUserProperties(Bundle parameters, GraphRequest.Callback callback) {
            updateUserProperties(null, null, null);
        }

        @Deprecated(message = "")
        @JvmStatic
        public final void updateUserProperties(Bundle parameters, String applicationID, GraphRequest.Callback callback) {
            AppEventsLoggerImpl.INSTANCE.functionDEPRECATED("AppEventsLogger#updateUserProperties is deprecated and it will be removed since v12");
        }
