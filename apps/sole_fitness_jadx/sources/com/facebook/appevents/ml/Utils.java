...
public final class Utils {
            ...
            try {
                ...
                while (i6 < length) {
                    ...
                    if (str == null) {
                        ...
                        ByteBuffer byteBufferWrap = ByteBuffer.wrap(bArr, i4, i8);
                        byteBufferWrap.order(ByteOrder.LITTLE_ENDIAN);
                        MTensor mTensor = new MTensor(iArr);
                        i = 0;
                        byteBufferWrap.asFloatBuffer().get(mTensor.getData(), 0, i7);
                        map.put(str, mTensor);
                        i4 = i9;
                    }
                    i6++;
    ...
    public final String normalizeString(String str) {
        ...
        try {
            ...
            if (array != null) {
                String strJoin = TextUtils.join(StringUtils.SPACE, (String[]) array);
                Intrinsics.checkNotNullExpressionValue(strJoin, "TextUtils.join(\" \", strArray)");
                return strJoin;
            }
