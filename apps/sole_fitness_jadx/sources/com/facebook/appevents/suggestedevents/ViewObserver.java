...
public final class ViewObserver implements ViewTreeObserver.OnGlobalLayoutListener {
            ...
            Runnable runnable = new Runnable() { // from class: com.facebook.appevents.suggestedevents.ViewObserver$process$runnable$1
                ...
                public final void run() {
                    ...
                    try {
                        ...
                        try {
                            View rootView = AppEventUtility.getRootView((Activity) ViewObserver.access$getActivityWeakReference$p(this.this$0).get());
                            Activity activity = (Activity) ViewObserver.access$getActivityWeakReference$p(this.this$0).get();
    ...
    public static final class Companion {
        ...
        public final void stopTrackingActivity(Activity activity) {
            Intrinsics.checkNotNullParameter(activity, "activity");
            int iHashCode = activity.hashCode();
            ViewObserver viewObserver = (ViewObserver) ViewObserver.access$getObservers$cp().get(Integer.valueOf(iHashCode));
            if (viewObserver != null) {
                ViewObserver.access$getObservers$cp().remove(Integer.valueOf(iHashCode));
