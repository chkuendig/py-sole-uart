...
public final class ViewOnClickListener implements View.OnClickListener {
    ...
    private final void predictAndProcess(final String pathID, final String buttonText, final JSONObject viewData) {
        ...
        try {
            Utility.runOnNonUiThread(new Runnable() { // from class: com.facebook.appevents.suggestedevents.ViewOnClickListener.predictAndProcess.1
                ...
                public final void run() {
                    ...
                    try {
                        ...
                        try {
                            ...
                            String textFeature = FeatureExtractor.getTextFeature(buttonText, ViewOnClickListener.access$getActivityName$p(ViewOnClickListener.this), lowerCase);
                            ...
                            if (!Intrinsics.areEqual(str, "other")) {
                                ViewOnClickListener.INSTANCE.processPredictedResult(str, buttonText, denseFeatures);
                            }
                        } catch (Exception unused) {
                        } catch (Throwable th) {
                            CrashShieldHandler.handleThrowable(th, this);
    ...
    public static final class Companion {
        ...
        public final boolean queryHistoryAndProcess(String pathID, final String buttonText) {
            ...
            if (!Intrinsics.areEqual(strQueryEvent, "other")) {
                Utility.runOnNonUiThread(new Runnable() { // from class: com.facebook.appevents.suggestedevents.ViewOnClickListener$Companion$queryHistoryAndProcess$1
                    @Override // java.lang.Runnable
                    public final void run() {
                        if (CrashShieldHandler.isObjectCrashing(this)) {
                            return;
                        ...
                        try {
                            ...
                            try {
                                ViewOnClickListener.INSTANCE.processPredictedResult(strQueryEvent, buttonText, new float[0]);
                            } catch (Throwable th) {
                                CrashShieldHandler.handleThrowable(th, this);
                            }
                        } catch (Throwable th2) {
        ...
        private final void sendPredictedResult(String eventToPost, String buttonText, float[] dense) throws JSONException {
            ...
            try {
                ...
                bundle.putString(MBTilesFileArchive.TABLE_METADATA, jSONObject.toString());
