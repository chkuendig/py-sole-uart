...
public class DaemonReceiver {
    ...
    private static GraphResponse createErrorResponse(JSONObject jSONObject, String str) {
        ...
        if (jSONObjectOptJSONObject != null) {
            return createErrorResponse(new FacebookRequestError(jSONObjectOptJSONObject.optInt(OAuthConstants.CODE), jSONObjectOptJSONObject.optString("type"), jSONObjectOptJSONObject.optString("message")), str);
        }
        return createDefaultErrorResponse(str);
    }
