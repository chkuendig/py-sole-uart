...
public class DaemonRequest {
    ...
    public static void executeAsync(Context context, JSONObject jSONObject, Callback callback, SDKMessageEnum sDKMessageEnum) throws JSONException {
        JSONObject jSONObjectPut;
        try {
            if (jSONObject == null) {
                jSONObjectPut = new JSONObject().put("type", sDKMessageEnum.toString());
            } else {
                jSONObjectPut = jSONObject.put("type", sDKMessageEnum.toString());
            }
    ...
    public static GraphResponse executeAndWait(Context context, JSONObject jSONObject, SDKMessageEnum sDKMessageEnum) throws JSONException {
        JSONObject jSONObjectPut;
        try {
            if (jSONObject == null) {
                jSONObjectPut = new JSONObject().put("type", sDKMessageEnum.toString());
            ...
            return new DaemonRequest(context, jSONObjectPut, null).executeAndWait();
        } catch (InterruptedException | ExecutionException | JSONException unused) {
    ...
    public static GraphResponse executeAndWait(Context context, JSONObject jSONObject, SDKMessageEnum sDKMessageEnum, int i) throws JSONException {
        JSONObject jSONObjectPut;
        try {
            if (jSONObject == null) {
                jSONObjectPut = new JSONObject().put("type", sDKMessageEnum.toString());
            ...
            return new DaemonRequest(context, jSONObjectPut, null).executeAndWait(i);
