...
public final class CancellationTokenSource implements Closeable {
    ...
    private final ScheduledExecutorService executor = BoltsExecutors.INSTANCE.scheduled$facebook_core_release();
    ...
    private final void cancelAfter(final long delay, final TimeUnit timeUnit) {
        if (!(delay >= ((long) (-1)))) {
                        ...
                        try {
                            ...
                            try {
                                synchronized (this.this$0.lock) {
                                    this.this$0.scheduledCancellation = null;
                                    Unit unit = Unit.INSTANCE;
                                }
                                this.this$0.cancel();
                            } catch (Throwable th) {
    ...
    public final CancellationTokenRegistration register$facebook_core_release(Runnable action) {
    ...
    public final void unregister$facebook_core_release(CancellationTokenRegistration registration) {
