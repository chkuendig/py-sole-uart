...
public final class CancellationToken {
    ...
    public final CancellationTokenRegistration register(Runnable action) {
        return this.tokenSource.register$facebook_core_release(action);
    }
    ...
    public String toString() {
        ...
        String str = String.format(Locale.US, "%s@%s[cancellationRequested=%s]", Arrays.copyOf(new Object[]{getClass().getName(), Integer.toHexString(hashCode()), Boolean.toString(this.tokenSource.isCancellationRequested())}, 3));
