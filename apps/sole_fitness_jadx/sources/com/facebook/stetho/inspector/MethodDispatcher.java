...
public class MethodDispatcher {
    ...
    public JSONObject dispatch(JsonRpcPeer jsonRpcPeer, String str, @Nullable JSONObject jSONObject) throws Throwable {
    ...
    private static class MethodDispatchHelper {
        ...
        public JSONObject invoke(JsonRpcPeer jsonRpcPeer, @Nullable JSONObject jSONObject) throws IllegalAccessException, JSONException, JsonRpcException, IllegalArgumentException, InvocationTargetException {
            Object objInvoke = this.mMethod.invoke(this.mInstance, jsonRpcPeer, jSONObject);
            if (objInvoke == null || (objInvoke instanceof EmptyResult)) {
                return new JSONObject();
            }
            return (JSONObject) this.mObjectMapper.convertValue((JsonRpcResult) objInvoke, JSONObject.class);
        }
    }

    private static Map<String, MethodDispatchHelper> buildDispatchTable(ObjectMapper objectMapper, Iterable<ChromeDevtoolsDomain> iterable) throws SecurityException {
