                        ...
                        callbackHandler.post(new Runnable() { // from class: com.facebook.ProgressOutputStream.reportBatchProgress.1
                            ...
                            public final void run() {
                                ...
                                try {
                                    ...
                                    try {
                                        ((GraphRequestBatch.OnProgressCallback) callback).onBatchProgress(ProgressOutputStream.this.requests, ProgressOutputStream.this.getBatchProgress(), ProgressOutputStream.this.getMaxProgress());
                                    } catch (Throwable th) {
