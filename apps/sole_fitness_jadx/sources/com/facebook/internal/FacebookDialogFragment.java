    ...
    public void onCreate(Bundle bundle) throws PackageManager.NameNotFoundException {
        ...
        if (this.dialog == null) {
            ...
            if (!methodArgumentsFromIntent.getBoolean(NativeProtocol.WEB_DIALOG_IS_FALLBACK, false)) {
                ...
                webDialogNewInstance = new WebDialog.Builder(activity, string, bundle2).setOnCompleteListener(new WebDialog.OnCompleteListener() { // from class: com.facebook.internal.FacebookDialogFragment.1
                ...
                if (Utility.isNullOrEmpty(string2)) {
                    ...
                    webDialogNewInstance = FacebookWebFallbackDialog.newInstance(activity, string2, String.format("fb%s://bridge/", FacebookSdk.getApplicationId()));
