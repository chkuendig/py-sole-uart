...
public final class ImageResponseCache {
    ...
    public static final InputStream getCachedImageStream(Uri uri) {
        ...
        try {
            ...
            Logger.INSTANCE.log(LoggingBehavior.CACHE, 5, TAG, e.toString());
            return null;
        }
    }
    ...
    private final boolean isCDNURL(Uri uri) {
        if (uri != null) {
            ...
            if (host != null && StringsKt.startsWith$default(host, "fbcdn", false, 2, (Object) null) && StringsKt.endsWith$default(host, "akamaihd.net", false, 2, (Object) null)) {
                return true;
            }
        }
        return false;
