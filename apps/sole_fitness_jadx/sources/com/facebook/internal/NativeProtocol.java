...
public final class NativeProtocol {
    ...
    public static final Intent createFacebookLiteIntent(Context context, String applicationId, Collection<String> permissions, String e2e, boolean isRerequest, boolean isForPublish, DefaultAudience defaultAudience, String clientState, String authType, String messengerPageId, boolean resetMessengerState, boolean isFamilyLogin, boolean shouldSkipAccountDedupe) {
        ...
        try {
            ...
            return validateActivityIntent(context, INSTANCE.createNativeAppIntent(fBLiteAppInfo, applicationId, permissions, e2e, isForPublish, defaultAudience, clientState, authType, false, messengerPageId, resetMessengerState, LoginTargetApp.FACEBOOK, isFamilyLogin, shouldSkipAccountDedupe), fBLiteAppInfo);
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, NativeProtocol.class);
            return null;
        }
    ...
    public static final Intent createInstagramIntent(Context context, String applicationId, Collection<String> permissions, String e2e, boolean isRerequest, boolean isForPublish, DefaultAudience defaultAudience, String clientState, String authType, String messengerPageId, boolean resetMessengerState, boolean isFamilyLogin, boolean shouldSkipAccountDedupe) {
        ...
        try {
            ...
            return validateActivityIntent(context, INSTANCE.createNativeAppIntent(instagramAppInfo, applicationId, permissions, e2e, isForPublish, defaultAudience, clientState, authType, false, messengerPageId, resetMessengerState, LoginTargetApp.INSTAGRAM, isFamilyLogin, shouldSkipAccountDedupe), instagramAppInfo);
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, NativeProtocol.class);
            return null;
        }
    ...
    private final Intent createNativeAppIntent(NativeAppInfo appInfo, String applicationId, Collection<String> permissions, String e2e, boolean isForPublish, DefaultAudience defaultAudience, String clientState, String authType, boolean ignoreAppSwitchToLoggedOut, String messengerPageId, boolean resetMessengerState, LoginTargetApp targetApp, boolean isFamilyLogin, boolean shouldSkipAccountDedupe) {
        ...
        try {
            ...
            if (isForPublish) {
                intentPutExtra.putExtra(ServerProtocol.DIALOG_PARAM_DEFAULT_AUDIENCE, defaultAudience.getNativeProtocolAudience());
            }
    ...
    public static final List<Intent> createProxyAuthIntents(Context context, String applicationId, Collection<String> permissions, String e2e, boolean isRerequest, boolean isForPublish, DefaultAudience defaultAudience, String clientState, String authType, boolean ignoreAppSwitchToLoggedOut, String messengerPageId, boolean resetMessengerState, boolean isFamilyLogin, boolean shouldSkipAccountDedupe) {
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                Intent intentCreateNativeAppIntent = INSTANCE.createNativeAppIntent((NativeAppInfo) it.next(), applicationId, permissions, e2e, isForPublish, defaultAudience, clientState, authType, ignoreAppSwitchToLoggedOut, messengerPageId, resetMessengerState, LoginTargetApp.FACEBOOK, isFamilyLogin, shouldSkipAccountDedupe);
    ...
    public static final Intent createTokenRefreshIntent(Context context) {
        ...
        try {
            ...
            for (NativeAppInfo nativeAppInfo : facebookAppInfoList) {
                Intent intentValidateServiceIntent = validateServiceIntent(context, new Intent().setClassName(nativeAppInfo.getPackage(), FACEBOOK_TOKEN_REFRESH_ACTIVITY), nativeAppInfo);
    ...
    /* JADX WARN: Removed duplicated region for block: B:30:0x0090 A[Catch: all -> 0x009c, TRY_ENTER, TryCatch #5 {all -> 0x009c, blocks: (B:5:0x000d, B:35:0x0098, B:36:0x009b, B:30:0x0090), top: B:45:0x000d }] */
    /* JADX WARN: Removed duplicated region for block: B:41:0x0072 A[EXC_TOP_SPLITTER, LOOP:0: B:41:0x0072->B:24:0x0078, LOOP_START, SYNTHETIC] */
    /*
    ...
    */
    ...
    private final Uri buildPlatformProviderVersionURI(NativeAppInfo appInfo) {
        ...
        try {
            ...
            Intrinsics.checkNotNullExpressionValue(uri, "Uri.parse(CONTENT_SCHEME…ATFORM_PROVIDER_VERSIONS)");
            return uri;
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, this);
            return null;
    ...
    public static abstract class NativeAppInfo {
        ...
        /* JADX WARN: Removed duplicated region for block: B:9:0x000f A[Catch: all -> 0x002e, TryCatch #0 {, blocks: (B:4:0x0003, B:7:0x0009, B:10:0x0017, B:12:0x001d, B:18:0x0029, B:9:0x000f), top: B:24:0x0003 }] */
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        */
    ...
    private static final class MessengerAppInfo extends NativeAppInfo {
        ...
        public Void m40getLoginActivity() {
            return null;
        }
        ...
        public /* bridge */ /* synthetic */ String getLoginActivity() {
            return (String) m40getLoginActivity();
        }
    }
    ...
    private static final class EffectTestAppInfo extends NativeAppInfo {
        /* renamed from: getLoginActivity, reason: collision with other method in class */
        public Void m39getLoginActivity() {
            return null;
        }
        ...
        @Override // com.facebook.internal.NativeProtocol.NativeAppInfo
        public /* bridge */ /* synthetic */ String getLoginActivity() {
            return (String) m39getLoginActivity();
        }
    }
