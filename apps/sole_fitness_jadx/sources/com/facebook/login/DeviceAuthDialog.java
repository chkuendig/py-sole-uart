...
public class DeviceAuthDialog extends DialogFragment {
        ...
        new GraphRequest(null, DEVICE_LOGIN_ENDPOINT, bundle, HttpMethod.POST, new GraphRequest.Callback() { // from class: com.facebook.login.DeviceAuthDialog.2
            ...
            public void onCompleted(GraphResponse graphResponse) {
                ...
                try {
                    ...
                    requestState.setRequestCode(graphObject.getString(OAuthConstants.CODE));
    ...
    protected View initializeContentView(boolean z) {
        ...
        this.progressBar = viewInflate.findViewById(com.facebook.common.R.id.progress_bar);
        this.confirmationCode = (TextView) viewInflate.findViewById(com.facebook.common.R.id.confirmation_code);
        ((Button) viewInflate.findViewById(com.facebook.common.R.id.cancel_button)).setOnClickListener(new View.OnClickListener() { // from class: com.facebook.login.DeviceAuthDialog.3
        ...
        TextView textView = (TextView) viewInflate.findViewById(com.facebook.common.R.id.com_facebook_device_auth_instructions);
    ...
    private GraphRequest getPollRequest() {
        Bundle bundle = new Bundle();
        bundle.putString(OAuthConstants.CODE, this.currentRequestState.getRequestCode());
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void presentConfirmation(final String str, final Utility.PermissionsLists permissionsLists, final String str2, String str3, final Date date, final Date date2) throws Resources.NotFoundException {
    ...
    public void onSuccess(final String str, Long l, Long l2) {
        ...
        new GraphRequest(new AccessToken(str, FacebookSdk.getApplicationId(), AppEventsConstants.EVENT_PARAM_VALUE_NO, null, null, null, null, date2, null, date), "me", bundle, HttpMethod.GET, new GraphRequest.Callback() { // from class: com.facebook.login.DeviceAuthDialog.8
            @Override // com.facebook.GraphRequest.Callback
            public void onCompleted(GraphResponse graphResponse) throws JSONException, Resources.NotFoundException {
                if (DeviceAuthDialog.this.completed.get()) {
                    return;
                }
                if (graphResponse.getError() != null) {
                ...
                try {
                    ...
                    if (!FetchedAppSettingsManager.getAppSettingsWithoutQuery(FacebookSdk.getApplicationId()).getSmartLoginOptions().contains(SmartLoginOption.RequireConfirm) || DeviceAuthDialog.this.isRetry) {
                        DeviceAuthDialog.this.completeLogin(string, permissionsListsHandlePermissionResponse, str, date2, date);
                    } else {
                        DeviceAuthDialog.this.isRetry = true;
                        DeviceAuthDialog.this.presentConfirmation(string, permissionsListsHandlePermissionResponse, str, string2, date2, date);
                    }
                } catch (JSONException e) {
                    DeviceAuthDialog.this.onError(new FacebookException(e));
                }
