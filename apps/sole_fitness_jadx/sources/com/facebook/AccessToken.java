...
public final class AccessToken implements Parcelable {
    ...
    /* compiled from: AccessToken.kt */
    @Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\bf\u0018\u00002\u00020\u0001J\u0012\u0010\u0002\u001a\u00020\u00032\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005H&J\u0012\u0010\u0006\u001a\u00020\u00032\b\u0010\u0007\u001a\u0004\u0018\u00010\bH&¨\u0006\t"}, d2 = {"Lcom/facebook/AccessToken$AccessTokenCreationCallback;", "", "onError", "", "error", "Lcom/facebook/FacebookException;", "onSuccess", AccessToken.TOKEN_KEY, "Lcom/facebook/AccessToken;", "facebook-core_release"}, k = 1, mv = {1, 5, 1})
    ...
    public AccessToken(String accessToken, String applicationId, String userId, Collection<String> collection, Collection<String> collection2, Collection<String> collection3, AccessTokenSource accessTokenSource, Date date, Date date2, Date date3, String str) {
        ...
        Intrinsics.checkNotNullExpressionValue(setUnmodifiableSet, "Collections.unmodifiable…missions) else HashSet())");
        ...
        Intrinsics.checkNotNullExpressionValue(setUnmodifiableSet2, "Collections.unmodifiable…missions) else HashSet())");
        ...
        Intrinsics.checkNotNullExpressionValue(setUnmodifiableSet3, "Collections.unmodifiable…missions) else HashSet())");
    ...
    public AccessToken(Parcel parcel) {
        ...
        Intrinsics.checkNotNullExpressionValue(setUnmodifiableSet, "Collections.unmodifiable…HashSet(permissionsList))");
        this.permissions = setUnmodifiableSet;
        arrayList.clear();
        parcel.readStringList(arrayList2);
        Set<String> setUnmodifiableSet2 = Collections.unmodifiableSet(new HashSet(arrayList3));
        Intrinsics.checkNotNullExpressionValue(setUnmodifiableSet2, "Collections.unmodifiable…HashSet(permissionsList))");
        this.declinedPermissions = setUnmodifiableSet2;
        arrayList.clear();
        parcel.readStringList(arrayList2);
        Set<String> setUnmodifiableSet3 = Collections.unmodifiableSet(new HashSet(arrayList3));
        Intrinsics.checkNotNullExpressionValue(setUnmodifiableSet3, "Collections.unmodifiable…HashSet(permissionsList))");
        this.expiredPermissions = setUnmodifiableSet3;
        String string = parcel.readString();
        Validate.notNullOrEmpty(string, TOKEN_KEY);
        if (string != null) {
            this.token = string;
    ...
    public static final class Companion {
        ...
        public final List<String> getPermissionsFromBundle$facebook_core_release(Bundle bundle, String key) {
            ...
            Intrinsics.checkNotNullExpressionValue(listUnmodifiableList, "Collections.unmodifiable…ist(originalPermissions))");
        ...
        public final AccessToken createFromBundle(List<String> requestedPermissions, Bundle bundle, AccessTokenSource source, Date expirationBase, String applicationId) throws NumberFormatException {
            String string;
