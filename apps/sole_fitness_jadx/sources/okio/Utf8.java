        ...
        while (i < i2) {
            ...
            if (Intrinsics.compare((int) cCharAt2, 128) < 0) {
                ...
                if (Intrinsics.compare((int) cCharAt2, 2048) < 0) {
                    yield.invoke(Byte.valueOf((byte) ((cCharAt2 >> 6) | R2.attr.constraintSet)));
                    yield.invoke(Byte.valueOf((byte) ((cCharAt2 & '?') | 128)));
                } else if (55296 > cCharAt2 || 57343 < cCharAt2) {
                    yield.invoke(Byte.valueOf((byte) ((cCharAt2 >> '\f') | R2.attr.customPixelDimension)));
                    ...
                    yield.invoke(Byte.valueOf((byte) ((iCharAt >> 18) | R2.attr.dividerPadding)));
                            ...
                            if ((b9 & 192) == 128) {
                                ...
                                if ((b10 & 192) == 128) {
                                    ...
                                    if (i13 <= 1114111 && ((55296 > i13 || 57343 < i13) && i13 >= 65536 && i13 != 65533)) {
                                        ...
                                        yield.invoke(Character.valueOf((char) ((i13 & R2.color.red) + LOG_SURROGATE_HEADER)));
                                    } else {
                                        yield.invoke(Character.valueOf(REPLACEMENT_CHARACTER));
                                    }
                                    Unit unit8 = Unit.INSTANCE;
