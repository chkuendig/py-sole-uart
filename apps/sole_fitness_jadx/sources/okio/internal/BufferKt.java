...
public final class BufferKt {
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:51:0x00ca A[EDGE_INSN: B:51:0x00ca->B:41:0x00ca BREAK  A[LOOP:0: B:5:0x0016->B:53:?], SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:43:0x00b7 A[EDGE_INSN: B:43:0x00b7->B:37:0x00b7 BREAK  A[LOOP:0: B:5:0x0012->B:45:?], SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
        ...
        while (i < i2) {
            ...
            if (cCharAt < 128) {
                ...
                if (cCharAt < 2048) {
                    ...
                    segmentWritableSegment$okio2.data[segmentWritableSegment$okio2.limit] = (byte) ((cCharAt >> 6) | R2.attr.constraintSet);
                    ...
                    segmentWritableSegment$okio3.data[segmentWritableSegment$okio3.limit] = (byte) ((cCharAt >> '\f') | R2.attr.customPixelDimension);
                    ...
                    if (cCharAt > 56319 || 56320 > cCharAt3 || 57343 < cCharAt3) {
                        ...
                        segmentWritableSegment$okio4.data[segmentWritableSegment$okio4.limit] = (byte) ((i6 >> 18) | R2.attr.dividerPadding);
    ...
    public static final Buffer commonWriteUtf8CodePoint(Buffer commonWriteUtf8CodePoint, int i) {
        ...
        if (i < 128) {
            ...
            segmentWritableSegment$okio.data[segmentWritableSegment$okio.limit] = (byte) ((i >> 6) | R2.attr.constraintSet);
            ...
            segmentWritableSegment$okio2.data[segmentWritableSegment$okio2.limit] = (byte) ((i >> 12) | R2.attr.customPixelDimension);
            ...
            segmentWritableSegment$okio3.data[segmentWritableSegment$okio3.limit] = (byte) ((i >> 18) | R2.attr.dividerPadding);
