...
public final class RealBufferedSinkKt {
    public static final void commonWrite(buffer commonWrite, Buffer source, long j) throws IOException {
    ...
    public static final BufferedSink commonWrite(buffer commonWrite, Source source, long j) throws IOException {
        Intrinsics.checkNotNullParameter(commonWrite, "$this$commonWrite");
        Intrinsics.checkNotNullParameter(source, "source");
        while (j > 0) {
