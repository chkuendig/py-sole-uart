...
public final class RealBufferedSourceKt {
    ...
    public static final void commonRequire(buffer commonRequire, long j) throws EOFException {
    ...
    public static final void commonReadFully(buffer commonReadFully, Buffer sink, long j) throws IOException {
        Intrinsics.checkNotNullParameter(commonReadFully, "$this$commonReadFully");
        Intrinsics.checkNotNullParameter(sink, "sink");
        try {
    ...
    public static final long commonIndexOf(buffer commonIndexOf, ByteString bytes, long j) throws IOException {
        Intrinsics.checkNotNullParameter(commonIndexOf, "$this$commonIndexOf");
