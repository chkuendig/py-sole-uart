                                ...
                                if ((b9 & 192) == 128) {
                                    ...
                                    if ((b10 & 192) == 128) {
                                        ...
                                        if (i17 > 1114111) {
                                            ...
                                            char c = (char) ((i17 & R2.color.red) + Utf8.LOG_SURROGATE_HEADER);
                                            i5 = i18 + 1;
                                            cArr[i18] = c;
                                        }
                ...
                while (i3 < length2) {
                    ...
                    if (Intrinsics.compare((int) cCharAt3, 128) < 0) {
                        ...
                        if (Intrinsics.compare((int) cCharAt3, 2048) < 0) {
                            int i6 = i4 + 1;
                            bArr[i4] = (byte) ((cCharAt3 >> 6) | R2.attr.constraintSet);
                            byte b = (byte) ((cCharAt3 & '?') | 128);
                            i = i6 + 1;
                            bArr[i6] = b;
                        } else if (55296 > cCharAt3 || 57343 < cCharAt3) {
                            int i7 = i4 + 1;
                            bArr[i4] = (byte) ((cCharAt3 >> '\f') | R2.attr.customPixelDimension);
                            int i8 = i7 + 1;
                            ...
                            int i9 = i4 + 1;
                            bArr[i4] = (byte) ((iCharAt >> 18) | R2.attr.dividerPadding);
                            int i10 = i9 + 1;
