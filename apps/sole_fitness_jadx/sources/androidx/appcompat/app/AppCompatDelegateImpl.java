...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    */
    ...
    public View createView(View view, String str, Context context, AttributeSet attributeSet) {
        ...
        boolean zShouldInheritContext = true;
        if (z3) {
    ...
    */
    ...
    private static Configuration generateConfigDelta(Configuration configuration, Configuration configuration2) {
        ...
        if (configuration2 != null && configuration.diff(configuration2) != 0) {
            ...
            if ((configuration.screenLayout & R2.attr.constraintSet) != (configuration2.screenLayout & R2.attr.constraintSet)) {
                configuration3.screenLayout |= configuration2.screenLayout & R2.attr.constraintSet;
            }
            ...
            if ((configuration.screenLayout & R2.bool.abc_config_actionMenuItemAllCaps) != (configuration2.screenLayout & R2.bool.abc_config_actionMenuItemAllCaps)) {
                configuration3.screenLayout |= configuration2.screenLayout & R2.bool.abc_config_actionMenuItemAllCaps;
            }
            if (Build.VERSION.SDK_INT >= 26) {
