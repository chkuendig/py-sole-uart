    ...
    private static void encodeUtf8Buffer(CharSequence charSequence, ByteBuffer byteBuffer) {
        ...
        while (i < length) {
            ...
            if (cCharAt2 < 128) {
                ...
                int i2 = iPosition + 1;
                try {
                    byteBuffer.put(iPosition, (byte) ((cCharAt2 >>> 6) | R2.attr.constraintSet));
                ...
                int i3 = iPosition + 1;
                byteBuffer.put(iPosition, (byte) ((cCharAt2 >>> '\f') | R2.attr.customPixelDimension));
                iPosition = i3 + 1;
                ...
                if (i4 != length) {
                    try {
                        ...
                        if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                            ...
                            int i5 = iPosition + 1;
                            try {
                                byteBuffer.put(iPosition, (byte) ((codePoint >>> 18) | R2.attr.dividerPadding));
                                int i6 = i5 + 1;
        ...
        while (i7 < length) {
            ...
            if (cCharAt2 >= 128 || i8 >= i6) {
                if (cCharAt2 < 2048 && i8 <= i6 - 2) {
                    int i9 = i8 + 1;
                    bArr[i8] = (byte) ((cCharAt2 >>> 6) | R2.color.lightsteelblue);
                    i8 = i9 + 1;
                        ...
                        if (i8 <= i6 - 4) {
                            ...
                            if (i10 != charSequence.length()) {
                                ...
                                if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                                    int codePoint = Character.toCodePoint(cCharAt2, cCharAt3);
                                    int i11 = i8 + 1;
                                    bArr[i8] = (byte) ((codePoint >>> 18) | R2.attr.dividerPadding);
                                    int i12 = i11 + 1;
                    ...
                    int i14 = i8 + 1;
                    bArr[i8] = (byte) ((cCharAt2 >>> '\f') | R2.attr.moveWhenScrollAtTop);
                    int i15 = i14 + 1;
