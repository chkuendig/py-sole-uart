...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    */
    ...
    public final class Recycler {
        ...
        /* JADX WARN: Removed duplicated region for block: B:73:0x0183 A[PHI: r1 r4
        ...
        */
        ...
        void recycleViewHolderInternal(ViewHolder viewHolder) {
            ...
            if ((RecyclerView.this.mAdapter != null && zDoesTransientStatePreventRecycling && RecyclerView.this.mAdapter.onFailedToRecycleView(viewHolder)) || viewHolder.isRecyclable()) {
                if (this.mViewCacheMax <= 0 || viewHolder.hasAnyOfTheFlags(R2.attr.quantizeMotionPhase)) {
                    z = false;
                } else {
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public final void bindViewHolder(VH vh, int i) {
            ...
            if (z) {
                ...
                vh.setFlags(1, R2.attr.popupMenuStyle);
    ...
    int getAdapterPositionInRecyclerView(ViewHolder viewHolder) {
        if (viewHolder.hasAnyOfTheFlags(R2.attr.progressBarStyle) || !viewHolder.isBound()) {
            return -1;
        }
