...
final class SavedStateHandleController implements LifecycleEventObserver {
    ...
    static SavedStateHandleController create(SavedStateRegistry registry, Lifecycle lifecycle, String key, Bundle defaultArgs) throws NoSuchMethodException, SecurityException {
    ...
    static void attachHandleIfNeeded(ViewModel viewModel, SavedStateRegistry registry, Lifecycle lifecycle) throws NoSuchMethodException, SecurityException {
    ...
    private static void tryToAddRecreator(final SavedStateRegistry registry, final Lifecycle lifecycle) throws NoSuchMethodException, SecurityException {
