    ...
    private void fire(String str, View call) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        if (method == null) {
            try {
                ...
                Log.e("KeyTrigger", "Could not find method \"" + str + "\"on class " + call.getClass().getSimpleName() + StringUtils.SPACE + Debug.getName(call));
                return;
            }
        }
        try {
            ...
            Log.e("KeyTrigger", "Exception in call \"" + this.mCross + "\"on class " + call.getClass().getSimpleName() + StringUtils.SPACE + Debug.getName(call));
        }
    }
