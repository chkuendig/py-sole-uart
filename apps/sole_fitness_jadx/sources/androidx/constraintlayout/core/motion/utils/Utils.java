...
public class Utils {
    ...
    public static void socketSend(String str) throws IOException {
        try {
            OutputStream outputStream = new Socket("127.0.0.1", R2.styleable.ConstraintLayout_Layout_layout_constraintHeight).getOutputStream();
    ...
    public static void logStack(String str, int i) {
        ...
        for (int i2 = 1; i2 <= iMin; i2++) {
            ...
            String str3 = ".(" + stackTrace[i2].getFileName() + CertificateUtil.DELIMITER + stackTrace[i2].getLineNumber() + ") " + stackTrace[i2].getMethodName();
    ...
    public static void log(String str) {
        ...
        String str2 = ".(" + stackTraceElement.getFileName() + CertificateUtil.DELIMITER + stackTraceElement.getLineNumber() + ")" + "    ".substring(Integer.toString(stackTraceElement.getLineNumber()).length()) + strSubstring;
