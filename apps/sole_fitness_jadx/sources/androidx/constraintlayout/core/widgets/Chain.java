    ...
    */
    static void applyChainConstraints(ConstraintWidgetContainer constraintWidgetContainer, LinearSystem linearSystem, int i, int i2, ChainHead chainHead) {
        ...
        while (true) {
            ...
            if (constraintAnchor3.mTarget != null) {
                if (r8 == constraintWidget11) {
                    ...
                    constraintWidget7 = constraintWidget13;
                    constraintWidget8 = constraintWidget9;
                    linearSystem.addGreaterThan(constraintAnchor3.mSolverVariable, constraintAnchor3.mTarget.mSolverVariable, i9, 8);
                }
                if (z10 && !z3) {
                    i8 = 5;
                }
                linearSystem.addEquality(constraintAnchor3.mSolverVariable, constraintAnchor3.mTarget.mSolverVariable, i9, (r8 == constraintWidget11 && z3 && r8.isInBarrier(i7)) ? 5 : i8);
            } else {
                constraintWidget7 = constraintWidget13;
                constraintWidget8 = constraintWidget9;
            }
        ...
        if (constraintWidget12 != null) {
            int i10 = i2 + 1;
            if (constraintWidget10.mListAnchors[i10].mTarget != null) {
                ConstraintAnchor constraintAnchor5 = constraintWidget12.mListAnchors[i10];
                if ((constraintWidget12.mListDimensionBehaviors[i7] == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && constraintWidget12.mResolvedMatchConstraintDefault[i7] == 0) && !z3 && constraintAnchor5.mTarget.mOwner == constraintWidgetContainer) {
                ...
                linearSystem.addLowerThan(constraintAnchor5.mSolverVariable, constraintWidget10.mListAnchors[i10].mTarget.mSolverVariable, -constraintAnchor5.getMargin(), 6);
            }
        }
        if (z5) {
            int i11 = i2 + 1;
            linearSystem.addGreaterThan(constraintWidgetContainer.mListAnchors[i11].mSolverVariable, constraintWidget10.mListAnchors[i11].mSolverVariable, constraintWidget10.mListAnchors[i11].getMargin(), 8);
        }
        ...
        if (arrayList2 != null && (size = arrayList2.size()) > 1) {
            ...
            int i12 = 0;
            while (i12 < size) {
                ConstraintWidget constraintWidget19 = arrayList2.get(i12);
                float f8 = constraintWidget19.mWeight[i7];
                if (f8 < f6) {
                ...
                if (f8 == f6) {
                    ...
                    if (constraintWidget18 != null) {
                        ...
                        int i13 = i2 + 1;
                        SolverVariable solverVariable6 = constraintWidget18.mListAnchors[i13].mSolverVariable;
                        SolverVariable solverVariable7 = constraintWidget19.mListAnchors[i2].mSolverVariable;
                        arrayList = arrayList2;
                        SolverVariable solverVariable8 = constraintWidget19.mListAnchors[i13].mSolverVariable;
                        i5 = size;
        ...
        if (constraintWidget11 != null && (constraintWidget11 == constraintWidget12 || z3)) {
            ...
            int i14 = i2 + 1;
            ConstraintAnchor constraintAnchor7 = constraintWidget10.mListAnchors[i14];
            ...
            if (constraintWidget12 != null) {
                constraintAnchor7 = constraintWidget12.mListAnchors[i14];
            }
            ...
            if (z6 && constraintWidget11 != null) {
                ...
                while (constraintWidget21 != null) {
                    ConstraintWidget constraintWidget22 = constraintWidget21.mNextChainWidget[i7];
                    ...
                    if (constraintWidget21 == constraintWidget11 || constraintWidget21 == constraintWidget12 || constraintWidget22 == null) {
                        ...
                        int i16 = i2 + 1;
                        SolverVariable solverVariable13 = constraintWidget20.mListAnchors[i16].mSolverVariable;
                        int margin2 = constraintAnchor9.getMargin();
                        int margin3 = constraintWidget21.mListAnchors[i16].getMargin();
                        if (constraintWidget23 != null) {
                            ...
                            solverVariable2 = constraintWidget21.mListAnchors[i16].mSolverVariable;
                        }
                        if (constraintAnchor != null) {
                            margin3 += constraintAnchor.getMargin();
                        }
                        int i17 = margin3;
                        int margin4 = constraintWidget20.mListAnchors[i16].getMargin() + margin2;
                        int i18 = z12 ? 8 : 4;
                    ...
                    constraintWidget20 = constraintWidget21.getVisibility() != i4 ? constraintWidget21 : constraintWidget;
                ...
                int i19 = i2 + 1;
                ConstraintAnchor constraintAnchor12 = constraintWidget12.mListAnchors[i19];
                ConstraintAnchor constraintAnchor13 = constraintWidget10.mListAnchors[i19].mTarget;
            ...
            while (constraintWidget25 != null) {
                ...
                if (constraintWidget26 != null || constraintWidget25 == constraintWidget12) {
                    ...
                    if (constraintWidget26 != null) {
                        ...
                        constraintAnchor2 = constraintWidget10.mListAnchors[i20].mTarget;
                        if (constraintAnchor2 != null) {
                            solverVariable3 = constraintAnchor2.mSolverVariable;
                        } else {
                            constraintWidget4 = constraintWidget26;
                            solverVariable3 = null;
                            SolverVariable solverVariable17 = constraintWidget25.mListAnchors[i20].mSolverVariable;
                            if (constraintAnchor2 != null) {
                            ...
                            if (solverVariable15 != null || solverVariable16 == null || solverVariable3 == null || solverVariable17 == null) {
                                ...
                                linearSystem.addCentering(solverVariable15, solverVariable16, i21, 0.5f, solverVariable3, solverVariable17, constraintWidget25 == constraintWidget12 ? constraintWidget12.mListAnchors[i20].getMargin() : margin6, z13 ? 8 : 5);
                    ...
                    constraintWidget4 = constraintWidget26;
                    SolverVariable solverVariable172 = constraintWidget25.mListAnchors[i20].mSolverVariable;
                    if (constraintAnchor2 != null) {
                    }
        ...
        int i22 = i2 + 1;
        ConstraintAnchor constraintAnchor16 = constraintWidget12.mListAnchors[i22];
        ...
        if (constraintWidget10 != constraintWidget12) {
            ConstraintAnchor constraintAnchor17 = constraintWidget10.mListAnchors[i22];
        ...
        if (constraintWidget11 == constraintWidget12) {
            ...
            constraintAnchor16 = constraintWidget11.mListAnchors[i22];
        }
        if (solverVariable18 == null || solverVariable4 == null) {
            return;
        }
        linearSystem.addCentering(constraintAnchor15.mSolverVariable, solverVariable18, constraintAnchor15.getMargin(), 0.5f, solverVariable4, constraintAnchor16.mSolverVariable, constraintWidget12.mListAnchors[i22].getMargin(), 5);
    }
}
