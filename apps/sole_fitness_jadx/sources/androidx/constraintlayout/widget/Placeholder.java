...
public class Placeholder extends View {
    ...
    public void onDraw(Canvas canvas) {
        if (isInEditMode()) {
            canvas.drawRGB(R2.attr.customNavigationLayout, R2.attr.customNavigationLayout, R2.attr.customNavigationLayout);
            Paint paint = new Paint();
            paint.setARGB(255, R2.attr.contentPaddingTop, R2.attr.contentPaddingTop, R2.attr.contentPaddingTop);
