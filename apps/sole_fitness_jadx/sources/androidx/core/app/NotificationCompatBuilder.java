...
class NotificationCompatBuilder implements NotificationBuilderWithBuilderAccessor {
    ...
    NotificationCompatBuilder(NotificationCompat.Builder builder) {
        ...
        if (Build.VERSION.SDK_INT >= 19 && Build.VERSION.SDK_INT < 21 && (listCombineLists2 = combineLists(getPeople(builder.mPersonList), builder.mPeople)) != null && !listCombineLists2.isEmpty()) {
            this.mExtras.putStringArray(NotificationCompat.EXTRA_PEOPLE, (String[]) listCombineLists2.toArray(new String[listCombineLists2.size()]));
        }
        if (Build.VERSION.SDK_INT >= 20) {
