                ...
                if (iFindPointerIndex == -1) {
                    ...
                    if (this.mIsBeingDragged) {
                        ...
                        if (z2) {
                            ...
                            int i7 = scrollY + i6;
                            if (i7 < 0) {
                                EdgeEffectCompat.onPullDistance(this.mEdgeGlowTop, (-i6) / getHeight(), motionEvent.getX(iFindPointerIndex) / getWidth());
                                if (!this.mEdgeGlowBottom.isFinished()) {
                                    this.mEdgeGlowBottom.onRelease();
                                }
                            } else if (i7 > scrollRange) {
                                EdgeEffectCompat.onPullDistance(this.mEdgeGlowBottom, i6 / getHeight(), 1.0f - (motionEvent.getX(iFindPointerIndex) / getWidth()));
