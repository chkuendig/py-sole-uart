...
public final class OnSubscribeRedo<T> implements Observable.OnSubscribe<T> {
    ...
    public void call(final Subscriber<? super T> subscriber) {
        ...
        final BehaviorSubject behaviorSubjectCreate = BehaviorSubject.create();
        behaviorSubjectCreate.subscribe((Subscriber) Subscribers.empty());
            ...
            public void call() {
                ...
                Subscriber<T> subscriber2 = new Subscriber<T>() { // from class: rx.internal.operators.OnSubscribeRedo.2.1
                    ...
                    public void onCompleted() {
                        ...
                        this.done = true;
                        unsubscribe();
                        behaviorSubjectCreate.onNext(Notification.createOnCompleted());
                    }
                    ...
                    public void onError(Throwable th) {
                        ...
                        this.done = true;
                        unsubscribe();
                        behaviorSubjectCreate.onNext(Notification.createOnError(th));
                    }
        ...
        final Observable<?> observableCall = this.controlHandlerFunction.call(behaviorSubjectCreate.lift(new Observable.Operator<Notification<?>, Notification<?>>() { // from class: rx.internal.operators.OnSubscribeRedo.3
            @Override // rx.functions.Func1
