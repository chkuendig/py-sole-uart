...
public class Completable {
        ...
        return create(new CompletableOnSubscribe() { // from class: rx.Completable.22
            ...
            public void call(final CompletableSubscriber completableSubscriber) {
                ...
                Completable.this.unsafeSubscribe(new CompletableSubscriber() { // from class: rx.Completable.22.1
                    @Override // rx.Completable.CompletableSubscriber
                    public void onCompleted() {
                        workerCreateWorker.schedule(new Action0() { // from class: rx.Completable.22.1.1
                            @Override // rx.functions.Action0
                            public void call() {
                                try {
                                    completableSubscriber.onCompleted();
                    ...
                    @Override // rx.Completable.CompletableSubscriber
                    public void onError(final Throwable th) {
                        workerCreateWorker.schedule(new Action0() { // from class: rx.Completable.22.1.2
                            @Override // rx.functions.Action0
                            public void call() {
                                try {
                                    completableSubscriber.onError(th);
    ...
    public final void unsafeSubscribe(CompletableSubscriber completableSubscriber) {
        ...
        try {
            ...
            Exceptions.throwIfFatal(th);
            Throwable thOnSubscribeError = HOOK.onSubscribeError(th);
            ERROR_HANDLER.handleError(thOnSubscribeError);
            throw toNpe(thOnSubscribeError);
        }
    }
    ...
    public final Completable subscribeOn(final Scheduler scheduler) {
        ...
        return create(new CompletableOnSubscribe() { // from class: rx.Completable.29
            ...
            public void call(final CompletableSubscriber completableSubscriber) {
                final Scheduler.Worker workerCreateWorker = scheduler.createWorker();
                workerCreateWorker.schedule(new Action0() { // from class: rx.Completable.29.1
                    @Override // rx.functions.Action0
                    public void call() {
                        try {
            ...
            Completable.this.unsafeSubscribe(new CompletableSubscriber() { // from class: rx.Completable.33.1
                ...
                public void onSubscribe(final Subscription subscription) {
                    completableSubscriber.onSubscribe(Subscriptions.create(new Action0() { // from class: rx.Completable.33.1.1
                        @Override // rx.functions.Action0
                        public void call() {
                            final Scheduler.Worker workerCreateWorker = AnonymousClass33.this.val$scheduler.createWorker();
                            workerCreateWorker.schedule(new Action0() { // from class: rx.Completable.33.1.1.1
                                @Override // rx.functions.Action0
                                public void call() {
                                    try {
                                        subscription.unsubscribe();
