...
public final class LocalDate extends BaseLocal implements ReadablePartial, Serializable {
    ...
    public static LocalDate fromDateFields(Date date) {
        ...
        return new LocalDate(date.getYear() + R2.drawable.edituser_sole_main, date.getMonth() + 1, date.getDate());
    }
    ...
    public LocalDate(int i, int i2, int i3, Chronology chronology) {
        ...
        long dateTimeMillis = chronologyWithUTC.getDateTimeMillis(i, i2, i3, 0);
        this.iChronology = chronologyWithUTC;
    ...
    LocalDate withLocalMillis(long j) {
        long jRoundFloor = this.iChronology.dayOfMonth().roundFloor(j);
    ...
    public LocalDate withPeriodAdded(ReadablePeriod readablePeriod, int i) {
        ...
        for (int i2 = 0; i2 < readablePeriod.size(); i2++) {
            long jSafeMultiply = FieldUtils.safeMultiply(readablePeriod.getValue(i2), i);
