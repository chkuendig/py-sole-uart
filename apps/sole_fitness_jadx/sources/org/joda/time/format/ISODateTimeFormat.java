    ...
    */
    ...
    static final class Constants {
        ...
        private static DateTimeFormatter hourMinuteSecondMillis() {
            ...
            return dateTimeFormatter == null ? new DateTimeFormatterBuilder().append(hourElement()).append(minuteElement()).append(secondElement()).appendLiteral(ClassUtils.PACKAGE_SEPARATOR_CHAR).appendFractionOfSecond(3, 3).toFormatter() : dateTimeFormatter;
        }
        ...
        private static DateTimeFormatter fractionElement() {
            ...
            return dateTimeFormatter == null ? new DateTimeFormatterBuilder().appendLiteral(ClassUtils.PACKAGE_SEPARATOR_CHAR).appendFractionOfSecond(3, 9).toFormatter() : dateTimeFormatter;
        }
