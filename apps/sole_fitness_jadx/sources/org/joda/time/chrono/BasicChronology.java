...
abstract class BasicChronology extends AssembledChronology {
    ...
    int getDaysInYearMax() {
        return R2.attr.layout_constraintGuide_begin;
    }
    ...
    public long getDateTimeMillis(int i, int i2, int i3, int i4, int i5, int i6, int i7) throws IllegalArgumentException {
        ...
        FieldUtils.verifyValueBounds(DateTimeFieldType.millisOfSecond(), i7, 0, R2.color.olive);
    ...
    int getDaysInYear(int i) {
        return isLeapYear(i) ? R2.attr.layout_constraintGuide_begin : R2.attr.layout_constraintEnd_toStartOf;
    }
