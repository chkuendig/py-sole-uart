...
public final class GJChronology extends AssembledChronology {
    ...
    private class CutoverField extends BaseDateTimeField {
        ...
        public long set(long j, int i) {
            ...
            if (j >= this.iCutover) {
                jJulianToGregorian = this.iGregorianField.set(j, i);
                ...
                jJulianToGregorian = this.iJulianField.set(j, i);
                if (jJulianToGregorian >= this.iCutover) {
    ...
    private final class ImpreciseCutoverField extends CutoverField {
        ...
        public long add(long j, int i) {
            if (j >= this.iCutover) {
                long jAdd = this.iGregorianField.add(j, i);
            ...
            long jAdd2 = this.iJulianField.add(j, i);
