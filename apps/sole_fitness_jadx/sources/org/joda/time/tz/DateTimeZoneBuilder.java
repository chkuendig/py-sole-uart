...
public class DateTimeZoneBuilder {
    ...
    static void writeMillis(DataOutput dataOutput, long j) throws IOException {
        ...
        dataOutput.writeByte(j < 0 ? 255 : R2.attr.constraintSet);
    ...
    public DateTimeZoneBuilder addCutover(int i, char c, int i2, int i3, int i4, boolean z, int i5) {
        if (this.iRuleSets.size() > 0) {
            this.iRuleSets.get(r10.size() - 1).setUpperLimit(i, new OfYear(c, i2, i3, i4, z, i5));
        }
    ...
    private static final class Transition {
        ...
        public String toString() {
            return new DateTime(this.iMillis, DateTimeZone.UTC) + StringUtils.SPACE + this.iStandardOffset + StringUtils.SPACE + this.iWallOffset;
        }
    }
    ...
    private static final class RuleSet {
        ...
        public Transition firstTransition(long j) {
            ...
            while (true) {
                Transition transitionNextTransition = nextTransition(j2, saveMillis);
        ...
        public String toString() {
            return this.iInitialNameKey + " initial: " + this.iInitialSaveMillis + " std: " + this.iStandardOffset + " upper: " + this.iUpperYear + StringUtils.SPACE + this.iUpperOfYear + StringUtils.SPACE + this.iRules;
        }
    }
