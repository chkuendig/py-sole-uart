...
public final class LocalDateTime extends BaseLocal implements ReadablePartial, Serializable {
    ...
    public static LocalDateTime fromDateFields(Date date) {
        ...
        return new LocalDateTime(date.getYear() + R2.drawable.edituser_sole_main, date.getMonth() + 1, date.getDate(), date.getHours(), date.getMinutes(), date.getSeconds(), (((int) (date.getTime() % 1000)) + 1000) % 1000);
    }
