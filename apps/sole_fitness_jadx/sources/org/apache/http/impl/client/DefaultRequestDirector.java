...
public class DefaultRequestDirector implements RequestDirector {
                        ...
                        if (zKeepAlive) {
                            ...
                            if (this.log.isDebugEnabled()) {
                                if (keepAliveDuration > 0) {
                                    str = "for " + keepAliveDuration + StringUtils.SPACE + TimeUnit.MILLISECONDS;
                                } else {
                                    str = "indefinitely";
                                }
    ...
    protected RoutedRequest handleResponse(RoutedRequest routedRequest, HttpResponse httpResponse, HttpContext httpContext) throws HttpException, NumberFormatException, IOException {
        HttpHost httpHost;
        HttpRoute route = routedRequest.getRoute();
        RequestWrapper request = routedRequest.getRequest();
