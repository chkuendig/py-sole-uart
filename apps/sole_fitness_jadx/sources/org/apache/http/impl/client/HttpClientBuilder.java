...
public class HttpClientBuilder {
    ...
    public CloseableHttpClient build() throws NumberFormatException, IOException {
        ...
        if (httpClientConnectionManager2 == null) {
            ...
            PoolingHttpClientConnectionManager poolingHttpClientConnectionManager = new PoolingHttpClientConnectionManager(registryBuild, null, null, null, j, timeUnit);
            ...
            if (this.systemProperties && ServerProtocol.DIALOG_RETURN_SCOPES_TRUE.equalsIgnoreCase(System.getProperty("http.keepAlive", ServerProtocol.DIALOG_RETURN_SCOPES_TRUE))) {
        ...
        ClientExecChain backoffStrategyExec = (backoffManager == null || (connectionBackoffStrategy = this.connectionBackoffStrategy) == null) ? clientExecChainDecorateProtocolExec : new BackoffStrategyExec(clientExecChainDecorateProtocolExec, connectionBackoffStrategy, backoffManager);
        ...
        Lookup<CookieSpecProvider> lookup2 = lookupCreateDefault;
        ...
        return new InternalHttpClient(backoffStrategyExec, httpClientConnectionManager, defaultRoutePlanner, lookup2, lookup, cookieStore, credentialsProvider, requestConfig, arrayList);
    }
}
