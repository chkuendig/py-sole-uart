...
final class NTLMEngineImpl implements NTLMEngine {
    ...
    static byte[] ntlm2SessionResponse(byte[] bArr, byte[] bArr2, byte[] bArr3) throws NoSuchAlgorithmException, NTLMEngineException {
        try {
    ...
    static class NTLMMessage {
        ...
        NTLMMessage(String str, int i) throws NTLMEngineException {
            this.messageContents = null;
            this.currentOutputPosition = 0;
            byte[] bArrDecodeBase64 = Base64.decodeBase64(str.getBytes(NTLMEngineImpl.DEFAULT_CHARSET));
    ...
    static class Type1Message extends NTLMMessage {
        ...
        String getResponse() {
            ...
            addUShort(0);
            addULong(40);
            addUShort(R2.attr.editTextStyle);
            addULong(R2.id.btnPause);
            addUShort(R2.layout.sport_dashboard);
    ...
    static class Type3Message extends NTLMMessage {
        ...
        Type3Message(String str, String str2, String str3, String str4, byte[] bArr, int i, String str5, byte[] bArr2) throws BadPaddingException, NoSuchPaddingException, IllegalBlockSizeException, NoSuchAlgorithmException, InvalidKeyException, NTLMEngineException {
        ...
        String getResponse() {
            ...
            addULong((i6 & 4) | (i6 & 128) | (i6 & 512) | (524288 & i6) | NTLMEngineImpl.FLAG_REQUEST_VERSION | (32768 & i6) | (i6 & 32) | (i6 & 16) | (NTLMEngineImpl.FLAG_REQUEST_128BIT_KEY_EXCH & i6) | (Integer.MIN_VALUE & i6) | (1073741824 & i6) | (8388608 & i6) | (i6 & 1));
            addUShort(R2.attr.editTextStyle);
            addULong(R2.id.btnPause);
            addUShort(R2.layout.sport_dashboard);
    ...
    static class HMACMD5 {
        ...
        HMACMD5(byte[] bArr) throws NoSuchAlgorithmException, NTLMEngineException {
            try {
                MessageDigest messageDigest = MessageDigest.getInstance("MD5");
