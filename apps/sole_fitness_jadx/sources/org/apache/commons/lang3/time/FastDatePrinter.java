    ...
    */
        ...
        while (i2 < length) {
            ...
            if (cCharAt == 'y') {
                ...
                if (length2 == 2) {
                    ...
                    objSelectNumberRule = selectNumberRule(1, length2);
                }
                if (cCharAt == 'Y') {
                    objSelectNumberRule = new WeekYear((NumberRule) objSelectNumberRule);
                    continue;
                }
            } else if (cCharAt != 'z') {
                switch (cCharAt) {
                ...
                objSelectNumberRule = new TimeZoneNameRule(this.mTimeZone, this.mLocale, 1);
                i = 0;
            } else {
                objSelectNumberRule = new TimeZoneNameRule(this.mTimeZone, this.mLocale, 0);
                i = 0;
            }
    ...
    private static class TimeZoneNumberRule implements Rule {
        ...
        public void appendTo(Appendable appendable, Calendar calendar) throws IOException {
            ...
            FastDatePrinter.appendDigits(appendable, (i / DateTimeConstants.MILLIS_PER_MINUTE) - (i2 * 60));
        }
    }
