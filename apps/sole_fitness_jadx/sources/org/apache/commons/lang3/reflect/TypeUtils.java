...
public class TypeUtils {
    ...
    private static final class GenericArrayTypeImpl implements GenericArrayType {
        ...
        public int hashCode() {
            return this.componentType.hashCode() | R2.color.xterra_bottom_gray;
        }
    }
    ...
    private static final class ParameterizedTypeImpl implements ParameterizedType {
        ...
        public int hashCode() {
            return ((((this.raw.hashCode() | R2.dimen.abc_list_item_height_small_material) << 4) | ObjectUtils.hashCode(this.useOwner)) << 8) | Arrays.hashCode(this.typeArguments);
        }
    }
