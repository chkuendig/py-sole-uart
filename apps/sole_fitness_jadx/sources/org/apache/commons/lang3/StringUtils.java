...
public class StringUtils {
    ...
    */
    public static int indexOfAnyBut(CharSequence charSequence, char... cArr) {
        ...
        if (!isEmpty(charSequence) && !ArrayUtils.isEmpty(cArr)) {
            ...
            while (i4 < length) {
                ...
                for (0; i < length2; i + 1) {
                    i = (cArr[i] != cCharAt || (i4 < i2 && i < i3 && Character.isHighSurrogate(cCharAt) && cArr[i + 1] != charSequence.charAt(i4 + 1))) ? i + 1 : 0;
                }
                return i4;
            }
        }
    ...
    public static String rightPad(String str, int i) {
        return rightPad(str, i, TokenParser.SP);
    }
    ...
    public static String leftPad(String str, int i) {
        return leftPad(str, i, TokenParser.SP);
    }
    ...
    public static String center(String str, int i) {
        return center(str, i, TokenParser.SP);
    }
    ...
    public static String uncapitalize(String str) {
        ...
        char cCharAt;
        char lowerCase;
        if (str == null || (length = str.length()) == 0 || cCharAt == (lowerCase = Character.toLowerCase((cCharAt = str.charAt(0))))) {
            return str;
        }
        char[] cArr = new char[length];
        cArr[0] = lowerCase;
        ...
        if (charSequenceArr != null && charSequenceArr.length > 1) {
            ...
            for (int i = 0; i < length; i++) {
                if (charSequenceArr[i] == null) {
                    ...
                    iMin = Math.min(charSequenceArr[i].length(), iMin);
