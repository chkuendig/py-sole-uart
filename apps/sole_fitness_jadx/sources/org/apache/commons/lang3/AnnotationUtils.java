...
public class AnnotationUtils {
    ...
    private static int hashMember(String str, Object obj) throws IllegalAccessException, SecurityException, IllegalArgumentException, InvocationTargetException {
        int iHashCode;
        int iHashCode2 = str.hashCode() * 127;
        if (obj.getClass().isArray()) {
            iHashCode = arrayMemberHash(obj.getClass().getComponentType(), obj);
        } else if (obj instanceof Annotation) {
            iHashCode = hashCode((Annotation) obj);
        } else {
