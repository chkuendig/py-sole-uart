...
public class ArrayUtils {
    ...
    static Object removeAll(Object obj, int... iArr) throws NegativeArraySizeException {
        int i;
        int i2;
        int length = getLength(obj);
    ...
    static Object removeAll(Object obj, BitSet bitSet) throws NegativeArraySizeException {
        int length = getLength(obj);
    ...
    public static boolean[] removeAllOccurences(boolean[] zArr, boolean z) {
        ...
        int i = 1;
        while (true) {
            int iIndexOf2 = indexOf(zArr, z, iArr[i - 1] + 1);
            if (iIndexOf2 != -1) {
                iArr[i] = iIndexOf2;
                i++;
            } else {
    ...
    public static char[] removeAllOccurences(char[] cArr, char c) {
        ...
        int i = 1;
        while (true) {
            int iIndexOf2 = indexOf(cArr, c, iArr[i - 1] + 1);
            if (iIndexOf2 != -1) {
                iArr[i] = iIndexOf2;
                i++;
            } else {
    ...
    public static byte[] removeAllOccurences(byte[] bArr, byte b) {
        ...
        int i = 1;
        while (true) {
            int iIndexOf2 = indexOf(bArr, b, iArr[i - 1] + 1);
            if (iIndexOf2 != -1) {
                iArr[i] = iIndexOf2;
                i++;
            } else {
    ...
    public static short[] removeAllOccurences(short[] sArr, short s) {
        ...
        int i = 1;
        while (true) {
            int iIndexOf2 = indexOf(sArr, s, iArr[i - 1] + 1);
            if (iIndexOf2 != -1) {
                iArr[i] = iIndexOf2;
                i++;
            } else {
    ...
    public static int[] removeAllOccurences(int[] iArr, int i) {
        ...
        int i2 = 1;
        while (true) {
            int iIndexOf2 = indexOf(iArr, i, iArr2[i2 - 1] + 1);
            if (iIndexOf2 != -1) {
                iArr2[i2] = iIndexOf2;
                i2++;
            } else {
    ...
    public static long[] removeAllOccurences(long[] jArr, long j) {
        ...
        int i = 1;
        while (true) {
            int iIndexOf2 = indexOf(jArr, j, iArr[i - 1] + 1);
            if (iIndexOf2 != -1) {
                iArr[i] = iIndexOf2;
                i++;
            } else {
    ...
    public static float[] removeAllOccurences(float[] fArr, float f) {
        ...
        int i = 1;
        while (true) {
            int iIndexOf2 = indexOf(fArr, f, iArr[i - 1] + 1);
            if (iIndexOf2 != -1) {
                iArr[i] = iIndexOf2;
                i++;
            } else {
    ...
    public static double[] removeAllOccurences(double[] dArr, double d) {
        ...
        int i = 1;
        while (true) {
            int iIndexOf2 = indexOf(dArr, d, iArr[i - 1] + 1);
            if (iIndexOf2 != -1) {
                iArr[i] = iIndexOf2;
                i++;
            } else {
    ...
    public static <T> T[] removeAllOccurences(T[] tArr, T t) {
        ...
        int i = 1;
        while (true) {
            int iIndexOf2 = indexOf(tArr, t, iArr[i - 1] + 1);
            if (iIndexOf2 != -1) {
                iArr[i] = iIndexOf2;
                i++;
            } else {
