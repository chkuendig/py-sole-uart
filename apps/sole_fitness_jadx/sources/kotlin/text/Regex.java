...
public final class Regex implements Serializable {
    ...
    public final Sequence<String> splitToSequence(CharSequence input, int limit) {
        Intrinsics.checkNotNullParameter(input, "input");
        StringsKt.requireNonNegativeLimit(limit);
        return SequencesKt.sequence(new C01591(input, limit, null));
    }
    ...
    @DebugMetadata(c = "kotlin.text.Regex$splitToSequence$1", f = "Regex.kt", i = {}, l = {R2.attr.dragScale, R2.attr.drawableStartCompat, 255}, m = "invokeSuspend", n = {}, s = {})
    /* renamed from: kotlin.text.Regex$splitToSequence$1, reason: invalid class name and case insensitive filesystem */
    static final class C01591 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super String>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01591(CharSequence charSequence, int i, Continuation continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> completion) {
            ...
            C01591 c01591 = Regex.this.new C01591(this.$input, this.$limit, completion);
            c01591.L$0 = obj;
            return c01591;
        }
        ...
        public final Object invoke(SequenceScope<? super String> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C01591) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i2 == 0) {
                ...
                if (this.$limit == 1 || !matcher2.find()) {
                    ...
                    matcher = matcher2;
                    i = 0;
                    string = c01591.$input.subSequence(iEnd, matcher.start()).toString();
                    c01591.L$0 = sequenceScope;
                    c01591.L$1 = matcher;
                    c01591.I$0 = i;
                    c01591.label = 2;
                    if (sequenceScope.yield(string, c01591) == coroutine_suspended) {
                    }
                    iEnd = matcher.end();
                    i++;
                    if (i != c01591.$limit - 1) {
                    }
                    CharSequence charSequence = c01591.$input;
                    string2 = charSequence.subSequence(iEnd, charSequence.length()).toString();
                    c01591.L$0 = null;
                    c01591.L$1 = null;
                    c01591.label = 3;
                    if (sequenceScope.yield(string2, c01591) == coroutine_suspended) {
                    }
                ...
                if (i2 != 1) {
                    ...
                    iEnd = matcher.end();
                    i++;
                    if (i != c01591.$limit - 1 || !matcher.find()) {
                        CharSequence charSequence2 = c01591.$input;
                    ...
                    CharSequence charSequence22 = c01591.$input;
