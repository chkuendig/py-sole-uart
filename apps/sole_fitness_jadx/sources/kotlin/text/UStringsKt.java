...
public final class UStringsKt {
    ...
    public static final String m1403toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1405toStringolVBNx4(short s, int i) {
    ...
    public static final String m1404toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1402toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String toUByteOrNull, int i) {
        ...
        if (UnsignedKt.uintCompare(data, UInt.m225constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m143boximpl(UByte.m149constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String toUShortOrNull, int i) {
        ...
        int data = uIntOrNull.getData();
        if (UnsignedKt.uintCompare(data, UInt.m225constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m403boximpl(UShort.m409constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String toUIntOrNull, int i) {
        ...
        int iM225constructorimpl = UInt.m225constructorimpl(i);
        int iM478uintDivideJ1ME1BU = 119304647;
        while (i3 < length) {
            int iDigitOf = CharsKt.digitOf(toUIntOrNull.charAt(i3), i);
            if (iDigitOf < 0) {
                return null;
            }
            if (UnsignedKt.uintCompare(i2, iM478uintDivideJ1ME1BU) > 0) {
                if (iM478uintDivideJ1ME1BU == 119304647) {
                    iM478uintDivideJ1ME1BU = UnsignedKt.m478uintDivideJ1ME1BU(-1, iM225constructorimpl);
                    if (UnsignedKt.uintCompare(i2, iM478uintDivideJ1ME1BU) > 0) {
                    }
                }
                return null;
            }
            int iM225constructorimpl2 = UInt.m225constructorimpl(i2 * iM225constructorimpl);
            int iM225constructorimpl3 = UInt.m225constructorimpl(UInt.m225constructorimpl(iDigitOf) + iM225constructorimpl2);
            if (UnsignedKt.uintCompare(iM225constructorimpl3, iM225constructorimpl2) < 0) {
                return null;
            }
            i3++;
            i2 = iM225constructorimpl3;
        }
        return UInt.m219boximpl(i2);
    }
    ...
    public static final ULong toULongOrNull(String toULongOrNull, int i) {
        ...
        long jM303constructorimpl = ULong.m303constructorimpl(i);
        long j2 = 0;
        long jM480ulongDivideeb3DHEI = 512409557603043100L;
        while (i2 < length) {
            if (CharsKt.digitOf(toULongOrNull.charAt(i2), i) < 0) {
                return null;
            }
            if (UnsignedKt.ulongCompare(j2, jM480ulongDivideeb3DHEI) > 0) {
                if (jM480ulongDivideeb3DHEI == 512409557603043100L) {
                    jM480ulongDivideeb3DHEI = UnsignedKt.m480ulongDivideeb3DHEI(j, jM303constructorimpl);
                    if (UnsignedKt.ulongCompare(j2, jM480ulongDivideeb3DHEI) > 0) {
                    }
                }
                return null;
            }
            long jM303constructorimpl2 = ULong.m303constructorimpl(j2 * jM303constructorimpl);
            long jM303constructorimpl3 = ULong.m303constructorimpl(ULong.m303constructorimpl(UInt.m225constructorimpl(r15) & 4294967295L) + jM303constructorimpl2);
            if (UnsignedKt.ulongCompare(jM303constructorimpl3, jM303constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j2 = jM303constructorimpl3;
            j = -1;
        }
        return ULong.m297boximpl(j2);
    }
}
