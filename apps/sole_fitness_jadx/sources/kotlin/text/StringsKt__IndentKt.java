...
public class StringsKt__IndentKt extends StringsKt__AppendableKt {
    ...
    public static final String replaceIndentByMargin(String replaceIndentByMargin, String newIndent, String marginPrefix) {
        ...
        String string = ((StringBuilder) CollectionsKt.joinTo$default(arrayList, new StringBuilder(length), StringUtils.LF, null, null, 0, null, null, 124, null)).toString();
    ...
    public static final String replaceIndent(String replaceIndent, String newIndent) {
        ...
        String string = ((StringBuilder) CollectionsKt.joinTo$default(arrayList4, new StringBuilder(length), StringUtils.LF, null, null, 0, null, null, 124, null)).toString();
        Intrinsics.checkNotNullExpressionValue(string, "mapIndexedNotNull { inde…\"\\n\")\n        .toString()");
        return string;
    }
    ...
    private static final String reindent$StringsKt__IndentKt(List<String> list, int i, Function1<? super String, String> function1, Function1<? super String, String> function12) {
        ...
        for (Object obj : list) {
            ...
            if ((i2 == 0 || i2 == lastIndex) && StringsKt.isBlank(str2)) {
                ...
                String strInvoke2 = function12.invoke(str2);
        ...
        String string = ((StringBuilder) CollectionsKt.joinTo$default(arrayList, new StringBuilder(i), StringUtils.LF, null, null, 0, null, null, 124, null)).toString();
        Intrinsics.checkNotNullExpressionValue(string, "mapIndexedNotNull { inde…\"\\n\")\n        .toString()");
        return string;
    }
}
