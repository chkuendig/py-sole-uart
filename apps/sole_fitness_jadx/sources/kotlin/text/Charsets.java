...
public final class Charsets {
    ...
    static {
        ...
        Intrinsics.checkNotNullExpressionValue(charsetForName2, "Charset.forName(\"UTF-16\")");
        UTF_16 = charsetForName2;
        Charset charsetForName3 = Charset.forName(CharEncoding.UTF_16BE);
        Intrinsics.checkNotNullExpressionValue(charsetForName3, "Charset.forName(\"UTF-16BE\")");
        UTF_16BE = charsetForName3;
        Charset charsetForName4 = Charset.forName(CharEncoding.UTF_16LE);
        Intrinsics.checkNotNullExpressionValue(charsetForName4, "Charset.forName(\"UTF-16LE\")");
        UTF_16LE = charsetForName4;
        Charset charsetForName5 = Charset.forName("US-ASCII");
        Intrinsics.checkNotNullExpressionValue(charsetForName5, "Charset.forName(\"US-ASCII\")");
        US_ASCII = charsetForName5;
        Charset charsetForName6 = Charset.forName("ISO-8859-1");
        Intrinsics.checkNotNullExpressionValue(charsetForName6, "Charset.forName(\"ISO-8859-1\")");
    ...
    public final Charset UTF32() {
        ...
        Intrinsics.checkNotNullExpressionValue(charsetForName, "Charset.forName(\"UTF-32\")");
    ...
    public final Charset UTF32_LE() {
        ...
        Intrinsics.checkNotNullExpressionValue(charsetForName, "Charset.forName(\"UTF-32LE\")");
    ...
    public final Charset UTF32_BE() {
        ...
        Intrinsics.checkNotNullExpressionValue(charsetForName, "Charset.forName(\"UTF-32BE\")");
