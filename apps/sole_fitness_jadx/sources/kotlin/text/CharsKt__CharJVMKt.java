...
public class CharsKt__CharJVMKt {
    ...
    public static final String titlecase(char c, Locale locale) {
        ...
        if (strUppercase.length() <= 1) {
            ...
            String upperCase = strValueOf.toUpperCase(Locale.ROOT);
            Intrinsics.checkNotNullExpressionValue(upperCase, "(this as java.lang.Strin….toUpperCase(Locale.ROOT)");
            return Intrinsics.areEqual(strUppercase, upperCase) ^ true ? strUppercase : String.valueOf(Character.toTitleCase(c));
        }
        if (c == 329) {
            return strUppercase;
        }
        char cCharAt = strUppercase.charAt(0);
        Objects.requireNonNull(strUppercase, "null cannot be cast to non-null type java.lang.String");
