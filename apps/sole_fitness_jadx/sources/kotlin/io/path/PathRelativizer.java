...
@Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006\bÂ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0016\u0010\u0007\u001a\u00020\u00042\u0006\u0010\b\u001a\u00020\u00042\u0006\u0010\t\u001a\u00020\u0004R\u0016\u0010\u0003\u001a\n \u0005*\u0004\u0018\u00010\u00040\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u0016\u0010\u0006\u001a\n \u0005*\u0004\u0018\u00010\u00040\u0004X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\n"}, d2 = {"Lkotlin/io/path/PathRelativizer;", "", "()V", "emptyPath", "Ljava/nio/file/Path;", "kotlin.jvm.PlatformType", "parentPath", "tryRelativeTo", ClientCookie.PATH_ATTR, "base", "kotlin-stdlib-jdk7"}, k = 1, mv = {1, 5, 1})
...
final class PathRelativizer {
    ...
    public final Path tryRelativeTo(Path path, Path base) {
        ...
        int iMin = Math.min(nameCount, r.getNameCount());
        ...
        if (!(!Intrinsics.areEqual(r, bn)) || !Intrinsics.areEqual(bn, emptyPath)) {
            ...
            if (StringsKt.endsWith$default(string, separator, false, 2, (Object) null)) {
                ...
                r = fileSystem2.getPath(StringsKt.dropLast(string, fileSystem3.getSeparator().length()), new String[0]);
            } else {
                r = rn;
            }
        }
