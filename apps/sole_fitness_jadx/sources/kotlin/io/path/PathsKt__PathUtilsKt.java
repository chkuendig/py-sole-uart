...
class PathsKt__PathUtilsKt extends PathsKt__PathReadWriteKt {
    ...
    public static final String getExtension(Path extension) {
        ...
        return (fileName == null || (string = fileName.toString()) == null || (strSubstringAfterLast = StringsKt.substringAfterLast(string, ClassUtils.PACKAGE_SEPARATOR_CHAR, "")) == null) ? "" : strSubstringAfterLast;
    }
