...
public final /* data */ class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m1504copyRFiDyg4$default(TimedValue timedValue, Object obj, long j, int i, Object obj2) {
        if ((i & 1) != 0) {
        ...
        return timedValue.m1506copyRFiDyg4(obj, j);
    }
    ...
    public final TimedValue<T> m1506copyRFiDyg4(T value, long duration) {
    ...
    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + Duration.m1465toStringimpl(this.duration) + ")";
    }
    ...
    public final long m1507getDurationUwyO8pc() {
        return this.duration;
    }
