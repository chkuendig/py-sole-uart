...
final class AdjustedTimeMark extends TimeMark {
    ...
    public long mo1406elapsedNowUwyO8pc() {
        return Duration.m1451minusLRDsOJo(this.mark.mo1406elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1407plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1452plusLRDsOJo(this.adjustment, duration));
    }
}
