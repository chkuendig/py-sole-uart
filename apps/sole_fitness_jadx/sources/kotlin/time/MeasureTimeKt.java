...
public final class MeasureTimeKt {
    public static final long measureTime(Function0<Unit> block) {
        ...
        block.invoke();
        return timeMarkMarkNow.mo1406elapsedNowUwyO8pc();
    }
    ...
    public static final <T> TimedValue<T> measureTimedValue(Function0<? extends T> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        return new TimedValue<>(block.invoke(), TimeSource.Monotonic.INSTANCE.markNow().mo1406elapsedNowUwyO8pc(), null);
    }
    ...
    public static final <T> TimedValue<T> measureTimedValue(TimeSource measureTimedValue, Function0<? extends T> block) {
        ...
        Intrinsics.checkNotNullParameter(block, "block");
        return new TimedValue<>(block.invoke(), measureTimedValue.markNow().mo1406elapsedNowUwyO8pc(), null);
    }
}
