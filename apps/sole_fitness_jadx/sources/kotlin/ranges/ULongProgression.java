...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m1321getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int iM303constructorimpl = ((int) ULong.m303constructorimpl(j ^ ULong.m303constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int iM303constructorimpl2 = (iM303constructorimpl + ((int) ULong.m303constructorimpl(j2 ^ ULong.m303constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return iM303constructorimpl2 + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append(ULong.m348toStringimpl(this.first));
            sb.append("..");
            sb.append(ULong.m348toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1344fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
