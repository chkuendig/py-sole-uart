...
public class AdaptedFunctionReference implements FunctionBase, Serializable {
    ...
    public int hashCode() {
        ...
        Class cls = this.owner;
        return ((((((((((iHashCode + (cls != null ? cls.hashCode() : 0)) * 31) + this.name.hashCode()) * 31) + this.signature.hashCode()) * 31) + (this.isTopLevel ? R2.dimen.compat_button_padding_horizontal_material : R2.dimen.connection_bg_width)) * 31) + this.arity) * 31) + this.flags;
    }
