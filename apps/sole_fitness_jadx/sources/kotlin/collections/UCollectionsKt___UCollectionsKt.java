...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> toUByteArray) {
        ...
        byte[] bArrM200constructorimpl = UByteArray.m200constructorimpl(toUByteArray.size());
        Iterator<UByte> it = toUByteArray.iterator();
        int i = 0;
        while (it.hasNext()) {
            UByteArray.m211setVurrAj0(bArrM200constructorimpl, i, it.next().getData());
            i++;
        }
        return bArrM200constructorimpl;
    }
    ...
    public static final int[] toUIntArray(Collection<UInt> toUIntArray) {
        ...
        int[] iArrM278constructorimpl = UIntArray.m278constructorimpl(toUIntArray.size());
        Iterator<UInt> it = toUIntArray.iterator();
        int i = 0;
        while (it.hasNext()) {
            UIntArray.m289setVXSXFK8(iArrM278constructorimpl, i, it.next().getData());
            i++;
        }
        return iArrM278constructorimpl;
    }
    ...
    public static final long[] toULongArray(Collection<ULong> toULongArray) {
        ...
        long[] jArrM356constructorimpl = ULongArray.m356constructorimpl(toULongArray.size());
        Iterator<ULong> it = toULongArray.iterator();
        int i = 0;
        while (it.hasNext()) {
            ULongArray.m367setk8EXiF4(jArrM356constructorimpl, i, it.next().getData());
            i++;
        }
        return jArrM356constructorimpl;
    }
    ...
    public static final short[] toUShortArray(Collection<UShort> toUShortArray) {
        ...
        short[] sArrM460constructorimpl = UShortArray.m460constructorimpl(toUShortArray.size());
        Iterator<UShort> it = toUShortArray.iterator();
        int i = 0;
        while (it.hasNext()) {
            UShortArray.m471set01HTLdE(sArrM460constructorimpl, i, it.next().getData());
            i++;
        }
        return sArrM460constructorimpl;
    }

    public static final int sumOfUInt(Iterable<UInt> sum) {
        Intrinsics.checkNotNullParameter(sum, "$this$sum");
        Iterator<UInt> it = sum.iterator();
        int iM225constructorimpl = 0;
        while (it.hasNext()) {
            iM225constructorimpl = UInt.m225constructorimpl(iM225constructorimpl + it.next().getData());
        }
        return iM225constructorimpl;
    }

    public static final long sumOfULong(Iterable<ULong> sum) {
        Intrinsics.checkNotNullParameter(sum, "$this$sum");
        Iterator<ULong> it = sum.iterator();
        long jM303constructorimpl = 0;
        while (it.hasNext()) {
            jM303constructorimpl = ULong.m303constructorimpl(jM303constructorimpl + it.next().getData());
        }
        return jM303constructorimpl;
    }
    ...
    public static final int sumOfUByte(Iterable<UByte> sum) {
        ...
        int iM225constructorimpl = 0;
        while (it.hasNext()) {
            iM225constructorimpl = UInt.m225constructorimpl(iM225constructorimpl + UInt.m225constructorimpl(it.next().getData() & UByte.MAX_VALUE));
        }
        return iM225constructorimpl;
    }
    ...
    public static final int sumOfUShort(Iterable<UShort> sum) {
        ...
        int iM225constructorimpl = 0;
        while (it.hasNext()) {
            iM225constructorimpl = UInt.m225constructorimpl(iM225constructorimpl + UInt.m225constructorimpl(it.next().getData() & UShort.MAX_VALUE));
        }
        return iM225constructorimpl;
    }
}
