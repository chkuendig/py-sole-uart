...
public final class ListBuilder<E> extends AbstractMutableList<E> implements List<E>, RandomAccess, KMutableList {
    ...
    public Object[] toArray() {
        E[] eArr = this.array;
        int i = this.offset;
        Object[] objArrCopyOfRange = ArraysKt.copyOfRange(eArr, i, this.length + i);
        Objects.requireNonNull(objArrCopyOfRange, "null cannot be cast to non-null type kotlin.Array<kotlin.Any?>");
