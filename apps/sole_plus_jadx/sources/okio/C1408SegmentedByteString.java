...
public final class C1408SegmentedByteString extends ByteString {
    ...
    public C1408SegmentedByteString(byte[][] segments, int[] directory) {
    ...
    public ByteString substring(int beginIndex, int endIndex) {
        C1408SegmentedByteString c1408SegmentedByteString = this;
        int iResolveDefaultParameter = SegmentedByteString.resolveDefaultParameter(c1408SegmentedByteString, endIndex);
        if (beginIndex < 0) {
        ...
        if (beginIndex == 0 && iResolveDefaultParameter == size()) {
            return c1408SegmentedByteString;
        }
