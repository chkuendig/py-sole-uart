...
public final class BufferKt {
    ...
    public static final int read(Buffer buffer, Function3<? super Memory, ? super Integer, ? super Integer, Integer> block) {
        ...
        int iIntValue = block.invoke(Memory.m8811boximpl(buffer.getMemory()), Integer.valueOf(buffer.getReadPosition()), Integer.valueOf(buffer.getWritePosition())).intValue();
    ...
    public static final int write(Buffer buffer, Function3<? super Memory, ? super Integer, ? super Integer, Integer> block) {
        Intrinsics.checkNotNullParameter(buffer, "<this>");
        Intrinsics.checkNotNullParameter(block, "block");
        int iIntValue = block.invoke(Memory.m8811boximpl(buffer.getMemory()), Integer.valueOf(buffer.getWritePosition()), Integer.valueOf(buffer.getLimit())).intValue();
