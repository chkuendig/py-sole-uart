...
public final class BufferCompatibilityKt {
    ...
    public static final void m8957fillsEu17AQ(Buffer fill, int i, byte b) {
    ...
    public static final void fill(Buffer buffer, int i, byte b) {
        ...
        MemoryJvmKt.m8834fillJT6ljtQ(buffer.getMemory(), buffer.getWritePosition(), i, b);
    ...
    public static final int appendChars(Buffer buffer, CharSequence csq, int i, int i2) {
        Intrinsics.checkNotNullParameter(buffer, "<this>");
        Intrinsics.checkNotNullParameter(csq, "csq");
        int iM9074encodeUTF8lBXzO7A = UTF8Kt.m9074encodeUTF8lBXzO7A(buffer.getMemory(), csq, i, i2, buffer.getWritePosition(), buffer.getLimit());
        int iM9070getCharactersMh2AYeg = EncodeResult.m9070getCharactersMh2AYeg(iM9074encodeUTF8lBXzO7A) & UShort.MAX_VALUE;
        buffer.commitWritten(EncodeResult.m9069getBytesMh2AYeg(iM9074encodeUTF8lBXzO7A) & UShort.MAX_VALUE);
        return i + iM9070getCharactersMh2AYeg;
    }
