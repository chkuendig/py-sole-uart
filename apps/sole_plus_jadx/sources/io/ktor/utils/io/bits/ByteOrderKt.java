...
public final class ByteOrderKt {
    ...
    public static final short m8810reverseByteOrderxj2QHRw(short s) {
        return UShort.m9368constructorimpl(Short.reverseBytes(s));
    }

    /* renamed from: reverseByteOrder-WZ4Q5Ns, reason: not valid java name */
    public static final int m8809reverseByteOrderWZ4Q5Ns(int i) {
        return UInt.m9182constructorimpl(Integer.reverseBytes(i));
    }

    /* renamed from: reverseByteOrder-VKZWuLQ, reason: not valid java name */
    public static final long m8808reverseByteOrderVKZWuLQ(long j) {
        return ULong.m9261constructorimpl(Long.reverseBytes(j));
    }
}
