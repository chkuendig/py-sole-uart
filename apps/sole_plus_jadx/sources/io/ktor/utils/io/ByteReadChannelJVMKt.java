...
public final class ByteReadChannelJVMKt {
    ...
    /* compiled from: ByteReadChannelJVM.kt */
    @Metadata(k = 3, mv = {1, 8, 0}, xi = 48)
    @DebugMetadata(c = "io.ktor.utils.io.ByteReadChannelJVMKt", f = "ByteReadChannelJVM.kt", i = {0, 0}, l = {WinUser.WM_SYSKEYUP}, m = "joinToImplSuspend", n = {"dst", "close"}, s = {"L$0", "Z$0"})
    ...
    */
    public static final java.lang.Object joinToImplSuspend(io.ktor.utils.io.ByteReadChannel r4, io.ktor.utils.io.ByteWriteChannel r5, boolean r6, kotlin.coroutines.Continuation<? super kotlin.Unit> r7) {
        /*
            boolean r0 = r7 instanceof io.ktor.utils.io.ByteReadChannelJVMKt.C12521
            if (r0 == 0) goto L14
            r0 = r7
            io.ktor.utils.io.ByteReadChannelJVMKt$joinToImplSuspend$1 r0 = (io.ktor.utils.io.ByteReadChannelJVMKt.C12521) r0
            int r1 = r0.label
    ...
    /* JADX WARN: Removed duplicated region for block: B:25:0x0090 A[Catch: all -> 0x00f6, TRY_ENTER, TRY_LEAVE, TryCatch #0 {all -> 0x00f6, blocks: (B:37:0x00ec, B:39:0x00f2, B:25:0x0090), top: B:54:0x00ec }] */
    /* JADX WARN: Removed duplicated region for block: B:31:0x00c5 A[Catch: all -> 0x0069, TRY_LEAVE, TryCatch #2 {all -> 0x0069, blocks: (B:13:0x0041, B:29:0x00bc, B:31:0x00c5, B:46:0x0105, B:18:0x0065), top: B:58:0x0027 }] */
