...
final class OutgoingContent$ReadChannelContent$readFrom$1 extends SuspendLambda implements Function2<WriterScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            from = this.this$0.getChannel();
            this.L$0 = writerScope2;
            this.L$1 = from;
            this.label = 1;
            if (from.discard(this.$range.getStart().longValue(), this) == coroutine_suspended) {
        ...
        this.L$1 = null;
        this.label = 2;
        if (ByteReadChannelJVMKt.copyTo(from, writerScope.getChannel(), jLongValue, this) == coroutine_suspended) {
            return coroutine_suspended;
        }
        return Unit.INSTANCE;
    }
