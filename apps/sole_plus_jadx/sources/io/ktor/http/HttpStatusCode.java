...
public final /* data */ class HttpStatusCode implements Comparable<HttpStatusCode> {
    ...
    private static final HttpStatusCode LengthRequired = new HttpStatusCode(DyacoWorkoutDataSource.SPIRIT_CLUB_MOBILE_APP, "Length Required");
    ...
    private static final HttpStatusCode UnsupportedMediaType = new HttpStatusCode(DyacoWorkoutDataSource.SPIRIT_CLUB_MACHINE_CONSOLE, "Unsupported Media Type");
    private static final HttpStatusCode RequestedRangeNotSatisfiable = new HttpStatusCode(TypedValues.CycleType.TYPE_PATH_ROTATE, "Requested Range Not Satisfiable");
    ...
    private static final HttpStatusCode Locked = new HttpStatusCode(TypedValues.CycleType.TYPE_WAVE_PERIOD, "Locked");
    ...
    private static final HttpStatusCode NotImplemented = new HttpStatusCode(TypedValues.PositionType.TYPE_TRANSITION_EASING, "Not Implemented");
