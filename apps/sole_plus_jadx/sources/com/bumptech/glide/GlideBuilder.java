...
public final class GlideBuilder {
    ...
    public GlideBuilder useLifecycleInsteadOfInjectingFragments(boolean z) {
        this.glideExperimentsBuilder.update(new UseLifecycleInsteadOfInjectingFragments(), z);
        return this;
    }
    ...
    Glide build(Context context, List<GlideModule> list, AppGlideModule appGlideModule) {
