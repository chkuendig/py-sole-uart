...
public class SupportRequestManagerFragment extends Fragment {
    ...
    public String toString() {
        return super.toString() + "{parent=" + getParentFragmentUsingHint() + SdkConstants.MANIFEST_PLACEHOLDER_SUFFIX;
    }
    ...
    private class SupportFragmentRequestManagerTreeNode implements RequestManagerTreeNode {
        ...
        public String toString() {
            return super.toString() + "{fragment=" + SupportRequestManagerFragment.this + SdkConstants.MANIFEST_PLACEHOLDER_SUFFIX;
        }
    }
}
