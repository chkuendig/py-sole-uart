...
public class RequestManagerRetriever implements Handler.Callback {
    ...
    public RequestManager get(FragmentActivity fragmentActivity) {
        ...
        if (useLifecycleInsteadOfInjectingFragments()) {
            ...
            return this.lifecycleRequestManagerRetriever.getOrCreate(applicationContext, Glide.get(applicationContext), fragmentActivity.getLifecycle(), fragmentActivity.getSupportFragmentManager(), zIsActivityVisible);
        }
        return supportFragmentGet(fragmentActivity, supportFragmentManager, null, zIsActivityVisible);
    }
