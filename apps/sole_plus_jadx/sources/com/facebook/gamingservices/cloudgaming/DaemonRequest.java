...
public class DaemonRequest {
    ...
    public static void executeAsync(Context context, JSONObject parameters, Callback callback, String type) throws JSONException {
        JSONObject jSONObjectPut;
        try {
            if (parameters == null) {
                jSONObjectPut = new JSONObject().put("type", type);
            } else {
                jSONObjectPut = parameters.put("type", type);
            }
