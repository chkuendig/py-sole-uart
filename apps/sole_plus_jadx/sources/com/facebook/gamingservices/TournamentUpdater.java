...
public final class TournamentUpdater {
    ...
    public final TaskCompletionSource<Boolean> update(String identifier, Number score) {
        ...
        new GraphRequest(currentAccessToken, strStringPlus, bundle, HttpMethod.POST, new GraphRequest.Callback() { // from class: com.facebook.gamingservices.TournamentUpdater$$ExternalSyntheticLambda0
            @Override // com.facebook.GraphRequest.Callback
            public final void onCompleted(GraphResponse graphResponse) {
                TournamentUpdater.m8150update$lambda0(taskCompletionSource, graphResponse);
            }
    ...
    public static final void m8150update$lambda0(TaskCompletionSource task, GraphResponse response) {
