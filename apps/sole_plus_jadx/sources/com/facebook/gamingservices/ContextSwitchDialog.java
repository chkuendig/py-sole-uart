...
public final class ContextSwitchDialog extends FacebookDialogBase<ContextSwitchContent, Result> {
    ...
    public void showImpl(ContextSwitchContent content, Object mode) throws JSONException {
        Intrinsics.checkNotNullParameter(content, "content");
    ...
    private final void showForCloud(ContextSwitchContent content) throws JSONException {
        ...
        DaemonRequest.Callback callback = new DaemonRequest.Callback() { // from class: com.facebook.gamingservices.ContextSwitchDialog$$ExternalSyntheticLambda0
            ...
            public final void onCompleted(GraphResponse graphResponse) {
                ContextSwitchDialog.m8145showForCloud$lambda2(this.f$0, graphResponse);
            }
        };
    ...
    public static final void m8145showForCloud$lambda2(ContextSwitchDialog this$0, GraphResponse response) {
        Unit unit;
    ...
    protected void registerCallbackImpl(CallbackManagerImpl callbackManager, final FacebookCallback<Result> callback) {
        ...
        callbackManager.registerCallback(getRequestCodeField(), new CallbackManagerImpl.Callback() { // from class: com.facebook.gamingservices.ContextSwitchDialog$$ExternalSyntheticLambda1
            ...
            public final boolean onActivityResult(int i, Intent intent) {
                return ContextSwitchDialog.m8144registerCallbackImpl$lambda3(this.f$0, resultProcessor, i, intent);
            }
        });
    }
    ...
    public static final boolean m8144registerCallbackImpl$lambda3(ContextSwitchDialog this$0, ResultProcessor resultProcessor, int i, Intent intent) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    private final class WebHandler extends FacebookDialogBase<ContextSwitchContent, Result>.ModeHandler {
        ...
        public AppCall createAppCall(ContextSwitchContent content) {
            ...
            DialogPresenter.setupAppCallForWebDialog(appCallCreateBaseAppCall, SdkConstants.ATTR_CONTEXT, bundle);
