...
public final class AppEventsLoggerImpl {
    ...
    public final void logEvent(String eventName, double valueToSum, Bundle parameters) {
        ...
        try {
            Double dValueOf = Double.valueOf(valueToSum);
            ActivityLifecycleTracker activityLifecycleTracker = ActivityLifecycleTracker.INSTANCE;
            logEvent(eventName, dValueOf, parameters, false, ActivityLifecycleTracker.getCurrentSessionGuid());
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, this);
        }
    }
    ...
    public final void logPurchase(BigDecimal purchaseAmount, Currency currency, Bundle parameters, boolean isImplicitlyLogged) {
        ...
        try {
            ...
            if (currency != null) {
                ...
                Double dValueOf = Double.valueOf(purchaseAmount.doubleValue());
                ActivityLifecycleTracker activityLifecycleTracker = ActivityLifecycleTracker.INSTANCE;
                logEvent(AppEventsConstants.EVENT_NAME_PURCHASED, dValueOf, bundle, isImplicitlyLogged, ActivityLifecycleTracker.getCurrentSessionGuid());
                INSTANCE.eagerFlush();
                return;
            }
    ...
    public final void logEventImplicitly(String eventName, BigDecimal purchaseAmount, Currency currency, Bundle parameters) {
        ...
        try {
            ...
            Double dValueOf = Double.valueOf(purchaseAmount.doubleValue());
            ActivityLifecycleTracker activityLifecycleTracker = ActivityLifecycleTracker.INSTANCE;
            logEvent(eventName, dValueOf, bundle, true, ActivityLifecycleTracker.getCurrentSessionGuid());
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, this);
        }
    }
    ...
    public static final class Companion {
            ...
            if (FacebookSdk.getAutoLogAppEventsEnabled()) {
                ...
                scheduledThreadPoolExecutorAccess$getBackgroundExecutor$cp.execute(new Runnable() { // from class: com.facebook.appevents.AppEventsLoggerImpl$Companion$$ExternalSyntheticLambda0
                    ...
                    public final void run() throws ClassNotFoundException {
                        AppEventsLoggerImpl.Companion.m8053initializeLib$lambda4(context, appEventsLoggerImpl);
                    }
                });
            }
        }
        ...
        public static final void m8053initializeLib$lambda4(Context context, AppEventsLoggerImpl logger) throws ClassNotFoundException {
            Intrinsics.checkNotNullParameter(context, "$context");
            ...
            synchronized (AppEventsLoggerImpl.access$getStaticLock$cp()) {
                ...
                Runnable runnable = new Runnable() { // from class: com.facebook.appevents.AppEventsLoggerImpl$Companion$$ExternalSyntheticLambda1
                    ...
                    public final void run() throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
                        AppEventsLoggerImpl.Companion.m8054initializeTimersIfNeeded$lambda6();
                    }
                };
                ScheduledThreadPoolExecutor scheduledThreadPoolExecutorAccess$getBackgroundExecutor$cp = AppEventsLoggerImpl.access$getBackgroundExecutor$cp();
                if (scheduledThreadPoolExecutorAccess$getBackgroundExecutor$cp == null) {
        ...
        public static final void m8054initializeTimersIfNeeded$lambda6() throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
                ...
                synchronized (AppEventsLoggerImpl.access$getStaticLock$cp()) {
                    if (AppEventsLoggerImpl.access$getAnonymousAppDeviceGUID$cp() == null) {
                        ...
                        if (AppEventsLoggerImpl.access$getAnonymousAppDeviceGUID$cp() == null) {
                            ...
                            AppEventsLoggerImpl.access$setAnonymousAppDeviceGUID$cp(Intrinsics.stringPlus("XZ", uuidRandomUUID));
