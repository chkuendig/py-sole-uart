...
public enum ConversionsAPIEventName {
    ...
    public static ConversionsAPIEventName[] valuesCustom() {
        ConversionsAPIEventName[] conversionsAPIEventNameArrValuesCustom = values();
        return (ConversionsAPIEventName[]) Arrays.copyOf(conversionsAPIEventNameArrValuesCustom, conversionsAPIEventNameArrValuesCustom.length);
    }
}
