...
public final class AppEventsCAPIManager {
        ...
        try {
            GraphRequest.Callback callback = new GraphRequest.Callback() { // from class: com.facebook.appevents.cloudbridge.AppEventsCAPIManager$$ExternalSyntheticLambda0
                ...
                public final void onCompleted(GraphResponse graphResponse) {
                    AppEventsCAPIManager.m8078enable$lambda0(graphResponse);
                }
            };
            FacebookSdk facebookSdk = FacebookSdk.INSTANCE;
    ...
    public static final void m8078enable$lambda0(GraphResponse response) {
    ...
    public final void getCAPIGSettingsFromGraphResponse$facebook_core_release(GraphResponse response) {
        ...
        if (TAG2 != null) {
            ...
            try {
                ...
                List<String> listConvertJSONArrayToList = Utility.convertJSONArrayToList((JSONArray) obj);
                Utility utility2 = Utility.INSTANCE;
                Map<String, ? extends Object> mapConvertJSONObjectToHashMap = Utility.convertJSONObjectToHashMap(new JSONObject((String) CollectionsKt.firstOrNull((List) listConvertJSONArrayToList)));
