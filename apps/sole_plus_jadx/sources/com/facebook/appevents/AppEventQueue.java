...
public final class AppEventQueue {
    ...
    private static final Runnable flushRunnable = new Runnable() { // from class: com.facebook.appevents.AppEventQueue$$ExternalSyntheticLambda2
        ...
        public final void run() {
            AppEventQueue.m8050flushRunnable$lambda0();
        }
    };
    ...
    public static final void m8050flushRunnable$lambda0() {
    ...
    public static final void persistToDisk() {
        ...
        try {
            singleThreadExecutor.execute(new Runnable() { // from class: com.facebook.appevents.AppEventQueue$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    AppEventQueue.m8052persistToDisk$lambda1();
                }
            });
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, AppEventQueue.class);
    ...
    public static final void m8052persistToDisk$lambda1() {
        if (CrashShieldHandler.isObjectCrashing(AppEventQueue.class)) {
            return;
        }
        try {
    ...
    public static final void flush(final FlushReason reason) {
        ...
        try {
            ...
            singleThreadExecutor.execute(new Runnable() { // from class: com.facebook.appevents.AppEventQueue$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    AppEventQueue.m8049flush$lambda2(reason);
                }
            });
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, AppEventQueue.class);
    ...
    public static final void m8049flush$lambda2(FlushReason reason) {
        if (CrashShieldHandler.isObjectCrashing(AppEventQueue.class)) {
            return;
        }
        try {
    ...
    public static final void add(final AccessTokenAppIdPair accessTokenAppId, final AppEvent appEvent) {
        ...
        try {
            ...
            singleThreadExecutor.execute(new Runnable() { // from class: com.facebook.appevents.AppEventQueue$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    AppEventQueue.m8047add$lambda3(accessTokenAppId, appEvent);
                }
            });
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, AppEventQueue.class);
    ...
    public static final void m8047add$lambda3(AccessTokenAppIdPair accessTokenAppId, AppEvent appEvent) {
        if (CrashShieldHandler.isObjectCrashing(AppEventQueue.class)) {
            return;
        }
        try {
        ...
        try {
            ...
            graphRequestNewPostRequest.setCallback(new GraphRequest.Callback() { // from class: com.facebook.appevents.AppEventQueue$$ExternalSyntheticLambda5
                ...
                public final void onCompleted(GraphResponse graphResponse) {
                    AppEventQueue.m8048buildRequestForSession$lambda4(accessTokenAppId, graphRequestNewPostRequest, appEvents, flushState, graphResponse);
                }
            });
    ...
    public static final void m8048buildRequestForSession$lambda4(AccessTokenAppIdPair accessTokenAppId, GraphRequest postRequest, SessionEventsState appEvents, FlushStatistics flushState, GraphResponse response) {
        if (CrashShieldHandler.isObjectCrashing(AppEventQueue.class)) {
            return;
        }
        try {
        ...
        try {
            ...
            if (flushResult == FlushResult.NO_CONNECTIVITY) {
                ...
                FacebookSdk.getExecutor().execute(new Runnable() { // from class: com.facebook.appevents.AppEventQueue$$ExternalSyntheticLambda4
                    @Override // java.lang.Runnable
                    public final void run() {
                        AppEventQueue.m8051handleResponse$lambda5(accessTokenAppId, appEvents);
                    }
                });
            }
    ...
    public static final void m8051handleResponse$lambda5(AccessTokenAppIdPair accessTokenAppId, SessionEventsState appEvents) {
        if (CrashShieldHandler.isObjectCrashing(AppEventQueue.class)) {
            return;
        }
        try {
