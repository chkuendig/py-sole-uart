...
public final class InAppPurchaseBillingClientWrapper {
        ...
        try {
            ...
            queryPurchaseHistoryAsync(skuType, new Runnable() { // from class: com.facebook.appevents.iap.InAppPurchaseBillingClientWrapper$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    InAppPurchaseBillingClientWrapper.m8100queryPurchaseHistory$lambda0(this.f$0, queryPurchaseHistoryRunnable);
                }
            });
        } catch (Throwable th) {
    ...
    public static final void m8100queryPurchaseHistory$lambda0(InAppPurchaseBillingClientWrapper this$0, Runnable queryPurchaseHistoryRunnable) {
        if (CrashShieldHandler.isObjectCrashing(InAppPurchaseBillingClientWrapper.class)) {
            return;
        }
        try {
    ...
    public final void queryPurchase(String skuType, Runnable querySkuRunnable) {
        ...
        try {
            ...
            Object objInvokeMethod = InAppPurchaseUtils.invokeMethod(this.billingClientClazz, this.queryPurchasesMethod, this.billingClient, IN_APP);
            InAppPurchaseUtils inAppPurchaseUtils2 = InAppPurchaseUtils.INSTANCE;
            Object objInvokeMethod2 = InAppPurchaseUtils.invokeMethod(this.purchaseResultClazz, this.getPurchaseListMethod, objInvokeMethod, new Object[0]);
            List list = objInvokeMethod2 instanceof List ? (List) objInvokeMethod2 : null;
            if (list == null) {
                return;
            }
            try {
                ...
                for (Object obj : list) {
                    ...
                    Object objInvokeMethod3 = InAppPurchaseUtils.invokeMethod(this.purchaseClazz, this.getOriginalJsonMethod, obj, new Object[0]);
    ...
    public static final class Companion {
        ...
        private final Object createBillingClient(Context context, Class<?> billingClientClazz) throws IllegalArgumentException {
            ...
            InAppPurchaseUtils inAppPurchaseUtils7 = InAppPurchaseUtils.INSTANCE;
            Object objInvokeMethod = InAppPurchaseUtils.invokeMethod(billingClientClazz, method, null, context);
            ...
            InAppPurchaseUtils inAppPurchaseUtils8 = InAppPurchaseUtils.INSTANCE;
            Object objInvokeMethod2 = InAppPurchaseUtils.invokeMethod(cls, method3, objInvokeMethod, objNewProxyInstance);
            if (objInvokeMethod2 == null) {
                return null;
            }
            InAppPurchaseUtils inAppPurchaseUtils9 = InAppPurchaseUtils.INSTANCE;
            Object objInvokeMethod3 = InAppPurchaseUtils.invokeMethod(cls, method2, objInvokeMethod2, new Object[0]);
