...
public final class ModelManager {
        ...
        try {
            ...
            Utility.runOnNonUiThread(new Runnable() { // from class: com.facebook.appevents.ml.ModelManager$$ExternalSyntheticLambda2
                ...
                public final void run() {
                    ModelManager.m8108enable$lambda0();
                }
            });
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, ModelManager.class);
    ...
    public static final void m8108enable$lambda0() {
        if (CrashShieldHandler.isObjectCrashing(ModelManager.class)) {
            return;
        }
        try {
                ...
                if (Intrinsics.areEqual(key, Task.MTML_APP_EVENT_PREDICTION.toUseCase())) {
                    ...
                    if (FeatureManager.isEnabled(FeatureManager.Feature.SuggestedEvents) && isLocaleEnglish()) {
                        arrayList.add(value.setOnPostExecute(new Runnable() { // from class: com.facebook.appevents.ml.ModelManager$$ExternalSyntheticLambda0
                            @Override // java.lang.Runnable
                            public final void run() {
                                ModelManager.m8109enableMTML$lambda1();
                            }
                        }));
                    }
                    assetUri = assetUri2;
                ...
                if (Intrinsics.areEqual(key, Task.MTML_INTEGRITY_DETECT.toUseCase())) {
                    ...
                    if (FeatureManager.isEnabled(FeatureManager.Feature.IntelligentIntegrity)) {
                        arrayList.add(value.setOnPostExecute(new Runnable() { // from class: com.facebook.appevents.ml.ModelManager$$ExternalSyntheticLambda1
                            @Override // java.lang.Runnable
                            public final void run() {
                                ModelManager.m8110enableMTML$lambda2();
                            }
                        }));
                    }
                }
    ...
    public static final void m8109enableMTML$lambda1() {
        if (CrashShieldHandler.isObjectCrashing(ModelManager.class)) {
            return;
        }
        try {
    ...
    public static final void m8110enableMTML$lambda2() {
        if (CrashShieldHandler.isObjectCrashing(ModelManager.class)) {
            return;
        }
        try {
    ...
    public static final class TaskHandler {
        ...
        public static final class Companion {
            ...
            public final void execute(TaskHandler master, final List<TaskHandler> slaves) {
                ...
                download(master.getAssetUri(), master.getUseCase() + '_' + master.getVersionId(), new FileDownloadTask.Callback() { // from class: com.facebook.appevents.ml.ModelManager$TaskHandler$Companion$$ExternalSyntheticLambda1
                    ...
                    public final void onComplete(File file) {
                        ModelManager.TaskHandler.Companion.m8112execute$lambda1(slaves, file);
                    }
                });
            }
            ...
            public static final void m8112execute$lambda1(List slaves, File file) {
                Intrinsics.checkNotNullParameter(slaves, "$slaves");
                    ...
                    while (it.hasNext()) {
                        ...
                        TaskHandler.INSTANCE.download(taskHandler.getRuleUri(), taskHandler.getUseCase() + '_' + taskHandler.getVersionId() + "_rule", new FileDownloadTask.Callback() { // from class: com.facebook.appevents.ml.ModelManager$TaskHandler$Companion$$ExternalSyntheticLambda0
                            ...
                            public final void onComplete(File file2) {
                                ModelManager.TaskHandler.Companion.m8113execute$lambda1$lambda0(taskHandler, modelBuild, file2);
                            }
                        });
                    }
                }
            ...
            public static final void m8113execute$lambda1$lambda0(TaskHandler slave, Model model, File file) {
