...
public final class ActivityLifecycleTracker {
        ...
        if (tracking.compareAndSet(false, true)) {
            ...
            FeatureManager.checkFeature(FeatureManager.Feature.CodelessEvents, new FeatureManager.Callback() { // from class: com.facebook.appevents.internal.ActivityLifecycleTracker$$ExternalSyntheticLambda4
                ...
                public final void onCompleted(boolean z) {
                    ActivityLifecycleTracker.m8107startTracking$lambda0(z);
                }
            });
            appId = appId2;
    ...
    public static final void m8107startTracking$lambda0(boolean z) {
        if (z) {
    ...
    public static final void onActivityCreated(Activity activity) {
        singleThreadExecutor.execute(new Runnable() { // from class: com.facebook.appevents.internal.ActivityLifecycleTracker$$ExternalSyntheticLambda3
            ...
            public final void run() {
                ActivityLifecycleTracker.m8103onActivityCreated$lambda1();
            }
        });
    }
    ...
    public static final void m8103onActivityCreated$lambda1() {
    ...
    public static final void onActivityResumed(Activity activity) {
        ...
        singleThreadExecutor.execute(new Runnable() { // from class: com.facebook.appevents.internal.ActivityLifecycleTracker$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                ActivityLifecycleTracker.m8106onActivityResumed$lambda2(jCurrentTimeMillis, activityName, applicationContext);
            }
        });
    }
    ...
    public static final void m8106onActivityResumed$lambda2(long j, String activityName, Context appContext) {
        SessionInfo sessionInfo;
    ...
    public final void onActivityPaused(Activity activity) {
        ...
        singleThreadExecutor.execute(new Runnable() { // from class: com.facebook.appevents.internal.ActivityLifecycleTracker$$ExternalSyntheticLambda1
            ...
            public final void run() throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
                ActivityLifecycleTracker.m8104onActivityPaused$lambda6(jCurrentTimeMillis, activityName);
            }
        });
    }
    ...
    public static final void m8104onActivityPaused$lambda6(final long j, final String activityName) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        Intrinsics.checkNotNullParameter(activityName, "$activityName");
        if (currentSession == null) {
            currentSession = new SessionInfo(Long.valueOf(j), null, null, 4, null);
        }
        ...
        if (foregroundActivityCount.get() <= 0) {
            Runnable runnable = new Runnable() { // from class: com.facebook.appevents.internal.ActivityLifecycleTracker$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    ActivityLifecycleTracker.m8105onActivityPaused$lambda6$lambda4(j, activityName);
                }
            };
    ...
    public static final void m8105onActivityPaused$lambda6$lambda4(long j, String activityName) {
        Intrinsics.checkNotNullParameter(activityName, "$activityName");
        if (currentSession == null) {
            currentSession = new SessionInfo(Long.valueOf(j), null, null, 4, null);
        }
