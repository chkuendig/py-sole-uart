...
public final class CodelessManager {
                ...
                if (Intrinsics.areEqual((Object) (appSettingsWithoutQuery == null ? null : Boolean.valueOf(appSettingsWithoutQuery.getCodelessEventsEnabled())), (Object) true) || INSTANCE.isDebugOnEmulator()) {
                    ...
                    viewIndexingTrigger2.setOnShakeListener(new ViewIndexingTrigger.OnShakeListener() { // from class: com.facebook.appevents.codeless.CodelessManager$$ExternalSyntheticLambda0
                        ...
                        public final void onShake() {
                            CodelessManager.m8087onActivityResumed$lambda0(appSettingsWithoutQuery, applicationId);
                        }
                    });
    ...
    public static final void m8087onActivityResumed$lambda0(FetchedAppSettings fetchedAppSettings, String appId) {
        if (CrashShieldHandler.isObjectCrashing(CodelessManager.class)) {
            return;
        }
        try {
        ...
        try {
            ...
            FacebookSdk.getExecutor().execute(new Runnable() { // from class: com.facebook.appevents.codeless.CodelessManager$$ExternalSyntheticLambda1
                ...
                public final void run() {
                    CodelessManager.m8086checkCodelessSession$lambda1(applicationId);
                }
            });
        } catch (Throwable th) {
    ...
    public static final void m8086checkCodelessSession$lambda1(String str) {
        if (CrashShieldHandler.isObjectCrashing(CodelessManager.class)) {
            return;
        }
        try {
            ...
            boolean z = true;
            String str2 = String.format(Locale.US, "%s/app_indexing_session", Arrays.copyOf(new Object[]{str}, 1));
            Intrinsics.checkNotNullExpressionValue(str2, "java.lang.String.format(locale, format, *args)");
            JSONObject graphObject = companion.newPostRequestWithBundle(null, str2, bundle, null).executeAndWait().getGraphObject();
