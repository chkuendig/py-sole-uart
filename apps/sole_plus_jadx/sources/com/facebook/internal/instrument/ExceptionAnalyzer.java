...
public final class ExceptionAnalyzer {
                ...
                try {
                    ...
                    arrayList.add(companion.newPostRequest(null, str, jSONObject, new GraphRequest.Callback() { // from class: com.facebook.internal.instrument.ExceptionAnalyzer$$ExternalSyntheticLambda0
                        ...
                        public final void onCompleted(GraphResponse graphResponse) {
                            ExceptionAnalyzer.m8185sendExceptionAnalysisReports$lambda1(instrumentDataLoad, graphResponse);
                        }
                    }));
    ...
    public static final void m8185sendExceptionAnalysisReports$lambda1(InstrumentData instrumentData, GraphResponse response) {
