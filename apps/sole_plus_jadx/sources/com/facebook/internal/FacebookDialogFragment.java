...
public final class FacebookDialogFragment extends DialogFragment {
        ...
        if (this.innerDialog == null && (activity = getActivity()) != null) {
            ...
            if (!(methodArgumentsFromIntent != null ? methodArgumentsFromIntent.getBoolean(NativeProtocol.WEB_DIALOG_IS_FALLBACK, false) : false)) {
                ...
                if (Utility.isNullOrEmpty(string)) {
                    ...
                    facebookWebFallbackDialogNewInstance = new WebDialog.Builder(fragmentActivity, string, bundle).setOnCompleteListener(new WebDialog.OnCompleteListener() { // from class: com.facebook.internal.FacebookDialogFragment$$ExternalSyntheticLambda0
                        @Override // com.facebook.internal.WebDialog.OnCompleteListener
                        public final void onComplete(Bundle bundle2, FacebookException facebookException) {
                            FacebookDialogFragment.m8152initDialog$lambda0(this.f$0, bundle2, facebookException);
                        }
                    }).build();
                }
            } else {
                ...
                facebookWebFallbackDialogNewInstance = companion.newInstance(fragmentActivity2, string2, str);
                facebookWebFallbackDialogNewInstance.setOnCompleteListener(new WebDialog.OnCompleteListener() { // from class: com.facebook.internal.FacebookDialogFragment$$ExternalSyntheticLambda1
                    @Override // com.facebook.internal.WebDialog.OnCompleteListener
                    public final void onComplete(Bundle bundle2, FacebookException facebookException) {
                        FacebookDialogFragment.m8153initDialog$lambda1(this.f$0, bundle2, facebookException);
                    }
                });
            }
    ...
    public static final void m8152initDialog$lambda0(FacebookDialogFragment this$0, Bundle bundle, FacebookException facebookException) {
    ...
    public static final void m8153initDialog$lambda1(FacebookDialogFragment this$0, Bundle bundle, FacebookException facebookException) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
