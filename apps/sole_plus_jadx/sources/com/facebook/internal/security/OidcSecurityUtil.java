...
public final class OidcSecurityUtil {
    ...
    public static final String getRawKeyFromEndPoint(final String kid) {
        ...
        FacebookSdk.getExecutor().execute(new Runnable() { // from class: com.facebook.internal.security.OidcSecurityUtil$$ExternalSyntheticLambda0
            ...
            public final void run() throws IOException {
                OidcSecurityUtil.m8202getRawKeyFromEndPoint$lambda1(url, objectRef, kid, reentrantLock, conditionNewCondition);
            }
        });
    ...
    public static final void m8202getRawKeyFromEndPoint$lambda1(URL openIdKeyUrl, Ref.ObjectRef result, String kid, ReentrantLock lock, Condition condition) throws IOException {
