...
public abstract class NativeAppLoginMethodHandler extends LoginMethodHandler {
            ...
            if (!Utility.isNullOrEmpty(extras.getString("code"))) {
                ...
                FacebookSdk.getExecutor().execute(new Runnable() { // from class: com.facebook.login.NativeAppLoginMethodHandler$$ExternalSyntheticLambda0
                    ...
                    public final void run() throws NumberFormatException {
                        NativeAppLoginMethodHandler.m8225processSuccessResponse$lambda0(this.f$0, request, extras);
                    }
                });
                return;
            }
    ...
    public static final void m8225processSuccessResponse$lambda0(NativeAppLoginMethodHandler this$0, LoginClient.Request request, Bundle extras) throws NumberFormatException {
