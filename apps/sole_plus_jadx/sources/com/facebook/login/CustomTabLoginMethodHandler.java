...
public final class CustomTabLoginMethodHandler extends WebLoginMethodHandler {
                        ...
                        if (urlQueryString.containsKey("access_token")) {
                            ...
                            FacebookSdk.getExecutor().execute(new Runnable() { // from class: com.facebook.login.CustomTabLoginMethodHandler$$ExternalSyntheticLambda0
                                ...
                                public final void run() {
                                    CustomTabLoginMethodHandler.m8204onCustomTabComplete$lambda0(this.f$0, request, urlQueryString);
                                }
                            });
                            return;
                        }
    ...
    public static final void m8204onCustomTabComplete$lambda0(CustomTabLoginMethodHandler this$0, LoginClient.Request request, Bundle values) {
