...
public class LoginButton extends FacebookButtonBase {
    ...
    public static final void m8229onAttachedToWindow$lambda0(CallbackManager.ActivityResultParameters activityResultParameters) {
    }
    ...
    jadx.core.utils.exceptions.JadxRuntimeException: Can't remove SSA var: r0v0 com.facebook.login.widget.LoginButton$ToolTipMode, still in use, count: 1, list:
      (r0v0 com.facebook.login.widget.LoginButton$ToolTipMode) from 0x0033: SPUT (r0v0 com.facebook.login.widget.LoginButton$ToolTipMode) (LINE:96) com.facebook.login.widget.LoginButton.ToolTipMode.DEFAULT com.facebook.login.widget.LoginButton$ToolTipMode
            ...
            if (getContext() instanceof ActivityResultRegistryOwner) {
                ...
                this.androidXLoginCaller = ((ActivityResultRegistryOwner) context).getActivityResultRegistry().register("facebook-login", this.loginManagerLazy.getValue().createLogInActivityResultContract(this.callbackManager, this.loggerID), new ActivityResultCallback() { // from class: com.facebook.login.widget.LoginButton$$ExternalSyntheticLambda2
                    ...
                    public final void onActivityResult(Object obj) {
                        LoginButton.m8229onAttachedToWindow$lambda0((CallbackManager.ActivityResultParameters) obj);
                    }
                });
            }
            ...
            if (i == 1) {
                ...
                FacebookSdk.getExecutor().execute(new Runnable() { // from class: com.facebook.login.widget.LoginButton$$ExternalSyntheticLambda1
                    ...
                    public final void run() throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
                        LoginButton.m8227checkToolTipSettings$lambda3(metadataApplicationId, this);
                    }
                });
                return;
            }
    ...
    public static final void m8227checkToolTipSettings$lambda3(String appId, final LoginButton this$0) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        this$0.getActivity().runOnUiThread(new Runnable() { // from class: com.facebook.login.widget.LoginButton$$ExternalSyntheticLambda0
            ...
            public final void run() {
                LoginButton.m8228checkToolTipSettings$lambda3$lambda2(this.f$0, fetchedAppSettingsQueryAppSettings);
            }
        });
    }
    ...
    public static final void m8228checkToolTipSettings$lambda3$lambda2(LoginButton this$0, FetchedAppSettings fetchedAppSettings) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        try {
            ...
            if (string == null) {
                ...
                Intrinsics.checkNotNullExpressionValue(string, "resources.getString(R.string.com_facebook_loginview_log_out_button)");
            }
    ...
    protected class LoginClickListener implements View.OnClickListener {
                ...
                if (this.this$0.confirmLogout) {
                    ...
                    builder.setMessage(string).setCancelable(true).setPositiveButton(string2, new DialogInterface.OnClickListener() { // from class: com.facebook.login.widget.LoginButton$LoginClickListener$$ExternalSyntheticLambda0
                        ...
                        public final void onClick(DialogInterface dialogInterface, int i) {
                            LoginButton.LoginClickListener.m8230performLogout$lambda2(loginManager, dialogInterface, i);
                        }
        ...
        public static final void m8230performLogout$lambda2(LoginManager loginManager, DialogInterface dialogInterface, int i) {
