...
public class DeviceAuthDialog extends DialogFragment {
    ...
    public void startLogin(LoginClient.Request request) {
        ...
        GraphRequest.INSTANCE.newPostRequestWithBundle(null, DEVICE_LOGIN_ENDPOINT, bundle, new GraphRequest.Callback() { // from class: com.facebook.login.DeviceAuthDialog$$ExternalSyntheticLambda6
            ...
            public final void onCompleted(GraphResponse graphResponse) {
                DeviceAuthDialog.m8212startLogin$lambda1(this.f$0, graphResponse);
            }
        }).executeAsync();
    }
    ...
    public static final void m8212startLogin$lambda1(DeviceAuthDialog this$0, GraphResponse response) {
    ...
    public String getApplicationAccessToken() {
        ...
        StringBuilder sbAppend = sb.append(Validate.hasAppID()).append('|');
        Validate validate2 = Validate.INSTANCE;
        return sbAppend.append(Validate.hasClientToken()).toString();
    }
    ...
    protected View initializeContentView(boolean isSmartLogin) {
        ...
        ((Button) viewFindViewById3).setOnClickListener(new View.OnClickListener() { // from class: com.facebook.login.DeviceAuthDialog$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view) {
                DeviceAuthDialog.m8207initializeContentView$lambda2(this.f$0, view);
            }
        });
    ...
    public static final void m8207initializeContentView$lambda2(DeviceAuthDialog this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.onCancel();
    }
        ...
        if (lValueOf != null) {
            this.scheduledPoll = DeviceAuthMethodHandler.INSTANCE.getBackgroundExecutor().schedule(new Runnable() { // from class: com.facebook.login.DeviceAuthDialog$$ExternalSyntheticLambda4
                ...
                public final void run() {
                    DeviceAuthDialog.m8211schedulePoll$lambda3(this.f$0);
                }
    ...
    public static final void m8211schedulePoll$lambda3(DeviceAuthDialog this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.poll();
    }
    ...
    private final GraphRequest getPollRequest() {
        ...
        return GraphRequest.INSTANCE.newPostRequestWithBundle(null, DEVICE_LOGIN_STATUS_ENDPOINT, bundle, new GraphRequest.Callback() { // from class: com.facebook.login.DeviceAuthDialog$$ExternalSyntheticLambda5
            ...
            public final void onCompleted(GraphResponse graphResponse) throws JSONException {
                DeviceAuthDialog.m8206_get_pollRequest_$lambda5(this.f$0, graphResponse);
            }
        });
    }
    ...
    public static final void m8206_get_pollRequest_$lambda5(DeviceAuthDialog this$0, GraphResponse response) throws JSONException {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(response, "response");
    ...
    private final void presentConfirmation(final String userId, final PermissionsLists permissions, final String accessToken, String name, final Date expirationTime, final Date dataAccessExpirationTime) throws Resources.NotFoundException {
        ...
        builder.setMessage(string).setCancelable(true).setNegativeButton(str, new DialogInterface.OnClickListener() { // from class: com.facebook.login.DeviceAuthDialog$$ExternalSyntheticLambda1
            ...
            public final void onClick(DialogInterface dialogInterface, int i) {
                DeviceAuthDialog.m8209presentConfirmation$lambda6(this.f$0, userId, permissions, accessToken, expirationTime, dataAccessExpirationTime, dialogInterface, i);
            }
            ...
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                DeviceAuthDialog.m8210presentConfirmation$lambda8(this.f$0, dialogInterface, i);
            }
        });
        builder.create().show();
    }
    ...
    public static final void m8209presentConfirmation$lambda6(DeviceAuthDialog this$0, String userId, PermissionsLists permissions, String accessToken, Date date, Date date2, DialogInterface dialogInterface, int i) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public static final void m8210presentConfirmation$lambda8(DeviceAuthDialog this$0, DialogInterface dialogInterface, int i) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    private final void onSuccess(final String accessToken, long expiresIn, Long dataAccessExpirationTime) {
        ...
        GraphRequest graphRequestNewGraphPathRequest = GraphRequest.INSTANCE.newGraphPathRequest(new AccessToken(accessToken, FacebookSdk.getApplicationId(), "0", null, null, null, null, date2, null, date, null, 1024, null), TournamentShareDialogURIBuilder.me, new GraphRequest.Callback() { // from class: com.facebook.login.DeviceAuthDialog$$ExternalSyntheticLambda3
            ...
            public final void onCompleted(GraphResponse graphResponse) throws JSONException, Resources.NotFoundException {
                DeviceAuthDialog.m8208onSuccess$lambda10(this.f$0, accessToken, date2, date, graphResponse);
            }
        });
    ...
    public static final void m8208onSuccess$lambda10(DeviceAuthDialog this$0, String accessToken, Date date, Date date2, GraphResponse response) throws JSONException, Resources.NotFoundException {
        ...
        try {
            ...
            if (Intrinsics.areEqual((Object) boolValueOf, (Object) true) && !this$0.isRetry) {
                this$0.isRetry = true;
