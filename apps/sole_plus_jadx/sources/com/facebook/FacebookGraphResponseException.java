...
public final class FacebookGraphResponseException extends FacebookException {
    ...
    public String toString() {
        ...
        if (error != null) {
            sb.append("httpResponseCode: ").append(error.getRequestStatusCode()).append(", facebookErrorCode: ").append(error.getErrorCode()).append(", facebookErrorType: ").append(error.getErrorType()).append(", message: ").append(error.getErrorMessage()).append(SdkConstants.MANIFEST_PLACEHOLDER_SUFFIX);
        }
