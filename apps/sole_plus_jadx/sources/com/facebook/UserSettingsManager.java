...
public final class UserSettingsManager {
                ...
                if (isFetchingCodelessStatus.compareAndSet(false, true)) {
                    ...
                    FacebookSdk.getExecutor().execute(new Runnable() { // from class: com.facebook.UserSettingsManager$$ExternalSyntheticLambda0
                        ...
                        public final void run() {
                            UserSettingsManager.m8040initializeCodelessSetupEnabledAsync$lambda0(jCurrentTimeMillis);
                        }
                    });
                }
            }
    ...
    public static final void m8040initializeCodelessSetupEnabledAsync$lambda0(long j) {
        if (CrashShieldHandler.isObjectCrashing(UserSettingsManager.class)) {
            return;
        }
        try {
            if (advertiserIDCollectionEnabled.m8041getValue()) {
        ...
        try {
            if (isInitialized.get()) {
                ...
                if (FacebookSdk.isInitialized()) {
                    ...
                    Context applicationContext = FacebookSdk.getApplicationContext();
                    int i3 = 0;
                    int i4 = (autoInitEnabled.m8041getValue() ? 1 : 0) | ((autoLogAppEventsEnabledLocally.m8041getValue() ? 1 : 0) << 1) | ((advertiserIDCollectionEnabled.m8041getValue() ? 1 : 0) << 2) | ((monitorEnabled.m8041getValue() ? 1 : 0) << 3);
                    SharedPreferences sharedPreferences = userSettingPref;
                    if (sharedPreferences == null) {
                        Intrinsics.throwUninitializedPropertyAccessException("userSettingPref");
                        throw null;
                    ...
                    if (i5 != i4) {
                        ...
                        if (applicationInfo.metaData != null) {
                            ...
                            while (true) {
                                ...
                                try {
                                    ...
                                    bundle.putInt(IInstrumentationResultParser.StatusKeys.CURRENT, i4);
                            ...
                            bundle2.putInt(IInstrumentationResultParser.StatusKeys.CURRENT, i4);
                        ...
                        bundle22.putInt(IInstrumentationResultParser.StatusKeys.CURRENT, i4);
    ...
    public static final boolean getAutoInitEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return autoInitEnabled.m8041getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
    ...
    private final boolean checkAutoLogAppEventsEnabled() {
        ...
        try {
            ...
            return autoLogAppEventsEnabledLocally.m8041getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, this);
            return false;
        }
    ...
    public static final boolean getAdvertiserIDCollectionEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return advertiserIDCollectionEnabled.m8041getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
    ...
    public static final boolean getCodelessSetupEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return codelessSetupEnabled.m8041getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
    ...
    public static final boolean getMonitorEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return monitorEnabled.m8041getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
    ...
    private static final class UserSetting {
        ...
        public final boolean m8041getValue() {
