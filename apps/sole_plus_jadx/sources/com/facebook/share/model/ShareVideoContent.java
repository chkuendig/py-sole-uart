...
public final class ShareVideoContent extends ShareContent<ShareVideoContent, Builder> implements ShareModel {
    ...
    public ShareVideoContent(Parcel parcel) {
        ...
        if (from$facebook_common_release.getImageUrl() != null || from$facebook_common_release.getBitmap() != null) {
            sharePhotoBuild = from$facebook_common_release.build();
        } else {
            sharePhotoBuild = null;
        }
        this.previewPhoto = sharePhotoBuild;
