...
public final class AuthenticationTokenClaims implements Parcelable {
    ...
    public AuthenticationTokenClaims(String jti, String iss, String aud, String nonce, long j, long j2, String sub, String str, String str2, String str3, String str4, String str5, String str6, Collection<String> collection, String str7, Map<String, Integer> map) {
        this(jti, iss, aud, nonce, j, j2, sub, str, str2, str3, str4, str5, str6, collection, str7, map, null, null, null, null, WinNT.STANDARD_RIGHTS_REQUIRED, null);
        Intrinsics.checkNotNullParameter(jti, "jti");
        Intrinsics.checkNotNullParameter(iss, "iss");
        Intrinsics.checkNotNullParameter(aud, "aud");
        Intrinsics.checkNotNullParameter(nonce, "nonce");
    ...
    public AuthenticationTokenClaims(String encodedClaims, String expectedNonce) throws JSONException {
        ...
        if (jSONArrayOptJSONArray == null) {
            ...
            setUnmodifiableSet = Collections.unmodifiableSet(Utility.jsonArrayToSet(jSONArrayOptJSONArray));
        }
        ...
        if (jSONObjectOptJSONObject == null) {
            ...
            mapUnmodifiableMap = Collections.unmodifiableMap(Utility.convertJSONObjectToHashMap(jSONObjectOptJSONObject));
        }
        this.userAgeRange = mapUnmodifiableMap;
        JSONObject jSONObjectOptJSONObject2 = jSONObject.optJSONObject(JSON_KEY_USER_HOMETOWN);
        if (jSONObjectOptJSONObject2 == null) {
            mapUnmodifiableMap2 = null;
        } else {
            Utility utility3 = Utility.INSTANCE;
            mapUnmodifiableMap2 = Collections.unmodifiableMap(Utility.convertJSONObjectToStringMap(jSONObjectOptJSONObject2));
        }
        this.userHometown = mapUnmodifiableMap2;
        JSONObject jSONObjectOptJSONObject3 = jSONObject.optJSONObject(JSON_KEY_USER_LOCATION);
        if (jSONObjectOptJSONObject3 != null) {
            Utility utility4 = Utility.INSTANCE;
            mapUnmodifiableMap3 = Collections.unmodifiableMap(Utility.convertJSONObjectToStringMap(jSONObjectOptJSONObject3));
        }
        this.userLocation = mapUnmodifiableMap3;
    ...
    public AuthenticationTokenClaims(Parcel parcel) {
        ...
        Validate validate = Validate.INSTANCE;
        this.jti = Validate.notNullOrEmpty(string, JSON_KEY_JIT);
        String string2 = parcel.readString();
        Validate validate2 = Validate.INSTANCE;
        this.iss = Validate.notNullOrEmpty(string2, JSON_KEY_ISS);
        String string3 = parcel.readString();
        Validate validate3 = Validate.INSTANCE;
        this.aud = Validate.notNullOrEmpty(string3, JSON_KEY_AUD);
        String string4 = parcel.readString();
        Validate validate4 = Validate.INSTANCE;
        this.nonce = Validate.notNullOrEmpty(string4, "nonce");
        this.exp = parcel.readLong();
        this.iat = parcel.readLong();
        String string5 = parcel.readString();
        Validate validate5 = Validate.INSTANCE;
        this.sub = Validate.notNullOrEmpty(string5, JSON_KEY_SUB);
    ...
    */
    private final boolean isValidClaims(org.json.JSONObject r7, java.lang.String r8) {
        ...
        L6:
            ...
            return r1
        L18:
            java.lang.String r2 = r7.optString(r0)     // Catch: java.net.MalformedURLException -> Ld4
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r0)     // Catch: java.net.MalformedURLException -> Ld4
            r0 = r2
            java.lang.CharSequence r0 = (java.lang.CharSequence) r0     // Catch: java.net.MalformedURLException -> Ld4
            int r0 = r0.length()     // Catch: java.net.MalformedURLException -> Ld4
            if (r0 != 0) goto L29
            goto L4c
        L29:
            java.net.URL r0 = new java.net.URL     // Catch: java.net.MalformedURLException -> Ld4
            r0.<init>(r2)     // Catch: java.net.MalformedURLException -> Ld4
            java.lang.String r0 = r0.getHost()     // Catch: java.net.MalformedURLException -> Ld4
            java.lang.String r3 = "facebook.com"
            boolean r0 = kotlin.jvm.internal.Intrinsics.areEqual(r0, r3)     // Catch: java.net.MalformedURLException -> Ld4
            if (r0 != 0) goto L4d
            java.net.URL r0 = new java.net.URL     // Catch: java.net.MalformedURLException -> Ld4
            r0.<init>(r2)     // Catch: java.net.MalformedURLException -> Ld4
            java.lang.String r0 = r0.getHost()     // Catch: java.net.MalformedURLException -> Ld4
            java.lang.String r2 = "www.facebook.com"
            boolean r0 = kotlin.jvm.internal.Intrinsics.areEqual(r0, r2)     // Catch: java.net.MalformedURLException -> Ld4
            if (r0 != 0) goto L4d
        L4c:
            return r1
        L4d:
    ...
    public static final class Companion {
        ...
        public final AuthenticationTokenClaims createFromJSONObject$facebook_core_release(JSONObject jsonObject) throws JSONException {
            List<String> listJsonArrayToStringList;
            ...
            Map<String, String> mapConvertJSONObjectToStringMap2 = null;
            if (jSONArrayOptJSONArray == null) {
                listJsonArrayToStringList = null;
            } else {
                Utility utility = Utility.INSTANCE;
                listJsonArrayToStringList = Utility.jsonArrayToStringList(jSONArrayOptJSONArray);
            }
            List<String> list = listJsonArrayToStringList;
            if (jSONObjectOptJSONObject == null) {
                mapConvertJSONObjectToHashMap = null;
            } else {
                Utility utility2 = Utility.INSTANCE;
                mapConvertJSONObjectToHashMap = Utility.convertJSONObjectToHashMap(jSONObjectOptJSONObject);
            }
            if (jSONObjectOptJSONObject2 == null) {
                mapConvertJSONObjectToStringMap = null;
            } else {
                Utility utility3 = Utility.INSTANCE;
