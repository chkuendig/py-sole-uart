...
public class AppLinkData {
    ...
    public static void fetchDeferredAppLinkFromServer(Context context, String applicationId, final CompletionHandler completionHandler) throws JSONException, PackageManager.NameNotFoundException {
        ...
        try {
            ...
            String str = String.format(DEFERRED_APP_LINK_PATH, applicationId);
            AppLinkData appLinkDataCreateFromJson = null;
            try {
                JSONObject graphObject = GraphRequest.newPostRequest(null, str, jSONObject, null).executeAndWait().getGraphObject();
                if (graphObject != null) {
    ...
    private static AppLinkData createFromJson(String jsonString) throws JSONException {
        if (jsonString == null) {
            return null;
        }
        try {
    ...
    private static Bundle toBundle(JSONObject node) throws JSONException {
        ...
        Iterator<String> itKeys = node.keys();
