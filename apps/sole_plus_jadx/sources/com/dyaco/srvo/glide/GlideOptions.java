...
public final class GlideOptions extends RequestOptions implements Cloneable {
    ...
    public static GlideOptions placeholderOf(int id2) {
    ...
    public static GlideOptions errorOf(int id2) {
    ...
    @Override // com.bumptech.glide.request.BaseRequestOptions
    public GlideOptions placeholder(int id2) {
    ...
    @Override // com.bumptech.glide.request.BaseRequestOptions
    public GlideOptions fallback(int id2) {
    ...
    @Override // com.bumptech.glide.request.BaseRequestOptions
    public GlideOptions error(int id2) {
    ...
    @Override // com.bumptech.glide.request.BaseRequestOptions
    /* renamed from: clone */
    public GlideOptions mo8008clone() {
        return (GlideOptions) super.mo8008clone();
    }
