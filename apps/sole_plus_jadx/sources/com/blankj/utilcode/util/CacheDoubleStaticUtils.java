...
public final class CacheDoubleStaticUtils {
    ...
    public static void put(String str, byte[] bArr) throws InterruptedException {
        put(str, bArr, getDefaultCacheDoubleUtils());
    }

    public static void put(String str, byte[] bArr, int i) throws InterruptedException {
    ...
    public static void put(String str, String str2) throws InterruptedException {
        put(str, str2, getDefaultCacheDoubleUtils());
    }

    public static void put(String str, String str2, int i) throws InterruptedException {
    ...
    public static void put(String str, JSONObject jSONObject) throws InterruptedException {
        put(str, jSONObject, getDefaultCacheDoubleUtils());
    }

    public static void put(String str, JSONObject jSONObject, int i) throws InterruptedException {
    ...
    public static void put(String str, JSONArray jSONArray) throws InterruptedException {
        put(str, jSONArray, getDefaultCacheDoubleUtils());
    }

    public static void put(String str, JSONArray jSONArray, int i) throws InterruptedException {
    ...
    public static void put(String str, Bitmap bitmap) throws InterruptedException {
        put(str, bitmap, getDefaultCacheDoubleUtils());
    }

    public static void put(String str, Bitmap bitmap, int i) throws InterruptedException {
    ...
    public static void put(String str, Drawable drawable) throws InterruptedException {
        put(str, drawable, getDefaultCacheDoubleUtils());
    }

    public static void put(String str, Drawable drawable, int i) throws InterruptedException {
    ...
    public static void put(String str, Parcelable parcelable) throws InterruptedException {
        put(str, parcelable, getDefaultCacheDoubleUtils());
    }

    public static void put(String str, Parcelable parcelable, int i) throws InterruptedException {
    ...
    public static void put(String str, Serializable serializable) throws InterruptedException {
        put(str, serializable, getDefaultCacheDoubleUtils());
    }

    public static void put(String str, Serializable serializable, int i) throws InterruptedException {
    ...
    public static void put(String str, byte[] bArr, CacheDoubleUtils cacheDoubleUtils) throws InterruptedException {
        cacheDoubleUtils.put(str, bArr);
    }

    public static void put(String str, byte[] bArr, int i, CacheDoubleUtils cacheDoubleUtils) throws InterruptedException {
    ...
    public static void put(String str, String str2, CacheDoubleUtils cacheDoubleUtils) throws InterruptedException {
        cacheDoubleUtils.put(str, str2);
    }

    public static void put(String str, String str2, int i, CacheDoubleUtils cacheDoubleUtils) throws InterruptedException {
    ...
    public static void put(String str, JSONObject jSONObject, CacheDoubleUtils cacheDoubleUtils) throws InterruptedException {
        cacheDoubleUtils.put(str, jSONObject);
    }

    public static void put(String str, JSONObject jSONObject, int i, CacheDoubleUtils cacheDoubleUtils) throws InterruptedException {
    ...
    public static void put(String str, JSONArray jSONArray, CacheDoubleUtils cacheDoubleUtils) throws InterruptedException {
        cacheDoubleUtils.put(str, jSONArray);
    }

    public static void put(String str, JSONArray jSONArray, int i, CacheDoubleUtils cacheDoubleUtils) throws InterruptedException {
    ...
    public static void put(String str, Bitmap bitmap, CacheDoubleUtils cacheDoubleUtils) throws InterruptedException {
        cacheDoubleUtils.put(str, bitmap);
    }

    public static void put(String str, Bitmap bitmap, int i, CacheDoubleUtils cacheDoubleUtils) throws InterruptedException {
    ...
    public static void put(String str, Drawable drawable, CacheDoubleUtils cacheDoubleUtils) throws InterruptedException {
        cacheDoubleUtils.put(str, drawable);
    }

    public static void put(String str, Drawable drawable, int i, CacheDoubleUtils cacheDoubleUtils) throws InterruptedException {
    ...
    public static void put(String str, Parcelable parcelable, CacheDoubleUtils cacheDoubleUtils) throws InterruptedException {
        cacheDoubleUtils.put(str, parcelable);
    }

    public static void put(String str, Parcelable parcelable, int i, CacheDoubleUtils cacheDoubleUtils) throws InterruptedException {
    ...
    public static void put(String str, Serializable serializable, CacheDoubleUtils cacheDoubleUtils) throws InterruptedException {
        cacheDoubleUtils.put(str, serializable);
    }

    public static void put(String str, Serializable serializable, int i, CacheDoubleUtils cacheDoubleUtils) throws InterruptedException {
