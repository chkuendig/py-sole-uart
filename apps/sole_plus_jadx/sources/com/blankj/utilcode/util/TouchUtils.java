...
public class TouchUtils {
    ...
    public static abstract class OnTouchUtilsListener implements View.OnTouchListener {
        ...
        public boolean onUtilsMove(View view, MotionEvent motionEvent) {
            ...
            boolean zOnMove = onMove(view, this.direction, rawX, rawY, rawX - this.lastX, rawY - this.lastY, rawX - this.downX, rawY - this.downY, motionEvent);
            this.lastX = rawX;
            this.lastY = rawY;
            return zOnMove;
        }
        ...
        public boolean onUtilsStop(View view, MotionEvent motionEvent) {
            ...
            boolean zOnStop = onStop(view, this.direction, rawX, rawY, rawX - this.downX, rawY - this.downY, i, i2, motionEvent);
