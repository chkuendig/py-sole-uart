    ...
    public static class ShadowDrawable extends DrawableWrapper {
        ...
        private void buildShadowCorners() {
            if (this.isCircle) {
                ...
                float f = -fWidth;
                RectF rectF = new RectF(f, f, fWidth, fWidth);
                ...
                float f3 = -rectF2.top;
                if (f3 > 0.0f) {
                    this.mCornerShadowPaint.setShader(new RadialGradient(0.0f, 0.0f, f3, new int[]{0, this.mShadowStartColor, this.mShadowEndColor}, new float[]{0.0f, fWidth / f3, 1.0f}, Shader.TileMode.CLAMP));
                    return;
                }
                return;
            }
