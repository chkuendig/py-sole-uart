...
public final class EncryptUtils {
    ...
    */
    ...
    static byte[] hashTemplate(byte[] bArr, String str) throws NoSuchAlgorithmException {
    ...
    private static byte[] rsaTemplate(byte[] bArr, byte[] bArr2, int i, String str, boolean z) throws InvalidKeySpecException, NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException, NoSuchProviderException {
        ...
        if (bArr != null && bArr.length != 0 && bArr2 != null && bArr2.length != 0) {
            try {
                ...
                cipher.init(z ? 1 : 2, keyGeneratePrivate);
