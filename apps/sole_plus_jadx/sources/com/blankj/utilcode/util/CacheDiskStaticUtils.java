...
public final class CacheDiskStaticUtils {
    ...
    public static void put(String str, byte[] bArr, CacheDiskUtils cacheDiskUtils) throws InterruptedException {
        cacheDiskUtils.put(str, bArr);
    }

    public static void put(String str, byte[] bArr, int i, CacheDiskUtils cacheDiskUtils) throws InterruptedException {
    ...
    public static void put(String str, String str2, CacheDiskUtils cacheDiskUtils) throws InterruptedException {
        cacheDiskUtils.put(str, str2);
    }

    public static void put(String str, String str2, int i, CacheDiskUtils cacheDiskUtils) throws InterruptedException {
    ...
    public static void put(String str, JSONObject jSONObject, CacheDiskUtils cacheDiskUtils) throws InterruptedException {
        cacheDiskUtils.put(str, jSONObject);
    }

    public static void put(String str, JSONObject jSONObject, int i, CacheDiskUtils cacheDiskUtils) throws InterruptedException {
    ...
    public static void put(String str, JSONArray jSONArray, CacheDiskUtils cacheDiskUtils) throws InterruptedException {
        cacheDiskUtils.put(str, jSONArray);
    }

    public static void put(String str, JSONArray jSONArray, int i, CacheDiskUtils cacheDiskUtils) throws InterruptedException {
    ...
    public static void put(String str, Bitmap bitmap, CacheDiskUtils cacheDiskUtils) throws InterruptedException {
        cacheDiskUtils.put(str, bitmap);
    }

    public static void put(String str, Bitmap bitmap, int i, CacheDiskUtils cacheDiskUtils) throws InterruptedException {
    ...
    public static void put(String str, Drawable drawable, CacheDiskUtils cacheDiskUtils) throws InterruptedException {
        cacheDiskUtils.put(str, drawable);
    }

    public static void put(String str, Drawable drawable, int i, CacheDiskUtils cacheDiskUtils) throws InterruptedException {
    ...
    public static void put(String str, Parcelable parcelable, CacheDiskUtils cacheDiskUtils) throws InterruptedException {
        cacheDiskUtils.put(str, parcelable);
    }

    public static void put(String str, Parcelable parcelable, int i, CacheDiskUtils cacheDiskUtils) throws InterruptedException {
    ...
    public static void put(String str, Serializable serializable, CacheDiskUtils cacheDiskUtils) throws InterruptedException {
        cacheDiskUtils.put(str, serializable);
    }

    public static void put(String str, Serializable serializable, int i, CacheDiskUtils cacheDiskUtils) throws InterruptedException {
