...
public final class RomUtils {
    ...
    public static RomInfo getRomInfo() throws Throwable {
    ...
    private static String getRomVersion(String str) throws Throwable {
        String lowerCase;
        if (TextUtils.isEmpty(str)) {
            lowerCase = "";
        } else {
            lowerCase = getSystemProperty(str);
        }
    ...
    private static String getSystemPropertyByStream(String str) throws IOException {
        try {
            ...
            properties.load(new FileInputStream(new File(Environment.getRootDirectory(), SdkConstants.FN_BUILD_PROP)));
    ...
    public static class RomInfo {
        ...
        public String toString() {
            return "RomInfo{name=" + this.name + ", version=" + this.version + SdkConstants.MANIFEST_PLACEHOLDER_SUFFIX;
        }
    }
}
