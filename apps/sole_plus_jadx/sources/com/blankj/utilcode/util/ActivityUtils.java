...
public final class ActivityUtils {
    ...
    public static Activity getActivityByContext(Context context) throws NoSuchFieldException {
        if (context == null) {
            return null;
        }
    ...
    private static Activity getActivityByContextInner(Context context) throws NoSuchFieldException {
        if (context == null) {
            return null;
        }
    ...
    private static Activity getActivityFromDecorContext(Context context) throws NoSuchFieldException {
