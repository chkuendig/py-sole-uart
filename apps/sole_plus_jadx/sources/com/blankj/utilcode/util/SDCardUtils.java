...
public final class SDCardUtils {
    ...
    public static List<SDCardInfo> getSDCardInfo() throws NoSuchMethodException, SecurityException {
    ...
    public static List<String> getMountedSDCardPath() throws NoSuchMethodException, SecurityException {
        ArrayList arrayList = new ArrayList();
    ...
    public static class SDCardInfo {
        ...
        public String toString() {
            return "SDCardInfo {path = " + this.path + ", state = " + this.state + ", isRemovable = " + this.isRemovable + ", totalSize = " + Formatter.formatFileSize(Utils.getApp(), this.totalSize) + ", availableSize = " + Formatter.formatFileSize(Utils.getApp(), this.availableSize) + AbstractJsonLexerKt.END_OBJ;
        }
    }
}
