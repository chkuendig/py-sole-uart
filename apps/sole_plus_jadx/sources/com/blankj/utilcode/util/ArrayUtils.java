...
public class ArrayUtils {
    ...
    private static Object realSubArray(Object obj, int i, int i2) throws NegativeArraySizeException {
        if (obj == null) {
            return null;
        }
        if (i < 0) {
    ...
    public static <T> T[] add(T[] tArr, T t) {
        ...
        return (T[]) ((Object[]) realAddOne(tArr, t, cls));
    }
    ...
    private static Object realAddOne(Object obj, Object obj2, Class cls) throws ArrayIndexOutOfBoundsException, IllegalArgumentException, NegativeArraySizeException {
    ...
    private static Object realAddArr(Object obj, Object obj2) throws NegativeArraySizeException {
    ...
    public static boolean[] add(boolean[] zArr, int i, boolean[] zArr2) throws NegativeArraySizeException {
    ...
    public static char[] add(char[] cArr, int i, char[] cArr2) throws NegativeArraySizeException {
    ...
    public static byte[] add(byte[] bArr, int i, byte[] bArr2) throws NegativeArraySizeException {
    ...
    public static short[] add(short[] sArr, int i, short[] sArr2) throws NegativeArraySizeException {
    ...
    public static int[] add(int[] iArr, int i, int[] iArr2) throws NegativeArraySizeException {
    ...
    public static long[] add(long[] jArr, int i, long[] jArr2) throws NegativeArraySizeException {
    ...
    public static float[] add(float[] fArr, int i, float[] fArr2) throws NegativeArraySizeException {
    ...
    public static double[] add(double[] dArr, int i, double[] dArr2) throws NegativeArraySizeException {
    ...
    private static Object realAddArr(Object obj, int i, Object obj2, Class cls) throws NegativeArraySizeException {
        if (obj == null && obj2 == null) {
            return null;
        }
        int length = getLength(obj);
    ...
    public static <T> T[] add(T[] tArr, int i, T t) {
        ...
        return (T[]) ((Object[]) realAdd(tArr, i, t, componentType));
    }
    ...
    private static Object realAdd(Object obj, int i, Object obj2, Class cls) throws ArrayIndexOutOfBoundsException, IllegalArgumentException, NegativeArraySizeException {
        if (obj == null) {
            if (i != 0) {
