...
public final class DeviceUtils {
    ...
    private static String getUdid(String str, String str2) {
        return str2.equals("") ? str + UUID.randomUUID().toString().replace(SdkConstants.RES_QUALIFIER_SEP, "") : str + UUID.nameUUIDFromBytes(str2.getBytes()).toString().replace(SdkConstants.RES_QUALIFIER_SEP, "");
    }
}
