...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    static class SavedState extends View.BaseSavedState {
        ...
        public String toString() {
            return "MaterialCheckBox.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " CheckedState=" + getCheckedStateString() + SdkConstants.MANIFEST_PLACEHOLDER_SUFFIX;
        }

        private String getCheckedStateString() {
            int i = this.checkedState;
            if (i == 1) {
                return SdkConstants.ATTR_CHECKED;
            }
            if (i == 2) {
                return SdkConstants.ATTR_INDETERMINATE;
            }
            return "unchecked";
        }
    }
