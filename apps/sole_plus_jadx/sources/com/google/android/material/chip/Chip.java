...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable, MaterialCheckable<Chip> {
    ...
    public Chip(Context context, AttributeSet attributeSet, int i) {
        ...
        super.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.google.android.material.chip.Chip$$ExternalSyntheticLambda0
            ...
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                this.f$0.m8433lambda$new$0$comgoogleandroidmaterialchipChip(compoundButton, z);
            }
        });
    }

    /* renamed from: lambda$new$0$com-google-android-material-chip-Chip, reason: not valid java name */
    /* synthetic */ void m8433lambda$new$0$comgoogleandroidmaterialchipChip(CompoundButton compoundButton, boolean z) {
    ...
    private void validateAttributes(AttributeSet attributeSet) {
        ...
        if (attributeSet.getAttributeValue("http://schemas.android.com/apk/res/android", SdkConstants.ATTR_BACKGROUND) != null) {
            Log.w(TAG, "Do not set the background; Chip manages its own background drawable.");
        }
        if (attributeSet.getAttributeValue("http://schemas.android.com/apk/res/android", SdkConstants.ATTR_DRAWABLE_LEFT) != null) {
            throw new UnsupportedOperationException("Please set left drawable using R.attr#chipIcon.");
        }
        if (attributeSet.getAttributeValue("http://schemas.android.com/apk/res/android", SdkConstants.ATTR_DRAWABLE_START) != null) {
            throw new UnsupportedOperationException("Please set start drawable using R.attr#chipIcon.");
        }
        if (attributeSet.getAttributeValue("http://schemas.android.com/apk/res/android", SdkConstants.ATTR_DRAWABLE_END) != null) {
            throw new UnsupportedOperationException("Please set end drawable using R.attr#closeIcon.");
        }
        if (attributeSet.getAttributeValue("http://schemas.android.com/apk/res/android", SdkConstants.ATTR_DRAWABLE_RIGHT) != null) {
            throw new UnsupportedOperationException("Please set end drawable using R.attr#closeIcon.");
        }
