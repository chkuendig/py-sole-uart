...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.AttachedBehavior {
    ...
    static final Property<View, Float> PADDING_START = new Property<View, Float>(Float.class, SdkConstants.ATTR_PADDING_START) { // from class: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.8
        @Override // android.util.Property
        public void set(View view, Float f) {
    ...
    static final Property<View, Float> PADDING_END = new Property<View, Float>(Float.class, SdkConstants.ATTR_PADDING_END) { // from class: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.9
        @Override // android.util.Property
        public void set(View view, Float f) {
    ...
    class ChangeSizeStrategy extends BaseMotionStrategy {
        ...
        public AnimatorSet createAnimator() {
            ...
            if (currentMotionSpec.hasPropertyValues(SdkConstants.ATTR_PADDING_START)) {
                PropertyValuesHolder[] propertyValues3 = currentMotionSpec.getPropertyValues(SdkConstants.ATTR_PADDING_START);
                propertyValues3[0].setFloatValues(ViewCompat.getPaddingStart(ExtendedFloatingActionButton.this), this.size.getPaddingStart());
                currentMotionSpec.setPropertyValues(SdkConstants.ATTR_PADDING_START, propertyValues3);
            }
            if (currentMotionSpec.hasPropertyValues(SdkConstants.ATTR_PADDING_END)) {
                PropertyValuesHolder[] propertyValues4 = currentMotionSpec.getPropertyValues(SdkConstants.ATTR_PADDING_END);
                propertyValues4[0].setFloatValues(ViewCompat.getPaddingEnd(ExtendedFloatingActionButton.this), this.size.getPaddingEnd());
                currentMotionSpec.setPropertyValues(SdkConstants.ATTR_PADDING_END, propertyValues4);
            }
