...
abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    AnimatorSet createAnimator(MotionSpec motionSpec) {
        ...
        if (motionSpec.hasPropertyValues(SdkConstants.ATTR_PADDING_START)) {
            arrayList.add(motionSpec.getAnimator(SdkConstants.ATTR_PADDING_START, this.fab, ExtendedFloatingActionButton.PADDING_START));
        }
        if (motionSpec.hasPropertyValues(SdkConstants.ATTR_PADDING_END)) {
            arrayList.add(motionSpec.getAnimator(SdkConstants.ATTR_PADDING_END, this.fab, ExtendedFloatingActionButton.PADDING_END));
        }
