...
public final class BadgeState {
    ...
    BadgeState(Context context, int i, int i2, int i3, State state) throws XmlPullParserException, Resources.NotFoundException {
        CharSequence string;
        int i4;
        int i5;
        int i6;
    ...
    private TypedArray generateTypedArray(Context context, int i, int i2, int i3) throws XmlPullParserException, Resources.NotFoundException {
