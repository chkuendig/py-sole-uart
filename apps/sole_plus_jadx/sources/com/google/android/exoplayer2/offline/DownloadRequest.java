...
public final class DownloadRequest implements Parcelable {
    ...
    DownloadRequest(Parcel parcel) {
        this.f162id = (String) Util.castNonNull(parcel.readString());
    ...
    public DownloadRequest copyWithKeySetId(byte[] bArr) {
        return new DownloadRequest(this.f162id, this.uri, this.mimeType, this.streamKeys, bArr, this.customCacheKey, this.data);
    }

    public DownloadRequest copyWithMergedRequest(DownloadRequest downloadRequest) {
        List listEmptyList;
        Assertions.checkArgument(this.f162id.equals(downloadRequest.f162id));
        ...
        return new DownloadRequest(this.f162id, downloadRequest.uri, downloadRequest.mimeType, listEmptyList, downloadRequest.keySetId, downloadRequest.customCacheKey, downloadRequest.data);
    }

    public MediaItem toMediaItem() {
        return new MediaItem.Builder().setMediaId(this.f162id).setUri(this.uri).setCustomCacheKey(this.customCacheKey).setMimeType(this.mimeType).setStreamKeys(this.streamKeys).build();
    }

    public String toString() {
        return this.mimeType + ":" + this.f162id;
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        parcel.writeString(this.f162id);
