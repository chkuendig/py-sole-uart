...
public final class Format implements Bundleable {
    ...
    public static final class Builder {
        ...
        public Builder setId(int i) {
            this.f151id = Integer.toString(i);
            return this;
        }
    ...
    public String toString() {
        return "Format(" + this.f150id + ", " + this.label + ", " + this.containerMimeType + ", " + this.sampleMimeType + ", " + this.codecs + ", " + this.bitrate + ", " + this.language + ", [" + this.width + ", " + this.height + ", " + this.frameRate + ", " + this.colorInfo + "], [" + this.channelCount + ", " + this.sampleRate + "])";
    }
    ...
    public static String toLogString(Format format) {
        ...
        sb.append("id=").append(format.f150id).append(", mimeType=").append(format.sampleMimeType);
        if (format.bitrate != -1) {
    ...
    public Bundle toBundle(boolean z) {
        ...
        bundle.putString(FIELD_ID, this.f150id);
