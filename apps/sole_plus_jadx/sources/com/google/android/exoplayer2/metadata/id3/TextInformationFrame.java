...
public final class TextInformationFrame extends Id3Frame {
    ...
    public boolean equals(Object obj) {
        ...
        return Util.areEqual(this.f161id, textInformationFrame.f161id) && Util.areEqual(this.description, textInformationFrame.description) && this.values.equals(textInformationFrame.values);
    }

    public int hashCode() {
        int iHashCode = (527 + this.f161id.hashCode()) * 31;
