...
final class SsaStyle {
    ...
    public static SsaStyle fromStyleLine(String str, Format format) {
        ...
        String[] strArrSplit = TextUtils.split(str.substring("Style:".length()), ",");
    ...
    static final class Format {
        ...
        */
        public static com.google.android.exoplayer2.text.ssa.SsaStyle.Format fromFormatLine(java.lang.String r15) {
            /*
