...
final class ExoPlayerImplInternal implements Handler.Callback, MediaPeriod.Callback, TrackSelector.InvalidationListener, MediaSourceList.MediaSourceListInfoRefreshListener, DefaultMediaClock.PlaybackParametersListener, PlayerMessage.Sender {
    ...
    public synchronized boolean release() {
        if (!this.released && this.playbackLooper.getThread().isAlive()) {
            ...
            waitUninterruptibly(new Supplier() { // from class: com.google.android.exoplayer2.ExoPlayerImplInternal$$ExternalSyntheticLambda1
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    return this.f$0.m8282x37739a9a();
                }
    ...
    /* synthetic */ Boolean m8282x37739a9a() {
    ...
    public boolean handleMessage(Message message) throws Throwable {
        ...
        try {
            ...
            if (e.type == 1 && (readingPeriod = this.queue.getReadingPeriod()) != null) {
                e = e.copyWithMediaPeriodId(readingPeriod.info.f154id);
            }
            if (e.isRecoverable && this.pendingRecoverableRendererError == null) {
                ...
                if (e.type == 1 && this.queue.getPlayingPeriod() != this.queue.getReadingPeriod()) {
                    ...
                    this.playbackInfo = handlePositionDiscontinuity(mediaPeriodHolder.info.f154id, mediaPeriodHolder.info.startPositionUs, mediaPeriodHolder.info.requestedContentPositionUs, mediaPeriodHolder.info.startPositionUs, true, 0);
                }
    ...
    private void handleIoException(IOException iOException, int i) {
        ...
        if (playingPeriod != null) {
            exoPlaybackExceptionCreateForSource = exoPlaybackExceptionCreateForSource.copyWithMediaPeriodId(playingPeriod.info.f154id);
        }
    ...
    private void seekToCurrentPosition(boolean z) throws ExoPlaybackException {
        MediaSource.MediaPeriodId mediaPeriodId = this.queue.getPlayingPeriod().info.f154id;
    ...
    */
    ...
    private long seekToPeriodPosition(MediaSource.MediaPeriodId mediaPeriodId, long j, boolean z, boolean z2) throws ExoPlaybackException {
        ...
        while (next != null && !mediaPeriodId.equals(next.info.f154id)) {
            next = next.getNext();
        }
    ...
    */
        ...
        if (!looper.getThread().isAlive()) {
            ...
            this.clock.createHandler(looper, null).post(new Runnable() { // from class: com.google.android.exoplayer2.ExoPlayerImplInternal$$ExternalSyntheticLambda2
                ...
                public final void run() {
                    this.f$0.m8283xacec0129(playerMessage);
                }
            });
        }
    }
    ...
    /* synthetic */ void m8283xacec0129(PlayerMessage playerMessage) {
        try {
            deliverMessage(playerMessage);
        } catch (ExoPlaybackException e) {
    ...
    */
    ...
    private boolean shouldTransitionToReadyState(boolean z) {
        ...
        MediaPeriodHolder playingPeriod = this.queue.getPlayingPeriod();
        long targetLiveOffsetUs = shouldUseLivePlaybackSpeedControl(this.playbackInfo.timeline, playingPeriod.info.f154id) ? this.livePlaybackSpeedControl.getTargetLiveOffsetUs() : -9223372036854775807L;
        MediaPeriodHolder loadingPeriod = this.queue.getLoadingPeriod();
        return (loadingPeriod.isFullyBuffered() && loadingPeriod.info.isFinal) || (loadingPeriod.info.f154id.isAd() && !loadingPeriod.prepared) || this.loadControl.shouldStartPlayback(this.playbackInfo.timeline, playingPeriod.info.f154id, getTotalBufferedDurationUs(), this.mediaClock.getPlaybackParameters().speed, this.isRebuffering, targetLiveOffsetUs);
    }
    ...
    /* JADX WARN: Not initialized variable reg: 25, insn: 0x0149: MOVE (r5 I:??[long, double]) = (r25 I:??[long, double]), block:B:73:0x0148 */
    ...
    */
    ...
    private void maybeUpdateReadingPeriod() throws ExoPlaybackException {
        ...
        if (readingPeriod.getNext() == null || this.pendingPauseAtEndOfPeriod) {
            ...
            if (readingPeriod.getNext().prepared || this.rendererPositionUs >= readingPeriod.getNext().getStartPositionRendererTime()) {
                ...
                updatePlaybackSpeedSettingsForNewPeriod(this.playbackInfo.timeline, mediaPeriodHolderAdvanceReadingPeriod.info.f154id, this.playbackInfo.timeline, readingPeriod.info.f154id, -9223372036854775807L, false);
    ...
    private void maybeUpdatePlayingPeriod() throws ExoPlaybackException {
        ...
        while (shouldAdvancePlayingPeriod()) {
            ...
            this.playbackInfo = handlePositionDiscontinuity(mediaPeriodHolder.info.f154id, mediaPeriodHolder.info.startPositionUs, mediaPeriodHolder.info.requestedContentPositionUs, mediaPeriodHolder.info.startPositionUs, !(this.playbackInfo.periodId.periodUid.equals(mediaPeriodHolder.info.f154id.periodUid) && this.playbackInfo.periodId.adGroupIndex == -1 && mediaPeriodHolder.info.f154id.adGroupIndex == -1 && this.playbackInfo.periodId.nextAdGroupIndex != mediaPeriodHolder.info.f154id.nextAdGroupIndex), 0);
            resetPendingPauseAtEndOfPeriod();
            updatePlaybackPositions();
            z = true;
        }
    ...
    private void handlePeriodPrepared(MediaPeriod mediaPeriod) throws ExoPlaybackException {
        if (this.queue.isLoading(mediaPeriod)) {
            ...
            updateLoadControlTrackSelection(loadingPeriod.info.f154id, loadingPeriod.getTrackGroups(), loadingPeriod.getTrackSelectorResult());
    ...
    private void handleLoadingMediaPeriodChanged(boolean z) {
        ...
        MediaPeriodHolder loadingPeriod = this.queue.getLoadingPeriod();
        MediaSource.MediaPeriodId mediaPeriodId = loadingPeriod == null ? this.playbackInfo.periodId : loadingPeriod.info.f154id;
