    ...
    private void onMoovContainerAtomRead(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        if (this.trackBundles.size() == 0) {
            while (i < size2) {
                ...
                this.trackBundles.put(track.f158id, new TrackBundle(this.extractorOutput.track(i, track.type), trackSampleTable, getDefaultSampleValues(sparseArray, track.f158id)));
        ...
        while (i < size2) {
            ...
            this.trackBundles.get(track2.f158id).reset(trackSampleTable2, getDefaultSampleValues(sparseArray, track2.f158id));
            i++;
        }
    }
