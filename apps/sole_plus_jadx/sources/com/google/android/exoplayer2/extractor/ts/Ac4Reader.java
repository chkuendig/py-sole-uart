...
public final class Ac4Reader implements ElementaryStreamReader {
    ...
    private void parseHeader() {
        ...
        if (this.format == null || ac4SyncframeInfo.channelCount != this.format.channelCount || ac4SyncframeInfo.sampleRate != this.format.sampleRate || !"audio/ac4".equals(this.format.sampleMimeType)) {
