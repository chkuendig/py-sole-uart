...
public abstract class Timeline implements Bundleable {
    ...
    public static final class Window implements Bundleable {
        ...
        public int hashCode() {
            int iHashCode = (((WinError.ERROR_EXE_CANNOT_MODIFY_SIGNED_BINARY + this.uid.hashCode()) * 31) + this.mediaItem.hashCode()) * 31;
        ...
        public static Window fromBundle(Bundle bundle) {
            ...
            MediaItem mediaItem = bundle2 != null ? (MediaItem) MediaItem.CREATOR.fromBundle(bundle2) : MediaItem.EMPTY;
    ...
    public static final class Period implements Bundleable {
        ...
        public boolean equals(Object obj) {
            ...
            return Util.areEqual(this.f156id, period.f156id) && Util.areEqual(this.uid, period.uid) && this.windowIndex == period.windowIndex && this.durationUs == period.durationUs && this.positionInWindowUs == period.positionInWindowUs && this.isPlaceholder == period.isPlaceholder && Util.areEqual(this.adPlaybackState, period.adPlaybackState);
        }

        public int hashCode() {
            Object obj = this.f156id;
            int iHashCode = (WinError.ERROR_EXE_CANNOT_MODIFY_SIGNED_BINARY + (obj == null ? 0 : obj.hashCode())) * 31;
    ...
    public int hashCode() {
        Window window = new Window();
        Period period = new Period();
        int windowCount = WinError.ERROR_EXE_CANNOT_MODIFY_SIGNED_BINARY + getWindowCount();
        for (int i = 0; i < getWindowCount(); i++) {
    ...
    public final Bundle toBundleWithOneWindowOnly(int i) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
    ...
    public static Timeline fromBundle(Bundle bundle) {
        ImmutableList immutableListFromBundleListRetriever = fromBundleListRetriever(Window.CREATOR, BundleUtil.getBinder(bundle, FIELD_WINDOWS));
        ImmutableList immutableListFromBundleListRetriever2 = fromBundleListRetriever(Period.CREATOR, BundleUtil.getBinder(bundle, FIELD_PERIODS));
    ...
    public static final class RemotableTimeline extends Timeline {
        ...
        public Period getPeriod(int i, Period period, boolean z) {
            ...
            period.set(period2.f156id, period2.uid, period2.windowIndex, period2.durationUs, period2.positionInWindowUs, period2.adPlaybackState, period2.isPlaceholder);
            return period;
        }
