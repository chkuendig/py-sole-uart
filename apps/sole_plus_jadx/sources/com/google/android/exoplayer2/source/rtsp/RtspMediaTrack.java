...
final class RtspMediaTrack {
    ...
    public int hashCode() {
        return ((WinError.ERROR_EXE_CANNOT_MODIFY_SIGNED_BINARY + this.payloadFormat.hashCode()) * 31) + this.uri.hashCode();
    }
    ...
    */
    ...
    private static void processMPEG4FmtpAttribute(Format.Builder builder, ImmutableMap<String, String> immutableMap) {
        ...
        if (str != null) {
            ...
            builder.setWidth(WinError.ERROR_FAIL_RESTART).setHeight(WinError.ERROR_NOT_OWNER);
        }
        String str2 = immutableMap.get(PARAMETER_PROFILE_LEVEL_ID);
