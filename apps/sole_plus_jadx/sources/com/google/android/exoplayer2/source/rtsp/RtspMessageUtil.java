...
final class RtspMessageUtil {
    ...
    public static Uri removeUserInfo(Uri uri) {
        ...
        Assertions.checkArgument(str.contains(SdkConstants.PREFIX_RESOURCE_REF));
        return uri.buildUpon().encodedAuthority(Util.split(str, SdkConstants.PREFIX_RESOURCE_REF)[1]).build();
    }
