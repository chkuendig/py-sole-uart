...
public final class TrackGroup implements Bundleable {
    ...
    public int hashCode() {
        if (this.hashCode == 0) {
            this.hashCode = ((527 + this.f167id.hashCode()) * 31) + Arrays.hashCode(this.formats);
        }
    ...
    public boolean equals(Object obj) {
        ...
        return this.f167id.equals(trackGroup.f167id) && Arrays.equals(this.formats, trackGroup.formats);
    }
    ...
    public Bundle toBundle() {
        ...
        bundle.putString(FIELD_ID, this.f167id);
        return bundle;
    }
