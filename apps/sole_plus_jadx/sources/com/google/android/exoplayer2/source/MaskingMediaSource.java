    ...
    */
    protected void onChildSourceInfoRefreshed(com.google.android.exoplayer2.Timeline r15) {
        ...
        L36:
            ...
            com.google.android.exoplayer2.source.MediaSource$MediaPeriodId r7 = r7.f165id
        ...
        L98:
            ...
            com.google.android.exoplayer2.source.MediaSource$MediaPeriodId r0 = r15.f165id
            com.google.android.exoplayer2.source.MediaSource$MediaPeriodId r15 = r15.f165id
    ...
    private void setPreparePositionOverrideToUnpreparedMaskingPeriod(long j) {
        ...
        int indexOfPeriod = this.timeline.getIndexOfPeriod(maskingMediaPeriod.f165id.periodUid);
        if (indexOfPeriod == -1) {
            return;
        }
