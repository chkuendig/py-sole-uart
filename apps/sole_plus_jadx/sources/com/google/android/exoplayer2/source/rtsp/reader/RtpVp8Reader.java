    ...
    public void consume(ParsableByteArray parsableByteArray, long j, int i, boolean z) {
        ...
        if (validateVp8Descriptor(parsableByteArray, i)) {
            ...
            if (!this.isOutputFormatSet) {
                ...
                int littleEndianUnsignedShort = parsableByteArray.readLittleEndianUnsignedShort() & Advapi32.MAX_VALUE_NAME;
                int littleEndianUnsignedShort2 = parsableByteArray.readLittleEndianUnsignedShort() & Advapi32.MAX_VALUE_NAME;
