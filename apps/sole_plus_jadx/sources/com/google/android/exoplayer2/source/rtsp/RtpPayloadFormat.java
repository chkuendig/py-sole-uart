...
public final class RtpPayloadFormat {
    ...
    public int hashCode() {
        return ((((((((WinError.ERROR_EXE_CANNOT_MODIFY_SIGNED_BINARY + this.rtpPayloadType) * 31) + this.clockRate) * 31) + this.format.hashCode()) * 31) + this.fmtpParameters.hashCode()) * 31) + this.mediaEncoding.hashCode();
    }
}
