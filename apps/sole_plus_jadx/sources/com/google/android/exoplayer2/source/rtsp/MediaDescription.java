...
final class MediaDescription {
    ...
    public static final class RtpMapAttribute {
        ...
        public int hashCode() {
            return ((((((WinError.ERROR_EXE_CANNOT_MODIFY_SIGNED_BINARY + this.payloadType) * 31) + this.mediaEncoding.hashCode()) * 31) + this.clockRate) * 31) + this.encodingParameters;
        }
    }
    ...
    public int hashCode() {
        int iHashCode = (((((((((((((WinError.ERROR_EXE_CANNOT_MODIFY_SIGNED_BINARY + this.mediaType.hashCode()) * 31) + this.port) * 31) + this.transportProtocol.hashCode()) * 31) + this.payloadType) * 31) + this.bitrate) * 31) + this.attributes.hashCode()) * 31) + this.rtpMapAttribute.hashCode()) * 31;
