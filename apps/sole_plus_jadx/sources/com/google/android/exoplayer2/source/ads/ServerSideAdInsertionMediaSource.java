...
public final class ServerSideAdInsertionMediaSource extends BaseMediaSource implements MediaSource.MediaSourceCaller, MediaSourceEventListener, DrmSessionEventListener {
            ...
            if (handler == null) {
                ...
                handler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.ads.ServerSideAdInsertionMediaSource$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        this.f$0.m8370x4663d317(immutableMap, timeline);
                    }
                });
            }
        }
    ...
    /* synthetic */ void m8370x4663d317(ImmutableMap immutableMap, Timeline timeline) {
            ...
            loop0: while (true) {
                ...
                if (exoTrackSelection != null) {
                    ...
                    for (int i2 = 0; i2 < trackGroup.length; i2++) {
                        ...
                        if (format.equals(mediaLoadData.trackFormat) || (z && format.f150id != null && format.f150id.equals(mediaLoadData.trackFormat.f150id))) {
                            break loop0;
                        }
                    }
                }
    ...
    private static final class ServerSideAdInsertionTimeline extends ForwardingTimeline {
        ...
        public Timeline.Period getPeriod(int i, Timeline.Period period, boolean z) {
            ...
            period.set(period.f156id, period.uid, period.windowIndex, j2, mediaPeriodPositionUsForContent2, adPlaybackState, period.isPlaceholder);
            return period;
        }
    }
