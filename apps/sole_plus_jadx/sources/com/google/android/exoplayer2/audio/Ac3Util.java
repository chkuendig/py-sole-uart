...
public final class Ac3Util {
    ...
    private static final int[] BITRATE_BY_HALF_FRMSIZECOD = {32, 40, 48, 56, 64, 80, 96, 112, 128, 160, 192, 224, 256, 320, 384, Fcntl.S_IRWXU, 512, WinError.ERROR_PAGEFILE_CREATE_FAILED, WinError.ERROR_MULTIPLE_FAULT_VIOLATION};
    private static final int[] SYNCFRAME_SIZE_WORDS_BY_HALF_FRMSIZECOD_44_1 = {69, 87, 104, 121, 139, 174, WinError.ERROR_META_EXPANSION_TOO_LONG, 243, WinError.ERROR_INVALID_EA_HANDLE, 348, 417, WinError.ERROR_INVALID_ADDRESS, WinError.ERROR_UNEXPECTED_MM_MAP_ERROR, WinError.ERROR_DBG_CONTROL_BREAK, 835, 975, WinError.ERROR_DLL_INIT_FAILED, WinError.ERROR_BAD_USER_PROFILE, WinError.ERROR_DISK_CORRUPT};
    ...
    */
    ...
    public static SyncFrameInfo parseAc3SyncframeInfo(ParsableBitArray parsableBitArray) {
        ...
        if (z) {
            ...
            String str3 = bits8 == 3 ? null : "audio/ac3";
