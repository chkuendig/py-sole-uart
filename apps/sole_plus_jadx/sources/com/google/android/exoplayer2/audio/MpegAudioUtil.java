...
public final class MpegAudioUtil {
    ...
    private static final int[] BITRATE_V1_L1 = {32000, 64000, 96000, WinBase.CBR_128000, 160000, 192000, 224000, 256000, 288000, 320000, 352000, 384000, 416000, 448000};
    private static final int[] BITRATE_V2_L1 = {32000, 48000, WinBase.CBR_56000, 64000, 80000, 96000, 112000, WinBase.CBR_128000, 144000, 160000, 176000, 192000, 224000, 256000};
    private static final int[] BITRATE_V1_L2 = {32000, 48000, WinBase.CBR_56000, 64000, 80000, 96000, 112000, WinBase.CBR_128000, 160000, 192000, 224000, 256000, 320000, 384000};
    private static final int[] BITRATE_V1_L3 = {32000, 40000, 48000, WinBase.CBR_56000, 64000, 80000, 96000, 112000, WinBase.CBR_128000, 160000, 192000, 224000, 256000, 320000};
    private static final int[] BITRATE_V2 = {8000, 16000, 24000, 32000, 40000, 48000, WinBase.CBR_56000, 64000, 80000, 96000, 112000, WinBase.CBR_128000, 144000, 160000};
    ...
    public static int getFrameSizeInSamples(int i, int i2) {
        if (i2 == 1) {
            if (i == 3) {
                return WinError.ERROR_SINGLE_INSTANCE_APP;
            }
            return 576;
        }
        if (i2 == 2) {
