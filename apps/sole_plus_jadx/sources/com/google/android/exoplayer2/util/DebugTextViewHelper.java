...
public class DebugTextViewHelper {
    ...
    protected String getVideoString() {
        ...
        return "\n" + videoFormat.sampleMimeType + "(id:" + videoFormat.f150id + " r:" + videoFormat.width + "x" + videoFormat.height + getColorInfoString(videoFormat.colorInfo) + getPixelAspectRatioString(videoFormat.pixelWidthHeightRatio) + getDecoderCountersBufferCountString(videoDecoderCounters) + " vfpo: " + getVideoFrameProcessingOffsetAverageString(videoDecoderCounters.totalVideoFrameProcessingOffsetUs, videoDecoderCounters.videoFrameProcessingOffsetCount) + ")";
    }
    ...
    protected String getAudioString() {
        ...
        return "\n" + audioFormat.sampleMimeType + "(id:" + audioFormat.f150id + " hz:" + audioFormat.sampleRate + " ch:" + audioFormat.channelCount + getDecoderCountersBufferCountString(audioDecoderCounters) + ")";
    }
