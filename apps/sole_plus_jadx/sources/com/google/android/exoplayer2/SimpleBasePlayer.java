...
public abstract class SimpleBasePlayer extends BasePlayer {
    ...
    static /* synthetic */ ListenableFuture lambda$handleReplaceMediaItems$30(ListenableFuture listenableFuture, Object obj) throws Exception {
    ...
    protected static final class State {
        ...
        public int hashCode() {
            int iHashCode = (((((((((WinError.ERROR_EXE_CANNOT_MODIFY_SIGNED_BINARY + this.availableCommands.hashCode()) * 31) + (this.playWhenReady ? 1 : 0)) * 31) + this.playWhenReadyChangeReason) * 31) + this.playbackState) * 31) + this.playbackSuppressionReason) * 31;
    ...
    protected static final class MediaItemData {
        ...
        public int hashCode() {
            int iHashCode = (((((WinError.ERROR_EXE_CANNOT_MODIFY_SIGNED_BINARY + this.uid.hashCode()) * 31) + this.tracks.hashCode()) * 31) + this.mediaItem.hashCode()) * 31;
            MediaMetadata mediaMetadata = this.mediaMetadata;
    ...
    protected static final class PeriodData {
        ...
        public int hashCode() {
            int iHashCode = (WinError.ERROR_EXE_CANNOT_MODIFY_SIGNED_BINARY + this.uid.hashCode()) * 31;
    ...
    protected SimpleBasePlayer(Looper looper, Clock clock) {
        ...
        this.listeners = new ListenerSet<>(looper, clock, new ListenerSet.IterationFinishedEvent() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda58
            ...
            public final void invoke(Object obj, FlagSet flagSet) {
                this.f$0.m8305lambda$new$0$comgoogleandroidexoplayer2SimpleBasePlayer((Player.Listener) obj, flagSet);
            }
        });
    }

    /* renamed from: lambda$new$0$com-google-android-exoplayer2-SimpleBasePlayer, reason: not valid java name */
    /* synthetic */ void m8305lambda$new$0$comgoogleandroidexoplayer2SimpleBasePlayer(Player.Listener listener, FlagSet flagSet) {
    ...
    public final void setPlayWhenReady(final boolean z) {
        ...
        if (shouldHandleCommand(1)) {
            updateStateForPendingOperation(handleSetPlayWhenReady(z), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda30
    ...
    private void setMediaItemsInternal(final List<MediaItem> list, final int i, final long j) {
        ...
        if (shouldHandleCommand(20) || (list.size() == 1 && shouldHandleCommand(31))) {
            updateStateForPendingOperation(handleSetMediaItems(list, i, j), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda53
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    return this.f$0.m8308xb80ed5ee(list, state, i, j);
                }
            });
        }
    }
    ...
    /* synthetic */ State m8308xb80ed5ee(List list, State state, int i, long j) {
    ...
    public final void addMediaItems(int i, final List<MediaItem> list) {
        ...
        updateStateForPendingOperation(handleAddMediaItems(iMin, list), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda0
            @Override // com.google.common.base.Supplier
            public final Object get() {
                return this.f$0.m8303xc134386b(state, list, iMin);
            }
        });
    }

    /* renamed from: lambda$addMediaItems$3$com-google-android-exoplayer2-SimpleBasePlayer, reason: not valid java name */
    /* synthetic */ State m8303xc134386b(State state, List list, int i) {
    ...
    public final void moveMediaItems(final int i, int i2, int i3) {
        ...
        updateStateForPendingOperation(handleMoveMediaItems(i, iMin, iMin2), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda57
            @Override // com.google.common.base.Supplier
            public final Object get() {
                return this.f$0.m8304xfea097c0(state, i, iMin, iMin2);
            }
        });
    }

    /* renamed from: lambda$moveMediaItems$4$com-google-android-exoplayer2-SimpleBasePlayer, reason: not valid java name */
    /* synthetic */ State m8304xfea097c0(State state, int i, int i2, int i3) {
        ArrayList arrayList = new ArrayList(state.playlist);
    ...
    public final void replaceMediaItems(final int i, int i2, final List<MediaItem> list) {
        ...
        final int iMin = Math.min(i2, size);
        updateStateForPendingOperation(handleReplaceMediaItems(i, iMin, list), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda59
            @Override // com.google.common.base.Supplier
            public final Object get() {
                return this.f$0.m8307xfb3793b6(state, list, iMin, i);
            }
        });
    }

    /* renamed from: lambda$replaceMediaItems$5$com-google-android-exoplayer2-SimpleBasePlayer, reason: not valid java name */
    /* synthetic */ State m8307xfb3793b6(State state, List list, int i, int i2) {
    ...
    public final void removeMediaItems(final int i, int i2) {
        ...
        updateStateForPendingOperation(handleRemoveMediaItems(i, iMin), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda50
            @Override // com.google.common.base.Supplier
            public final Object get() {
                return this.f$0.m8306x52962b(state, i, iMin);
            }
        });
    }

    /* renamed from: lambda$removeMediaItems$6$com-google-android-exoplayer2-SimpleBasePlayer, reason: not valid java name */
    /* synthetic */ State m8306x52962b(State state, int i, int i2) {
        ArrayList arrayList = new ArrayList(state.playlist);
    ...
    public final void prepare() {
        ...
        if (shouldHandleCommand(2)) {
            updateStateForPendingOperation(handlePrepare(), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda39
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void setRepeatMode(final int i) {
        ...
        if (shouldHandleCommand(15)) {
            updateStateForPendingOperation(handleSetRepeatMode(i), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda37
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void setShuffleModeEnabled(final boolean z) {
        ...
        if (shouldHandleCommand(14)) {
            updateStateForPendingOperation(handleSetShuffleModeEnabled(z), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda32
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void seekTo(final int i, final long j, int i2, boolean z) {
        ...
        if (state.playlist.isEmpty() || i < state.playlist.size()) {
            updateStateForPendingOperation(handleSeek(i, j, i2), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda44
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    SimpleBasePlayer.State state2 = state;
    ...
    public final void setPlaybackParameters(final PlaybackParameters playbackParameters) {
        ...
        if (shouldHandleCommand(13)) {
            updateStateForPendingOperation(handleSetPlaybackParameters(playbackParameters), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda55
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void stop() {
        ...
        if (shouldHandleCommand(3)) {
            updateStateForPendingOperation(handleStop(), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda38
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    SimpleBasePlayer.State state2 = state;
    ...
    public final void release() {
        ...
        if (shouldHandleCommand(32)) {
            updateStateForPendingOperation(handleRelease(), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda31
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void setTrackSelectionParameters(final TrackSelectionParameters trackSelectionParameters) {
        ...
        if (shouldHandleCommand(29)) {
            updateStateForPendingOperation(handleSetTrackSelectionParameters(trackSelectionParameters), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda56
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void setPlaylistMetadata(final MediaMetadata mediaMetadata) {
        ...
        if (shouldHandleCommand(19)) {
            updateStateForPendingOperation(handleSetPlaylistMetadata(mediaMetadata), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda49
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void setVolume(final float f) {
        ...
        if (shouldHandleCommand(24)) {
            updateStateForPendingOperation(handleSetVolume(f), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda34
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void setVideoSurface(Surface surface) {
        ...
        if (shouldHandleCommand(27)) {
            if (surface == null) {
                ...
                updateStateForPendingOperation(handleSetVideoOutput(surface), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda35
                    @Override // com.google.common.base.Supplier
                    public final Object get() {
    ...
    public final void setVideoSurfaceHolder(final SurfaceHolder surfaceHolder) {
        ...
        if (shouldHandleCommand(27)) {
            if (surfaceHolder == null) {
                ...
                updateStateForPendingOperation(handleSetVideoOutput(surfaceHolder), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda52
                    @Override // com.google.common.base.Supplier
                    public final Object get() {
    ...
    public final void setVideoSurfaceView(final SurfaceView surfaceView) {
        ...
        if (shouldHandleCommand(27)) {
            if (surfaceView == null) {
                ...
                updateStateForPendingOperation(handleSetVideoOutput(surfaceView), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda21
                    @Override // com.google.common.base.Supplier
                    public final Object get() {
    ...
    public final void setVideoTextureView(TextureView textureView) {
        ...
        if (shouldHandleCommand(27)) {
            ...
            updateStateForPendingOperation(handleSetVideoOutput(textureView), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda54
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    private void clearVideoOutput(Object obj) {
        ...
        final State state = this.state;
        if (shouldHandleCommand(27)) {
            updateStateForPendingOperation(handleClearVideoOutput(obj), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda47
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void setDeviceVolume(final int i) {
        ...
        if (shouldHandleCommand(25)) {
            updateStateForPendingOperation(handleSetDeviceVolume(i, 1), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda43
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void setDeviceVolume(final int i, int i2) {
        ...
        if (shouldHandleCommand(33)) {
            updateStateForPendingOperation(handleSetDeviceVolume(i, i2), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda45
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    return state.buildUpon().setDeviceVolume(i).build();
                }
    ...
    public final void increaseDeviceVolume() {
        ...
        if (shouldHandleCommand(26)) {
            updateStateForPendingOperation(handleIncreaseDeviceVolume(1), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda11
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    SimpleBasePlayer.State state2 = state;
    ...
    public final void increaseDeviceVolume(int i) {
        ...
        if (shouldHandleCommand(34)) {
            updateStateForPendingOperation(handleIncreaseDeviceVolume(i), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda36
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    SimpleBasePlayer.State state2 = state;
                    return state2.buildUpon().setDeviceVolume(state2.deviceVolume + 1).build();
    ...
    public final void decreaseDeviceVolume() {
        ...
        final State state = this.state;
        if (shouldHandleCommand(26)) {
            updateStateForPendingOperation(handleDecreaseDeviceVolume(1), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda40
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void decreaseDeviceVolume(int i) {
        ...
        final State state = this.state;
        if (shouldHandleCommand(34)) {
            updateStateForPendingOperation(handleDecreaseDeviceVolume(i), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda33
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    return state.buildUpon().setDeviceVolume(Math.max(0, r0.deviceVolume - 1)).build();
                }
    ...
    public final void setDeviceMuted(final boolean z) {
        ...
        final State state = this.state;
        if (shouldHandleCommand(26)) {
            updateStateForPendingOperation(handleSetDeviceMuted(z, 1), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda46
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void setDeviceMuted(final boolean z, int i) {
        ...
        final State state = this.state;
        if (shouldHandleCommand(34)) {
            updateStateForPendingOperation(handleSetDeviceMuted(z, i), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda51
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    return state.buildUpon().setIsDeviceMuted(z).build();
                }
    ...
    protected ListenableFuture<?> handleReplaceMediaItems(int i, int i2, List<MediaItem> list) {
        ...
        return Util.transformFutureAsync(listenableFutureHandleAddMediaItems, new AsyncFunction() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda48
            @Override // com.google.common.util.concurrent.AsyncFunction
            public final ListenableFuture apply(Object obj) {
                return SimpleBasePlayer.lambda$handleReplaceMediaItems$30(listenableFutureHandleRemoveMediaItems, obj);
            }
        });
    }
    ...
    private void updateStateAndInformListeners(final State state, boolean z, boolean z2) {
        ...
        if (!state2.timedMetadata.equals(state.timedMetadata) && state.timedMetadata.presentationTimeUs != -9223372036854775807L) {
            this.listeners.queueEvent(28, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda19
                @Override // com.google.android.exoplayer2.util.ListenerSet.Event
                public final void invoke(Object obj) {
    ...
    private void updateStateForPendingOperation(final ListenableFuture<?> listenableFuture, Supplier<State> supplier, boolean z, boolean z2) {
        ...
        listenableFuture.addListener(new Runnable() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda41
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m8309xa88ecfc9(listenableFuture);
            }
    ...
    /* renamed from: lambda$updateStateForPendingOperation$61$com-google-android-exoplayer2-SimpleBasePlayer, reason: not valid java name */
    /* synthetic */ void m8309xa88ecfc9(ListenableFuture listenableFuture) {
