...
final class AutoValue_ExperimentIds extends ExperimentIds {
    ...
    public String toString() {
        return "ExperimentIds{clearBlob=" + Arrays.toString(this.clearBlob) + ", encryptedBlob=" + Arrays.toString(this.encryptedBlob) + SdkConstants.MANIFEST_PLACEHOLDER_SUFFIX;
    }
