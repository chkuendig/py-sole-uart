...
final class AutoValue_SendRequest extends SendRequest {
    ...
    public String toString() {
        return "SendRequest{transportContext=" + this.transportContext + ", transportName=" + this.transportName + ", event=" + this.event + ", transformer=" + this.transformer + ", encoding=" + this.encoding + SdkConstants.MANIFEST_PLACEHOLDER_SUFFIX;
    }
