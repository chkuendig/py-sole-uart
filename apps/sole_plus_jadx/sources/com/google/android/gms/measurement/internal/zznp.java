    ...
    */
    final long zza(android.content.Context r7, java.lang.String r8) throws java.lang.IllegalStateException, java.security.NoSuchAlgorithmException {
        ...
        L77:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.zznp.zza(android.content.Context, java.lang.String):long");
    }
    ...
    final Bundle zza(String str, String str2, Bundle bundle, List<String> list, boolean z) {
        ...
        for (String str3 : new TreeSet(bundle.keySet())) {
            if (list == null || !list.contains(str3)) {
                iZzl = !z ? zznpVar.zzl(str3) : 0;
                if (iZzl == 0) {
                    iZzl = zznpVar.zzk(str3);
                }
            } else {
                iZzl = 0;
            }
    ...
    public final void zza(com.google.android.gms.internal.measurement.zzdg zzdgVar, boolean z) throws IllegalStateException {
        Bundle bundle = new Bundle();
        bundle.putBoolean(SdkConstants.FD_RES_CLASS, z);
        try {
            zzdgVar.zza(bundle);
    ...
    public final void zza(com.google.android.gms.internal.measurement.zzdg zzdgVar, ArrayList<Bundle> arrayList) throws IllegalStateException {
        Bundle bundle = new Bundle();
        bundle.putParcelableArrayList(SdkConstants.FD_RES_CLASS, arrayList);
        try {
            zzdgVar.zza(bundle);
        } catch (RemoteException e) {
    ...
    public final void zza(com.google.android.gms.internal.measurement.zzdg zzdgVar, byte[] bArr) throws IllegalStateException {
        Bundle bundle = new Bundle();
        bundle.putByteArray(SdkConstants.FD_RES_CLASS, bArr);
        try {
            zzdgVar.zza(bundle);
        } catch (RemoteException e) {
    ...
    public final void zza(com.google.android.gms.internal.measurement.zzdg zzdgVar, int i) throws IllegalStateException {
        Bundle bundle = new Bundle();
        bundle.putInt(SdkConstants.FD_RES_CLASS, i);
        try {
            zzdgVar.zza(bundle);
        } catch (RemoteException e) {
    ...
    public final void zza(com.google.android.gms.internal.measurement.zzdg zzdgVar, long j) throws IllegalStateException {
        Bundle bundle = new Bundle();
        bundle.putLong(SdkConstants.FD_RES_CLASS, j);
        try {
            zzdgVar.zza(bundle);
        } catch (RemoteException e) {
    ...
    public final void zza(com.google.android.gms.internal.measurement.zzdg zzdgVar, String str) throws IllegalStateException {
        Bundle bundle = new Bundle();
        bundle.putString(SdkConstants.FD_RES_CLASS, str);
        try {
            zzdgVar.zza(bundle);
        } catch (RemoteException e) {
    ...
    */
    private final boolean zzy() throws java.lang.IllegalStateException {
        ...
        L5f:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.zznp.zzy():boolean");
    }
    ...
    final boolean zza(String str, double d) throws IllegalStateException {
        try {
            ...
            editorEdit.putLong(SDKConstants.PARAM_DEBUG_MESSAGE_TIMESTAMP, Double.doubleToRawLongBits(d));
