...
public class zzhj implements zzil {
    ...
    final /* synthetic */ void zza(String str, int i, Throwable th, byte[] bArr, Map map) throws IllegalStateException {
        ...
        try {
            ...
            double dOptDouble = jSONObject.optDouble(SDKConstants.PARAM_DEBUG_MESSAGE_TIMESTAMP, AudioStats.AUDIO_AMPLITUDE_NONE);
    ...
    */
    protected final void zza(com.google.android.gms.internal.measurement.zzdo r13) throws java.lang.IllegalStateException {
        /*
    ...
    public final boolean zzah() throws IllegalStateException {
        ...
        if (!zzkxVarZzr.zzao() || zzkxVarZzr.zzq().zzg() >= 234200) {
            ...
            sb.append("&dma=").append(zzavVarZza.zzd() == Boolean.FALSE ? 0 : 1);
            if (!TextUtils.isEmpty(zzavVarZza.zze())) {
                sb.append("&dma_cps=").append(zzavVarZza.zze());
            }
