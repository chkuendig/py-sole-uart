...
final class zzkn extends zzmx {
    ...
    public final byte[] zza(zzbd zzbdVar, String str) throws IllegalStateException {
        ...
        try {
            ...
            if (zzgVarZze.zze() != SieveCacheKt.NodeMetaAndPreviousMask) {
            ...
            zzfn.zzo[] zzoVarArr = new zzfn.zzo[listZzk.size()];
            ...
            zzaVar2.zza(zzaVarZza).zza(zzfn.zzl.zza().zza(zzfn.zzg.zza().zza(zzazVarZza.zzc).zza(zzbdVar.zza)));
