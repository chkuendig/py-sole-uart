...
public final class zzb extends zzf {
    ...
    static /* synthetic */ void zzb(zzb zzbVar, String str, long j) throws IllegalStateException {
        ...
        Integer num = zzbVar.zzb.get(str);
        if (num != null) {
            zzkp zzkpVarZza = zzbVar.zzn().zza(false);
            ...
            if (iIntValue == 0) {
                ...
                if (l == null) {
                    ...
                    zzbVar.zza(str, jLongValue, zzkpVarZza);
                }
                if (zzbVar.zzb.isEmpty()) {
                    long j2 = zzbVar.zzc;
                    if (j2 == 0) {
    ...
    private final void zza(long j, zzkp zzkpVar) throws IllegalStateException {
        if (zzkpVar == null) {
    ...
    private final void zza(String str, long j, zzkp zzkpVar) throws IllegalStateException {
        if (zzkpVar == null) {
    ...
    public final void zza(long j) {
        zzkp zzkpVarZza = zzn().zza(false);
        for (String str : this.zza.keySet()) {
            zza(str, j - this.zza.get(str).longValue(), zzkpVarZza);
        }
        if (!this.zza.isEmpty()) {
            zza(j - this.zzc, zzkpVarZza);
        }
        zzb(j);
    }
