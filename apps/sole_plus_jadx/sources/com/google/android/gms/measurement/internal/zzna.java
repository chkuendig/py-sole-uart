...
public final class zzna extends zzmy {
    ...
    public final zzmz zza(String str) throws IllegalStateException {
        zzg zzgVarZze;
        if (zzpn.zza() && zze().zza(zzbf.zzbs)) {
            ...
            if (zznp.zzf(str)) {
                ...
                zzfi.zzd zzdVarZzc = zzm().zzc(str);
                ...
                if (zzgVarZze2.zzat()) {
                    ...
                    zzfi.zzd zzdVarZzc2 = zzm().zzc(zzgVarZze2.zzac());
