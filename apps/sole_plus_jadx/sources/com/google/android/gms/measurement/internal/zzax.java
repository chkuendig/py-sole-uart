...
public final class zzax extends zzii {
    ...
    final boolean zzn() throws IllegalStateException, OperationCanceledException, IOException, AuthenticatorException {
        ...
        if (jCurrentTimeMillis - this.zze > CalendarModelKt.MillisecondsIn24Hours) {
            this.zzd = null;
        }
    ...
    protected final boolean zzo() {
        ...
        this.zzb = locale.getLanguage().toLowerCase(Locale.ENGLISH) + SdkConstants.RES_QUALIFIER_SEP + locale.getCountry().toLowerCase(Locale.ENGLISH);
        return false;
    }
}
