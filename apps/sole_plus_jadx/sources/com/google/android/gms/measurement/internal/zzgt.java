...
public final class zzgt extends zzmx implements zzai {
    ...
    final zzim zza(String str, zzin.zza zzaVar) throws Throwable {
        ...
        for (zzfi.zza.C0170zza c0170zza : zzaVarZzb.zzf()) {
            if (zza(c0170zza.zzc()) == zzaVar) {
                int i = zzha.zzc[c0170zza.zzb().ordinal()];
                if (i == 1) {
                    return zzim.DENIED;
                }
                if (i == 2) {
    ...
    final boolean zzc(String str, zzin.zza zzaVar) throws Throwable {
        ...
        Iterator<zzfi.zza.C0170zza> it = zzaVarZzb.zzd().iterator();
        while (true) {
            if (!it.hasNext()) {
                break;
            }
            zzfi.zza.C0170zza next = it.next();
