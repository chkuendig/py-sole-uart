...
public final class zzau {
    ...
    static void zza(zzfw zzfwVar, SQLiteDatabase sQLiteDatabase, String str, String str2, String str3, String[] strArr) throws IllegalStateException, SQLException {
        if (zzfwVar == null) {
    ...
    static void zza(zzfw zzfwVar, SQLiteDatabase sQLiteDatabase) throws IllegalStateException {
        if (zzfwVar == null) {
            throw new IllegalArgumentException("Monitor must not be null");
        }
