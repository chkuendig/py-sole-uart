        ...
        if (bundleZza != null) {
            ...
            if (j == 0) {
                ...
                if (string == null || string.isEmpty()) {
                    ...
                    Bundle bundleZza2 = zzgqVar.zza.zzt().zza(Uri.parse(SdkConstants.PREFIX_THEME_REF + string), z);
                    if (bundleZza2 == null) {
                        ...
                        if (zzgqVar.zza.zzac()) {
                            ...
                            zzgqVar.zza.zzp().zza("auto", Constants.ScionAnalytics.EVENT_FIREBASE_CAMPAIGN, bundleZza2, str);
                        }
                    }
                }
            }
