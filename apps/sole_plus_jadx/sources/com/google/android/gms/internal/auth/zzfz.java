...
final class zzfz<T> implements zzgh<T> {
    ...
    private final void zzB(Object obj, Object obj2, int i) {
        long jZzv = zzv(i) & WinNT.NLS_VALID_LOCALE_MASK;
        if (zzG(obj2, i)) {
    ...
    private final void zzC(Object obj, Object obj2, int i) {
        int iZzv = zzv(i);
        int i2 = this.zzc[i];
        long j = iZzv & WinNT.NLS_VALID_LOCALE_MASK;
        if (zzJ(obj2, i2, i)) {
    ...
    private final void zzE(Object obj, int i, int i2) {
        zzhi.zzn(obj, zzs(i2) & WinNT.NLS_VALID_LOCALE_MASK, i);
    }
    ...
    private final boolean zzG(Object obj, int i) {
        ...
        int iZzv = zzv(i);
        long j2 = iZzv & WinNT.NLS_VALID_LOCALE_MASK;
        switch (zzu(iZzv)) {
            case 0:
    ...
    private static boolean zzI(Object obj, int i, zzgh zzghVar) {
        return zzghVar.zzi(zzhi.zzf(obj, i & WinNT.NLS_VALID_LOCALE_MASK));
    }

    private final boolean zzJ(Object obj, int i, int i2) {
        return zzhi.zzc(obj, (long) (zzs(i2) & WinNT.NLS_VALID_LOCALE_MASK)) == i;
    }
    ...
    */
    ...
    private final int zzn(Object obj, byte[] bArr, int i, int i2, int i3, int i4, int i5, int i6, int i7, long j, int i8, zzds zzdsVar) throws IOException {
        Unsafe unsafe = zzb;
        long j2 = this.zzc[i8 + 2] & WinNT.NLS_VALID_LOCALE_MASK;
        switch (i7) {
            case 51:
                if (i5 == 1) {
    ...
    private final int zzo(Object obj, byte[] bArr, int i, int i2, zzds zzdsVar) throws IOException {
        ...
        Unsafe unsafe2 = zzb;
        int i14 = WinNT.NLS_VALID_LOCALE_MASK;
        int i15 = -1;
        int iZzi = i;
        int i16 = -1;
        int i17 = 1048575;
        ...
        while (iZzi < i13) {
            ...
            if (iZzr == i15) {
                ...
                if (iZzu <= 17) {
                    int i24 = iArr[iZzr + 2];
                    int i25 = 1 << (i24 >>> 20);
                    int i26 = i24 & WinNT.NLS_VALID_LOCALE_MASK;
                    if (i26 != i17) {
                        if (i17 != 1048575) {
                    ...
                    i7 = iZzr;
                    int i27 = iZzk;
                    i9 = WinNT.NLS_VALID_LOCALE_MASK;
                    i4 = i21;
                    if (iZzu == 27) {
                        if (i22 == 2) {
                        ...
                        if (iZzi != i27) {
                            ...
                            i18 = i6;
                            unsafe2 = unsafe;
                            i14 = WinNT.NLS_VALID_LOCALE_MASK;
                            zzfzVar = this;
                        } else {
                            i3 = iZzi;
                            i17 = i12;
    ...
    */
    ...
    public final void zze(Object obj) {
        ...
        while (true) {
            ...
            long jZzv = zzv(this.zzi[i2]) & WinNT.NLS_VALID_LOCALE_MASK;
            Object objZzf = zzhi.zzf(obj, jZzv);
            if (objZzf != null) {
                ((zzfq) objZzf).zzc();
    ...
    public final boolean zzh(Object obj, Object obj2) {
        ...
        for (int i = 0; i < length; i += 3) {
            ...
            switch (zzu(iZzv)) {
                ...
                case 67:
                case 68:
                    long jZzs = zzs(i) & WinNT.NLS_VALID_LOCALE_MASK;
