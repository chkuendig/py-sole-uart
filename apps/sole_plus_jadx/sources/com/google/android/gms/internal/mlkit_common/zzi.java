...
public final class zzi {
    ...
    private static final String[] zzb = {SdkConstants.ANDROID_SUPPORT_ARTIFACT_PREFIX, "com.google.", "com.chrome.", "com.nest.", "com.waymo.", "com.waze"};
    ...
    public static AssetFileDescriptor zza(Context context, Uri uri, String str) throws IOException, ErrnoException {
        ...
        if ("android.resource".equals(scheme)) {
            return contentResolver.openAssetFileDescriptor(uriZzc, SdkConstants.FD_RES_CLASS);
        }
        if ("content".equals(scheme)) {
            if (!zzj(context, uriZzc, 1, zzhVar)) {
                throw new FileNotFoundException("Can't open content uri.");
            }
            AssetFileDescriptor assetFileDescriptorOpenAssetFileDescriptor = contentResolver.openAssetFileDescriptor(uriZzc, SdkConstants.FD_RES_CLASS);
        ...
        AssetFileDescriptor assetFileDescriptorOpenAssetFileDescriptor2 = contentResolver.openAssetFileDescriptor(uriZzc, SdkConstants.FD_RES_CLASS);
    ...
    public static InputStream zzb(Context context, Uri uri, zzh zzhVar) throws IOException, ErrnoException {
        ...
        try {
            ParcelFileDescriptor parcelFileDescriptorOpenFileDescriptor = contentResolver.openFileDescriptor(Uri.fromFile(new File(uriZzc.getPath()).getCanonicalFile()), SdkConstants.FD_RES_CLASS);
            try {
