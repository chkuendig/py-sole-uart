...
final class zzaw extends zzas implements RandomAccess, zzcn, zzdu {
    ...
    public final int hashCode() {
        int iZza = 1;
        for (int i = 0; i < this.zzc; i++) {
            iZza = (iZza * 31) + zzco.zza(this.zzb[i]);
        }
        return iZza;
    }
    ...
    public final /* bridge */ /* synthetic */ zzcn zzd(int i) {
        if (i >= this.zzc) {
            return new zzaw(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
    ...
    private zzaw(boolean[] zArr, int i, boolean z) {
        super(z);
        this.zzb = zArr;
        this.zzc = i;
    }
