        ...
        if (cCTDestination.getSupportedEncodings().contains(Encoding.of(SdkConstants.EXT_JSON))) {
            this.zza = new Lazy(new Provider() { // from class: com.google.android.gms.internal.mlkit_common.zzsm
                ...
                public final Object get() {
                    return transportFactoryNewFactory.getTransport("FIREBASE_ML_SDK", byte[].class, Encoding.of(SdkConstants.EXT_JSON), new Transformer() { // from class: com.google.android.gms.internal.mlkit_common.zzso
