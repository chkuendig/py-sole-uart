...
class zzai extends AbstractCollection {
    ...
    zzai(zzal zzalVar, Object obj, @CheckForNull Collection collection, zzai zzaiVar) {
        this.zze = zzalVar;
        this.zza = obj;
        this.zzb = collection;
        this.zzc = zzaiVar;
    ...
    final void zza() {
        ...
        zzal zzalVar = this.zze;
        zzalVar.zza.put(this.zza, this.zzb);
    }
    ...
    final void zzb() {
        ...
        if (this.zzb.isEmpty()) {
            zzal zzalVar = this.zze;
            Collection collection = (Collection) zzalVar.zza.get(this.zza);
            if (collection != null) {
                this.zzb = collection;
            }
        }
