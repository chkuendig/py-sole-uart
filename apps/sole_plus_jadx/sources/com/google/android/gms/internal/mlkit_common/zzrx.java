...
final class zzrx extends zzsj {
    ...
    public final int hashCode() {
        ...
        int i2 = ((iHashCode * 1000003) ^ (true != z ? 1237 : 1231)) * 1000003;
        if (true == this.zzd) {
            i = 1231;
        }
        return ((((((i2 ^ i) * 1000003) ^ this.zze.hashCode()) * 1000003) ^ this.zzf.hashCode()) * 1000003) ^ this.zzg;
    }

    public final String toString() {
        zzna zznaVar = this.zzf;
        ModelType modelType = this.zze;
        return "RemoteModelLoggingOptions{errorCode=" + this.zza.toString() + ", tfliteSchemaVersion=" + this.zzb + ", shouldLogRoughDownloadTime=" + this.zzc + ", shouldLogExactDownloadTime=" + this.zzd + ", modelType=" + modelType.toString() + ", downloadStatus=" + zznaVar.toString() + ", failureStatusCode=" + this.zzg + SdkConstants.MANIFEST_PLACEHOLDER_SUFFIX;
    }
