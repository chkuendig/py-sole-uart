...
public abstract class zzbp extends zzax {
    ...
    @Deprecated
    static int zzt(int i, zzdn zzdnVar, zzdy zzdyVar) {
        int iZzH = ((zzar) zzdnVar).zzH(zzdyVar);
        int iZzx = zzx(i << 3);
        return iZzx + iZzx + iZzH;
    }
    ...
    static int zzv(zzdn zzdnVar, zzdy zzdyVar) {
        int iZzH = ((zzar) zzdnVar).zzH(zzdyVar);
        return zzx(iZzH) + iZzH;
    }
    ...
    public static zzbp zzz(byte[] bArr, int i, int i2) {
        return new zzbm(bArr, 0, i2);
    }
    ...
    final void zzB(String str, zzfd zzfdVar) throws IOException {
    ...
    public abstract void zze(int i, zzbh zzbhVar) throws IOException;
