...
public final class zzai implements zzaq {
    ...
    public final Boolean zzd() {
        return Boolean.valueOf((Double.isNaN(this.zza.doubleValue()) || this.zza.doubleValue() == AudioStats.AUDIO_AMPLITUDE_NONE) ? false : true);
    }
    ...
    public final String zzf() throws NumberFormatException {
        ...
        if (Double.isInfinite(this.zza.doubleValue())) {
            if (this.zza.doubleValue() > AudioStats.AUDIO_AMPLITUDE_NONE) {
                return "Infinity";
            }
            return "-Infinity";
        }
