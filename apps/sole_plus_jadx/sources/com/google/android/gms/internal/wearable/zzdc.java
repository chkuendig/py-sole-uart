...
final class zzdc extends zzas implements RandomAccess, zzcm, zzdu {
    private static final zzdc zza = new zzdc(new long[0], 0, false);
    private long[] zzb;
    private int zzc;
    ...
    public final boolean addAll(Collection collection) {
        ...
        System.arraycopy(zzdcVar.zzb, 0, this.zzb, this.zzc, zzdcVar.zzc);
        this.zzc = i3;
        this.modCount++;
        return true;
    }
    ...
    public final zzcm zzd(int i) {
        if (i >= this.zzc) {
            return new zzdc(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
    ...
    private zzdc(long[] jArr, int i, boolean z) {
        super(z);
        this.zzb = jArr;
        this.zzc = i;
    }
