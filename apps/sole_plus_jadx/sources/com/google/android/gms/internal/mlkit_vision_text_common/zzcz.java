...
final class zzcz implements ObjectEncoderContext {
    ...
    final zzcz zzd(FieldDescriptor fieldDescriptor, int i, boolean z) throws IOException {
        if (!z || i != 0) {
            zzcx zzcxVarZzj = zzj(fieldDescriptor);
            int iOrdinal = zzcxVarZzj.zzb().ordinal();
            if (iOrdinal == 0) {
                zzn(zzcxVarZzj.zza() << 3);
                zzn(i);
            } else if (iOrdinal == 1) {
                zzn(zzcxVarZzj.zza() << 3);
                zzn((i + i) ^ (i >> 31));
            } else if (iOrdinal == 2) {
                zzn((zzcxVarZzj.zza() << 3) | 5);
