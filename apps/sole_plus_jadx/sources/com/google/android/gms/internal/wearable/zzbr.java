...
final class zzbr extends zzas implements RandomAccess, zzcn, zzdu {
    private static final zzbr zza = new zzbr(new double[0], 0, false);
    private double[] zzb;
    private int zzc;
    ...
    public final boolean addAll(Collection collection) {
        ...
        System.arraycopy(zzbrVar.zzb, 0, this.zzb, this.zzc, zzbrVar.zzc);
        this.zzc = i3;
        this.modCount++;
        return true;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzbrVar.zzc) {
            return false;
        }
        double[] dArr = zzbrVar.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzcn zzd(int i) {
        if (i >= this.zzc) {
            return new zzbr(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
    ...
    private zzbr(double[] dArr, int i, boolean z) {
        super(z);
        this.zzb = dArr;
        this.zzc = i;
    }
