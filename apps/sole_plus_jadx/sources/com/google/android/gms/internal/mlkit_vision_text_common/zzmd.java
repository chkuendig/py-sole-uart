...
final class zzmd implements ObjectEncoder {
    ...
    static {
        ...
        FieldDescriptor.Builder builder3 = FieldDescriptor.builder(SdkConstants.ATTR_START_X);
        zzct zzctVar3 = new zzct();
        zzctVar3.zza(3);
        builder3.withProperty(zzctVar3.zzb()).build();
        FieldDescriptor.Builder builder4 = FieldDescriptor.builder(SdkConstants.ATTR_START_Y);
