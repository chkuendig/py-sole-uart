...
final class zzmj {
    ...
    static /* synthetic */ void zza(byte b, byte b2, byte b3, byte b4, char[] cArr, int i) throws zzjs {
    ...
    static /* synthetic */ void zza(byte b, byte b2, byte b3, char[] cArr, int i) throws zzjs {
    ...
    static /* synthetic */ void zza(byte b, byte b2, char[] cArr, int i) throws zzjs {
        if (b < -62 || zza(b2)) {
            throw zzjs.zzd();
        }
