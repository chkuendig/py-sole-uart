    ...
    protected final boolean zza(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
        ...
        switch (i) {
            ...
            case 3:
                ...
                zzbw.zzb(parcel);
                logEventAndBundle(string3, string4, bundle2, zzdgVar, j3);
                break;
            case 4:
            ...
            case 5:
                ...
                if (strongBinder2 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface2 instanceof zzdg) {
                        zzdiVar2 = (zzdg) iInterfaceQueryLocalInterface2;
                    } else {
                        zzdiVar2 = new zzdi(strongBinder2);
                    }
                }
                zzbw.zzb(parcel);
                getUserProperties(string7, string8, zZzc4, zzdiVar2);
                break;
            case 6:
                ...
                if (strongBinder3 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface3 instanceof zzdg) {
                        zzdiVar15 = (zzdg) iInterfaceQueryLocalInterface3;
                    } else {
                        zzdiVar15 = new zzdi(strongBinder3);
                    }
                }
                zzbw.zzb(parcel);
                getMaxUserProperties(string9, zzdiVar15);
                break;
            case 7:
            ...
            case 10:
                ...
                if (strongBinder4 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface4 instanceof zzdg) {
                        zzdiVar14 = (zzdg) iInterfaceQueryLocalInterface4;
                    } else {
                        zzdiVar14 = new zzdi(strongBinder4);
                    }
                }
                zzbw.zzb(parcel);
                getConditionalUserProperties(string13, string14, zzdiVar14);
                break;
            case 11:
            ...
            case 16:
                ...
                if (strongBinder5 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface5 instanceof zzdg) {
                        zzdiVar13 = (zzdg) iInterfaceQueryLocalInterface5;
                    } else {
                        zzdiVar13 = new zzdi(strongBinder5);
                    }
                }
                zzbw.zzb(parcel);
            ...
            case 17:
                ...
                if (strongBinder6 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface6 instanceof zzdg) {
                        zzdiVar12 = (zzdg) iInterfaceQueryLocalInterface6;
                    } else {
                        zzdiVar12 = new zzdi(strongBinder6);
                    }
                }
                zzbw.zzb(parcel);
            ...
            case 19:
                ...
                if (strongBinder8 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface8 instanceof zzdg) {
                        zzdiVar11 = (zzdg) iInterfaceQueryLocalInterface8;
                    } else {
                        zzdiVar11 = new zzdi(strongBinder8);
                    }
                }
                zzbw.zzb(parcel);
            ...
            case 20:
                ...
                if (strongBinder9 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface9 instanceof zzdg) {
                        zzdiVar10 = (zzdg) iInterfaceQueryLocalInterface9;
                    } else {
                        zzdiVar10 = new zzdi(strongBinder9);
                    }
                }
                zzbw.zzb(parcel);
            ...
            case 21:
                ...
                if (strongBinder10 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface10 instanceof zzdg) {
                        zzdiVar9 = (zzdg) iInterfaceQueryLocalInterface10;
                    } else {
                        zzdiVar9 = new zzdi(strongBinder10);
                    }
                }
                zzbw.zzb(parcel);
            ...
            case 22:
                ...
                if (strongBinder11 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface11 instanceof zzdg) {
                        zzdiVar8 = (zzdg) iInterfaceQueryLocalInterface11;
                    } else {
                        zzdiVar8 = new zzdi(strongBinder11);
                    }
                }
                zzbw.zzb(parcel);
            ...
            case 31:
                ...
                if (strongBinder12 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface12 instanceof zzdg) {
                        zzdiVar7 = (zzdg) iInterfaceQueryLocalInterface12;
                    } else {
                        zzdiVar7 = new zzdi(strongBinder12);
                    }
                }
                long j20 = parcel.readLong();
                zzbw.zzb(parcel);
                onActivitySaveInstanceState(iObjectWrapperAsInterface10, zzdiVar7, j20);
                break;
            case 32:
                ...
                if (strongBinder13 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface13 instanceof zzdg) {
                        zzdiVar6 = (zzdg) iInterfaceQueryLocalInterface13;
                    } else {
                        zzdiVar6 = new zzdi(strongBinder13);
                    }
                }
                long j21 = parcel.readLong();
                zzbw.zzb(parcel);
                performAction(bundle6, zzdiVar6, j21);
                break;
            case 33:
            ...
            case 38:
                ...
                if (strongBinder17 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface17 instanceof zzdg) {
                        zzdiVar5 = (zzdg) iInterfaceQueryLocalInterface17;
                    } else {
                        zzdiVar5 = new zzdi(strongBinder17);
                    }
                }
                int i4 = parcel.readInt();
                zzbw.zzb(parcel);
                getTestFlag(zzdiVar5, i4);
                break;
            case 39:
            ...
            case 40:
                ...
                if (strongBinder18 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface18 instanceof zzdg) {
                        zzdiVar4 = (zzdg) iInterfaceQueryLocalInterface18;
                    } else {
                        zzdiVar4 = new zzdi(strongBinder18);
                    }
                }
                zzbw.zzb(parcel);
            ...
            case 46:
                ...
                if (strongBinder19 != null) {
                    ...
                    if (iInterfaceQueryLocalInterface19 instanceof zzdg) {
                        zzdiVar3 = (zzdg) iInterfaceQueryLocalInterface19;
                    } else {
                        zzdiVar3 = new zzdi(strongBinder19);
                    }
                }
                zzbw.zzb(parcel);
