...
public final class zzba extends zzay {
    ...
    */
    ...
    private static boolean zzb(zzaq zzaqVar, zzaq zzaqVar2) {
        ...
        return (Double.isNaN(dDoubleValue) || Double.isNaN(dDoubleValue2) || (dDoubleValue == AudioStats.AUDIO_AMPLITUDE_NONE && dDoubleValue2 == -0.0d) || ((dDoubleValue == -0.0d && dDoubleValue2 == AudioStats.AUDIO_AMPLITUDE_NONE) || Double.compare(dDoubleValue, dDoubleValue2) >= 0)) ? false : true;
    }
