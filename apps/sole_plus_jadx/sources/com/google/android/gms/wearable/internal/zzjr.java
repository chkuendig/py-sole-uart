...
public final class zzjr {
    ...
    zzjr(Context context) {
        this.zzd = context.getApplicationContext();
    }

    public static zzjr zza(Context context) {
        Preconditions.checkNotNull(context);
        synchronized (zzjr.class) {
            if (zzc == null) {
                zzc = new zzjr(context);
            }
        }
        return zzc;
    }
    ...
    public final boolean zzb() {
        ...
        if (packageInfo != null) {
            if (GooglePlayServicesUtilLight.honorsDebugCertificates(this.zzd)) {
                zZzc = zzc(packageInfo, true);
            } else {
                boolean zZzc2 = zzc(packageInfo, false);
                if (zZzc2 || !zzc(packageInfo, true)) {
                    zZzc = zZzc2;
                } else {
