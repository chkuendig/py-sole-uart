...
public abstract class BaseGmsClient<T extends IInterface> {
    ...
    public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        if (iInterface == null) {
            ...
            printWriter.append((CharSequence) getServiceDescriptor()).append(SdkConstants.PREFIX_RESOURCE_REF).append((CharSequence) Integer.toHexString(System.identityHashCode(iInterface.asBinder())));
        }
    ...
    final /* synthetic */ boolean zzg() throws ClassNotFoundException {
