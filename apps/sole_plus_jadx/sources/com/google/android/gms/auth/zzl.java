...
public class zzl {
    ...
    public static Boolean requestGoogleAccountsAccess(Context context) throws GoogleAuthException, IOException {
        ...
        if (zzhs.zze() && zzo(context)) {
            try {
                ...
                String string = bundle.getString(IInstrumentationResultParser.StatusKeys.ERROR);
                ...
                zzd.w("isUserRecoverableError status: " + String.valueOf(zzbyVarZza), new Object[0]);
    ...
    static /* bridge */ /* synthetic */ Object zzd(Object obj) throws IOException {
        zzj(obj);
        return obj;
    }
    ...
    private static TokenData zzg(Bundle bundle) throws GoogleAuthException, IOException {
        ...
        zzby zzbyVarZza = zzby.zza(string);
        if (zzby.zzb(zzbyVarZza)) {
            zzd.w("isUserRecoverableError status: ".concat(String.valueOf(String.valueOf(zzbyVarZza))), new Object[0]);
            throw new UserRecoverableAuthException(string, intent);
        }
