...
public final class Detector {
    ...
    public static PDF417DetectorResult detect(BinaryBitmap binaryBitmap, Map<DecodeHintType, ?> map, boolean z) throws NotFoundException {
        ...
        if (listDetect.isEmpty()) {
            blackMatrix = blackMatrix.m8597clone();
    ...
    */
    ...
    private static ResultPoint[] findRowsWithPattern(BitMatrix bitMatrix, int i, int i2, int i3, int i4, int[] iArr) {
        ...
        while (true) {
            ...
            int[] iArrFindGuardPattern = findGuardPattern(bitMatrix, i4, i6, i2, iArr, iArr2);
            if (iArrFindGuardPattern != null) {
                int i7 = i6;
                int[] iArr3 = iArrFindGuardPattern;
                while (i7 > 0) {
                    int i8 = i7 - 1;
                    int[] iArrFindGuardPattern2 = findGuardPattern(bitMatrix, i4, i8, i2, iArr, iArr2);
        ...
        if (z) {
            ...
            while (true) {
                ...
                i5 = i11;
                int[] iArrFindGuardPattern3 = findGuardPattern(bitMatrix, iArr4[0], i10, i2, iArr, iArr2);
