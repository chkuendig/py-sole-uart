...
public final class PDF417ScanningDecoder {
    ...
    public static DecoderResult decode(BitMatrix bitMatrix, ResultPoint resultPoint, ResultPoint resultPoint2, ResultPoint resultPoint3, ResultPoint resultPoint4, int i, int i2) throws NotFoundException, ChecksumException, FormatException {
        ...
        while (i7 <= barcodeColumnCount) {
            int i8 = z3 ? i7 : barcodeColumnCount - i7;
            if (detectionResultMerge.getDetectionResultColumn(i8) == null) {
                if (i8 == 0 || i8 == barcodeColumnCount) {
                    detectionResultRowIndicatorColumn = new DetectionResultRowIndicatorColumn(boundingBox, i8 == 0 ? z : false);
                } else {
                ...
                detectionResultMerge.setDetectionResultColumn(i8, detectionResultColumn2);
                int i9 = -1;
                int minY = boundingBox.getMinY();
                int i10 = -1;
                while (minY <= boundingBox.getMaxY()) {
                    int startColumn = getStartColumn(detectionResultMerge, i8, minY, z3);
                    ...
                    i5 = i9;
                    detectionResultColumn = detectionResultColumn2;
                    Codeword codewordDetectCodeword = detectCodeword(bitMatrix, boundingBox.getMinX(), boundingBox.getMaxX(), z3, i6, i11, iMin, iMax);
                    i4 = i11;
