...
public final class WifiResultParser extends ResultParser {
    ...
    public WifiParsedResult parse(Result result) {
        ...
        if (strMatchSinglePrefixedField5 == null) {
            ...
            if (strMatchSinglePrefixedField4 != null || "true".equalsIgnoreCase(strMatchSinglePrefixedField5) || SdkConstants.VALUE_FALSE.equalsIgnoreCase(strMatchSinglePrefixedField5)) {
                str = strMatchSinglePrefixedField4;
