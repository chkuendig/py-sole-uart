...
public class CommonUtils {
    ...
    static final class Architecture {
        ...
        static {
            ...
            matcher = map;
            map.put(SdkConstants.ABI_ARMEABI_V7A, new Architecture());
            map.put(SdkConstants.ABI_ARMEABI, new Architecture());
            map.put(SdkConstants.ABI_ARM64_V8A, new Architecture());
    ...
    public static String createInstanceIdFrom(String... strArr) {
        ...
        for (String str : strArr) {
            if (str != null) {
                arrayList.add(str.replace(SdkConstants.RES_QUALIFIER_SEP, "").toLowerCase(Locale.US));
            }
        }
