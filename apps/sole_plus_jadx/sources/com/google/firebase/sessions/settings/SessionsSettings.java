...
public final class SessionsSettings {
    ...
    public final long m8585getSessionRestartTimeoutUwyO8pc() {
        Duration durationMo8583getSessionRestartTimeoutFghU774 = this.localOverrideSettings.mo8583getSessionRestartTimeoutFghU774();
        if (durationMo8583getSessionRestartTimeoutFghU774 != null) {
            long rawValue = durationMo8583getSessionRestartTimeoutFghU774.getRawValue();
            if (m8584isValidSessionRestartTimeoutLRDsOJo(rawValue)) {
                return rawValue;
            }
        }
        Duration durationMo8583getSessionRestartTimeoutFghU7742 = this.remoteSettings.mo8583getSessionRestartTimeoutFghU774();
        if (durationMo8583getSessionRestartTimeoutFghU7742 != null) {
            long rawValue2 = durationMo8583getSessionRestartTimeoutFghU7742.getRawValue();
            if (m8584isValidSessionRestartTimeoutLRDsOJo(rawValue2)) {
                return rawValue2;
            }
        }
    ...
    private final boolean m8584isValidSessionRestartTimeoutLRDsOJo(long sessionRestartTimeout) {
        return Duration.m10447isPositiveimpl(sessionRestartTimeout) && Duration.m10442isFiniteimpl(sessionRestartTimeout);
    }
