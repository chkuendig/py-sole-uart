...
public final class zzd {
    ...
    public static Bundle zza(AnalyticsConnector.ConditionalUserProperty conditionalUserProperty) {
        ...
        if (conditionalUserProperty.value != null) {
            zzik.zza(bundle, conditionalUserProperty.value);
        }
    ...
    public static AnalyticsConnector.ConditionalUserProperty zza(Bundle bundle) {
        ...
        conditionalUserProperty.active = ((Boolean) zzik.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.ACTIVE, Boolean.class, false)).booleanValue();
    ...
    public static boolean zzb(AnalyticsConnector.ConditionalUserProperty conditionalUserProperty) {
        ...
        if ((conditionalUserProperty.value != null && zzkq.zza(conditionalUserProperty.value) == null) || !zzf(str) || !zza(str, conditionalUserProperty.name)) {
            return false;
        }
