    ...
    private final class QueueWorker implements Runnable {
        ...
        */
        ...
        public String toString() {
            ...
            return runnable != null ? "SequentialExecutorWorker{running=" + runnable + SdkConstants.MANIFEST_PLACEHOLDER_SUFFIX : "SequentialExecutorWorker{state=" + SequentialExecutor.this.workerRunningState + SdkConstants.MANIFEST_PLACEHOLDER_SUFFIX;
        }
    }

    public String toString() {
        return "SequentialExecutor@" + System.identityHashCode(this) + "{" + this.executor + SdkConstants.MANIFEST_PLACEHOLDER_SUFFIX;
    }
}
