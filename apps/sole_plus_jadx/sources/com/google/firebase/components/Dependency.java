...
public final class Dependency {
    ...
    public String toString() {
        ...
        int i = this.type;
        return sbAppend.append(i == 1 ? "required" : i == 0 ? "optional" : "set").append(", injection=").append(describeInjection(this.injection)).append(SdkConstants.MANIFEST_PLACEHOLDER_SUFFIX).toString();
    }
