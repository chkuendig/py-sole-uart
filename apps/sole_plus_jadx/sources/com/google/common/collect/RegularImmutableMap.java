...
final class RegularImmutableMap<K, V> extends ImmutableMap<K, V> {
    ...
    private static Object createHashTable(Object[] objArr, int i, int i2, int i3) {
                ...
                while (true) {
                    ...
                    if (i11 == 255) {
                        ...
                        if (objRequireNonNull.equals(objArr[i11])) {
                            int i12 = i11 ^ 1;
                            duplicateKey = new ImmutableMap.Builder.DuplicateKey(objRequireNonNull, objRequireNonNull2, Objects.requireNonNull(objArr[i12]));
            ...
            for (int i14 = 0; i14 < i; i14++) {
                ...
                while (true) {
                    ...
                    if (i18 == 65535) {
                        sArr[i17] = (short) i16;
                        if (i13 < i14) {
                            objArr[i16] = objRequireNonNull3;
                            objArr[i16 ^ 1] = objRequireNonNull4;
                        }
                        i13++;
                    } else {
                        if (objRequireNonNull3.equals(objArr[i18])) {
                            int i19 = i18 ^ 1;
                            duplicateKey = new ImmutableMap.Builder.DuplicateKey(objRequireNonNull3, objRequireNonNull4, Objects.requireNonNull(objArr[i19]));
                            objArr[i19] = objRequireNonNull4;
                            break;
                        }
                        iSmear2 = i17 + 1;
                    }
        ...
        while (i20 < i) {
            ...
            Object objRequireNonNull6 = Objects.requireNonNull(objArr[i22 ^ 1]);
            ...
            while (true) {
                ...
                if (i25 == i5) {
                    iArr[i24] = i23;
                    if (i21 < i20) {
                        objArr[i23] = objRequireNonNull5;
                        objArr[i23 ^ 1] = objRequireNonNull6;
                    }
                    i21++;
                } else {
                    if (objRequireNonNull5.equals(objArr[i25])) {
                        int i26 = i25 ^ 1;
                        duplicateKey = new ImmutableMap.Builder.DuplicateKey(objRequireNonNull5, objRequireNonNull6, Objects.requireNonNull(objArr[i26]));
                        objArr[i26] = objRequireNonNull6;
                        break;
                    }
                    iSmear3 = i24 + 1;
                    i5 = -1;
