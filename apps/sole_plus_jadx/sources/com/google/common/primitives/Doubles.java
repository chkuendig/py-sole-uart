...
public final class Doubles extends DoublesMethodsForWeb {
    ...
    */
    ...
    private static Pattern fpPattern() {
        ...
        return Pattern.compile(new StringBuilder(String.valueOf(strConcat).length() + 23 + String.valueOf(string).length()).append("[+-]?(?:NaN|Infinity|").append(strConcat).append(SdkConstants.VALUE_DELIMITER_PIPE).append(string).append(")").toString().replace("#", Marker.ANY_NON_NULL_MARKER));
    }
