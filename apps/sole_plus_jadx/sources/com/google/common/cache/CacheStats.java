...
public final class CacheStats {
    ...
    public double missRate() {
        long jRequestCount = requestCount();
        return jRequestCount == 0 ? AudioStats.AUDIO_AMPLITUDE_NONE : this.missCount / jRequestCount;
    }
    ...
    public double loadExceptionRate() {
        ...
        return jSaturatedAdd == 0 ? AudioStats.AUDIO_AMPLITUDE_NONE : this.loadExceptionCount / jSaturatedAdd;
    }
    ...
    public double averageLoadPenalty() {
        long jSaturatedAdd = LongMath.saturatedAdd(this.loadSuccessCount, this.loadExceptionCount);
        return jSaturatedAdd == 0 ? AudioStats.AUDIO_AMPLITUDE_NONE : this.totalLoadTime / jSaturatedAdd;
    }
