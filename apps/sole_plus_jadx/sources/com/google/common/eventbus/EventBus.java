...
public class EventBus {
    ...
    public EventBus() {
        this(SdkConstants.SKIN_DEFAULT);
    }
    ...
    public EventBus(SubscriberExceptionHandler subscriberExceptionHandler) {
        this(SdkConstants.SKIN_DEFAULT, MoreExecutors.directExecutor(), Dispatcher.perThreadDispatchQueue(), subscriberExceptionHandler);
    }
