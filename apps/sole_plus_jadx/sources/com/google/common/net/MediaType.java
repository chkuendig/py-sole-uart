...
public final class MediaType {
    ...
    public static final MediaType CSV_UTF_8 = createConstantUtf8("text", SdkConstants.EXT_CSV);
    ...
    public static final MediaType PNG = createConstant("image", SdkConstants.EXT_PNG);
    ...
    public static final MediaType JSON_UTF_8 = createConstantUtf8("application", SdkConstants.EXT_JSON);
    ...
    public static final MediaType ZIP = createConstant("application", SdkConstants.EXT_ZIP);
    ...
    private static String escapeAndQuote(String str) {
        ...
        for (int i = 0; i < str.length(); i++) {
            ...
            if (cCharAt == '\r' || cCharAt == '\\' || cCharAt == '\"') {
                sbAppend.append(AbstractJsonLexerKt.STRING_ESC);
            }
