...
public final class Stats implements Serializable {
    ...
    public String toString() {
        if (count() > 0) {
            return MoreObjects.toStringHelper(this).add("count", this.count).add(HealthConstants.BloodPressure.MEAN, this.mean).add("populationStandardDeviation", populationStandardDeviation()).add(HealthConstants.HeartRate.MIN, this.min).add("max", this.max).toString();
        }
