    ...
    public static final class FieldAccessorTable {
        ...
        private static class SingularFieldAccessor implements FieldAccessor {
            ...
            private static final class ReflectionInvoker implements MethodInvoker {
                ...
                ReflectionInvoker(Descriptors.FieldDescriptor fieldDescriptor, String str, Class<? extends GeneratedMessageV3> cls, Class<? extends Builder> cls2, String str2, boolean z, boolean z2) {
                    ...
                    this.clearMethod = GeneratedMessageV3.getMethodOrDie(cls2, CervicalMucusRecord.Appearance.CLEAR + str, new Class[0]);
                    this.caseMethod = z ? GeneratedMessageV3.getMethodOrDie(cls, "get" + str2 + "Case", new Class[0]) : null;
                    this.caseMethodBuilder = z ? GeneratedMessageV3.getMethodOrDie(cls2, "get" + str2 + "Case", new Class[0]) : null;
                }
        ...
        private static class RepeatedFieldAccessor implements FieldAccessor {
            ...
            private static final class ReflectionInvoker implements MethodInvoker {
                ...
                ReflectionInvoker(Descriptors.FieldDescriptor fieldDescriptor, String str, Class<? extends GeneratedMessageV3> cls, Class<? extends Builder> cls2) {
                    ...
                    java.lang.reflect.Method methodOrDie = GeneratedMessageV3.getMethodOrDie(cls, "get" + str, Integer.TYPE);
        ...
        private static final class SingularEnumFieldAccessor extends SingularFieldAccessor {
            ...
            SingularEnumFieldAccessor(Descriptors.FieldDescriptor fieldDescriptor, String str, Class<? extends GeneratedMessageV3> cls, Class<? extends Builder> cls2, String str2) {
                ...
                if (zSupportsUnknownEnumValue) {
                    this.getValueMethod = GeneratedMessageV3.getMethodOrDie(cls, "get" + str + JvmWideVariable.ValueWrapperMBean.VALUE_PROPERTY, new Class[0]);
                    this.getValueMethodBuilder = GeneratedMessageV3.getMethodOrDie(cls2, "get" + str + JvmWideVariable.ValueWrapperMBean.VALUE_PROPERTY, new Class[0]);
                    this.setValueMethod = GeneratedMessageV3.getMethodOrDie(cls2, "set" + str + JvmWideVariable.ValueWrapperMBean.VALUE_PROPERTY, Integer.TYPE);
                }
            }
        ...
        private static final class RepeatedEnumFieldAccessor extends RepeatedFieldAccessor {
            ...
            RepeatedEnumFieldAccessor(Descriptors.FieldDescriptor fieldDescriptor, String str, Class<? extends GeneratedMessageV3> cls, Class<? extends Builder> cls2) {
                ...
                this.supportUnknownEnumValue = zSupportsUnknownEnumValue;
                if (zSupportsUnknownEnumValue) {
                    this.getRepeatedValueMethod = GeneratedMessageV3.getMethodOrDie(cls, "get" + str + JvmWideVariable.ValueWrapperMBean.VALUE_PROPERTY, Integer.TYPE);
                    this.getRepeatedValueMethodBuilder = GeneratedMessageV3.getMethodOrDie(cls2, "get" + str + JvmWideVariable.ValueWrapperMBean.VALUE_PROPERTY, Integer.TYPE);
                    this.setRepeatedValueMethod = GeneratedMessageV3.getMethodOrDie(cls2, "set" + str + JvmWideVariable.ValueWrapperMBean.VALUE_PROPERTY, Integer.TYPE, Integer.TYPE);
                    this.addRepeatedValueMethod = GeneratedMessageV3.getMethodOrDie(cls2, "add" + str + JvmWideVariable.ValueWrapperMBean.VALUE_PROPERTY, Integer.TYPE);
                }
            }
