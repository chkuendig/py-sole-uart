...
public final class Timestamp extends GeneratedMessageV3 implements TimestampOrBuilder {
    ...
    public int hashCode() {
        ...
        int iHashCode = ((((((((((WinError.ERROR_MEMORY_HARDWARE + getDescriptor().hashCode()) * 37) + 1) * 53) + Internal.hashLong(getSeconds())) * 37) + 2) * 53) + getNanos()) * 29) + this.unknownFields.hashCode();
