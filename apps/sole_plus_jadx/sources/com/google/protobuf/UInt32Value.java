...
public final class UInt32Value extends GeneratedMessageV3 implements UInt32ValueOrBuilder {
    ...
    public int getSerializedSize() {
        ...
        int i2 = this.value_;
        int iComputeUInt32Size = (i2 != 0 ? CodedOutputStream.computeUInt32Size(1, i2) : 0) + this.unknownFields.getSerializedSize();
    ...
    public int hashCode() {
        ...
        int iHashCode = ((((((WinError.ERROR_MEMORY_HARDWARE + getDescriptor().hashCode()) * 37) + 1) * 53) + getValue()) * 29) + this.unknownFields.hashCode();
