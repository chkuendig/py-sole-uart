...
public final class Any extends GeneratedMessageV3 implements AnyOrBuilder {
    ...
    public int getSerializedSize() {
        ...
        int iComputeStringSize = !getTypeUrlBytes().isEmpty() ? GeneratedMessageV3.computeStringSize(1, this.typeUrl_) : 0;
        if (!this.value_.isEmpty()) {
    ...
    public int hashCode() {
        ...
        int iHashCode = ((((((((((WinError.ERROR_MEMORY_HARDWARE + getDescriptor().hashCode()) * 37) + 1) * 53) + getTypeUrl().hashCode()) * 37) + 2) * 53) + getValue().hashCode()) * 29) + this.unknownFields.hashCode();
