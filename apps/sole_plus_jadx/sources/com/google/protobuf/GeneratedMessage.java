...
public abstract class GeneratedMessage extends AbstractMessage implements Serializable {
    ...
    */
    ...
    public static abstract class Builder<BuilderType extends Builder<BuilderType>> extends AbstractMessage.Builder<BuilderType> {
        ...
        /* renamed from: clone */
        public BuilderType mo7987clone() {
    ...
    public static abstract class ExtendableBuilder<MessageType extends ExtendableMessage, BuilderType extends ExtendableBuilder<MessageType, BuilderType>> extends Builder<BuilderType> implements ExtendableMessageOrBuilder<MessageType> {
        ...
        /* renamed from: clone */
        public BuilderType mo7987clone() {
            return (BuilderType) super.mo7987clone();
        }

        private void ensureExtensionsIsMutable() {
            if (this.extensions.isImmutable()) {
                this.extensions = this.extensions.m8592clone();
            }
        }
        ...
        public final <Type> BuilderType setExtension(Extension<MessageType, List<Type>> extension, int i, Type type) {
            return (BuilderType) setExtension((ExtensionLite<MessageType, List<int>>) extension, i, (int) type);
        }

        public <Type> BuilderType setExtension(GeneratedExtension<MessageType, List<Type>> generatedExtension, int i, Type type) {
            return (BuilderType) setExtension((ExtensionLite<MessageType, List<int>>) generatedExtension, i, (int) type);
        }
    ...
    public static final class FieldAccessorTable {
        ...
        private static class OneofAccessor {
            ...
            OneofAccessor(Descriptors.Descriptor descriptor, String str, Class<? extends GeneratedMessage> cls, Class<? extends Builder> cls2) {
                ...
                this.clearMethod = GeneratedMessage.getMethodOrDie(cls2, CervicalMucusRecord.Appearance.CLEAR + str, new Class[0]);
            }
        ...
        private static class SingularFieldAccessor implements FieldAccessor {
            ...
            SingularFieldAccessor(Descriptors.FieldDescriptor fieldDescriptor, String str, Class<? extends GeneratedMessage> cls, Class<? extends Builder> cls2, String str2) {
                ...
                this.clearMethod = GeneratedMessage.getMethodOrDie(cls2, CervicalMucusRecord.Appearance.CLEAR + str, new Class[0]);
                this.caseMethod = z ? GeneratedMessage.getMethodOrDie(cls, "get" + str2 + "Case", new Class[0]) : null;
                this.caseMethodBuilder = z ? GeneratedMessage.getMethodOrDie(cls2, "get" + str2 + "Case", new Class[0]) : null;
            }
        ...
        private static class RepeatedFieldAccessor implements FieldAccessor {
            ...
            RepeatedFieldAccessor(Descriptors.FieldDescriptor fieldDescriptor, String str, Class<? extends GeneratedMessage> cls, Class<? extends Builder> cls2) {
                ...
                java.lang.reflect.Method methodOrDie = GeneratedMessage.getMethodOrDie(cls, "get" + str, Integer.TYPE);
        ...
        private static final class SingularEnumFieldAccessor extends SingularFieldAccessor {
            ...
            SingularEnumFieldAccessor(Descriptors.FieldDescriptor fieldDescriptor, String str, Class<? extends GeneratedMessage> cls, Class<? extends Builder> cls2, String str2) {
                ...
                if (zSupportsUnknownEnumValue) {
                    this.getValueMethod = GeneratedMessage.getMethodOrDie(cls, "get" + str + JvmWideVariable.ValueWrapperMBean.VALUE_PROPERTY, new Class[0]);
                    this.getValueMethodBuilder = GeneratedMessage.getMethodOrDie(cls2, "get" + str + JvmWideVariable.ValueWrapperMBean.VALUE_PROPERTY, new Class[0]);
                    this.setValueMethod = GeneratedMessage.getMethodOrDie(cls2, "set" + str + JvmWideVariable.ValueWrapperMBean.VALUE_PROPERTY, Integer.TYPE);
                }
            }
        ...
        private static final class RepeatedEnumFieldAccessor extends RepeatedFieldAccessor {
            ...
            RepeatedEnumFieldAccessor(Descriptors.FieldDescriptor fieldDescriptor, String str, Class<? extends GeneratedMessage> cls, Class<? extends Builder> cls2) {
                ...
                this.supportUnknownEnumValue = zSupportsUnknownEnumValue;
                if (zSupportsUnknownEnumValue) {
                    this.getRepeatedValueMethod = GeneratedMessage.getMethodOrDie(cls, "get" + str + JvmWideVariable.ValueWrapperMBean.VALUE_PROPERTY, Integer.TYPE);
                    this.getRepeatedValueMethodBuilder = GeneratedMessage.getMethodOrDie(cls2, "get" + str + JvmWideVariable.ValueWrapperMBean.VALUE_PROPERTY, Integer.TYPE);
                    this.setRepeatedValueMethod = GeneratedMessage.getMethodOrDie(cls2, "set" + str + JvmWideVariable.ValueWrapperMBean.VALUE_PROPERTY, Integer.TYPE, Integer.TYPE);
                    this.addRepeatedValueMethod = GeneratedMessage.getMethodOrDie(cls2, "add" + str + JvmWideVariable.ValueWrapperMBean.VALUE_PROPERTY, Integer.TYPE);
                }
            }
