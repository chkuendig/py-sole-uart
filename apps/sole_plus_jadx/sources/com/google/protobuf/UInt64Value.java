...
public final class UInt64Value extends GeneratedMessageV3 implements UInt64ValueOrBuilder {
    ...
    public int getSerializedSize() {
        ...
        long j = this.value_;
        int iComputeUInt64Size = (j != 0 ? CodedOutputStream.computeUInt64Size(1, j) : 0) + this.unknownFields.getSerializedSize();
    ...
    public int hashCode() {
        ...
        int iHashCode = ((((((WinError.ERROR_MEMORY_HARDWARE + getDescriptor().hashCode()) * 37) + 1) * 53) + Internal.hashLong(getValue())) * 29) + this.unknownFields.hashCode();
