...
public final class DoubleValue extends GeneratedMessageV3 implements DoubleValueOrBuilder {
    ...
    public int getSerializedSize() {
        ...
        double d = this.value_;
        int iComputeDoubleSize = (d != AudioStats.AUDIO_AMPLITUDE_NONE ? CodedOutputStream.computeDoubleSize(1, d) : 0) + this.unknownFields.getSerializedSize();
    ...
    public int hashCode() {
        ...
        int iHashCode = ((((((WinError.ERROR_MEMORY_HARDWARE + getDescriptor().hashCode()) * 37) + 1) * 53) + Internal.hashLong(Double.doubleToLongBits(getValue()))) * 29) + this.unknownFields.hashCode();
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements DoubleValueOrBuilder {
        ...
        public Builder mergeFrom(DoubleValue doubleValue) {
            ...
            if (doubleValue.getValue() != AudioStats.AUDIO_AMPLITUDE_NONE) {
