...
public final class Segment$$serializer implements GeneratedSerializer<Segment> {
    ...
    static {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.google.ai.client.generativeai.common.server.Segment", segment$$serializer, 2);
        pluginGeneratedSerialDescriptor.addElement("start_index", false);
        pluginGeneratedSerialDescriptor.addElement("end_index", false);
    ...
    public Segment deserialize(Decoder decoder) {
        ...
        return new Segment(i, iDecodeIntElement, iDecodeIntElement2, null);
    }
    ...
    public void serialize(Encoder encoder, Segment value) {
        ...
        Segment.write$Self(value, compositeEncoderBeginStructure, descriptor2);
