...
public final class ResponseStoppedException extends GoogleGenerativeAIException {
    ...
    public ResponseStoppedException(GenerateContentResponse response, Throwable th) {
        ...
        FinishReason finishReason = ((Candidate) CollectionsKt.first((List) response.getCandidates())).getFinishReason();
        super("Content generation stopped. Reason: " + (finishReason != null ? finishReason.name() : null), th, null);
