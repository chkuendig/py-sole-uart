...
public final class UsageMetadata$$serializer implements GeneratedSerializer<UsageMetadata> {
    ...
    static {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.google.ai.client.generativeai.common.UsageMetadata", usageMetadata$$serializer, 3);
    ...
    public UsageMetadata deserialize(Decoder decoder) {
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            objDecodeNullableSerializableElement3 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 0, IntSerializer.INSTANCE, null);
            ...
            while (z) {
                ...
                if (iDecodeElementIndex == -1) {
                    ...
                    objDecodeNullableSerializableElement4 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 0, IntSerializer.INSTANCE, objDecodeNullableSerializableElement4);
                    i2 |= 1;
                } else if (iDecodeElementIndex == 1) {
                    objDecodeNullableSerializableElement5 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 1, IntSerializer.INSTANCE, objDecodeNullableSerializableElement5);
                    i2 |= 2;
                } else {
        ...
        return new UsageMetadata(i, (Integer) objDecodeNullableSerializableElement3, (Integer) objDecodeNullableSerializableElement, (Integer) objDecodeNullableSerializableElement2, (SerializationConstructorMarker) null);
    }
    ...
    public void serialize(Encoder encoder, UsageMetadata value) {
        ...
        UsageMetadata.write$Self(value, compositeEncoderBeginStructure, descriptor2);
