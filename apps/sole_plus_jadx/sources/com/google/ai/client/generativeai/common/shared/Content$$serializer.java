...
public final class Content$$serializer implements GeneratedSerializer<Content> {
    ...
    static {
        ...
        pluginGeneratedSerialDescriptor.addElement("parts", false);
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{BuiltinSerializersKt.getNullable(StringSerializer.INSTANCE), Content.$childSerializers[1]};
    }
    ...
    public Content deserialize(Decoder decoder) {
        ...
        return new Content(i, (String) objDecodeNullableSerializableElement, (List) objDecodeSerializableElement, serializationConstructorMarker);
    }
    ...
    public void serialize(Encoder encoder, Content value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(descriptor2);
        Content.write$Self(value, compositeEncoderBeginStructure, descriptor2);
