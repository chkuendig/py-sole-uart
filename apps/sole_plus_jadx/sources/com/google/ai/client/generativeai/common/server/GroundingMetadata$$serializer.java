...
public final class GroundingMetadata$$serializer implements GeneratedSerializer<GroundingMetadata> {
    ...
    static {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.google.ai.client.generativeai.common.server.GroundingMetadata", groundingMetadata$$serializer, 4);
    ...
    public KSerializer<?>[] childSerializers() {
        KSerializer[] kSerializerArr = GroundingMetadata.$childSerializers;
    ...
    public GroundingMetadata deserialize(Decoder decoder) {
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            objDecodeNullableSerializableElement2 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 0, kSerializerArr[0], null);
            objDecodeNullableSerializableElement3 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 1, SearchEntryPoint$$serializer.INSTANCE, null);
            Object objDecodeNullableSerializableElement6 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 2, kSerializerArr[2], null);
            objDecodeNullableSerializableElement4 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 3, kSerializerArr[3], null);
            ...
            while (z) {
                ...
                if (iDecodeElementIndex == -1) {
                    ...
                    objDecodeNullableSerializableElement5 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 0, kSerializerArr[0], objDecodeNullableSerializableElement5);
                    i2 |= 1;
                } else if (iDecodeElementIndex == 1) {
                    objDecodeNullableSerializableElement7 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 1, SearchEntryPoint$$serializer.INSTANCE, objDecodeNullableSerializableElement7);
                    i2 |= 2;
                    ...
                    objDecodeNullableSerializableElement8 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 3, kSerializerArr[3], objDecodeNullableSerializableElement8);
                    i2 |= 8;
                }
            }
            i = i2;
        ...
        return new GroundingMetadata(i, (List) objDecodeNullableSerializableElement2, (SearchEntryPoint) objDecodeNullableSerializableElement3, (List) objDecodeNullableSerializableElement, (List) objDecodeNullableSerializableElement4, null);
    }
    ...
    public void serialize(Encoder encoder, GroundingMetadata value) {
        ...
        GroundingMetadata.write$Self(value, compositeEncoderBeginStructure, descriptor2);
