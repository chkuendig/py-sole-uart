...
public final class FunctionCall$$serializer implements GeneratedSerializer<FunctionCall> {
    ...
    static {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.google.ai.client.generativeai.common.shared.FunctionCall", functionCall$$serializer, 2);
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{StringSerializer.INSTANCE, FunctionCall.$childSerializers[1]};
    }
    ...
    public FunctionCall deserialize(Decoder decoder) {
        ...
        KSerializer[] kSerializerArr = FunctionCall.$childSerializers;
        ...
        return new FunctionCall(i, strDecodeStringElement, (Map) objDecodeSerializableElement, null);
    }
    ...
    public void serialize(Encoder encoder, FunctionCall value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(descriptor2);
        FunctionCall.write$Self(value, compositeEncoderBeginStructure, descriptor2);
