...
public class LocalModelLoader {
    ...
    public MappedByteBuffer load() throws MlKitException, IOException, ErrnoException {
        ...
        if (absoluteFilePath != null) {
            try {
                RandomAccessFile randomAccessFile = new RandomAccessFile(absoluteFilePath, SdkConstants.FD_RES_CLASS);
                try {
            ...
            try {
                AssetFileDescriptor assetFileDescriptorZza = zzi.zza(this.zzb, uri, SdkConstants.FD_RES_CLASS);
                try {
