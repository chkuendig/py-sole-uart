...
final class AutoValue_ModelUtils_ModelLoggingInfo extends ModelUtils.ModelLoggingInfo {
    ...
    public final int hashCode() {
        long j = this.zza;
        return ((((((int) (j ^ (j >>> 32))) ^ 1000003) * 1000003) ^ this.zzb.hashCode()) * 1000003) ^ (true != this.zzc ? WinError.ERROR_RETRY : WinError.ERROR_NETWORK_UNREACHABLE);
    }
    ...
    public final String toString() {
        return "ModelLoggingInfo{size=" + this.zza + ", hash=" + this.zzb + ", manifestModel=" + this.zzc + SdkConstants.MANIFEST_PLACEHOLDER_SUFFIX;
    }
}
