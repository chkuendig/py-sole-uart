...
public final class HealthConstants {
    ...
    public interface Albumin extends DiscreteMeasurement {
        ...
        public static final String HEALTH_DATA_TYPE = "com.samsung.health.albumin";
    }

    public interface Alp extends DiscreteMeasurement {
        public static final String ALP = "alp";
        public static final String HEALTH_DATA_TYPE = "com.samsung.health.alp";
    }

    public interface Alt extends DiscreteMeasurement {
        public static final String ALT = "alt";
        public static final String HEALTH_DATA_TYPE = "com.samsung.health.alt";
    }
    ...
    public interface Amylase extends DiscreteMeasurement {
        ...
        public static final String HEALTH_DATA_TYPE = "com.samsung.health.amylase";
    }

    public interface Ast extends DiscreteMeasurement {
        public static final String AST = "ast";
        public static final String HEALTH_DATA_TYPE = "com.samsung.health.ast";
    }
    ...
    public interface BodyFat extends DiscreteMeasurement {
        ...
        public static final String HEALTH_DATA_TYPE = "com.samsung.health.body_fat";
    }

    public interface BodyMuscle extends DiscreteMeasurement {
        public static final String BODY_MUSCLE = "body_muscle";
        public static final String HEALTH_DATA_TYPE = "com.samsung.health.body_muscle";
    }
    ...
    public interface Bun extends DiscreteMeasurement {
        ...
        public static final String HEALTH_DATA_TYPE = "com.samsung.health.bun";
    }
    ...
    public interface Cpk extends DiscreteMeasurement {
        ...
        public static final String HEALTH_DATA_TYPE = "com.samsung.health.cpk";
    }

    public interface Creatinine extends DiscreteMeasurement {
        public static final String CREATININE = "creatinine";
        public static final String HEALTH_DATA_TYPE = "com.samsung.health.creatinine";
    }

    public interface DirectBilirubin extends DiscreteMeasurement {
        public static final String DIRECT_BILIRUBIN = "direct_bilirubin";
        public static final String HEALTH_DATA_TYPE = "com.samsung.health.direct_bilirubin";
    }
    ...
    public interface Exercise extends SessionMeasurement {
        ...
        public static final int COUNT_TYPE_REPETITION = 30004;
    ...
    public interface Fev1 extends DiscreteMeasurement {
        ...
        public static final String HEALTH_DATA_TYPE = "com.samsung.health.fev1";
    }

    public interface FloorsClimbed extends SessionMeasurement {
        public static final String FLOOR = "floor";
        public static final String HEALTH_DATA_TYPE = "com.samsung.health.floors_climbed";
    }
    ...
    public interface Fvc extends DiscreteMeasurement {
        ...
        public static final String HEALTH_DATA_TYPE = "com.samsung.health.fvc";
    }

    public interface Ggt extends DiscreteMeasurement {
        public static final String GGT = "ggt";
        public static final String HEALTH_DATA_TYPE = "com.samsung.health.ggt";
    }

    public interface Globulin extends DiscreteMeasurement {
        public static final String GLOBULIN = "globulin";
        public static final String HEALTH_DATA_TYPE = "com.samsung.health.globulin";
    }
    ...
    public interface Hdlc extends DiscreteMeasurement {
        ...
        public static final String HEALTH_DATA_TYPE = "com.samsung.health.hdlc";
    }
    ...
    public interface HealthDocument extends DiscreteMeasurement {
        ...
        public static final String HEALTH_DATA_TYPE = "com.samsung.shealth.health_document";
        ...
        public static final int TYPE_CDA = 1;
    ...
    public interface Height extends DiscreteMeasurement {
        public static final String HEALTH_DATA_TYPE = "com.samsung.health.height";
        public static final String HEIGHT = "height";
    }

    public interface HipCircumference extends DiscreteMeasurement {
        public static final String HEALTH_DATA_TYPE = "com.samsung.health.hip_circum";
        public static final String HIP_CIRCUM = "hip_circum";
    }

    public interface Homocysteine extends DiscreteMeasurement {
        public static final String HEALTH_DATA_TYPE = "com.samsung.health.homocysteine";
        public static final String HOMOCYSTEINE = "homocysteine";
    }

    public interface Ldh extends DiscreteMeasurement {
        public static final String HEALTH_DATA_TYPE = "com.samsung.health.ldh";
        public static final String LDH = "ldh";
    }

    public interface Ldlc extends DiscreteMeasurement {
        public static final String HEALTH_DATA_TYPE = "com.samsung.health.ldlc";
    ...
    public interface Nutrition extends DiscreteMeasurement {
        ...
        public static final String CHOLESTEROL = "cholesterol";
        public static final String DIETARY_FIBER = "dietary_fiber";
        public static final String HEALTH_DATA_TYPE = "com.samsung.health.nutrition";
        public static final String IRON = "iron";
        public static final String MEAL_TYPE = "meal_type";
        public static final int MEAL_TYPE_AFTERNOON_SNACK = 100005;
        public static final int MEAL_TYPE_BREAKFAST = 100001;
    ...
    public interface StepDailyTrend extends Common {
        public static final String BINNING_DATA = "binning_data";
        public static final String CALORIE = "calorie";
        public static final String COUNT = "count";
        ...
        public static final int SOURCE_TYPE_PARTNER_APP = -1;
        public static final int SOURCE_TYPE_PHONE_ONLY = 0;
        public static final String SPEED = "speed";
    }

    public interface TotalBilirubin extends DiscreteMeasurement {
        public static final String HEALTH_DATA_TYPE = "com.samsung.health.total_bilirubin";
        public static final String TOTAL_BILIRUBIN = "total_bilirubin";
    }

    public interface TotalCholesterol extends DiscreteMeasurement {
        public static final String HEALTH_DATA_TYPE = "com.samsung.health.total_cholesterol";
        public static final String TOTAL_CHOLESTEROL = "total_cholesterol";
    }

    public interface TotalProtein extends DiscreteMeasurement {
        public static final String HEALTH_DATA_TYPE = "com.samsung.health.total_protein";
        public static final String TOTAL_PROTEIN = "total_protein";
    }

    public interface Triglyceride extends DiscreteMeasurement {
        public static final String HEALTH_DATA_TYPE = "com.samsung.health.triglyceride";
        public static final String TRIGLYCERIDE = "triglyceride";
    }

    public interface Uph extends DiscreteMeasurement {
        public static final String HEALTH_DATA_TYPE = "com.samsung.health.uph";
        public static final String UPH = "uph";
    }

    public interface Usg extends DiscreteMeasurement {
        public static final String HEALTH_DATA_TYPE = "com.samsung.health.usg";
    ...
    public interface WaistCircumference extends DiscreteMeasurement {
        public static final String HEALTH_DATA_TYPE = "com.samsung.health.waist_circum";
    ...
    public interface Weight extends DiscreteMeasurement {
        ...
        public static final String BODY_FAT = "body_fat";
        public static final String BODY_FAT_MASS = "body_fat_mass";
        public static final String COMMENT = "comment";
        public static final String FAT_FREE = "fat_free";
        public static final String FAT_FREE_MASS = "fat_free_mass";
        ...
        public static final String SKELETAL_MUSCLE_MASS = "skeletal_muscle_mass";
