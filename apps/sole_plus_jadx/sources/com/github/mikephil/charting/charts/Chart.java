...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends ViewGroup implements ChartInterface {
    ...
    public boolean saveToPath(String str, String str2) throws IOException {
        ...
        try {
            FileOutputStream fileOutputStream = new FileOutputStream(Environment.getExternalStorageDirectory().getPath() + str2 + "/" + str + SdkConstants.DOT_PNG);
    ...
    public boolean saveToGallery(String str, String str2, String str3, Bitmap.CompressFormat compressFormat, int i) throws IOException {
        ...
        if (i2 == 1) {
            str4 = "image/png";
            if (!str.endsWith(SdkConstants.DOT_PNG)) {
                str = str + SdkConstants.DOT_PNG;
            }
        } else if (i2 == 2) {
            str4 = "image/webp";
            if (!str.endsWith(SdkConstants.DOT_WEBP)) {
                str = str + SdkConstants.DOT_WEBP;
            }
        } else {
            str4 = "image/jpeg";
            if (!str.endsWith(SdkConstants.DOT_JPG) && !str.endsWith(SdkConstants.DOT_JPEG)) {
                str = str + SdkConstants.DOT_JPG;
            }
        }
        ...
        try {
            ...
            contentValues.put(SdkConstants.ATTR_ORIENTATION, (Integer) 0);
