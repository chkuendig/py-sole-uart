...
public final class CameraConfigurationUtils {
    ...
    public static void setTorch(Camera.Parameters parameters, boolean z) {
        ...
        String strFindSettableValue = z ? findSettableValue("flash mode", supportedFlashModes, "torch", DebugKt.DEBUG_PROPERTY_VALUE_ON) : findSettableValue("flash mode", supportedFlashModes, DebugKt.DEBUG_PROPERTY_VALUE_OFF);
        if (strFindSettableValue != null) {
    ...
    public static void setInvertColor(Camera.Parameters parameters) {
        if (OvulationTestRecord.Result.NEGATIVE.equals(parameters.getColorEffect())) {
            Log.i(TAG, "Negative effect already set");
            return;
        }
        String strFindSettableValue = findSettableValue("color effect", parameters.getSupportedColorEffects(), OvulationTestRecord.Result.NEGATIVE);
        if (strFindSettableValue != null) {
