...
public class ReflectionUtils {
    ...
    static {
        ...
        METHOD_HANDLES_LOOKUP_IN = lookupMethod(clsLookupClass3, SdkConstants.UNIT_IN, Class.class);
    ...
    private static Constructor lookupDeclaredConstructor(Class cls, Class... clsArr) throws NoSuchMethodException, SecurityException {
        if (cls == null) {
