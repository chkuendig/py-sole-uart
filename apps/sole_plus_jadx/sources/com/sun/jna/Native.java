...
public final class Native implements Version {
    ...
    public static void dispose() {
        ...
        unregisterAll();
        jnidispatchPath = null;
        System.setProperty("jna.loaded", SdkConstants.VALUE_FALSE);
    }
    ...
    public static File extractFromResourcePath(String str, ClassLoader classLoader) throws Throwable {
        ...
        String strSubstring = str.startsWith("/") ? str : Platform.RESOURCE_PREFIX + "/" + strMapSharedLibraryName;
    ...
    /* JADX WARN: Removed duplicated region for block: B:63:0x01ba A[FALL_THROUGH] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public static void register(java.lang.Class<?> r33, com.sun.jna.NativeLibrary r34) throws java.lang.SecurityException {
        /*
    ...
    public static void main(String[] strArr) {
        ...
        if (r3 == null) {
            implementationVersion = "5.6.0 (package information missing)";
        } else {
            implementationVersion = r3.getImplementationVersion();
        }
        System.out.println("Version: " + (implementationVersion != null ? implementationVersion : "5.6.0 (package information missing)"));
