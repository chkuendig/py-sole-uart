...
public interface WinNT extends WinError, WinDef, WinBase, BaseTSD {
    ...
    @Structure.FieldOrder({FirebaseAnalytics.Param.LEVEL, "associativity", "lineSize", ContentDisposition.Parameters.Size, "type"})
    ...
    @Structure.FieldOrder({"baseAddress", "allocationBase", "allocationProtect", "regionSize", ServerProtocol.DIALOG_PARAM_STATE, "protect", "type"})
    ...
    @Structure.FieldOrder({"relationship", ContentDisposition.Parameters.Size})
    ...
    @Structure.FieldOrder({"mask", SdkConstants.TAG_GROUP, "reserved"})
