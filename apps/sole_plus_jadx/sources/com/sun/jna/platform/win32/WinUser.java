...
public interface WinUser extends WinDef {
    ...
    @Structure.FieldOrder({"hWnd", "message", "wParam", "lParam", "time", SdkConstants.UNIT_PT})
    ...
    @Structure.FieldOrder({SessionDescription.ATTR_LENGTH, "flags", "showCmd", "ptMinPosition", "ptMaxPosition", "rcNormalPosition"})
