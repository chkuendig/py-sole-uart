...
public class CallbackProxy implements IDispatchCallback {
    ...
    Map<OaIdl.DISPID, Method> createDispIdMap(Class<?> cls) throws SecurityException {
    ...
    void invokeOnThread(OaIdl.DISPID dispid, Guid.REFIID refiid, WinDef.LCID lcid, WinDef.WORD word, OleAuto.DISPPARAMS.ByReference byReference) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    @Override // com.sun.jna.platform.win32.COM.IDispatch
    public WinNT.HRESULT Invoke(OaIdl.DISPID dispid, Guid.REFIID refiid, WinDef.LCID lcid, WinDef.WORD word, OleAuto.DISPPARAMS.ByReference byReference, Variant.VARIANT.ByReference byReference2, OaIdl.EXCEPINFO.ByReference byReference3, IntByReference intByReference) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
