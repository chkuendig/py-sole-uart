...
public enum Win32VK {
    ...
    VK_LMENU(164),
    VK_RMENU(165),
    VK_BROWSER_BACK(Opcodes.IF_ACMPNE, 1280),
    VK_BROWSER_FORWARD(167, 1280),
    VK_BROWSER_REFRESH(Opcodes.JSR, 1280),
    VK_BROWSER_STOP(Opcodes.RET, 1280),
    VK_BROWSER_SEARCH(170, 1280),
    VK_BROWSER_FAVORITES(Opcodes.LOOKUPSWITCH, 1280),
    VK_BROWSER_HOME(172, 1280),
    VK_VOLUME_MUTE(173, 1280),
    VK_VOLUME_DOWN(174, 1280),
    VK_VOLUME_UP(Opcodes.DRETURN, 1280),
    VK_MEDIA_NEXT_TRACK(Opcodes.ARETURN, 1280),
    VK_MEDIA_PREV_TRACK(Opcodes.RETURN, 1280),
    VK_MEDIA_STOP(Opcodes.GETSTATIC, 1280),
    VK_MEDIA_PLAY_PAUSE(Opcodes.PUTSTATIC, 1280),
    VK_LAUNCH_MAIL(180, 1280),
    VK_LAUNCH_MEDIA_SELECT(Opcodes.PUTFIELD, 1280),
    VK_LAUNCH_APP1(182, 1280),
    VK_LAUNCH_APP2(183, 1280),
    VK_RESERVED_B8(Opcodes.INVOKESTATIC),
    VK_RESERVED_B9(Opcodes.INVOKEINTERFACE),
    VK_OEM_1(186),
    VK_OEM_PLUS(187),
    VK_OEM_COMMA(188),
    VK_OEM_MINUS(189),
    ...
    VK_ZOOM(251),
    VK_NONAME(252),
    VK_PA1(GattError.GATT_CCCD_CFG_ERROR),
    VK_OEM_CLEAR(254),
    VK_RESERVED_FF(255);
