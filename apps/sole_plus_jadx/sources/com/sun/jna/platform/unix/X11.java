...
public interface X11 extends Library {
    ...
    @Structure.FieldOrder({"type", "serial", Constants.MessageTypes.SEND_EVENT, "display", "window"})
    ...
    @Structure.FieldOrder({"type", "serial", Constants.MessageTypes.SEND_EVENT, "display", "window", "root", "subwindow", "time", "x", "y", "x_root", "y_root", ServerProtocol.DIALOG_PARAM_STATE, SdkConstants.ATTR_BUTTON, "same_screen"})
    ...
    @Structure.FieldOrder({"type", "serial", Constants.MessageTypes.SEND_EVENT, "display", NotificationCompat.CATEGORY_EVENT, "window", "place"})
    ...
    @Structure.FieldOrder({"type", "serial", Constants.MessageTypes.SEND_EVENT, "display", SdkConstants.ATTR_PARENT, "window", "place"})
    ...
    @Structure.FieldOrder({"type", "serial", Constants.MessageTypes.SEND_EVENT, "display", "window", Constants.MessagePayloadKeys.MESSAGE_TYPE, "format", "data"})
    ...
    @Structure.FieldOrder({"type", "serial", Constants.MessageTypes.SEND_EVENT, "display", "window", "colormap", "c_new", ServerProtocol.DIALOG_PARAM_STATE})
    ...
    @Structure.FieldOrder({"type", "serial", Constants.MessageTypes.SEND_EVENT, "display", NotificationCompat.CATEGORY_EVENT, "window", "x", "y", "width", "height", "border_width", "above", "override_redirect"})
    ...
    @Structure.FieldOrder({"type", "serial", Constants.MessageTypes.SEND_EVENT, "display", SdkConstants.ATTR_PARENT, "window", "x", "y", "width", "height", "border_width", "above", "detail", "value_mask"})
    ...
    @Structure.FieldOrder({"type", "serial", Constants.MessageTypes.SEND_EVENT, "display", SdkConstants.ATTR_PARENT, "window", "x", "y", "width", "height", "border_width", "override_redirect"})
    ...
    @Structure.FieldOrder({"type", "serial", Constants.MessageTypes.SEND_EVENT, "display", "window", "root", "subwindow", "time", "x", "y", "x_root", "y_root", "mode", "detail", "same_screen", "focus", ServerProtocol.DIALOG_PARAM_STATE})
    ...
    @Structure.FieldOrder({"type", "serial", Constants.MessageTypes.SEND_EVENT, "display", NotificationCompat.CATEGORY_EVENT, "window"})
    ...
    @Structure.FieldOrder({"device_id", "num_classes", SdkConstants.FD_CLASSES_OUTPUT})
    ...
    @Structure.FieldOrder({"type", "display", "serial", "error_code", LoginLogger.EVENT_EXTRAS_REQUEST_CODE, "minor_code", "resourceid"})
    ...
    @Structure.FieldOrder({"type", "serial", Constants.MessageTypes.SEND_EVENT, "display", "window", "x", "y", "width", "height", "count"})
    ...
    @Structure.FieldOrder({"type", "serial", Constants.MessageTypes.SEND_EVENT, "display", "window", "mode", "detail"})
    ...
    @Structure.FieldOrder({"function", "plane_mask", "foreground", SdkConstants.ATTR_BACKGROUND, "line_width", "line_style", "cap_style", "join_style", "fill_style", "fill_rule", "arc_mode", "tile", "stipple", "ts_x_origin", "ts_y_origin", "font", "subwindow_mode", "graphics_exposures", "clip_x_origin", "clip_y_origin", "clip_mask", "dash_offset", "dashes"})
    ...
    @Structure.FieldOrder({"type", "serial", Constants.MessageTypes.SEND_EVENT, "display", "drawable", "x", "y", "width", "height", "count", "major_code", "minor_code"})
    ...
    @Structure.FieldOrder({"type", "serial", Constants.MessageTypes.SEND_EVENT, "display", NotificationCompat.CATEGORY_EVENT, "window", "x", "y"})
    ...
    @Structure.FieldOrder({"type", "serial", Constants.MessageTypes.SEND_EVENT, "display", "window", "root", "subwindow", "time", "x", "y", "x_root", "y_root", ServerProtocol.DIALOG_PARAM_STATE, "keycode", "same_screen"})
    ...
    @Structure.FieldOrder({"type", "serial", Constants.MessageTypes.SEND_EVENT, "display", "window", "key_vector"})
    ...
    @Structure.FieldOrder({"type", "serial", Constants.MessageTypes.SEND_EVENT, "display", NotificationCompat.CATEGORY_EVENT, "window", "override_redirect"})
    ...
    @Structure.FieldOrder({"type", "serial", Constants.MessageTypes.SEND_EVENT, "display", SdkConstants.ATTR_PARENT, "window"})
    ...
    @Structure.FieldOrder({"type", "serial", Constants.MessageTypes.SEND_EVENT, "display", "window", "request", "first_keycode", "count"})
    ...
    @Structure.FieldOrder({"type", "serial", Constants.MessageTypes.SEND_EVENT, "display", "window", "root", "subwindow", "time", "x", "y", "x_root", "y_root", ServerProtocol.DIALOG_PARAM_STATE, "is_hint", "same_screen"})
    ...
    @Structure.FieldOrder({"type", "serial", Constants.MessageTypes.SEND_EVENT, "display", "drawable", "major_code", "minor_code"})
    ...
    @Structure.FieldOrder({"type", "serial", Constants.MessageTypes.SEND_EVENT, "display", "window", SdkConstants.EXT_ATOM, "time", ServerProtocol.DIALOG_PARAM_STATE})
    ...
    @Structure.FieldOrder({"type", "serial", Constants.MessageTypes.SEND_EVENT, "display", NotificationCompat.CATEGORY_EVENT, "window", SdkConstants.ATTR_PARENT, "x", "y", "override_redirect"})
    ...
    @Structure.FieldOrder({"type", "serial", Constants.MessageTypes.SEND_EVENT, "display", "window", "width", "height"})
    ...
    @Structure.FieldOrder({"type", "serial", Constants.MessageTypes.SEND_EVENT, "display", "window", "selection", "time"})
    ...
    @Structure.FieldOrder({"type", "serial", Constants.MessageTypes.SEND_EVENT, "display", "requestor", "selection", TypedValues.AttributesType.S_TARGET, SdkConstants.TAG_PROPERTY, "time"})
    ...
    @Structure.FieldOrder({"type", "serial", Constants.MessageTypes.SEND_EVENT, "display", "owner", "requestor", "selection", TypedValues.AttributesType.S_TARGET, SdkConstants.TAG_PROPERTY, "time"})
    ...
    @Structure.FieldOrder({"type", "serial", Constants.MessageTypes.SEND_EVENT, "display", NotificationCompat.CATEGORY_EVENT, "window", "from_configure"})
    ...
    @Structure.FieldOrder({"type", "serial", Constants.MessageTypes.SEND_EVENT, "display", "window", ServerProtocol.DIALOG_PARAM_STATE})
    ...
    public interface Xrender extends Library {
        ...
        @Structure.FieldOrder({"id", "type", "depth", DevicePublicKeyStringDef.DIRECT, "colormap"})
