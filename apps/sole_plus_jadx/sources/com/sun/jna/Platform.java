...
public final class Platform {
    ...
    public static final boolean isARM() {
        String str = ARCH;
        return str.startsWith(SdkConstants.CPU_ARCH_ARM) || str.startsWith("aarch");
    }
    ...
    static String getCanonicalArchitecture(String str, int i) {
        ...
        return (SdkConstants.CPU_ARCH_ARM.equals(strTrim) && i == 1 && isSoftFloat()) ? "armel" : strTrim;
    }
    ...
    static String getNativeLibraryResourcePrefix(int i, String str, String str2) {
        ...
        switch (i) {
            ...
            default:
                ...
                return lowerCase + SdkConstants.RES_QUALIFIER_SEP + canonicalArchitecture;
            case 8:
                if (canonicalArchitecture.startsWith(SdkConstants.CPU_ARCH_ARM)) {
                    canonicalArchitecture = SdkConstants.CPU_ARCH_ARM;
                }
