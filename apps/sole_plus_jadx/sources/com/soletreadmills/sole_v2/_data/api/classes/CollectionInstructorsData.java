...
public final /* data */ class CollectionInstructorsData implements ClassInstructorsDataBase {
    ...
    public final CollectionInstructorsData copy(GetClassInstructorsApiData.ClassInstructorsData instructorsData, boolean isSelect) {
        Intrinsics.checkNotNullParameter(instructorsData, "instructorsData");
        return new CollectionInstructorsData(instructorsData, isSelect);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof CollectionInstructorsData)) {
            return false;
        }
        CollectionInstructorsData collectionInstructorsData = (CollectionInstructorsData) other;
        return Intrinsics.areEqual(this.instructorsData, collectionInstructorsData.instructorsData) && this.isSelect == collectionInstructorsData.isSelect;
    }
    ...
    public String toString() {
        return "CollectionInstructorsData(instructorsData=" + this.instructorsData + ", isSelect=" + this.isSelect + ')';
    }

    public CollectionInstructorsData(GetClassInstructorsApiData.ClassInstructorsData instructorsData, boolean z) {
        Intrinsics.checkNotNullParameter(instructorsData, "instructorsData");
        this.instructorsData = instructorsData;
        this.isSelect = z;
    }

    public /* synthetic */ CollectionInstructorsData(GetClassInstructorsApiData.ClassInstructorsData classInstructorsData, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
