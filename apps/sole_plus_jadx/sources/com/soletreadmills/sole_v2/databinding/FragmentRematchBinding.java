...
public abstract class FragmentRematchBinding extends ViewDataBinding {
    public final LinearLayout LLLeave;
    public final AnimatedPathImgForLoop animatedPathImageView;
    ...
    public static FragmentRematchBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot) {
        return inflate(inflater, root, attachToRoot, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static FragmentRematchBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot, Object component) {
        return (FragmentRematchBinding) ViewDataBinding.inflateInternal(inflater, R.layout.fragment_rematch, root, attachToRoot, component);
    }

    public static FragmentRematchBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static FragmentRematchBinding inflate(LayoutInflater inflater, Object component) {
        return (FragmentRematchBinding) ViewDataBinding.inflateInternal(inflater, R.layout.fragment_rematch, null, false, component);
    }

    public static FragmentRematchBinding bind(View view) {
        return bind(view, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static FragmentRematchBinding bind(View view, Object component) {
        return (FragmentRematchBinding) bind(component, view, R.layout.fragment_rematch);
    }
}
