...
import com.soletreadmills.sole_v2.databinding.FragmentRematchBinding;
...
import com.soletreadmills.sole_v2.ui.club.ClubRaceViewModel;
...
public final class RematchFragment extends BaseFragment<FragmentRematchBinding> implements View.OnClickListener {
    ...
    private final RematchFragment$bluetoothCallbackListener$1 bluetoothCallbackListener = new BluetoothCallbackListener() { // from class: com.soletreadmills.sole_v2.ui.history.RematchFragment$bluetoothCallbackListener$1
        ...
        public void onReceiveFtmsData(String ftmsDataJsonStr, String className) throws InterruptedException, ClassNotFoundException, NumberFormatException {
            ...
            int iIntValue;
            AnimatedPathImgForLoop animatedPathImgForLoop;
            AnimatedPathImgForLoop animatedPathImgForLoop2;
            AnimatedPathImgForLoop animatedPathImgForLoop3;
            AnimatedPathImgForLoop animatedPathImgForLoop4;
            AnimatedPathImgForLoop animatedPathImgForLoop5;
            FragmentRematchBinding fragmentRematchBindingAccess$getBinding;
            AnimatedPathImgForLoop animatedPathImgForLoop6;
            AnimatedPathImgForLoop animatedPathImgForLoop7;
            AnimatedPathImgForLoop animatedPathImgForLoop8;
            if (className == null || ftmsDataJsonStr == null || RematchFragment.access$getBinding(this.this$0) == null || this.this$0.getIsFinish()) {
                return;
            }
            try {
            ...
            FragmentRematchBinding fragmentRematchBindingAccess$getBinding2 = RematchFragment.access$getBinding(this.this$0);
            if (fragmentRematchBindingAccess$getBinding2 == null || (animatedPathImgForLoop8 = fragmentRematchBindingAccess$getBinding2.animatedPathImageView) == null || !animatedPathImgForLoop8.getIsPaused()) {
                ...
                if (i3 != 1) {
                    if (i3 != 2) {
                        if (i3 != 3) {
                            if (i3 == 4) {
                                if ((ftmsBaseData instanceof StepClimberData) && (fragmentRematchBindingAccess$getBinding = RematchFragment.access$getBinding(this.this$0)) != null && (animatedPathImgForLoop6 = fragmentRematchBindingAccess$getBinding.animatedPathImageView) != null) {
                                    Double stepPerMinute = ((StepClimberData) ftmsBaseData).getStepPerMinute();
                                    animatedPathImgForLoop6.updateSpeed(stepPerMinute != null ? (float) stepPerMinute.doubleValue() : 0.0f);
                                }
                            } else if (i3 == 5 && (ftmsBaseData instanceof RowerData)) {
                                FragmentRematchBinding fragmentRematchBindingAccess$getBinding3 = RematchFragment.access$getBinding(this.this$0);
                                if (fragmentRematchBindingAccess$getBinding3 != null && (animatedPathImgForLoop7 = fragmentRematchBindingAccess$getBinding3.animatedPathImageView) != null) {
                                    Double instantaneousPace = ((RowerData) ftmsBaseData).getInstantaneousPace();
                                    animatedPathImgForLoop7.updateSpeed(instantaneousPace != null ? (float) instantaneousPace.doubleValue() : 0.0f);
                                }
                            ...
                            FragmentRematchBinding fragmentRematchBindingAccess$getBinding4 = RematchFragment.access$getBinding(this.this$0);
                            if (fragmentRematchBindingAccess$getBinding4 != null && (animatedPathImgForLoop5 = fragmentRematchBindingAccess$getBinding4.animatedPathImageView) != null) {
                                Double instantaneousSpeed = ((CrossTrainerData) ftmsBaseData).getInstantaneousSpeed();
                                animatedPathImgForLoop5.updateSpeed(instantaneousSpeed != null ? (float) instantaneousSpeed.doubleValue() : 0.0f);
                            }
                        ...
                        FragmentRematchBinding fragmentRematchBindingAccess$getBinding5 = RematchFragment.access$getBinding(this.this$0);
                        if (fragmentRematchBindingAccess$getBinding5 != null && (animatedPathImgForLoop4 = fragmentRematchBindingAccess$getBinding5.animatedPathImageView) != null) {
                            Double instantaneousSpeed2 = ((IndoorBikeData) ftmsBaseData).getInstantaneousSpeed();
                            animatedPathImgForLoop4.updateSpeed(instantaneousSpeed2 != null ? (float) instantaneousSpeed2.doubleValue() : 0.0f);
                        }
                    ...
                    FragmentRematchBinding fragmentRematchBindingAccess$getBinding6 = RematchFragment.access$getBinding(this.this$0);
                    if (fragmentRematchBindingAccess$getBinding6 != null && (animatedPathImgForLoop = fragmentRematchBindingAccess$getBinding6.animatedPathImageView) != null) {
                        Double instantaneousSpeed4 = treadmillData.getInstantaneousSpeed();
                        animatedPathImgForLoop.updateSpeed(instantaneousSpeed4 != null ? (float) instantaneousSpeed4.doubleValue() : 0.0f);
                    }
                ...
                FragmentRematchBinding fragmentRematchBindingAccess$getBinding7 = RematchFragment.access$getBinding(this.this$0);
                if (fragmentRematchBindingAccess$getBinding7 != null && (animatedPathImgForLoop3 = fragmentRematchBindingAccess$getBinding7.animatedPathImageView) != null) {
                    totalDistanceKm = animatedPathImgForLoop3.getTotalDistanceKm();
                }
                if (i >= totalDistanceKm * 1000) {
                    ...
                    FragmentRematchBinding fragmentRematchBindingAccess$getBinding8 = RematchFragment.access$getBinding(this.this$0);
                    if (fragmentRematchBindingAccess$getBinding8 != null && (animatedPathImgForLoop2 = fragmentRematchBindingAccess$getBinding8.animatedPathImageView) != null) {
                        animatedPathImgForLoop2.pauseAnimation();
                    }
        ...
        public void onReceiveFitnessMachineStatus(FitnessMachineStatusType fitnessMachineStatusType) {
            ...
            if (this.this$0.getIsStart()) {
                ...
                if (BleDataManager.getInstance().getNowTrainingStatusType() == TrainingStatusType.IDLE || nowFMSTypeOnlyFourType == FitnessMachineStatusType.FITNESS_MACHINE_STOPPED_BY_THE_USER || nowFMSTypeOnlyFourType == FitnessMachineStatusType.FITNESS_MACHINE_PAUSED_BY_THE_USER || (fragmentRematchBindingAccess$getBinding = RematchFragment.access$getBinding(this.this$0)) == null || (linearLayout = fragmentRematchBindingAccess$getBinding.start) == null) {
                    return;
                }
    ...
    /* JADX WARN: Type inference failed for: r0v4, types: [com.soletreadmills.sole_v2.ui.history.RematchFragment$bluetoothCallbackListener$1] */
    public RematchFragment() {
        final RematchFragment rematchFragment = this;
        final Function0 function0 = null;
        this.viewModel = FragmentViewModelLazyKt.createViewModelLazy(rematchFragment, Reflection.getOrCreateKotlinClass(ClubRaceViewModel.class), new Function0<ViewModelStore>() { // from class: com.soletreadmills.sole_v2.ui.history.RematchFragment$special$$inlined$activityViewModels$default$1
            {
                super(0);
            }
            ...
            public final ViewModelStore invoke() {
                ViewModelStore viewModelStore = rematchFragment.requireActivity().getViewModelStore();
                Intrinsics.checkNotNullExpressionValue(viewModelStore, "requireActivity().viewModelStore");
                return viewModelStore;
            }
        }, new Function0<CreationExtras>() { // from class: com.soletreadmills.sole_v2.ui.history.RematchFragment$special$$inlined$activityViewModels$default$2
            ...
            public final CreationExtras invoke() {
                ...
                CreationExtras defaultViewModelCreationExtras = rematchFragment.requireActivity().getDefaultViewModelCreationExtras();
                Intrinsics.checkNotNullExpressionValue(defaultViewModelCreationExtras, "requireActivity().defaultViewModelCreationExtras");
                return defaultViewModelCreationExtras;
            }
        }, new Function0<ViewModelProvider.Factory>() { // from class: com.soletreadmills.sole_v2.ui.history.RematchFragment$special$$inlined$activityViewModels$default$3
            {
                super(0);
            }
            ...
            public final ViewModelProvider.Factory invoke() {
                ViewModelProvider.Factory defaultViewModelProviderFactory = rematchFragment.requireActivity().getDefaultViewModelProviderFactory();
                Intrinsics.checkNotNullExpressionValue(defaultViewModelProviderFactory, "requireActivity().defaultViewModelProviderFactory");
                return defaultViewModelProviderFactory;
            }
        });
        this.activityViewModel = FragmentViewModelLazyKt.createViewModelLazy(rematchFragment, Reflection.getOrCreateKotlinClass(ActivityViewModel.class), new Function0<ViewModelStore>() { // from class: com.soletreadmills.sole_v2.ui.history.RematchFragment$special$$inlined$activityViewModels$default$4
            {
                super(0);
            }
        ...
        }, new Function0<CreationExtras>() { // from class: com.soletreadmills.sole_v2.ui.history.RematchFragment$special$$inlined$activityViewModels$default$5
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
        ...
        }, new Function0<ViewModelProvider.Factory>() { // from class: com.soletreadmills.sole_v2.ui.history.RematchFragment$special$$inlined$activityViewModels$default$6
            {
                super(0);
            }
    ...
    public static final /* synthetic */ FragmentRematchBinding access$getBinding(RematchFragment rematchFragment) {
        return rematchFragment.getBinding();
    }
    ...
    public void onResume() {
        ...
        CharSequence text;
        String string;
        FragmentRematchBinding binding;
        View root;
        super.onResume();
        FragmentRematchBinding binding2 = getBinding();
        ...
        root.postDelayed(new Runnable() { // from class: com.soletreadmills.sole_v2.ui.history.RematchFragment$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                RematchFragment.onResume$lambda$0(this.f$0);
            }
        }, 3000L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void onResume$lambda$0(RematchFragment this$0) {
    ...
    public void onStop() {
        AnimatedPathImgForLoop animatedPathImgForLoop;
        super.onStop();
        FragmentRematchBinding binding = getBinding();
        if (binding == null || (animatedPathImgForLoop = binding.animatedPathImageView) == null) {
            return;
        }
        animatedPathImgForLoop.stopAnimation();
    }
    ...
    public FragmentRematchBinding inflateBinding(LayoutInflater inflater, ViewGroup container) {
        Intrinsics.checkNotNullParameter(inflater, "inflater");
        FragmentRematchBinding fragmentRematchBindingInflate = FragmentRematchBinding.inflate(inflater, container, false);
        Intrinsics.checkNotNullExpressionValue(fragmentRematchBindingInflate, "inflate(...)");
        return fragmentRematchBindingInflate;
    }
    ...
    public void initViews() throws IOException {
        ...
        this.workoutData = getActivityViewModel().getWorkoutData();
        MainActivity mainActivity = getMainActivity();
        ...
        onBackPressedDispatcher.addCallback(viewLifecycleOwner, new OnBackPressedCallback() { // from class: com.soletreadmills.sole_v2.ui.history.RematchFragment.initViews.2
    ...
    @DebugMetadata(c = "com.soletreadmills.sole_v2.ui.history.RematchFragment$initViews$1", f = "RematchFragment.kt", i = {}, l = {138}, m = "invokeSuspend", n = {}, s = {})
    /* renamed from: com.soletreadmills.sole_v2.ui.history.RematchFragment$initViews$1, reason: invalid class name */
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return RematchFragment.this.new AnonymousClass1(continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                StateFlow<List<DisplaySelectStatsData>> selectedList = RematchFragment.this.getViewModel().getSelectedList();
                final RematchFragment rematchFragment = RematchFragment.this;
                this.label = 1;
                if (selectedList.collect(new FlowCollector() { // from class: com.soletreadmills.sole_v2.ui.history.RematchFragment.initViews.1.1
                    ...
                    public final Object emit(List<DisplaySelectStatsData> list, Continuation<? super Unit> continuation) {
                        rematchFragment.setDisplayView(list);
    ...
    public void onClick(View v) {
        ...
        if (numValueOf != null && numValueOf.intValue() == i2) {
            MainActivity mainActivity = getMainActivity();
            if (mainActivity == null || (bleManager = mainActivity.getBleManager()) == null || !bleManager.isConnectedFtms() || (workoutViewVo = this.workoutData) == null) {
                return;
            }
            BleDataManager.getInstance().uploadSummaryData();
            FragmentRematchBinding binding = getBinding();
            AnimatedPathImgForLoop animatedPathImgForLoop = binding != null ? binding.animatedPathImageView : null;
            if (animatedPathImgForLoop != null) {
                animatedPathImgForLoop.setOtherUsersDataList(CollectionsKt.mutableListOf(workoutViewVo));
            }
            TrainingStatusType nowTrainingStatusType = BleDataManager.getInstance().getNowTrainingStatusType();
            FitnessMachineStatusType nowFMSTypeOnlyFourType = BleDataManager.getInstance().getNowFMSTypeOnlyFourType();
            if (nowTrainingStatusType == TrainingStatusType.IDLE) {
                ...
                if (nowFMSTypeOnlyFourType == FitnessMachineStatusType.FITNESS_MACHINE_STOPPED_BY_THE_USER || nowFMSTypeOnlyFourType == FitnessMachineStatusType.FITNESS_MACHINE_STOPPED_BY_SAFETY_KEY || nowFMSTypeOnlyFourType == FitnessMachineStatusType.FITNESS_MACHINE_PAUSED_BY_THE_USER) {
                    return;
                }
                startRace();
                return;
    ...
    public final void setRaceView() throws IOException {
        ...
        FragmentRematchBinding binding = getBinding();
        TextView textView = binding != null ? binding.tvDistance : null;
        String str = "";
        if (textView != null) {
            textView.setText("" + workoutViewVo.getTotalDistance() + 'K');
        }
        FragmentRematchBinding binding2 = getBinding();
        if (binding2 != null && (animatedPathImgForLoop5 = binding2.animatedPathImageView) != null) {
            Double totalDistance = workoutViewVo.getTotalDistance();
            animatedPathImgForLoop5.setTotalDistance(totalDistance != null ? (float) totalDistance.doubleValue() : 0.0f);
        }
        FragmentRematchBinding binding3 = getBinding();
        if (binding3 != null && (animatedPathImgForLoop4 = binding3.animatedPathImageView) != null) {
            animatedPathImgForLoop4.updateSpeed(480.0f);
        }
        FragmentRematchBinding binding4 = getBinding();
        if (binding4 != null && (animatedPathImgForLoop3 = binding4.animatedPathImageView) != null) {
            animatedPathImgForLoop3.resetView();
        }
        Timber.INSTANCE.e("startAnimation", new Object[0]);
        FragmentRematchBinding binding5 = getBinding();
        if (binding5 != null && (animatedPathImgForLoop2 = binding5.animatedPathImageView) != null) {
            animatedPathImgForLoop2.stopAnimation();
        }
        changeScaleFactor();
        ...
        FragmentRematchBinding binding6 = getBinding();
        if (binding6 == null || (animatedPathImgForLoop = binding6.animatedPathImageView) == null) {
            return;
        }
        animatedPathImgForLoop.setMainUserBitmap(str);
    }

    /* compiled from: RematchFragment.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {1, 9, 0}, xi = 48)
    @DebugMetadata(c = "com.soletreadmills.sole_v2.ui.history.RematchFragment$setProgressBar$1", f = "RematchFragment.kt", i = {}, l = {264}, m = "invokeSuspend", n = {}, s = {})
    /* renamed from: com.soletreadmills.sole_v2.ui.history.RematchFragment$setProgressBar$1, reason: invalid class name and case insensitive filesystem */
    static final class C09771 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return RematchFragment.this.new C09771(continuation);
        }
        ...
        /* compiled from: RematchFragment.kt */
        @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {1, 9, 0}, xi = 48)
        @DebugMetadata(c = "com.soletreadmills.sole_v2.ui.history.RematchFragment$setProgressBar$1$1", f = "RematchFragment.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
        /* renamed from: com.soletreadmills.sole_v2.ui.history.RematchFragment$setProgressBar$1$1, reason: invalid class name and collision with other inner class name */
        static final class C02521 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            int label;
            final /* synthetic */ RematchFragment this$0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C02521(RematchFragment rematchFragment, Continuation<? super C02521> continuation) {
                super(2, continuation);
                this.this$0 = rematchFragment;
            }

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new C02521(this.this$0, continuation);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                ResultKt.throwOnFailure(obj);
                FragmentRematchBinding fragmentRematchBindingAccess$getBinding = RematchFragment.access$getBinding(this.this$0);
                if (fragmentRematchBindingAccess$getBinding == null) {
                    return Unit.INSTANCE;
                }
                AnimatedPathImgForLoop animatedPathImgForLoop = fragmentRematchBindingAccess$getBinding.animatedPathImageView;
                float currentDistance = animatedPathImgForLoop != null ? animatedPathImgForLoop.getCurrentDistance() : 0.0f;
                AnimatedPathImgForLoop animatedPathImgForLoop2 = fragmentRematchBindingAccess$getBinding.animatedPathImageView;
                float fCoerceIn = RangesKt.coerceIn(currentDistance / (animatedPathImgForLoop2 != null ? animatedPathImgForLoop2.getTotalDistanceKm() : 0.0f), 0.0f, 1.0f) * 100;
                ProgressBar progressBar = fragmentRematchBindingAccess$getBinding.progressBar;
                if (progressBar != null) {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                LifecycleOwner viewLifecycleOwner = RematchFragment.this.getViewLifecycleOwner();
                Intrinsics.checkNotNullExpressionValue(viewLifecycleOwner, "getViewLifecycleOwner(...)");
                this.label = 1;
                if (RepeatOnLifecycleKt.repeatOnLifecycle(viewLifecycleOwner, Lifecycle.State.RESUMED, new C02521(RematchFragment.this, null), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (i != 1) {
    ...
    public final void setProgressBar() {
        LifecycleOwner viewLifecycleOwner = getViewLifecycleOwner();
        Intrinsics.checkNotNullExpressionValue(viewLifecycleOwner, "getViewLifecycleOwner(...)");
        BuildersKt__Builders_commonKt.launch$default(LifecycleOwnerKt.getLifecycleScope(viewLifecycleOwner), null, null, new C09771(null), 3, null);
    }
    ...
    public final void changeScaleFactor() {
        ...
        animatedPathImgForLoop.setScaleFactor(3.0f);
    }
    ...
    public final void openSelectDisplayStatsView(int pos) {
        ...
        changeViewManager.changePage(new DisplayStatsSelectCustom(mainActivity, string, getViewModel().getStatsList().getValue(), new DisplayStatsSelectCustom.BottomDialogCustomListener() { // from class: com.soletreadmills.sole_v2.ui.history.RematchFragment$openSelectDisplayStatsView$1$1
    ...
    public final void startRace() {
        ...
        FragmentRematchBinding binding3 = getBinding();
        if (binding3 != null && (animatedPathImgForLoop = binding3.animatedPathImageView) != null) {
            animatedPathImgForLoop.setOtherUsers();
        }
        this.isStart = true;
        BuildersKt__Builders_commonKt.launch$default(LifecycleOwnerKt.getLifecycleScope(this), null, null, new C09781(null), 3, null);
    }

    /* compiled from: RematchFragment.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {1, 9, 0}, xi = 48)
    @DebugMetadata(c = "com.soletreadmills.sole_v2.ui.history.RematchFragment$startRace$1", f = "RematchFragment.kt", i = {}, l = {315}, m = "invokeSuspend", n = {}, s = {})
    /* renamed from: com.soletreadmills.sole_v2.ui.history.RematchFragment$startRace$1, reason: invalid class name and case insensitive filesystem */
    static final class C09781 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        int label;

        C09781(Continuation<? super C09781> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return RematchFragment.this.new C09781(continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            FragmentRematchBinding fragmentRematchBindingAccess$getBinding = RematchFragment.access$getBinding(RematchFragment.this);
            ConstraintLayout constraintLayout = fragmentRematchBindingAccess$getBinding != null ? fragmentRematchBindingAccess$getBinding.layoutTopView : null;
            if (constraintLayout != null) {
                constraintLayout.setVisibility(8);
            }
            FragmentRematchBinding fragmentRematchBindingAccess$getBinding2 = RematchFragment.access$getBinding(RematchFragment.this);
            if (fragmentRematchBindingAccess$getBinding2 != null && (animatedPathImgForLoop = fragmentRematchBindingAccess$getBinding2.animatedPathImageView) != null) {
                animatedPathImgForLoop.startAnimation();
            }
            RematchFragment.this.showDisplayInfo();
            return Unit.INSTANCE;
        }
    }
    ...
    public final void finishRace() {
        ...
        root.postDelayed(new Runnable() { // from class: com.soletreadmills.sole_v2.ui.history.RematchFragment$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                RematchFragment.finishRace$lambda$2(this.f$0);
            }
        }, 3000L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void finishRace$lambda$2(RematchFragment this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.safeNavigateUp();
    }
        ...
        if (list.size() >= 4) {
            for (int i = 0; i < 4; i++) {
                ...
                if (i == 0) {
                    ...
                    FragmentRematchBinding binding7 = getBinding();
                    ImageView imageView4 = binding7 != null ? binding7.imgDisplay4 : null;
                    FragmentRematchBinding binding8 = getBinding();
    ...
    */
    private final java.lang.String getDisplayValue(com.soletreadmills.sole_v2._type.DisplayStatsType r19, com.soletreadmills.sole_v2.ble.data.FtmsBaseData r20) throws java.lang.NumberFormatException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.soletreadmills.sole_v2.ui.history.RematchFragment.getDisplayValue(com.soletreadmills.sole_v2._type.DisplayStatsType, com.soletreadmills.sole_v2.ble.data.FtmsBaseData):java.lang.String");
    }
    ...
    public final double calculateMets(Double speed, Double inclinePercent, Double watt) throws NumberFormatException {
        RematchFragment rematchFragment;
        double d;
        double d2;
        double d3;
        String weight;
        ...
        try {
            int i = WhenMappings.$EnumSwitchMapping$0[rematchFragment.bleFtmsMachineType.ordinal()];
            if (i == 3) {
    ...
    public final void setBlueToothConnectStatus() {
        ...
        root.post(new Runnable() { // from class: com.soletreadmills.sole_v2.ui.history.RematchFragment$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                RematchFragment.setBlueToothConnectStatus$lambda$5(this.f$0);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void setBlueToothConnectStatus$lambda$5(RematchFragment this$0) {
        ImageView imageView;
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        ...
        if (zIsConnectedHr) {
            FragmentRematchBinding binding = this$0.getBinding();
            ImageView imageView2 = binding != null ? binding.imgWatch : null;
            if (imageView2 != null) {
                imageView2.setVisibility(0);
            }
        } else {
            FragmentRematchBinding binding2 = this$0.getBinding();
        ...
        if (zIsConnectedFtms) {
            FragmentRematchBinding binding3 = this$0.getBinding();
        ...
        FragmentRematchBinding binding4 = this$0.getBinding();
    ...
    public final void isPaused(FitnessMachineStatusType fitnessMachineStatusType) {
        ...
        if (fitnessMachineStatusType == FitnessMachineStatusType.FITNESS_MACHINE_PAUSED_BY_THE_USER || fitnessMachineStatusType == FitnessMachineStatusType.FITNESS_MACHINE_STOPPED_BY_THE_USER) {
            ...
            animatedPathImgForLoop.pauseAnimation();
            return;
        }
        FragmentRematchBinding binding2 = getBinding();
        if (binding2 == null || (animatedPathImgForLoop2 = binding2.animatedPathImageView) == null) {
            return;
        }
        animatedPathImgForLoop2.resumeAnimation();
    }
}
