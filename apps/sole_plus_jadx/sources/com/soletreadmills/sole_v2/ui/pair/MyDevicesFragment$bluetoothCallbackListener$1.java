...
public final class MyDevicesFragment$bluetoothCallbackListener$1 implements BluetoothCallbackListener {
    ...
    MyDevicesFragment$bluetoothCallbackListener$1(MyDevicesFragment myDevicesFragment) {
    ...
    public void onConnected(BluetoothCallbackListener.DeviceType deviceType, String macAddress) {
        FragmentMyDevicesBinding fragmentMyDevicesBindingAccess$getBinding;
        View root;
        Intrinsics.checkNotNullParameter(deviceType, "deviceType");
        Intrinsics.checkNotNullParameter(macAddress, "macAddress");
        BleDeviceInfoData connectFtmsBleDeviceInfoData = this.this$0.getConnectFtmsBleDeviceInfoData();
        if (!Intrinsics.areEqual(connectFtmsBleDeviceInfoData != null ? connectFtmsBleDeviceInfoData.getAddress() : null, macAddress) || (fragmentMyDevicesBindingAccess$getBinding = MyDevicesFragment.access$getBinding(this.this$0)) == null || (root = fragmentMyDevicesBindingAccess$getBinding.getRoot()) == null) {
            return;
        }
        final MyDevicesFragment myDevicesFragment = this.this$0;
        root.post(new Runnable() { // from class: com.soletreadmills.sole_v2.ui.pair.MyDevicesFragment$bluetoothCallbackListener$1$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() throws CloneNotSupportedException {
                MyDevicesFragment$bluetoothCallbackListener$1.onConnected$lambda$0(myDevicesFragment);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void onConnected$lambda$0(MyDevicesFragment this$0) throws CloneNotSupportedException {
    ...
    public void onDisconnected(BluetoothCallbackListener.DeviceType deviceType, String macAddress) {
        ...
        Intrinsics.checkNotNullParameter(deviceType, "deviceType");
        Intrinsics.checkNotNullParameter(macAddress, "macAddress");
        if (this.this$0.getIsEdit() || (fragmentMyDevicesBindingAccess$getBinding = MyDevicesFragment.access$getBinding(this.this$0)) == null || (root = fragmentMyDevicesBindingAccess$getBinding.getRoot()) == null) {
            return;
        }
        final MyDevicesFragment myDevicesFragment = this.this$0;
        root.post(new Runnable() { // from class: com.soletreadmills.sole_v2.ui.pair.MyDevicesFragment$bluetoothCallbackListener$1$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() throws CloneNotSupportedException {
                MyDevicesFragment$bluetoothCallbackListener$1.onDisconnected$lambda$1(myDevicesFragment);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void onDisconnected$lambda$1(MyDevicesFragment this$0) throws CloneNotSupportedException {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.setRecyclerview();
    }
}
