...
public final class HomeMainFragment$bluetoothCallbackListener$1 implements BluetoothCallbackListener {
    ...
    HomeMainFragment$bluetoothCallbackListener$1(HomeMainFragment homeMainFragment) {
    ...
    public void onConnected(BluetoothCallbackListener.DeviceType deviceType, String macAddress) {
        ...
        if (fragmentHomeMainBindingAccess$getBinding != null && (root = fragmentHomeMainBindingAccess$getBinding.getRoot()) != null) {
            final HomeMainFragment homeMainFragment = this.this$0;
            root.post(new Runnable() { // from class: com.soletreadmills.sole_v2.ui.home.HomeMainFragment$bluetoothCallbackListener$1$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() throws CloneNotSupportedException {
                    HomeMainFragment$bluetoothCallbackListener$1.onConnected$lambda$0(homeMainFragment);
                }
            });
        }
    ...
    public static final void onConnected$lambda$0(HomeMainFragment this$0) throws CloneNotSupportedException {
    ...
    public void onDisconnected(BluetoothCallbackListener.DeviceType deviceType, String macAddress) {
        ...
        if (fragmentHomeMainBindingAccess$getBinding != null && (root = fragmentHomeMainBindingAccess$getBinding.getRoot()) != null) {
            final HomeMainFragment homeMainFragment = this.this$0;
            root.post(new Runnable() { // from class: com.soletreadmills.sole_v2.ui.home.HomeMainFragment$bluetoothCallbackListener$1$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() throws CloneNotSupportedException {
                    HomeMainFragment$bluetoothCallbackListener$1.onDisconnected$lambda$1(homeMainFragment);
                }
            });
        }
        this.this$0.isUserClickConnectBtn = false;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void onDisconnected$lambda$1(HomeMainFragment this$0) throws CloneNotSupportedException {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.setConnectRecyclerView();
    }

    @Override // com.soletreadmills.sole_v2.listener.BluetoothCallbackListener
    public void onReceiveTrainingStatus(TrainingStatusType trainingStatusType) throws CloneNotSupportedException {
        this.this$0.setConnectRecyclerView();
    }

    @Override // com.soletreadmills.sole_v2.listener.BluetoothCallbackListener
    public void onReceiveFitnessMachineControlPoint(FitnessMachineControlPointResponseData fitnessMachineControlPointResponseData) throws CloneNotSupportedException {
        Timber.INSTANCE.e("fitnessMachineControlPointResponseData opCodeType :%s", fitnessMachineControlPointResponseData != null ? fitnessMachineControlPointResponseData.getOpCodeType() : null);
        if ((fitnessMachineControlPointResponseData != null ? fitnessMachineControlPointResponseData.getOpCodeType() : null) == FitnessMachineControlPointOpCode.Type.SUPPORT_PROGRAM) {
            this.this$0.setConnectRecyclerView();
        }
    }
}
