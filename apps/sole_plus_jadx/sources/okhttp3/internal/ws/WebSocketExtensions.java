            ...
            for (int i = 0; i < size; i++) {
                if (StringsKt.equals(responseHeaders.name(i), "Sec-WebSocket-Extensions", true)) {
                    ...
                    while (i2 < strValue.length()) {
                        int iDelimiterOffset$default = Util.delimiterOffset$default(strValue, AbstractJsonLexerKt.COMMA, i2, 0, 4, (Object) null);
                        ...
                        if (StringsKt.equals(strTrimSubstring, "permessage-deflate", true)) {
                            ...
                            while (i2 < iDelimiterOffset$default) {
                                ...
                                int iDelimiterOffset3 = Util.delimiterOffset(strValue, SignatureVisitor.INSTANCEOF, i2, iDelimiterOffset2);
