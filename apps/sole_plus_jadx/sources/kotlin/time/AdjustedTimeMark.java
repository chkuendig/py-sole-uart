...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo10404minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m10550minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo10403elapsedNowUwyO8pc() {
        return Duration.m10448minusLRDsOJo(this.mark.mo10403elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo10406plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m10449plusLRDsOJo(this.adjustment, duration), null);
    }
}
