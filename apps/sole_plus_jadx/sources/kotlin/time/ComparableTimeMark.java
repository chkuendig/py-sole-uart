...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark mo10404minusLRDsOJo(long duration);

    /* renamed from: minus-UwyO8pc */
    long mo10405minusUwyO8pc(ComparableTimeMark other);

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    ComparableTimeMark mo10406plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static ComparableTimeMark m10408minusLRDsOJo(ComparableTimeMark comparableTimeMark, long j) {
            return comparableTimeMark.mo10406plusLRDsOJo(Duration.m10466unaryMinusUwyO8pc(j));
        }

        public static int compareTo(ComparableTimeMark comparableTimeMark, ComparableTimeMark other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Duration.m10412compareToLRDsOJo(comparableTimeMark.mo10405minusUwyO8pc(other), Duration.INSTANCE.m10516getZEROUwyO8pc());
        }
    }
}
