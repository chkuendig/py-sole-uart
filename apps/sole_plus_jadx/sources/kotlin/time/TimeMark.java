...
public interface TimeMark {
    ...
    TimeMark mo10404minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo10406plusLRDsOJo(long duration);

    /* compiled from: TimeSource.kt */
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m10551plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m10550minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo10406plusLRDsOJo(Duration.m10466unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m10446isNegativeimpl(timeMark.mo10403elapsedNowUwyO8pc());
        }
