...
public final class DurationKt {
    ...
    private static final long m10540timesmvk6XK0(int i, long j) {
        return Duration.m10451timesUwyO8pc(j, i);
    }

    /* renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m10539timeskIfJnKk(double d, long j) {
        return Duration.m10450timesUwyO8pc(j, d);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long jM10516getZEROUwyO8pc = Duration.Companion.m10516getZEROUwyO8pc();
        char cCharAt3 = str.charAt(0);
        int length2 = (cCharAt3 == '+' || cCharAt3 == '-') ? 1 : 0;
        boolean z4 = length2 > 0;
        Object obj = null;
        boolean z5 = z4 && StringsKt.startsWith$default((CharSequence) str, SignatureVisitor.SUPER, false, 2, (Object) null);
        if (length <= length2) {
        ...
        if (str.charAt(length2) == 'P') {
            ...
            while (i < length) {
                if (str.charAt(i) != 'T') {
                    ...
                    if (durationUnitDurationUnitByIsoChar == DurationUnit.SECONDS && iIndexOf$default > 0) {
                        ...
                        long jM10449plusLRDsOJo = Duration.m10449plusLRDsOJo(jM10516getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring2), durationUnitDurationUnitByIsoChar));
                        Intrinsics.checkNotNull(strSubstring, "null cannot be cast to non-null type java.lang.String");
                        String strSubstring3 = strSubstring.substring(iIndexOf$default);
                        Intrinsics.checkNotNullExpressionValue(strSubstring3, "substring(...)");
                        jM10516getZEROUwyO8pc = Duration.m10449plusLRDsOJo(jM10449plusLRDsOJo, toDuration(Double.parseDouble(strSubstring3), durationUnitDurationUnitByIsoChar));
                    } else {
                        jM10516getZEROUwyO8pc = Duration.m10449plusLRDsOJo(jM10516getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring), durationUnitDurationUnitByIsoChar));
                    }
            ...
            if (StringsKt.regionMatches(str, length2, "Infinity", 0, Math.max(length - length2, "Infinity".length()), true)) {
                jM10516getZEROUwyO8pc = Duration.Companion.m10514getINFINITEUwyO8pc();
            } else {
                boolean z7 = !z4;
                ...
                while (length2 < length) {
                    ...
                    if (iIndexOf$default2 > 0) {
                        ...
                        long jM10449plusLRDsOJo2 = Duration.m10449plusLRDsOJo(jM10516getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring6), durationUnitDurationUnitByShortName));
                        Intrinsics.checkNotNull(strSubstring4, "null cannot be cast to non-null type java.lang.String");
                        ...
                        jM10516getZEROUwyO8pc = Duration.m10449plusLRDsOJo(jM10449plusLRDsOJo2, toDuration(Double.parseDouble(strSubstring7), durationUnitDurationUnitByShortName));
                        if (length2 < length) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        jM10516getZEROUwyO8pc = Duration.m10449plusLRDsOJo(jM10516getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring4), durationUnitDurationUnitByShortName));
                    }
                    str4 = str6;
        ...
        return z2 ? Duration.m10466unaryMinusUwyO8pc(jM10516getZEROUwyO8pc) : jM10516getZEROUwyO8pc;
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m10413constructorimpl(j << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m10413constructorimpl((j << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m10413constructorimpl((j << 1) + i);
    }
