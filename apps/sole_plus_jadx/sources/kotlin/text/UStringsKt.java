...
public final class UStringsKt {
    ...
    public static final String m10400toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m10402toStringolVBNx4(short s, int i) {
    ...
    public static final String m10401toStringV7xB4Y4(int i, int i2) {
        return UnsignedKt.ulongToString(i & 4294967295L, CharsKt.checkRadix(i2));
    }

    /* renamed from: toString-JSWoG40, reason: not valid java name */
    public static final String m10399toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compareUnsigned(data, UInt.m9182constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m9099boximpl(UByte.m9105constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m9182constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m9362boximpl(UShort.m9368constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM9182constructorimpl = UInt.m9182constructorimpl(i);
        ...
        while (i2 < length) {
            ...
            if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                if (iDivideUnsigned == 119304647) {
                    iDivideUnsigned = Integer.divideUnsigned(-1, iM9182constructorimpl);
                    if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            int iM9182constructorimpl2 = UInt.m9182constructorimpl(i3 * iM9182constructorimpl);
            int iM9182constructorimpl3 = UInt.m9182constructorimpl(UInt.m9182constructorimpl(iDigitOf) + iM9182constructorimpl2);
            if (Integer.compareUnsigned(iM9182constructorimpl3, iM9182constructorimpl2) < 0) {
                return null;
            }
            i2++;
            i3 = iM9182constructorimpl3;
        }
        return UInt.m9176boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM9261constructorimpl = ULong.m9261constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                if (jDivideUnsigned == 512409557603043100L) {
                    jDivideUnsigned = Long.divideUnsigned(-1L, jM9261constructorimpl);
                    if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            long jM9261constructorimpl2 = ULong.m9261constructorimpl(j * jM9261constructorimpl);
            long jM9261constructorimpl3 = ULong.m9261constructorimpl(ULong.m9261constructorimpl(UInt.m9182constructorimpl(r13) & 4294967295L) + jM9261constructorimpl2);
            if (Long.compareUnsigned(jM9261constructorimpl3, jM9261constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j = jM9261constructorimpl3;
        }
        return ULong.m9255boximpl(j);
    }
}
