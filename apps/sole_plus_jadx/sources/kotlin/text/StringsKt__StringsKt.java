...
public class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
    ...
    public static final boolean toBooleanStrict(String str) {
        ...
        if (Intrinsics.areEqual(str, SdkConstants.VALUE_FALSE)) {
            return false;
        }
    ...
    public static final Boolean toBooleanStrictOrNull(String str) {
        ...
        return Intrinsics.areEqual(str, SdkConstants.VALUE_FALSE) ? false : null;
    }
