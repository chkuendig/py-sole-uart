...
public final class HexExtensionsKt {
    ...
    private static final int checkFormatLength(long j) {
        if (0 > j || j > SieveCacheKt.NodeLinkMask) {
            throw new IllegalArgumentException("The resulting string length is too big: " + ((Object) ULong.m9307toStringimpl(ULong.m9261constructorimpl(j))));
        }
        return (int) j;
    }
