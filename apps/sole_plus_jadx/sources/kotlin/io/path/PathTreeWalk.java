...
public final class PathTreeWalk implements Sequence<Path> {
    ...
    @DebugMetadata(c = "kotlin.io.path.PathTreeWalk$dfsIterator$1", f = "PathTreeWalk.kt", i = {0, 0, 0, 0, 0, 0, 1, 1, 1, 2, 2, 2, 2, 2, 2, 3, 3, 3}, l = {192, 198, 211, WinError.ERROR_EXE_CANNOT_MODIFY_SIGNED_BINARY}, m = "invokeSuspend", n = {"$this$iterator", IInstrumentationResultParser.StatusKeys.STACK, "entriesReader", "startNode", "this_$iv", "path$iv", "$this$iterator", IInstrumentationResultParser.StatusKeys.STACK, "entriesReader", "$this$iterator", IInstrumentationResultParser.StatusKeys.STACK, "entriesReader", "pathNode", "this_$iv", "path$iv", "$this$iterator", IInstrumentationResultParser.StatusKeys.STACK, "entriesReader"}, s = {"L$0", "L$1", "L$2", "L$3", "L$4", "L$5", "L$0", "L$1", "L$2", "L$0", "L$1", "L$2", "L$3", "L$4", "L$5", "L$0", "L$1", "L$2"})
    /* renamed from: kotlin.io.path.PathTreeWalk$dfsIterator$1, reason: invalid class name and case insensitive filesystem */
    static final class C12981 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super Path>, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C12981 c12981 = PathTreeWalk.this.new C12981(continuation);
            c12981.L$0 = obj;
            return c12981;
        }
        ...
        public final Object invoke(SequenceScope<? super Path> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C12981) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r19) throws java.nio.file.FileSystemLoopException {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlin.io.path.PathTreeWalk.C12981.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }

    private final Iterator<Path> dfsIterator() {
        return SequencesKt.iterator(new C12981(null));
    }
