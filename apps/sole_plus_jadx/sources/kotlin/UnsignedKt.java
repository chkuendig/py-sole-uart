...
public final class UnsignedKt {
    ...
    public static final int m9439uintRemainderJ1ME1BU(int i, int i2) {
        return UInt.m9182constructorimpl((int) ((i & 4294967295L) % (i2 & 4294967295L)));
    }

    /* renamed from: uintDivide-J1ME1BU, reason: not valid java name */
    public static final int m9438uintDivideJ1ME1BU(int i, int i2) {
        return UInt.m9182constructorimpl((int) ((i & 4294967295L) / (i2 & 4294967295L)));
    }

    /* renamed from: ulongDivide-eb3DHEI, reason: not valid java name */
    public static final long m9440ulongDivideeb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compareUnsigned(j, j2) < 0 ? ULong.m9261constructorimpl(0L) : ULong.m9261constructorimpl(1L);
        }
        if (j >= 0) {
            return ULong.m9261constructorimpl(j / j2);
        }
        long j3 = ((j >>> 1) / j2) << 1;
        return ULong.m9261constructorimpl(j3 + (Long.compareUnsigned(ULong.m9261constructorimpl(j - (j3 * j2)), ULong.m9261constructorimpl(j2)) < 0 ? 0 : 1));
    }

    /* renamed from: ulongRemainder-eb3DHEI, reason: not valid java name */
    public static final long m9441ulongRemaindereb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compareUnsigned(j, j2) < 0 ? j : ULong.m9261constructorimpl(j - j2);
        }
        if (j >= 0) {
            return ULong.m9261constructorimpl(j % j2);
        }
        long j3 = j - ((((j >>> 1) / j2) << 1) * j2);
        if (Long.compareUnsigned(ULong.m9261constructorimpl(j3), ULong.m9261constructorimpl(j2)) < 0) {
            j2 = 0;
        }
        return ULong.m9261constructorimpl(j3 - j2);
    }
    ...
    public static final int doubleToUInt(double d) {
        ...
        if (d <= 2.147483647E9d) {
            return UInt.m9182constructorimpl((int) d);
        }
        return UInt.m9182constructorimpl(UInt.m9182constructorimpl((int) (d - Integer.MAX_VALUE)) + UInt.m9182constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double d) {
        ...
        if (d < 9.223372036854776E18d) {
            return ULong.m9261constructorimpl((long) d);
        }
        return ULong.m9261constructorimpl(ULong.m9261constructorimpl((long) (d - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
