...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM9087constructorimpl = Result.m9087constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM9087constructorimpl = Result.m9087constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m9093isFailureimpl(objM9087constructorimpl) ? null : objM9087constructorimpl);
