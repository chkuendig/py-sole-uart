...
public final class PublisherCoroutine<T> extends AbstractCoroutine<Unit> implements ProducerScope<T>, Subscription {
    ...
    static final class C13961 extends ContinuationImpl {
        ...
        C13961(PublisherCoroutine<? super T> publisherCoroutine, Continuation<? super C13961> continuation) {
            super(continuation);
    ...
    public /* bridge */ /* synthetic */ void mo10659invokeOnClose(Function1 function1) {
    ...
    public Object mo10590trySendJP2dKIU(T element) {
        if (!Mutex.DefaultImpls.tryLock$default(this.mutex, null, 1, null)) {
        ...
        return ChannelResult.INSTANCE.m10614closedJP2dKIU(thDoLockedNext);
    }
    ...
    */
    public java.lang.Object send(T r5, kotlin.coroutines.Continuation<? super kotlin.Unit> r6) throws java.lang.Throwable {
        /*
            r4 = this;
            boolean r0 = r6 instanceof kotlinx.coroutines.reactive.PublisherCoroutine.C13961
            if (r0 == 0) goto L14
            r0 = r6
            kotlinx.coroutines.reactive.PublisherCoroutine$send$1 r0 = (kotlinx.coroutines.reactive.PublisherCoroutine.C13961) r0
            int r1 = r0.label
