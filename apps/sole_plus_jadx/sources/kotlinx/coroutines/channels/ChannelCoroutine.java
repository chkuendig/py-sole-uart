...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public void mo10659invokeOnClose(Function1<? super Throwable, Unit> handler) {
        this._channel.mo10659invokeOnClose(handler);
    }
    ...
    public Object mo10594receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo10594receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo10595tryReceivePtdJZtk() {
        return this._channel.mo10595tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo10590trySendJP2dKIU(E element) {
        return this._channel.mo10590trySendJP2dKIU(element);
    }
