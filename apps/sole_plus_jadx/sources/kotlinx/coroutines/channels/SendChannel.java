...
public interface SendChannel<E> {
    ...
    void mo10659invokeOnClose(Function1<? super Throwable, Unit> handler);
    ...
    Object mo10590trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m10611isSuccessimpl(objMo10590trySendJP2dKIU)) {
                return true;
            }
            Throwable thM10605exceptionOrNullimpl = ChannelResult.m10605exceptionOrNullimpl(objMo10590trySendJP2dKIU);
