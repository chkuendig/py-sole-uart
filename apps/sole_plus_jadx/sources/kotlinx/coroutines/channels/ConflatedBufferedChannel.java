...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM10618trySendImplMj0NB7M = conflatedBufferedChannel.m10618trySendImplMj0NB7M(e, true);
        if (objM10618trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m10605exceptionOrNullimpl(objM10618trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM10618trySendImplMj0NB7M = conflatedBufferedChannel.m10618trySendImplMj0NB7M(e, true);
        if (!(objM10618trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo10590trySendJP2dKIU(E element) {
        return m10618trySendImplMj0NB7M(element, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m10618trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m10617trySendDropLatestMj0NB7M(element, isSendOp) : m10596trySendDropOldestJP2dKIU(element);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m10617trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo10590trySendJP2dKIU = super.mo10590trySendJP2dKIU(element);
        if (ChannelResult.m10611isSuccessimpl(objMo10590trySendJP2dKIU) || ChannelResult.m10609isClosedimpl(objMo10590trySendJP2dKIU)) {
            return objMo10590trySendJP2dKIU;
        }
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo10590trySendJP2dKIU = mo10590trySendJP2dKIU(element);
        if (!(objMo10590trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo10590trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m10605exceptionOrNullimpl(objMo10590trySendJP2dKIU);
