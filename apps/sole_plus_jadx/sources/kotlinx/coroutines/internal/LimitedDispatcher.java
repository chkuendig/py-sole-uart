...
public final class LimitedDispatcher extends CoroutineDispatcher implements Delay {
    ...
    public void mo10647scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        this.$$delegate_0.mo10647scheduleResumeAfterDelay(timeMillis, continuation);
    }
        ...
        public void run() {
            ...
            while (true) {
                ...
                if (i >= 16 && LimitedDispatcher.this.dispatcher.isDispatchNeeded(LimitedDispatcher.this)) {
                    LimitedDispatcher.this.dispatcher.mo10646dispatch(LimitedDispatcher.this, this);
                    return;
                }
            }
        }
    ...
    public void mo10646dispatch(CoroutineContext context, Runnable block) {
        ...
        this.dispatcher.mo10646dispatch(this, new Worker(runnableObtainTaskOrDeallocateWorker));
    }
