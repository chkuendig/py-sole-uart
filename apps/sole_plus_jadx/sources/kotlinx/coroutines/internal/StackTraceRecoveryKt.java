...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM9087constructorimpl = Result.m9087constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
        ...
        if (Result.m9090exceptionOrNullimpl(objM9087constructorimpl) == null) {
            obj2 = objM9087constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM9087constructorimpl2 = Result.m9087constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
