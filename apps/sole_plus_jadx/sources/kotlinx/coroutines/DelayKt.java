...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.get$context()).mo10647scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m10578delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m10579toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m10579toDelayMillisLRDsOJo(long j) {
        boolean zM10447isPositiveimpl = Duration.m10447isPositiveimpl(j);
        if (zM10447isPositiveimpl) {
            Duration.Companion companion = Duration.INSTANCE;
            return Duration.m10431getInWholeMillisecondsimpl(Duration.m10449plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        }
        if (zM10447isPositiveimpl) {
