        ...
        for (String str : this.mFragments) {
            ...
            if (fragment != null) {
                ...
                if (savedState != null) {
                    ...
                    Fragment fragmentInstantiate = ((FragmentState) savedState.getParcelable(ServerProtocol.DIALOG_PARAM_STATE)).instantiate(fragmentManager.getFragmentFactory(), classLoader);
