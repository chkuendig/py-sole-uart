...
public final class FragmentViewModelLazyKt {
    public static /* synthetic */ Lazy viewModels$default(final Fragment fragment, Function0 ownerProducer, Function0 function0, int i, Object obj) {
        ...
        C07672 c07672 = new C07672(lazy);
        C07683 c07683 = new C07683(lazy);
        if (function0 == null) {
            function0 = new C07694(fragment, lazy);
        }
        return createViewModelLazy(fragment, orCreateKotlinClass, c07672, c07683, function0);
    }
    ...
    public static final ViewModelStoreOwner m7568viewModels$lambda0(Lazy<? extends ViewModelStoreOwner> lazy) {
        return lazy.getValue();
    }

    /* compiled from: FragmentViewModelLazy.kt */
    @Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001\"\n\b\u0000\u0010\u0002\u0018\u0001*\u00020\u0003H\n¢\u0006\u0002\b\u0004"}, d2 = {"<anonymous>", "Landroidx/lifecycle/ViewModelStore;", "VM", "Landroidx/lifecycle/ViewModel;", "invoke"}, k = 3, mv = {1, 8, 0}, xi = Opcodes.ARETURN)
    ...
    public static final class C07672 extends Lambda implements Function0<ViewModelStore> {
        final /* synthetic */ Lazy<ViewModelStoreOwner> $owner$delegate;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C07672(Lazy<? extends ViewModelStoreOwner> lazy) {
            super(0);
        ...
        public final ViewModelStore invoke() {
            return FragmentViewModelLazyKt.m7568viewModels$lambda0(this.$owner$delegate).getViewModelStore();
        }
    }
    ...
    public static final class C07683 extends Lambda implements Function0<CreationExtras> {
        final /* synthetic */ Lazy<ViewModelStoreOwner> $owner$delegate;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C07683(Lazy<? extends ViewModelStoreOwner> lazy) {
            super(0);
            this.$owner$delegate = lazy;
        }
        ...
        public final CreationExtras invoke() {
            ...
            ViewModelStoreOwner viewModelStoreOwnerM7568viewModels$lambda0 = FragmentViewModelLazyKt.m7568viewModels$lambda0(this.$owner$delegate);
            HasDefaultViewModelProviderFactory hasDefaultViewModelProviderFactory = viewModelStoreOwnerM7568viewModels$lambda0 instanceof HasDefaultViewModelProviderFactory ? (HasDefaultViewModelProviderFactory) viewModelStoreOwnerM7568viewModels$lambda0 : null;
    ...
    public static final class C07694 extends Lambda implements Function0<ViewModelProvider.Factory> {
        final /* synthetic */ Lazy<ViewModelStoreOwner> $owner$delegate;
        final /* synthetic */ Fragment $this_viewModels;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C07694(Fragment fragment, Lazy<? extends ViewModelStoreOwner> lazy) {
            super(0);
    ...
    public static /* synthetic */ Lazy viewModels$default(final Fragment fragment, Function0 ownerProducer, Function0 function0, Function0 function02, int i, Object obj) {
        ...
        Intrinsics.reifiedOperationMarker(4, "VM");
        KClass orCreateKotlinClass = Reflection.getOrCreateKotlinClass(ViewModel.class);
        C07716 c07716 = new C07716(lazy);
        AnonymousClass7 anonymousClass7 = new AnonymousClass7(function0, lazy);
        if (function02 == null) {
            function02 = new AnonymousClass8(fragment, lazy);
        }
        return createViewModelLazy(fragment, orCreateKotlinClass, c07716, anonymousClass7, function02);
    }
    ...
    public static final ViewModelStoreOwner m7569viewModels$lambda1(Lazy<? extends ViewModelStoreOwner> lazy) {
        return lazy.getValue();
    }
    ...
    public static final class C07716 extends Lambda implements Function0<ViewModelStore> {
        final /* synthetic */ Lazy<ViewModelStoreOwner> $owner$delegate;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C07716(Lazy<? extends ViewModelStoreOwner> lazy) {
            super(0);
            this.$owner$delegate = lazy;
        }
        ...
        @Override // kotlin.jvm.functions.Function0
        public final ViewModelStore invoke() {
            return FragmentViewModelLazyKt.m7569viewModels$lambda1(this.$owner$delegate).getViewModelStore();
        }
    }
    ...
    public static final class AnonymousClass7 extends Lambda implements Function0<CreationExtras> {
        ...
        public final CreationExtras invoke() {
            ...
            ViewModelStoreOwner viewModelStoreOwnerM7569viewModels$lambda1 = FragmentViewModelLazyKt.m7569viewModels$lambda1(this.$owner$delegate);
