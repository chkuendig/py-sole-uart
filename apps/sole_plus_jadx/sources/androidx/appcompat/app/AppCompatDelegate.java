...
public abstract class AppCompatDelegate {
    ...
    static class SerialExecutor implements Executor {
        ...
        /* synthetic */ void m9x45c145d(Runnable runnable) {
            try {
                runnable.run();
            } finally {
                scheduleNext();
    ...
    static Object getLocaleManagerForApplication() {
        ...
        while (it.hasNext()) {
            ...
            if (appCompatDelegate != null && (contextForDelegate = appCompatDelegate.getContextForDelegate()) != null) {
                return contextForDelegate.getSystemService(SdkConstants.ATTR_LOCALE);
            }
        }
        return null;
    }
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            ...
            if (context.getPackageManager().getComponentEnabledSetting(componentName) != 1) {
                if (getApplicationLocales().isEmpty()) {
                    ...
                    Object systemService = context.getSystemService(SdkConstants.ATTR_LOCALE);
