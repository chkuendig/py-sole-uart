...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    */
    ...
    final int updateStatusGuard(WindowInsetsCompat windowInsetsCompat, Rect rect) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
    ...
    private boolean applyApplicationSpecificConfig(boolean z, boolean z2) throws PackageManager.NameNotFoundException {
        if (this.mDestroyed) {
            return false;
        }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private boolean updateAppConfiguration(int r10, androidx.core.os.LocaleListCompat r11, boolean r12) throws android.content.pm.PackageManager.NameNotFoundException {
        /*
            r9 = this;
