...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<LinearLayoutCompat> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            this.mBaselineAlignedId = propertyMapper.mapBoolean(SdkConstants.ATTR_BASELINE_ALIGNED, R.attr.baselineAligned);
            ...
            this.mOrientationId = propertyMapper.mapIntEnum(SdkConstants.ATTR_ORIENTATION, R.attr.orientation, new IntFunction<String>() { // from class: androidx.appcompat.widget.LinearLayoutCompat.InspectionCompanion.1
            ...
            this.mWeightSumId = propertyMapper.mapFloat(SdkConstants.ATTR_WEIGHT_SUM, R.attr.weightSum);
            this.mDividerId = propertyMapper.mapObject(SdkConstants.ATTR_DIVIDER, androidx.appcompat.R.attr.divider);
            this.mDividerPaddingId = propertyMapper.mapInt(SdkConstants.ATTR_DIVIDER_PADDING, androidx.appcompat.R.attr.dividerPadding);
