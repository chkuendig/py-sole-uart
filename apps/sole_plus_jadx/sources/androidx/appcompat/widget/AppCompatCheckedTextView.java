...
public class AppCompatCheckedTextView extends CheckedTextView implements TintableCheckedTextView, TintableBackgroundView, EmojiCompatConfigurationView, TintableCompoundDrawablesView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<AppCompatCheckedTextView> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            this.mBackgroundTintId = propertyMapper.mapObject(SdkConstants.ATTR_BACKGROUND_TINT, R.attr.backgroundTint);
            this.mBackgroundTintModeId = propertyMapper.mapObject(SdkConstants.ATTR_BACKGROUND_TINT_MODE, R.attr.backgroundTintMode);
            this.mCheckMarkTintId = propertyMapper.mapObject(SdkConstants.ATTR_CHECK_MARK_TINT, R.attr.checkMarkTint);
            this.mCheckMarkTintModeId = propertyMapper.mapObject("checkMarkTintMode", R.attr.checkMarkTintMode);
            this.mDrawableTintId = propertyMapper.mapObject(SdkConstants.ATTR_DRAWABLE_TINT, R.attr.drawableTint);
