...
public class AppCompatMultiAutoCompleteTextView extends MultiAutoCompleteTextView implements TintableBackgroundView, EmojiCompatConfigurationView, TintableCompoundDrawablesView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<AppCompatMultiAutoCompleteTextView> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            this.mBackgroundTintId = propertyMapper.mapObject(SdkConstants.ATTR_BACKGROUND_TINT, androidx.appcompat.R.attr.backgroundTint);
            this.mBackgroundTintModeId = propertyMapper.mapObject(SdkConstants.ATTR_BACKGROUND_TINT_MODE, androidx.appcompat.R.attr.backgroundTintMode);
            this.mDrawableTintId = propertyMapper.mapObject(SdkConstants.ATTR_DRAWABLE_TINT, androidx.appcompat.R.attr.drawableTint);
