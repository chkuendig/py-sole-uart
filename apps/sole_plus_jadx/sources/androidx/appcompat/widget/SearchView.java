...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<SearchView> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            this.mImeOptionsId = propertyMapper.mapInt(SdkConstants.ATTR_IME_OPTIONS, R.attr.imeOptions);
            this.mMaxWidthId = propertyMapper.mapInt(SdkConstants.ATTR_MAX_WIDTH, R.attr.maxWidth);
    ...
    void onVoiceClicked() throws Resources.NotFoundException {
        SearchableInfo searchableInfo = this.mSearchable;
        if (searchableInfo == null) {
            return;
        }
    ...
    static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            return "SearchView.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " isIconified=" + this.isIconified + SdkConstants.MANIFEST_PLACEHOLDER_SUFFIX;
        }
    }
