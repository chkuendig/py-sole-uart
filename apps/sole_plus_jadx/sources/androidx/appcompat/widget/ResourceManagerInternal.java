...
public final class ResourceManagerInternal {
    ...
    private Drawable loadDrawableFromDelegates(Context context, int i) throws XmlPullParserException, Resources.NotFoundException {
        int next;
        ...
        if (typedValue.string != null && typedValue.string.toString().endsWith(SdkConstants.DOT_XML)) {
            try {
