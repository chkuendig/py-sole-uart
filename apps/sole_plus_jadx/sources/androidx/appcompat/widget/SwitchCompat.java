...
public class SwitchCompat extends CompoundButton implements EmojiCompatConfigurationView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<SwitchCompat> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            this.mTextOffId = propertyMapper.mapObject(SdkConstants.ATTR_TEXT_OFF, R.attr.textOff);
            this.mTextOnId = propertyMapper.mapObject(SdkConstants.ATTR_TEXT_ON, R.attr.textOn);
            this.mThumbId = propertyMapper.mapObject(SdkConstants.ATTR_THUMB, R.attr.thumb);
            this.mShowTextId = propertyMapper.mapBoolean(SdkConstants.ATTR_SHOW_TEXT, androidx.appcompat.R.attr.showText);
            this.mSplitTrackId = propertyMapper.mapBoolean(SdkConstants.ATTR_SPLIT_TRACK, androidx.appcompat.R.attr.splitTrack);
            this.mSwitchMinWidthId = propertyMapper.mapInt(SdkConstants.ATTR_SWITCH_MIN_WIDTH, androidx.appcompat.R.attr.switchMinWidth);
            this.mSwitchPaddingId = propertyMapper.mapInt(SdkConstants.ATTR_SWITCH_PADDING, androidx.appcompat.R.attr.switchPadding);
            this.mThumbTextPaddingId = propertyMapper.mapInt("thumbTextPadding", androidx.appcompat.R.attr.thumbTextPadding);
            this.mThumbTintId = propertyMapper.mapObject(SdkConstants.ATTR_THUMB_TINT, androidx.appcompat.R.attr.thumbTint);
            this.mThumbTintModeId = propertyMapper.mapObject("thumbTintMode", androidx.appcompat.R.attr.thumbTintMode);
            this.mTrackId = propertyMapper.mapObject(SdkConstants.ATTR_TRACK, androidx.appcompat.R.attr.track);
            this.mTrackTintId = propertyMapper.mapObject(SdkConstants.ATTR_TRACK_TINT, androidx.appcompat.R.attr.trackTint);
