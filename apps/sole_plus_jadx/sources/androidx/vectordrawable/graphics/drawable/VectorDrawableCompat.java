...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    private void updateStateFromTypedArray(TypedArray typedArray, XmlPullParser xmlPullParser, Resources.Theme theme) throws XmlPullParserException {
        ...
        vPathRenderer.mViewportWidth = TypedArrayUtils.getNamedFloat(typedArray, xmlPullParser, SdkConstants.ATTR_VIEWPORT_WIDTH, 7, vPathRenderer.mViewportWidth);
        vPathRenderer.mViewportHeight = TypedArrayUtils.getNamedFloat(typedArray, xmlPullParser, SdkConstants.ATTR_VIEWPORT_HEIGHT, 8, vPathRenderer.mViewportHeight);
    ...
    private static class VClipPath extends VPath {
        ...
        public void inflate(Resources resources, AttributeSet attributeSet, Resources.Theme theme, XmlPullParser xmlPullParser) {
            if (TypedArrayUtils.hasAttribute(xmlPullParser, SdkConstants.ATTR_PATH_DATA)) {
    ...
    private static class VFullPath extends VPath {
        ...
        private void updateStateFromTypedArray(TypedArray typedArray, XmlPullParser xmlPullParser, Resources.Theme theme) {
            ...
            if (TypedArrayUtils.hasAttribute(xmlPullParser, SdkConstants.ATTR_PATH_DATA)) {
                ...
                this.mFillColor = TypedArrayUtils.getNamedComplexColor(typedArray, xmlPullParser, theme, SdkConstants.ATTR_FILL_COLOR, 1, 0);
                ...
                this.mStrokeColor = TypedArrayUtils.getNamedComplexColor(typedArray, xmlPullParser, theme, SdkConstants.ATTR_STROKE_COLOR, 3, 0);
                this.mStrokeAlpha = TypedArrayUtils.getNamedFloat(typedArray, xmlPullParser, "strokeAlpha", 11, this.mStrokeAlpha);
                this.mStrokeWidth = TypedArrayUtils.getNamedFloat(typedArray, xmlPullParser, SdkConstants.ATTR_STROKE_WIDTH, 4, this.mStrokeWidth);
