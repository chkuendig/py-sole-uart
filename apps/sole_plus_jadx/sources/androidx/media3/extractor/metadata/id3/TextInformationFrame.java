...
public final class TextInformationFrame extends Id3Frame {
    ...
    public boolean equals(Object obj) {
        ...
        return Util.areEqual(this.f128id, textInformationFrame.f128id) && Util.areEqual(this.description, textInformationFrame.description) && this.values.equals(textInformationFrame.values);
    }

    public int hashCode() {
        int iHashCode = (527 + this.f128id.hashCode()) * 31;
    ...
    public String toString() {
        return this.f128id + ": description=" + this.description + ": values=" + this.values;
    }
