...
public final class UrlLinkFrame extends Id3Frame {
    ...
    public boolean equals(Object obj) {
        ...
        return this.f128id.equals(urlLinkFrame.f128id) && Util.areEqual(this.description, urlLinkFrame.description) && Util.areEqual(this.url, urlLinkFrame.url);
    }
    ...
    public String toString() {
        return this.f128id + ": url=" + this.url;
    }
