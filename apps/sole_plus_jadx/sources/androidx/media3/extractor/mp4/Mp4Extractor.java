...
public final class Mp4Extractor implements Extractor, SeekMap {
    ...
    */
    ...
    private void processMoovAtom(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        List<TrackSampleTable> traks = AtomParsers.parseTraks(containerAtom, gaplessInfoHolder2, -9223372036854775807L, null, (this.flags & 1) != 0, z, new Function() { // from class: androidx.media3.extractor.mp4.Mp4Extractor$$ExternalSyntheticLambda0
        ...
        while (i2 < size) {
            ...
            if (trackSampleTable.sampleCount == 0) {
                ...
                if (track.type == 2) {
                    if ((this.flags & 8) != 0) {
                        builderBuildUpon.setRoleFlags((size2 == -1 ? 1 : 2) | track.format.roleFlags);
                    }
                    if (j2 > 0 && trackSampleTable.sampleCount > 1) {
                ...
                MetadataUtil.setFormatMetadata(i3, mdtaFromMeta, builderBuildUpon, metadataArr);
