    ...
    public synchronized Extractor[] createExtractors(Uri uri, Map<String, List<String>> map) {
        ...
        for (int i2 = 0; i2 < arrayList.size(); i2++) {
            if (this.textTrackTranscodingEnabled) {
                subtitleTranscodingExtractor = new SubtitleTranscodingExtractor(arrayList.get(i2), this.subtitleParserFactory);
            } else {
                subtitleTranscodingExtractor = arrayList.get(i2);
            }
