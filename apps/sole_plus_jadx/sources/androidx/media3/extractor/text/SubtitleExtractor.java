...
public class SubtitleExtractor implements Extractor {
    ...
    public SubtitleExtractor(SubtitleParser subtitleParser, Format format) {
        ...
        this.format = format.buildUpon().setSampleMimeType(MimeTypes.APPLICATION_MEDIA3_CUES).setCodecs(format.sampleMimeType).build();
    }
        ...
        try {
            ...
            this.subtitleParser.parse(this.subtitleData, outputOptionsAllCues, new Consumer() { // from class: androidx.media3.extractor.text.SubtitleExtractor$$ExternalSyntheticLambda0
                ...
                public final void accept(Object obj) {
                    this.f$0.m7733xdbba10ad((CuesWithTiming) obj);
                }
            });
    ...
    /* synthetic */ void m7733xdbba10ad(CuesWithTiming cuesWithTiming) {
