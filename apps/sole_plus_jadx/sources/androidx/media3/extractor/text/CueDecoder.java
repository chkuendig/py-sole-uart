...
public final class CueDecoder {
    ...
    public CuesWithTiming decode(long j, byte[] bArr, int i, int i2) {
        ...
        return new CuesWithTiming(BundleableUtil.fromBundleList(Cue.CREATOR, (ArrayList) Assertions.checkNotNull(bundle.getParcelableArrayList("c"))), j, bundle.getLong("d"));
    }
}
