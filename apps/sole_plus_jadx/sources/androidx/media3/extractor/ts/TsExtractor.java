    ...
    */
        ...
        if (!fillBufferWithAtLeastOnePacket(extractorInput)) {
            for (int i = 0; i < this.tsPayloadReaders.size(); i++) {
                ...
                if (tsPayloadReaderValueAt instanceof PesReader) {
                    tsPayloadReaderValueAt.consume(new ParsableByteArray(), 1);
                }
            }
            return -1;
        }
    ...
    private class PmtReader implements SectionPayloadReader {
        ...
        /*
            ...
            To view partially-correct add '--show-bad-code' argument
        */
        private androidx.media3.extractor.ts.TsPayloadReader.EsInfo readEsInfo(androidx.media3.common.util.ParsableByteArray r13, int r14) {
            /*
                r12 = this;
            ...
            L88:
                ...
                androidx.media3.extractor.ts.TsPayloadReader$DvbSubtitleInfo r8 = new androidx.media3.extractor.ts.TsPayloadReader$DvbSubtitleInfo
                r8.<init>(r3, r4, r9)
                r1.add(r8)
                goto L88
            Laa:
            ...
            Lbd:
                r13.setPosition(r14)
                androidx.media3.extractor.ts.TsPayloadReader$EsInfo r4 = new androidx.media3.extractor.ts.TsPayloadReader$EsInfo
