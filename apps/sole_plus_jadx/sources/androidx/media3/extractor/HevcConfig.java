        ...
        try {
            ...
            for (int i14 = 0; i14 < unsignedByte2; i14++) {
                ...
                while (i15 < unsignedShort3) {
                    ...
                    System.arraycopy(NalUnitUtil.NAL_START_CODE, 0, bArr, i13, NalUnitUtil.NAL_START_CODE.length);
                    int length = i13 + NalUnitUtil.NAL_START_CODE.length;
            ...
            return new HevcConfig(i3 == 0 ? Collections.emptyList() : Collections.singletonList(bArr), unsignedByte + 1, i6, i7, i8, i9, i10, i11, i12, f, strBuildHevcCodecString);
        } catch (ArrayIndexOutOfBoundsException e) {
            throw ParserException.createForMalformedContainer("Error parsing HEVC config", e);
        }
    }

    private HevcConfig(List<byte[]> list, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, float f, String str) {
