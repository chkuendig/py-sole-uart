...
public class DefaultDashChunkSource implements DashChunkSource {
    ...
    public static final class Factory implements DashChunkSource.Factory {
        ...
        Factory setSubtitleParserFactory(SubtitleParser.Factory factory) {
            ChunkExtractor.Factory factory2 = this.chunkExtractorFactory;
            if (factory2 instanceof BundledChunkExtractor.Factory) {
                ((BundledChunkExtractor.Factory) factory2).experimentalSetSubtitleParserFactory(factory);
            }
            return this;
        }
    ...
    */
    ...
    protected Chunk newMediaChunk(RepresentationHolder representationHolder, DataSource dataSource, int i, Format format, int i2, Object obj, long j, int i3, long j2, long j3, CmcdData.Factory factory) {
        ...
        return new ContainerMediaChunk(dataSource, dataSpecBuildDataSpec2, format, i2, obj, segmentStartTimeUs, segmentEndTimeUs2, j2, j6, j, i5, -representation.presentationTimeOffsetUs, representationHolder.chunkExtractor);
    }
    ...
    private Pair<String, String> getNextObjectAndRangeRequest(long j, RangedUri rangedUri, RepresentationHolder representationHolder) {
        ...
        String str = segmentUrl.start + SdkConstants.RES_QUALIFIER_SEP;
