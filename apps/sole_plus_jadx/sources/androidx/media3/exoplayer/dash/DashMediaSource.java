...
public final class DashMediaSource extends BaseMediaSource {
    ...
    public static final class Factory implements MediaSourceFactory {
        ...
        public Factory experimentalParseSubtitlesDuringExtraction(boolean z) {
            if (z) {
                if (this.subtitleParserFactory == null) {
            ...
            if (factory instanceof DefaultDashChunkSource.Factory) {
                ((DefaultDashChunkSource.Factory) factory).setSubtitleParserFactory(this.subtitleParserFactory);
                return this;
            }
        ...
        public DashMediaSource createMediaSource(DashManifest dashManifest, MediaItem mediaItem) {
            ...
            return new DashMediaSource(mediaItemBuild, dashManifest, null, null, this.chunkSourceFactory, this.compositeSequenceableLoaderFactory, factory == null ? null : factory.createCmcdConfiguration(mediaItemBuild), this.drmSessionManagerProvider.get(mediaItemBuild), this.loadErrorHandlingPolicy, this.subtitleParserFactory, this.fallbackTargetLiveOffsetMs, this.minLiveStartPositionUs);
        }
    ...
    private DashMediaSource(MediaItem mediaItem, DashManifest dashManifest, DataSource.Factory factory, ParsingLoadable.Parser<? extends DashManifest> parser, DashChunkSource.Factory factory2, CompositeSequenceableLoaderFactory compositeSequenceableLoaderFactory, CmcdConfiguration cmcdConfiguration, DrmSessionManager drmSessionManager, LoadErrorHandlingPolicy loadErrorHandlingPolicy, SubtitleParser.Factory factory3, long j, long j2) {
        ...
        this.simulateManifestRefreshRunnable = new Runnable() { // from class: androidx.media3.exoplayer.dash.DashMediaSource$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m7663lambda$new$0$androidxmedia3exoplayerdashDashMediaSource();
            }
        };
    }

    /* renamed from: lambda$new$0$androidx-media3-exoplayer-dash-DashMediaSource, reason: not valid java name */
    /* synthetic */ void m7663lambda$new$0$androidxmedia3exoplayerdashDashMediaSource() {
    ...
    public MediaPeriod createPeriod(MediaSource.MediaPeriodId mediaPeriodId, Allocator allocator, long j) {
        ...
        this.periodsById.put(dashMediaPeriod.f116id, dashMediaPeriod);
    ...
    public void releasePeriod(MediaPeriod mediaPeriod) {
        ...
        this.periodsById.remove(dashMediaPeriod.f116id);
    }
    ...
    */
    ...
    private static final class DashTimeline extends Timeline {
        ...
        public Timeline.Period getPeriod(int i, Timeline.Period period, boolean z) {
            ...
            return period.set(z ? this.manifest.getPeriod(i).f119id : null, z ? Integer.valueOf(this.firstPeriodId + i) : null, 0, this.manifest.getPeriodDurationUs(i), Util.msToUs(this.manifest.getPeriod(i).startMs - this.manifest.getPeriod(0).startMs) - this.offsetInFirstPeriodUs);
        }
