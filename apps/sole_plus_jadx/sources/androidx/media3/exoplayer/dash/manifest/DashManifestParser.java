...
public class DashManifestParser extends DefaultHandler implements ParsingLoadable.Parser<DashManifest> {
    ...
    /* JADX WARN: Removed duplicated region for block: B:82:0x01ed A[LOOP:0: B:25:0x00ac->B:82:0x01ed, LOOP_END] */
    ...
    */
    ...
    protected ServiceDescriptionElement parseServiceDescription(XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (XmlPullParserUtil.isStartTag(xmlPullParser, "Latency")) {
                ...
                j2 = parseLong(xmlPullParser, HealthConstants.HeartRate.MIN, -9223372036854775807L);
                j3 = parseLong(xmlPullParser, "max", -9223372036854775807L);
            } else if (XmlPullParserUtil.isStartTag(xmlPullParser, "PlaybackRate")) {
                f = parseFloat(xmlPullParser, HealthConstants.HeartRate.MIN, -3.4028235E38f);
    ...
    /* JADX WARN: Removed duplicated region for block: B:71:0x0316 A[LOOP:0: B:3:0x0080->B:71:0x0316, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:72:0x02d6 A[EDGE_INSN: B:72:0x02d6->B:65:0x02d6 BREAK  A[LOOP:0: B:3:0x0080->B:71:0x0316], SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:57:0x01f4 A[LOOP:0: B:3:0x006c->B:57:0x01f4, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:58:0x019e A[EDGE_INSN: B:58:0x019e->B:47:0x019e BREAK  A[LOOP:0: B:3:0x006c->B:57:0x01f4], SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    ...
    protected SegmentBase.SingleSegmentBase parseSegmentBase(XmlPullParser xmlPullParser, SegmentBase.SingleSegmentBase singleSegmentBase) throws XmlPullParserException, NumberFormatException, IOException {
        ...
        if (attributeValue != null) {
            String[] strArrSplit = attributeValue.split(SdkConstants.RES_QUALIFIER_SEP);
    ...
    protected List<SegmentBase.SegmentTimelineElement> parseSegmentTimeline(XmlPullParser xmlPullParser, long j, long j2) throws XmlPullParserException, IOException {
        ...
        do {
            ...
            if (XmlPullParserUtil.isStartTag(xmlPullParser, ExifInterface.LATITUDE_SOUTH)) {
                ...
                i = parseInt(xmlPullParser, SdkConstants.FD_RES_CLASS, 0);
                z = true;
    ...
    protected RangedUri parseRangedUrl(XmlPullParser xmlPullParser, String str, String str2) throws NumberFormatException {
        ...
        if (attributeValue2 != null) {
            String[] strArrSplit = attributeValue2.split(SdkConstants.RES_QUALIFIER_SEP);
    ...
    */
    protected int parseAudioChannelConfiguration(org.xmlpull.v1.XmlPullParser r4) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        /*
            ...
            r2 = -1
            switch(r1) {
                case -2128649360: goto L5d;
                case -1352850286: goto L51;
                case -1138141449: goto L45;
                case -986633423: goto L39;
                case -79006963: goto L2d;
                case 312179081: goto L21;
    ...
    protected static int parseDolbyChannelConfiguration(org.xmlpull.v1.XmlPullParser r4) {
        ...
        Lc:
            ...
            switch(r1) {
                ...
                case 2937391: goto L3f;
                case 3094034: goto L34;
