...
public final class MediaParserHlsMediaChunkExtractor implements HlsMediaChunkExtractor {
    ...
    private static MediaParser createMediaParserInstance(MediaParser.OutputConsumer outputConsumer, Format format, boolean z, ImmutableList<MediaFormat> immutableList, PlayerId playerId, String... strArr) {
        ...
        mediaParserCreate.setParameter("android.media.mediaParser.exposeCaptionFormats", immutableList);
        mediaParserCreate.setParameter("android.media.mediaParser.overrideInBandCaptionDeclarations", Boolean.valueOf(z));
        mediaParserCreate.setParameter("android.media.mediaparser.inBandCryptoInfo", true);
        mediaParserCreate.setParameter("android.media.mediaparser.eagerlyExposeTrackType", true);
        mediaParserCreate.setParameter("android.media.mediaparser.ignoreTimestampOffset", true);
