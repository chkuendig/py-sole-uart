...
public final class HlsMediaSource extends BaseMediaSource implements HlsPlaylistTracker.PrimaryPlaylistListener {
    ...
    private SinglePeriodTimeline createTimelineForOnDemand(HlsMediaPlaylist hlsMediaPlaylist, long j, long j2, HlsManifest hlsManifest) {
        ...
        return new SinglePeriodTimeline(j, j2, -9223372036854775807L, hlsMediaPlaylist.durationUs, hlsMediaPlaylist.durationUs, 0L, j3, true, false, true, hlsManifest, getMediaItem(), null);
    }
    ...
    private void updateLiveConfiguration(HlsMediaPlaylist hlsMediaPlaylist, long j) {
        ...
        boolean z = liveConfiguration.minPlaybackSpeed == -3.4028235E38f && liveConfiguration.maxPlaybackSpeed == -3.4028235E38f && hlsMediaPlaylist.serverControl.holdBackUs == -9223372036854775807L && hlsMediaPlaylist.serverControl.partHoldBackUs == -9223372036854775807L;
