...
public final class CmcdData {
    ...
    public DataSpec addToDataSpec(DataSpec dataSpec) {
        ...
        return dataSpec.buildUpon().setUri(dataSpec.uri.buildUpon().appendQueryParameter(CmcdConfiguration.CMCD_QUERY_PARAMETER_KEY, Uri.encode(COMMA_JOINER.join(arrayList))).build()).build();
    }
