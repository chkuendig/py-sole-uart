...
final class MediaPeriodQueue {
    ...
    public MediaPeriodHolder advancePlayingPeriod() {
        ...
        if (i == 0) {
            ...
            this.oldFrontPeriodWindowSequenceNumber = this.playing.info.f114id.windowSequenceNumber;
        }
    ...
    public void clear() {
        ...
        this.oldFrontPeriodWindowSequenceNumber = next.info.f114id.windowSequenceNumber;
        while (next != null) {
            next.release();
            next = next.getNext();
        }
    ...
    */
    public androidx.media3.exoplayer.MediaPeriodInfo getUpdatedMediaPeriodInfo(androidx.media3.common.Timeline r19, androidx.media3.exoplayer.MediaPeriodInfo r20) {
        /*
            ...
            r1 = r19
            r2 = r20
            androidx.media3.exoplayer.source.MediaSource$MediaPeriodId r3 = r2.f114id
            boolean r12 = r0.isLastInPeriod(r3)
            boolean r13 = r0.isLastInWindow(r1, r3)
            boolean r14 = r0.isLastInTimeline(r1, r3, r12)
            androidx.media3.exoplayer.source.MediaSource$MediaPeriodId r4 = r2.f114id
    ...
    private void notifyQueueUpdate() {
        ...
        for (MediaPeriodHolder next = this.playing; next != null; next = next.getNext()) {
            builder.add((ImmutableList.Builder) next.info.f114id);
        }
        MediaPeriodHolder mediaPeriodHolder = this.reading;
        final MediaSource.MediaPeriodId mediaPeriodId = mediaPeriodHolder == null ? null : mediaPeriodHolder.info.f114id;
        this.analyticsCollectorHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.MediaPeriodQueue$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m7636x6b40a91a(builder, mediaPeriodId);
            }
        });
    }

    /* renamed from: lambda$notifyQueueUpdate$0$androidx-media3-exoplayer-MediaPeriodQueue, reason: not valid java name */
    /* synthetic */ void m7636x6b40a91a(ImmutableList.Builder builder, MediaSource.MediaPeriodId mediaPeriodId) {
    ...
    private long resolvePeriodIndexToWindowSequenceNumber(Timeline timeline, Object obj) {
        ...
        for (MediaPeriodHolder next = this.playing; next != null; next = next.getNext()) {
            if (next.uid.equals(obj)) {
                return next.info.f114id.windowSequenceNumber;
            }
        }
        for (MediaPeriodHolder next2 = this.playing; next2 != null; next2 = next2.getNext()) {
            ...
            if (indexOfPeriod2 != -1 && timeline.getPeriod(indexOfPeriod2, this.period).windowIndex == i) {
                return next2.info.f114id.windowSequenceNumber;
            }
        }
    ...
    private boolean canKeepMediaPeriodHolder(MediaPeriodInfo mediaPeriodInfo, MediaPeriodInfo mediaPeriodInfo2) {
        return mediaPeriodInfo.startPositionUs == mediaPeriodInfo2.startPositionUs && mediaPeriodInfo.f114id.equals(mediaPeriodInfo2.f114id);
    }
    ...
    private MediaPeriodInfo getFirstMediaPeriodInfoOfNextPeriod(Timeline timeline, MediaPeriodHolder mediaPeriodHolder, long j) {
        ...
        int nextPeriodIndex = timeline.getNextPeriodIndex(timeline.getIndexOfPeriod(mediaPeriodInfo2.f114id.periodUid), this.period, this.window, this.repeatMode, this.shuffleModeEnabled);
        ...
        long j7 = mediaPeriodInfo2.f114id.windowSequenceNumber;
        if (timeline.getWindow(i, this.window).firstPeriodIndex == nextPeriodIndex) {
            ...
            if (next != null && next.uid.equals(obj2)) {
                j6 = next.info.f114id.windowSequenceNumber;
            } else {
        ...
        if (j3 == -9223372036854775807L || mediaPeriodInfo.requestedContentPositionUs == -9223372036854775807L) {
            ...
            boolean zHasServerSideInsertedAds = hasServerSideInsertedAds(mediaPeriodInfo.f114id.periodUid, timeline);
    ...
    private MediaPeriodInfo getFollowingMediaPeriodInfoOfCurrentPeriod(Timeline timeline, MediaPeriodHolder mediaPeriodHolder, long j) {
        MediaPeriodInfo mediaPeriodInfo = mediaPeriodHolder.info;
        MediaSource.MediaPeriodId mediaPeriodId = mediaPeriodInfo.f114id;
