...
final class ExoPlayerImplInternal implements Handler.Callback, MediaPeriod.Callback, TrackSelector.InvalidationListener, MediaSourceList.MediaSourceListInfoRefreshListener, DefaultMediaClock.PlaybackParametersListener, PlayerMessage.Sender {
    ...
    public synchronized boolean release() {
        if (!this.released && this.playbackLooper.getThread().isAlive()) {
            ...
            waitUninterruptibly(new Supplier() { // from class: androidx.media3.exoplayer.ExoPlayerImplInternal$$ExternalSyntheticLambda0
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    return this.f$0.m7634lambda$release$0$androidxmedia3exoplayerExoPlayerImplInternal();
                }
    ...
    /* synthetic */ Boolean m7634lambda$release$0$androidxmedia3exoplayerExoPlayerImplInternal() {
    ...
    public boolean handleMessage(Message message) throws Throwable {
        ...
        try {
            ...
            if (e.type == 1 && (readingPeriod = this.queue.getReadingPeriod()) != null) {
                e = e.copyWithMediaPeriodId(readingPeriod.info.f114id);
            }
            if (e.isRecoverable && (this.pendingRecoverableRendererError == null || e.errorCode == 5003)) {
                ...
                if (e.type == 1 && this.queue.getPlayingPeriod() != this.queue.getReadingPeriod()) {
                    ...
                    this.playbackInfo = handlePositionDiscontinuity(mediaPeriodHolder.info.f114id, mediaPeriodHolder.info.startPositionUs, mediaPeriodHolder.info.requestedContentPositionUs, mediaPeriodHolder.info.startPositionUs, true, 0);
                }
    ...
    private void handleIoException(IOException iOException, int i) {
        ...
        if (playingPeriod != null) {
            exoPlaybackExceptionCreateForSource = exoPlaybackExceptionCreateForSource.copyWithMediaPeriodId(playingPeriod.info.f114id);
        }
    ...
    private void seekToCurrentPosition(boolean z) throws ExoPlaybackException {
        MediaSource.MediaPeriodId mediaPeriodId = this.queue.getPlayingPeriod().info.f114id;
    ...
    */
    ...
    private long seekToPeriodPosition(MediaSource.MediaPeriodId mediaPeriodId, long j, boolean z, boolean z2) throws ExoPlaybackException {
        ...
        while (next != null && !mediaPeriodId.equals(next.info.f114id)) {
            next = next.getNext();
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:46:0x00f8 A[PHI: r3
    ...
    */
        ...
        if (!looper.getThread().isAlive()) {
            ...
            this.clock.createHandler(looper, null).post(new Runnable() { // from class: androidx.media3.exoplayer.ExoPlayerImplInternal$$ExternalSyntheticLambda1
                ...
                public final void run() {
                    this.f$0.m7635x7e52fcd1(playerMessage);
                }
            });
        }
    }
    ...
    /* synthetic */ void m7635x7e52fcd1(PlayerMessage playerMessage) {
        try {
            deliverMessage(playerMessage);
    ...
    */
    ...
    private boolean shouldTransitionToReadyState(boolean z) {
        ...
        MediaPeriodHolder playingPeriod = this.queue.getPlayingPeriod();
        long targetLiveOffsetUs = shouldUseLivePlaybackSpeedControl(this.playbackInfo.timeline, playingPeriod.info.f114id) ? this.livePlaybackSpeedControl.getTargetLiveOffsetUs() : -9223372036854775807L;
        MediaPeriodHolder loadingPeriod = this.queue.getLoadingPeriod();
        return (loadingPeriod.isFullyBuffered() && loadingPeriod.info.isFinal) || (loadingPeriod.info.f114id.isAd() && !loadingPeriod.prepared) || this.loadControl.shouldStartPlayback(this.playbackInfo.timeline, playingPeriod.info.f114id, getTotalBufferedDurationUs(), this.mediaClock.getPlaybackParameters().speed, this.isRebuffering, targetLiveOffsetUs);
    }
    ...
    /* JADX WARN: Not initialized variable reg: 25, insn: 0x0158: MOVE (r5 I:??[long, double]) = (r25 I:??[long, double]), block:B:77:0x0157 */
    ...
    */
    ...
    private void maybeUpdateReadingPeriod() throws ExoPlaybackException {
        ...
        if (readingPeriod.getNext() == null || this.pendingPauseAtEndOfPeriod) {
            ...
            if (readingPeriod.getNext().prepared || this.rendererPositionUs >= readingPeriod.getNext().getStartPositionRendererTime()) {
                ...
                updatePlaybackSpeedSettingsForNewPeriod(this.playbackInfo.timeline, mediaPeriodHolderAdvanceReadingPeriod.info.f114id, this.playbackInfo.timeline, readingPeriod.info.f114id, -9223372036854775807L, false);
            ...
            if (isRendererEnabled(renderer)) {
                ...
                if (!trackSelectorResult.isRendererEnabled(i) || z2) {
                    if (!renderer.isCurrentStreamFinal()) {
                        renderer.replaceStream(getFormats(trackSelectorResult.selections[i]), readingPeriod.sampleStreams[i], readingPeriod.getStartPositionRendererTime(), readingPeriod.getRendererOffset(), readingPeriod.info.f114id);
    ...
    private void maybeUpdatePlayingPeriod() throws ExoPlaybackException {
        ...
        while (shouldAdvancePlayingPeriod()) {
            ...
            this.playbackInfo = handlePositionDiscontinuity(mediaPeriodHolder.info.f114id, mediaPeriodHolder.info.startPositionUs, mediaPeriodHolder.info.requestedContentPositionUs, mediaPeriodHolder.info.startPositionUs, !(this.playbackInfo.periodId.periodUid.equals(mediaPeriodHolder.info.f114id.periodUid) && this.playbackInfo.periodId.adGroupIndex == -1 && mediaPeriodHolder.info.f114id.adGroupIndex == -1 && this.playbackInfo.periodId.nextAdGroupIndex != mediaPeriodHolder.info.f114id.nextAdGroupIndex), 0);
            resetPendingPauseAtEndOfPeriod();
            updatePlaybackPositions();
    ...
    private void handlePeriodPrepared(MediaPeriod mediaPeriod) throws ExoPlaybackException {
        if (this.queue.isLoading(mediaPeriod)) {
            ...
            updateLoadControlTrackSelection(loadingPeriod.info.f114id, loadingPeriod.getTrackGroups(), loadingPeriod.getTrackSelectorResult());
    ...
    private void enableRenderer(int i, boolean z, long j) throws ExoPlaybackException {
        ...
        renderer.enable(rendererConfiguration, formats, readingPeriod.sampleStreams[i], this.rendererPositionUs, z4, z2, j, readingPeriod.getRendererOffset(), readingPeriod.info.f114id);
    ...
    private void handleLoadingMediaPeriodChanged(boolean z) {
        ...
        MediaPeriodHolder loadingPeriod = this.queue.getLoadingPeriod();
        MediaSource.MediaPeriodId mediaPeriodId = loadingPeriod == null ? this.playbackInfo.periodId : loadingPeriod.info.f114id;
