    ...
    public long selectTracks(ExoTrackSelection[] exoTrackSelectionArr, boolean[] zArr, SampleStream[] sampleStreamArr, boolean[] zArr2, long j) {
        ...
        while (true) {
            ...
            if (exoTrackSelection != null) {
                ...
                iArr2[i2] = Integer.parseInt(trackGroup.f112id.substring(0, trackGroup.f112id.indexOf(":")));
            } else {
                iArr2[i2] = -1;
            }
            i2++;
        ...
        while (true) {
            ...
            if (i2 < mediaPeriodArr.length) {
                ...
                while (i5 < i4) {
                    ...
                    TrackGroup trackGroupCopyWithId = trackGroup.copyWithId(i2 + ":" + trackGroup.f112id);
