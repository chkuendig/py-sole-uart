    ...
    */
    protected void onChildSourceInfoRefreshed(androidx.media3.common.Timeline r15) {
        ...
        L36:
            ...
            androidx.media3.exoplayer.source.MediaSource$MediaPeriodId r7 = r7.f123id
        ...
        L98:
            ...
            androidx.media3.exoplayer.source.MediaSource$MediaPeriodId r0 = r15.f123id
            androidx.media3.exoplayer.source.MediaSource$MediaPeriodId r15 = r15.f123id
    ...
    private void setPreparePositionOverrideToUnpreparedMaskingPeriod(long j) {
        ...
        int indexOfPeriod = this.timeline.getIndexOfPeriod(maskingMediaPeriod.f123id.periodUid);
        if (indexOfPeriod == -1) {
            return;
        }
