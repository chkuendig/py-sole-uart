...
public final class AdsMediaSource extends CompositeMediaSource<MediaSource.MediaPeriodId> {
    ...
    protected void prepareSourceInternal(TransferListener transferListener) {
        ...
        this.mainHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ads.AdsMediaSource$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m7706x9f9466de(componentListener);
            }
        });
    }
    ...
    /* synthetic */ void m7706x9f9466de(ComponentListener componentListener) {
    ...
    public void releasePeriod(MediaPeriod mediaPeriod) {
        ...
        MediaSource.MediaPeriodId mediaPeriodId = maskingMediaPeriod.f123id;
    ...
    protected void releaseSourceInternal() {
        ...
        this.mainHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ads.AdsMediaSource$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m7707x4d6cb35f(componentListener);
            }
        });
    }
    ...
    /* synthetic */ void m7707x4d6cb35f(ComponentListener componentListener) {
    ...
    public void m7693x28f9175(MediaSource.MediaPeriodId mediaPeriodId, MediaSource mediaSource, Timeline timeline) {
        if (mediaPeriodId.isAd()) {
    ...
    final class ComponentListener implements AdsLoader.EventListener {
        ...
        public void onAdPlaybackState(final AdPlaybackState adPlaybackState) {
            ...
            this.playerHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ads.AdsMediaSource$ComponentListener$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m7710x6396e000(adPlaybackState);
                }
            });
        }
        ...
        /* synthetic */ void m7710x6396e000(AdPlaybackState adPlaybackState) {
            if (this.stopped) {
                return;
            }
    ...
    final class AdPrepareListener implements MaskingMediaPeriod.PrepareListener {
        ...
        public void onPrepareComplete(final MediaSource.MediaPeriodId mediaPeriodId) {
            AdsMediaSource.this.mainHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ads.AdsMediaSource$AdPrepareListener$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m7708x672fc1f4(mediaPeriodId);
                }
            });
        }
        ...
        /* synthetic */ void m7708x672fc1f4(MediaSource.MediaPeriodId mediaPeriodId) {
        ...
        public void onPrepareError(final MediaSource.MediaPeriodId mediaPeriodId, final IOException iOException) {
            ...
            AdsMediaSource.this.mainHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ads.AdsMediaSource$AdPrepareListener$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m7709xa9898f8e(mediaPeriodId, iOException);
                }
            });
        }
        ...
        /* synthetic */ void m7709xa9898f8e(MediaSource.MediaPeriodId mediaPeriodId, IOException iOException) {
    ...
    private final class AdMediaSourceHolder {
        ...
        private final MediaSource.MediaPeriodId f125id;
        private Timeline timeline;

        public AdMediaSourceHolder(MediaSource.MediaPeriodId mediaPeriodId) {
            this.f125id = mediaPeriodId;
        }
        ...
        public void initializeWithMediaSource(MediaSource mediaSource, Uri uri) {
            ...
            AdsMediaSource.this.prepareChildSource(this.f125id, mediaSource);
        }
        ...
        public void handleSourceInfoRefresh(Timeline timeline) {
            ...
            if (this.timeline == null) {
                ...
                for (int i = 0; i < this.activeMediaPeriods.size(); i++) {
                    MaskingMediaPeriod maskingMediaPeriod = this.activeMediaPeriods.get(i);
                    maskingMediaPeriod.createPeriod(new MediaSource.MediaPeriodId(uidOfPeriod, maskingMediaPeriod.f123id.windowSequenceNumber));
                }
            }
        ...
        public void release() {
            if (hasMediaSource()) {
                AdsMediaSource.this.releaseChildSource(this.f125id);
            }
        }
