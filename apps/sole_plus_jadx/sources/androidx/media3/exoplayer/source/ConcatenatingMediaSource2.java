...
public final class ConcatenatingMediaSource2 extends CompositeMediaSource<Integer> {
    ...
    public void m7693x28f9175(Integer num, MediaSource mediaSource, Timeline timeline) {
        scheduleTimelineUpdate();
    }
        ...
        while (i2 < size) {
            ...
            while (i3 < timeline2.getWindowCount()) {
                ...
                while (i4 <= window.lastPeriodIndex) {
                    ...
                    if (i4 != window.firstPeriodIndex || ((mediaSourceHolder.index == 0 && i3 == 0) || j6 == -9223372036854775807L)) {
                        obj2 = obj;
                        timeline = timeline2;
                        j = 0;
                    } else {
