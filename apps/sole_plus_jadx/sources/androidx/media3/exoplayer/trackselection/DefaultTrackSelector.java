...
public class DefaultTrackSelector extends MappingTrackSelector implements RendererCapabilities.Listener {
    ...
    private static final Ordering<Integer> NO_ORDER = Ordering.from(new Comparator() { // from class: androidx.media3.exoplayer.trackselection.DefaultTrackSelector$$ExternalSyntheticLambda1
        @Override // java.util.Comparator
        public final int compare(Object obj, Object obj2) {
    ...
    protected Pair<ExoTrackSelection.Definition, Integer> selectAudioTrack(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, final int[] iArr2, final Parameters parameters) throws ExoPlaybackException {
        ...
        return selectTracksForType(1, mappedTrackInfo, iArr, new TrackInfo.Factory() { // from class: androidx.media3.exoplayer.trackselection.DefaultTrackSelector$$ExternalSyntheticLambda3
            ...
            public final List create(int i2, TrackGroup trackGroup, int[] iArr3) {
                return this.f$0.m7712x86684b84(parameters, z, iArr2, i2, trackGroup, iArr3);
            }
    ...
    /* synthetic */ List m7712x86684b84(Parameters parameters, boolean z, int[] iArr, int i, TrackGroup trackGroup, int[] iArr2) {
        return AudioTrackInfo.createForTrackGroup(i, trackGroup, parameters, iArr2, z, new Predicate() { // from class: androidx.media3.exoplayer.trackselection.DefaultTrackSelector$$ExternalSyntheticLambda2
    ...
    protected static int getFormatLanguageScore(Format format, String str, boolean z) {
        ...
        return Util.splitAtFirst(strNormalizeUndeterminedLanguageToNull2, SdkConstants.RES_QUALIFIER_SEP)[0].equals(Util.splitAtFirst(strNormalizeUndeterminedLanguageToNull, SdkConstants.RES_QUALIFIER_SEP)[0]) ? 2 : 0;
    }
    ...
    static final class AudioTrackInfo extends TrackInfo<AudioTrackInfo> implements Comparable<AudioTrackInfo> {
        ...
        private int evaluateSelectionEligibility(int i, boolean z, int i2) {
            ...
            if (this.parameters.audioOffloadPreferences.audioOffloadMode != 2 || DefaultTrackSelector.rendererSupportsOffload(this.parameters, i, this.format)) {
                return (!DefaultTrackSelector.isSupported(i, false) || !this.isWithinConstraints || this.format.bitrate == -1 || this.parameters.forceHighestSupportedBitrate || this.parameters.forceLowestBitrate || (!this.parameters.allowMultipleAdaptiveSelections && z) || this.parameters.audioOffloadPreferences.audioOffloadMode == 2 || (i & i2) == 0) ? 1 : 2;
            }
            return 0;
        }
