...
final class PlayerControlViewLayoutManager {
    ...
    public PlayerControlViewLayoutManager(final PlayerControlView playerControlView) throws Resources.NotFoundException {
        ...
        if (viewFindViewById2 != null && viewFindViewById3 != null) {
            viewFindViewById2.setOnClickListener(new View.OnClickListener() { // from class: androidx.media3.ui.PlayerControlViewLayoutManager$$ExternalSyntheticLambda1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.onOverflowButtonClick(view);
                }
            });
            viewFindViewById3.setOnClickListener(new View.OnClickListener() { // from class: androidx.media3.ui.PlayerControlViewLayoutManager$$ExternalSyntheticLambda1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.onOverflowButtonClick(view);
                }
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.media3.ui.PlayerControlViewLayoutManager$$ExternalSyntheticLambda2
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m7746lambda$new$0$androidxmedia3uiPlayerControlViewLayoutManager(valueAnimator);
            }
        });
        ...
        valueAnimatorOfFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.media3.ui.PlayerControlViewLayoutManager$$ExternalSyntheticLambda3
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m7747lambda$new$1$androidxmedia3uiPlayerControlViewLayoutManager(valueAnimator);
            }
        });
        ...
        valueAnimatorOfFloat3.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.media3.ui.PlayerControlViewLayoutManager$$ExternalSyntheticLambda6
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m7748lambda$new$2$androidxmedia3uiPlayerControlViewLayoutManager(valueAnimator);
            }
        });
        ...
        valueAnimatorOfFloat4.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.media3.ui.PlayerControlViewLayoutManager$$ExternalSyntheticLambda7
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m7749lambda$new$3$androidxmedia3uiPlayerControlViewLayoutManager(valueAnimator);
            }
        });
    ...
    /* synthetic */ void m7746lambda$new$0$androidxmedia3uiPlayerControlViewLayoutManager(ValueAnimator valueAnimator) {
    ...
    /* synthetic */ void m7747lambda$new$1$androidxmedia3uiPlayerControlViewLayoutManager(ValueAnimator valueAnimator) {
        float fFloatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        View view = this.controlsBackground;
        if (view != null) {
            view.setAlpha(fFloatValue);
    ...
    /* synthetic */ void m7748lambda$new$2$androidxmedia3uiPlayerControlViewLayoutManager(ValueAnimator valueAnimator) {
    ...
    /* synthetic */ void m7749lambda$new$3$androidxmedia3uiPlayerControlViewLayoutManager(ValueAnimator valueAnimator) {
        animateOverflow(((Float) valueAnimator.getAnimatedValue()).floatValue());
    }
