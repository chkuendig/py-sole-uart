...
public final class VideoSize implements Bundleable {
    ...
    public int hashCode() {
        return ((((((WinError.ERROR_EXE_CANNOT_MODIFY_SIGNED_BINARY + this.width) * 31) + this.height) * 31) + this.unappliedRotationDegrees) * 31) + Float.floatToRawIntBits(this.pixelWidthHeightRatio);
    }
