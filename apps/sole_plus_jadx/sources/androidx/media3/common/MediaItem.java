    ...
    public static final class LocalConfiguration implements Bundleable {
        ...
        public static LocalConfiguration fromBundle(Bundle bundle) {
            ...
            if (parcelableArrayList == null) {
                ...
                immutableListFromBundleList = BundleableUtil.fromBundleList(new Bundleable.Creator() { // from class: androidx.media3.common.MediaItem$LocalConfiguration$$ExternalSyntheticLambda1
                    @Override // androidx.media3.common.Bundleable.Creator
            ...
            return new LocalConfiguration((Uri) Assertions.checkNotNull((Uri) bundle.getParcelable(FIELD_URI)), bundle.getString(FIELD_MIME_TYPE), drmConfiguration, adsConfiguration, immutableList, bundle.getString(FIELD_CUSTOM_CACHE_KEY), immutableListFromBundleList2, null, bundle.getLong(FIELD_IMAGE_DURATION_MS, -9223372036854775807L));
        }
    }
    ...
    public static class SubtitleConfiguration implements Bundleable {
        ...
        public static final class Builder {
            ...
            private Builder(SubtitleConfiguration subtitleConfiguration) {
                ...
                this.f110id = subtitleConfiguration.f109id;
            }
