...
public final class Format implements Bundleable {
    ...
    public static final class Builder {
        ...
        public Builder setId(int i) {
            this.f108id = Integer.toString(i);
            return this;
        }
    ...
    public String toString() {
        return "Format(" + this.f107id + ", " + this.label + ", " + this.containerMimeType + ", " + this.sampleMimeType + ", " + this.codecs + ", " + this.bitrate + ", " + this.language + ", [" + this.width + ", " + this.height + ", " + this.frameRate + ", " + this.colorInfo + "], [" + this.channelCount + ", " + this.sampleRate + "])";
    }
    ...
    public static String toLogString(Format format) {
        ...
        sb.append("id=").append(format.f107id).append(", mimeType=").append(format.sampleMimeType);
        ...
        if (format.selectionFlags != 0) {
            ...
            if ((format.selectionFlags & 1) != 0) {
                arrayList.add(SdkConstants.SKIN_DEFAULT);
            }
        ...
        if (format.roleFlags != 0) {
            ...
            if ((format.roleFlags & 1) != 0) {
                arrayList2.add(SdkConstants.FD_MAIN);
            }
            if ((format.roleFlags & 2) != 0) {
                arrayList2.add(HealthConstants.Alt.ALT);
            }
    ...
    public Bundle toBundle(boolean z) {
        ...
        bundle.putString(FIELD_ID, this.f107id);
