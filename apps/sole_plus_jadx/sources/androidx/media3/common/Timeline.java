...
public abstract class Timeline implements Bundleable {
    ...
    public static final Bundleable.Creator<Timeline> CREATOR = new Bundleable.Creator() { // from class: androidx.media3.common.Timeline$$ExternalSyntheticLambda0
    ...
    public static final class Period implements Bundleable {
        ...
        public boolean equals(Object obj) {
            ...
            return Util.areEqual(this.f111id, period.f111id) && Util.areEqual(this.uid, period.uid) && this.windowIndex == period.windowIndex && this.durationUs == period.durationUs && this.positionInWindowUs == period.positionInWindowUs && this.isPlaceholder == period.isPlaceholder && Util.areEqual(this.adPlaybackState, period.adPlaybackState);
        }

        public int hashCode() {
            Object obj = this.f111id;
    ...
    public static final class RemotableTimeline extends Timeline {
        ...
        public Period getPeriod(int i, Period period, boolean z) {
            ...
            period.set(period2.f111id, period2.uid, period2.windowIndex, period2.durationUs, period2.positionInWindowUs, period2.adPlaybackState, period2.isPlaceholder);
            return period;
        }
