...
public final class ParcelableArraySerializer implements KSerializer<Parcelable[]> {
    ...
    public void serialize(Encoder encoder, Parcelable[] value) {
        ...
        SavedStateWriter.m7917putParcelableArrayimpl(SavedStateWriter.m7892constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }
    ...
    public Parcelable[] deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m7854getParcelableArrayimpl(SavedStateReader.m7806constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey(), Reflection.getOrCreateKotlinClass(Parcelable.class));
    }
}
