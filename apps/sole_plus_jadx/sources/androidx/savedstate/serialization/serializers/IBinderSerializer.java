...
public final class IBinderSerializer implements KSerializer<IBinder> {
    ...
    public void serialize(Encoder encoder, IBinder value) {
        ...
        SavedStateWriter.m7897putBinderimpl(SavedStateWriter.m7892constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }
    ...
    public IBinder deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m7813getBinderimpl(SavedStateReader.m7806constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
    }
}
