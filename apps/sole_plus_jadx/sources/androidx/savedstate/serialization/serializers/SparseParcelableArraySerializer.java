...
public final class SparseParcelableArraySerializer implements KSerializer<SparseArray<Parcelable>> {
    ...
    public void serialize(Encoder encoder, SparseArray<Parcelable> value) {
        ...
        SavedStateWriter.m7924putSparseParcelableArrayimpl(SavedStateWriter.m7892constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }
    ...
    public SparseArray<Parcelable> deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m7874getSparseParcelableArrayimpl(SavedStateReader.m7806constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey(), Reflection.getOrCreateKotlinClass(Parcelable.class));
    }
}
