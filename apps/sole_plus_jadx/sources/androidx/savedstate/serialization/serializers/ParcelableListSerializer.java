...
public final class ParcelableListSerializer implements KSerializer<List<? extends Parcelable>> {
    ...
    public void serialize(Encoder encoder, List<? extends Parcelable> value) {
        ...
        SavedStateWriter.m7918putParcelableListimpl(SavedStateWriter.m7892constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }
    ...
    public List<Parcelable> deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m7858getParcelableListimpl(SavedStateReader.m7806constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey(), Reflection.getOrCreateKotlinClass(Parcelable.class));
    }
}
