...
public abstract class JavaSerializableSerializer<T extends Serializable> implements KSerializer<T> {
    ...
    public final void serialize(Encoder encoder, T value) {
        ...
        SavedStateWriter.m7912putJavaSerializableimpl(SavedStateWriter.m7892constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }
    ...
    public final T deserialize(Decoder decoder) {
        ...
        T t = (T) SavedStateReader.m7844getJavaSerializableimpl(SavedStateReader.m7806constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey(), Reflection.getOrCreateKotlinClass(Serializable.class));
