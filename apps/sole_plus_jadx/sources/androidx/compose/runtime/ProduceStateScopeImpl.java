...
final class ProduceStateScopeImpl<T> implements ProduceStateScope<T>, MutableState<T> {
    ...
    @DebugMetadata(c = "androidx.compose.runtime.ProduceStateScopeImpl", f = "ProduceState.kt", i = {0}, l = {WinError.ERROR_META_EXPANSION_TOO_LONG}, m = "awaitDispose", n = {"onDispose"}, s = {"L$0"})
