...
final class DefaultRadioButtonColors implements RadioButtonColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4539equalsimpl0(this.selectedColor, defaultRadioButtonColors.selectedColor) && Color.m4539equalsimpl0(this.unselectedColor, defaultRadioButtonColors.unselectedColor) && Color.m4539equalsimpl0(this.disabledColor, defaultRadioButtonColors.disabledColor);
    }

    public int hashCode() {
        return (((Color.m4545hashCodeimpl(this.selectedColor) * 31) + Color.m4545hashCodeimpl(this.unselectedColor)) * 31) + Color.m4545hashCodeimpl(this.disabledColor);
    }
}
