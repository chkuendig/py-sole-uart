...
public final class MinimumInteractiveModifierNode extends Modifier.Node implements CompositionLocalConsumerModifierNode, LayoutModifierNode {
    ...
    public MeasureResult mo395measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (z) {
            width = Math.max(placeableMo5957measureBRTryo0.getWidth(), measureScope.mo671roundToPx0680j_4(DpSize.m7353getWidthD9Ej5fM(j2)));
        } else {
            width = placeableMo5957measureBRTryo0.getWidth();
        }
        final int i = width;
        if (z) {
            height = Math.max(placeableMo5957measureBRTryo0.getHeight(), measureScope.mo671roundToPx0680j_4(DpSize.m7351getHeightD9Ej5fM(j2)));
        } else {
            height = placeableMo5957measureBRTryo0.getHeight();
        }
        final int i2 = height;
        return MeasureScope.layout$default(measureScope, i, i2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.MinimumInteractiveModifierNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.place$default(placementScope, placeableMo5957measureBRTryo0, MathKt.roundToInt((i - placeableMo5957measureBRTryo0.getWidth()) / 2.0f), MathKt.roundToInt((i2 - placeableMo5957measureBRTryo0.getHeight()) / 2.0f), 0.0f, 4, null);
            }
        }, 4, null);
    }
}
