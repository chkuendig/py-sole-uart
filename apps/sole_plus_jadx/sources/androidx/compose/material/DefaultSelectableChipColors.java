...
final class DefaultSelectableChipColors implements SelectableChipColors {
    ...
    public State<Color> backgroundColor(boolean z, boolean z2, Composer composer, int i) {
        ...
        ComposerKt.sourceInformation(composer, "C(backgroundColor)667@29380L28:Chip.kt#jmzs0o");
    ...
    public State<Color> contentColor(boolean z, boolean z2, Composer composer, int i) {
        ...
        ComposerKt.sourceInformation(composer, "C(contentColor)677@29692L28:Chip.kt#jmzs0o");
        if (ComposerKt.isTraceInProgress()) {
    ...
    public State<Color> leadingIconColor(boolean z, boolean z2, Composer composer, int i) {
        ...
        ComposerKt.sourceInformation(composer, "C(leadingIconColor)687@30020L28:Chip.kt#jmzs0o");
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4539equalsimpl0(this.backgroundColor, defaultSelectableChipColors.backgroundColor) && Color.m4539equalsimpl0(this.contentColor, defaultSelectableChipColors.contentColor) && Color.m4539equalsimpl0(this.leadingIconColor, defaultSelectableChipColors.leadingIconColor) && Color.m4539equalsimpl0(this.disabledBackgroundColor, defaultSelectableChipColors.disabledBackgroundColor) && Color.m4539equalsimpl0(this.disabledContentColor, defaultSelectableChipColors.disabledContentColor) && Color.m4539equalsimpl0(this.disabledLeadingIconColor, defaultSelectableChipColors.disabledLeadingIconColor) && Color.m4539equalsimpl0(this.selectedBackgroundColor, defaultSelectableChipColors.selectedBackgroundColor) && Color.m4539equalsimpl0(this.selectedContentColor, defaultSelectableChipColors.selectedContentColor) && Color.m4539equalsimpl0(this.selectedLeadingIconColor, defaultSelectableChipColors.selectedLeadingIconColor);
    }

    public int hashCode() {
        return (((((((((((((((Color.m4545hashCodeimpl(this.backgroundColor) * 31) + Color.m4545hashCodeimpl(this.contentColor)) * 31) + Color.m4545hashCodeimpl(this.leadingIconColor)) * 31) + Color.m4545hashCodeimpl(this.disabledBackgroundColor)) * 31) + Color.m4545hashCodeimpl(this.disabledContentColor)) * 31) + Color.m4545hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m4545hashCodeimpl(this.selectedBackgroundColor)) * 31) + Color.m4545hashCodeimpl(this.selectedContentColor)) * 31) + Color.m4545hashCodeimpl(this.selectedLeadingIconColor);
    }
}
