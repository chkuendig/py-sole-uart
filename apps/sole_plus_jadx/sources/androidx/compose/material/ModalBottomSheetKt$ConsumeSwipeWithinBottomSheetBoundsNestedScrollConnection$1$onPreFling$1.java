...
@DebugMetadata(c = "androidx.compose.material.ModalBottomSheetKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1", f = "ModalBottomSheet.kt", i = {0}, l = {WinError.ERROR_LOST_WRITEBEHIND_DATA_NETWORK_SERVER_ERROR}, m = "onPreFling-QWom1Mo", n = {"available"}, s = {"J$0"})
