...
final class MinimumInteractiveComponentSizeModifier implements LayoutModifier {
    ...
    public MeasureResult mo368measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        final int iMax = Math.max(placeableMo5957measureBRTryo0.getWidth(), measureScope.mo671roundToPx0680j_4(DpSize.m7353getWidthD9Ej5fM(this.size)));
        final int iMax2 = Math.max(placeableMo5957measureBRTryo0.getHeight(), measureScope.mo671roundToPx0680j_4(DpSize.m7351getHeightD9Ej5fM(this.size)));
        return MeasureScope.layout$default(measureScope, iMax, iMax2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.MinimumInteractiveComponentSizeModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.place$default(placementScope, placeableMo5957measureBRTryo0, MathKt.roundToInt((iMax - placeableMo5957measureBRTryo0.getWidth()) / 2.0f), MathKt.roundToInt((iMax2 - placeableMo5957measureBRTryo0.getHeight()) / 2.0f), 0.0f, 4, null);
            }
        }, 4, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return DpSize.m7350equalsimpl0(this.size, minimumInteractiveComponentSizeModifier.size);
    }

    public int hashCode() {
        return DpSize.m7355hashCodeimpl(this.size);
    }
}
