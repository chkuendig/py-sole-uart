...
final class TwoLine {
    ...
    private static final float MinHeight = Dp.m7255constructorimpl(64);
    private static final float MinHeightWithIcon = Dp.m7255constructorimpl(72);
    private static final float IconMinPaddedWidth = Dp.m7255constructorimpl(40);
    private static final float OverlineBaselineOffset = Dp.m7255constructorimpl(24);
    private static final float PrimaryBaselineOffsetNoIcon = Dp.m7255constructorimpl(28);
    private static final float PrimaryBaselineOffsetWithIcon = Dp.m7255constructorimpl(32);
    ...
    */
    ...
    static {
        ...
        IconVerticalPadding = Dp.m7255constructorimpl(f);
        ContentLeftPadding = Dp.m7255constructorimpl(f);
        ContentRightPadding = Dp.m7255constructorimpl(f);
        float f2 = 20;
        OverlineToPrimaryBaselineOffset = Dp.m7255constructorimpl(f2);
        PrimaryToSecondaryBaselineOffsetNoIcon = Dp.m7255constructorimpl(f2);
        PrimaryToSecondaryBaselineOffsetWithIcon = Dp.m7255constructorimpl(f2);
