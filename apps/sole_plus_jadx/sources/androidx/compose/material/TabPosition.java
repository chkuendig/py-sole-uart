...
public final class TabPosition {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m7260equalsimpl0(this.left, tabPosition.left) && Dp.m7260equalsimpl0(this.width, tabPosition.width);
    }

    public int hashCode() {
        return (Dp.m7261hashCodeimpl(this.left) * 31) + Dp.m7261hashCodeimpl(this.width);
    }

    public String toString() {
        return "TabPosition(left=" + ((Object) Dp.m7266toStringimpl(this.left)) + ", right=" + ((Object) Dp.m7266toStringimpl(m2000getRightD9Ej5fM())) + ", width=" + ((Object) Dp.m7266toStringimpl(this.width)) + ')';
    }
}
