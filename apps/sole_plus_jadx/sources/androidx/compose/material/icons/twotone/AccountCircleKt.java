...
public final class AccountCircleKt {
    ...
    public static final ImageVector getAccountCircle(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.AccountCircle", Dp.m7255constructorimpl(24.0f), Dp.m7255constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilder3.close();
        ImageVector imageVectorBuild = ImageVector.Builder.m5274addPathoIyEayM$default(builder, pathBuilder3.getNodes(), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, iM4908getButtKaPHkGw3, iM4918getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
