...
public final class ShareKt {
    ...
    public static final ImageVector getShare(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Share", Dp.m7255constructorimpl(24.0f), Dp.m7255constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilder.arcToRelative(1.0f, 1.0f, 0.0f, true, true, -2.0f, 0.0f);
        ImageVector.Builder.m5274addPathoIyEayM$default(builder, pathBuilder.getNodes(), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM4908getButtKaPHkGw, iM4918getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        int defaultFillType2 = VectorKt.getDefaultFillType();
        SolidColor solidColor2 = new SolidColor(Color.INSTANCE.m4564getBlack0d7_KjU(), null);
        int iM4908getButtKaPHkGw2 = StrokeCap.INSTANCE.m4908getButtKaPHkGw();
        int iM4918getBevelLxFBmk82 = StrokeJoin.INSTANCE.m4918getBevelLxFBmk8();
        ...
        pathBuilder2.arcToRelative(1.0f, 1.0f, 0.0f, true, true, -2.0f, 0.0f);
        ImageVector.Builder.m5274addPathoIyEayM$default(builder, pathBuilder2.getNodes(), defaultFillType2, "", solidColor2, 0.3f, null, 0.3f, 1.0f, iM4908getButtKaPHkGw2, iM4918getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        int defaultFillType3 = VectorKt.getDefaultFillType();
        SolidColor solidColor3 = new SolidColor(Color.INSTANCE.m4564getBlack0d7_KjU(), null);
        int iM4908getButtKaPHkGw3 = StrokeCap.INSTANCE.m4908getButtKaPHkGw();
        int iM4918getBevelLxFBmk83 = StrokeJoin.INSTANCE.m4918getBevelLxFBmk8();
        ...
        pathBuilder3.arcToRelative(1.0f, 1.0f, 0.0f, true, true, -2.0f, 0.0f);
        ImageVector.Builder.m5274addPathoIyEayM$default(builder, pathBuilder3.getNodes(), defaultFillType3, "", solidColor3, 0.3f, null, 0.3f, 1.0f, iM4908getButtKaPHkGw3, iM4918getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        int defaultFillType4 = VectorKt.getDefaultFillType();
        SolidColor solidColor4 = new SolidColor(Color.INSTANCE.m4564getBlack0d7_KjU(), null);
        int iM4908getButtKaPHkGw4 = StrokeCap.INSTANCE.m4908getButtKaPHkGw();
        int iM4918getBevelLxFBmk84 = StrokeJoin.INSTANCE.m4918getBevelLxFBmk8();
        ...
        pathBuilder4.reflectiveCurveToRelative(-0.45f, 1.0f, -1.0f, 1.0f);
        pathBuilder4.close();
        ImageVector imageVectorBuild = ImageVector.Builder.m5274addPathoIyEayM$default(builder, pathBuilder4.getNodes(), defaultFillType4, "", solidColor4, 1.0f, null, 1.0f, 1.0f, iM4908getButtKaPHkGw4, iM4918getBevelLxFBmk84, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
