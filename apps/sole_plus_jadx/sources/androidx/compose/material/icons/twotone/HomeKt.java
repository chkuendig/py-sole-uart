...
public final class HomeKt {
    ...
    public static final ImageVector getHome(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Home", Dp.m7255constructorimpl(24.0f), Dp.m7255constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilder2.close();
        ImageVector imageVectorBuild = ImageVector.Builder.m5274addPathoIyEayM$default(builder, pathBuilder2.getNodes(), defaultFillType2, "", solidColor2, 0.3f, null, 0.3f, 1.0f, iM4908getButtKaPHkGw2, iM4918getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
