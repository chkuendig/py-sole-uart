...
final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo1893defaultColorWaAFU9c(Composer composer, int i) {
        ...
        long jM2067defaultRippleColor5vOe2sY = RippleTheme.INSTANCE.m2067defaultRippleColor5vOe2sY(Color.INSTANCE.m4564getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public RippleAlpha rippleAlpha(Composer composer, int i) {
        ...
        RippleAlpha rippleAlphaM2066defaultRippleAlphaDxMtmZc = RippleTheme.INSTANCE.m2066defaultRippleAlphaDxMtmZc(Color.INSTANCE.m4564getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
