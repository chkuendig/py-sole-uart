...
public final class RippleAnimation {
    ...
    */
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Job>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.label == 0) {
                ...
                BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new C01022(RippleAnimation.this, null), 3, null);
        ...
        static final class C01022 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            int label;
            final /* synthetic */ RippleAnimation this$0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C01022(RippleAnimation rippleAnimation, Continuation<? super C01022> continuation) {
                super(2, continuation);
                this.this$0 = rippleAnimation;
            }
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new C01022(this.this$0, continuation);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ResultKt.throwOnFailure(obj);
                    this.label = 1;
                    if (Animatable.animateTo$default(this.this$0.animatedRadiusPercent, Boxing.boxFloat(1.0f), AnimationSpecKt.tween$default(WinError.ERROR_VIRUS_INFECTED, 0, EasingKt.getFastOutSlowInEasing(), 2, null), null, null, this, 12, null) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
                    if (i != 1) {
        ...
        static final class AnonymousClass3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ResultKt.throwOnFailure(obj);
                    this.label = 1;
                    if (Animatable.animateTo$default(this.this$0.animatedCenterPercent, Boxing.boxFloat(1.0f), AnimationSpecKt.tween$default(WinError.ERROR_VIRUS_INFECTED, 0, EasingKt.getLinearEasing(), 2, null), null, null, this, 12, null) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
                    if (i != 1) {
    ...
    static final class C05562 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Job>, Object> {
        private /* synthetic */ Object L$0;
        int label;

        C05562(Continuation<? super C05562> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C05562 c05562 = RippleAnimation.this.new C05562(continuation);
            c05562.L$0 = obj;
            return c05562;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Job> continuation) {
            return ((C05562) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final Object fadeOut(Continuation<? super Unit> continuation) {
        Object objCoroutineScope = CoroutineScopeKt.coroutineScope(new C05562(null), continuation);
        return objCoroutineScope == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCoroutineScope : Unit.INSTANCE;
    }
    ...
    public final void m2058draw4WTKRHQ(DrawScope drawScope, long j) {
        Float fValueOf;
        if (this.startRadius == null) {
            this.startRadius = Float.valueOf(RippleAnimationKt.m2060getRippleStartRadiusuvyYCjk(drawScope.mo5117getSizeNHjbRc()));
        }
        if (this.targetRadius == null) {
            if (Float.isNaN(this.radius)) {
                fValueOf = Float.valueOf(RippleAnimationKt.m2059getRippleEndRadiuscSwnlzA(drawScope, this.bounded, drawScope.mo5117getSizeNHjbRc()));
            } else {
                fValueOf = Float.valueOf(drawScope.mo677toPx0680j_4(this.radius));
            }
            this.targetRadius = fValueOf;
        }
        if (this.origin == null) {
            this.origin = Offset.m4283boximpl(drawScope.mo5116getCenterF1C5BW0());
        }
        if (this.targetCenter == null) {
            this.targetCenter = Offset.m4283boximpl(OffsetKt.Offset(Size.m4363getWidthimpl(drawScope.mo5117getSizeNHjbRc()) / 2.0f, Size.m4360getHeightimpl(drawScope.mo5117getSizeNHjbRc()) / 2.0f));
        }
        ...
        float fM4294getXimpl = Offset.m4294getXimpl(offset.m4304unboximpl());
        Offset offset2 = this.targetCenter;
        Intrinsics.checkNotNull(offset2);
        float fLerp2 = MathHelpersKt.lerp(fM4294getXimpl, Offset.m4294getXimpl(offset2.m4304unboximpl()), this.animatedCenterPercent.getValue().floatValue());
        Offset offset3 = this.origin;
        Intrinsics.checkNotNull(offset3);
        float fM4295getYimpl = Offset.m4295getYimpl(offset3.m4304unboximpl());
        Offset offset4 = this.targetCenter;
        Intrinsics.checkNotNull(offset4);
        long jOffset = OffsetKt.Offset(fLerp2, MathHelpersKt.lerp(fM4295getYimpl, Offset.m4295getYimpl(offset4.m4304unboximpl()), this.animatedCenterPercent.getValue().floatValue()));
        long jM4537copywmQWz5c$default = Color.m4537copywmQWz5c$default(j, Color.m4540getAlphaimpl(j) * fFloatValue, 0.0f, 0.0f, 0.0f, 14, null);
        if (!this.bounded) {
            DrawScope.m5098drawCircleVaOC9Bg$default(drawScope, jM4537copywmQWz5c$default, fLerp, jOffset, 0.0f, null, null, 0, 120, null);
            return;
        }
