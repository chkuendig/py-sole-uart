...
final class PullRefreshNestedScrollConnection implements NestedScrollConnection {
    ...
    public long mo1061onPreScrollOzD1aCk(long available, int source) {
        return !this.enabled ? Offset.INSTANCE.m4310getZeroF1C5BW0() : (!NestedScrollSource.m5709equalsimpl0(source, NestedScrollSource.INSTANCE.m5717getDragWNlRxjI()) || Offset.m4295getYimpl(available) >= 0.0f) ? Offset.INSTANCE.m4310getZeroF1C5BW0() : OffsetKt.Offset(0.0f, this.onPull.invoke(Float.valueOf(Offset.m4295getYimpl(available))).floatValue());
    }
    ...
    */
    public java.lang.Object mo1060onPreFlingQWom1Mo(long r5, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r7) {
        ...
        L4e:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.pullrefresh.PullRefreshNestedScrollConnection.mo1060onPreFlingQWom1Mo(long, kotlin.coroutines.Continuation):java.lang.Object");
    }
}
