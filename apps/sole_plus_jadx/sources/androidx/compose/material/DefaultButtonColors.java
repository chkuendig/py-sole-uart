...
final class DefaultButtonColors implements ButtonColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4539equalsimpl0(this.backgroundColor, defaultButtonColors.backgroundColor) && Color.m4539equalsimpl0(this.contentColor, defaultButtonColors.contentColor) && Color.m4539equalsimpl0(this.disabledBackgroundColor, defaultButtonColors.disabledBackgroundColor) && Color.m4539equalsimpl0(this.disabledContentColor, defaultButtonColors.disabledContentColor);
    }

    public int hashCode() {
        return (((((Color.m4545hashCodeimpl(this.backgroundColor) * 31) + Color.m4545hashCodeimpl(this.contentColor)) * 31) + Color.m4545hashCodeimpl(this.disabledBackgroundColor)) * 31) + Color.m4545hashCodeimpl(this.disabledContentColor);
    }
}
