...
final class DefaultSliderColors implements SliderColors {
    ...
    public State<Color> thumbColor(boolean z, Composer composer, int i) {
        ...
        ComposerKt.sourceInformation(composer, "C(thumbColor)1091@42641L69:Slider.kt#jmzs0o");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1733795637, i, -1, "androidx.compose.material.DefaultSliderColors.thumbColor (Slider.kt:1090)");
        }
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4528boximpl(z ? this.thumbColor : this.disabledThumbColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public State<Color> trackColor(boolean z, boolean z2, Composer composer, int i) {
        ...
        ComposerKt.sourceInformation(composer, "C(trackColor)P(1)1096@42828L247:Slider.kt#jmzs0o");
        if (ComposerKt.isTraceInProgress()) {
    ...
    public State<Color> tickColor(boolean z, boolean z2, Composer composer, int i) {
        ...
        ComposerKt.sourceInformation(composer, "C(tickColor)P(1)1107@43192L243:Slider.kt#jmzs0o");
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4539equalsimpl0(this.thumbColor, defaultSliderColors.thumbColor) && Color.m4539equalsimpl0(this.disabledThumbColor, defaultSliderColors.disabledThumbColor) && Color.m4539equalsimpl0(this.activeTrackColor, defaultSliderColors.activeTrackColor) && Color.m4539equalsimpl0(this.inactiveTrackColor, defaultSliderColors.inactiveTrackColor) && Color.m4539equalsimpl0(this.disabledActiveTrackColor, defaultSliderColors.disabledActiveTrackColor) && Color.m4539equalsimpl0(this.disabledInactiveTrackColor, defaultSliderColors.disabledInactiveTrackColor) && Color.m4539equalsimpl0(this.activeTickColor, defaultSliderColors.activeTickColor) && Color.m4539equalsimpl0(this.inactiveTickColor, defaultSliderColors.inactiveTickColor) && Color.m4539equalsimpl0(this.disabledActiveTickColor, defaultSliderColors.disabledActiveTickColor) && Color.m4539equalsimpl0(this.disabledInactiveTickColor, defaultSliderColors.disabledInactiveTickColor);
    }

    public int hashCode() {
        return (((((((((((((((((Color.m4545hashCodeimpl(this.thumbColor) * 31) + Color.m4545hashCodeimpl(this.disabledThumbColor)) * 31) + Color.m4545hashCodeimpl(this.activeTrackColor)) * 31) + Color.m4545hashCodeimpl(this.inactiveTrackColor)) * 31) + Color.m4545hashCodeimpl(this.disabledActiveTrackColor)) * 31) + Color.m4545hashCodeimpl(this.disabledInactiveTrackColor)) * 31) + Color.m4545hashCodeimpl(this.activeTickColor)) * 31) + Color.m4545hashCodeimpl(this.inactiveTickColor)) * 31) + Color.m4545hashCodeimpl(this.disabledActiveTickColor)) * 31) + Color.m4545hashCodeimpl(this.disabledInactiveTickColor);
    }
}
