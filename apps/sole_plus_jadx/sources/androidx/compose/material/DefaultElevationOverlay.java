...
final class DefaultElevationOverlay implements ElevationOverlay {
    ...
    public long mo1839apply7g2Lkgo(long j, float f, Composer composer, int i) {
        ...
        if (Dp.m7254compareTo0680j_4(f, Dp.m7255constructorimpl(0)) > 0 && !colors.isLight()) {
            j = ColorKt.m4583compositeOverOWjLjI(ElevationOverlayKt.m1864calculateForegroundColorCLU3JFs(j, f, composer, i & 126), j);
        }
        if (ComposerKt.isTraceInProgress()) {
