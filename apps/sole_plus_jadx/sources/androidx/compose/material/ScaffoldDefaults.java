...
public final class ScaffoldDefaults {
    ...
    public final WindowInsets getContentWindowInsets(Composer composer, int i) {
        ...
        ComposerKt.sourceInformation(composer, "C365@16666L29:Scaffold.kt#jmzs0o");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(423092031, i, -1, "androidx.compose.material.ScaffoldDefaults.<get-contentWindowInsets> (Scaffold.kt:365)");
        }
