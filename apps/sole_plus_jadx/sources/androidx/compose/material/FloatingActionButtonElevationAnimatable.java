...
final class FloatingActionButtonElevationAnimatable {
    ...
    @DebugMetadata(c = "androidx.compose.material.FloatingActionButtonElevationAnimatable", f = "FloatingActionButton.kt", i = {0, 0}, l = {395}, m = "animateElevation", n = {"this", "to"}, s = {"L$0", "L$1"})
    ...
    /* compiled from: FloatingActionButton.kt */
    @Metadata(k = 3, mv = {1, 8, 0}, xi = 48)
    @DebugMetadata(c = "androidx.compose.material.FloatingActionButtonElevationAnimatable", f = "FloatingActionButton.kt", i = {0}, l = {381}, m = "snapElevation", n = {"this"}, s = {"L$0"})
    ...
    static final class C05161 extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    private FloatingActionButtonElevationAnimatable(float f, float f2, float f3, float f4) {
        ...
        this.animatable = new Animatable<>(Dp.m7253boximpl(this.defaultElevation), VectorConvertersKt.getVectorConverter(Dp.INSTANCE), null, null, 12, null);
    }
    ...
    public final Object m1884updateElevationlDy3nrA(float f, float f2, float f3, float f4, Continuation<? super Unit> continuation) throws Throwable {
        this.defaultElevation = f;
        this.pressedElevation = f2;
        this.hoveredElevation = f3;
        this.focusedElevation = f4;
    ...
    */
    public final java.lang.Object snapElevation(kotlin.coroutines.Continuation<? super kotlin.Unit> r5) throws java.lang.Throwable {
        /*
            r4 = this;
            boolean r0 = r5 instanceof androidx.compose.material.FloatingActionButtonElevationAnimatable.C05161
            if (r0 == 0) goto L14
            r0 = r5
            androidx.compose.material.FloatingActionButtonElevationAnimatable$snapElevation$1 r0 = (androidx.compose.material.FloatingActionButtonElevationAnimatable.C05161) r0
            int r1 = r0.label
        ...
        L38:
            ...
            float r2 = r2.m7269unboximpl()
            boolean r2 = androidx.compose.ui.unit.Dp.m7260equalsimpl0(r2, r5)
            if (r2 != 0) goto L71
            ...
            androidx.compose.ui.unit.Dp r5 = androidx.compose.ui.unit.Dp.m7253boximpl(r5)     // Catch: java.lang.Throwable -> L6a
    ...
    */
    public final java.lang.Object animateElevation(androidx.compose.foundation.interaction.Interaction r6, kotlin.coroutines.Continuation<? super kotlin.Unit> r7) throws java.lang.Throwable {
        ...
        L3c:
            ...
            float r2 = r2.m7269unboximpl()     // Catch: java.lang.Throwable -> L6e
            boolean r2 = androidx.compose.ui.unit.Dp.m7260equalsimpl0(r2, r7)     // Catch: java.lang.Throwable -> L6e
            if (r2 != 0) goto L68
            androidx.compose.animation.core.Animatable<androidx.compose.ui.unit.Dp, androidx.compose.animation.core.AnimationVector1D> r2 = r5.animatable     // Catch: java.lang.Throwable -> L6e
            ...
            java.lang.Object r7 = androidx.compose.material.ElevationKt.m1861animateElevationrAjV9yQ(r2, r7, r4, r6, r0)     // Catch: java.lang.Throwable -> L6e
            if (r7 != r1) goto L68
            return r1
        L68:
            r0 = r5
