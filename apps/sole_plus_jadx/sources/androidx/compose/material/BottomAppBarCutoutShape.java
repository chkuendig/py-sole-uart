...
final /* data */ class BottomAppBarCutoutShape implements Shape {
    ...
    public Outline mo588createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        ...
        Path.addRect(new Rect(0.0f, 0.0f, Size.m4363getWidthimpl(size), Size.m4360getHeightimpl(size)));
        Path Path2 = AndroidPath_androidKt.Path();
        addCutoutShape(Path2, layoutDirection, density);
        Path2.mo4428opN5in7k0(Path, Path2, PathOperation.INSTANCE.m4842getDifferenceb3I0S0c());
    ...
    private final void addCutoutShape(Path path, LayoutDirection layoutDirection, Density density) {
        float fMo677toPx0680j_4 = density.mo677toPx0680j_4(AppBarKt.BottomAppBarCutoutOffset);
        float f = 2 * fMo677toPx0680j_4;
        long jSize = SizeKt.Size(this.fabPlacement.getWidth() + f, this.fabPlacement.getHeight() + f);
        float left = this.fabPlacement.getLeft() - fMo677toPx0680j_4;
        float fM4363getWidthimpl = left + Size.m4363getWidthimpl(jSize);
        float fM4360getHeightimpl = Size.m4360getHeightimpl(jSize) / 2.0f;
        OutlineKt.addOutline(path, this.cutoutShape.mo588createOutlinePq9zytI(jSize, layoutDirection, density));
        path.mo4431translatek4lQ0M(OffsetKt.Offset(left, -fM4360getHeightimpl));
        if (Intrinsics.areEqual(this.cutoutShape, RoundedCornerShapeKt.getCircleShape())) {
            addRoundedEdges(path, left, fM4363getWidthimpl, fM4360getHeightimpl, density.mo677toPx0680j_4(AppBarKt.BottomAppBarRoundedEdgeRadius), 0.0f);
        }
    }
