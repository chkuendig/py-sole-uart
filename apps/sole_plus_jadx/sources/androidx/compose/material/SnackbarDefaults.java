...
public final class SnackbarDefaults {
    ...
    public final long getBackgroundColor(Composer composer, int i) {
        ...
        long jM4583compositeOverOWjLjI = ColorKt.m4583compositeOverOWjLjI(Color.m4537copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composer, 6).m1798getOnSurface0d7_KjU(), SnackbarOverlayAlpha, 0.0f, 0.0f, 0.0f, 14, null), MaterialTheme.INSTANCE.getColors(composer, 6).m1803getSurface0d7_KjU());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return jM4583compositeOverOWjLjI;
    }

    public final long getPrimaryActionColor(Composer composer, int i) {
        long jM1800getPrimaryVariant0d7_KjU;
        ...
        if (colors.isLight()) {
            jM1800getPrimaryVariant0d7_KjU = ColorKt.m4583compositeOverOWjLjI(Color.m4537copywmQWz5c$default(colors.m1803getSurface0d7_KjU(), 0.6f, 0.0f, 0.0f, 0.0f, 14, null), colors.m1799getPrimary0d7_KjU());
        } else {
            jM1800getPrimaryVariant0d7_KjU = colors.m1800getPrimaryVariant0d7_KjU();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return jM1800getPrimaryVariant0d7_KjU;
    }
}
