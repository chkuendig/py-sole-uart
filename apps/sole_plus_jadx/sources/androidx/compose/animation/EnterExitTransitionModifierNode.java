...
final class EnterExitTransitionModifierNode extends LayoutModifierNodeWithPassThroughIntrinsics {
    ...
    private final void m394setLookaheadConstraintsBRTryo0(long j) {
    ...
    public final long m396sizeByStateUzc_VyU(EnterExitState targetState, long fullSize) {
        ...
        if (i == 2) {
            ChangeSize changeSize = this.enter.getData().getChangeSize();
            return (changeSize == null || (size = changeSize.getSize()) == null) ? fullSize : size.invoke(IntSize.m7418boximpl(fullSize)).m7430unboximpl();
        }
        if (i != 3) {
            throw new NoWhenBranchMatchedException();
        }
        ChangeSize changeSize2 = this.exit.getData().getChangeSize();
        return (changeSize2 == null || (size2 = changeSize2.getSize()) == null) ? fullSize : size2.invoke(IntSize.m7418boximpl(fullSize)).m7430unboximpl();
    }
    ...
    public final long m398targetOffsetByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        if (this.currentAlignment != null && getAlignment() != null && !Intrinsics.areEqual(this.currentAlignment, getAlignment())) {
            int i = WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()];
            if (i == 1) {
                return IntOffset.INSTANCE.m7394getZeronOccac();
            }
            if (i == 2) {
                return IntOffset.INSTANCE.m7394getZeronOccac();
            }
            ...
            if (changeSize != null) {
                long jM7430unboximpl = changeSize.getSize().invoke(IntSize.m7418boximpl(fullSize)).m7430unboximpl();
                Alignment alignment = getAlignment();
                Intrinsics.checkNotNull(alignment);
                long jMo4017alignKFBX0sM = alignment.mo4017alignKFBX0sM(fullSize, jM7430unboximpl, LayoutDirection.Ltr);
                Alignment alignment2 = this.currentAlignment;
                Intrinsics.checkNotNull(alignment2);
                return IntOffset.m7386minusqkQi6aY(jMo4017alignKFBX0sM, alignment2.mo4017alignKFBX0sM(fullSize, jM7430unboximpl, LayoutDirection.Ltr));
            }
            return IntOffset.INSTANCE.m7394getZeronOccac();
        }
        return IntOffset.INSTANCE.m7394getZeronOccac();
    ...
    public MeasureResult mo395measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (measureScope.isLookingAhead()) {
            ...
            long jIntSize = IntSizeKt.IntSize(placeableMo5957measureBRTryo0.getWidth(), placeableMo5957measureBRTryo0.getHeight());
            this.lookaheadSize = jIntSize;
            m394setLookaheadConstraintsBRTryo0(j);
            return MeasureScope.layout$default(measureScope, IntSize.m7426getWidthimpl(jIntSize), IntSize.m7425getHeightimpl(jIntSize), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$1
                {
                    super(1);
                }
        ...
        if (this.isEnabled.invoke().booleanValue()) {
            ...
            final Placeable placeableMo5957measureBRTryo02 = measurable.mo5957measureBRTryo0(j);
            long jIntSize2 = IntSizeKt.IntSize(placeableMo5957measureBRTryo02.getWidth(), placeableMo5957measureBRTryo02.getHeight());
            final long j2 = AnimationModifierKt.m372isValidozmzZPI(this.lookaheadSize) ? this.lookaheadSize : jIntSize2;
            ...
            State<IntSize> stateAnimate3 = deferredAnimation != null ? deferredAnimation.animate(this.sizeTransitionSpec, new Function1<EnterExitState, IntSize>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$animSize$1
                ...
                public /* bridge */ /* synthetic */ IntSize invoke(EnterExitState enterExitState) {
                    return IntSize.m7418boximpl(m399invokeYEO4UFw(enterExitState));
                }

                /* renamed from: invoke-YEO4UFw, reason: not valid java name */
                public final long m399invokeYEO4UFw(EnterExitState enterExitState) {
                    return this.this$0.m396sizeByStateUzc_VyU(enterExitState, j2);
                }
            }) : null;
            if (stateAnimate3 != null) {
                jIntSize2 = stateAnimate3.getValue().m7430unboximpl();
            }
            long jM7222constrain4WqzIAM = ConstraintsKt.m7222constrain4WqzIAM(j, jIntSize2);
            Transition<EnterExitState>.DeferredAnimation<IntOffset, AnimationVector2D> deferredAnimation2 = this.offsetAnimation;
            final long jM7394getZeronOccac = (deferredAnimation2 == null || (stateAnimate2 = deferredAnimation2.animate(new Function1<Transition.Segment<EnterExitState>, FiniteAnimationSpec<IntOffset>>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$offsetDelta$1
                @Override // kotlin.jvm.functions.Function1
                public final FiniteAnimationSpec<IntOffset> invoke(Transition.Segment<EnterExitState> segment) {
                    return EnterExitTransitionKt.DefaultOffsetAnimationSpec;
                }
                ...
                public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                    return IntOffset.m7374boximpl(m400invokeBjo55l4(enterExitState));
                }

                /* renamed from: invoke-Bjo55l4, reason: not valid java name */
                public final long m400invokeBjo55l4(EnterExitState enterExitState) {
                    return this.this$0.m398targetOffsetByStateoFUgxo0(enterExitState, j2);
                }
            })) == null) ? IntOffset.INSTANCE.m7394getZeronOccac() : stateAnimate2.getValue().m7392unboximpl();
            Transition<EnterExitState>.DeferredAnimation<IntOffset, AnimationVector2D> deferredAnimation3 = this.slideAnimation;
            long jM7394getZeronOccac2 = (deferredAnimation3 == null || (stateAnimate = deferredAnimation3.animate(this.slideSpec, new Function1<EnterExitState, IntOffset>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$slideOffset$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                @Override // kotlin.jvm.functions.Function1
                public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                    return IntOffset.m7374boximpl(m401invokeBjo55l4(enterExitState));
                }

                /* renamed from: invoke-Bjo55l4, reason: not valid java name */
                public final long m401invokeBjo55l4(EnterExitState enterExitState) {
                    return this.this$0.m397slideTargetValueByStateoFUgxo0(enterExitState, j2);
                }
            })) == null) ? IntOffset.INSTANCE.m7394getZeronOccac() : stateAnimate.getValue().m7392unboximpl();
            Alignment alignment2 = this.currentAlignment;
            final long jM7387plusqkQi6aY = IntOffset.m7387plusqkQi6aY(alignment2 != null ? alignment2.mo4017alignKFBX0sM(j2, jM7222constrain4WqzIAM, LayoutDirection.Ltr) : IntOffset.INSTANCE.m7394getZeronOccac(), jM7394getZeronOccac2);
            return MeasureScope.layout$default(measureScope, IntSize.m7426getWidthimpl(jM7222constrain4WqzIAM), IntSize.m7425getHeightimpl(jM7222constrain4WqzIAM), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                ...
                /* renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2(Placeable.PlacementScope placementScope) {
                    placementScope.placeWithLayer(placeableMo5957measureBRTryo02, IntOffset.m7383getXimpl(jM7394getZeronOccac) + IntOffset.m7383getXimpl(jM7387plusqkQi6aY), IntOffset.m7384getYimpl(jM7394getZeronOccac) + IntOffset.m7384getYimpl(jM7387plusqkQi6aY), 0.0f, function1Init);
                }
            }, 4, null);
        }
        final Placeable placeableMo5957measureBRTryo03 = measurable.mo5957measureBRTryo0(j);
        return MeasureScope.layout$default(measureScope, placeableMo5957measureBRTryo03.getWidth(), placeableMo5957measureBRTryo03.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$3$1
            {
                super(1);
            }
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.place$default(placementScope, placeableMo5957measureBRTryo03, 0, 0, 0.0f, 4, null);
            }
        }, 4, null);
    }
    ...
    public final long m397slideTargetValueByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        Function1<IntSize, IntOffset> slideOffset;
        Function1<IntSize, IntOffset> slideOffset2;
        Slide slide = this.enter.getData().getSlide();
        long jM7394getZeronOccac = (slide == null || (slideOffset2 = slide.getSlideOffset()) == null) ? IntOffset.INSTANCE.m7394getZeronOccac() : slideOffset2.invoke(IntSize.m7418boximpl(fullSize)).m7392unboximpl();
        Slide slide2 = this.exit.getData().getSlide();
        long jM7394getZeronOccac2 = (slide2 == null || (slideOffset = slide2.getSlideOffset()) == null) ? IntOffset.INSTANCE.m7394getZeronOccac() : slideOffset.invoke(IntSize.m7418boximpl(fullSize)).m7392unboximpl();
        int i = WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()];
        if (i == 1) {
            return IntOffset.INSTANCE.m7394getZeronOccac();
        }
