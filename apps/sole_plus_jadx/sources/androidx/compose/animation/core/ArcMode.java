...
public final class ArcMode {
    ...
    private static final int ArcAbove = m448constructorimpl(5);
    private static final int ArcBelow = m448constructorimpl(4);
    private static final int ArcLinear = m448constructorimpl(0);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ArcMode m447boximpl(int i) {
    ...
    public static boolean m449equalsimpl(int i, Object obj) {
    ...
    public static int m451hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m452toStringimpl(int i) {
