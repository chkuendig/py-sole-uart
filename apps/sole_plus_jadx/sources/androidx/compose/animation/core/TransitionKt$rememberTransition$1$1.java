...
@DebugMetadata(c = "androidx.compose.animation.core.TransitionKt$rememberTransition$1$1", f = "Transition.kt", i = {0}, l = {LMErr.NERR_ServiceCtlNotValid}, m = "invokeSuspend", n = {"$this$withLock_u24default$iv"}, s = {"L$0"})
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            ...
            if (compositionContinuation$animation_core_release != null) {
                ...
                compositionContinuation$animation_core_release.resumeWith(Result.m9087constructorimpl(transitionState.getTargetState()));
            }
