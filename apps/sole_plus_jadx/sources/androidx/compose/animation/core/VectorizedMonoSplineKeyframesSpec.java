    ...
    private final void init(V initialValue, V targetValue, V initialVelocity) {
        ...
        if (this.values == null) {
            ...
            if (!zAreEqual && !this.keyframes.contains(0)) {
                ...
                if (fArr6 == null) {
                    Intrinsics.throwUninitializedPropertyAccessException(SdkConstants.FD_RES_VALUES);
                    fArr6 = null;
                }
