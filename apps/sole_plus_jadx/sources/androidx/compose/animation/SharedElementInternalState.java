...
public final class SharedElementInternalState implements LayerRenderer, RememberObserver {
    ...
    public void drawInOverlay(DrawScope drawScope) {
        ...
        if (layer != null && getShouldRenderInOverlay$animation_release()) {
            ...
            Unit unit = null;
            Offset offsetM4283boximpl = currentBounds != null ? Offset.m4283boximpl(currentBounds.m4329getTopLeftF1C5BW0()) : null;
            Intrinsics.checkNotNull(offsetM4283boximpl);
            long jM4304unboximpl = offsetM4283boximpl.m4304unboximpl();
            float fM4294getXimpl = Offset.m4294getXimpl(jM4304unboximpl);
            float fM4295getYimpl = Offset.m4295getYimpl(jM4304unboximpl);
            ...
            if (path != null) {
                ...
                try {
                    ...
                    drawScope.getDrawContext().getTransform().translate(fM4294getXimpl, fM4295getYimpl);
                    try {
    ...
    public final long m411getNonNullLookaheadSizeNHjbRc() {
        ...
        return IntSizeKt.m7438toSizeozmzZPI(layoutCoordinatesInvoke.mo5965getSizeYbymL2g());
    }
    ...
    public final long m410calculateLookaheadOffsetF1C5BW0() {
        LayoutCoordinates layoutCoordinatesInvoke = this.lookaheadCoords.invoke();
        if (layoutCoordinatesInvoke == null) {
            throw new IllegalArgumentException("Error: lookahead coordinates is null.".toString());
        }
        return getSharedElement().getScope().getLookaheadRoot$animation_release().mo5966localPositionOfR5De75A(layoutCoordinatesInvoke, Offset.INSTANCE.m4310getZeroF1C5BW0());
    }
