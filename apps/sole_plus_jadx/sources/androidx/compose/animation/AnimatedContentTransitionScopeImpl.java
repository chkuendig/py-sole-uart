...
public final class AnimatedContentTransitionScopeImpl<S> implements AnimatedContentTransitionScope<S> {
    ...
    private final MutableState measuredSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m7418boximpl(IntSize.INSTANCE.m7431getZeroYbymL2g()), null, 2, null);
    ...
    public EnterTransition mo345slideIntoContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> initialOffset) {
        return m364isLeftgWo6LJ4(towards) ? EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$1
            ...
            public final Integer invoke(int i) {
                return initialOffset.invoke(Integer.valueOf(IntSize.m7426getWidthimpl(this.m363getCurrentSizeYbymL2g()) - IntOffset.m7383getXimpl(this.m362calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), this.m363getCurrentSizeYbymL2g()))));
            }
        }) : m365isRightgWo6LJ4(towards) ? EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final Integer invoke(int i) {
                return initialOffset.invoke(Integer.valueOf((-IntOffset.m7383getXimpl(this.m362calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), this.m363getCurrentSizeYbymL2g()))) - i));
            }
        }) : AnimatedContentTransitionScope.SlideDirection.m350equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m359getUpDKzdypw()) ? EnterExitTransitionKt.slideInVertically(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$3
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final Integer invoke(int i) {
                return initialOffset.invoke(Integer.valueOf(IntSize.m7425getHeightimpl(this.m363getCurrentSizeYbymL2g()) - IntOffset.m7384getYimpl(this.m362calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), this.m363getCurrentSizeYbymL2g()))));
            }
        }) : AnimatedContentTransitionScope.SlideDirection.m350equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m354getDownDKzdypw()) ? EnterExitTransitionKt.slideInVertically(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$4
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final Integer invoke(int i) {
                return initialOffset.invoke(Integer.valueOf((-IntOffset.m7384getYimpl(this.m362calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), this.m363getCurrentSizeYbymL2g()))) - i));
            }
        }) : EnterTransition.INSTANCE.getNone();
    }

    /* renamed from: isLeft-gWo6LJ4, reason: not valid java name */
    private final boolean m364isLeftgWo6LJ4(int i) {
        return AnimatedContentTransitionScope.SlideDirection.m350equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m356getLeftDKzdypw()) || (AnimatedContentTransitionScope.SlideDirection.m350equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m358getStartDKzdypw()) && this.layoutDirection == LayoutDirection.Ltr) || (AnimatedContentTransitionScope.SlideDirection.m350equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m355getEndDKzdypw()) && this.layoutDirection == LayoutDirection.Rtl);
    }

    /* renamed from: isRight-gWo6LJ4, reason: not valid java name */
    private final boolean m365isRightgWo6LJ4(int i) {
        return AnimatedContentTransitionScope.SlideDirection.m350equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m357getRightDKzdypw()) || (AnimatedContentTransitionScope.SlideDirection.m350equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m358getStartDKzdypw()) && this.layoutDirection == LayoutDirection.Rtl) || (AnimatedContentTransitionScope.SlideDirection.m350equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m355getEndDKzdypw()) && this.layoutDirection == LayoutDirection.Ltr);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: calculateOffset-emnUabE, reason: not valid java name */
    public final long m362calculateOffsetemnUabE(long fullSize, long currentSize) {
        return getContentAlignment().mo4017alignKFBX0sM(fullSize, currentSize, LayoutDirection.Ltr);
    }

    @Override // androidx.compose.animation.AnimatedContentTransitionScope
    /* renamed from: slideOutOfContainer-mOhB8PU */
    public ExitTransition mo346slideOutOfContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> targetOffset) {
        return m364isLeftgWo6LJ4(towards) ? EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$1
            ...
            public final Integer invoke(int i) {
                ...
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m7383getXimpl(this.this$0.m362calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), state != null ? ((IntSize) state.getValue()).m7430unboximpl() : IntSize.INSTANCE.m7431getZeroYbymL2g()))) - i));
            }
        }) : m365isRightgWo6LJ4(towards) ? EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$2
            final /* synthetic */ AnimatedContentTransitionScopeImpl<S> this$0;
            ...
            public final Integer invoke(int i) {
                State state = (State) this.this$0.getTargetSizeMap$animation_release().get(this.this$0.getTransition$animation_release().getTargetState());
                long jM7430unboximpl = state != null ? ((IntSize) state.getValue()).m7430unboximpl() : IntSize.INSTANCE.m7431getZeroYbymL2g();
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m7383getXimpl(this.this$0.m362calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), jM7430unboximpl))) + IntSize.m7426getWidthimpl(jM7430unboximpl)));
            }
            ...
            public final Integer invoke(int i) {
                State state = (State) this.this$0.getTargetSizeMap$animation_release().get(this.this$0.getTransition$animation_release().getTargetState());
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m7384getYimpl(this.this$0.m362calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), state != null ? ((IntSize) state.getValue()).m7430unboximpl() : IntSize.INSTANCE.m7431getZeroYbymL2g()))) - i));
            }
        }) : AnimatedContentTransitionScope.SlideDirection.m350equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m354getDownDKzdypw()) ? EnterExitTransitionKt.slideOutVertically(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$4
            final /* synthetic */ AnimatedContentTransitionScopeImpl<S> this$0;
            ...
            public final Integer invoke(int i) {
                State state = (State) this.this$0.getTargetSizeMap$animation_release().get(this.this$0.getTransition$animation_release().getTargetState());
                long jM7430unboximpl = state != null ? ((IntSize) state.getValue()).m7430unboximpl() : IntSize.INSTANCE.m7431getZeroYbymL2g();
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m7384getYimpl(this.this$0.m362calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), jM7430unboximpl))) + IntSize.m7425getHeightimpl(jM7430unboximpl)));
            }
    ...
    public final long m366getMeasuredSizeYbymL2g$animation_release() {
        return ((IntSize) this.measuredSize.getValue()).m7430unboximpl();
    }

    /* renamed from: setMeasuredSize-ozmzZPI$animation_release, reason: not valid java name */
    public final void m367setMeasuredSizeozmzZPI$animation_release(long j) {
        this.measuredSize.setValue(IntSize.m7418boximpl(j));
    }
    ...
    public final long m363getCurrentSizeYbymL2g() {
        State<IntSize> state = this.animatedSize;
        return state != null ? state.getValue().m7430unboximpl() : m366getMeasuredSizeYbymL2g$animation_release();
    }
        ...
        public MeasureResult mo368measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
            ...
            Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>> function1 = new Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$size$1
                ...
                public final FiniteAnimationSpec<IntSize> invoke(Transition.Segment<S> segment) {
                    FiniteAnimationSpec<IntSize> finiteAnimationSpecMo427createAnimationSpecTemP2vQ;
                    State<IntSize> state = animatedContentTransitionScopeImpl.getTargetSizeMap$animation_release().get(segment.getInitialState());
                    long jM7430unboximpl2 = state != null ? state.getValue().m7430unboximpl() : IntSize.INSTANCE.m7431getZeroYbymL2g();
                    State<IntSize> state2 = animatedContentTransitionScopeImpl.getTargetSizeMap$animation_release().get(segment.getTargetState());
                    long jM7430unboximpl3 = state2 != null ? state2.getValue().m7430unboximpl() : IntSize.INSTANCE.m7431getZeroYbymL2g();
                    SizeTransform value = this.getSizeTransform().getValue();
                    return (value == null || (finiteAnimationSpecMo427createAnimationSpecTemP2vQ = value.mo427createAnimationSpecTemP2vQ(jM7430unboximpl2, jM7430unboximpl3)) == null) ? AnimationSpecKt.spring$default(0.0f, 0.0f, null, 7, null) : finiteAnimationSpecMo427createAnimationSpecTemP2vQ;
                }
            };
            ...
            State<IntSize> stateAnimate = deferredAnimation.animate(function1, new Function1<S, IntSize>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$size$2
                ...
                public /* bridge */ /* synthetic */ IntSize invoke(Object obj) {
                    return IntSize.m7418boximpl(m369invokeYEO4UFw(obj));
                }

                /* renamed from: invoke-YEO4UFw, reason: not valid java name */
                public final long m369invokeYEO4UFw(S s) {
                    State<IntSize> state = animatedContentTransitionScopeImpl2.getTargetSizeMap$animation_release().get(s);
                    return state != null ? state.getValue().m7430unboximpl() : IntSize.INSTANCE.m7431getZeroYbymL2g();
                }
            });
            AnimatedContentTransitionScopeImpl.this.setAnimatedSize$animation_release(stateAnimate);
            if (measureScope.isLookingAhead()) {
                jM7430unboximpl = IntSizeKt.IntSize(placeableMo5957measureBRTryo0.getWidth(), placeableMo5957measureBRTryo0.getHeight());
            } else {
                jM7430unboximpl = stateAnimate.getValue().m7430unboximpl();
            }
            int iM7426getWidthimpl = IntSize.m7426getWidthimpl(jM7430unboximpl);
            int iM7425getHeightimpl = IntSize.m7425getHeightimpl(jM7430unboximpl);
            final AnimatedContentTransitionScopeImpl<S> animatedContentTransitionScopeImpl3 = AnimatedContentTransitionScopeImpl.this;
            return MeasureScope.layout$default(measureScope, iM7426getWidthimpl, iM7425getHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(Placeable.PlacementScope placementScope) {
                    Placeable.PlacementScope.m6022place70tqf50$default(placementScope, placeableMo5957measureBRTryo0, animatedContentTransitionScopeImpl3.getContentAlignment().mo4017alignKFBX0sM(IntSizeKt.IntSize(placeableMo5957measureBRTryo0.getWidth(), placeableMo5957measureBRTryo0.getHeight()), jM7430unboximpl, LayoutDirection.Ltr), 0.0f, 2, null);
                }
            }, 4, null);
        }
    }
