...
final class SkipToLookaheadNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m429setLookaheadConstraints_Sx5XlM(Constraints constraints) {
    ...
    public MeasureResult mo395measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        if (measureScope.isLookingAhead()) {
            this.lookaheadConstraints = Constraints.m7195boximpl(j);
        }
        Constraints constraints = this.lookaheadConstraints;
        Intrinsics.checkNotNull(constraints);
        final Placeable placeableMo5957measureBRTryo0 = measurable.mo5957measureBRTryo0(constraints.getValue());
        final long jIntSize = IntSizeKt.IntSize(placeableMo5957measureBRTryo0.getWidth(), placeableMo5957measureBRTryo0.getHeight());
        final long jM7222constrain4WqzIAM = ConstraintsKt.m7222constrain4WqzIAM(j, jIntSize);
        return MeasureScope.layout$default(measureScope, IntSize.m7426getWidthimpl(jM7222constrain4WqzIAM), IntSize.m7425getHeightimpl(jM7222constrain4WqzIAM), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SkipToLookaheadNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                if (IntSize.m7426getWidthimpl(jIntSize) == 0 || IntSize.m7425getHeightimpl(jIntSize) == 0) {
                    jScaleFactor = ScaleFactorKt.ScaleFactor(1.0f, 1.0f);
                } else {
                    jScaleFactor = contentScale.mo5950computeScaleFactorH7hwNQA(IntSizeKt.m7438toSizeozmzZPI(jIntSize), IntSizeKt.m7438toSizeozmzZPI(jM7222constrain4WqzIAM));
                }
                long jMo4017alignKFBX0sM = scaleToBounds.getAlignment().mo4017alignKFBX0sM(IntSizeKt.IntSize(MathKt.roundToInt(IntSize.m7426getWidthimpl(jIntSize) * ScaleFactor.m6047getScaleXimpl(jScaleFactor)), MathKt.roundToInt(IntSize.m7425getHeightimpl(jIntSize) * ScaleFactor.m6048getScaleYimpl(jScaleFactor))), jM7222constrain4WqzIAM, measureScope.getLayoutDirection());
                Placeable.PlacementScope.placeWithLayer$default(placementScope, placeableMo5957measureBRTryo0, IntOffset.m7383getXimpl(jMo4017alignKFBX0sM), IntOffset.m7384getYimpl(jMo4017alignKFBX0sM), 0.0f, new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.animation.SkipToLookaheadNode$measure$1.1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    }
                    ...
                    public final void invoke2(GraphicsLayerScope graphicsLayerScope) {
                        graphicsLayerScope.setScaleX(ScaleFactor.m6047getScaleXimpl(jScaleFactor));
                        graphicsLayerScope.setScaleY(ScaleFactor.m6048getScaleYimpl(jScaleFactor));
                        graphicsLayerScope.mo4740setTransformOrigin__ExYCQ(TransformOriginKt.TransformOrigin(0.0f, 0.0f));
                    }
                }, 4, (Object) null);
            }
        }, 4, null);
