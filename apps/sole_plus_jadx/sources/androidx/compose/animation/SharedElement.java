...
public final class SharedElement {
    ...
    public final Rect getTargetBounds() {
        ...
        set_targetBounds(sharedElementInternalState != null ? RectKt.m4334Recttz77jQw(sharedElementInternalState.m410calculateLookaheadOffsetF1C5BW0(), sharedElementInternalState.m411getNonNullLookaheadSizeNHjbRc()) : null);
    ...
    public final void m409onLookaheadResultv_w8tDc(SharedElementInternalState state, long lookaheadSize, long topLeft) {
        if (state.getBoundsAnimation().getTarget()) {
            this.targetBoundsProvider = state;
            Rect rect = get_targetBounds();
            Offset offsetM4283boximpl = rect != null ? Offset.m4283boximpl(rect.m4329getTopLeftF1C5BW0()) : null;
            if (offsetM4283boximpl == null ? false : Offset.m4291equalsimpl0(offsetM4283boximpl.m4304unboximpl(), topLeft)) {
                Rect rect2 = get_targetBounds();
                Size sizeM4351boximpl = rect2 != null ? Size.m4351boximpl(rect2.m4327getSizeNHjbRc()) : null;
                if (sizeM4351boximpl == null ? false : Size.m4359equalsimpl0(sizeM4351boximpl.m4368unboximpl(), lookaheadSize)) {
                    return;
                }
            }
            Rect rectM4334Recttz77jQw = RectKt.m4334Recttz77jQw(topLeft, lookaheadSize);
            set_targetBounds(rectM4334Recttz77jQw);
            SnapshotStateList<SharedElementInternalState> snapshotStateList = this.states;
            int size = snapshotStateList.size();
            for (int i = 0; i < size; i++) {
                ...
                boundsAnimation.animate(currentBounds, rectM4334Recttz77jQw);
            }
        }
    }
