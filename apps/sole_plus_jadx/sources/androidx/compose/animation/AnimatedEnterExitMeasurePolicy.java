...
final class AnimatedEnterExitMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo342measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        for (int i = 0; i < size; i++) {
            arrayList.add(list.get(i).mo5957measureBRTryo0(j));
        }
        ...
        if (measureScope.isLookingAhead()) {
            ...
            this.scope.getTargetSize$animation_release().setValue(IntSize.m7418boximpl(IntSizeKt.IntSize(width3, height3)));
