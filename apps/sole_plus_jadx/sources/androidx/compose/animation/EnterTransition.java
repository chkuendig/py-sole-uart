...
public abstract class EnterTransition {
    ...
    public final EnterTransition plus(EnterTransition enter) {
        ...
        return new EnterTransitionImpl(new TransitionData(fade2, slide2, changeSize2, scale, false, MapsKt.plus(getData$animation_release().getEffectsMap(), enter.getData$animation_release().getEffectsMap()), 16, null));
    }
