...
final class SizeAnimationModifierNode extends LayoutModifierNodeWithPassThroughIntrinsics {
    ...
    public static final /* data */ class AnimData {
        ...
        public static /* synthetic */ AnimData m422copyO0kMr_c$default(AnimData animData, Animatable animatable, long j, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return animData.m424copyO0kMr_c(animatable, j);
        }
        ...
        public final AnimData m424copyO0kMr_c(Animatable<IntSize, AnimationVector2D> anim, long startSize) {
        ...
        public boolean equals(Object other) {
            ...
            return Intrinsics.areEqual(this.anim, animData.anim) && IntSize.m7424equalsimpl0(this.startSize, animData.startSize);
        }

        public int hashCode() {
            return (this.anim.hashCode() * 31) + IntSize.m7427hashCodeimpl(this.startSize);
        }

        public String toString() {
            return "AnimData(anim=" + this.anim + ", startSize=" + ((Object) IntSize.m7429toStringimpl(this.startSize)) + ')';
        }
        ...
        public final long m425getStartSizeYbymL2g() {
            return this.startSize;
        }

        /* renamed from: setStartSize-ozmzZPI, reason: not valid java name */
        public final void m426setStartSizeozmzZPI(long j) {
            this.startSize = j;
        }
    }
    ...
    public MeasureResult mo395measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        ...
        long jM7222constrain4WqzIAM;
        if (measureScope.isLookingAhead()) {
            m419setLookaheadConstraintsBRTryo0(j);
            placeableMo5957measureBRTryo0 = measurable.mo5957measureBRTryo0(j);
        } else {
            placeableMo5957measureBRTryo0 = measurable.mo5957measureBRTryo0(m420targetConstraintsZezNO4M(j));
        }
        ...
        if (measureScope.isLookingAhead()) {
            ...
            jM7222constrain4WqzIAM = jIntSize;
        } else {
            jM7222constrain4WqzIAM = ConstraintsKt.m7222constrain4WqzIAM(j, m421animateTomzRDjE0(AnimationModifierKt.m372isValidozmzZPI(this.lookaheadSize) ? this.lookaheadSize : jIntSize));
        }
        final int iM7426getWidthimpl = IntSize.m7426getWidthimpl(jM7222constrain4WqzIAM);
        final int iM7425getHeightimpl = IntSize.m7425getHeightimpl(jM7222constrain4WqzIAM);
        return MeasureScope.layout$default(measureScope, iM7426getWidthimpl, iM7425getHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SizeAnimationModifierNode$measure$2
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.m6023placeRelative70tqf50$default(placementScope, placeable, this.this$0.getAlignment().mo4017alignKFBX0sM(jIntSize, IntSizeKt.IntSize(iM7426getWidthimpl, iM7425getHeightimpl), measureScope.getLayoutDirection()), 0.0f, 2, null);
            }
        }, 4, null);
    }

    /* renamed from: animateTo-mzRDjE0, reason: not valid java name */
    public final long m421animateTomzRDjE0(long targetSize) {
        AnimData animData = getAnimData();
        if (animData != null) {
            boolean z = (IntSize.m7424equalsimpl0(targetSize, animData.getAnim().getValue().m7430unboximpl()) || animData.getAnim().isRunning()) ? false : true;
            if (!IntSize.m7424equalsimpl0(targetSize, animData.getAnim().getTargetValue().m7430unboximpl()) || z) {
                animData.m426setStartSizeozmzZPI(animData.getAnim().getValue().m7430unboximpl());
            ...
            animData = new AnimData(new Animatable(IntSize.m7418boximpl(targetSize), VectorConvertersKt.getVectorConverter(IntSize.INSTANCE), IntSize.m7418boximpl(IntSizeKt.IntSize(1, 1)), null, 8, null), targetSize, null);
        }
        setAnimData(animData);
        return animData.getAnim().getValue().m7430unboximpl();
    }
}
