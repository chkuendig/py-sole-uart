...
public final class SharedBoundsNode extends Modifier.Node implements ApproachLayoutModifierNode, DrawModifierNode, ModifierLocalModifierNode {
    ...
    public MeasureResult mo395measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        final long jSize = SizeKt.Size(placeableMo5957measureBRTryo0.getWidth(), placeableMo5957measureBRTryo0.getHeight());
        return MeasureScope.layout$default(measureScope, placeableMo5957measureBRTryo0.getWidth(), placeableMo5957measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SharedBoundsNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Offset offsetM4283boximpl;
                LayoutCoordinates coordinates = placementScope.getCoordinates();
                if (coordinates != null) {
                    SharedBoundsNode sharedBoundsNode = this;
                    long j2 = jSize;
                    long jMo5966localPositionOfR5De75A = sharedBoundsNode.getRootLookaheadCoords().mo5966localPositionOfR5De75A(coordinates, Offset.INSTANCE.m4310getZeroF1C5BW0());
                    if (sharedBoundsNode.getSharedElement().getCurrentBounds() == null) {
                        sharedBoundsNode.getSharedElement().setCurrentBounds(RectKt.m4334Recttz77jQw(jMo5966localPositionOfR5De75A, j2));
                    }
                    offsetM4283boximpl = Offset.m4283boximpl(jMo5966localPositionOfR5De75A);
                } else {
                    offsetM4283boximpl = null;
                }
                Placeable.PlacementScope.place$default(placementScope, placeableMo5957measureBRTryo0, 0, 0, 0.0f, 4, null);
                if (offsetM4283boximpl != null) {
                    SharedBoundsNode sharedBoundsNode2 = this;
                    sharedBoundsNode2.getSharedElement().m409onLookaheadResultv_w8tDc(sharedBoundsNode2.getState(), jSize, offsetM4283boximpl.m4304unboximpl());
                }
            }
        }, 4, null);
    }
    ...
    private final MeasureResult place(MeasureScope measureScope, final Placeable placeable) {
        long jMo412calculateSizeJyjRU_E = this.state.getPlaceHolderSize().mo412calculateSizeJyjRU_E(requireLookaheadLayoutCoordinates().mo5965getSizeYbymL2g(), IntSizeKt.IntSize(placeable.getWidth(), placeable.getHeight()));
        return MeasureScope.layout$default(measureScope, IntSize.m7426getWidthimpl(jMo412calculateSizeJyjRU_E), IntSize.m7425getHeightimpl(jMo412calculateSizeJyjRU_E), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SharedBoundsNode.place.1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                if (SharedBoundsNode.this.getSharedElement().getFoundMatch()) {
                    ...
                    Offset offsetM4283boximpl = coordinates2 != null ? Offset.m4283boximpl(SharedBoundsNode.this.getRootCoords().mo5966localPositionOfR5De75A(coordinates2, Offset.INSTANCE.m4310getZeroF1C5BW0())) : null;
                    if (value != null) {
                        if (SharedBoundsNode.this.getBoundsAnimation().getTarget()) {
                            SharedBoundsNode.this.getSharedElement().setCurrentBounds(value);
                        }
                        jM4329getTopLeftF1C5BW0 = value.m4329getTopLeftF1C5BW0();
                    } else {
                        ...
                        jM4329getTopLeftF1C5BW0 = currentBounds2.m4329getTopLeftF1C5BW0();
                    }
                    long jM4298minusMKHz9U = offsetM4283boximpl != null ? Offset.m4298minusMKHz9U(jM4329getTopLeftF1C5BW0, offsetM4283boximpl.m4304unboximpl()) : Offset.INSTANCE.m4310getZeroF1C5BW0();
                    Placeable.PlacementScope.place$default(placementScope, placeable, Math.round(Offset.m4294getXimpl(jM4298minusMKHz9U)), Math.round(Offset.m4295getYimpl(jM4298minusMKHz9U)), 0.0f, 4, null);
                    return;
                }
    ...
    public boolean mo408isMeasurementApproachInProgressozmzZPI(long lookaheadSize) {
        return getSharedElement().getFoundMatch() && this.state.getSharedElement().getScope().isTransitionActive();
    }

    @Override // androidx.compose.ui.layout.ApproachLayoutModifierNode
    /* renamed from: approachMeasure-3p2s80s, reason: not valid java name */
    public MeasureResult mo407approachMeasure3p2s80s(ApproachMeasureScope approachMeasureScope, Measurable measurable, long j) {
        if (getSharedElement().getFoundMatch()) {
            ...
            if (value != null) {
                long jM7434roundToIntSizeuvyYCjk = IntSizeKt.m7434roundToIntSizeuvyYCjk(value.m4327getSizeNHjbRc());
                int iM7426getWidthimpl = IntSize.m7426getWidthimpl(jM7434roundToIntSizeuvyYCjk);
                int iM7425getHeightimpl = IntSize.m7425getHeightimpl(jM7434roundToIntSizeuvyYCjk);
                if (iM7426getWidthimpl == Integer.MAX_VALUE || iM7425getHeightimpl == Integer.MAX_VALUE) {
                ...
                j = Constraints.INSTANCE.m7218fixedJhjzzOo(RangesKt.coerceAtLeast(iM7426getWidthimpl, 0), RangesKt.coerceAtLeast(iM7425getHeightimpl, 0));
            }
        }
        return place(approachMeasureScope, measurable.mo5957measureBRTryo0(j));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void updateCurrentBounds(LayoutCoordinates layoutCoordinates) {
        getSharedElement().setCurrentBounds(RectKt.m4334Recttz77jQw(getRootCoords().mo5966localPositionOfR5De75A(layoutCoordinates, Offset.INSTANCE.m4310getZeroF1C5BW0()), SizeKt.Size(IntSize.m7426getWidthimpl(layoutCoordinates.mo5965getSizeYbymL2g()), IntSize.m7425getHeightimpl(layoutCoordinates.mo5965getSizeYbymL2g()))));
    }
    ...
    public void draw(final ContentDrawScope contentDrawScope) {
        ...
        DrawScope.m5115recordJVtK1S4$default(contentDrawScope2, layer, 0L, new Function1<DrawScope, Unit>() { // from class: androidx.compose.animation.SharedBoundsNode.draw.1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
