...
public final class RenderInTransitionOverlayNode extends Modifier.Node implements DrawModifierNode, ModifierLocalModifierNode {
    ...
    private final class LayerWithRenderer implements LayerRenderer {
        ...
        public void drawInOverlay(DrawScope drawScope) {
            if (RenderInTransitionOverlayNode.this.getRenderInOverlay().invoke().booleanValue()) {
                ...
                long jMo5966localPositionOfR5De75A = renderInTransitionOverlayNode.getSharedScope().getRoot$animation_release().mo5966localPositionOfR5De75A(DelegatableNodeKt.requireLayoutCoordinates(renderInTransitionOverlayNode2), Offset.INSTANCE.m4310getZeroF1C5BW0());
                float fM4294getXimpl = Offset.m4294getXimpl(jMo5966localPositionOfR5De75A);
                float fM4295getYimpl = Offset.m4295getYimpl(jMo5966localPositionOfR5De75A);
                ...
                if (pathInvoke != null) {
                    ...
                    try {
                        drawContext.getTransform().mo5040clipPathmtrdDE(pathInvoke, iM4527getIntersectrtfAjoo);
    ...
    public void draw(final ContentDrawScope contentDrawScope) {
        ...
        DrawScope.m5115recordJVtK1S4$default(contentDrawScope2, layer, 0L, new Function1<DrawScope, Unit>() { // from class: androidx.compose.animation.RenderInTransitionOverlayNode.draw.1
            {
                super(1);
            }
