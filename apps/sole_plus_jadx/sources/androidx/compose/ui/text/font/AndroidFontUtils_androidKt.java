...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m6781getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int i) {
        return getAndroidTypefaceStyle(fontWeight.compareTo(getAndroidBold(FontWeight.INSTANCE)) >= 0, FontStyle.m6830equalsimpl0(i, FontStyle.INSTANCE.m6836getItalic_LCdwA()));
    }
}
