...
public final class TextDrawStyleKt {
    public static final TextForegroundStyle lerp(TextForegroundStyle textForegroundStyle, TextForegroundStyle textForegroundStyle2, float f) {
        ...
        if (!z && !(textForegroundStyle2 instanceof BrushStyle)) {
            return TextForegroundStyle.INSTANCE.m7160from8_81llA(ColorKt.m4589lerpjxsXWHM(textForegroundStyle.mo7025getColor0d7_KjU(), textForegroundStyle2.mo7025getColor0d7_KjU(), f));
        }
        if (z && (textForegroundStyle2 instanceof BrushStyle)) {
    ...
    public static final long m7159modulateDxMtmZc(long j, float f) {
        return (Float.isNaN(f) || f >= 1.0f) ? j : Color.m4537copywmQWz5c$default(j, Color.m4540getAlphaimpl(j) * f, 0.0f, 0.0f, 0.0f, 14, null);
    }
