...
public final class Html_androidKt {
    ...
    private static final void addSpans(AnnotatedString.Builder builder, Spanned spanned, TextLinkStyles textLinkStyles, LinkInteractionListener linkInteractionListener) {
        for (Object obj : spanned.getSpans(0, builder.getLength(), Object.class)) {
            ...
            addSpan(builder, obj, TextRange.m6717getStartimpl(jTextRange), TextRange.m6712getEndimpl(jTextRange), textLinkStyles, linkInteractionListener);
        }
    }
    ...
    private static final void addSpan(AnnotatedString.Builder builder, Object obj, int i, int i2, TextLinkStyles textLinkStyles, LinkInteractionListener linkInteractionListener) {
        ...
        if (obj instanceof BulletSpanWithLevel) {
            long jM6541getDefaultIndentationXSAIIZE = Bullet.INSTANCE.m6541getDefaultIndentationXSAIIZE();
            ...
            TextUnitKt.m7462checkArithmeticR2X_6o(jM6541getDefaultIndentationXSAIIZE);
            builder.m6531addBulletr9BaKPg(bulletSpanWithLevel.getBullet(), TextUnitKt.pack(TextUnit.m7447getRawTypeimpl(jM6541getDefaultIndentationXSAIIZE), TextUnit.m7449getValueimpl(jM6541getDefaultIndentationXSAIIZE) * indentationLevel), i, i2);
            return;
        }
        ...
        if (obj instanceof SubscriptSpan) {
            builder.addStyle(new SpanStyle(0L, 0L, (FontWeight) null, (FontStyle) null, (FontSynthesis) null, (FontFamily) null, (String) null, 0L, BaselineShift.m7011boximpl(BaselineShift.INSTANCE.m7022getSubscripty9eOQZs()), (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65279, (DefaultConstructorMarker) null), i, i2);
            return;
        }
        if (obj instanceof SuperscriptSpan) {
            builder.addStyle(new SpanStyle(0L, 0L, (FontWeight) null, (FontStyle) null, (FontSynthesis) null, (FontFamily) null, (String) null, 0L, BaselineShift.m7011boximpl(BaselineShift.INSTANCE.m7023getSuperscripty9eOQZs()), (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65279, (DefaultConstructorMarker) null), i, i2);
            return;
        }
    ...
    private static final ParagraphStyle toParagraphStyle(AlignmentSpan alignmentSpan) {
        int iM7144getStarte0LSkKk;
        Layout.Alignment alignment = alignmentSpan.getAlignment();
        int i = alignment == null ? -1 : WhenMappings.$EnumSwitchMapping$0[alignment.ordinal()];
        if (i == 1) {
            iM7144getStarte0LSkKk = TextAlign.INSTANCE.m7144getStarte0LSkKk();
        } else if (i == 2) {
            iM7144getStarte0LSkKk = TextAlign.INSTANCE.m7139getCentere0LSkKk();
        } else if (i == 3) {
            iM7144getStarte0LSkKk = TextAlign.INSTANCE.m7140getEnde0LSkKk();
        } else {
            iM7144getStarte0LSkKk = TextAlign.INSTANCE.m7145getUnspecifiede0LSkKk();
        }
        return new ParagraphStyle(iM7144getStarte0LSkKk, 0, 0L, (TextIndent) null, (PlatformParagraphStyle) null, (LineHeightStyle) null, 0, 0, (TextMotion) null, TypedValues.PositionType.TYPE_POSITION_TYPE, (DefaultConstructorMarker) null);
    }
