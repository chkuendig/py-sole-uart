...
public final class TextStyleKt {
    ...
    public static final int m6763resolveTextDirectionIhaHGbI(LayoutDirection layoutDirection, int i) {
        if (TextDirection.m7149equalsimpl0(i, TextDirection.INSTANCE.m7153getContents_7Xco())) {
            int i2 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i2 == 1) {
                return TextDirection.INSTANCE.m7154getContentOrLtrs_7Xco();
            }
            if (i2 != 2) {
                throw new NoWhenBranchMatchedException();
            }
            return TextDirection.INSTANCE.m7155getContentOrRtls_7Xco();
        }
        if (!TextDirection.m7149equalsimpl0(i, TextDirection.INSTANCE.m7158getUnspecifieds_7Xco())) {
            return i;
        }
        int i3 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
        if (i3 == 1) {
            return TextDirection.INSTANCE.m7156getLtrs_7Xco();
        }
        if (i3 != 2) {
            throw new NoWhenBranchMatchedException();
        }
        return TextDirection.INSTANCE.m7157getRtls_7Xco();
    }
