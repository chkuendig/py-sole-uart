...
public final class BeyondBoundsLayoutKt {
    ...
    public static final <T> T m4168searchBeyondBoundsOMvw8(FocusTargetNode focusTargetNode, int i, Function1<? super BeyondBoundsLayout.BeyondBoundsScope, ? extends T> function1) {
        Modifier.Node nodePop;
        BeyondBoundsLayout beyondBoundsLayoutParent;
        int iM5946getBeforehoxUOeE;
        NodeChain nodes;
        ...
        if (FocusDirection.m4173equalsimpl0(i, FocusDirection.INSTANCE.m4184getUpdhqQ8s())) {
            iM5946getBeforehoxUOeE = BeyondBoundsLayout.LayoutDirection.INSTANCE.m5944getAbovehoxUOeE();
        } else if (FocusDirection.m4173equalsimpl0(i, FocusDirection.INSTANCE.m4177getDowndhqQ8s())) {
            iM5946getBeforehoxUOeE = BeyondBoundsLayout.LayoutDirection.INSTANCE.m5947getBelowhoxUOeE();
        } else if (FocusDirection.m4173equalsimpl0(i, FocusDirection.INSTANCE.m4180getLeftdhqQ8s())) {
            iM5946getBeforehoxUOeE = BeyondBoundsLayout.LayoutDirection.INSTANCE.m5948getLefthoxUOeE();
        } else if (FocusDirection.m4173equalsimpl0(i, FocusDirection.INSTANCE.m4183getRightdhqQ8s())) {
            iM5946getBeforehoxUOeE = BeyondBoundsLayout.LayoutDirection.INSTANCE.m5949getRighthoxUOeE();
        } else if (FocusDirection.m4173equalsimpl0(i, FocusDirection.INSTANCE.m4181getNextdhqQ8s())) {
            iM5946getBeforehoxUOeE = BeyondBoundsLayout.LayoutDirection.INSTANCE.m5945getAfterhoxUOeE();
        } else {
            if (!FocusDirection.m4173equalsimpl0(i, FocusDirection.INSTANCE.m4182getPreviousdhqQ8s())) {
                throw new IllegalStateException("Unsupported direction for beyond bounds layout".toString());
            }
            iM5946getBeforehoxUOeE = BeyondBoundsLayout.LayoutDirection.INSTANCE.m5946getBeforehoxUOeE();
        }
        return (T) beyondBoundsLayoutParent.mo1138layouto7g1Pn8(iM5946getBeforehoxUOeE, function1);
    }
}
