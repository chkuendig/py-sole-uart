...
public final /* data */ class TransferParameters {
    ...
    public TransferParameters(double d, double d2, double d3, double d4, double d5, double d6, double d7) {
        ...
        if (!Double.isNaN(d2) && !Double.isNaN(d3) && !Double.isNaN(d4) && !Double.isNaN(d5) && !Double.isNaN(d6) && !Double.isNaN(d7) && !Double.isNaN(d)) {
            ...
            if (d5 < AudioStats.AUDIO_AMPLITUDE_NONE || d5 > 1.0d) {
                throw new IllegalArgumentException("Parameter d must be in the range [0..1], was " + d5);
            }
            if (d5 == AudioStats.AUDIO_AMPLITUDE_NONE && (d2 == AudioStats.AUDIO_AMPLITUDE_NONE || d == AudioStats.AUDIO_AMPLITUDE_NONE)) {
                throw new IllegalArgumentException("Parameter a or g is zero, the transfer function is constant");
            }
            if (d5 >= 1.0d && d4 == AudioStats.AUDIO_AMPLITUDE_NONE) {
                throw new IllegalArgumentException("Parameter c is zero, the transfer function is constant");
            }
            if ((d2 == AudioStats.AUDIO_AMPLITUDE_NONE || d == AudioStats.AUDIO_AMPLITUDE_NONE) && d4 == AudioStats.AUDIO_AMPLITUDE_NONE) {
