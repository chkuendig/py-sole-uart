...
public final class Oklab extends ColorSpace {
    ...
    public Oklab(String str, int i) {
        super(str, ColorModel.INSTANCE.m4969getLabxdoWZVw(), i, null);
    }
