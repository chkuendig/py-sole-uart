...
public final class ComposeScrollCaptureCallback implements ScrollCaptureCallback {
    ...
    static final class C07391 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C07391(ScrollCaptureSession scrollCaptureSession, Rect rect, Consumer<Rect> consumer, Continuation<? super C07391> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return ComposeScrollCaptureCallback.this.new C07391(this.$session, this.$captureArea, this.$onComplete, continuation);
        }
    ...
    public void onScrollCaptureImageRequest(ScrollCaptureSession session, CancellationSignal signal, Rect captureArea, Consumer<Rect> onComplete) {
        ComposeScrollCaptureCallback_androidKt.launchWithCancellationSignal(this.coroutineScope, signal, new C07391(session, captureArea, onComplete, null));
    }
    ...
    */
    ...
    private final void drawDebugBackground(Canvas canvas) {
        canvas.drawColor(ColorKt.m4592toArgb8_81llA(Color.Companion.m4562hslJlNiLsg$default(Color.INSTANCE, Random.INSTANCE.nextFloat() * 360.0f, 0.75f, 0.5f, 1.0f, null, 16, null)));
    }
