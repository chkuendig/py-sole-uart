...
public final class FontScaleConverterFactory {
    ...
    private final void put(float scaleKey, FontScaleConverter fontScaleConverter) {
        synchronized (LookupTablesWriteLock) {
            ...
            SparseArrayCompat<FontScaleConverter> sparseArrayCompatM338clone = sLookupTables.m338clone();
            fontScaleConverterFactory.putInto(sparseArrayCompatM338clone, scaleKey, fontScaleConverter);
            sLookupTables = sparseArrayCompatM338clone;
            Unit unit = Unit.INSTANCE;
        }
    }
