...
final class EmptyFillMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo342measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        return MeasureScope.layout$default(measureScope, Constraints.m7208getMaxWidthimpl(j), Constraints.m7207getMaxHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.spatial.EmptyFillMeasurePolicy$measure$1
