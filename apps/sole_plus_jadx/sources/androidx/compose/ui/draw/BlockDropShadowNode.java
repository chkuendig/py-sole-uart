...
public final class BlockDropShadowNode extends Modifier.Node implements DrawModifierNode, ObserverModifierNode, DropShadowScope {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof BlockDropShadowNode)) {
            ...
            return getAlpha() == blockDropShadowNode.getAlpha() && Intrinsics.areEqual(this.shape, blockDropShadowNode.shape) && this.block == blockDropShadowNode.block && getRadius() == blockDropShadowNode.getRadius() && getSpread() == blockDropShadowNode.getSpread() && Offset.m4291equalsimpl0(getOffset(), blockDropShadowNode.getOffset()) && Color.m4539equalsimpl0(getColor(), blockDropShadowNode.getColor()) && Intrinsics.areEqual(getBrush(), blockDropShadowNode.getBrush()) && BlendMode.m4448equalsimpl0(getBlendMode(), blockDropShadowNode.getBlendMode());
        }
        return false;
    }
