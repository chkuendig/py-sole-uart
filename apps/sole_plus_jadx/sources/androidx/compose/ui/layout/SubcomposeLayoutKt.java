...
public final class SubcomposeLayoutKt {
    ...
    public static final void SubcomposeLayout(final Modifier modifier, final Function2<? super SubcomposeMeasureScope, ? super Constraints, ? extends MeasureResult> function2, Composer composer, final int i, final int i2) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(SubcomposeLayout)P(1)94@4643L36,93@4609L145:SubcomposeLayout.kt#80mrfh");
        int i4 = i2 & 1;
        if (i4 != 0) {
            i3 = i | 6;
        } else if ((i & 6) == 0) {
        ...
        if (!composerStartRestartGroup.shouldExecute((i3 & 19) != 18, i3 & 1)) {
            ...
            ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, 2118156148, "CC(remember):SubcomposeLayout.kt#9igjgp");
    ...
    public static final void SubcomposeLayout(final SubcomposeLayoutState subcomposeLayoutState, Modifier modifier, final Function2<? super SubcomposeMeasureScope, ? super Constraints, ? extends MeasureResult> function2, Composer composer, final int i, final int i2) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(SubcomposeLayout)P(2,1)126@6106L27,127@6174L28,130@6330L436:SubcomposeLayout.kt#80mrfh");
        if ((i2 & 1) != 0) {
            i3 = i | 6;
        } else if ((i & 6) == 0) {
        ...
        if (!composerStartRestartGroup.shouldExecute((i3 & 147) != 146, i3 & 1)) {
            ...
            Updater.m3864setimpl(composerM3857constructorimpl, subcomposeLayoutState, subcomposeLayoutState.getSetRoot$ui_release());
            Updater.m3864setimpl(composerM3857constructorimpl, compositionContextRememberCompositionContext, subcomposeLayoutState.getSetCompositionContext$ui_release());
            Updater.m3864setimpl(composerM3857constructorimpl, function2, subcomposeLayoutState.getSetMeasurePolicy$ui_release());
            ...
            if (!composerStartRestartGroup.getSkipping()) {
                composerStartRestartGroup.startReplaceGroup(-1259274676);
                ComposerKt.sourceInformation(composerStartRestartGroup, "142@6823L34,142@6812L45");
                ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, 1899041531, "CC(remember):SubcomposeLayout.kt#9igjgp");
                ...
                composerStartRestartGroup.startReplaceGroup(-1259216055);
                composerStartRestartGroup.endReplaceGroup();
            }
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
