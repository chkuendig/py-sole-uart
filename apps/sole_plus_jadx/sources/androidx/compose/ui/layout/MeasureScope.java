...
public interface MeasureScope extends IntrinsicMeasureScope {
    ...
    public static final class DefaultImpls {
        ...
        public static int m6000roundToPxR2X_6o(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo670roundToPxR2X_6o(j);
        }

        @Deprecated
        /* renamed from: roundToPx-0680j_4, reason: not valid java name */
        public static int m6001roundToPx0680j_4(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo671roundToPx0680j_4(f);
        }

        @Deprecated
        /* renamed from: toDp-GaN1DYA, reason: not valid java name */
        public static float m6002toDpGaN1DYA(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo672toDpGaN1DYA(j);
        }

        @Deprecated
        /* renamed from: toDp-u2uoSUM, reason: not valid java name */
        public static float m6003toDpu2uoSUM(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo673toDpu2uoSUM(f);
        }

        @Deprecated
        /* renamed from: toDp-u2uoSUM, reason: not valid java name */
        public static float m6004toDpu2uoSUM(MeasureScope measureScope, int i) {
            return MeasureScope.super.mo674toDpu2uoSUM(i);
        }

        @Deprecated
        /* renamed from: toDpSize-k-rfVVM, reason: not valid java name */
        public static long m6005toDpSizekrfVVM(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo675toDpSizekrfVVM(j);
        }

        @Deprecated
        /* renamed from: toPx--R2X_6o, reason: not valid java name */
        public static float m6006toPxR2X_6o(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo676toPxR2X_6o(j);
        }

        @Deprecated
        /* renamed from: toPx-0680j_4, reason: not valid java name */
        public static float m6007toPx0680j_4(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo677toPx0680j_4(f);
        }
        ...
        public static long m6008toSizeXkaWNTQ(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo678toSizeXkaWNTQ(j);
        }

        @Deprecated
        /* renamed from: toSp-0xMU5do, reason: not valid java name */
        public static long m6009toSp0xMU5do(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo679toSp0xMU5do(f);
        }

        @Deprecated
        /* renamed from: toSp-kPz2Gy4, reason: not valid java name */
        public static long m6010toSpkPz2Gy4(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo680toSpkPz2Gy4(f);
        }

        @Deprecated
        /* renamed from: toSp-kPz2Gy4, reason: not valid java name */
        public static long m6011toSpkPz2Gy4(MeasureScope measureScope, int i) {
            return MeasureScope.super.mo681toSpkPz2Gy4(i);
        }
