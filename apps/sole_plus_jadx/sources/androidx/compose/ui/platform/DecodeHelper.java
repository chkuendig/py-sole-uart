...
public final class DecodeHelper {
    ...
    public final SpanStyle decodeSpanStyle() {
        ...
        MutableSpanStyle mutableSpanStyle3 = new MutableSpanStyle(0L, 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, Advapi32.MAX_VALUE_NAME, null);
        while (this.parcel.dataAvail() > 1) {
            ...
            if (bDecodeByte != 1) {
                ...
                if (bDecodeByte == 2) {
                    ...
                    mutableSpanStyle.m6423setFontSizeR2X_6o(m6382decodeTextUnitXSAIIZE());
                    ...
                    mutableSpanStyle.m6424setFontStylemLjRB2g(FontStyle.m6827boximpl(m6380decodeFontStyle_LCdwA()));
                    mutableSpanStyle2 = mutableSpanStyle;
                            ...
                            if (bDecodeByte != 8) {
                                if (bDecodeByte != 9) {
                                    if (bDecodeByte != 10) {
                                        ...
                                        mutableSpanStyle.m6420setBackground8_81llA(m6379decodeColor0d7_KjU());
                                    }
                                } else {
                                    if (dataAvailable() < 8) {
                                        break;
                                ...
                                mutableSpanStyle.m6421setBaselineShift_isdbwI(BaselineShift.m7011boximpl(m6377decodeBaselineShifty9eOQZs()));
                            }
                        } else {
                            if (dataAvailable() < 5) {
                                break;
                            }
                            mutableSpanStyle.m6426setLetterSpacingR2X_6o(m6382decodeTextUnitXSAIIZE());
                        }
                    } else {
                    ...
                    mutableSpanStyle.m6425setFontSynthesistDdu0R4(FontSynthesis.m6838boximpl(m6381decodeFontSynthesisGVVA2EU()));
                    mutableSpanStyle2 = mutableSpanStyle;
                }
            } else {
                if (dataAvailable() < 8) {
                ...
                mutableSpanStyle2.m6422setColor8_81llA(m6379decodeColor0d7_KjU());
            }
        }
        mutableSpanStyle = mutableSpanStyle2;
    ...
    public final long m6379decodeColor0d7_KjU() {
        return AndroidColor_androidKt.fromColorLong(Color.INSTANCE, this.parcel.readLong());
    }

    /* renamed from: decodeTextUnit-XSAIIZE, reason: not valid java name */
    public final long m6382decodeTextUnitXSAIIZE() {
        long jM7483getUnspecifiedUIouoOA;
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 1) {
            jM7483getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m7482getSpUIouoOA();
        } else if (bDecodeByte == 2) {
            jM7483getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m7481getEmUIouoOA();
        } else {
            jM7483getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m7483getUnspecifiedUIouoOA();
        }
        if (TextUnitType.m7477equalsimpl0(jM7483getUnspecifiedUIouoOA, TextUnitType.INSTANCE.m7483getUnspecifiedUIouoOA())) {
            return TextUnit.INSTANCE.m7460getUnspecifiedXSAIIZE();
        }
        return TextUnitKt.m7461TextUnitanM5pPY(decodeFloat(), jM7483getUnspecifiedUIouoOA);
    }
    ...
    public final int m6380decodeFontStyle_LCdwA() {
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 0) {
            return FontStyle.INSTANCE.m6837getNormal_LCdwA();
        }
        if (bDecodeByte == 1) {
            return FontStyle.INSTANCE.m6836getItalic_LCdwA();
        }
        return FontStyle.INSTANCE.m6837getNormal_LCdwA();
    }

    /* renamed from: decodeFontSynthesis-GVVA2EU, reason: not valid java name */
    public final int m6381decodeFontSynthesisGVVA2EU() {
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 0) {
            return FontSynthesis.INSTANCE.m6848getNoneGVVA2EU();
        }
        if (bDecodeByte == 1) {
            return FontSynthesis.INSTANCE.m6847getAllGVVA2EU();
        }
        if (bDecodeByte == 3) {
            return FontSynthesis.INSTANCE.m6849getStyleGVVA2EU();
        }
        if (bDecodeByte == 2) {
            return FontSynthesis.INSTANCE.m6850getWeightGVVA2EU();
        }
        return FontSynthesis.INSTANCE.m6848getNoneGVVA2EU();
    }

    /* renamed from: decodeBaselineShift-y9eOQZs, reason: not valid java name */
    private final float m6377decodeBaselineShifty9eOQZs() {
        return BaselineShift.m7012constructorimpl(decodeFloat());
    }
    ...
    private final Shadow decodeShadow() {
        long jM6379decodeColor0d7_KjU = m6379decodeColor0d7_KjU();
        float fDecodeFloat = decodeFloat();
        float fDecodeFloat2 = decodeFloat();
        return new Shadow(jM6379decodeColor0d7_KjU, Offset.m4286constructorimpl((Float.floatToRawIntBits(fDecodeFloat) << 32) | (4294967295L & Float.floatToRawIntBits(fDecodeFloat2))), decodeFloat(), null);
    }
    ...
    private final long m6378decodeULongsVKNKU() {
        return ULong.m9261constructorimpl(this.parcel.readLong());
    }
