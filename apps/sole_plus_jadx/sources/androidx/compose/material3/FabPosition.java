...
public final class FabPosition {
    ...
    private static final int Start = m2401constructorimpl(0);
    private static final int Center = m2401constructorimpl(1);
    private static final int End = m2401constructorimpl(2);
    private static final int EndOverlay = m2401constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FabPosition m2400boximpl(int i) {
        return new FabPosition(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m2401constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2402equalsimpl(int i, Object obj) {
        return (obj instanceof FabPosition) && i == ((FabPosition) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2403equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m2404hashCodeimpl(int i) {
    ...
    public int hashCode() {
        return m2404hashCodeimpl(this.value);
    }
    ...
    public String toString() {
        return m2405toStringimpl(this.value);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m2405toStringimpl(int i) {
        return m2403equalsimpl0(i, Start) ? "FabPosition.Start" : m2403equalsimpl0(i, Center) ? "FabPosition.Center" : m2403equalsimpl0(i, End) ? "FabPosition.End" : "FabPosition.EndOverlay";
    }
}
