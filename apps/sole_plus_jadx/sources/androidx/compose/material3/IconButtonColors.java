...
public final class IconButtonColors {
    ...
    public final long m2432containerColorvNxB06k$material3_release(boolean enabled) {
    ...
    public final long m2433contentColorvNxB06k$material3_release(boolean enabled) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4539equalsimpl0(this.containerColor, iconButtonColors.containerColor) && Color.m4539equalsimpl0(this.contentColor, iconButtonColors.contentColor) && Color.m4539equalsimpl0(this.disabledContainerColor, iconButtonColors.disabledContainerColor) && Color.m4539equalsimpl0(this.disabledContentColor, iconButtonColors.disabledContentColor);
    }

    public int hashCode() {
        return (((((Color.m4545hashCodeimpl(this.containerColor) * 31) + Color.m4545hashCodeimpl(this.contentColor)) * 31) + Color.m4545hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m4545hashCodeimpl(this.disabledContentColor);
    }

    /* renamed from: copy-jRlVdoo, reason: not valid java name */
    public final IconButtonColors m2434copyjRlVdoo(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor) {
        return new IconButtonColors(containerColor != Color.INSTANCE.m4574getUnspecified0d7_KjU() ? containerColor : this.containerColor, contentColor != Color.INSTANCE.m4574getUnspecified0d7_KjU() ? contentColor : this.contentColor, disabledContainerColor != Color.INSTANCE.m4574getUnspecified0d7_KjU() ? disabledContainerColor : this.disabledContainerColor, disabledContentColor != Color.INSTANCE.m4574getUnspecified0d7_KjU() ? disabledContentColor : this.disabledContentColor, null);
    }
}
