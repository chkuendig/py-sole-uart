...
final class ListItemType implements Comparable<ListItemType> {
    ...
    private static final int OneLine = m2499constructorimpl(1);
    private static final int TwoLine = m2499constructorimpl(2);
    private static final int ThreeLine = m2499constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ListItemType m2497boximpl(int i) {
        return new ListItemType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m2499constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2500equalsimpl(int i, Object obj) {
        return (obj instanceof ListItemType) && i == ((ListItemType) obj).getLines();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2501equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m2502hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m2503toStringimpl(int i) {
        return "ListItemType(lines=" + i + ')';
    }

    public boolean equals(Object obj) {
        return m2500equalsimpl(this.lines, obj);
    }

    public int hashCode() {
        return m2502hashCodeimpl(this.lines);
    }

    public String toString() {
        return m2503toStringimpl(this.lines);
    }
    ...
    public /* bridge */ /* synthetic */ int compareTo(ListItemType listItemType) {
        return m2504compareToyh95HIg(listItemType.getLines());
    }
    ...
    public static int m2498compareToyh95HIg(int i, int i2) {
        return Intrinsics.compare(i, i2);
    }

    /* renamed from: compareTo-yh95HIg, reason: not valid java name */
    public int m2504compareToyh95HIg(int i) {
        return m2498compareToyh95HIg(this.lines, i);
    }
