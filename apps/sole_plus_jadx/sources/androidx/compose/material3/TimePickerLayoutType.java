...
public final class TimePickerLayoutType {
    ...
    private static final int Horizontal = m3014constructorimpl(0);
    private static final int Vertical = m3014constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TimePickerLayoutType m3013boximpl(int i) {
        return new TimePickerLayoutType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m3014constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3015equalsimpl(int i, Object obj) {
        return (obj instanceof TimePickerLayoutType) && i == ((TimePickerLayoutType) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3016equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m3017hashCodeimpl(int i) {
    ...
    public int hashCode() {
        return m3017hashCodeimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m3020getHorizontalQJTpgSE() {
            return TimePickerLayoutType.Horizontal;
        }

        /* renamed from: getVertical-QJTpgSE, reason: not valid java name */
        public final int m3021getVerticalQJTpgSE() {
            return TimePickerLayoutType.Vertical;
        }
    }

    public String toString() {
        return m3018toStringimpl(this.value);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3018toStringimpl(int i) {
        return m3016equalsimpl0(i, Horizontal) ? "Horizontal" : m3016equalsimpl0(i, Vertical) ? "Vertical" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
