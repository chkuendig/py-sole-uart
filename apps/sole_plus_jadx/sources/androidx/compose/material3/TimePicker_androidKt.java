...
public final class TimePicker_androidKt {
    ...
    public static final int getDefaultTimePickerLayoutType(Composer composer, int i) {
        ...
        if (configuration.screenHeightDp < configuration.screenWidthDp) {
            iM3021getVerticalQJTpgSE = TimePickerLayoutType.INSTANCE.m3020getHorizontalQJTpgSE();
        } else {
            iM3021getVerticalQJTpgSE = TimePickerLayoutType.INSTANCE.m3021getVerticalQJTpgSE();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return iM3021getVerticalQJTpgSE;
    }
}
