...
public final class SliderRange {
    ...
    public static final /* synthetic */ SliderRange m2729boximpl(long j) {
        return new SliderRange(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m2730constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2731equalsimpl(long j, Object obj) {
        return (obj instanceof SliderRange) && j == ((SliderRange) obj).m2737unboximpl();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2732equalsimpl0(long j, long j2) {
        return j == j2;
    }
    ...
    public static int m2735hashCodeimpl(long j) {
    ...
    public int hashCode() {
        return m2735hashCodeimpl(this.packedValue);
    }

    /* renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ long m2737unboximpl() {
    ...
    public static final float m2734getStartimpl(long j) {
        if (j == Unspecified) {
    ...
    public static final float m2733getEndInclusiveimpl(long j) {
        if (j == Unspecified) {
            throw new IllegalStateException("SliderRange is unspecified".toString());
        }
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m2738getUnspecifiedFYbKRX4$annotations() {
        }
        ...
        public final long m2739getUnspecifiedFYbKRX4() {
            return SliderRange.Unspecified;
        }
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m2736toStringimpl(long j) {
        if (SliderKt.m2723isSpecifiedIf1S1O4(j)) {
            return m2734getStartimpl(j) + ".." + m2733getEndInclusiveimpl(j);
        }
        return "FloatRange.Unspecified";
    }

    public String toString() {
        return m2736toStringimpl(this.packedValue);
    }
}
