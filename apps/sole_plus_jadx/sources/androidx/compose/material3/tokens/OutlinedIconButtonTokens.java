...
public final class OutlinedIconButtonTokens {
    ...
    private static final float ContainerSize = Dp.m7255constructorimpl((float) 40.0d);
    ...
    private static final float Size = Dp.m7255constructorimpl((float) 24.0d);
    ...
    public final float m3509getContainerSizeD9Ej5fM() {
    ...
    public final float m3510getSizeD9Ej5fM() {
        return Size;
    }
    ...
    public final float m3511getUnselectedOutlineWidthD9Ej5fM() {
