...
public final class CircularProgressIndicatorTokens {
    ...
    private static final float ActiveIndicatorWidth = Dp.m7255constructorimpl((float) 4.0d);
    ...
    private static final float Size = Dp.m7255constructorimpl((float) 48.0d);
    ...
    public final float m3185getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m3186getSizeD9Ej5fM() {
        return Size;
    }
}
