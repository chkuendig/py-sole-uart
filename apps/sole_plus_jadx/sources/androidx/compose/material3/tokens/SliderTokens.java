...
public final class SliderTokens {
    ...
    private static final float DisabledHandleElevation = ElevationTokens.INSTANCE.m3322getLevel0D9Ej5fM();
    ...
    private static final float HandleElevation = ElevationTokens.INSTANCE.m3323getLevel1D9Ej5fM();
    ...
    private static final float LabelContainerElevation = ElevationTokens.INSTANCE.m3322getLevel0D9Ej5fM();
    private static final float LabelContainerHeight = Dp.m7255constructorimpl((float) 28.0d);
    ...
    private static final float StateLayerSize = Dp.m7255constructorimpl((float) 40.0d);
    private static final float TrackElevation = ElevationTokens.INSTANCE.m3322getLevel0D9Ej5fM();
    private static final ColorSchemeKeyTokens OverlapHandleOutlineColor = ColorSchemeKeyTokens.OnPrimary;
    private static final float OverlapHandleOutlineWidth = Dp.m7255constructorimpl((float) 1.0d);
    ...
    private static final float TickMarksContainerSize = Dp.m7255constructorimpl((float) 2.0d);
    ...
    static {
        float f = (float) 4.0d;
        ActiveTrackHeight = Dp.m7255constructorimpl(f);
        float f2 = (float) 20.0d;
        HandleHeight = Dp.m7255constructorimpl(f2);
        HandleWidth = Dp.m7255constructorimpl(f2);
        InactiveTrackHeight = Dp.m7255constructorimpl(f);
    }
    ...
    public final float m3635getActiveTrackHeightD9Ej5fM() {
    ...
    public final float m3636getDisabledHandleElevationD9Ej5fM() {
    ...
    public final float m3637getHandleElevationD9Ej5fM() {
        return HandleElevation;
    }

    /* renamed from: getHandleHeight-D9Ej5fM, reason: not valid java name */
    public final float m3638getHandleHeightD9Ej5fM() {
        return HandleHeight;
    }
    ...
    public final float m3639getHandleWidthD9Ej5fM() {
        return HandleWidth;
    }
    ...
    public final float m3640getInactiveTrackHeightD9Ej5fM() {
    ...
    public final float m3641getLabelContainerElevationD9Ej5fM() {
        return LabelContainerElevation;
    }

    /* renamed from: getLabelContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m3642getLabelContainerHeightD9Ej5fM() {
    ...
    public final float m3644getStateLayerSizeD9Ej5fM() {
        return StateLayerSize;
    }

    /* renamed from: getTrackElevation-D9Ej5fM, reason: not valid java name */
    public final float m3646getTrackElevationD9Ej5fM() {
    ...
    public final float m3643getOverlapHandleOutlineWidthD9Ej5fM() {
    ...
    public final float m3645getTickMarksContainerSizeD9Ej5fM() {
