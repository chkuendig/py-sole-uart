...
public final class ShapeTokens {
    ...
    static {
        float f = (float) 28.0d;
        CornerExtraLarge = RoundedCornerShapeKt.m1268RoundedCornerShape0680j_4(Dp.m7255constructorimpl(f));
        ...
        CornerExtraLargeTop = RoundedCornerShapeKt.m1269RoundedCornerShapea9UjIt4(fM7255constructorimpl, fM7255constructorimpl2, Dp.m7255constructorimpl(f2), Dp.m7255constructorimpl(f2));
        float f3 = (float) 4.0d;
        CornerExtraSmall = RoundedCornerShapeKt.m1268RoundedCornerShape0680j_4(Dp.m7255constructorimpl(f3));
        CornerExtraSmallTop = RoundedCornerShapeKt.m1269RoundedCornerShapea9UjIt4(Dp.m7255constructorimpl(f3), Dp.m7255constructorimpl(f3), Dp.m7255constructorimpl(f2), Dp.m7255constructorimpl(f2));
        CornerFull = RoundedCornerShapeKt.getCircleShape();
        float f4 = (float) 16.0d;
        CornerLarge = RoundedCornerShapeKt.m1268RoundedCornerShape0680j_4(Dp.m7255constructorimpl(f4));
        CornerLargeEnd = RoundedCornerShapeKt.m1269RoundedCornerShapea9UjIt4(Dp.m7255constructorimpl(f2), Dp.m7255constructorimpl(f4), Dp.m7255constructorimpl(f4), Dp.m7255constructorimpl(f2));
        CornerLargeTop = RoundedCornerShapeKt.m1269RoundedCornerShapea9UjIt4(Dp.m7255constructorimpl(f4), Dp.m7255constructorimpl(f4), Dp.m7255constructorimpl(f2), Dp.m7255constructorimpl(f2));
        CornerMedium = RoundedCornerShapeKt.m1268RoundedCornerShape0680j_4(Dp.m7255constructorimpl((float) 12.0d));
        CornerNone = RectangleShapeKt.getRectangleShape();
        CornerSmall = RoundedCornerShapeKt.m1268RoundedCornerShape0680j_4(Dp.m7255constructorimpl((float) 8.0d));
    }
}
