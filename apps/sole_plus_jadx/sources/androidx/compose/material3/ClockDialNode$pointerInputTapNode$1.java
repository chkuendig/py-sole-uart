...
final class ClockDialNode$pointerInputTapNode$1 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        ...
        if (i == 0) {
            ...
            if (TapGestureDetectorKt.detectTapGestures$default(pointerInputScope, null, null, anonymousClass1, new Function1<Offset, Unit>() { // from class: androidx.compose.material3.ClockDialNode$pointerInputTapNode$1.2
                ...
                public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                    m2200invokek4lQ0M(offset.m4304unboximpl());
                    return Unit.INSTANCE;
                }

                /* compiled from: TimePicker.kt */
                @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {1, 8, 0}, xi = 48)
                @DebugMetadata(c = "androidx.compose.material3.ClockDialNode$pointerInputTapNode$1$2$1", f = "TimePicker.kt", i = {}, l = {WinError.ERROR_VDM_DISALLOWED}, m = "invokeSuspend", n = {}, s = {})
                ...
                static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    public final Object invokeSuspend(Object obj) {
                        ...
                        if (i == 0) {
                            ResultKt.throwOnFailure(obj);
                            this.label = 1;
                            if (this.this$0.state.onTap$material3_release(Offset.m4294getXimpl(this.$it), Offset.m4295getYimpl(this.$it), this.this$0.getMaxDist(), this.this$0.autoSwitchToMinute, this) == coroutine_suspended) {
                ...
                public final void m2200invokek4lQ0M(long j) {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> {
        ...
        public /* bridge */ /* synthetic */ Object invoke(PressGestureScope pressGestureScope, Offset offset, Continuation<? super Unit> continuation) {
            return m2199invoked4ec7I(pressGestureScope, offset.m4304unboximpl(), continuation);
        }

        /* renamed from: invoke-d-4ec7I, reason: not valid java name */
        public final Object m2199invoked4ec7I(PressGestureScope pressGestureScope, long j, Continuation<? super Unit> continuation) {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            long j = this.J$0;
            this.this$0.offsetX = Offset.m4294getXimpl(j);
            this.this$0.offsetY = Offset.m4295getYimpl(j);
            return Unit.INSTANCE;
        }
    }
}
