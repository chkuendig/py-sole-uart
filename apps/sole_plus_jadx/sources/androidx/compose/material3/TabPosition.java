...
public final class TabPosition {
    ...
    public final float m2870getRightD9Ej5fM() {
        return Dp.m7255constructorimpl(this.left + this.width);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m7260equalsimpl0(this.left, tabPosition.left) && Dp.m7260equalsimpl0(this.width, tabPosition.width) && Dp.m7260equalsimpl0(this.contentWidth, tabPosition.contentWidth);
    }

    public int hashCode() {
        return (((Dp.m7261hashCodeimpl(this.left) * 31) + Dp.m7261hashCodeimpl(this.width)) * 31) + Dp.m7261hashCodeimpl(this.contentWidth);
    }

    public String toString() {
        return "TabPosition(left=" + ((Object) Dp.m7266toStringimpl(this.left)) + ", right=" + ((Object) Dp.m7266toStringimpl(m2870getRightD9Ej5fM())) + ", width=" + ((Object) Dp.m7266toStringimpl(this.width)) + ", contentWidth=" + ((Object) Dp.m7266toStringimpl(this.contentWidth)) + ')';
    }
}
