...
public final class NavigationRailKt {
    ...
    private static final float NavigationRailHeaderPadding = Dp.m7255constructorimpl(8);
    private static final float NavigationRailItemWidth = NavigationRailTokens.INSTANCE.m3484getContainerWidthD9Ej5fM();
    private static final float NavigationRailItemHeight = NavigationRailTokens.INSTANCE.m3487getNoLabelActiveIndicatorHeightD9Ej5fM();
    ...
    */
    public static final void m2570NavigationRailqi6gXK8(androidx.compose.ui.Modifier r25, long r26, long r28, kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.ColumnScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r30, androidx.compose.foundation.layout.WindowInsets r31, final kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.ColumnScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r32, androidx.compose.runtime.Composer r33, final int r34, final int r35) {
        /*
            Method dump skipped, instructions count: 406
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.NavigationRailKt.m2570NavigationRailqi6gXK8(androidx.compose.ui.Modifier, long, long, kotlin.jvm.functions.Function3, androidx.compose.foundation.layout.WindowInsets, kotlin.jvm.functions.Function3, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    */
                    ...
                    public final MeasureResult mo342measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
                        ...
                        for (int i5 = 0; i5 < size; i5++) {
                            ...
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable2), "icon")) {
                                ...
                                float f = 2;
                                int width = placeableMo5957measureBRTryo02.getWidth() + measureScope.mo671roundToPx0680j_4(Dp.m7255constructorimpl(NavigationRailKt.IndicatorHorizontalPadding * f));
                                int iRoundToInt = MathKt.roundToInt(width * fFloatValue);
                                int height = placeableMo5957measureBRTryo02.getHeight() + measureScope.mo671roundToPx0680j_4(Dp.m7255constructorimpl((function24 == null ? NavigationRailKt.IndicatorVerticalPaddingNoLabel : NavigationRailKt.IndicatorVerticalPaddingWithLabel) * f));
                                int size2 = list.size();
                                for (int i6 = 0; i6 < size2; i6++) {
                                    ...
                                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable3), "indicatorRipple")) {
                                        ...
                                        if (function24 == null) {
                                            return NavigationRailKt.m2573placeIconX9ElhV4(measureScope, placeableMo5957measureBRTryo02, placeableMo5957measureBRTryo03, placeableMo5957measureBRTryo04, j);
                                        }
                                        Intrinsics.checkNotNull(placeableMo5957measureBRTryo0);
                                        return NavigationRailKt.m2574placeLabelAndIconzUg2_y0(measureScope, placeableMo5957measureBRTryo0, placeableMo5957measureBRTryo02, placeableMo5957measureBRTryo03, placeableMo5957measureBRTryo04, j, z, fFloatValue);
                                    }
                                }
                                throw new NoSuchElementException("Collection contains no element matching the predicate.");
                            }
    ...
    public static final MeasureResult m2573placeIconX9ElhV4(MeasureScope measureScope, final Placeable placeable, final Placeable placeable2, final Placeable placeable3, long j) {
        final int iM7225constrainWidthK40F9xA = ConstraintsKt.m7225constrainWidthK40F9xA(j, Math.max(placeable.getWidth(), Math.max(placeable2.getWidth(), placeable3 != null ? placeable3.getWidth() : 0)));
        final int iM7224constrainHeightK40F9xA = ConstraintsKt.m7224constrainHeightK40F9xA(j, measureScope.mo671roundToPx0680j_4(NavigationRailItemHeight));
        final int width = (iM7225constrainWidthK40F9xA - placeable.getWidth()) / 2;
        final int height = (iM7224constrainHeightK40F9xA - placeable.getHeight()) / 2;
        final int width2 = (iM7225constrainWidthK40F9xA - placeable2.getWidth()) / 2;
        final int height2 = (iM7224constrainHeightK40F9xA - placeable2.getHeight()) / 2;
        return MeasureScope.layout$default(measureScope, iM7225constrainWidthK40F9xA, iM7224constrainHeightK40F9xA, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.NavigationRailKt$placeIcon$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                if (placeable4 != null) {
                    Placeable.PlacementScope.placeRelative$default(placementScope, placeable4, (iM7225constrainWidthK40F9xA - placeable4.getWidth()) / 2, (iM7224constrainHeightK40F9xA - placeable4.getHeight()) / 2, 0.0f, 4, null);
                }
    ...
    public static final MeasureResult m2574placeLabelAndIconzUg2_y0(final MeasureScope measureScope, final Placeable placeable, final Placeable placeable2, final Placeable placeable3, final Placeable placeable4, long j, final boolean z, final float f) {
        ...
        final int iM7225constrainWidthK40F9xA = ConstraintsKt.m7225constrainWidthK40F9xA(j, Math.max(placeable2.getWidth(), Math.max(placeable.getWidth(), placeable4 != null ? placeable4.getWidth() : 0)));
        final int width = (iM7225constrainWidthK40F9xA - placeable.getWidth()) / 2;
        final int width2 = (iM7225constrainWidthK40F9xA - placeable2.getWidth()) / 2;
        final int width3 = (iM7225constrainWidthK40F9xA - placeable3.getWidth()) / 2;
        final float f8 = fCoerceAtLeast - measureScope.mo677toPx0680j_4(f2);
        return MeasureScope.layout$default(measureScope, iM7225constrainWidthK40F9xA, MathKt.roundToInt(f7), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.NavigationRailKt$placeLabelAndIcon$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                if (placeable5 != null) {
                    int i = iM7225constrainWidthK40F9xA;
                    float f9 = fCoerceAtLeast;
                    MeasureScope measureScope2 = measureScope;
                    Placeable.PlacementScope.placeRelative$default(placementScope, placeable5, (i - placeable5.getWidth()) / 2, MathKt.roundToInt((f9 - measureScope2.mo677toPx0680j_4(NavigationRailKt.IndicatorVerticalPaddingWithLabel)) + height2), 0.0f, 4, null);
                }
                if (z || f != 0.0f) {
    ...
    static {
        float f = 4;
        NavigationRailVerticalPadding = Dp.m7255constructorimpl(f);
        NavigationRailItemVerticalPadding = Dp.m7255constructorimpl(f);
        float f2 = 2;
        IndicatorHorizontalPadding = Dp.m7255constructorimpl(Dp.m7255constructorimpl(NavigationRailTokens.INSTANCE.m3482getActiveIndicatorWidthD9Ej5fM() - NavigationRailTokens.INSTANCE.m3485getIconSizeD9Ej5fM()) / f2);
        IndicatorVerticalPaddingWithLabel = Dp.m7255constructorimpl(Dp.m7255constructorimpl(NavigationRailTokens.INSTANCE.m3481getActiveIndicatorHeightD9Ej5fM() - NavigationRailTokens.INSTANCE.m3485getIconSizeD9Ej5fM()) / f2);
        IndicatorVerticalPaddingNoLabel = Dp.m7255constructorimpl(Dp.m7255constructorimpl(NavigationRailTokens.INSTANCE.m3487getNoLabelActiveIndicatorHeightD9Ej5fM() - NavigationRailTokens.INSTANCE.m3485getIconSizeD9Ej5fM()) / f2);
    }
}
