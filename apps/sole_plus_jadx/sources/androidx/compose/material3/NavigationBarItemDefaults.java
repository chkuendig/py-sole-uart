...
public final class NavigationBarItemDefaults {
    ...
    public final NavigationBarItemColors m2539colors69fazGs(long j, long j2, long j3, long j4, long j5, long j6, long j7, Composer composer, int i, int i2) {
        ...
        NavigationBarItemColors navigationBarItemColorsM2530copy4JmcsL4 = getDefaultNavigationBarItemColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2530copy4JmcsL4(jM4574getUnspecified0d7_KjU, jM4574getUnspecified0d7_KjU2, jM4574getUnspecified0d7_KjU3, jM4574getUnspecified0d7_KjU4, jM4574getUnspecified0d7_KjU5, jM4574getUnspecified0d7_KjU6, jM4574getUnspecified0d7_KjU7);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return navigationBarItemColorsM2530copy4JmcsL4;
    }
    ...
    public final /* synthetic */ NavigationBarItemColors m2540colorszjMxDiM(long j, long j2, long j3, long j4, long j5, Composer composer, int i, int i2) {
        ...
        NavigationBarItemColors navigationBarItemColors = new NavigationBarItemColors(value, value2, value3, value4, value5, Color.m4537copywmQWz5c$default(value4, 0.38f, 0.0f, 0.0f, 0.0f, 14, null), Color.m4537copywmQWz5c$default(value5, 0.38f, 0.0f, 0.0f, 0.0f, 14, null), null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
