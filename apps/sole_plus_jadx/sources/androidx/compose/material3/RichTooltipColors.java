...
public final class RichTooltipColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4539equalsimpl0(this.containerColor, richTooltipColors.containerColor) && Color.m4539equalsimpl0(this.contentColor, richTooltipColors.contentColor) && Color.m4539equalsimpl0(this.titleContentColor, richTooltipColors.titleContentColor) && Color.m4539equalsimpl0(this.actionContentColor, richTooltipColors.actionContentColor);
    }

    public int hashCode() {
        return (((((Color.m4545hashCodeimpl(this.containerColor) * 31) + Color.m4545hashCodeimpl(this.contentColor)) * 31) + Color.m4545hashCodeimpl(this.titleContentColor)) * 31) + Color.m4545hashCodeimpl(this.actionContentColor);
    }

    /* renamed from: copy-jRlVdoo, reason: not valid java name */
    public final RichTooltipColors m2624copyjRlVdoo(long containerColor, long contentColor, long titleContentColor, long actionContentColor) {
        return new RichTooltipColors(containerColor != Color.INSTANCE.m4574getUnspecified0d7_KjU() ? containerColor : this.containerColor, contentColor != Color.INSTANCE.m4574getUnspecified0d7_KjU() ? contentColor : this.contentColor, titleContentColor != Color.INSTANCE.m4574getUnspecified0d7_KjU() ? titleContentColor : this.titleContentColor, actionContentColor != Color.INSTANCE.m4574getUnspecified0d7_KjU() ? actionContentColor : this.actionContentColor, null);
    }
}
