...
public final class TabIndicatorOffsetNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo395measure3p2s80s(final MeasureScope measureScope, Measurable measurable, final long j) {
        Measurable measurable2;
        long jM7198copyZbe2FdA$default;
        ...
        if (this.followContentSize) {
            if (this.initialWidth != null) {
                ...
                if (!Dp.m7260equalsimpl0(contentWidth, animatable.getTargetValue().m7269unboximpl())) {
                ...
                this.initialWidth = Dp.m7253boximpl(contentWidth);
            }
        }
        ...
        if (this.initialOffset != null) {
            ...
            if (!Dp.m7260equalsimpl0(left, animatable2.getTargetValue().m7269unboximpl())) {
            ...
            this.initialOffset = Dp.m7253boximpl(left);
        }
        Animatable<Dp, AnimationVector1D> animatable3 = this.offsetAnimatable;
        if (animatable3 != null) {
            left = animatable3.getValue().m7269unboximpl();
        }
        final float f = left;
        if (this.followContentSize) {
            Animatable<Dp, AnimationVector1D> animatable4 = this.widthAnimatable;
            if (animatable4 != null) {
                contentWidth = animatable4.getValue().m7269unboximpl();
            }
            jM7198copyZbe2FdA$default = Constraints.m7198copyZbe2FdA$default(j, measureScope.mo671roundToPx0680j_4(contentWidth), measureScope.mo671roundToPx0680j_4(contentWidth), 0, 0, 12, null);
            measurable2 = measurable;
        } else {
            measurable2 = measurable;
            jM7198copyZbe2FdA$default = j;
        }
        final Placeable placeableMo5957measureBRTryo0 = measurable2.mo5957measureBRTryo0(jM7198copyZbe2FdA$default);
        return MeasureScope.layout$default(measureScope, placeableMo5957measureBRTryo0.getWidth(), Constraints.m7207getMaxHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.TabIndicatorOffsetNode$measure$4
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.place$default(placementScope, placeableMo5957measureBRTryo0, measureScope.mo671roundToPx0680j_4(f), Constraints.m7207getMaxHeightimpl(j) - placeableMo5957measureBRTryo0.getHeight(), 0.0f, 4, null);
            }
        }, 4, null);
    }
}
