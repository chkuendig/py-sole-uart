...
public final class InputIdentifier {
    ...
    private static final int SingleDateInput = m2464constructorimpl(0);
    private static final int StartDateInput = m2464constructorimpl(1);
    private static final int EndDateInput = m2464constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ InputIdentifier m2463boximpl(int i) {
        return new InputIdentifier(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m2464constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2465equalsimpl(int i, Object obj) {
        return (obj instanceof InputIdentifier) && i == ((InputIdentifier) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2466equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m2467hashCodeimpl(int i) {
    ...
    public static String m2468toStringimpl(int i) {
        return m2466equalsimpl0(i, SingleDateInput) ? "SingleDateInput" : m2466equalsimpl0(i, StartDateInput) ? "StartDateInput" : m2466equalsimpl0(i, EndDateInput) ? "EndDateInput" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
