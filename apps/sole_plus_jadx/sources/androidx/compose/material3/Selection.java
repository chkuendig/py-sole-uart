...
public final class Selection {
    ...
    private static final int Hour = m2693constructorimpl(0);
    private static final int Minute = m2693constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ Selection m2692boximpl(int i) {
        return new Selection(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m2693constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2694equalsimpl(int i, Object obj) {
        return (obj instanceof Selection) && i == ((Selection) obj).m2698unboximpl();
    }
    ...
    public final /* synthetic */ int m2698unboximpl() {
        return this.value;
    }
