...
public final class InputChipDefaults {
    ...
    public final SelectableChipColors m2461inputChipColorskwJvTHA(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, Composer composer, int i, int i2, int i3) {
        ...
        long jM4574getUnspecified0d7_KjU13 = (i3 & 4096) != 0 ? Color.INSTANCE.m4574getUnspecified0d7_KjU() : j13;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1312840646, i, i2, "androidx.compose.material3.InputChipDefaults.inputChipColors (Chip.kt:1516)");
        }
        SelectableChipColors selectableChipColorsM2679copydaRQuJA = getDefaultInputChipColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2679copydaRQuJA(jM4574getUnspecified0d7_KjU, jM4574getUnspecified0d7_KjU2, jM4574getUnspecified0d7_KjU3, jM4574getUnspecified0d7_KjU4, jM4574getUnspecified0d7_KjU5, jM4574getUnspecified0d7_KjU6, jM4574getUnspecified0d7_KjU7, jM4574getUnspecified0d7_KjU8, jM4574getUnspecified0d7_KjU9, jM4574getUnspecified0d7_KjU10, jM4574getUnspecified0d7_KjU11, jM4574getUnspecified0d7_KjU12, jM4574getUnspecified0d7_KjU13);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final SelectableChipElevation m2462inputChipElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float fM3444getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? InputChipTokens.INSTANCE.m3444getContainerElevationD9Ej5fM() : f;
        float f7 = (i2 & 2) != 0 ? fM3444getContainerElevationD9Ej5fM : f2;
        float f8 = (i2 & 4) != 0 ? fM3444getContainerElevationD9Ej5fM : f3;
        float f9 = (i2 & 8) != 0 ? fM3444getContainerElevationD9Ej5fM : f4;
        float fM3446getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? InputChipTokens.INSTANCE.m3446getDraggedContainerElevationD9Ej5fM() : f5;
        float f10 = (i2 & 32) != 0 ? fM3444getContainerElevationD9Ej5fM : f6;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1745270109, i, -1, "androidx.compose.material3.InputChipDefaults.inputChipElevation (Chip.kt:1580)");
        }
        SelectableChipElevation selectableChipElevation = new SelectableChipElevation(fM3444getContainerElevationD9Ej5fM, f7, f8, f9, fM3446getDraggedContainerElevationD9Ej5fM, f10, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final BorderStroke m2460inputChipBorder_7El2pE(boolean z, boolean z2, long j, long j2, long j3, long j4, float f, float f2, Composer composer, int i, int i2) {
        ...
        long jM4537copywmQWz5c$default = (i2 & 16) != 0 ? Color.m4537copywmQWz5c$default(ColorSchemeKt.getValue(InputChipTokens.INSTANCE.getDisabledUnselectedOutlineColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j3;
        long jM4573getTransparent0d7_KjU2 = (i2 & 32) != 0 ? Color.INSTANCE.m4573getTransparent0d7_KjU() : j4;
        float fM3450getUnselectedOutlineWidthD9Ej5fM = (i2 & 64) != 0 ? InputChipTokens.INSTANCE.m3450getUnselectedOutlineWidthD9Ej5fM() : f;
        float fM3448getSelectedOutlineWidthD9Ej5fM = (i2 & 128) != 0 ? InputChipTokens.INSTANCE.m3448getSelectedOutlineWidthD9Ej5fM() : f2;
        if (ComposerKt.isTraceInProgress()) {
        ...
        if (z2) {
            fM3450getUnselectedOutlineWidthD9Ej5fM = fM3448getSelectedOutlineWidthD9Ej5fM;
        }
        BorderStroke borderStrokeM567BorderStrokecXLIe8U = BorderStrokeKt.m567BorderStrokecXLIe8U(fM3450getUnselectedOutlineWidthD9Ej5fM, value);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
