...
public final class WindowAlignmentMarginPosition {
    ...
    public static final /* data */ class Horizontal implements MenuPosition.Horizontal {
        ...
        public int mo2074position95KtPRI(IntRect anchorBounds, long windowSize, int menuWidth, LayoutDirection layoutDirection) {
            if (menuWidth >= IntSize.m7426getWidthimpl(windowSize) - (this.margin * 2)) {
                return Alignment.INSTANCE.getCenterHorizontally().align(menuWidth, IntSize.m7426getWidthimpl(windowSize), layoutDirection);
            }
            return RangesKt.coerceIn(this.alignment.align(menuWidth, IntSize.m7426getWidthimpl(windowSize), layoutDirection), this.margin, (IntSize.m7426getWidthimpl(windowSize) - this.margin) - menuWidth);
        }
    }
    ...
    public static final /* data */ class Vertical implements MenuPosition.Vertical {
        ...
        public int mo2075positionJVtK1S4(IntRect anchorBounds, long windowSize, int menuHeight) {
            if (menuHeight >= IntSize.m7425getHeightimpl(windowSize) - (this.margin * 2)) {
                return Alignment.INSTANCE.getCenterVertically().align(menuHeight, IntSize.m7425getHeightimpl(windowSize));
            }
            return RangesKt.coerceIn(this.alignment.align(menuHeight, IntSize.m7425getHeightimpl(windowSize)), this.margin, (IntSize.m7425getHeightimpl(windowSize) - this.margin) - menuHeight);
        }
    }
}
