...
public final class TabKt {
    ...
    private static final float SmallTabHeight = PrimaryNavigationTabTokens.INSTANCE.m3615getContainerHeightD9Ej5fM();
    ...
    */
    public static final void m2865TabwqdebIU(final boolean r29, final kotlin.jvm.functions.Function0<kotlin.Unit> r30, androidx.compose.ui.Modifier r31, boolean r32, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r33, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r34, long r35, long r37, androidx.compose.foundation.interaction.MutableInteractionSource r39, androidx.compose.runtime.Composer r40, final int r41, final int r42) {
        /*
            Method dump skipped, instructions count: 610
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.TabKt.m2865TabwqdebIU(boolean, kotlin.jvm.functions.Function0, androidx.compose.ui.Modifier, boolean, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function2, long, long, androidx.compose.foundation.interaction.MutableInteractionSource, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m2863LeadingIconTabwqdebIU(final boolean r23, final kotlin.jvm.functions.Function0<kotlin.Unit> r24, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r25, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r26, androidx.compose.ui.Modifier r27, boolean r28, long r29, long r31, androidx.compose.foundation.interaction.MutableInteractionSource r33, androidx.compose.runtime.Composer r34, final int r35, final int r36) {
        /*
            Method dump skipped, instructions count: 606
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.TabKt.m2863LeadingIconTabwqdebIU(boolean, kotlin.jvm.functions.Function0, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function2, androidx.compose.ui.Modifier, boolean, long, long, androidx.compose.foundation.interaction.MutableInteractionSource, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m2864TabbogVsAg(final boolean r27, final kotlin.jvm.functions.Function0<kotlin.Unit> r28, androidx.compose.ui.Modifier r29, boolean r30, long r31, long r33, androidx.compose.foundation.interaction.MutableInteractionSource r35, final kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.ColumnScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r36, androidx.compose.runtime.Composer r37, final int r38, final int r39) {
        /*
            Method dump skipped, instructions count: 555
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.TabKt.m2864TabbogVsAg(boolean, kotlin.jvm.functions.Function0, androidx.compose.ui.Modifier, boolean, long, long, androidx.compose.foundation.interaction.MutableInteractionSource, kotlin.jvm.functions.Function3, androidx.compose.runtime.Composer, int, int):void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: TabTransition-Klgx-Pg, reason: not valid java name */
    public static final void m2866TabTransitionKlgxPg(final long j, final long j2, final boolean z, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        int i2;
        Composer composerStartRestartGroup = composer.startRestartGroup(735731848);
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(TabTransition)P(0:c#ui.graphics.Color,2:c#ui.graphics.Color,3)279@11954L26,280@12009L550,298@12564L99:Tab.kt#uh7d8r");
        if ((i & 6) == 0) {
        ...
        if ((i2 & WinError.ERROR_POINT_NOT_FOUND) != 1170 || !composerStartRestartGroup.getSkipping()) {
            ...
            composerStartRestartGroup.endReplaceableGroup();
            composerStartRestartGroup.endReplaceableGroup();
            CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.m4528boximpl(TabTransition_Klgx_Pg$lambda$5(stateCreateTransitionAnimation))), function2, composerStartRestartGroup, (i3 & 112) | ProvidedValue.$stable);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabKt$TabTransition$1
                ...
                public final void invoke(Composer composer2, int i4) {
                    TabKt.m2866TabTransitionKlgxPg(j, j2, z, function2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
                }
            });
        }
    }
    ...
    public static final void TabBaselineLayout(final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, Composer composer, final int i) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(TabBaselineLayout)P(1)327@13445L1785,314@13071L2159:Tab.kt#uh7d8r");
        if ((i & 6) == 0) {
        ...
        if ((i2 & 19) != 18 || !composerStartRestartGroup.getSkipping()) {
            ...
            ComposerKt.sourceInformation(composerStartRestartGroup, "CC(remember):Tab.kt#9igjgp");
            int i3 = i2 & 14;
            ...
            if (z || measurePolicyRememberedValue == Composer.INSTANCE.getEmpty()) {
                measurePolicyRememberedValue = new MeasurePolicy() { // from class: androidx.compose.material3.TabKt$TabBaselineLayout$2$1
                    ...
                    public final MeasureResult mo342measure3p2s80s(final MeasureScope measureScope, List<? extends Measurable> list, long j) {
                        final Placeable placeableMo5957measureBRTryo0;
                        ...
                        final int iMax2 = Math.max(measureScope.mo671roundToPx0680j_4((placeableMo5957measureBRTryo0 == null || placeableMo5957measureBRTryo02 == null) ? TabKt.SmallTabHeight : TabKt.LargeTabHeight), (placeableMo5957measureBRTryo02 != null ? placeableMo5957measureBRTryo02.getHeight() : 0) + (placeableMo5957measureBRTryo0 != null ? placeableMo5957measureBRTryo0.getHeight() : 0) + measureScope.mo670roundToPxR2X_6o(TabKt.IconDistanceFromBaseline));
                        ...
                        return MeasureScope.layout$default(measureScope, iMax, iMax2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.TabKt$TabBaselineLayout$2$1.1
                            ...
                            public final void invoke2(Placeable.PlacementScope placementScope) {
                                ...
                                if (placeable2 == null || (placeable = placeableMo5957measureBRTryo02) == null) {
                                    if (placeable2 != null) {
                                        TabKt.placeTextOrIcon(placementScope, placeable2, iMax2);
                                        return;
                                    }
                                    Placeable placeable3 = placeableMo5957measureBRTryo02;
                                    if (placeable3 != null) {
            ...
            ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, 720851373, "C:Tab.kt#uh7d8r");
            composerStartRestartGroup.startReplaceableGroup(720851373);
            ComposerKt.sourceInformation(composerStartRestartGroup, "317@13137L173");
            if (function2 != null) {
                ...
                ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, -978021225, "C321@13302L6:Tab.kt#uh7d8r");
            ...
            ComposerKt.sourceInformation(composerStartRestartGroup, "324@13373L41");
            if (function22 != null) {
                ...
                ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, -978021121, "C324@13406L6:Tab.kt#uh7d8r");
    ...
    public static final void placeTextAndIcon(Placeable.PlacementScope placementScope, Density density, Placeable placeable, Placeable placeable2, int i, int i2, int i3, int i4) {
        ...
        int iMo671roundToPx0680j_4 = density.mo671roundToPx0680j_4(f) + density.mo671roundToPx0680j_4(PrimaryNavigationTabTokens.INSTANCE.m3613getActiveIndicatorHeightD9Ej5fM());
