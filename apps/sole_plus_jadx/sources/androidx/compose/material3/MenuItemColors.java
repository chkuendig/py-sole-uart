...
public final class MenuItemColors {
    ...
    public final long m2519leadingIconColorXeAY9LY$material3_release(boolean z, Composer composer, int i) {
    ...
    public final long m2520trailingIconColorXeAY9LY$material3_release(boolean z, Composer composer, int i) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4539equalsimpl0(this.textColor, menuItemColors.textColor) && Color.m4539equalsimpl0(this.leadingIconColor, menuItemColors.leadingIconColor) && Color.m4539equalsimpl0(this.trailingIconColor, menuItemColors.trailingIconColor) && Color.m4539equalsimpl0(this.disabledTextColor, menuItemColors.disabledTextColor) && Color.m4539equalsimpl0(this.disabledLeadingIconColor, menuItemColors.disabledLeadingIconColor) && Color.m4539equalsimpl0(this.disabledTrailingIconColor, menuItemColors.disabledTrailingIconColor);
    }

    public int hashCode() {
        return (((((((((Color.m4545hashCodeimpl(this.textColor) * 31) + Color.m4545hashCodeimpl(this.leadingIconColor)) * 31) + Color.m4545hashCodeimpl(this.trailingIconColor)) * 31) + Color.m4545hashCodeimpl(this.disabledTextColor)) * 31) + Color.m4545hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m4545hashCodeimpl(this.disabledTrailingIconColor);
    }

    /* renamed from: copy-tNS2XkQ, reason: not valid java name */
    public final MenuItemColors m2512copytNS2XkQ(long textColor, long leadingIconColor, long trailingIconColor, long disabledTextColor, long disabledLeadingIconColor, long disabledTrailingIconColor) {
        return new MenuItemColors(textColor != Color.INSTANCE.m4574getUnspecified0d7_KjU() ? textColor : this.textColor, leadingIconColor != Color.INSTANCE.m4574getUnspecified0d7_KjU() ? leadingIconColor : this.leadingIconColor, trailingIconColor != Color.INSTANCE.m4574getUnspecified0d7_KjU() ? trailingIconColor : this.trailingIconColor, disabledTextColor != Color.INSTANCE.m4574getUnspecified0d7_KjU() ? disabledTextColor : this.disabledTextColor, disabledLeadingIconColor != Color.INSTANCE.m4574getUnspecified0d7_KjU() ? disabledLeadingIconColor : this.disabledLeadingIconColor, disabledTrailingIconColor != Color.INSTANCE.m4574getUnspecified0d7_KjU() ? disabledTrailingIconColor : this.disabledTrailingIconColor, null);
    }
}
