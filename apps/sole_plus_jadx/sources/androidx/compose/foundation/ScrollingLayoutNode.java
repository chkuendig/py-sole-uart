...
public final class ScrollingLayoutNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo395measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        CheckScrollableContainerConstraintsKt.m568checkScrollableContainerConstraintsK40F9xA(j, this.isVertical ? Orientation.Vertical : Orientation.Horizontal);
        final Placeable placeableMo5957measureBRTryo0 = measurable.mo5957measureBRTryo0(Constraints.m7198copyZbe2FdA$default(j, 0, this.isVertical ? Constraints.m7208getMaxWidthimpl(j) : Integer.MAX_VALUE, 0, this.isVertical ? Integer.MAX_VALUE : Constraints.m7207getMaxHeightimpl(j), 5, null));
        int iCoerceAtMost = RangesKt.coerceAtMost(placeableMo5957measureBRTryo0.getWidth(), Constraints.m7208getMaxWidthimpl(j));
        int iCoerceAtMost2 = RangesKt.coerceAtMost(placeableMo5957measureBRTryo0.getHeight(), Constraints.m7207getMaxHeightimpl(j));
        final int height = placeableMo5957measureBRTryo0.getHeight() - iCoerceAtMost2;
        int width = placeableMo5957measureBRTryo0.getWidth() - iCoerceAtMost;
        if (!this.isVertical) {
            height = width;
        }
