...
public final class KeyboardOptions {
    ...
    private static final KeyboardOptions SecureTextField = new KeyboardOptions(0, (Boolean) false, KeyboardType.INSTANCE.m6958getPasswordPjHm6EE(), 0, (PlatformImeOptions) null, (Boolean) null, (LocaleList) null, 121, (DefaultConstructorMarker) null);
    ...
    public /* synthetic */ KeyboardOptions(int i, Boolean bool, int i2, int i3, PlatformImeOptions platformImeOptions, Boolean bool2, LocaleList localeList, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m6934getUnspecifiedIUNYP9k() : i, (i4 & 2) != 0 ? null : bool, (i4 & 4) != 0 ? KeyboardType.INSTANCE.m6961getUnspecifiedPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.INSTANCE.m6907getUnspecifiedeUduSuo() : i3, (i4 & 16) != 0 ? null : platformImeOptions, (i4 & 32) != 0 ? null : bool2, (i4 & 64) == 0 ? localeList : null, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ KeyboardOptions(int i, boolean z, int i2, int i3, PlatformImeOptions platformImeOptions, Boolean bool, LocaleList localeList, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m6934getUnspecifiedIUNYP9k() : i, z, (i4 & 4) != 0 ? KeyboardType.INSTANCE.m6961getUnspecifiedPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.INSTANCE.m6907getUnspecifiedeUduSuo() : i3, (i4 & 16) != 0 ? null : platformImeOptions, (i4 & 32) != 0 ? null : bool, (i4 & 64) != 0 ? null : localeList, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ KeyboardOptions(int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m6934getUnspecifiedIUNYP9k() : i, (i4 & 2) != 0 ? Default.getAutoCorrectOrDefault() : z, (i4 & 4) != 0 ? KeyboardType.INSTANCE.m6961getUnspecifiedPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.INSTANCE.m6899getDefaulteUduSuo() : i3, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ KeyboardOptions(int i, boolean z, int i2, int i3, PlatformImeOptions platformImeOptions, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m6932getNoneIUNYP9k() : i, (i4 & 2) != 0 ? Default.getAutoCorrectOrDefault() : z, (i4 & 4) != 0 ? KeyboardType.INSTANCE.m6960getTextPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.INSTANCE.m6899getDefaulteUduSuo() : i3, (i4 & 16) != 0 ? null : platformImeOptions, (DefaultConstructorMarker) null);
    }
    ...
    private final int m1308getCapitalizationOrDefaultIUNYP9k() {
        KeyboardCapitalization keyboardCapitalizationM6919boximpl = KeyboardCapitalization.m6919boximpl(this.capitalization);
        if (KeyboardCapitalization.m6922equalsimpl0(keyboardCapitalizationM6919boximpl.getValue(), KeyboardCapitalization.INSTANCE.m6934getUnspecifiedIUNYP9k())) {
            keyboardCapitalizationM6919boximpl = null;
        }
        return keyboardCapitalizationM6919boximpl != null ? keyboardCapitalizationM6919boximpl.getValue() : KeyboardCapitalization.INSTANCE.m6932getNoneIUNYP9k();
    }

    /* renamed from: getKeyboardTypeOrDefault-PjHm6EE, reason: not valid java name */
    private final int m1309getKeyboardTypeOrDefaultPjHm6EE() {
        KeyboardType keyboardTypeM6936boximpl = KeyboardType.m6936boximpl(this.keyboardType);
        if (KeyboardType.m6939equalsimpl0(keyboardTypeM6936boximpl.getValue(), KeyboardType.INSTANCE.m6961getUnspecifiedPjHm6EE())) {
            keyboardTypeM6936boximpl = null;
        }
        return keyboardTypeM6936boximpl != null ? keyboardTypeM6936boximpl.getValue() : KeyboardType.INSTANCE.m6960getTextPjHm6EE();
    }

    /* renamed from: getImeActionOrDefault-eUduSuo$foundation_release, reason: not valid java name */
    public final int m1316getImeActionOrDefaulteUduSuo$foundation_release() {
        ImeAction imeActionM6883boximpl = ImeAction.m6883boximpl(this.imeAction);
        if (ImeAction.m6886equalsimpl0(imeActionM6883boximpl.getValue(), ImeAction.INSTANCE.m6907getUnspecifiedeUduSuo())) {
            imeActionM6883boximpl = null;
        }
        return imeActionM6883boximpl != null ? imeActionM6883boximpl.getValue() : ImeAction.INSTANCE.m6899getDefaulteUduSuo();
    }
    ...
    private final boolean isCompletelyUnspecified() {
        return KeyboardCapitalization.m6922equalsimpl0(this.capitalization, KeyboardCapitalization.INSTANCE.m6934getUnspecifiedIUNYP9k()) && this.autoCorrectEnabled == null && KeyboardType.m6939equalsimpl0(this.keyboardType, KeyboardType.INSTANCE.m6961getUnspecifiedPjHm6EE()) && ImeAction.m6886equalsimpl0(this.imeAction, ImeAction.INSTANCE.m6907getUnspecifiedeUduSuo()) && this.platformImeOptions == null && this.showKeyboardOnFocus == null && this.hintLocales == null;
    }
    ...
    public final ImeOptions toImeOptions$foundation_release(boolean singleLine) {
        return new ImeOptions(singleLine, m1308getCapitalizationOrDefaultIUNYP9k(), getAutoCorrectOrDefault(), m1309getKeyboardTypeOrDefaultPjHm6EE(), m1316getImeActionOrDefaulteUduSuo$foundation_release(), this.platformImeOptions, getHintLocalesOrDefault(), (DefaultConstructorMarker) null);
    }

    /* renamed from: copy-INvB4aQ$default, reason: not valid java name */
    public static /* synthetic */ KeyboardOptions m1305copyINvB4aQ$default(KeyboardOptions keyboardOptions, int i, Boolean bool, int i2, int i3, PlatformImeOptions platformImeOptions, Boolean bool2, LocaleList localeList, int i4, Object obj) {
        if ((i4 & 1) != 0) {
        ...
        return keyboardOptions.m1311copyINvB4aQ(i, bool3, i5, i6, platformImeOptions, (i4 & 32) != 0 ? null : bool2, (i4 & 64) != 0 ? null : localeList);
    }

    /* renamed from: copy-INvB4aQ, reason: not valid java name */
    public final KeyboardOptions m1311copyINvB4aQ(int capitalization, Boolean autoCorrectEnabled, int keyboardType, int imeAction, PlatformImeOptions platformImeOptions, Boolean showKeyboardOnFocus, LocaleList hintLocales) {
    ...
    /* renamed from: copy-INvB4aQ$default, reason: not valid java name */
    public static /* synthetic */ KeyboardOptions m1306copyINvB4aQ$default(KeyboardOptions keyboardOptions, int i, boolean z, int i2, int i3, PlatformImeOptions platformImeOptions, Boolean bool, LocaleList localeList, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            i = keyboardOptions.capitalization;
        }
        if ((i4 & 2) != 0) {
        ...
        return keyboardOptions.m1312copyINvB4aQ(i, z2, i5, i6, platformImeOptions2, bool2, localeList);
    }
    ...
    /* renamed from: copy-INvB4aQ, reason: not valid java name */
    public final /* synthetic */ KeyboardOptions m1312copyINvB4aQ(int capitalization, boolean autoCorrect, int keyboardType, int imeAction, PlatformImeOptions platformImeOptions, Boolean showKeyboardOnFocus, LocaleList hintLocales) {
    ...
    public static /* synthetic */ KeyboardOptions m1307copyij11fho$default(KeyboardOptions keyboardOptions, int i, boolean z, int i2, int i3, PlatformImeOptions platformImeOptions, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            i = keyboardOptions.capitalization;
        }
        if ((i4 & 2) != 0) {
        ...
        return keyboardOptions.m1313copyij11fho(i, z2, i5, i6, platformImeOptions);
    }

    @Deprecated(level = DeprecationLevel.HIDDEN, message = "Maintained for binary compatibility")
    /* renamed from: copy-ij11fho, reason: not valid java name */
    public final /* synthetic */ KeyboardOptions m1313copyij11fho(int capitalization, boolean autoCorrect, int keyboardType, int imeAction, PlatformImeOptions platformImeOptions) {
    ...
    public static /* synthetic */ KeyboardOptions m1304copy3m2b7yw$default(KeyboardOptions keyboardOptions, int i, boolean z, int i2, int i3, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            i = keyboardOptions.capitalization;
        }
        if ((i4 & 2) != 0) {
        ...
        return keyboardOptions.m1310copy3m2b7yw(i, z, i2, i3);
    }
    ...
    public final /* synthetic */ KeyboardOptions m1310copy3m2b7yw(int capitalization, boolean autoCorrect, int keyboardType, int imeAction) {
    ...
    public boolean equals(Object other) {
        ...
        return KeyboardCapitalization.m6922equalsimpl0(this.capitalization, keyboardOptions.capitalization) && Intrinsics.areEqual(this.autoCorrectEnabled, keyboardOptions.autoCorrectEnabled) && KeyboardType.m6939equalsimpl0(this.keyboardType, keyboardOptions.keyboardType) && ImeAction.m6886equalsimpl0(this.imeAction, keyboardOptions.imeAction) && Intrinsics.areEqual(this.platformImeOptions, keyboardOptions.platformImeOptions) && Intrinsics.areEqual(this.showKeyboardOnFocus, keyboardOptions.showKeyboardOnFocus) && Intrinsics.areEqual(this.hintLocales, keyboardOptions.hintLocales);
    }

    public int hashCode() {
        int iM6923hashCodeimpl = KeyboardCapitalization.m6923hashCodeimpl(this.capitalization) * 31;
        Boolean bool = this.autoCorrectEnabled;
        int iHashCode = (((((iM6923hashCodeimpl + (bool != null ? bool.hashCode() : 0)) * 31) + KeyboardType.m6940hashCodeimpl(this.keyboardType)) * 31) + ImeAction.m6887hashCodeimpl(this.imeAction)) * 31;
    ...
    public String toString() {
        return "KeyboardOptions(capitalization=" + ((Object) KeyboardCapitalization.m6924toStringimpl(this.capitalization)) + ", autoCorrectEnabled=" + this.autoCorrectEnabled + ", keyboardType=" + ((Object) KeyboardType.m6941toStringimpl(this.keyboardType)) + ", imeAction=" + ((Object) ImeAction.m6888toStringimpl(this.imeAction)) + ", platformImeOptions=" + this.platformImeOptions + "showKeyboardOnFocus=" + this.showKeyboardOnFocus + ", hintLocales=" + this.hintLocales + ')';
    }
    ...
    public final KeyboardOptions fillUnspecifiedValuesWith$foundation_release(KeyboardOptions other) {
        ...
        if (keyboardCapitalizationM6919boximpl != null) {
            value = keyboardCapitalizationM6919boximpl.getValue();
        } else {
        ...
        if (keyboardTypeM6936boximpl != null) {
            value2 = keyboardTypeM6936boximpl.getValue();
        } else {
            value2 = other.keyboardType;
        }
        int i2 = value2;
        ImeAction imeActionM6883boximpl = ImeAction.m6883boximpl(this.imeAction);
        ImeAction imeAction = ImeAction.m6886equalsimpl0(imeActionM6883boximpl.getValue(), ImeAction.INSTANCE.m6907getUnspecifiedeUduSuo()) ? null : imeActionM6883boximpl;
        if (imeAction != null) {
