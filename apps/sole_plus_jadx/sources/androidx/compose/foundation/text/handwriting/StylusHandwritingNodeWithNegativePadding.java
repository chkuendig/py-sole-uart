...
public final class StylusHandwritingNodeWithNegativePadding extends StylusHandwritingNode implements LayoutModifierNode {
    ...
    public MeasureResult mo395measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        final int i = measureScope.mo671roundToPx0680j_4(StylusHandwritingKt.getHandwritingBoundsVerticalOffset());
        final int i2 = measureScope.mo671roundToPx0680j_4(StylusHandwritingKt.getHandwritingBoundsHorizontalOffset());
        int i3 = i2 * 2;
        int i4 = i * 2;
        final Placeable placeableMo5957measureBRTryo0 = measurable.mo5957measureBRTryo0(ConstraintsKt.m7227offsetNN6EwU(j, i3, i4));
        return MeasureScope.layout$default(measureScope, placeableMo5957measureBRTryo0.getWidth() - i3, placeableMo5957measureBRTryo0.getHeight() - i4, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.handwriting.StylusHandwritingNodeWithNegativePadding$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.place$default(placementScope, placeableMo5957measureBRTryo0, -i2, -i, 0.0f, 4, null);
            }
        }, 4, null);
    }
}
