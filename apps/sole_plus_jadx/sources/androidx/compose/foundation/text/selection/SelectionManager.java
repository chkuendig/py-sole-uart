...
public final class SelectionManager {
    ...
    private final MutableState dragBeginPosition = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m4283boximpl(Offset.INSTANCE.m4310getZeroF1C5BW0()), null, 2, null);

    /* renamed from: dragTotalDistance$delegate, reason: from kotlin metadata */
    private final MutableState dragTotalDistance = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m4283boximpl(Offset.INSTANCE.m4310getZeroF1C5BW0()), null, 2, null);
    ...
    public SelectionManager(SelectionRegistrarImpl selectionRegistrarImpl) {
        ...
        selectionRegistrarImpl.setOnSelectionUpdateStartCallback$foundation_release(new Function4<Boolean, LayoutCoordinates, Offset, SelectionAdjustment, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.2
            ...
            public /* bridge */ /* synthetic */ Unit invoke(Boolean bool, LayoutCoordinates layoutCoordinates, Offset offset, SelectionAdjustment selectionAdjustment) {
                m1679invokeRg1IO4c(bool.booleanValue(), layoutCoordinates, offset.m4304unboximpl(), selectionAdjustment);
                return Unit.INSTANCE;
            }
            ...
            public final void m1679invokeRg1IO4c(boolean z, LayoutCoordinates layoutCoordinates, long j, SelectionAdjustment selectionAdjustment) {
                ...
                Rect rect = new Rect(0.0f, 0.0f, IntSize.m7426getWidthimpl(jMo5965getSizeYbymL2g), IntSize.m7425getHeightimpl(jMo5965getSizeYbymL2g));
                if (!SelectionManagerKt.m1684containsInclusiveUv8p0NA(rect, j)) {
                    j = TextLayoutStateKt.m1524coerceIn3MmeM6k(j, rect);
                }
                long jM1663convertToContainerCoordinatesR5De75A = SelectionManager.this.m1663convertToContainerCoordinatesR5De75A(layoutCoordinates, j);
                if (OffsetKt.m4313isSpecifiedk4lQ0M(jM1663convertToContainerCoordinatesR5De75A)) {
                    SelectionManager.this.setInTouchMode(z);
                    SelectionManager.this.m1670startSelection9KIMszo(jM1663convertToContainerCoordinatesR5De75A, false, selectionAdjustment);
        ...
        selectionRegistrarImpl.setOnSelectionUpdateCallback$foundation_release(new Function6<Boolean, LayoutCoordinates, Offset, Offset, Boolean, SelectionAdjustment, Boolean>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.4
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(Boolean bool, LayoutCoordinates layoutCoordinates, Offset offset, Offset offset2, Boolean bool2, SelectionAdjustment selectionAdjustment) {
                return m1680invokepGV3PM0(bool.booleanValue(), layoutCoordinates, offset.m4304unboximpl(), offset2.m4304unboximpl(), bool2.booleanValue(), selectionAdjustment);
            }
            ...
            public final Boolean m1680invokepGV3PM0(boolean z, LayoutCoordinates layoutCoordinates, long j, long j2, boolean z2, SelectionAdjustment selectionAdjustment) {
                long jM1663convertToContainerCoordinatesR5De75A = SelectionManager.this.m1663convertToContainerCoordinatesR5De75A(layoutCoordinates, j);
                long jM1663convertToContainerCoordinatesR5De75A2 = SelectionManager.this.m1663convertToContainerCoordinatesR5De75A(layoutCoordinates, j2);
                SelectionManager.this.setInTouchMode(z);
                return Boolean.valueOf(SelectionManager.this.m1678updateSelectionqNKwrvQ$foundation_release(Offset.m4283boximpl(jM1663convertToContainerCoordinatesR5De75A), jM1663convertToContainerCoordinatesR5De75A2, z2, selectionAdjustment));
            }
        });
    ...
    public final Modifier getModifier() {
        return KeyInputModifierKt.onKeyEvent(SelectionGesturesKt.updateSelectionTouchMode(FocusableKt.focusable$default(FocusChangedModifierKt.onFocusChanged(FocusRequesterModifierKt.focusRequester(OnGloballyPositionedModifierKt.onGloballyPositioned(onClearSelectionRequested(Modifier.INSTANCE, new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager$modifier$1
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m1681invokeZmokQxo(keyEvent.m5673unboximpl());
            }
    ...
    public final void setContainerLayoutCoordinates(LayoutCoordinates layoutCoordinates) {
        ...
        Offset offsetM4283boximpl = layoutCoordinates != null ? Offset.m4283boximpl(LayoutCoordinatesKt.positionInWindow(layoutCoordinates)) : null;
        if (Intrinsics.areEqual(this.previousPosition, offsetM4283boximpl)) {
            return;
        }
        this.previousPosition = offsetM4283boximpl;
        updateHandleOffsets();
        updateSelectionToolbar();
    }
    ...
    public final void m1666setDragBeginPositionk4lQ0M(long j) {
        this.dragBeginPosition.setValue(Offset.m4283boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getDragBeginPosition-F1C5BW0$foundation_release, reason: not valid java name */
    public final long m1673getDragBeginPositionF1C5BW0$foundation_release() {
        return ((Offset) this.dragBeginPosition.getValue()).m4304unboximpl();
    }
    ...
    public final void m1667setDragTotalDistancek4lQ0M(long j) {
        this.dragTotalDistance.setValue(Offset.m4283boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getDragTotalDistance-F1C5BW0$foundation_release, reason: not valid java name */
    public final long m1674getDragTotalDistanceF1C5BW0$foundation_release() {
        return ((Offset) this.dragTotalDistance.getValue()).m4304unboximpl();
    }
    ...
    */
    public final void updateHandleOffsets() {
        ...
        L42:
            ...
            boolean r3 = androidx.compose.ui.geometry.OffsetKt.m4315isUnspecifiedk4lQ0M(r8)
            if (r3 == 0) goto L54
            goto L6f
        L54:
            long r8 = r1.mo5966localPositionOfR5De75A(r5, r8)
            androidx.compose.ui.geometry.Offset r3 = androidx.compose.ui.geometry.Offset.m4283boximpl(r8)
            long r8 = r3.m4304unboximpl()
        ...
        L70:
            ...
            boolean r0 = androidx.compose.ui.geometry.OffsetKt.m4315isUnspecifiedk4lQ0M(r3)
            if (r0 == 0) goto L81
            goto L9c
        L81:
            long r0 = r1.mo5966localPositionOfR5De75A(r6, r3)
            androidx.compose.ui.geometry.Offset r0 = androidx.compose.ui.geometry.Offset.m4283boximpl(r0)
            long r3 = r0.m4304unboximpl()
    ...
    public final void updateSelectionToolbar() {
        ...
        if (getHasFocus() && (textToolbar = this.textToolbar) != null) {
            if (this.showToolbar && isInTouchMode()) {
                ...
                TextToolbar.showMenu$default(textToolbar, contentRect, isNonEmptySelection$foundation_release() ? new C04951(this) : null, null, null, isEntireContainerSelected$foundation_release() ? null : new C04962(this), 12, null);
                return;
            }
    ...
    /* synthetic */ class C04951 extends FunctionReferenceImpl implements Function0<Unit> {
        C04951(Object obj) {
    ...
    /* synthetic */ class C04962 extends FunctionReferenceImpl implements Function0<Unit> {
        C04962(Object obj) {
    ...
    private final Rect getContentRect() {
        ...
        Rect rectM4331translatek4lQ0M = rectIntersect.m4331translatek4lQ0M(LayoutCoordinatesKt.positionInRoot(layoutCoordinates));
        return Rect.copy$default(rectM4331translatek4lQ0M, 0.0f, 0.0f, 0.0f, rectM4331translatek4lQ0M.getBottom() + (SelectionHandlesKt.getHandleHeight() * 4), 7, null);
    }
    ...
    public final TextDragObserver handleDragObserver(final boolean isStartHandle) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.SelectionManager.handleDragObserver.1
            ...
            public void mo1362onDownk4lQ0M(long point) {
                LayoutCoordinates layoutCoordinates;
                Offset offsetM1676getStartHandlePosition_m7T9E = isStartHandle ? this.m1676getStartHandlePosition_m7T9E() : this.m1675getEndHandlePosition_m7T9E();
                if (offsetM1676getStartHandlePosition_m7T9E != null) {
                    offsetM1676getStartHandlePosition_m7T9E.m4304unboximpl();
                    ...
                    long jMo1632getHandlePositiondBAh8RU = anchorSelectable$foundation_release.mo1632getHandlePositiondBAh8RU(selection, isStartHandle);
                    if (OffsetKt.m4315isUnspecifiedk4lQ0M(jMo1632getHandlePositiondBAh8RU)) {
                        return;
                    }
                    long jM1647getAdjustedCoordinatesk4lQ0M = SelectionHandlesKt.m1647getAdjustedCoordinatesk4lQ0M(jMo1632getHandlePositiondBAh8RU);
                    SelectionManager selectionManager = this;
                    selectionManager.m1665setCurrentDragPosition_kEHs6E(Offset.m4283boximpl(selectionManager.requireContainerCoordinates$foundation_release().mo5966localPositionOfR5De75A(layoutCoordinates, jM1647getAdjustedCoordinatesk4lQ0M)));
            ...
            public void mo1364onStartk4lQ0M(long startPoint) {
                ...
                long jMo1632getHandlePositiondBAh8RU = selectable2.mo1632getHandlePositiondBAh8RU(selection, isStartHandle);
                if (OffsetKt.m4315isUnspecifiedk4lQ0M(jMo1632getHandlePositiondBAh8RU)) {
                    return;
                }
                long jM1647getAdjustedCoordinatesk4lQ0M = SelectionHandlesKt.m1647getAdjustedCoordinatesk4lQ0M(jMo1632getHandlePositiondBAh8RU);
                SelectionManager selectionManager = this;
                selectionManager.m1666setDragBeginPositionk4lQ0M(selectionManager.requireContainerCoordinates$foundation_release().mo5966localPositionOfR5De75A(layoutCoordinates, jM1647getAdjustedCoordinatesk4lQ0M));
                this.m1667setDragTotalDistancek4lQ0M(Offset.INSTANCE.m4310getZeroF1C5BW0());
            }
            ...
            public void mo1363onDragk4lQ0M(long delta) {
                ...
                SelectionManager selectionManager = this;
                selectionManager.m1667setDragTotalDistancek4lQ0M(Offset.m4299plusMKHz9U(selectionManager.m1674getDragTotalDistanceF1C5BW0$foundation_release(), delta));
                long jM4299plusMKHz9U = Offset.m4299plusMKHz9U(this.m1673getDragBeginPositionF1C5BW0$foundation_release(), this.m1674getDragTotalDistanceF1C5BW0$foundation_release());
                if (this.m1678updateSelectionqNKwrvQ$foundation_release(Offset.m4283boximpl(jM4299plusMKHz9U), this.m1673getDragBeginPositionF1C5BW0$foundation_release(), isStartHandle, SelectionAdjustment.INSTANCE.getCharacterWithWordAccelerate())) {
                    this.m1666setDragBeginPositionk4lQ0M(jM4299plusMKHz9U);
                    this.m1667setDragTotalDistancek4lQ0M(Offset.INSTANCE.m4310getZeroF1C5BW0());
                }
            }
    ...
    @DebugMetadata(c = "androidx.compose.foundation.text.selection.SelectionManager$detectNonConsumingTap$2", f = "SelectionManager.kt", i = {}, l = {WinError.ERROR_ALERTED}, m = "invokeSuspend", n = {}, s = {})
    ...
    static final class C04922 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C04922(Function1<? super Offset, Unit> function1, Continuation<? super C04922> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C04922 c04922 = new C04922(this.$onTap, continuation);
            c04922.L$0 = obj;
            return c04922;
        }
        ...
        public final Object invoke(AwaitPointerEventScope awaitPointerEventScope, Continuation<? super Unit> continuation) {
            return ((C04922) create(awaitPointerEventScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (pointerInputChange != null) {
                this.$onTap.invoke(Offset.m4283boximpl(pointerInputChange.getPosition()));
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public final Object detectNonConsumingTap(PointerInputScope pointerInputScope, Function1<? super Offset, Unit> function1, Continuation<? super Unit> continuation) {
        Object objAwaitEachGesture = ForEachGestureKt.awaitEachGesture(pointerInputScope, new C04922(function1, null), continuation);
        return objAwaitEachGesture == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objAwaitEachGesture : Unit.INSTANCE;
    }

    /* compiled from: SelectionManager.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, d2 = {"<anonymous>", "", "Landroidx/compose/ui/input/pointer/PointerInputScope;"}, k = 3, mv = {1, 8, 0}, xi = 48)
    @DebugMetadata(c = "androidx.compose.foundation.text.selection.SelectionManager$onClearSelectionRequested$1", f = "SelectionManager.kt", i = {}, l = {WinError.ERROR_PRIMARY_TRANSPORT_CONNECT_FAILED}, m = "invokeSuspend", n = {}, s = {})
    ...
    static final class C04941 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04941(Function0<Unit> function0, Continuation<? super C04941> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C04941 c04941 = SelectionManager.this.new C04941(this.$block, continuation);
            c04941.L$0 = obj;
            return c04941;
        }
            ...
            if (i == 0) {
                ...
                if (selectionManager.detectNonConsumingTap(pointerInputScope, new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.onClearSelectionRequested.1.1
                    ...
                    public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                        m1682invokek4lQ0M(offset.m4304unboximpl());
                        return Unit.INSTANCE;
                    }

                    /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
                    public final void m1682invokek4lQ0M(long j) {
                        function0.invoke();
                    }
    ...
    private final Modifier onClearSelectionRequested(Modifier modifier, Function0<Unit> function0) {
        return getHasFocus() ? modifier.then(new SuspendPointerInputElement(Unit.INSTANCE, null, null, new SuspendingPointerInputFilterKt$sam$androidx_compose_ui_input_pointer_PointerInputEventHandler$0(new C04941(function0, null)), 6, null)) : modifier;
    }
    ...
    public final long m1663convertToContainerCoordinatesR5De75A(LayoutCoordinates layoutCoordinates, long offset) {
        ...
        return requireContainerCoordinates$foundation_release().mo5966localPositionOfR5De75A(layoutCoordinates, offset);
    }
    ...
    public final void m1670startSelection9KIMszo(long position, boolean isStartHandle, SelectionAdjustment adjustment) {
        this.previousSelectionLayout = null;
        m1677updateSelectionjyLRC_s$foundation_release(position, Offset.INSTANCE.m4309getUnspecifiedF1C5BW0(), isStartHandle, adjustment);
    }
    ...
    public final boolean m1678updateSelectionqNKwrvQ$foundation_release(Offset newPosition, long previousPosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        ...
        return m1677updateSelectionjyLRC_s$foundation_release(newPosition.m4304unboximpl(), previousPosition, isStartHandle, adjustment);
    }
    ...
    public final boolean m1677updateSelectionjyLRC_s$foundation_release(long position, long previousHandlePosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        ...
        m1665setCurrentDragPosition_kEHs6E(Offset.m4283boximpl(position));
        SelectionLayout selectionLayoutM1664getSelectionLayoutWko1d7g = m1664getSelectionLayoutWko1d7g(position, previousHandlePosition, isStartHandle);
        if (!selectionLayoutM1664getSelectionLayoutWko1d7g.shouldRecomputeSelection(this.previousSelectionLayout)) {
            return false;
        }
        Selection selectionAdjust = adjustment.adjust(selectionLayoutM1664getSelectionLayoutWko1d7g);
        if (!Intrinsics.areEqual(selectionAdjust, getSelection())) {
            selectionChanged(selectionLayoutM1664getSelectionLayoutWko1d7g, selectionAdjust);
        }
        this.previousSelectionLayout = selectionLayoutM1664getSelectionLayoutWko1d7g;
        return true;
    }
    ...
    private final SelectionLayout m1664getSelectionLayoutWko1d7g(long position, long previousHandlePosition, boolean isStartHandle) {
        ...
        SelectionLayoutBuilder selectionLayoutBuilder = new SelectionLayoutBuilder(position, previousHandlePosition, layoutCoordinatesRequireContainerCoordinates$foundation_release, isStartHandle, OffsetKt.m4315isUnspecifiedk4lQ0M(previousHandlePosition) ? null : getSelection(), new Comparator() { // from class: androidx.compose.foundation.text.selection.SelectionManager$getSelectionLayout-Wko1d7g$$inlined$compareBy$1
            /* JADX WARN: Multi-variable type inference failed */
    ...
    public final void m1671contextMenuOpenAdjustmentk4lQ0M(long position) {
        Selection selection = getSelection();
        if (selection != null ? TextRange.m6711getCollapsedimpl(selection.m1638toTextRanged9O1mEE()) : true) {
