...
@DebugMetadata(c = "androidx.compose.foundation.text.selection.SelectionGesturesKt$touchSelectionSubsequentPress$downResolution$1", f = "SelectionGestures.kt", i = {0}, l = {WinError.ERROR_EA_TABLE_FULL}, m = "invokeSuspend", n = {"$this$withTimeoutOrNull"}, s = {"L$0"})
...
final class SelectionGesturesKt$touchSelectionSubsequentPress$downResolution$1 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super DownResolution>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            Object objM720awaitTouchSlopOrCancellationjO51t88 = DragGestureDetectorKt.m720awaitTouchSlopOrCancellationjO51t88(awaitPointerEventScope2, j, new Function2<PointerInputChange, Offset, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionGesturesKt$touchSelectionSubsequentPress$downResolution$1$firstDragPastSlop$1
                {
                    super(2);
                }
                ...
                public /* bridge */ /* synthetic */ Unit invoke(PointerInputChange pointerInputChange, Offset offset) {
                    m1642invokeUv8p0NA(pointerInputChange, offset.m4304unboximpl());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-Uv8p0NA, reason: not valid java name */
                public final void m1642invokeUv8p0NA(PointerInputChange pointerInputChange, long j2) {
                    pointerInputChange.consume();
                    longRef.element = j2;
                }
            }, this);
            if (objM720awaitTouchSlopOrCancellationjO51t88 == coroutine_suspended) {
                return coroutine_suspended;
            }
            awaitPointerEventScope = awaitPointerEventScope2;
            obj = objM720awaitTouchSlopOrCancellationjO51t88;
        } else {
            if (i != 1) {
        ...
        if (((PointerInputChange) obj) != null && OffsetKt.m4313isSpecifiedk4lQ0M(this.$overSlop.element)) {
