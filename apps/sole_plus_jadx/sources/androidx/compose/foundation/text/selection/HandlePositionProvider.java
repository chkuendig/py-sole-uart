...
public final class HandlePositionProvider implements PopupPositionProvider {
    ...
    private long prevPosition = Offset.INSTANCE.m4310getZeroF1C5BW0();
    ...
    public long mo649calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        long jMo1275provideF1C5BW0 = this.positionProvider.mo1275provideF1C5BW0();
        if (!OffsetKt.m4313isSpecifiedk4lQ0M(jMo1275provideF1C5BW0)) {
            jMo1275provideF1C5BW0 = this.prevPosition;
        }
        this.prevPosition = jMo1275provideF1C5BW0;
        return IntOffset.m7387plusqkQi6aY(IntOffset.m7387plusqkQi6aY(anchorBounds.m7412getTopLeftnOccac(), IntOffsetKt.m7400roundk4lQ0M(jMo1275provideF1C5BW0)), this.handleReferencePoint.mo4017alignKFBX0sM(popupContentSize, IntSize.INSTANCE.m7431getZeroYbymL2g(), layoutDirection));
    }
}
