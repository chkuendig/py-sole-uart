...
public final class MultiWidgetSelectionDelegate implements Selectable {
    ...
    private final synchronized int getLastVisibleOffset(TextLayoutResult textLayoutResult) {
        ...
        if (this._previousTextLayoutResult != textLayoutResult) {
            if (!textLayoutResult.getDidOverflowHeight() || textLayoutResult.getMultiParagraph().getDidExceedMaxLines()) {
                ...
                int iCoerceAtMost = RangesKt.coerceAtMost(textLayoutResult.getLineForVerticalPosition(IntSize.m7425getHeightimpl(textLayoutResult.getSize())), textLayoutResult.getLineCount() - 1);
                while (iCoerceAtMost >= 0 && textLayoutResult.getLineTop(iCoerceAtMost) >= IntSize.m7425getHeightimpl(textLayoutResult.getSize())) {
                    iCoerceAtMost--;
                }
    ...
    public void appendSelectableInfoToBuilder(SelectionLayoutBuilder builder) {
        ...
        long jM4298minusMKHz9U;
        LayoutCoordinates layoutCoordinates = getLayoutCoordinates();
        if (layoutCoordinates == null || (textLayoutResultInvoke = this.layoutResultCallback.invoke()) == null) {
            return;
        }
        long jMo5966localPositionOfR5De75A = builder.getContainerCoordinates().mo5966localPositionOfR5De75A(layoutCoordinates, Offset.INSTANCE.m4310getZeroF1C5BW0());
        long jM4298minusMKHz9U2 = Offset.m4298minusMKHz9U(builder.getCurrentPosition(), jMo5966localPositionOfR5De75A);
        if (OffsetKt.m4315isUnspecifiedk4lQ0M(builder.getPreviousHandlePosition())) {
            jM4298minusMKHz9U = Offset.INSTANCE.m4309getUnspecifiedF1C5BW0();
        } else {
            jM4298minusMKHz9U = Offset.m4298minusMKHz9U(builder.getPreviousHandlePosition(), jMo5966localPositionOfR5De75A);
        }
        MultiWidgetSelectionDelegateKt.m1634appendSelectableInfoParwq6A(builder, textLayoutResultInvoke, jM4298minusMKHz9U2, jM4298minusMKHz9U, getSelectableId());
    }
