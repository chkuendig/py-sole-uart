...
public final class TextFieldSelectionManager {
    ...
    public TextFieldSelectionManager(UndoManager undoManager) {
        ...
        this.dragBeginPosition = Offset.INSTANCE.m4310getZeroF1C5BW0();
        ...
        this.touchSelectionObserver = new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$touchSelectionObserver$1
                ...
                if (this.this$0.getEnabled() && this.this$0.getDraggingHandle() == null) {
                    ...
                    if (state == null || (layoutResult2 = state.getLayoutResult()) == null || !layoutResult2.m1396isPositionOnTextk4lQ0M(startPoint)) {
                        ...
                        if (state2 != null && (layoutResult = state2.getLayoutResult()) != null) {
                            ...
                            int iTransformedToOriginal = textFieldSelectionManager.getOffsetMapping().transformedToOriginal(TextLayoutResultProxy.m1394getOffsetForPosition3MmeM6k$default(layoutResult, startPoint, false, 2, null));
                            TextFieldValue textFieldValueM1698createTextFieldValueFDrldGo = textFieldSelectionManager.m1698createTextFieldValueFDrldGo(textFieldSelectionManager.getValue$foundation_release().getAnnotatedString(), TextRangeKt.TextRange(iTransformedToOriginal, iTransformedToOriginal));
                            ...
                            textFieldSelectionManager.getOnValueChange$foundation_release().invoke(textFieldValueM1698createTextFieldValueFDrldGo);
                        }
                    } else {
                        ...
                        this.this$0.dragBeginOffsetInText = Integer.valueOf(TextRange.m6717getStartimpl(textFieldSelectionManager2.m1701updateSelection8UEBfa8(TextFieldValue.m6963copy3r_uNRQ$default(textFieldSelectionManager2.getValue$foundation_release(), (AnnotatedString) null, TextRange.INSTANCE.m6722getZerod9O1mEE(), (TextRange) null, 5, (Object) null), startPoint, true, false, SelectionAdjustment.INSTANCE.getWord(), true)));
                    }
                    this.this$0.setHandleState(HandleState.None);
                    this.this$0.dragBeginPosition = startPoint;
                    TextFieldSelectionManager textFieldSelectionManager3 = this.this$0;
                    textFieldSelectionManager3.m1700setCurrentDragPosition_kEHs6E(Offset.m4283boximpl(textFieldSelectionManager3.dragBeginPosition));
                    this.this$0.dragTotalDistance = Offset.INSTANCE.m4310getZeroF1C5BW0();
                }
            }
            ...
            */
            public void mo1363onDragk4lQ0M(long r10) {
                /*
                    r9 = this;
                ...
                L1c:
                    ...
                    long r10 = androidx.compose.ui.geometry.Offset.m4299plusMKHz9U(r1, r10)
                    ...
                    long r0 = androidx.compose.ui.geometry.Offset.m4299plusMKHz9U(r0, r2)
                    androidx.compose.ui.geometry.Offset r0 = androidx.compose.ui.geometry.Offset.m4283boximpl(r0)
                    androidx.compose.foundation.text.selection.TextFieldSelectionManager.m1696access$setCurrentDragPosition_kEHs6E(r6, r0)
                    ...
                    if (r0 != 0) goto Lb8
                    androidx.compose.ui.geometry.Offset r0 = r6.m1704getCurrentDragPosition_m7T9E()
                    kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
                    long r0 = r0.m4304unboximpl()
                    boolean r0 = r10.m1396isPositionOnTextk4lQ0M(r0)
                    if (r0 != 0) goto Lb8
                    ...
                    r3 = 0
                    r0 = r10
                    int r0 = androidx.compose.foundation.text.TextLayoutResultProxy.m1394getOffsetForPosition3MmeM6k$default(r0, r1, r3, r4, r5)
                    int r7 = r7.transformedToOriginal(r0)
                    androidx.compose.ui.text.input.OffsetMapping r8 = r6.getOffsetMapping()
                    androidx.compose.ui.geometry.Offset r0 = r6.m1704getCurrentDragPosition_m7T9E()
                    kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
                    long r1 = r0.m4304unboximpl()
                    r0 = r10
                    int r10 = androidx.compose.foundation.text.TextLayoutResultProxy.m1394getOffsetForPosition3MmeM6k$default(r0, r1, r3, r4, r5)
                ...
                L9f:
                    ...
                    androidx.compose.ui.geometry.Offset r0 = r6.m1704getCurrentDragPosition_m7T9E()
                    kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
                    long r2 = r0.m4304unboximpl()
                    r5 = 0
                    r7 = 1
                    r4 = 0
                    r0 = r6
                    r6 = r10
                    long r0 = androidx.compose.foundation.text.selection.TextFieldSelectionManager.m1697access$updateSelection8UEBfa8(r0, r1, r2, r4, r5, r6, r7)
                    goto L101
                Lb8:
                    java.lang.Integer r0 = androidx.compose.foundation.text.selection.TextFieldSelectionManager.access$getDragBeginOffsetInText$p(r6)
                    if (r0 == 0) goto Lc3
                ...
                Lc3:
                    long r0 = androidx.compose.foundation.text.selection.TextFieldSelectionManager.access$getDragBeginPosition$p(r6)
                    int r0 = r10.m1395getOffsetForPosition3MmeM6k(r0, r11)
                Lcb:
                    androidx.compose.ui.geometry.Offset r1 = r6.m1704getCurrentDragPosition_m7T9E()
                    kotlin.jvm.internal.Intrinsics.checkNotNull(r1)
                    long r1 = r1.m4304unboximpl()
                    int r10 = r10.m1395getOffsetForPosition3MmeM6k(r1, r11)
                ...
                Le3:
                    androidx.compose.ui.text.input.TextFieldValue r1 = r6.getValue$foundation_release()
                    androidx.compose.ui.geometry.Offset r10 = r6.m1704getCurrentDragPosition_m7T9E()
                    kotlin.jvm.internal.Intrinsics.checkNotNull(r10)
                    long r2 = r10.m4304unboximpl()
                    androidx.compose.foundation.text.selection.SelectionAdjustment$Companion r10 = androidx.compose.foundation.text.selection.SelectionAdjustment.INSTANCE
                    androidx.compose.foundation.text.selection.SelectionAdjustment r10 = r10.getWord()
                    r7 = 1
                    r4 = 0
                    ...
                    long r0 = androidx.compose.foundation.text.selection.TextFieldSelectionManager.m1697access$updateSelection8UEBfa8(r0, r1, r2, r4, r5, r6, r7)
                L101:
                    androidx.compose.ui.text.TextRange.m6705boximpl(r0)
                L104:
                    androidx.compose.foundation.text.selection.TextFieldSelectionManager r10 = r9.this$0
                ...
                L109:
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.selection.TextFieldSelectionManager$touchSelectionObserver$1.mo1363onDragk4lQ0M(long):void");
            }
            ...
            private final void onEnd() {
                ...
                this.this$0.m1700setCurrentDragPosition_kEHs6E(null);
                this.this$0.updateFloatingToolbar(true);
                this.this$0.dragBeginOffsetInText = null;
                boolean zM6711getCollapsedimpl = TextRange.m6711getCollapsedimpl(this.this$0.getValue$foundation_release().getSelection());
                this.this$0.setHandleState(zM6711getCollapsedimpl ? HandleState.Cursor : HandleState.Selection);
                LegacyTextFieldState state = this.this$0.getState();
                if (state != null) {
                    state.setShowSelectionHandleStart(!zM6711getCollapsedimpl && TextFieldSelectionManagerKt.isSelectionHandleInVisibleBound(this.this$0, true));
                }
                LegacyTextFieldState state2 = this.this$0.getState();
                if (state2 != null) {
                    state2.setShowSelectionHandleEnd(!zM6711getCollapsedimpl && TextFieldSelectionManagerKt.isSelectionHandleInVisibleBound(this.this$0, false));
                }
                LegacyTextFieldState state3 = this.this$0.getState();
                if (state3 == null) {
                    return;
                }
                state3.setShowCursorHandle(zM6711getCollapsedimpl && TextFieldSelectionManagerKt.isSelectionHandleInVisibleBound(this.this$0, true));
            }
        };
        this.mouseSelectionObserver = new MouseSelectionObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$mouseSelectionObserver$1
            ...
            public final void updateMouseSelection(TextFieldValue value, long currentPosition, boolean isStartOfSelection, SelectionAdjustment adjustment) {
                this.this$0.setHandleState(TextRange.m6711getCollapsedimpl(this.this$0.m1701updateSelection8UEBfa8(value, currentPosition, isStartOfSelection, false, adjustment, false)) ? HandleState.Cursor : HandleState.Selection);
            }
        };
    }
    ...
    public final TextDragObserver handleDragObserver$foundation_release(final boolean isStartHandle) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$handleDragObserver$1
            ...
            public void mo1362onDownk4lQ0M(long point) {
                ...
                long jM1647getAdjustedCoordinatesk4lQ0M = SelectionHandlesKt.m1647getAdjustedCoordinatesk4lQ0M(this.this$0.m1706getHandlePositiontuRUvjQ$foundation_release(isStartHandle));
                LegacyTextFieldState state = this.this$0.getState();
                if (state == null || (layoutResult = state.getLayoutResult()) == null) {
                    return;
                }
                long jM1398translateInnerToDecorationCoordinatesMKHz9U$foundation_release = layoutResult.m1398translateInnerToDecorationCoordinatesMKHz9U$foundation_release(jM1647getAdjustedCoordinatesk4lQ0M);
                this.this$0.dragBeginPosition = jM1398translateInnerToDecorationCoordinatesMKHz9U$foundation_release;
                this.this$0.m1700setCurrentDragPosition_kEHs6E(Offset.m4283boximpl(jM1398translateInnerToDecorationCoordinatesMKHz9U$foundation_release));
                this.this$0.dragTotalDistance = Offset.INSTANCE.m4310getZeroF1C5BW0();
                this.this$0.previousRawDragOffset = -1;
                LegacyTextFieldState state2 = this.this$0.getState();
                if (state2 != null) {
            ...
            public void mo1363onDragk4lQ0M(long delta) {
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.dragTotalDistance = Offset.m4299plusMKHz9U(textFieldSelectionManager.dragTotalDistance, delta);
                TextFieldSelectionManager textFieldSelectionManager2 = this.this$0;
                textFieldSelectionManager2.m1700setCurrentDragPosition_kEHs6E(Offset.m4283boximpl(Offset.m4299plusMKHz9U(textFieldSelectionManager2.dragBeginPosition, this.this$0.dragTotalDistance)));
                TextFieldSelectionManager textFieldSelectionManager3 = this.this$0;
                TextFieldValue value$foundation_release = textFieldSelectionManager3.getValue$foundation_release();
                Offset offsetM1704getCurrentDragPosition_m7T9E = this.this$0.m1704getCurrentDragPosition_m7T9E();
                Intrinsics.checkNotNull(offsetM1704getCurrentDragPosition_m7T9E);
                textFieldSelectionManager3.m1701updateSelection8UEBfa8(value$foundation_release, offsetM1704getCurrentDragPosition_m7T9E.m4304unboximpl(), false, isStartHandle, SelectionAdjustment.INSTANCE.getCharacterWithWordAccelerate(), true);
                this.this$0.updateFloatingToolbar(false);
            }
    ...
    public final TextDragObserver cursorDragObserver$foundation_release() {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$cursorDragObserver$1
            ...
            public void mo1364onStartk4lQ0M(long startPoint) {
                TextLayoutResultProxy layoutResult;
                long jM1647getAdjustedCoordinatesk4lQ0M = SelectionHandlesKt.m1647getAdjustedCoordinatesk4lQ0M(this.this$0.m1706getHandlePositiontuRUvjQ$foundation_release(true));
                LegacyTextFieldState state = this.this$0.getState();
                if (state == null || (layoutResult = state.getLayoutResult()) == null) {
                    return;
                }
            ...
            public void mo1363onDragk4lQ0M(long delta) {
                ...
                TextFieldSelectionManager textFieldSelectionManager2 = this.this$0;
                textFieldSelectionManager2.m1700setCurrentDragPosition_kEHs6E(Offset.m4283boximpl(Offset.m4299plusMKHz9U(textFieldSelectionManager2.dragBeginPosition, textFieldSelectionManager2.dragTotalDistance)));
                OffsetMapping offsetMapping = textFieldSelectionManager2.getOffsetMapping();
                Offset offsetM1704getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m1704getCurrentDragPosition_m7T9E();
                Intrinsics.checkNotNull(offsetM1704getCurrentDragPosition_m7T9E);
                int iTransformedToOriginal = offsetMapping.transformedToOriginal(TextLayoutResultProxy.m1394getOffsetForPosition3MmeM6k$default(layoutResult, offsetM1704getCurrentDragPosition_m7T9E.m4304unboximpl(), false, 2, null));
                long jTextRange = TextRangeKt.TextRange(iTransformedToOriginal, iTransformedToOriginal);
                if (TextRange.m6710equalsimpl0(jTextRange, textFieldSelectionManager2.getValue$foundation_release().getSelection())) {
                    return;
                }
                ...
                textFieldSelectionManager2.getOnValueChange$foundation_release().invoke(textFieldSelectionManager2.m1698createTextFieldValueFDrldGo(textFieldSelectionManager2.getValue$foundation_release().getAnnotatedString(), jTextRange));
            }
    ...
    public final void m1703deselect_kEHs6E$foundation_release(Offset position) {
        int iM6714getMaximpl;
        if (!TextRange.m6711getCollapsedimpl(getValue$foundation_release().getSelection())) {
            LegacyTextFieldState legacyTextFieldState = this.state;
            ...
            if (position != null && layoutResult != null) {
                iM6714getMaximpl = this.offsetMapping.transformedToOriginal(TextLayoutResultProxy.m1394getOffsetForPosition3MmeM6k$default(layoutResult, position.m4304unboximpl(), false, 2, null));
            } else {
                iM6714getMaximpl = TextRange.m6714getMaximpl(getValue$foundation_release().getSelection());
            }
            this.onValueChange.invoke(TextFieldValue.m6963copy3r_uNRQ$default(getValue$foundation_release(), (AnnotatedString) null, TextRangeKt.TextRange(iM6714getMaximpl), (TextRange) null, 5, (Object) null));
        }
    ...
    public final void m1708setSelectionPreviewHighlight5zctL8$foundation_release(long range) {
        ...
        if (legacyTextFieldState2 != null) {
            legacyTextFieldState2.m1322setDeletionPreviewHighlightRange5zctL8(TextRange.INSTANCE.m6722getZerod9O1mEE());
        }
        if (TextRange.m6711getCollapsedimpl(range)) {
            return;
        }
    ...
    public final void m1707setDeletionPreviewHighlight5zctL8$foundation_release(long range) {
        ...
        LegacyTextFieldState legacyTextFieldState2 = this.state;
        if (legacyTextFieldState2 != null) {
            legacyTextFieldState2.m1325setSelectionPreviewHighlightRange5zctL8(TextRange.INSTANCE.m6722getZerod9O1mEE());
        }
        if (TextRange.m6711getCollapsedimpl(range)) {
            return;
        }
    ...
    public final void clearPreviewHighlight$foundation_release() {
        LegacyTextFieldState legacyTextFieldState = this.state;
        if (legacyTextFieldState != null) {
            legacyTextFieldState.m1322setDeletionPreviewHighlightRange5zctL8(TextRange.INSTANCE.m6722getZerod9O1mEE());
        }
        LegacyTextFieldState legacyTextFieldState2 = this.state;
        if (legacyTextFieldState2 == null) {
            return;
    ...
    public final void copy$foundation_release(boolean cancelSelection) {
        ...
        if (cancelSelection) {
            int iM6714getMaximpl = TextRange.m6714getMaximpl(getValue$foundation_release().getSelection());
            this.onValueChange.invoke(m1698createTextFieldValueFDrldGo(getValue$foundation_release().getAnnotatedString(), TextRangeKt.TextRange(iM6714getMaximpl, iM6714getMaximpl)));
            setHandleState(HandleState.None);
        }
    }
    ...
    public final void paste$foundation_release() {
        ...
        int iM6715getMinimpl = TextRange.m6715getMinimpl(getValue$foundation_release().getSelection()) + text.length();
        this.onValueChange.invoke(m1698createTextFieldValueFDrldGo(annotatedStringPlus, TextRangeKt.TextRange(iM6715getMinimpl, iM6715getMinimpl)));
        setHandleState(HandleState.None);
    ...
    public final void cut$foundation_release() {
        ...
        int iM6715getMinimpl = TextRange.m6715getMinimpl(getValue$foundation_release().getSelection());
        this.onValueChange.invoke(m1698createTextFieldValueFDrldGo(annotatedStringPlus, TextRangeKt.TextRange(iM6715getMinimpl, iM6715getMinimpl)));
        setHandleState(HandleState.None);
        UndoManager undoManager = this.undoManager;
        if (undoManager != null) {
    ...
    public final void selectAll$foundation_release() {
        TextFieldValue textFieldValueM1698createTextFieldValueFDrldGo = m1698createTextFieldValueFDrldGo(getValue$foundation_release().getAnnotatedString(), TextRangeKt.TextRange(0, getValue$foundation_release().getText().length()));
        this.onValueChange.invoke(textFieldValueM1698createTextFieldValueFDrldGo);
        this.oldValue = TextFieldValue.m6963copy3r_uNRQ$default(this.oldValue, (AnnotatedString) null, textFieldValueM1698createTextFieldValueFDrldGo.getSelection(), (TextRange) null, 5, (Object) null);
    ...
    public final long m1706getHandlePositiontuRUvjQ$foundation_release(boolean isStartHandle) {
        ...
        return TextSelectionDelegateKt.getSelectionHandleCoordinates(value, this.offsetMapping.originalToTransformed(isStartHandle ? TextRange.m6717getStartimpl(selection) : TextRange.m6712getEndimpl(selection)), isStartHandle, TextRange.m6716getReversedimpl(getValue$foundation_release().getSelection()));
    }

    /* renamed from: getCursorPosition-tuRUvjQ$foundation_release, reason: not valid java name */
    public final long m1705getCursorPositiontuRUvjQ$foundation_release(Density density) {
        int iOriginalToTransformed = this.offsetMapping.originalToTransformed(TextRange.m6717getStartimpl(getValue$foundation_release().getSelection()));
        LegacyTextFieldState legacyTextFieldState = this.state;
        TextLayoutResultProxy layoutResult = legacyTextFieldState != null ? legacyTextFieldState.getLayoutResult() : null;
    ...
    public final void showSelectionToolbar$foundation_release() {
        ...
        if (getEnabled()) {
            ...
            if (legacyTextFieldState == null || legacyTextFieldState.isInTouchMode()) {
                ...
                Function0<Unit> function0 = (TextRange.m6711getCollapsedimpl(getValue$foundation_release().getSelection()) || z) ? null : new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$showSelectionToolbar$copy$1
                    {
                        super(0);
                    }
                ...
                Function0<Unit> function02 = (TextRange.m6711getCollapsedimpl(getValue$foundation_release().getSelection()) || !getEditable() || z) ? null : new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$showSelectionToolbar$cut$1
                    {
                        super(0);
                    }
                ...
                Function0<Unit> function04 = TextRange.m6713getLengthimpl(getValue$foundation_release().getSelection()) != getValue$foundation_release().getText().length() ? new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$showSelectionToolbar$selectAll$1
                    {
                        super(0);
                    }
    ...
    public final void m1702contextMenuOpenAdjustmentk4lQ0M(long position) {
        ...
        if (TextRange.m6708containsimpl(getValue$foundation_release().getSelection(), TextLayoutResultProxy.m1394getOffsetForPosition3MmeM6k$default(layoutResult, position, false, 2, null))) {
            return;
        }
        this.previousRawDragOffset = -1;
    ...
    private final Rect getContentRect() {
        ...
        if (legacyTextFieldState != null) {
            ...
            if (legacyTextFieldState != null) {
                int iOriginalToTransformed = this.offsetMapping.originalToTransformed(TextRange.m6717getStartimpl(getValue$foundation_release().getSelection()));
                int iOriginalToTransformed2 = this.offsetMapping.originalToTransformed(TextRange.m6712getEndimpl(getValue$foundation_release().getSelection()));
                LegacyTextFieldState legacyTextFieldState2 = this.state;
                long jM4310getZeroF1C5BW0 = (legacyTextFieldState2 == null || (layoutCoordinates4 = legacyTextFieldState2.getLayoutCoordinates()) == null) ? Offset.INSTANCE.m4310getZeroF1C5BW0() : layoutCoordinates4.mo5968localToRootMKHz9U(m1706getHandlePositiontuRUvjQ$foundation_release(true));
                LegacyTextFieldState legacyTextFieldState3 = this.state;
                long jM4310getZeroF1C5BW02 = (legacyTextFieldState3 == null || (layoutCoordinates3 = legacyTextFieldState3.getLayoutCoordinates()) == null) ? Offset.INSTANCE.m4310getZeroF1C5BW0() : layoutCoordinates3.mo5968localToRootMKHz9U(m1706getHandlePositiontuRUvjQ$foundation_release(false));
                ...
                if (legacyTextFieldState4 == null || (layoutCoordinates2 = legacyTextFieldState4.getLayoutCoordinates()) == null) {
                    ...
                    fM4295getYimpl = Offset.m4295getYimpl(layoutCoordinates2.mo5968localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult == null || (value2 = layoutResult.getValue()) == null || (cursorRect2 = value2.getCursorRect(iOriginalToTransformed)) == null) ? 0.0f : cursorRect2.getTop())));
                }
                ...
                if (legacyTextFieldState5 != null && (layoutCoordinates = legacyTextFieldState5.getLayoutCoordinates()) != null) {
                    ...
                    fM4295getYimpl2 = Offset.m4295getYimpl(layoutCoordinates.mo5968localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult2 == null || (value = layoutResult2.getValue()) == null || (cursorRect = value.getCursorRect(iOriginalToTransformed2)) == null) ? 0.0f : cursorRect.getTop())));
                }
                return new Rect(Math.min(Offset.m4294getXimpl(jM4310getZeroF1C5BW0), Offset.m4294getXimpl(jM4310getZeroF1C5BW02)), Math.min(fM4295getYimpl, fM4295getYimpl2), Math.max(Offset.m4294getXimpl(jM4310getZeroF1C5BW0), Offset.m4294getXimpl(jM4310getZeroF1C5BW02)), Math.max(Offset.m4295getYimpl(jM4310getZeroF1C5BW0), Offset.m4295getYimpl(jM4310getZeroF1C5BW02)) + (Dp.m7255constructorimpl(25) * legacyTextFieldState.getTextDelegate().getDensity().getDensity()));
            }
        }
    ...
    public final long m1701updateSelection8UEBfa8(TextFieldValue value, long currentPosition, boolean isStartOfSelection, boolean isStartHandle, SelectionAdjustment adjustment, boolean isTouchBasedSelection) {
        ...
        long jTextRange = TextRangeKt.TextRange(this.offsetMapping.originalToTransformed(TextRange.m6717getStartimpl(value.getSelection())), this.offsetMapping.originalToTransformed(TextRange.m6712getEndimpl(value.getSelection())));
        boolean z = false;
        int iM1395getOffsetForPosition3MmeM6k = layoutResult.m1395getOffsetForPosition3MmeM6k(currentPosition, false);
        int iM6717getStartimpl = (isStartHandle || isStartOfSelection) ? iM1395getOffsetForPosition3MmeM6k : TextRange.m6717getStartimpl(jTextRange);
        int iM6712getEndimpl = (!isStartHandle || isStartOfSelection) ? iM1395getOffsetForPosition3MmeM6k : TextRange.m6712getEndimpl(jTextRange);
        ...
        SelectionLayout selectionLayoutM1650getTextFieldSelectionLayoutRcvTLA = SelectionLayoutKt.m1650getTextFieldSelectionLayoutRcvTLA(layoutResult.getValue(), iM6717getStartimpl, iM6712getEndimpl, i2, jTextRange, isStartOfSelection, isStartHandle);
        if (!selectionLayoutM1650getTextFieldSelectionLayoutRcvTLA.shouldRecomputeSelection(selectionLayout)) {
            return value.getSelection();
        }
        this.previousSelectionLayout = selectionLayoutM1650getTextFieldSelectionLayoutRcvTLA;
        this.previousRawDragOffset = iM1395getOffsetForPosition3MmeM6k;
        Selection selectionAdjust = adjustment.adjust(selectionLayoutM1650getTextFieldSelectionLayoutRcvTLA);
        ...
        if (TextRange.m6710equalsimpl0(jTextRange2, value.getSelection())) {
            return value.getSelection();
        }
        boolean z2 = TextRange.m6716getReversedimpl(jTextRange2) != TextRange.m6716getReversedimpl(value.getSelection()) && TextRange.m6710equalsimpl0(TextRangeKt.TextRange(TextRange.m6712getEndimpl(jTextRange2), TextRange.m6717getStartimpl(jTextRange2)), value.getSelection());
        boolean z3 = TextRange.m6711getCollapsedimpl(jTextRange2) && TextRange.m6711getCollapsedimpl(value.getSelection());
        if (isTouchBasedSelection && value.getText().length() > 0 && !z2 && !z3 && (hapticFeedback = this.hapticFeedBack) != null) {
            hapticFeedback.mo5312performHapticFeedbackCdsT49E(HapticFeedbackType.INSTANCE.m5329getTextHandleMove5zf0vsI());
        }
        this.onValueChange.invoke(m1698createTextFieldValueFDrldGo(value.getAnnotatedString(), jTextRange2));
        if (!isTouchBasedSelection) {
            updateFloatingToolbar(!TextRange.m6711getCollapsedimpl(jTextRange2));
        }
        LegacyTextFieldState legacyTextFieldState2 = this.state;
        if (legacyTextFieldState2 != null) {
        ...
        if (legacyTextFieldState3 != null) {
            legacyTextFieldState3.setShowSelectionHandleStart(!TextRange.m6711getCollapsedimpl(jTextRange2) && TextFieldSelectionManagerKt.isSelectionHandleInVisibleBound(this, true));
        }
        LegacyTextFieldState legacyTextFieldState4 = this.state;
        if (legacyTextFieldState4 != null) {
            legacyTextFieldState4.setShowSelectionHandleEnd(!TextRange.m6711getCollapsedimpl(jTextRange2) && TextFieldSelectionManagerKt.isSelectionHandleInVisibleBound(this, false));
        }
        LegacyTextFieldState legacyTextFieldState5 = this.state;
        if (legacyTextFieldState5 != null) {
            if (TextRange.m6711getCollapsedimpl(jTextRange2) && TextFieldSelectionManagerKt.isSelectionHandleInVisibleBound(this, true)) {
                z = true;
            }
