    ...
    */
    ...
    private final int getInfoListIndexBySelectableId(long id2) {
        try {
            ...
            throw new IllegalStateException("Invalid selectableId: " + id2, e);
        }
    }
}
