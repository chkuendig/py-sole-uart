...
public final class SelectionContainerKt {
    ...
    public static final void SelectionContainer(final Modifier modifier, final Selection selection, final Function1<? super Selection, Unit> function1, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & WinError.ERROR_POINT_NOT_FOUND) != 1170 || !composerStartRestartGroup.getSkipping()) {
            ...
            final SelectionRegistrarImpl selectionRegistrarImpl = (SelectionRegistrarImpl) RememberSaveableKt.m3983rememberSaveable(new Object[0], (Saver) SelectionRegistrarImpl.INSTANCE.getSaver(), (String) null, (Function0) new Function0<SelectionRegistrarImpl>() { // from class: androidx.compose.foundation.text.selection.SelectionContainerKt$SelectionContainer$registrarImpl$1
                /* JADX WARN: Can't rename method to resolve collision */
                @Override // kotlin.jvm.functions.Function0
                public final SelectionRegistrarImpl invoke() {
                    return new SelectionRegistrarImpl();
                }
            }, composerStartRestartGroup, WinPerf.PERF_TYPE_ZERO, 4);
                                                                ...
                                                                if (zBooleanValue) {
                                                                    obj = (Function0) new Function0<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionContainerKt$SelectionContainer$3$1$1$1$1$positionProvider$1$1
                                                                        ...
                                                                        public /* bridge */ /* synthetic */ Offset invoke() {
                                                                            return Offset.m4283boximpl(m1640invokeF1C5BW0());
                                                                        }

                                                                        /* renamed from: invoke-F1C5BW0, reason: not valid java name */
                                                                        public final long m1640invokeF1C5BW0() {
                                                                            Offset offsetM1676getStartHandlePosition_m7T9E = selectionManager4.m1676getStartHandlePosition_m7T9E();
                                                                            return offsetM1676getStartHandlePosition_m7T9E != null ? offsetM1676getStartHandlePosition_m7T9E.m4304unboximpl() : Offset.INSTANCE.m4309getUnspecifiedF1C5BW0();
                                                                        }
                                                                    };
                                                                } else {
                                                                    obj = (Function0) new Function0<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionContainerKt$SelectionContainer$3$1$1$1$1$positionProvider$1$2
                                                                        ...
                                                                        @Override // kotlin.jvm.functions.Function0
                                                                        public /* bridge */ /* synthetic */ Offset invoke() {
                                                                            return Offset.m4283boximpl(m1641invokeF1C5BW0());
                                                                        }

                                                                        /* renamed from: invoke-F1C5BW0, reason: not valid java name */
                                                                        public final long m1641invokeF1C5BW0() {
                                                                            Offset offsetM1675getEndHandlePosition_m7T9E = selectionManager4.m1675getEndHandlePosition_m7T9E();
                                                                            return offsetM1675getEndHandlePosition_m7T9E != null ? offsetM1675getEndHandlePosition_m7T9E.m4304unboximpl() : Offset.INSTANCE.m4309getUnspecifiedF1C5BW0();
                                                                        }
                                                                    };
                                                                }
