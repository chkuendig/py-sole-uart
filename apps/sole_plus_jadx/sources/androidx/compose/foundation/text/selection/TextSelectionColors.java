...
public final class TextSelectionColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4539equalsimpl0(this.handleColor, textSelectionColors.handleColor) && Color.m4539equalsimpl0(this.backgroundColor, textSelectionColors.backgroundColor);
    }

    public int hashCode() {
        return (Color.m4545hashCodeimpl(this.handleColor) * 31) + Color.m4545hashCodeimpl(this.backgroundColor);
    }

    public String toString() {
        return "SelectionColors(selectionHandleColor=" + ((Object) Color.m4546toStringimpl(this.handleColor)) + ", selectionBackgroundColor=" + ((Object) Color.m4546toStringimpl(this.backgroundColor)) + ')';
    }
}
