    ...
    */
    ...
    public static final void SelectionHandleIcon(final Modifier modifier, final Function0<Boolean> function0, final boolean z, Composer composer, final int i) {
        ...
        if ((i2 & 147) != 146 || !composerStartRestartGroup.getSkipping()) {
            ...
            SpacerKt.Spacer(drawSelectionHandle(SizeKt.m1032sizeVpY3zN4(modifier, SelectionHandlesKt.getHandleWidth(), SelectionHandlesKt.getHandleHeight()), function0, z), composerStartRestartGroup, 0);
            if (ComposerKt.isTraceInProgress()) {
                ...
                if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue = (Function1) new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$drawSelectionHandle$1$1$1
                        ...
                        public final DrawResult invoke(CacheDrawScope cacheDrawScope) {
                            final ImageBitmap imageBitmapCreateHandleImage = AndroidSelectionHandles_androidKt.createHandleImage(cacheDrawScope, Size.m4363getWidthimpl(cacheDrawScope.m4078getSizeNHjbRc()) / 2.0f);
                            final ColorFilter colorFilterM4579tintxETnrds$default = ColorFilter.Companion.m4579tintxETnrds$default(ColorFilter.INSTANCE, handleColor, 0, 2, null);
                                ...
                                public final void invoke2(ContentDrawScope contentDrawScope) {
                                    ...
                                    if (function03.invoke().booleanValue()) {
                                        if (z3) {
                                            ...
                                            ColorFilter colorFilter = colorFilterM4579tintxETnrds$default;
                                            long jMo5116getCenterF1C5BW0 = contentDrawScope2.mo5116getCenterF1C5BW0();
                                            ...
                                            try {
                                                ...
                                                DrawScope.m5101drawImagegbVJVH8$default(contentDrawScope2, imageBitmap, 0L, 0.0f, null, colorFilter, 0, 46, null);
                                                return;
                                            } finally {
                                        ...
                                        DrawScope.m5101drawImagegbVJVH8$default(contentDrawScope, imageBitmapCreateHandleImage, 0L, 0.0f, null, colorFilterM4579tintxETnrds$default, 0, 46, null);
                                    }
                                }
                            });
                        }
    ...
    public static final ImageBitmap createHandleImage(CacheDrawScope cacheDrawScope, float f) {
        ...
        if (imageBitmap == null || canvas == null || iCeil > imageBitmap.getWidth() || iCeil > imageBitmap.getHeight()) {
            imageBitmap = ImageBitmapKt.m4775ImageBitmapx__hDU$default(iCeil, iCeil, ImageBitmapConfig.INSTANCE.m4769getAlpha8_sVssgQ(), false, null, 24, null);
        ...
        drawParams2.m5037setSizeuvyYCjk(jSize);
        canvas2.save();
        CanvasDrawScope canvasDrawScope3 = canvasDrawScope2;
        DrawScope.m5111drawRectnJ9OG0$default(canvasDrawScope3, Color.INSTANCE.m4564getBlack0d7_KjU(), 0L, canvasDrawScope3.mo5117getSizeNHjbRc(), 0.0f, null, null, BlendMode.INSTANCE.m4452getClear0nO6VwU(), 58, null);
        DrawScope.m5111drawRectnJ9OG0$default(canvasDrawScope3, ColorKt.Color(4278190080L), Offset.INSTANCE.m4310getZeroF1C5BW0(), androidx.compose.ui.geometry.SizeKt.Size(f, f), 0.0f, null, null, 0, 120, null);
        DrawScope.m5098drawCircleVaOC9Bg$default(canvasDrawScope3, ColorKt.Color(4278190080L), f, OffsetKt.Offset(f, f), 0.0f, null, null, 0, 120, null);
        canvas2.restore();
        CanvasDrawScope.DrawParams drawParams3 = canvasDrawScope2.getDrawParams();
        drawParams3.setDensity(density);
        drawParams3.setLayoutDirection(layoutDirection2);
        drawParams3.setCanvas(canvas3);
        drawParams3.m5037setSizeuvyYCjk(size);
        return imageBitmap2;
    }
