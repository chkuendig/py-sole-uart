...
public final class SelectionHandlesKt {
    ...
    public static final long m1647getAdjustedCoordinatesk4lQ0M(long j) {
        return OffsetKt.Offset(Offset.m4294getXimpl(j), Offset.m4295getYimpl(j) - 1.0f);
    }
    ...
    static {
        float f = 25;
        HandleWidth = Dp.m7255constructorimpl(f);
        HandleHeight = Dp.m7255constructorimpl(f);
    }
}
