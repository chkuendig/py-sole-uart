...
public final class SelectableInfo {
    ...
    public String toString() {
        return "SelectionInfo(id=" + this.selectableId + ", range=(" + this.rawStartHandleOffset + SignatureVisitor.SUPER + getStartRunDirection() + AbstractJsonLexerKt.COMMA + this.rawEndHandleOffset + SignatureVisitor.SUPER + getEndRunDirection() + "), prevOffset=" + this.rawPreviousHandleOffset + ')';
    }
}
