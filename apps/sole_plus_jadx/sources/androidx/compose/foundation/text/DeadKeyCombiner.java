...
public final class DeadKeyCombiner {
    ...
    public final Integer m1299consumeZmokQxo(KeyEvent event) {
        int iM5686getUtf16CodePointZmokQxo = KeyEvent_androidKt.m5686getUtf16CodePointZmokQxo(event);
        if ((Integer.MIN_VALUE & iM5686getUtf16CodePointZmokQxo) != 0) {
            this.deadKeyCode = Integer.valueOf(iM5686getUtf16CodePointZmokQxo & Integer.MAX_VALUE);
            return null;
        }
        Integer num = this.deadKeyCode;
        if (num != null) {
            this.deadKeyCode = null;
            Integer numValueOf = Integer.valueOf(KeyCharacterMap.getDeadChar(num.intValue(), iM5686getUtf16CodePointZmokQxo));
            Integer num2 = numValueOf.intValue() != 0 ? numValueOf : null;
            return num2 == null ? Integer.valueOf(iM5686getUtf16CodePointZmokQxo) : num2;
        }
        return Integer.valueOf(iM5686getUtf16CodePointZmokQxo);
    }
}
