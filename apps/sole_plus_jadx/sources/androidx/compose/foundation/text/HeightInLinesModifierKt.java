...
@Metadata(d1 = {"\u0000\"\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0000\u001a\u0018\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00012\u0006\u0010\u0005\u001a\u00020\u0001H\u0000\u001a(\u0010\u0006\u001a\u00020\u0007*\u00020\u00072\u0006\u0010\b\u001a\u00020\t2\b\b\u0002\u0010\u0004\u001a\u00020\u00012\b\b\u0002\u0010\u0005\u001a\u00020\u0001H\u0000\"\u000e\u0010\u0000\u001a\u00020\u0001X\u0080T¢\u0006\u0002\n\u0000¨\u0006\n²\u0006\n\u0010\u000b\u001a\u00020\fX\u008a\u0084\u0002"}, d2 = {"DefaultMinLines", "", "validateMinMaxLines", "", "minLines", "maxLines", "heightInLines", "Landroidx/compose/ui/Modifier;", SdkConstants.ATTR_TEXT_STYLE, "Landroidx/compose/ui/text/TextStyle;", "foundation_release", SdkConstants.ATTR_TYPEFACE, ""}, k = 2, mv = {1, 8, 0}, xi = 48)
    ...
    public static final Modifier heightInLines(Modifier modifier, final TextStyle textStyle, final int i, final int i2) {
        return ComposedModifierKt.composed(modifier, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.text.HeightInLinesModifierKt$heightInLines$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set(SdkConstants.ATTR_TEXT_STYLE, textStyle);
            }
            ...
            public final Modifier invoke(Modifier modifier2, Composer composer, int i3) {
                ...
                if (zChanged2 || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                    ...
                    FontStyle fontStyleM6749getFontStyle4Lr2A7w = textStyle3.m6749getFontStyle4Lr2A7w();
                    int iM6833unboximpl = fontStyleM6749getFontStyle4Lr2A7w != null ? fontStyleM6749getFontStyle4Lr2A7w.m6833unboximpl() : FontStyle.INSTANCE.m6837getNormal_LCdwA();
                    FontSynthesis fontSynthesisM6750getFontSynthesisZQGJjVo = textStyle3.m6750getFontSynthesisZQGJjVo();
                    objRememberedValue2 = resolver.mo6802resolveDPcqOEQ(fontFamily, fontWeight, iM6833unboximpl, fontSynthesisM6750getFontSynthesisZQGJjVo != null ? fontSynthesisM6750getFontSynthesisZQGJjVo.getValue() : FontSynthesis.INSTANCE.m6847getAllGVVA2EU());
                ...
                if (zChanged3 || objRememberedValue3 == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue3 = Integer.valueOf(IntSize.m7425getHeightimpl(TextFieldDelegateKt.computeSizeForDefaultText(textStyle3, density, resolver, TextFieldDelegateKt.getEmptyTextReplacement(), 1)));
                ...
                if (zChanged4 || objRememberedValue4 == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue4 = Integer.valueOf(IntSize.m7425getHeightimpl(TextFieldDelegateKt.computeSizeForDefaultText(textStyle3, density, resolver, TextFieldDelegateKt.getEmptyTextReplacement() + '\n' + TextFieldDelegateKt.getEmptyTextReplacement(), 2)));
                ...
                Modifier modifierM1017heightInVpY3zN4 = SizeKt.m1017heightInVpY3zN4(Modifier.INSTANCE, numValueOf != null ? density.mo674toDpu2uoSUM(numValueOf.intValue()) : Dp.INSTANCE.m7275getUnspecifiedD9Ej5fM(), numValueOf2 != null ? density.mo674toDpu2uoSUM(numValueOf2.intValue()) : Dp.INSTANCE.m7275getUnspecifiedD9Ej5fM());
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                composer.endReplaceGroup();
                return modifierM1017heightInVpY3zN4;
            }
        });
    }
}
