...
public final class TextFieldScrollerPosition {
    ...
    public TextFieldScrollerPosition(Orientation orientation, float f) {
        ...
        this.previousSelection = TextRange.INSTANCE.m6722getZerod9O1mEE();
    ...
    public final void m1388setPreviousSelection5zctL8(long j) {
    ...
    public final int m1386getOffsetToFollow5zctL8(long selection) {
        return TextRange.m6717getStartimpl(selection) != TextRange.m6717getStartimpl(this.previousSelection) ? TextRange.m6717getStartimpl(selection) : TextRange.m6712getEndimpl(selection) != TextRange.m6712getEndimpl(this.previousSelection) ? TextRange.m6712getEndimpl(selection) : TextRange.m6715getMinimpl(selection);
    }
