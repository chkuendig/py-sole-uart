...
public final class ParagraphLayoutCache {
    ...
    private ParagraphLayoutCache(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3) {
        ...
        this.maxLines = i2;
        this.minLines = i3;
        this.lastDensity = InlineDensity.INSTANCE.m1602getUnspecifiedL26CHvs();
        this.layoutSize = IntSizeKt.IntSize(0, 0);
        this.prevConstraints = Constraints.INSTANCE.m7218fixedJhjzzOo(0, 0);
    ...
    public /* synthetic */ ParagraphLayoutCache(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.INSTANCE.m7190getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, null);
    }
    ...
    public final void setDensity$foundation_release(Density density) {
        ...
        long jM1594constructorimpl = density != null ? InlineDensity.m1594constructorimpl(density) : InlineDensity.INSTANCE.m1602getUnspecifiedL26CHvs();
        if (density2 == null) {
            this.density = density;
            this.lastDensity = jM1594constructorimpl;
        } else if (density == null || !InlineDensity.m1596equalsimpl0(this.lastDensity, jM1594constructorimpl)) {
            this.density = density;
            this.lastDensity = jM1594constructorimpl;
            markDirty();
        }
    ...
    public final void m1618setLayoutSizeozmzZPI$foundation_release(long j) {
        this.layoutSize = j;
    }

    /* renamed from: layoutWithConstraints-K40F9xA, reason: not valid java name */
    public final boolean m1617layoutWithConstraintsK40F9xA(long constraints, LayoutDirection layoutDirection) {
        boolean z = true;
        if (this.minLines > 1) {
            ...
            constraints = minLinesConstrainerFrom.m1606coerceMinLinesOh53vG4$foundation_release(constraints, this.minLines);
        }
        boolean z2 = false;
        if (!m1615newLayoutWillBeDifferentK40F9xA(constraints, layoutDirection)) {
            if (!Constraints.m7201equalsimpl0(constraints, this.prevConstraints)) {
                Paragraph paragraph = this.paragraph;
                Intrinsics.checkNotNull(paragraph);
                this.layoutSize = ConstraintsKt.m7222constrain4WqzIAM(constraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(Math.min(paragraph.getMaxIntrinsicWidth(), paragraph.getWidth())), TextDelegateKt.ceilToIntPx(paragraph.getHeight())));
                if (TextOverflow.m7181equalsimpl0(this.overflow, TextOverflow.INSTANCE.m7194getVisiblegIe3tQ8()) || (IntSize.m7426getWidthimpl(r3) >= paragraph.getWidth() && IntSize.m7425getHeightimpl(r3) >= paragraph.getHeight())) {
                    z = false;
                }
                this.didOverflow = z;
        ...
        Paragraph paragraphM1614layoutTextK40F9xA = m1614layoutTextK40F9xA(constraints, layoutDirection);
        this.prevConstraints = constraints;
        this.layoutSize = ConstraintsKt.m7222constrain4WqzIAM(constraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(paragraphM1614layoutTextK40F9xA.getWidth()), TextDelegateKt.ceilToIntPx(paragraphM1614layoutTextK40F9xA.getHeight())));
        if (!TextOverflow.m7181equalsimpl0(this.overflow, TextOverflow.INSTANCE.m7194getVisiblegIe3tQ8()) && (IntSize.m7426getWidthimpl(r9) < paragraphM1614layoutTextK40F9xA.getWidth() || IntSize.m7425getHeightimpl(r9) < paragraphM1614layoutTextK40F9xA.getHeight())) {
            z2 = true;
        }
        this.didOverflow = z2;
        this.paragraph = paragraphM1614layoutTextK40F9xA;
        return true;
    }
    ...
    public final int intrinsicHeight(int width, LayoutDirection layoutDirection) {
        ...
        int iCeilToIntPx = TextDelegateKt.ceilToIntPx(m1614layoutTextK40F9xA(ConstraintsKt.Constraints(0, width, 0, Integer.MAX_VALUE), layoutDirection).getHeight());
    ...
    public final void m1619updateL6sJoHM(String text, TextStyle style, FontFamily.Resolver fontFamilyResolver, int overflow, boolean softWrap, int maxLines, int minLines) {
        this.text = text;
        this.style = style;
    ...
    private final Paragraph m1614layoutTextK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ParagraphIntrinsics layoutDirection2 = setLayoutDirection(layoutDirection);
        return ParagraphKt.m6579Paragraph_EkL_Y(layoutDirection2, LayoutUtilsKt.m1603finalConstraintstfFHcEY(constraints, this.softWrap, this.overflow, layoutDirection2.getMaxIntrinsicWidth()), LayoutUtilsKt.m1604finalMaxLinesxdlQI24(this.softWrap, this.overflow, this.maxLines), TextOverflow.m7181equalsimpl0(this.overflow, TextOverflow.INSTANCE.m7191getEllipsisgIe3tQ8()));
    }

    /* renamed from: newLayoutWillBeDifferent-K40F9xA, reason: not valid java name */
    private final boolean m1615newLayoutWillBeDifferentK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        return Constraints.m7208getMaxWidthimpl(constraints) != Constraints.m7208getMaxWidthimpl(this.prevConstraints) || ((float) Constraints.m7207getMaxHeightimpl(constraints)) < paragraph.getHeight() || paragraph.getDidExceedMaxLines();
    }
    ...
    public final TextLayoutResult slowCreateTextLayoutResultOrNull(TextStyle style) {
        ...
        long jM7198copyZbe2FdA$default = Constraints.m7198copyZbe2FdA$default(this.prevConstraints, 0, 0, 0, 0, 10, null);
        return new TextLayoutResult(new TextLayoutInput(annotatedString, style, CollectionsKt.emptyList(), this.maxLines, this.softWrap, this.overflow, density, layoutDirection, this.fontFamilyResolver, jM7198copyZbe2FdA$default, (DefaultConstructorMarker) null), new MultiParagraph(new MultiParagraphIntrinsics(annotatedString, style, (List<AnnotatedString.Range<Placeholder>>) CollectionsKt.emptyList(), density, this.fontFamilyResolver), jM7198copyZbe2FdA$default, this.maxLines, TextOverflow.m7181equalsimpl0(this.overflow, TextOverflow.INSTANCE.m7191getEllipsisgIe3tQ8()), (DefaultConstructorMarker) null), this.layoutSize, null);
    }
    ...
    public String toString() {
        return "ParagraphLayoutCache(paragraph=" + (this.paragraph != null ? "<paragraph>" : AbstractJsonLexerKt.NULL) + ", lastDensity=" + ((Object) InlineDensity.m1600toStringimpl(this.lastDensity)) + ')';
    }
}
