...
public final class MinLinesConstrainer {
    ...
    public final long m1606coerceMinLinesOh53vG4$foundation_release(long inConstraints, int minLines) {
        ...
        if (Float.isNaN(height) || Float.isNaN(height2)) {
            height = ParagraphKt.m6575ParagraphUdtVg6A(MinLinesConstrainerKt.EmptyTextReplacement, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (64 & 32) != 0 ? CollectionsKt.emptyList() : null, (64 & 64) != 0 ? CollectionsKt.emptyList() : null, (64 & 128) != 0 ? Integer.MAX_VALUE : 1, (64 & 256) != 0 ? false : false).getHeight();
            height2 = ParagraphKt.m6575ParagraphUdtVg6A(MinLinesConstrainerKt.TwoLineTextReplacement, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (64 & 32) != 0 ? CollectionsKt.emptyList() : null, (64 & 64) != 0 ? CollectionsKt.emptyList() : null, (64 & 128) != 0 ? Integer.MAX_VALUE : 2, (64 & 256) != 0 ? false : false).getHeight() - height;
            this.oneLineHeightCache = height;
            this.lineHeightCache = height2;
        }
        if (minLines != 1) {
            iM7209getMinHeightimpl = RangesKt.coerceAtMost(RangesKt.coerceAtLeast(Math.round(height + (height2 * (minLines - 1))), 0), Constraints.m7207getMaxHeightimpl(inConstraints));
        } else {
            iM7209getMinHeightimpl = Constraints.m7209getMinHeightimpl(inConstraints);
        }
        return ConstraintsKt.Constraints(Constraints.m7210getMinWidthimpl(inConstraints), Constraints.m7208getMaxWidthimpl(inConstraints), iM7209getMinHeightimpl, Constraints.m7207getMaxHeightimpl(inConstraints));
    }
}
