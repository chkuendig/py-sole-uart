...
public final class TransformedTextFieldState {
    ...
    @DebugMetadata(c = "androidx.compose.foundation.text.input.internal.TransformedTextFieldState", f = "TransformedTextFieldState.kt", i = {0, 0}, l = {WinError.ERROR_MEDIA_CHECK}, m = "collectImeNotifications", n = {"this", "notifyImeListener"}, s = {"L$0", "L$1"})
    ...
    public final void m1538selectUntransformedCharsIn5zctL8(long untransformedRange) {
        ...
        textFieldState.getMainBuffer().setSelection(TextRange.m6717getStartimpl(untransformedRange), TextRange.m6712getEndimpl(untransformedRange));
    ...
    public final void m1531highlightCharsIn7RAjNK8(int type, long transformedRange) {
        long jM1533mapFromTransformedGEjPoXI = m1533mapFromTransformedGEjPoXI(transformedRange);
        TextFieldState textFieldState = this.textFieldState;
        InputTransformation inputTransformation = this.inputTransformation;
        TextFieldEditUndoBehavior textFieldEditUndoBehavior = TextFieldEditUndoBehavior.MergeIfPossible;
        textFieldState.getMainBuffer().getChangeTracker().clearChanges();
        textFieldState.getMainBuffer().m1447setHighlightK7f2yys(type, TextRange.m6717getStartimpl(jM1533mapFromTransformedGEjPoXI), TextRange.m6712getEndimpl(jM1533mapFromTransformedGEjPoXI));
        textFieldState.commitEditAsUser(inputTransformation, true, textFieldEditUndoBehavior);
    }
    ...
    public final void deleteSelectedText() {
        ...
        textFieldState.getMainBuffer().getChangeTracker().clearChanges();
        EditingBuffer mainBuffer = textFieldState.getMainBuffer();
        mainBuffer.delete(TextRange.m6715getMinimpl(mainBuffer.m1446getSelectiond9O1mEE()), TextRange.m6714getMaximpl(mainBuffer.m1446getSelectiond9O1mEE()));
        mainBuffer.setSelection(TextRange.m6715getMinimpl(mainBuffer.m1446getSelectiond9O1mEE()), TextRange.m6715getMinimpl(mainBuffer.m1446getSelectiond9O1mEE()));
        textFieldState.commitEditAsUser(inputTransformation, true, textFieldEditUndoBehavior);
    }
    ...
    public final void m1536replaceTextM8tDOmk(CharSequence newText, long range, TextFieldEditUndoBehavior undoBehavior, boolean restartImeIfContentChanges) {
        ...
        textFieldState.getMainBuffer().getChangeTracker().clearChanges();
        EditingBuffer mainBuffer = textFieldState.getMainBuffer();
        long jM1533mapFromTransformedGEjPoXI = m1533mapFromTransformedGEjPoXI(range);
        mainBuffer.replace(TextRange.m6715getMinimpl(jM1533mapFromTransformedGEjPoXI), TextRange.m6714getMaximpl(jM1533mapFromTransformedGEjPoXI), newText);
        int iM6715getMinimpl = TextRange.m6715getMinimpl(jM1533mapFromTransformedGEjPoXI) + newText.length();
        mainBuffer.setSelection(iM6715getMinimpl, iM6715getMinimpl);
    ...
    public final void replaceSelectedText(CharSequence newText, boolean clearComposition, TextFieldEditUndoBehavior undoBehavior) {
        ...
        long jM1446getSelectiond9O1mEE = mainBuffer.m1446getSelectiond9O1mEE();
        mainBuffer.replace(TextRange.m6715getMinimpl(jM1446getSelectiond9O1mEE), TextRange.m6714getMaximpl(jM1446getSelectiond9O1mEE), newText);
        int iM6715getMinimpl = TextRange.m6715getMinimpl(jM1446getSelectiond9O1mEE) + newText.length();
        mainBuffer.setSelection(iM6715getMinimpl, iM6715getMinimpl);
    ...
    public final void collapseSelectionToMax() {
        ...
        textFieldState.getMainBuffer().getChangeTracker().clearChanges();
        EditingBuffer mainBuffer = textFieldState.getMainBuffer();
        mainBuffer.setSelection(TextRange.m6714getMaximpl(mainBuffer.m1446getSelectiond9O1mEE()), TextRange.m6714getMaximpl(mainBuffer.m1446getSelectiond9O1mEE()));
        textFieldState.commitEditAsUser(inputTransformation, true, textFieldEditUndoBehavior);
    }
    ...
    public final void collapseSelectionToEnd() {
        ...
        textFieldState.getMainBuffer().getChangeTracker().clearChanges();
        EditingBuffer mainBuffer = textFieldState.getMainBuffer();
        mainBuffer.setSelection(TextRange.m6712getEndimpl(mainBuffer.m1446getSelectiond9O1mEE()), TextRange.m6712getEndimpl(mainBuffer.m1446getSelectiond9O1mEE()));
        textFieldState.commitEditAsUser(inputTransformation, true, textFieldEditUndoBehavior);
    }
    ...
    public final long m1534mapToTransformedjx7JFs(int offset) {
        ...
        if (offsetMapping2 != null) {
            jTextRange = offsetMapping2.m1484mapFromSourcejx7JFs(offset);
        } else {
            jTextRange = TextRangeKt.TextRange(offset);
        }
        return offsetMapping != null ? Companion.m1542mapToTransformedXGyztTk(jTextRange, offsetMapping, getSelectionWedgeAffinity()) : jTextRange;
    }
    ...
    public final long m1535mapToTransformedGEjPoXI(long range) {
        ...
        if (offsetMapping2 != null) {
            range = Companion.m1543mapToTransformedXGyztTk$default(Companion, range, offsetMapping2, null, 4, null);
        }
        return offsetMapping != null ? Companion.m1542mapToTransformedXGyztTk(range, offsetMapping, getSelectionWedgeAffinity()) : range;
    }
    ...
    public final long m1532mapFromTransformedjx7JFs(int offset) {
        ...
        if (offsetMapping != null) {
            jTextRange = offsetMapping.m1483mapFromDestjx7JFs(offset);
        } else {
            jTextRange = TextRangeKt.TextRange(offset);
        }
        return offsetMapping2 != null ? Companion.m1541mapFromTransformedxdX6G0(jTextRange, offsetMapping2) : jTextRange;
    }
    ...
    public final long m1533mapFromTransformedGEjPoXI(long range) {
        ...
        if (offsetMapping != null) {
            range = Companion.m1541mapFromTransformedxdX6G0(range, offsetMapping);
        }
        return offsetMapping2 != null ? Companion.m1541mapFromTransformedxdX6G0(range, offsetMapping2) : range;
    }
    ...
    */
    ...
    static final class Companion {
        ...
        public final TransformedText calculateTransformedText(TextFieldCharSequence untransformedValue, OutputTransformation outputTransformation, SelectionWedgeAffinity wedgeAffinity) {
            ...
            TextRange textRangeM6705boximpl = null;
            if (textFieldBuffer.getChanges().getChangeCount() == 0) {
                return null;
            }
            long jM1542mapToTransformedXGyztTk = m1542mapToTransformedXGyztTk(untransformedValue.getSelection(), offsetMappingCalculator, wedgeAffinity);
            TextRange composition = untransformedValue.getComposition();
            if (composition != null) {
                textRangeM6705boximpl = TextRange.m6705boximpl(TransformedTextFieldState.Companion.m1542mapToTransformedXGyztTk(composition.getPackedValue(), offsetMappingCalculator, wedgeAffinity));
            }
            return new TransformedText(textFieldBuffer.m1408toTextFieldCharSequenceudt6zUU$foundation_release(jM1542mapToTransformedXGyztTk, textRangeM6705boximpl), offsetMappingCalculator);
        }
        ...
        public final TransformedText calculateTransformedText(TextFieldCharSequence untransformedValue, CodepointTransformation codepointTransformation, SelectionWedgeAffinity wedgeAffinity) {
            TextRange textRangeM6705boximpl;
            OffsetMappingCalculator offsetMappingCalculator = new OffsetMappingCalculator();
            ...
            return new TransformedText(new TextFieldCharSequence(visualText, jM1542mapToTransformedXGyztTk, textRangeM6705boximpl, null, 8, null), offsetMappingCalculator);
        }
        ...
        public final long m1542mapToTransformedXGyztTk(long range, OffsetMappingCalculator mapping, SelectionWedgeAffinity wedgeAffinity) {
            long jTextRange;
            long jM1484mapFromSourcejx7JFs = mapping.m1484mapFromSourcejx7JFs(TextRange.m6717getStartimpl(range));
            long jM1484mapFromSourcejx7JFs2 = TextRange.m6711getCollapsedimpl(range) ? jM1484mapFromSourcejx7JFs : mapping.m1484mapFromSourcejx7JFs(TextRange.m6712getEndimpl(range));
            int iMin = Math.min(TextRange.m6715getMinimpl(jM1484mapFromSourcejx7JFs), TextRange.m6715getMinimpl(jM1484mapFromSourcejx7JFs2));
            int iMax = Math.max(TextRange.m6714getMaximpl(jM1484mapFromSourcejx7JFs), TextRange.m6714getMaximpl(jM1484mapFromSourcejx7JFs2));
            if (TextRange.m6716getReversedimpl(range)) {
                jTextRange = TextRangeKt.TextRange(iMax, iMin);
            } else {
                jTextRange = TextRangeKt.TextRange(iMin, iMax);
            }
            if (!TextRange.m6711getCollapsedimpl(range) || TextRange.m6711getCollapsedimpl(jTextRange)) {
                return jTextRange;
            }
            ...
            if (i == 1) {
                return TextRangeKt.TextRange(TextRange.m6717getStartimpl(jTextRange));
            }
            if (i == 2) {
                return TextRangeKt.TextRange(TextRange.m6712getEndimpl(jTextRange));
            }
        ...
        public final long m1541mapFromTransformedxdX6G0(long range, OffsetMappingCalculator mapping) {
            long jM1483mapFromDestjx7JFs = mapping.m1483mapFromDestjx7JFs(TextRange.m6717getStartimpl(range));
            long jM1483mapFromDestjx7JFs2 = TextRange.m6711getCollapsedimpl(range) ? jM1483mapFromDestjx7JFs : mapping.m1483mapFromDestjx7JFs(TextRange.m6712getEndimpl(range));
            int iMin = Math.min(TextRange.m6715getMinimpl(jM1483mapFromDestjx7JFs), TextRange.m6715getMinimpl(jM1483mapFromDestjx7JFs2));
            int iMax = Math.max(TextRange.m6714getMaximpl(jM1483mapFromDestjx7JFs), TextRange.m6714getMaximpl(jM1483mapFromDestjx7JFs2));
            if (TextRange.m6716getReversedimpl(range)) {
