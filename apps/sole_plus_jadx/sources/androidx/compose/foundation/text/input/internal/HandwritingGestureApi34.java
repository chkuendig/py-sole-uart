...
public final class HandwritingGestureApi34 {
    ...
    private final int performSelectGesture(TransformedTextFieldState transformedTextFieldState, SelectGesture selectGesture, TextLayoutState textLayoutState) {
        long jM1474getRangeForScreenRectOH9lIzo = HandwritingGesture_androidKt.m1474getRangeForScreenRectOH9lIzo(textLayoutState, RectHelper_androidKt.toComposeRect(selectGesture.getSelectionArea()), m1456toTextGranularityNUwxegE(selectGesture.getGranularity()), TextInclusionStrategy.INSTANCE.getContainsCenter());
        ...
        transformedTextFieldState.m1537selectCharsIn5zctL8(jM1474getRangeForScreenRectOH9lIzo);
        return 1;
    }
    ...
    private final void previewSelectGesture(TransformedTextFieldState transformedTextFieldState, SelectGesture selectGesture, TextLayoutState textLayoutState) {
        m1452highlightRangeXJREzCE(transformedTextFieldState, HandwritingGesture_androidKt.m1474getRangeForScreenRectOH9lIzo(textLayoutState, RectHelper_androidKt.toComposeRect(selectGesture.getSelectionArea()), m1456toTextGranularityNUwxegE(selectGesture.getGranularity()), TextInclusionStrategy.INSTANCE.getContainsCenter()), TextHighlightType.INSTANCE.m1425getHandwritingSelectPreviewsxJuwY());
    }
    ...
    private final int performDeleteGesture(TransformedTextFieldState transformedTextFieldState, DeleteGesture deleteGesture, TextLayoutState textLayoutState) {
        int iM1456toTextGranularityNUwxegE = m1456toTextGranularityNUwxegE(deleteGesture.getGranularity());
        long jM1474getRangeForScreenRectOH9lIzo = HandwritingGesture_androidKt.m1474getRangeForScreenRectOH9lIzo(textLayoutState, RectHelper_androidKt.toComposeRect(deleteGesture.getDeletionArea()), iM1456toTextGranularityNUwxegE, TextInclusionStrategy.INSTANCE.getContainsCenter());
        if (TextRange.m6711getCollapsedimpl(jM1474getRangeForScreenRectOH9lIzo)) {
            return INSTANCE.fallback(transformedTextFieldState, deleteGesture);
        }
        m1453performDeletionSbBc2M(transformedTextFieldState, jM1474getRangeForScreenRectOH9lIzo, TextGranularity.m6675equalsimpl0(iM1456toTextGranularityNUwxegE, TextGranularity.INSTANCE.m6680getWordDRrd7Zo()));
        return 1;
    }
    ...
    private final void previewDeleteGesture(TransformedTextFieldState transformedTextFieldState, DeleteGesture deleteGesture, TextLayoutState textLayoutState) {
        m1452highlightRangeXJREzCE(transformedTextFieldState, HandwritingGesture_androidKt.m1474getRangeForScreenRectOH9lIzo(textLayoutState, RectHelper_androidKt.toComposeRect(deleteGesture.getDeletionArea()), m1456toTextGranularityNUwxegE(deleteGesture.getGranularity()), TextInclusionStrategy.INSTANCE.getContainsCenter()), TextHighlightType.INSTANCE.m1424getHandwritingDeletePreviewsxJuwY());
    }
    ...
    private final void previewSelectRangeGesture(TransformedTextFieldState transformedTextFieldState, SelectRangeGesture selectRangeGesture, TextLayoutState textLayoutState) {
        m1452highlightRangeXJREzCE(transformedTextFieldState, HandwritingGesture_androidKt.m1476getRangeForScreenRectsO048IG0(textLayoutState, RectHelper_androidKt.toComposeRect(selectRangeGesture.getSelectionStartArea()), RectHelper_androidKt.toComposeRect(selectRangeGesture.getSelectionEndArea()), m1456toTextGranularityNUwxegE(selectRangeGesture.getGranularity()), TextInclusionStrategy.INSTANCE.getContainsCenter()), TextHighlightType.INSTANCE.m1425getHandwritingSelectPreviewsxJuwY());
    }
    ...
    private final int performDeleteRangeGesture(TransformedTextFieldState transformedTextFieldState, DeleteRangeGesture deleteRangeGesture, TextLayoutState textLayoutState) {
        int iM1456toTextGranularityNUwxegE = m1456toTextGranularityNUwxegE(deleteRangeGesture.getGranularity());
        long jM1476getRangeForScreenRectsO048IG0 = HandwritingGesture_androidKt.m1476getRangeForScreenRectsO048IG0(textLayoutState, RectHelper_androidKt.toComposeRect(deleteRangeGesture.getDeletionStartArea()), RectHelper_androidKt.toComposeRect(deleteRangeGesture.getDeletionEndArea()), iM1456toTextGranularityNUwxegE, TextInclusionStrategy.INSTANCE.getContainsCenter());
        if (TextRange.m6711getCollapsedimpl(jM1476getRangeForScreenRectsO048IG0)) {
            return INSTANCE.fallback(transformedTextFieldState, deleteRangeGesture);
        }
        m1453performDeletionSbBc2M(transformedTextFieldState, jM1476getRangeForScreenRectsO048IG0, TextGranularity.m6675equalsimpl0(iM1456toTextGranularityNUwxegE, TextGranularity.INSTANCE.m6680getWordDRrd7Zo()));
        return 1;
    }
    ...
    private final void previewDeleteRangeGesture(TransformedTextFieldState transformedTextFieldState, DeleteRangeGesture deleteRangeGesture, TextLayoutState textLayoutState) {
        m1452highlightRangeXJREzCE(transformedTextFieldState, HandwritingGesture_androidKt.m1476getRangeForScreenRectsO048IG0(textLayoutState, RectHelper_androidKt.toComposeRect(deleteRangeGesture.getDeletionStartArea()), RectHelper_androidKt.toComposeRect(deleteRangeGesture.getDeletionEndArea()), m1456toTextGranularityNUwxegE(deleteRangeGesture.getGranularity()), TextInclusionStrategy.INSTANCE.getContainsCenter()), TextHighlightType.INSTANCE.m1424getHandwritingDeletePreviewsxJuwY());
    }
    ...
    private final int performJoinOrSplitGesture(TransformedTextFieldState transformedTextFieldState, JoinOrSplitGesture joinOrSplitGesture, TextLayoutState textLayoutState, ViewConfiguration viewConfiguration) {
        ...
        int iM1469getOffsetForHandwritingGestured4ec7I = HandwritingGesture_androidKt.m1469getOffsetForHandwritingGestured4ec7I(textLayoutState, HandwritingGesture_androidKt.toOffset(joinOrSplitGesture.getJoinOrSplitPoint()), viewConfiguration);
        if (iM1469getOffsetForHandwritingGestured4ec7I != -1 && ((layoutResult = textLayoutState.getLayoutResult()) == null || !HandwritingGesture_androidKt.isBiDiBoundary(layoutResult, iM1469getOffsetForHandwritingGestured4ec7I))) {
            long jRangeOfWhitespaces = HandwritingGesture_androidKt.rangeOfWhitespaces(transformedTextFieldState.getVisualText(), iM1469getOffsetForHandwritingGestured4ec7I);
            if (TextRange.m6711getCollapsedimpl(jRangeOfWhitespaces)) {
                TransformedTextFieldState.m1530replaceTextM8tDOmk$default(transformedTextFieldState, " ", jRangeOfWhitespaces, null, false, 12, null);
            } else {
                m1453performDeletionSbBc2M(transformedTextFieldState, jRangeOfWhitespaces, false);
            }
            return 1;
        }
    ...
    private final int performInsertGesture(TransformedTextFieldState transformedTextFieldState, InsertGesture insertGesture, TextLayoutState textLayoutState, ViewConfiguration viewConfiguration) {
        int iM1469getOffsetForHandwritingGestured4ec7I = HandwritingGesture_androidKt.m1469getOffsetForHandwritingGestured4ec7I(textLayoutState, HandwritingGesture_androidKt.toOffset(insertGesture.getInsertionPoint()), viewConfiguration);
        if (iM1469getOffsetForHandwritingGestured4ec7I == -1) {
            return fallback(transformedTextFieldState, insertGesture);
        }
        TransformedTextFieldState.m1530replaceTextM8tDOmk$default(transformedTextFieldState, insertGesture.getTextToInsert(), TextRangeKt.TextRange(iM1469getOffsetForHandwritingGestured4ec7I), null, false, 12, null);
        return 1;
    }
    ...
    private final int performRemoveSpaceGesture(TransformedTextFieldState transformedTextFieldState, RemoveSpaceGesture removeSpaceGesture, TextLayoutState textLayoutState, ViewConfiguration viewConfiguration) {
        long jM1471getRangeForRemoveSpaceGesture5iVPX68 = HandwritingGesture_androidKt.m1471getRangeForRemoveSpaceGesture5iVPX68(textLayoutState.getLayoutResult(), HandwritingGesture_androidKt.toOffset(removeSpaceGesture.getStartPoint()), HandwritingGesture_androidKt.toOffset(removeSpaceGesture.getEndPoint()), textLayoutState.getTextLayoutNodeCoordinates(), viewConfiguration);
        if (TextRange.m6711getCollapsedimpl(jM1471getRangeForRemoveSpaceGesture5iVPX68)) {
        ...
        intRef2.element = -1;
        String strReplace = new Regex("\\s+").replace(TextRangeKt.m6724substringFDrldGo(transformedTextFieldState.getVisualText(), jM1471getRangeForRemoveSpaceGesture5iVPX68), new Function1<MatchResult, CharSequence>() { // from class: androidx.compose.foundation.text.input.internal.HandwritingGestureApi34$performRemoveSpaceGesture$newText$1
        ...
        long jTextRange = TextRangeKt.TextRange(TextRange.m6717getStartimpl(jM1471getRangeForRemoveSpaceGesture5iVPX68) + intRef.element, TextRange.m6717getStartimpl(jM1471getRangeForRemoveSpaceGesture5iVPX68) + intRef2.element);
        String strSubstring = strReplace.substring(intRef.element, strReplace.length() - (TextRange.m6713getLengthimpl(jM1471getRangeForRemoveSpaceGesture5iVPX68) - intRef2.element));
        Intrinsics.checkNotNullExpressionValue(strSubstring, "this as java.lang.String…ing(startIndex, endIndex)");
        TransformedTextFieldState.m1530replaceTextM8tDOmk$default(transformedTextFieldState, strSubstring, jTextRange, null, false, 12, null);
        return 1;
    }
    ...
    private final void m1452highlightRangeXJREzCE(TransformedTextFieldState transformedTextFieldState, long j, int i) {
        if (TextRange.m6711getCollapsedimpl(j)) {
    ...
    private final int performSelectGesture(LegacyTextFieldState legacyTextFieldState, SelectGesture selectGesture, TextFieldSelectionManager textFieldSelectionManager, Function1<? super EditCommand, Unit> function1) {
        long jM1473getRangeForScreenRectOH9lIzo = HandwritingGesture_androidKt.m1473getRangeForScreenRectOH9lIzo(legacyTextFieldState, RectHelper_androidKt.toComposeRect(selectGesture.getSelectionArea()), m1456toTextGranularityNUwxegE(selectGesture.getGranularity()), TextInclusionStrategy.INSTANCE.getContainsCenter());
        ...
        m1455performSelectionOnLegacyTextField8ffj60Q(jM1473getRangeForScreenRectOH9lIzo, textFieldSelectionManager, function1);
        return 1;
    }
    ...
    private final void previewSelectGesture(LegacyTextFieldState legacyTextFieldState, SelectGesture selectGesture, TextFieldSelectionManager textFieldSelectionManager) {
        if (textFieldSelectionManager != null) {
            textFieldSelectionManager.m1708setSelectionPreviewHighlight5zctL8$foundation_release(HandwritingGesture_androidKt.m1473getRangeForScreenRectOH9lIzo(legacyTextFieldState, RectHelper_androidKt.toComposeRect(selectGesture.getSelectionArea()), m1456toTextGranularityNUwxegE(selectGesture.getGranularity()), TextInclusionStrategy.INSTANCE.getContainsCenter()));
        }
    }
    ...
    private final int performDeleteGesture(LegacyTextFieldState legacyTextFieldState, DeleteGesture deleteGesture, AnnotatedString annotatedString, Function1<? super EditCommand, Unit> function1) {
        int iM1456toTextGranularityNUwxegE = m1456toTextGranularityNUwxegE(deleteGesture.getGranularity());
        long jM1473getRangeForScreenRectOH9lIzo = HandwritingGesture_androidKt.m1473getRangeForScreenRectOH9lIzo(legacyTextFieldState, RectHelper_androidKt.toComposeRect(deleteGesture.getDeletionArea()), iM1456toTextGranularityNUwxegE, TextInclusionStrategy.INSTANCE.getContainsCenter());
        if (TextRange.m6711getCollapsedimpl(jM1473getRangeForScreenRectOH9lIzo)) {
            return INSTANCE.fallbackOnLegacyTextField(deleteGesture, function1);
        }
        m1454performDeletionOnLegacyTextFieldvJH6DeI(jM1473getRangeForScreenRectOH9lIzo, annotatedString, TextGranularity.m6675equalsimpl0(iM1456toTextGranularityNUwxegE, TextGranularity.INSTANCE.m6680getWordDRrd7Zo()), function1);
        return 1;
    }
    ...
    private final void previewDeleteGesture(LegacyTextFieldState legacyTextFieldState, DeleteGesture deleteGesture, TextFieldSelectionManager textFieldSelectionManager) {
        if (textFieldSelectionManager != null) {
            textFieldSelectionManager.m1707setDeletionPreviewHighlight5zctL8$foundation_release(HandwritingGesture_androidKt.m1473getRangeForScreenRectOH9lIzo(legacyTextFieldState, RectHelper_androidKt.toComposeRect(deleteGesture.getDeletionArea()), m1456toTextGranularityNUwxegE(deleteGesture.getGranularity()), TextInclusionStrategy.INSTANCE.getContainsCenter()));
        }
    }
    ...
    private final int performSelectRangeGesture(LegacyTextFieldState legacyTextFieldState, SelectRangeGesture selectRangeGesture, TextFieldSelectionManager textFieldSelectionManager, Function1<? super EditCommand, Unit> function1) {
        long jM1475getRangeForScreenRectsO048IG0 = HandwritingGesture_androidKt.m1475getRangeForScreenRectsO048IG0(legacyTextFieldState, RectHelper_androidKt.toComposeRect(selectRangeGesture.getSelectionStartArea()), RectHelper_androidKt.toComposeRect(selectRangeGesture.getSelectionEndArea()), m1456toTextGranularityNUwxegE(selectRangeGesture.getGranularity()), TextInclusionStrategy.INSTANCE.getContainsCenter());
        if (TextRange.m6711getCollapsedimpl(jM1475getRangeForScreenRectsO048IG0)) {
            return INSTANCE.fallbackOnLegacyTextField(selectRangeGesture, function1);
        }
        m1455performSelectionOnLegacyTextField8ffj60Q(jM1475getRangeForScreenRectsO048IG0, textFieldSelectionManager, function1);
        return 1;
    }
    ...
    private final void previewSelectRangeGesture(LegacyTextFieldState legacyTextFieldState, SelectRangeGesture selectRangeGesture, TextFieldSelectionManager textFieldSelectionManager) {
        if (textFieldSelectionManager != null) {
            textFieldSelectionManager.m1708setSelectionPreviewHighlight5zctL8$foundation_release(HandwritingGesture_androidKt.m1475getRangeForScreenRectsO048IG0(legacyTextFieldState, RectHelper_androidKt.toComposeRect(selectRangeGesture.getSelectionStartArea()), RectHelper_androidKt.toComposeRect(selectRangeGesture.getSelectionEndArea()), m1456toTextGranularityNUwxegE(selectRangeGesture.getGranularity()), TextInclusionStrategy.INSTANCE.getContainsCenter()));
        }
    }
    ...
    private final int performDeleteRangeGesture(LegacyTextFieldState legacyTextFieldState, DeleteRangeGesture deleteRangeGesture, AnnotatedString annotatedString, Function1<? super EditCommand, Unit> function1) {
        int iM1456toTextGranularityNUwxegE = m1456toTextGranularityNUwxegE(deleteRangeGesture.getGranularity());
        long jM1475getRangeForScreenRectsO048IG0 = HandwritingGesture_androidKt.m1475getRangeForScreenRectsO048IG0(legacyTextFieldState, RectHelper_androidKt.toComposeRect(deleteRangeGesture.getDeletionStartArea()), RectHelper_androidKt.toComposeRect(deleteRangeGesture.getDeletionEndArea()), iM1456toTextGranularityNUwxegE, TextInclusionStrategy.INSTANCE.getContainsCenter());
        if (TextRange.m6711getCollapsedimpl(jM1475getRangeForScreenRectsO048IG0)) {
            return INSTANCE.fallbackOnLegacyTextField(deleteRangeGesture, function1);
        }
        m1454performDeletionOnLegacyTextFieldvJH6DeI(jM1475getRangeForScreenRectsO048IG0, annotatedString, TextGranularity.m6675equalsimpl0(iM1456toTextGranularityNUwxegE, TextGranularity.INSTANCE.m6680getWordDRrd7Zo()), function1);
        return 1;
    }
    ...
    private final void previewDeleteRangeGesture(LegacyTextFieldState legacyTextFieldState, DeleteRangeGesture deleteRangeGesture, TextFieldSelectionManager textFieldSelectionManager) {
        if (textFieldSelectionManager != null) {
            textFieldSelectionManager.m1707setDeletionPreviewHighlight5zctL8$foundation_release(HandwritingGesture_androidKt.m1475getRangeForScreenRectsO048IG0(legacyTextFieldState, RectHelper_androidKt.toComposeRect(deleteRangeGesture.getDeletionStartArea()), RectHelper_androidKt.toComposeRect(deleteRangeGesture.getDeletionEndArea()), m1456toTextGranularityNUwxegE(deleteRangeGesture.getGranularity()), TextInclusionStrategy.INSTANCE.getContainsCenter()));
        }
    }
    ...
    private final int performJoinOrSplitGesture(LegacyTextFieldState legacyTextFieldState, JoinOrSplitGesture joinOrSplitGesture, AnnotatedString annotatedString, ViewConfiguration viewConfiguration, Function1<? super EditCommand, Unit> function1) {
        ...
        if (viewConfiguration != null) {
            int iM1468getOffsetForHandwritingGestured4ec7I = HandwritingGesture_androidKt.m1468getOffsetForHandwritingGestured4ec7I(legacyTextFieldState, HandwritingGesture_androidKt.toOffset(joinOrSplitGesture.getJoinOrSplitPoint()), viewConfiguration);
            if (iM1468getOffsetForHandwritingGestured4ec7I != -1 && ((layoutResult = legacyTextFieldState.getLayoutResult()) == null || (value = layoutResult.getValue()) == null || !HandwritingGesture_androidKt.isBiDiBoundary(value, iM1468getOffsetForHandwritingGestured4ec7I))) {
                long jRangeOfWhitespaces = HandwritingGesture_androidKt.rangeOfWhitespaces(annotatedString, iM1468getOffsetForHandwritingGestured4ec7I);
                if (TextRange.m6711getCollapsedimpl(jRangeOfWhitespaces)) {
                    performInsertionOnLegacyTextField(TextRange.m6717getStartimpl(jRangeOfWhitespaces), " ", function1);
                } else {
                    m1454performDeletionOnLegacyTextFieldvJH6DeI(jRangeOfWhitespaces, annotatedString, false, function1);
                }
                return 1;
            }
    ...
    private final int performInsertGesture(LegacyTextFieldState legacyTextFieldState, InsertGesture insertGesture, ViewConfiguration viewConfiguration, Function1<? super EditCommand, Unit> function1) {
        ...
        TextLayoutResult value;
        if (viewConfiguration != null) {
            int iM1468getOffsetForHandwritingGestured4ec7I = HandwritingGesture_androidKt.m1468getOffsetForHandwritingGestured4ec7I(legacyTextFieldState, HandwritingGesture_androidKt.toOffset(insertGesture.getInsertionPoint()), viewConfiguration);
            if (iM1468getOffsetForHandwritingGestured4ec7I == -1 || ((layoutResult = legacyTextFieldState.getLayoutResult()) != null && (value = layoutResult.getValue()) != null && HandwritingGesture_androidKt.isBiDiBoundary(value, iM1468getOffsetForHandwritingGestured4ec7I))) {
                return fallbackOnLegacyTextField(insertGesture, function1);
            }
            performInsertionOnLegacyTextField(iM1468getOffsetForHandwritingGestured4ec7I, insertGesture.getTextToInsert(), function1);
            return 1;
        }
        return fallbackOnLegacyTextField(insertGesture, function1);
    }
    ...
    private final int performRemoveSpaceGesture(LegacyTextFieldState legacyTextFieldState, RemoveSpaceGesture removeSpaceGesture, AnnotatedString annotatedString, ViewConfiguration viewConfiguration, Function1<? super EditCommand, Unit> function1) {
        ...
        final Ref.IntRef intRef2 = new Ref.IntRef();
        intRef2.element = -1;
        String strReplace = new Regex("\\s+").replace(TextRangeKt.m6724substringFDrldGo(annotatedString, jM1471getRangeForRemoveSpaceGesture5iVPX68), new Function1<MatchResult, CharSequence>() { // from class: androidx.compose.foundation.text.input.internal.HandwritingGestureApi34$performRemoveSpaceGesture$newText$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
        ...
        int iM6717getStartimpl = TextRange.m6717getStartimpl(jM1471getRangeForRemoveSpaceGesture5iVPX68) + intRef.element;
        int iM6717getStartimpl2 = TextRange.m6717getStartimpl(jM1471getRangeForRemoveSpaceGesture5iVPX68) + intRef2.element;
        String strSubstring = strReplace.substring(intRef.element, strReplace.length() - (TextRange.m6713getLengthimpl(jM1471getRangeForRemoveSpaceGesture5iVPX68) - intRef2.element));
        Intrinsics.checkNotNullExpressionValue(strSubstring, "this as java.lang.String…ing(startIndex, endIndex)");
        function1.invoke(HandwritingGesture_androidKt.compoundEditCommand(new SetSelectionCommand(iM6717getStartimpl, iM6717getStartimpl2), new CommitTextCommand(strSubstring, 1)));
        return 1;
    }
    ...
    private final void m1455performSelectionOnLegacyTextField8ffj60Q(long range, TextFieldSelectionManager textSelectionManager, Function1<? super EditCommand, Unit> editCommandConsumer) {
        editCommandConsumer.invoke(new SetSelectionCommand(TextRange.m6717getStartimpl(range), TextRange.m6712getEndimpl(range)));
    ...
    private final void m1454performDeletionOnLegacyTextFieldvJH6DeI(long range, AnnotatedString text, boolean adjustRange, Function1<? super EditCommand, Unit> editCommandConsumer) {
        ...
        editCommandConsumer.invoke(HandwritingGesture_androidKt.compoundEditCommand(new SetSelectionCommand(TextRange.m6712getEndimpl(range), TextRange.m6712getEndimpl(range)), new DeleteSurroundingTextCommand(TextRange.m6713getLengthimpl(range), 0)));
    }
    ...
    private final int m1456toTextGranularityNUwxegE(int i) {
        if (i == 1) {
            return TextGranularity.INSTANCE.m6680getWordDRrd7Zo();
        }
        if (i == 2) {
            return TextGranularity.INSTANCE.m6679getCharacterDRrd7Zo();
        }
        return TextGranularity.INSTANCE.m6679getCharacterDRrd7Zo();
    }
