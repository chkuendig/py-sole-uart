...
public final class TextFieldCoreModifierNode extends DelegatingNode implements LayoutModifierNode, DrawModifierNode, CompositionLocalConsumerModifierNode, GlobalPositionAwareModifierNode, SemanticsModifierNode {
    ...
    private final MeasureResult m1502measureVerticalScroll3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        final Placeable placeableMo5957measureBRTryo0 = measurable.mo5957measureBRTryo0(Constraints.m7198copyZbe2FdA$default(j, 0, 0, 0, Integer.MAX_VALUE, 7, null));
        final int iMin = Math.min(placeableMo5957measureBRTryo0.getHeight(), Constraints.m7207getMaxHeightimpl(j));
        return MeasureScope.layout$default(measureScope, placeableMo5957measureBRTryo0.getWidth(), iMin, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldCoreModifierNode$measureVerticalScroll$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                this.this$0.m1503updateScrollStatetIlFzwE(measureScope, iMin, placeableMo5957measureBRTryo0.getHeight(), this.this$0.textFieldState.getVisualText().getSelection(), measureScope.getLayoutDirection());
                Placeable.PlacementScope.placeRelative$default(placementScope, placeableMo5957measureBRTryo0, 0, -this.this$0.scrollState.getValue(), 0.0f, 4, null);
            }
        }, 4, null);
    }
    ...
    private final MeasureResult m1501measureHorizontalScroll3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        final Placeable placeableMo5957measureBRTryo0 = measurable.mo5957measureBRTryo0(Constraints.m7198copyZbe2FdA$default(j, 0, Integer.MAX_VALUE, 0, 0, 13, null));
        final int iMin = Math.min(placeableMo5957measureBRTryo0.getWidth(), Constraints.m7208getMaxWidthimpl(j));
        return MeasureScope.layout$default(measureScope, iMin, placeableMo5957measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldCoreModifierNode$measureHorizontalScroll$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Placeable.PlacementScope placementScope) {
                this.this$0.m1503updateScrollStatetIlFzwE(measureScope, iMin, placeableMo5957measureBRTryo0.getWidth(), this.this$0.textFieldState.getVisualText().getSelection(), measureScope.getLayoutDirection());
                Placeable.PlacementScope.placeRelative$default(placementScope, placeableMo5957measureBRTryo0, -this.this$0.scrollState.getValue(), 0, 0.0f, 4, null);
            }
        }, 4, null);
    }
    ...
    private final int m1499calculateOffsetToFollow72CqOWE(long currSelection, int currTextLayoutSize) {
        ...
        if (textRange == null || TextRange.m6712getEndimpl(currSelection) != TextRange.m6712getEndimpl(textRange.getPackedValue())) {
            return TextRange.m6712getEndimpl(currSelection);
        }
        TextRange textRange2 = this.previousSelection;
        if (textRange2 == null || TextRange.m6717getStartimpl(currSelection) != TextRange.m6717getStartimpl(textRange2.getPackedValue())) {
            return TextRange.m6717getStartimpl(currSelection);
        }
    ...
    */
    public final void m1503updateScrollStatetIlFzwE(androidx.compose.ui.unit.Density r9, int r10, int r11, long r12, androidx.compose.ui.unit.LayoutDirection r14) {
        /*
            r8 = this;
            int r0 = r11 - r10
            androidx.compose.foundation.ScrollState r1 = r8.scrollState
            r1.setMaxValue$foundation_release(r0)
            int r0 = r8.m1499calculateOffsetToFollow72CqOWE(r12, r11)
            if (r0 < 0) goto Lca
        ...
        Laa:
            r1 = 0
        Lab:
            androidx.compose.ui.text.TextRange r10 = androidx.compose.ui.text.TextRange.m6705boximpl(r12)
        ...
        Lca:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.input.internal.TextFieldCoreModifierNode.m1503updateScrollStatetIlFzwE(androidx.compose.ui.unit.Density, int, int, long, androidx.compose.ui.unit.LayoutDirection):void");
    }
    ...
    private final void m1500drawSelectionSbBc2M(DrawScope drawScope, long j, TextLayoutResult textLayoutResult) {
        ...
        if (iM6715getMinimpl != iM6714getMaximpl) {
            DrawScope.m5107drawPathLG529CI$default(drawScope, textLayoutResult.getPathForRange(iM6715getMinimpl, iM6714getMaximpl), ((TextSelectionColors) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, TextSelectionColorsKt.getLocalTextSelectionColors())).getBackgroundColor(), 0.0f, null, null, 0, 60, null);
        }
    }
    ...
    private final void drawHighlight(DrawScope drawScope, Pair<TextHighlightType, TextRange> pair, TextLayoutResult textLayoutResult) {
        ...
        if (TextRange.m6711getCollapsedimpl(packedValue)) {
            return;
        }
        Path pathForRange = textLayoutResult.getPathForRange(TextRange.m6715getMinimpl(packedValue), TextRange.m6714getMaximpl(packedValue));
        if (TextHighlightType.m1420equalsimpl0(value, TextHighlightType.INSTANCE.m1424getHandwritingDeletePreviewsxJuwY())) {
            ...
            if (brush != null) {
                DrawScope.m5106drawPathGBMwjPU$default(drawScope, pathForRange, brush, 0.2f, null, null, 0, 56, null);
                return;
            }
            long jM6747getColor0d7_KjU = textLayoutResult.getLayoutInput().getStyle().m6747getColor0d7_KjU();
            if (jM6747getColor0d7_KjU == 16) {
                jM6747getColor0d7_KjU = Color.INSTANCE.m4564getBlack0d7_KjU();
            }
            long j = jM6747getColor0d7_KjU;
            DrawScope.m5107drawPathLG529CI$default(drawScope, pathForRange, Color.m4537copywmQWz5c$default(j, Color.m4540getAlphaimpl(j) * 0.2f, 0.0f, 0.0f, 0.0f, 14, null), 0.0f, null, null, 0, 60, null);
            return;
        }
        DrawScope.m5107drawPathLG529CI$default(drawScope, pathForRange, ((TextSelectionColors) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, TextSelectionColorsKt.getLocalTextSelectionColors())).getBackgroundColor(), 0.0f, null, null, 0, 60, null);
    }
    ...
    private final void drawCursor(DrawScope drawScope) {
        ...
        if (cursorAlpha != 0.0f && getShowCursor()) {
            ...
            DrawScope.m5102drawLine1RTmtNc$default(drawScope, this.cursorBrush, cursorRect.m4328getTopCenterF1C5BW0(), cursorRect.m4321getBottomCenterF1C5BW0(), cursorRect.getWidth(), 0, null, cursorAlpha, null, 0, 432, null);
        }
    }

    /* compiled from: TextFieldCoreModifier.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {1, 8, 0}, xi = 48)
    @DebugMetadata(c = "androidx.compose.foundation.text.input.internal.TextFieldCoreModifierNode$startCursorJob$1", f = "TextFieldCoreModifier.kt", i = {}, l = {WinError.ERROR_INVALID_LDT_OFFSET}, m = "invokeSuspend", n = {}, s = {})
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @DebugMetadata(c = "androidx.compose.foundation.text.input.internal.TextFieldCoreModifierNode$startCursorJob$1$2", f = "TextFieldCoreModifier.kt", i = {}, l = {WinError.ERROR_TOO_MANY_THREADS}, m = "invokeSuspend", n = {}, s = {})
