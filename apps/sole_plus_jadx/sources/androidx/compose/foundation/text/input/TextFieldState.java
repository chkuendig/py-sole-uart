...
public final class TextFieldState {
    ...
    private TextFieldState(String str, long j, TextUndoManager textUndoManager) {
        ...
        this.mainBuffer = new EditingBuffer(str, TextRangeKt.m6723coerceIn8ffj60Q(j, 0, str.length()), (DefaultConstructorMarker) null);
    ...
    public String toString() {
        ...
        try {
            return "TextFieldState(selection=" + ((Object) TextRange.m6720toStringimpl(m1414getSelectiond9O1mEE())) + ", text=\"" + ((Object) getText()) + "\")";
        } finally {
    ...
    public final void commitEdit(TextFieldBuffer newValue) {
        ...
        boolean zM6710equalsimpl0 = true ^ TextRange.m6710equalsimpl0(newValue.getSelectionInChars(), this.mainBuffer.m1446getSelectiond9O1mEE());
        if (z) {
            this.textUndoManager.clearHistory();
        }
        m1415syncMainBufferToTemporaryBufferTS3Rm5k$foundation_release(newValue, null, z, zM6710equalsimpl0);
    }
    ...
    public final void commitEditAsUser(InputTransformation inputTransformation, boolean restartImeIfContentChanges, TextFieldEditUndoBehavior undoBehavior) {
        ...
        if (this.mainBuffer.getChangeTracker().getChangeCount() == 0 && TextRange.m6710equalsimpl0(value$foundation_release.getSelection(), this.mainBuffer.m1446getSelectiond9O1mEE())) {
        ...
        boolean zM6710equalsimpl0 = TextRange.m6710equalsimpl0(textFieldBuffer2.getSelectionInChars(), textFieldCharSequence.getSelection());
        boolean z2 = !zM6710equalsimpl0;
        if (!zContentEquals || !zM6710equalsimpl0) {
    ...
    public final void m1415syncMainBufferToTemporaryBufferTS3Rm5k$foundation_release(TextFieldBuffer textFieldBuffer, TextRange newComposition, boolean textChanged, boolean selectionChanged) {
        ...
        TextFieldCharSequence textFieldCharSequence = new TextFieldCharSequence(string, this.mainBuffer.m1446getSelectiond9O1mEE(), this.mainBuffer.m1445getCompositionMzsxiRA(), null, 8, null);
        boolean zAreEqual = Intrinsics.areEqual(newComposition, this.mainBuffer.m1445getCompositionMzsxiRA());
        if (textChanged) {
            ...
            this.mainBuffer.setSelection(TextRange.m6717getStartimpl(textFieldBuffer.getSelectionInChars()), TextRange.m6712getEndimpl(textFieldBuffer.getSelectionInChars()));
        }
        if (newComposition == null || TextRange.m6711getCollapsedimpl(newComposition.getPackedValue())) {
            this.mainBuffer.commitComposition();
        } else {
            this.mainBuffer.setComposition(TextRange.m6715getMinimpl(newComposition.getPackedValue()), TextRange.m6714getMaximpl(newComposition.getPackedValue()));
        }
        ...
        updateValueAndNotifyListeners(textFieldCharSequence, new TextFieldCharSequence(string, this.mainBuffer.m1446getSelectiond9O1mEE(), this.mainBuffer.m1445getCompositionMzsxiRA(), null, 8, null), true);
    }
    ...
    public static final class Saver implements androidx.compose.runtime.saveable.Saver<TextFieldState, Object> {
        ...
        public Object save(SaverScope saverScope, TextFieldState textFieldState) {
            return CollectionsKt.listOf(textFieldState.getText().toString(), Integer.valueOf(TextRange.m6717getStartimpl(textFieldState.m1414getSelectiond9O1mEE())), Integer.valueOf(TextRange.m6712getEndimpl(textFieldState.m1414getSelectiond9O1mEE())), TextUndoManager.Companion.Saver.INSTANCE.save(saverScope, textFieldState.getTextUndoManager()));
        }
