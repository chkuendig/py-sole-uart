...
public final class TextFieldPreparedSelection {
    ...
    public final void m1559setSelection5zctL8(long j) {
        this.selection = j;
    }

    public final void deleteIfSelectedOr(Function0<TextRange> block) {
        if (!TextRange.m6711getCollapsedimpl(getSelection())) {
            TransformedTextFieldState.m1530replaceTextM8tDOmk$default(this.state, "", getSelection(), null, !this.isFromSoftKeyboard, 4, null);
            return;
        }
        TextRange textRangeInvoke = block.invoke();
        if (textRangeInvoke != null) {
            TransformedTextFieldState.m1530replaceTextM8tDOmk$default(this.state, "", textRangeInvoke.getPackedValue(), null, !this.isFromSoftKeyboard, 4, null);
        }
    }

    private final int jumpByPagesOffset(int pagesAmount) {
        int iM6712getEndimpl = TextRange.m6712getEndimpl(this.initialValue.getSelection());
        if (this.textLayoutResult == null || Float.isNaN(this.visibleTextLayoutHeight)) {
            return iM6712getEndimpl;
        }
        Rect rectTranslate = this.textLayoutResult.getCursorRect(iM6712getEndimpl).translate(0.0f, this.visibleTextLayoutHeight * pagesAmount);
        ...
        if (Math.abs(rectTranslate.getTop() - lineBottom) > Math.abs(rectTranslate.getBottom() - lineBottom)) {
            return this.textLayoutResult.m6687getOffsetForPositionk4lQ0M(rectTranslate.m4329getTopLeftF1C5BW0());
        }
        return this.textLayoutResult.m6687getOffsetForPositionk4lQ0M(rectTranslate.m4322getBottomLeftF1C5BW0());
    }
    ...
    public final int getPrecedingCharacterIndex() {
        return StringHelpers_androidKt.findPrecedingBreak(this.text, TextRange.m6712getEndimpl(this.selection));
    }

    public final int getNextCharacterIndex() {
        return StringHelpers_androidKt.findFollowingBreak(this.text, TextRange.m6712getEndimpl(this.selection));
    }
    ...
    private final boolean isLtr() {
        ...
        TextLayoutResult textLayoutResult = this.textLayoutResult;
        return textLayoutResult == null || (paragraphDirection = textLayoutResult.getParagraphDirection(TextRange.m6712getEndimpl(this.selection))) == null || paragraphDirection == ResolvedTextDirection.Ltr;
    }
    ...
    static /* synthetic */ int getNextWordOffsetForLayout$default(TextFieldPreparedSelection textFieldPreparedSelection, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.m6712getEndimpl(textFieldPreparedSelection.selection);
        }
    ...
    private final int getNextWordOffsetForLayout(TextLayoutResult textLayoutResult, int i) {
        while (i < this.initialValue.length()) {
            long jM6689getWordBoundaryjx7JFs = textLayoutResult.m6689getWordBoundaryjx7JFs(charOffset(i));
            if (TextRange.m6712getEndimpl(jM6689getWordBoundaryjx7JFs) > i) {
                return TextRange.m6712getEndimpl(jM6689getWordBoundaryjx7JFs);
            }
            i++;
        }
    ...
    private final int getPrevWordOffsetForLayout(TextLayoutResult textLayoutResult, int i) {
        while (i > 0) {
            long jM6689getWordBoundaryjx7JFs = textLayoutResult.m6689getWordBoundaryjx7JFs(charOffset(i));
            if (TextRange.m6717getStartimpl(jM6689getWordBoundaryjx7JFs) < i) {
                return TextRange.m6717getStartimpl(jM6689getWordBoundaryjx7JFs);
            }
            i--;
        }
        return 0;
    ...
    static /* synthetic */ int getLineStartByOffsetForLayout$default(TextFieldPreparedSelection textFieldPreparedSelection, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.m6715getMinimpl(textFieldPreparedSelection.selection);
        }
    ...
    static /* synthetic */ int getLineEndByOffsetForLayout$default(TextFieldPreparedSelection textFieldPreparedSelection, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.m6714getMaximpl(textFieldPreparedSelection.selection);
        }
    ...
    private final int jumpByLinesOffset(TextLayoutResult textLayoutResult, int i) {
        int iM6712getEndimpl = TextRange.m6712getEndimpl(this.selection);
        if (Float.isNaN(this.textPreparedSelectionState.getCachedX())) {
            this.textPreparedSelectionState.setCachedX(textLayoutResult.getCursorRect(iM6712getEndimpl).getLeft());
        }
        int lineForOffset = textLayoutResult.getLineForOffset(iM6712getEndimpl) + i;
        if (lineForOffset < 0) {
            return 0;
        }
        ...
        return textLayoutResult.m6687getOffsetForPositionk4lQ0M(OffsetKt.Offset(cachedX, lineBottom));
    }
    ...
    public final TextFieldPreparedSelection deselect() {
        this.textPreparedSelectionState.resetCachedX();
        if (this.text.length() > 0) {
            setCursor(TextRange.m6712getEndimpl(this.selection));
        }
        return this;
    }
    ...
    public final TextFieldPreparedSelection collapseLeftOr(Function1<? super TextFieldPreparedSelection, Unit> or) {
        this.textPreparedSelectionState.resetCachedX();
        if (this.text.length() > 0) {
            if (TextRange.m6711getCollapsedimpl(this.selection)) {
                or.invoke(this);
            } else if (isLtr()) {
                setCursor(TextRange.m6715getMinimpl(this.selection));
            } else {
                setCursor(TextRange.m6714getMaximpl(this.selection));
            }
        }
        return this;
    }
    ...
    private final TextFieldPreparedSelection moveCursorPrev() {
        ...
        this.textPreparedSelectionState.resetCachedX();
        if (this.text.length() > 0 && (iCalculateAdjacentCursorPosition = TextPreparedSelectionKt.calculateAdjacentCursorPosition(this.text, (iM6712getEndimpl = TextRange.m6712getEndimpl(this.selection)), false, this.state)) != iM6712getEndimpl) {
    ...
    private final TextFieldPreparedSelection moveCursorNext() {
        ...
        int iCalculateAdjacentCursorPosition;
        this.textPreparedSelectionState.resetCachedX();
        if (this.text.length() > 0 && (iCalculateAdjacentCursorPosition = TextPreparedSelectionKt.calculateAdjacentCursorPosition(this.text, (iM6712getEndimpl = TextRange.m6712getEndimpl(this.selection)), true, this.state)) != iM6712getEndimpl) {
            setCursor(iCalculateAdjacentCursorPosition);
        }
        return this;
    }
    ...
    public final TextFieldPreparedSelection moveCursorPrevByParagraph() {
        this.textPreparedSelectionState.resetCachedX();
        if (this.text.length() > 0) {
            int iFindParagraphStart = StringHelpersKt.findParagraphStart(this.text, TextRange.m6715getMinimpl(this.selection));
            if (iFindParagraphStart == TextRange.m6715getMinimpl(this.selection) && iFindParagraphStart != 0) {
    ...
    public final TextFieldPreparedSelection moveCursorNextByParagraph() {
        this.textPreparedSelectionState.resetCachedX();
        if (this.text.length() > 0) {
            int iFindParagraphEnd = StringHelpersKt.findParagraphEnd(this.text, TextRange.m6714getMaximpl(this.selection));
            if (iFindParagraphEnd == TextRange.m6714getMaximpl(this.selection) && iFindParagraphEnd != this.text.length()) {
    ...
    public final TextFieldPreparedSelection selectMovement() {
        if (this.text.length() > 0) {
            this.selection = TextRangeKt.TextRange(TextRange.m6717getStartimpl(this.initialValue.getSelection()), TextRange.m6712getEndimpl(this.selection));
        }
        return this;
    }
}
