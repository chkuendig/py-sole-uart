...
public final class TextUndoManagerKt {
    ...
    public static final void recordChanges(TextUndoManager textUndoManager, TextFieldCharSequence textFieldCharSequence, TextFieldCharSequence textFieldCharSequence2, TextFieldBuffer.ChangeList changeList, boolean z) {
        ...
        if (changeList.getChangeCount() == 1) {
            long jMo1409getOriginalRangejx7JFs = changeList.mo1409getOriginalRangejx7JFs(0);
            long jMo1410getRangejx7JFs = changeList.mo1410getRangejx7JFs(0);
            if (TextRange.m6711getCollapsedimpl(jMo1409getOriginalRangejx7JFs) && TextRange.m6711getCollapsedimpl(jMo1410getRangejx7JFs)) {
                return;
            }
            textUndoManager.record(new TextUndoOperation(TextRange.m6715getMinimpl(jMo1409getOriginalRangejx7JFs), TextRangeKt.m6724substringFDrldGo(textFieldCharSequence, jMo1409getOriginalRangejx7JFs), TextRangeKt.m6724substringFDrldGo(textFieldCharSequence2, jMo1410getRangejx7JFs), textFieldCharSequence.getSelection(), textFieldCharSequence2.getSelection(), 0L, z, 32, null));
        }
    }
