...
public final class TextFieldSelectionState {
    ...
    private final MutableState startTextLayoutPositionInWindow = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m4283boximpl(Offset.INSTANCE.m4309getUnspecifiedF1C5BW0()), null, 2, null);

    /* renamed from: rawHandleDragPosition$delegate, reason: from kotlin metadata */
    private final MutableState rawHandleDragPosition = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m4283boximpl(Offset.INSTANCE.m4309getUnspecifiedF1C5BW0()), null, 2, null);
    ...
    /* compiled from: TextFieldSelectionState.kt */
    @Metadata(k = 3, mv = {1, 8, 0}, xi = 48)
    @DebugMetadata(c = "androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState", f = "TextFieldSelectionState.kt", i = {0, 0, 0}, l = {WinError.ERROR_NO_CALLBACK_ACTIVE}, m = "detectCursorHandleDragGestures", n = {"this", "cursorDragStart", "cursorDragDelta"}, s = {"L$0", "L$1", "L$2"})
    ...
    /* compiled from: TextFieldSelectionState.kt */
    @Metadata(k = 3, mv = {1, 8, 0}, xi = 48)
    @DebugMetadata(c = "androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState", f = "TextFieldSelectionState.kt", i = {0, 0, 0, 0}, l = {980}, m = "detectSelectionHandleDragGestures", n = {"this", "dragBeginPosition", "dragTotalDistance", SdkConstants.ATTR_HANDLE}, s = {"L$0", "L$1", "L$2", "L$3"})
    ...
    private final long m1566getStartTextLayoutPositionInWindowF1C5BW0() {
        return ((Offset) this.startTextLayoutPositionInWindow.getValue()).m4304unboximpl();
    }
    ...
    private final void m1570setStartTextLayoutPositionInWindowk4lQ0M(long j) {
        this.startTextLayoutPositionInWindow.setValue(Offset.m4283boximpl(j));
    }
    ...
    private final long m1563getCurrentTextLayoutPositionInWindowF1C5BW0() {
        ...
        return textLayoutCoordinates != null ? LayoutCoordinatesKt.positionInWindow(textLayoutCoordinates) : Offset.INSTANCE.m4309getUnspecifiedF1C5BW0();
    }
    ...
    private final long m1565getRawHandleDragPositionF1C5BW0() {
        return ((Offset) this.rawHandleDragPosition.getValue()).m4304unboximpl();
    }
    ...
    private final void m1569setRawHandleDragPositionk4lQ0M(long j) {
        this.rawHandleDragPosition.setValue(Offset.m4283boximpl(j));
    }

    /* renamed from: getHandleDragPosition-F1C5BW0, reason: not valid java name */
    public final long m1573getHandleDragPositionF1C5BW0() {
        if (OffsetKt.m4315isUnspecifiedk4lQ0M(m1565getRawHandleDragPositionF1C5BW0())) {
            return Offset.INSTANCE.m4309getUnspecifiedF1C5BW0();
        }
        if (OffsetKt.m4315isUnspecifiedk4lQ0M(m1566getStartTextLayoutPositionInWindowF1C5BW0())) {
        ...
        return Offset.m4299plusMKHz9U(m1565getRawHandleDragPositionF1C5BW0(), Offset.m4298minusMKHz9U(m1566getStartTextLayoutPositionInWindowF1C5BW0(), m1563getCurrentTextLayoutPositionInWindowF1C5BW0()));
    }
    ...
    public final TextFieldHandleState getCursorHandleState$foundation_release(boolean includePosition) {
        ...
        if (!showCursorHandle || !z || !TextRange.m6711getCollapsedimpl(visualText.getSelection()) || !visualText.shouldShowSelection() || visualText.length() <= 0 || (draggingHandle != Handle.Cursor && !isCursorHandleInVisibleBounds())) {
            return TextFieldHandleState.INSTANCE.getHidden();
        }
        return new TextFieldHandleState(true, includePosition ? getCursorRect().m4321getBottomCenterF1C5BW0() : Offset.INSTANCE.m4309getUnspecifiedF1C5BW0(), ResolvedTextDirection.Ltr, false, null);
    }
    ...
    private final boolean isCursorHandleInVisibleBounds() {
        ...
        try {
            long jM4321getBottomCenterF1C5BW0 = getCursorRect().m4321getBottomCenterF1C5BW0();
            ...
            return SelectionManagerKt.m1684containsInclusiveUv8p0NA(rectVisibleBounds, jM4321getBottomCenterF1C5BW0);
        } catch (Throwable th) {
            companion.restoreNonObservable(currentThreadSnapshot, snapshotMakeCurrentNonObservable, readObserver);
            throw th;
        }
    ...
    public final Rect getCursorRect() {
        ...
        TextFieldCharSequence visualText = this.textFieldState.getVisualText();
        if (!TextRange.m6711getCollapsedimpl(visualText.getSelection())) {
            return Rect.INSTANCE.getZero();
        }
        Rect cursorRect = layoutResult.getCursorRect(TextRange.m6717getStartimpl(visualText.getSelection()));
        float fMo677toPx0680j_4 = this.density.mo677toPx0680j_4(TextFieldCursorKt.getDefaultCursorThickness());
        if (layoutResult.getLayoutInput().getLayoutDirection() == LayoutDirection.Ltr) {
            right = cursorRect.getLeft() + (fMo677toPx0680j_4 / 2);
        } else {
            right = cursorRect.getRight() - (fMo677toPx0680j_4 / 2);
        }
        float f = fMo677toPx0680j_4 / 2;
        float fCoerceAtLeast = RangesKt.coerceAtLeast(RangesKt.coerceAtMost(right, IntSize.m7426getWidthimpl(layoutResult.getSize()) - f), f);
                ...
                if (i == 0) {
                    ...
                    if (TapGestureDetectorKt.detectTapGestures$default(pointerInputScope, null, null, null, new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.cursorHandleGestures.2.3.1
                        ...
                        public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                            m1580invokek4lQ0M(offset.m4304unboximpl());
                            return Unit.INSTANCE;
                        }
    ...
    static final class C04812 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Job>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04812(PointerInputScope pointerInputScope, boolean z, Continuation<? super C04812> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C04812 c04812 = TextFieldSelectionState.this.new C04812(this.$this_selectionHandleGestures, this.$isStartHandle, continuation);
            c04812.L$0 = obj;
            return c04812;
        }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ...
                    TapOnPosition tapOnPosition = new TapOnPosition() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.selectionHandleGestures.2.2.1
                        ...
                        public final void mo1544onEventk4lQ0M(long j) {
                            Handle handle;
                            ...
                            textFieldSelectionState2.m1574updateHandleDraggingUv8p0NA(handle, SelectionHandlesKt.m1647getAdjustedCoordinatesk4lQ0M(textFieldSelectionState.m1564getHandlePositiontuRUvjQ(z)));
                        }
                    };
    ...
    public final Object selectionHandleGestures(PointerInputScope pointerInputScope, boolean z, Continuation<? super Unit> continuation) {
        Object objCoroutineScope = CoroutineScopeKt.coroutineScope(new C04812(pointerInputScope, z, null), continuation);
        return objCoroutineScope == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCoroutineScope : Unit.INSTANCE;
    }
    ...
    */
    public final java.lang.Object observeChanges(kotlin.coroutines.Continuation<? super kotlin.Unit> r6) throws java.lang.Throwable {
        /*
            r5 = this;
            boolean r0 = r6 instanceof androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.C04741
            if (r0 == 0) goto L14
            r0 = r6
            androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState$observeChanges$1 r0 = (androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.C04741) r0
            int r1 = r0.label
    ...
    static final class C04752 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Job>, Object> {
        private /* synthetic */ Object L$0;
        int label;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C04752 c04752 = TextFieldSelectionState.this.new C04752(continuation);
            c04752.L$0 = obj;
            return c04752;
        }
    ...
    static final class C04722 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
        private /* synthetic */ Object L$0;
        int label;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C04722 c04722 = TextFieldSelectionState.this.new C04722(continuation);
            c04722.L$0 = obj;
            return c04722;
        }
        ...
        public final Object invoke(AwaitPointerEventScope awaitPointerEventScope, Continuation<? super Unit> continuation) {
            return ((C04722) create(awaitPointerEventScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r5) {
            ...
            L33:
                ...
                goto L23
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.C04722.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }

    public final Object detectTouchMode(PointerInputScope pointerInputScope, Continuation<? super Unit> continuation) {
        Object objAwaitPointerEventScope = pointerInputScope.awaitPointerEventScope(new C04722(null), continuation);
    ...
    public final Object detectTextFieldTapGestures(PointerInputScope pointerInputScope, MutableInteractionSource mutableInteractionSource, final Function0<Unit> function0, final Function0<Unit> function02, Continuation<? super Unit> continuation) {
        Object objDetectTapAndPress = TapGestureDetectorKt.detectTapAndPress(pointerInputScope, new C04702(mutableInteractionSource, this, null), new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.detectTextFieldTapGestures.3
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                m1586invokek4lQ0M(offset.m4304unboximpl());
                return Unit.INSTANCE;
            }
            ...
            public final void m1586invokek4lQ0M(long j) {
                ...
                if (this.enabled && this.getIsFocused()) {
                    ...
                    long jM1518coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release = this.textLayoutState.m1518coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release(j);
                    TextFieldSelectionState textFieldSelectionState = this;
                    textFieldSelectionState.m1568placeCursorAtNearestOffsetk4lQ0M(TextLayoutStateKt.m1525fromDecorationToTextLayoutUv8p0NA(textFieldSelectionState.textLayoutState, jM1518coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release));
                }
            }
        }, continuation);
    ...
    static final class C04702 extends SuspendLambda implements Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04702(MutableInteractionSource mutableInteractionSource, TextFieldSelectionState textFieldSelectionState, Continuation<? super C04702> continuation) {
        ...
        public /* bridge */ /* synthetic */ Object invoke(PressGestureScope pressGestureScope, Offset offset, Continuation<? super Unit> continuation) {
            return m1585invoked4ec7I(pressGestureScope, offset.m4304unboximpl(), continuation);
        }
        ...
        public final Object m1585invoked4ec7I(PressGestureScope pressGestureScope, long j, Continuation<? super Unit> continuation) {
            C04702 c04702 = new C04702(this.$interactionSource, this.this$0, continuation);
            c04702.L$0 = pressGestureScope;
            c04702.J$0 = j;
            return c04702.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final boolean m1568placeCursorAtNearestOffsetk4lQ0M(long offset) {
        int iM6687getOffsetForPositionk4lQ0M;
        IndexTransformationType indexTransformationType;
        int iM6717getStartimpl;
        SelectionWedgeAffinity selectionWedgeAffinity;
        TextLayoutResult layoutResult = this.textLayoutState.getLayoutResult();
        if (layoutResult == null || (iM6687getOffsetForPositionk4lQ0M = layoutResult.m6687getOffsetForPositionk4lQ0M(offset)) == -1) {
            return false;
        }
        TransformedTextFieldState transformedTextFieldState = this.textFieldState;
        long jM1532mapFromTransformedjx7JFs = transformedTextFieldState.m1532mapFromTransformedjx7JFs(iM6687getOffsetForPositionk4lQ0M);
        ...
        if (i == 1 || i == 2) {
            iM6717getStartimpl = TextRange.m6717getStartimpl(jM1532mapFromTransformedjx7JFs);
        } else if (i == 3) {
            if (MathUtilsKt.m1480findClosestRect9KIMszo(offset, layoutResult.getCursorRect(TextRange.m6717getStartimpl(jM1535mapToTransformedGEjPoXI)), layoutResult.getCursorRect(TextRange.m6712getEndimpl(jM1535mapToTransformedGEjPoXI))) < 0) {
            ...
            if (MathUtilsKt.m1480findClosestRect9KIMszo(offset, layoutResult.getCursorRect(TextRange.m6717getStartimpl(jM1535mapToTransformedGEjPoXI)), layoutResult.getCursorRect(TextRange.m6712getEndimpl(jM1535mapToTransformedGEjPoXI))) < 0) {
                ...
                iM6717getStartimpl = TextRange.m6712getEndimpl(jM1532mapFromTransformedjx7JFs);
            }
        }
        long jTextRange = TextRangeKt.TextRange(iM6717getStartimpl);
        if (TextRange.m6710equalsimpl0(jTextRange, this.textFieldState.getUntransformedText().getSelection()) && (selectionWedgeAffinity2 == null || Intrinsics.areEqual(selectionWedgeAffinity2, this.textFieldState.getSelectionWedgeAffinity()))) {
            return false;
        }
        this.textFieldState.m1538selectUntransformedCharsIn5zctL8(jTextRange);
    ...
    */
    public final java.lang.Object detectCursorHandleDragGestures(androidx.compose.ui.input.pointer.PointerInputScope r10, kotlin.coroutines.Continuation<? super kotlin.Unit> r11) throws java.lang.Throwable {
        ...
        L42:
            ...
            long r3 = r1.m4309getUnspecifiedF1C5BW0()
            r11.element = r3
    ...
    public static final void detectCursorHandleDragGestures$onDragStop(Ref.LongRef longRef, Ref.LongRef longRef2, TextFieldSelectionState textFieldSelectionState) {
        if (OffsetKt.m4313isSpecifiedk4lQ0M(longRef.element)) {
            longRef.element = Offset.INSTANCE.m4309getUnspecifiedF1C5BW0();
            longRef2.element = Offset.INSTANCE.m4309getUnspecifiedF1C5BW0();
    ...
    private final class TextFieldMouseSelectionObserver implements MouseSelectionObserver {
        ...
        public boolean mo1579onStart3MmeM6k(long downPosition, SelectionAdjustment adjustment) {
            ...
            this.dragBeginOffsetInText = TextRange.m6717getStartimpl(m1575updateSelectionr1Wruf4(downPosition, adjustment, true));
            return true;
        }
        ...
        public boolean mo1576onDrag3MmeM6k(final long dragPosition, SelectionAdjustment adjustment) {
            ...
            TextFieldSelectionStateKt.logDebug(new Function0<String>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState$TextFieldMouseSelectionObserver$onDrag$1
                ...
                @Override // kotlin.jvm.functions.Function0
                public final String invoke() {
                    return "Mouse.onDrag " + ((Object) Offset.m4302toStringimpl(dragPosition));
                }
            });
        ...
        private final long m1575updateSelectionr1Wruf4(long dragPosition, SelectionAdjustment adjustment, boolean isStartOfSelection) {
            ...
            int iIntValue = numValueOf != null ? numValueOf.intValue() : TextFieldSelectionState.this.textLayoutState.m1520getOffsetForPosition3MmeM6k(this.dragBeginPosition, false);
            int iM1520getOffsetForPosition3MmeM6k = TextFieldSelectionState.this.textLayoutState.m1520getOffsetForPosition3MmeM6k(dragPosition, false);
            TextFieldSelectionState textFieldSelectionState = TextFieldSelectionState.this;
            long jM1571updateSelectionSsLRf8 = textFieldSelectionState.m1571updateSelectionSsLRf8(textFieldSelectionState.textFieldState.getVisualText(), iIntValue, iM1520getOffsetForPosition3MmeM6k, false, adjustment, false, isStartOfSelection);
            if (this.dragBeginOffsetInText == -1 && !TextRange.m6711getCollapsedimpl(jM1571updateSelectionSsLRf8)) {
                this.dragBeginOffsetInText = TextRange.m6717getStartimpl(jM1571updateSelectionSsLRf8);
            }
            if (TextRange.m6716getReversedimpl(jM1571updateSelectionSsLRf8)) {
                jM1571updateSelectionSsLRf8 = TextFieldSelectionStateKt.m1588reverse5zctL8(jM1571updateSelectionSsLRf8);
            }
            TextFieldSelectionState.this.textFieldState.m1537selectCharsIn5zctL8(jM1571updateSelectionSsLRf8);
            TextFieldSelectionState.this.updateTextToolbarState(TextToolbarState.Selection);
            return jM1571updateSelectionSsLRf8;
        }
    ...
    /* compiled from: TextFieldSelectionState.kt */
    @Metadata(d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0011\b\u0082\u0004\u0018\u00002\u00020\u0001B\u0013\u0012\f\u0010\u0002\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003¢\u0006\u0002\u0010\u0005J\b\u0010\u000e\u001a\u00020\u0004H\u0016J\u001a\u0010\u000f\u001a\u00020\u00042\u0006\u0010\u0010\u001a\u00020\u000bH\u0016ø\u0001\u0000¢\u0006\u0004\b\u0011\u0010\u0012J\u001a\u0010\u0013\u001a\u00020\u00042\u0006\u0010\u0014\u001a\u00020\u000bH\u0016ø\u0001\u0000¢\u0006\u0004\b\u0015\u0010\u0012J\b\u0010\u0016\u001a\u00020\u0004H\u0002J\u001a\u0010\u0017\u001a\u00020\u00042\u0006\u0010\u0018\u001a\u00020\u000bH\u0016ø\u0001\u0000¢\u0006\u0004\b\u0019\u0010\u0012J\b\u0010\u001a\u001a\u00020\u0004H\u0016J\b\u0010\u001b\u001a\u00020\u0004H\u0016R\u000e\u0010\u0006\u001a\u00020\u0007X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\tX\u0082\u000e¢\u0006\u0002\n\u0000R\u0016\u0010\n\u001a\u00020\u000bX\u0082\u000eø\u0001\u0000ø\u0001\u0001¢\u0006\u0004\n\u0002\u0010\fR\u0016\u0010\r\u001a\u00020\u000bX\u0082\u000eø\u0001\u0000ø\u0001\u0001¢\u0006\u0004\n\u0002\u0010\fR\u0014\u0010\u0002\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003X\u0082\u0004¢\u0006\u0002\n\u0000\u0082\u0002\u000b\n\u0005\b¡\u001e0\u0001\n\u0002\b!¨\u0006\u001c"}, d2 = {"Landroidx/compose/foundation/text/input/internal/selection/TextFieldSelectionState$TextFieldTextDragObserver;", "Landroidx/compose/foundation/text/TextDragObserver;", SdkConstants.REQUEST_FOCUS, "Lkotlin/Function0;", "", "(Landroidx/compose/foundation/text/input/internal/selection/TextFieldSelectionState;Lkotlin/jvm/functions/Function0;)V", "actingHandle", "Landroidx/compose/foundation/text/Handle;", "dragBeginOffsetInText", "", "dragBeginPosition", "Landroidx/compose/ui/geometry/Offset;", "J", "dragTotalDistance", "onCancel", "onDown", "point", "onDown-k-4lQ0M", "(J)V", "onDrag", "delta", "onDrag-k-4lQ0M", "onDragStop", "onStart", "startPoint", "onStart-k-4lQ0M", "onStop", "onUp", "foundation_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    private final class TextFieldTextDragObserver implements TextDragObserver {
        private final Function0<Unit> requestFocus;
        private int dragBeginOffsetInText = -1;
        private long dragBeginPosition = Offset.INSTANCE.m4309getUnspecifiedF1C5BW0();
        private long dragTotalDistance = Offset.INSTANCE.m4310getZeroF1C5BW0();
        ...
        private final void onDragStop() {
            if (OffsetKt.m4313isSpecifiedk4lQ0M(this.dragBeginPosition)) {
                ...
                this.dragBeginOffsetInText = -1;
                this.dragBeginPosition = Offset.INSTANCE.m4309getUnspecifiedF1C5BW0();
                this.dragTotalDistance = Offset.INSTANCE.m4310getZeroF1C5BW0();
                TextFieldSelectionState.this.previousRawDragOffset = -1;
                TextFieldSelectionState.this.setDirectDragGestureInitiator(InputType.None);
                this.requestFocus.invoke();
            }
        ...
        public void mo1364onStartk4lQ0M(final long startPoint) {
            if (TextFieldSelectionState.this.enabled) {
                TextFieldSelectionStateKt.logDebug(new Function0<String>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState$TextFieldTextDragObserver$onStart$1
                    ...
                    @Override // kotlin.jvm.functions.Function0
                    public final String invoke() {
                        return "Touch.onDragStart after longPress at " + ((Object) Offset.m4302toStringimpl(startPoint));
                    }
                });
                ...
                if (!TextFieldSelectionState.this.textLayoutState.m1521isPositionOnTextk4lQ0M(startPoint)) {
                    int iM1517getOffsetForPosition3MmeM6k$default = TextLayoutState.m1517getOffsetForPosition3MmeM6k$default(TextFieldSelectionState.this.textLayoutState, startPoint, false, 2, null);
                    HapticFeedback hapticFeedback = TextFieldSelectionState.this.hapticFeedBack;
                    if (hapticFeedback != null) {
                        hapticFeedback.mo5312performHapticFeedbackCdsT49E(HapticFeedbackType.INSTANCE.m5329getTextHandleMove5zf0vsI());
                    }
                    TextFieldSelectionState.this.textFieldState.placeCursorBeforeCharAt(iM1517getOffsetForPosition3MmeM6k$default);
                ...
                int iM1517getOffsetForPosition3MmeM6k$default2 = TextLayoutState.m1517getOffsetForPosition3MmeM6k$default(TextFieldSelectionState.this.textLayoutState, startPoint, false, 2, null);
                long jM1572updateSelectionSsLRf8$default = TextFieldSelectionState.m1572updateSelectionSsLRf8$default(TextFieldSelectionState.this, new TextFieldCharSequence(TextFieldSelectionState.this.textFieldState.getVisualText(), TextRange.INSTANCE.m6722getZerod9O1mEE(), null, null, 12, null), iM1517getOffsetForPosition3MmeM6k$default2, iM1517getOffsetForPosition3MmeM6k$default2, false, SelectionAdjustment.INSTANCE.getWord(), false, false, 96, null);
                TextFieldSelectionState.this.textFieldState.m1537selectCharsIn5zctL8(jM1572updateSelectionSsLRf8$default);
                TextFieldSelectionState.this.updateTextToolbarState(TextToolbarState.Selection);
                this.dragBeginOffsetInText = TextRange.m6717getStartimpl(jM1572updateSelectionSsLRf8$default);
            }
        }
        ...
        public void mo1363onDragk4lQ0M(long delta) {
            int iIntValue;
            int iM1520getOffsetForPosition3MmeM6k;
            SelectionAdjustment word;
            Handle handle;
            if (!TextFieldSelectionState.this.enabled || TextFieldSelectionState.this.textFieldState.getVisualText().length() == 0) {
                return;
            }
            long jM4299plusMKHz9U = Offset.m4299plusMKHz9U(this.dragTotalDistance, delta);
            this.dragTotalDistance = jM4299plusMKHz9U;
            final long jM4299plusMKHz9U2 = Offset.m4299plusMKHz9U(this.dragBeginPosition, jM4299plusMKHz9U);
            TextFieldSelectionStateKt.logDebug(new Function0<String>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState$TextFieldTextDragObserver$onDrag$1
                ...
                @Override // kotlin.jvm.functions.Function0
                public final String invoke() {
                    return "Touch.onDrag at " + ((Object) Offset.m4302toStringimpl(jM4299plusMKHz9U2));
                }
            });
            if (this.dragBeginOffsetInText < 0 && !TextFieldSelectionState.this.textLayoutState.m1521isPositionOnTextk4lQ0M(jM4299plusMKHz9U2)) {
                iIntValue = TextLayoutState.m1517getOffsetForPosition3MmeM6k$default(TextFieldSelectionState.this.textLayoutState, this.dragBeginPosition, false, 2, null);
                iM1520getOffsetForPosition3MmeM6k = TextLayoutState.m1517getOffsetForPosition3MmeM6k$default(TextFieldSelectionState.this.textLayoutState, jM4299plusMKHz9U2, false, 2, null);
                if (iIntValue == iM1520getOffsetForPosition3MmeM6k) {
                ...
                iIntValue = numValueOf != null ? numValueOf.intValue() : TextFieldSelectionState.this.textLayoutState.m1520getOffsetForPosition3MmeM6k(this.dragBeginPosition, false);
                iM1520getOffsetForPosition3MmeM6k = TextFieldSelectionState.this.textLayoutState.m1520getOffsetForPosition3MmeM6k(jM4299plusMKHz9U2, false);
                if (this.dragBeginOffsetInText < 0 && iIntValue == iM1520getOffsetForPosition3MmeM6k) {
                    return;
                }
                word = SelectionAdjustment.INSTANCE.getWord();
                TextFieldSelectionState.this.updateTextToolbarState(TextToolbarState.Selection);
            ...
            int i = iIntValue;
            int i2 = iM1520getOffsetForPosition3MmeM6k;
            ...
            TextFieldSelectionState textFieldSelectionState = TextFieldSelectionState.this;
            long jM1572updateSelectionSsLRf8$default = TextFieldSelectionState.m1572updateSelectionSsLRf8$default(textFieldSelectionState, textFieldSelectionState.textFieldState.getVisualText(), i, i2, false, selectionAdjustment, false, false, 64, null);
            if (this.dragBeginOffsetInText == -1 && !TextRange.m6711getCollapsedimpl(jM1572updateSelectionSsLRf8$default)) {
                this.dragBeginOffsetInText = TextRange.m6717getStartimpl(jM1572updateSelectionSsLRf8$default);
            }
            if (TextRange.m6716getReversedimpl(jM1572updateSelectionSsLRf8$default)) {
                jM1572updateSelectionSsLRf8$default = TextFieldSelectionStateKt.m1588reverse5zctL8(jM1572updateSelectionSsLRf8$default);
            }
            if (!TextRange.m6710equalsimpl0(jM1572updateSelectionSsLRf8$default, selection)) {
                if (TextRange.m6717getStartimpl(jM1572updateSelectionSsLRf8$default) != TextRange.m6717getStartimpl(selection) && TextRange.m6712getEndimpl(jM1572updateSelectionSsLRf8$default) == TextRange.m6712getEndimpl(selection)) {
                    handle = Handle.SelectionStart;
                } else if ((TextRange.m6717getStartimpl(jM1572updateSelectionSsLRf8$default) == TextRange.m6717getStartimpl(selection) && TextRange.m6712getEndimpl(jM1572updateSelectionSsLRf8$default) != TextRange.m6712getEndimpl(selection)) || (TextRange.m6717getStartimpl(jM1572updateSelectionSsLRf8$default) + TextRange.m6712getEndimpl(jM1572updateSelectionSsLRf8$default)) / 2.0f > (TextRange.m6717getStartimpl(selection) + TextRange.m6712getEndimpl(selection)) / 2.0f) {
                    handle = Handle.SelectionEnd;
                } else {
                    handle = Handle.SelectionStart;
                }
            ...
            if (TextRange.m6711getCollapsedimpl(selection) || !TextRange.m6711getCollapsedimpl(jM1572updateSelectionSsLRf8$default)) {
                TextFieldSelectionState.this.textFieldState.m1537selectCharsIn5zctL8(jM1572updateSelectionSsLRf8$default);
            }
            TextFieldSelectionState.this.m1574updateHandleDraggingUv8p0NA(this.actingHandle, jM4299plusMKHz9U2);
        }
    }
    ...
    */
    ...
    public static final void detectSelectionHandleDragGestures$onDragStop$5(Ref.LongRef longRef, TextFieldSelectionState textFieldSelectionState, Ref.LongRef longRef2) {
        if (OffsetKt.m4313isSpecifiedk4lQ0M(longRef.element)) {
            textFieldSelectionState.clearHandleDragging();
            longRef.element = Offset.INSTANCE.m4309getUnspecifiedF1C5BW0();
            longRef2.element = Offset.INSTANCE.m4310getZeroF1C5BW0();
    ...
    /* synthetic */ class C04773 extends FunctionReferenceImpl implements Function2<TextFieldCharSequence, CharSequence, Boolean> {
        public static final C04773 INSTANCE = new C04773();
    ...
    public final Object observeTextChanges(Continuation<? super Unit> continuation) {
        ...
        }), C04773.INSTANCE), 1).collect(new FlowCollector() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.observeTextChanges.4
    ...
    public final Object observeTextToolbarVisibility(Continuation<? super Unit> continuation) {
        Object objCollect = SnapshotStateKt.snapshotFlow(new Function0<Rect>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.observeTextToolbarVisibility.2
            ...
            public final Rect invoke() {
                Rect rectIntersect;
                boolean zM6711getCollapsedimpl = TextRange.m6711getCollapsedimpl(TextFieldSelectionState.this.textFieldState.getVisualText().getSelection());
                if (((zM6711getCollapsedimpl && TextFieldSelectionState.this.getTextToolbarState() == TextToolbarState.Cursor) || (!zM6711getCollapsedimpl && TextFieldSelectionState.this.getTextToolbarState() == TextToolbarState.Selection)) && TextFieldSelectionState.this.getDraggingHandle() == null && TextFieldSelectionState.this.isInTouchMode()) {
                    ...
                    if (rectVisibleBounds != null) {
                        ...
                        Offset offsetM4283boximpl = textLayoutCoordinates2 != null ? Offset.m4283boximpl(textLayoutCoordinates2.mo5968localToRootMKHz9U(rectVisibleBounds.m4329getTopLeftF1C5BW0())) : null;
                        Intrinsics.checkNotNull(offsetM4283boximpl);
                        Rect rectM4334Recttz77jQw = RectKt.m4334Recttz77jQw(offsetM4283boximpl.m4304unboximpl(), rectVisibleBounds.m4327getSizeNHjbRc());
                        Rect contentRect = TextFieldSelectionState.this.getContentRect();
                        Rect rect = rectM4334Recttz77jQw.overlaps(contentRect) ? contentRect : null;
                        return (rect == null || (rectIntersect = rect.intersect(rectM4334Recttz77jQw)) == null) ? Rect.INSTANCE.getZero() : rectIntersect;
                    }
                    return Rect.INSTANCE.getZero();
                }
                return Rect.INSTANCE.getZero();
    ...
    public final Rect getContentRect() {
        ...
        if (TextRange.m6711getCollapsedimpl(visualText.getSelection())) {
            ...
            LayoutCoordinates textLayoutCoordinates = getTextLayoutCoordinates();
            return RectKt.m4334Recttz77jQw(textLayoutCoordinates != null ? textLayoutCoordinates.mo5968localToRootMKHz9U(cursorRect3.m4329getTopLeftF1C5BW0()) : Offset.INSTANCE.m4310getZeroF1C5BW0(), cursorRect3.m4327getSizeNHjbRc());
        }
        LayoutCoordinates textLayoutCoordinates2 = getTextLayoutCoordinates();
        long jMo5968localToRootMKHz9U = textLayoutCoordinates2 != null ? textLayoutCoordinates2.mo5968localToRootMKHz9U(m1564getHandlePositiontuRUvjQ(true)) : Offset.INSTANCE.m4310getZeroF1C5BW0();
        LayoutCoordinates textLayoutCoordinates3 = getTextLayoutCoordinates();
        long jMo5968localToRootMKHz9U2 = textLayoutCoordinates3 != null ? textLayoutCoordinates3.mo5968localToRootMKHz9U(m1564getHandlePositiontuRUvjQ(false)) : Offset.INSTANCE.m4310getZeroF1C5BW0();
        LayoutCoordinates textLayoutCoordinates4 = getTextLayoutCoordinates();
        float fM4295getYimpl2 = 0.0f;
        if (textLayoutCoordinates4 != null) {
            TextLayoutResult layoutResult = this.textLayoutState.getLayoutResult();
            fM4295getYimpl = Offset.m4295getYimpl(textLayoutCoordinates4.mo5968localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult == null || (cursorRect2 = layoutResult.getCursorRect(TextRange.m6717getStartimpl(visualText.getSelection()))) == null) ? 0.0f : cursorRect2.getTop())));
        } else {
            fM4295getYimpl = 0.0f;
        }
        ...
        if (textLayoutCoordinates5 != null) {
            ...
            fM4295getYimpl2 = Offset.m4295getYimpl(textLayoutCoordinates5.mo5968localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult2 == null || (cursorRect = layoutResult2.getCursorRect(TextRange.m6712getEndimpl(visualText.getSelection()))) == null) ? 0.0f : cursorRect.getTop())));
        }
        return new Rect(Math.min(Offset.m4294getXimpl(jMo5968localToRootMKHz9U), Offset.m4294getXimpl(jMo5968localToRootMKHz9U2)), Math.min(fM4295getYimpl, fM4295getYimpl2), Math.max(Offset.m4294getXimpl(jMo5968localToRootMKHz9U), Offset.m4294getXimpl(jMo5968localToRootMKHz9U2)), Math.max(Offset.m4295getYimpl(jMo5968localToRootMKHz9U), Offset.m4295getYimpl(jMo5968localToRootMKHz9U2)));
    }

    /* JADX WARN: Code restructure failed: missing block: B:23:0x0052, code lost:
    
        if (((r0 == null || (r0 = androidx.compose.foundation.text.selection.SelectionManagerKt.visibleBounds(r0)) == null) ? false : androidx.compose.foundation.text.selection.SelectionManagerKt.m1684containsInclusiveUv8p0NA(r0, r4)) != false) goto L24;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public final androidx.compose.foundation.text.input.internal.selection.TextFieldHandleState getSelectionHandleState$foundation_release(boolean r14, boolean r15) {
        ...
        L16:
            ...
            boolean r4 = androidx.compose.ui.text.TextRange.m6711getCollapsedimpl(r2)
            if (r4 == 0) goto L2d
            androidx.compose.foundation.text.input.internal.selection.TextFieldHandleState$Companion r14 = androidx.compose.foundation.text.input.internal.selection.TextFieldHandleState.INSTANCE
            androidx.compose.foundation.text.input.internal.selection.TextFieldHandleState r14 = r14.getHidden()
            return r14
        L2d:
            long r4 = r13.m1564getHandlePositiontuRUvjQ(r14)
            ...
            if (r0 == 0) goto L51
            boolean r0 = androidx.compose.foundation.text.selection.SelectionManagerKt.m1684containsInclusiveUv8p0NA(r0, r4)
            goto L52
        L51:
            r0 = r7
        L52:
        ...
        L67:
            if (r14 == 0) goto L6e
            int r14 = androidx.compose.ui.text.TextRange.m6717getStartimpl(r2)
            goto L78
        L6e:
            int r14 = androidx.compose.ui.text.TextRange.m6712getEndimpl(r2)
            int r14 = r14 + (-1)
            int r14 = java.lang.Math.max(r14, r7)
        L78:
            androidx.compose.ui.text.style.ResolvedTextDirection r10 = r1.getBidiRunDirection(r14)
            boolean r11 = androidx.compose.ui.text.TextRange.m6716getReversedimpl(r2)
            if (r15 == 0) goto L93
            ...
            if (r14 == 0) goto L99
            long r4 = androidx.compose.foundation.text.input.internal.TextLayoutStateKt.m1524coerceIn3MmeM6k(r4, r14)
            goto L99
        L93:
            androidx.compose.ui.geometry.Offset$Companion r14 = androidx.compose.ui.geometry.Offset.INSTANCE
            long r4 = r14.m4309getUnspecifiedF1C5BW0()
        L99:
            r8 = r4
    ...
    public final long m1564getHandlePositiontuRUvjQ(boolean isStartHandle) {
        ...
        if (isStartHandle) {
            iM6712getEndimpl = TextRange.m6717getStartimpl(selection);
        } else {
            iM6712getEndimpl = TextRange.m6712getEndimpl(selection);
        }
        return TextSelectionDelegateKt.getSelectionHandleCoordinates(layoutResult, iM6712getEndimpl, isStartHandle, TextRange.m6716getReversedimpl(selection));
    }
    ...
    public final void clearHandleDragging() {
        ...
        m1569setRawHandleDragPositionk4lQ0M(Offset.INSTANCE.m4309getUnspecifiedF1C5BW0());
        m1570setStartTextLayoutPositionInWindowk4lQ0M(Offset.INSTANCE.m4309getUnspecifiedF1C5BW0());
    }

    public final boolean canCut() {
        return (TextRange.m6711getCollapsedimpl(this.textFieldState.getVisualText().getSelection()) || !getEditable() || this.isPassword) ? false : true;
    }
    ...
    public final boolean canCopy() {
        return (TextRange.m6711getCollapsedimpl(this.textFieldState.getVisualText().getSelection()) || this.isPassword) ? false : true;
    }
    ...
    public final void paste() {
        ...
        TransferableContent transferableContentOnReceive = receiveContentConfigurationInvoke.getReceiveContentListener().onReceive(new TransferableContent(clip, clip.getClipMetadata(), TransferableContent.Source.INSTANCE.m640getClipboardkB6V9T0(), null, 8, null));
    ...
    public final boolean canSelectAll() {
        return TextRange.m6713getLengthimpl(this.textFieldState.getVisualText().getSelection()) != this.textFieldState.getVisualText().length();
    }
    ...
    public final void deselect() {
        if (!TextRange.m6711getCollapsedimpl(this.textFieldState.getVisualText().getSelection())) {
    ...
    static /* synthetic */ long m1572updateSelectionSsLRf8$default(TextFieldSelectionState textFieldSelectionState, TextFieldCharSequence textFieldCharSequence, int i, int i2, boolean z, SelectionAdjustment selectionAdjustment, boolean z2, boolean z3, int i3, Object obj) {
    ...
    public final long m1571updateSelectionSsLRf8(TextFieldCharSequence textFieldCharSequence, int startOffset, int endOffset, boolean isStartHandle, SelectionAdjustment adjustment, boolean allowPreviousSelectionCollapsed, boolean isStartOfSelection) {
        ...
        TextRange textRangeM6705boximpl = TextRange.m6705boximpl(textFieldCharSequence.getSelection());
        long packedValue = textRangeM6705boximpl.getPackedValue();
        if (isStartOfSelection || (!allowPreviousSelectionCollapsed && TextRange.m6711getCollapsedimpl(packedValue))) {
            textRangeM6705boximpl = null;
        }
        long jM1567getTextFieldSelectionqeG_v_k = m1567getTextFieldSelectionqeG_v_k(startOffset, endOffset, textRangeM6705boximpl, isStartHandle, adjustment);
        if (TextRange.m6710equalsimpl0(jM1567getTextFieldSelectionqeG_v_k, textFieldCharSequence.getSelection())) {
            return jM1567getTextFieldSelectionqeG_v_k;
        }
        boolean z = TextRange.m6716getReversedimpl(jM1567getTextFieldSelectionqeG_v_k) != TextRange.m6716getReversedimpl(textFieldCharSequence.getSelection()) && TextRange.m6710equalsimpl0(TextRangeKt.TextRange(TextRange.m6712getEndimpl(jM1567getTextFieldSelectionqeG_v_k), TextRange.m6717getStartimpl(jM1567getTextFieldSelectionqeG_v_k)), textFieldCharSequence.getSelection());
    ...
    private final long m1567getTextFieldSelectionqeG_v_k(int rawStartOffset, int rawEndOffset, TextRange previousSelection, boolean isStartHandle, SelectionAdjustment adjustment) {
        ...
        SelectionLayout selectionLayoutM1650getTextFieldSelectionLayoutRcvTLA = SelectionLayoutKt.m1650getTextFieldSelectionLayoutRcvTLA(layoutResult, rawStartOffset, rawEndOffset, this.previousRawDragOffset, previousSelection != null ? previousSelection.getPackedValue() : TextRange.INSTANCE.m6722getZerod9O1mEE(), previousSelection == null, isStartHandle);
        if (previousSelection != null && !selectionLayoutM1650getTextFieldSelectionLayoutRcvTLA.shouldRecomputeSelection(this.previousSelectionLayout)) {
            return previousSelection.getPackedValue();
        }
        long jM1638toTextRanged9O1mEE = adjustment.adjust(selectionLayoutM1650getTextFieldSelectionLayoutRcvTLA).m1638toTextRanged9O1mEE();
        this.previousSelectionLayout = selectionLayoutM1650getTextFieldSelectionLayoutRcvTLA;
        if (!isStartHandle) {
            rawStartOffset = rawEndOffset;
        }
        this.previousRawDragOffset = rawStartOffset;
        return jM1638toTextRanged9O1mEE;
    }
}
