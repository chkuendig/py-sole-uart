...
public final class TransformedTextFieldStateKt {
    public static final <R> R getIndexTransformationType(TransformedTextFieldState transformedTextFieldState, int i, Function3<? super IndexTransformationType, ? super TextRange, ? super TextRange, ? extends R> function3) {
        ...
        long jM1532mapFromTransformedjx7JFs = transformedTextFieldState.m1532mapFromTransformedjx7JFs(i);
        ...
        return function3.invoke(indexTransformationType, TextRange.m6705boximpl(jM1532mapFromTransformedjx7JFs), TextRange.m6705boximpl(jM1535mapToTransformedGEjPoXI));
    }
}
