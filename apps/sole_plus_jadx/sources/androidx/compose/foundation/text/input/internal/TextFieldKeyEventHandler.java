...
public abstract class TextFieldKeyEventHandler {
    ...
    public boolean mo1438onPreKeyEventMyFupTE(KeyEvent event, TransformedTextFieldState textFieldState, TextFieldSelectionState textFieldSelectionState, FocusManager focusManager, SoftwareKeyboardController keyboardController) {
        if (TextRange.m6711getCollapsedimpl(textFieldState.getVisualText().getSelection()) || !KeyEventHelpers_androidKt.m1300cancelsTextSelectionZmokQxo(event)) {
            return false;
        }
    ...
    public boolean mo1437onKeyEvent6ptp14s(KeyEvent event, TransformedTextFieldState textFieldState, TextLayoutState textLayoutState, TextFieldSelectionState textFieldSelectionState, boolean editable, boolean singleLine, Function0<Unit> onSubmit) {
        TextRange textRangeM6705boximpl;
        Integer numM1299consumeZmokQxo;
        boolean z = false;
        if (!KeyEventType.m5677equalsimpl0(KeyEvent_androidKt.m5685getTypeZmokQxo(event), KeyEventType.INSTANCE.m5681getKeyDownCS__XNY())) {
            return false;
        }
        if (TextFieldKeyInput_androidKt.m1383isTypedEventZmokQxo(event) && (numM1299consumeZmokQxo = this.deadKeyCombiner.m1299consumeZmokQxo(event)) != null) {
            String string = StringHelpers_jvmKt.appendCodePointX(new StringBuilder(2), numM1299consumeZmokQxo.intValue()).toString();
            if (!editable) {
                return false;
            }
            boolean z2 = !TextFieldKeyEventHandler_androidKt.m1509isFromSoftKeyboardZmokQxo(event);
        ...
        KeyCommand keyCommandMo1301mapZmokQxo = this.keyMapping.mo1301mapZmokQxo(event);
        if (keyCommandMo1301mapZmokQxo != null && (!keyCommandMo1301mapZmokQxo.getEditsText() || editable)) {
            TextFieldPreparedSelection textFieldPreparedSelection = new TextFieldPreparedSelection(textFieldState, textLayoutState.getLayoutResult(), TextFieldKeyEventHandler_androidKt.m1509isFromSoftKeyboardZmokQxo(event), getVisibleTextLayoutHeight(textLayoutState), this.preparedSelectionState);
            switch (WhenMappings.$EnumSwitchMapping$0[keyCommandMo1301mapZmokQxo.ordinal()]) {
                case 1:
                ...
                case 19:
                    ...
                    break;
                case 20:
                    if (TextRange.m6711getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        Integer numValueOf = Integer.valueOf(textFieldPreparedSelection.getPrecedingCharacterIndex());
                        if (numValueOf.intValue() == -1) {
                            numValueOf = null;
                        }
                        textRangeM6705boximpl = numValueOf != null ? TextRange.m6705boximpl(TextRangeKt.TextRange(numValueOf.intValue(), TextRange.m6712getEndimpl(textFieldPreparedSelection.getSelection()))) : null;
                        if (textRangeM6705boximpl != null) {
                            TransformedTextFieldState.m1530replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", textRangeM6705boximpl.getPackedValue(), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                        }
                    } else {
                        TransformedTextFieldState.m1530replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", textFieldPreparedSelection.getSelection(), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    }
                    z = true;
                    break;
                case 21:
                    if (TextRange.m6711getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        ...
                        textRangeM6705boximpl = numValueOf2 != null ? TextRange.m6705boximpl(TextRangeKt.TextRange(TextRange.m6717getStartimpl(textFieldPreparedSelection.getSelection()), numValueOf2.intValue())) : null;
                        if (textRangeM6705boximpl != null) {
                            TransformedTextFieldState.m1530replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", textRangeM6705boximpl.getPackedValue(), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                        }
                    } else {
                ...
                case 22:
                    if (!TextRange.m6711getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        ...
                        TransformedTextFieldState.m1530replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(textFieldPreparedSelection.getPreviousWordOffset(), TextRange.m6712getEndimpl(textFieldPreparedSelection.getSelection())), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    }
                    z = true;
                    break;
                case 23:
                    if (!TextRange.m6711getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        ...
                        TransformedTextFieldState.m1530replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(TextRange.m6717getStartimpl(textFieldPreparedSelection.getSelection()), textFieldPreparedSelection.getNextWordOffset()), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    }
                    z = true;
                    break;
                case 24:
                    if (!TextRange.m6711getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        ...
                        TransformedTextFieldState.m1530replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(textFieldPreparedSelection.getLineStartByOffset(), TextRange.m6712getEndimpl(textFieldPreparedSelection.getSelection())), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    }
                    z = true;
                    break;
                case 25:
                    if (!TextRange.m6711getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        ...
                        TransformedTextFieldState.m1530replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(TextRange.m6717getStartimpl(textFieldPreparedSelection.getSelection()), textFieldPreparedSelection.getLineEndByOffset()), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    }
                    z = true;
                    break;
                case 26:
                ...
                case 27:
                    if (!singleLine) {
                        ...
                        EditCommandKt.commitText(mainBuffer3, TlbBase.TAB, 1);
            ...
            if (!TextRange.m6710equalsimpl0(textFieldPreparedSelection.getSelection(), textFieldPreparedSelection.getInitialValue().getSelection())) {
                textFieldState.m1537selectCharsIn5zctL8(textFieldPreparedSelection.getSelection());
            }
        }
        return z;
    }
    ...
    private final void preparedSelectionContext(TransformedTextFieldState state, TextLayoutState textLayoutState, boolean isFromSoftKeyboard, Function1<? super TextFieldPreparedSelection, Unit> block) {
        ...
        state.m1537selectCharsIn5zctL8(textFieldPreparedSelection.getSelection());
    }
        ...
        if (textLayoutNodeCoordinates != null) {
            ...
            if (textLayoutNodeCoordinates != null) {
                ...
                if (rectLocalBoundingBoxOf$default != null) {
                    return Size.m4360getHeightimpl(rectLocalBoundingBoxOf$default.m4327getSizeNHjbRc());
                }
            }
        }
        return Float.NaN;
