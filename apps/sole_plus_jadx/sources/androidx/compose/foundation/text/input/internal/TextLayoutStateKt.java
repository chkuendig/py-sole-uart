...
public final class TextLayoutStateKt {
    ...
    public static final long m1524coerceIn3MmeM6k(long j, Rect rect) {
        float right;
        float bottom;
        if (Offset.m4294getXimpl(j) < rect.getLeft()) {
            right = rect.getLeft();
        } else {
            right = Offset.m4294getXimpl(j) > rect.getRight() ? rect.getRight() : Offset.m4294getXimpl(j);
        }
        if (Offset.m4295getYimpl(j) < rect.getTop()) {
            bottom = rect.getTop();
        } else {
            bottom = Offset.m4295getYimpl(j) > rect.getBottom() ? rect.getBottom() : Offset.m4295getYimpl(j);
        }
    ...
    public static final long m1526fromTextLayoutToCoreUv8p0NA(TextLayoutState textLayoutState, long j) {
        ...
        Offset offsetM4283boximpl = null;
        ...
        if (coreNodeCoordinates != null) {
            ...
            if (coreNodeCoordinates != null) {
                offsetM4283boximpl = Offset.m4283boximpl(coreNodeCoordinates.mo5966localPositionOfR5De75A(textLayoutNodeCoordinates, j));
            }
        }
        return offsetM4283boximpl != null ? offsetM4283boximpl.m4304unboximpl() : j;
    }
    ...
    public static final long m1525fromDecorationToTextLayoutUv8p0NA(TextLayoutState textLayoutState, long j) {
        ...
        if (decoratorNodeCoordinates != null) {
            offsetM4283boximpl = Offset.m4283boximpl((textLayoutNodeCoordinates.isAttached() && decoratorNodeCoordinates.isAttached()) ? textLayoutNodeCoordinates.mo5966localPositionOfR5De75A(decoratorNodeCoordinates, j) : j);
        } else {
    ...
    public static final long m1527fromWindowToDecorationUv8p0NA(TextLayoutState textLayoutState, long j) {
        LayoutCoordinates decoratorNodeCoordinates = textLayoutState.getDecoratorNodeCoordinates();
        return (decoratorNodeCoordinates == null || !decoratorNodeCoordinates.isAttached()) ? j : decoratorNodeCoordinates.mo5974windowToLocalMKHz9U(j);
    }
}
