...
public final class TextObfuscationMode {
    ...
    private static final int Visible = m1427constructorimpl(0);
    private static final int RevealLastTyped = m1427constructorimpl(1);
    private static final int Hidden = m1427constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TextObfuscationMode m1426boximpl(int i) {
        return new TextObfuscationMode(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m1427constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m1428equalsimpl(int i, Object obj) {
        return (obj instanceof TextObfuscationMode) && i == ((TextObfuscationMode) obj).m1432unboximpl();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1429equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m1430hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m1431toStringimpl(int i) {
        return "TextObfuscationMode(value=" + i + ')';
    }

    public boolean equals(Object obj) {
        return m1428equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m1430hashCodeimpl(this.value);
    }

    public String toString() {
        return m1431toStringimpl(this.value);
    }
