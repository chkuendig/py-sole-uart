...
public final class OffsetMappingCalculator {
    ...
    private int[] ops = OpArray.m1486constructorimpl(10);
    private int opsSize;
    ...
    public final void recordEditOperation(int sourceStart, int sourceEnd, int newLength) {
        ...
        if (iMax >= 2 || iMax != newLength) {
            ...
            if (i > OpArray.m1493getSizeimpl(this.ops)) {
                this.ops = OpArray.m1488copyOfpSmdads(this.ops, Math.max(i * 2, OpArray.m1493getSizeimpl(this.ops) * 2));
            }
            OpArray.m1495setimpl(this.ops, this.opsSize, iMin, iMax, newLength);
            this.opsSize = i;
        }
    }

    /* renamed from: mapFromSource--jx7JFs, reason: not valid java name */
    public final long m1484mapFromSourcejx7JFs(int offset) {
        return m1481mapfzxv0v0(offset, true);
    }

    /* renamed from: mapFromDest--jx7JFs, reason: not valid java name */
    public final long m1483mapFromDestjx7JFs(int offset) {
        return m1481mapfzxv0v0(offset, false);
    }

    /* renamed from: map-fzxv0v0, reason: not valid java name */
    private final long m1481mapfzxv0v0(int offset, boolean fromSource) {
        int i;
        int[] iArr = this.ops;
        int i2 = this.opsSize;
        if (i2 < 0) {
            ...
            while (i3 < i2) {
                ...
                int i6 = iArr[i4 + 1];
                int i7 = iArr[i4 + 2];
                long jM1482mapStepC6uMEY = m1482mapStepC6uMEY(iMin, i5, i6, i7, fromSource);
                long jM1482mapStepC6uMEY2 = m1482mapStepC6uMEY(offset, i5, i6, i7, fromSource);
                i3++;
                iMin = Math.min(TextRange.m6717getStartimpl(jM1482mapStepC6uMEY), TextRange.m6717getStartimpl(jM1482mapStepC6uMEY2));
                offset = Math.max(TextRange.m6712getEndimpl(jM1482mapStepC6uMEY), TextRange.m6712getEndimpl(jM1482mapStepC6uMEY2));
            }
            i = offset;
            offset = iMin;
        } else {
            ...
            while (-1 < i8) {
                ...
                int i11 = iArr[i9 + 1];
                int i12 = iArr[i9 + 2];
                long jM1482mapStepC6uMEY3 = m1482mapStepC6uMEY(iMin2, i10, i11, i12, fromSource);
                long jM1482mapStepC6uMEY4 = m1482mapStepC6uMEY(offset, i10, i11, i12, fromSource);
                i8--;
                iMin2 = Math.min(TextRange.m6717getStartimpl(jM1482mapStepC6uMEY3), TextRange.m6717getStartimpl(jM1482mapStepC6uMEY4));
                offset = Math.max(TextRange.m6712getEndimpl(jM1482mapStepC6uMEY3), TextRange.m6712getEndimpl(jM1482mapStepC6uMEY4));
            }
            i = offset;
            offset = iMin2;
        }
    ...
    private final long m1482mapStepC6uMEY(int offset, int opOffset, int untransformedLen, int transformedLen, boolean fromSource) {
