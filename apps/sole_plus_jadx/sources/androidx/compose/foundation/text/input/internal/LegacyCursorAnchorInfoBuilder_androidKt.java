...
public final class LegacyCursorAnchorInfoBuilder_androidKt {
    public static final CursorAnchorInfo build(CursorAnchorInfo.Builder builder, TextFieldValue textFieldValue, OffsetMapping offsetMapping, TextLayoutResult textLayoutResult, Matrix matrix, Rect rect, Rect rect2, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        int iM6715getMinimpl = TextRange.m6715getMinimpl(textFieldValue.getSelection());
        builder.setSelectionRange(iM6715getMinimpl, TextRange.m6714getMaximpl(textFieldValue.getSelection()));
        if (z) {
            setInsertionMarker(builder, iM6715getMinimpl, offsetMapping, textLayoutResult, rect);
        }
        if (z2) {
            ...
            int iM6714getMaximpl = composition2 != null ? TextRange.m6714getMaximpl(composition2.getPackedValue()) : -1;
            if (iM6715getMinimpl2 >= 0 && iM6715getMinimpl2 < iM6714getMaximpl) {
                builder.setComposingText(iM6715getMinimpl2, textFieldValue.getText().subSequence(iM6715getMinimpl2, iM6714getMaximpl));
                addCharacterBounds(builder, iM6715getMinimpl2, iM6714getMaximpl, offsetMapping, textLayoutResult, rect);
            }
        }
    ...
    */
    private static final android.view.inputmethod.CursorAnchorInfo.Builder addCharacterBounds(android.view.inputmethod.CursorAnchorInfo.Builder r17, int r18, int r19, androidx.compose.ui.text.input.OffsetMapping r20, androidx.compose.ui.text.TextLayoutResult r21, androidx.compose.ui.geometry.Rect r22) {
        /*
            ...
            r5 = 0
            r7.m6557fillBoundingBoxes8ffj60Q(r8, r6, r5)
        L22:
            if (r2 >= r0) goto L8b
