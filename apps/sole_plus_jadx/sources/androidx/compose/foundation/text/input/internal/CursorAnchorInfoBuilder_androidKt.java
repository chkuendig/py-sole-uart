...
public final class CursorAnchorInfoBuilder_androidKt {
    ...
    public static final CursorAnchorInfo m1443buildvxqZcH0(CursorAnchorInfo.Builder builder, CharSequence charSequence, long j, TextRange textRange, TextLayoutResult textLayoutResult, Matrix matrix, Rect rect, Rect rect2, boolean z, boolean z2, boolean z3, boolean z4) {
        builder.reset();
        builder.setMatrix(matrix);
        int iM6715getMinimpl = TextRange.m6715getMinimpl(j);
        builder.setSelectionRange(iM6715getMinimpl, TextRange.m6714getMaximpl(j));
        if (z) {
            setInsertionMarker(builder, iM6715getMinimpl, textLayoutResult, rect);
        }
        if (z2) {
            int iM6715getMinimpl2 = textRange != null ? TextRange.m6715getMinimpl(textRange.getPackedValue()) : -1;
            int iM6714getMaximpl = textRange != null ? TextRange.m6714getMaximpl(textRange.getPackedValue()) : -1;
            if (iM6715getMinimpl2 >= 0 && iM6715getMinimpl2 < iM6714getMaximpl) {
                builder.setComposingText(iM6715getMinimpl2, charSequence.subSequence(iM6715getMinimpl2, iM6714getMaximpl));
                addCharacterBounds(builder, iM6715getMinimpl2, iM6714getMaximpl, textLayoutResult, rect);
            }
        }
    ...
    private static final CursorAnchorInfo.Builder setInsertionMarker(CursorAnchorInfo.Builder builder, int i, TextLayoutResult textLayoutResult, Rect rect) {
        ...
        float fCoerceIn = RangesKt.coerceIn(cursorRect.getLeft(), 0.0f, IntSize.m7426getWidthimpl(textLayoutResult.getSize()));
    ...
    */
    private static final android.view.inputmethod.CursorAnchorInfo.Builder addCharacterBounds(android.view.inputmethod.CursorAnchorInfo.Builder r14, int r15, int r16, androidx.compose.ui.text.TextLayoutResult r17, androidx.compose.ui.geometry.Rect r18) {
        /*
            ...
            r6 = 0
            r3.m6557fillBoundingBoxes8ffj60Q(r4, r2, r6)
            r3 = r15
        L17:
            if (r3 >= r0) goto L77
            int r4 = r3 - r15
