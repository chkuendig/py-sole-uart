...
public final class TextUndoOperationKt {
    public static final void undo(TextFieldState textFieldState, TextUndoOperation textUndoOperation) {
        ...
        mainBuffer.setSelection(TextRange.m6717getStartimpl(textUndoOperation.getPreSelection()), TextRange.m6712getEndimpl(textUndoOperation.getPreSelection()));
        textFieldState.updateValueAndNotifyListeners(textFieldState.getValue$foundation_release(), new TextFieldCharSequence(textFieldState.getMainBuffer().toString(), textFieldState.getMainBuffer().m1446getSelectiond9O1mEE(), textFieldState.getMainBuffer().m1445getCompositionMzsxiRA(), null, 8, null), true);
    }
    ...
    public static final void redo(TextFieldState textFieldState, TextUndoOperation textUndoOperation) {
        ...
        mainBuffer.setSelection(TextRange.m6717getStartimpl(textUndoOperation.getPostSelection()), TextRange.m6712getEndimpl(textUndoOperation.getPostSelection()));
        textFieldState.updateValueAndNotifyListeners(textFieldState.getValue$foundation_release(), new TextFieldCharSequence(textFieldState.getMainBuffer().toString(), textFieldState.getMainBuffer().m1446getSelectiond9O1mEE(), textFieldState.getMainBuffer().m1445getCompositionMzsxiRA(), null, 8, null), true);
    }
}
