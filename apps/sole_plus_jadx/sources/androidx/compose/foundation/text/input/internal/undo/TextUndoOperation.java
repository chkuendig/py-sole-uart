...
public final class TextUndoOperation {
    ...
    private static final Saver<TextUndoOperation, Object> Saver = new Saver<TextUndoOperation, Object>() { // from class: androidx.compose.foundation.text.input.internal.undo.TextUndoOperation$Companion$Saver$1
        ...
        public Object save(SaverScope saverScope, TextUndoOperation textUndoOperation) {
            return CollectionsKt.listOf(Integer.valueOf(textUndoOperation.getIndex()), textUndoOperation.getPreText(), textUndoOperation.getPostText(), Integer.valueOf(TextRange.m6717getStartimpl(textUndoOperation.getPreSelection())), Integer.valueOf(TextRange.m6712getEndimpl(textUndoOperation.getPreSelection())), Integer.valueOf(TextRange.m6717getStartimpl(textUndoOperation.getPostSelection())), Integer.valueOf(TextRange.m6712getEndimpl(textUndoOperation.getPostSelection())), Long.valueOf(textUndoOperation.getTimeInMillis()));
        }
    ...
    public final TextDeleteType getDeletionType() {
        if (this.textEditType == TextEditType.Delete && TextRange.m6711getCollapsedimpl(this.postSelection)) {
            if (TextRange.m6711getCollapsedimpl(this.preSelection)) {
                if (TextRange.m6717getStartimpl(this.preSelection) > TextRange.m6717getStartimpl(this.postSelection)) {
                    return TextDeleteType.Start;
                }
                return TextDeleteType.End;
            }
            if (TextRange.m6717getStartimpl(this.preSelection) == TextRange.m6717getStartimpl(this.postSelection) && TextRange.m6717getStartimpl(this.preSelection) == this.index) {
