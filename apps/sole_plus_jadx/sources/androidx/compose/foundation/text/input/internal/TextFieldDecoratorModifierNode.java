...
public final class TextFieldDecoratorModifierNode extends DelegatingNode implements PlatformTextInputModifierNode, SemanticsModifierNode, FocusRequesterModifierNode, FocusEventModifierNode, GlobalPositionAwareModifierNode, PointerInputModifierNode, KeyInputModifierNode, CompositionLocalConsumerModifierNode, ModifierLocalModifierNode, ObserverModifierNode, LayoutAwareModifierNode {
    ...
    private final DragAndDropModifierNode dragAndDropNode = (DragAndDropModifierNode) delegate(TextFieldDragAndDropNode_androidKt.textFieldDragAndDropNode(new Function0<Set<? extends MediaType>>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$dragAndDropNode$1
        ...
        public final Boolean invoke(ClipEntry clipEntry, ClipMetadata clipMetadata) {
            ...
            if (receiveContentConfiguration != null) {
                TransferableContent transferableContentOnReceive = receiveContentConfiguration.getReceiveContentListener().onReceive(new TransferableContent(clipEntry, clipMetadata, TransferableContent.Source.INSTANCE.m641getDragAndDropkB6V9T0(), null, 8, null));
        ...
        public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
            m1506invokek4lQ0M(offset.m4304unboximpl());
            return Unit.INSTANCE;
        }

        /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
        public final void m1506invokek4lQ0M(long j) {
            long jM1527fromWindowToDecorationUv8p0NA = TextLayoutStateKt.m1527fromWindowToDecorationUv8p0NA(this.this$0.getTextLayoutState(), j);
            this.this$0.getTextFieldState().m1537selectCharsIn5zctL8(TextRangeKt.TextRange(TextLayoutState.m1517getOffsetForPosition3MmeM6k$default(this.this$0.getTextLayoutState(), jM1527fromWindowToDecorationUv8p0NA, false, 2, null)));
            this.this$0.getTextFieldSelectionState().m1574updateHandleDraggingUv8p0NA(Handle.Cursor, jM1527fromWindowToDecorationUv8p0NA);
        }
    ...
    public TextFieldDecoratorModifierNode(TransformedTextFieldState transformedTextFieldState, TextLayoutState textLayoutState, TextFieldSelectionState textFieldSelectionState, InputTransformation inputTransformation, boolean z, boolean z2, final KeyboardOptions keyboardOptions, KeyboardActionHandler keyboardActionHandler, boolean z3, MutableInteractionSource mutableInteractionSource) {
        ...
        this.stylusHandwritingNode = (StylusHandwritingNode) delegate(new StylusHandwritingNode(new Function0<Boolean>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$stylusHandwritingNode$1
            ...
            public final Boolean invoke() {
                ...
                if (!KeyboardType.m6939equalsimpl0(keyboardOptions.getKeyboardType(), KeyboardType.INSTANCE.m6958getPasswordPjHm6EE()) && !KeyboardType.m6939equalsimpl0(keyboardOptions.getKeyboardType(), KeyboardType.INSTANCE.m6957getNumberPasswordPjHm6EE()) && (stylusHandwritingTrigger = this.this$0.getStylusHandwritingTrigger()) != null) {
    ...
    public void applySemantics(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        ...
        SemanticsPropertiesKt.m6484setTextSelectionRangeFDrldGo(semanticsPropertyReceiver, selection);
        if (!this.enabled) {
        ...
        SemanticsPropertiesKt.setSelection$default(semanticsPropertyReceiver, null, new Function3<Integer, Integer, Boolean, Boolean>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode.applySemantics.4
            ...
            public final Boolean invoke(int i, int i2, boolean z) {
                ...
                if (i == TextRange.m6717getStartimpl(selection2) && i2 == TextRange.m6712getEndimpl(selection2)) {
                    return true;
                }
                ...
                if (z) {
                    TextFieldDecoratorModifierNode.this.getTextFieldState().m1538selectUntransformedCharsIn5zctL8(jTextRange);
                } else {
                    TextFieldDecoratorModifierNode.this.getTextFieldState().m1537selectCharsIn5zctL8(jTextRange);
                }
                return true;
            }
        }, 1, null);
        final int iM1316getImeActionOrDefaulteUduSuo$foundation_release = this.keyboardOptions.m1316getImeActionOrDefaulteUduSuo$foundation_release();
        SemanticsPropertiesKt.m6480onImeAction9UiTYpY$default(semanticsPropertyReceiver, iM1316getImeActionOrDefaulteUduSuo$foundation_release, null, new Function0<Boolean>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode.applySemantics.5
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
            ...
            @Override // kotlin.jvm.functions.Function0
            public final Boolean invoke() {
                TextFieldDecoratorModifierNode.this.m1505onImeActionPerformedKlQnJC8(iM1316getImeActionOrDefaulteUduSuo$foundation_release);
                return true;
            }
        }, 2, null);
        ...
        if (!TextRange.m6711getCollapsedimpl(selection)) {
    ...
    public final void onFocusChange() {
        ...
        if (isFocused() && this.observeChangesJob == null) {
            this.observeChangesJob = BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new C04611(null), 3, null);
        } else {
            if (isFocused()) {
                return;
            }
    ...
    @DebugMetadata(c = "androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$onFocusChange$1", f = "TextFieldDecoratorModifier.kt", i = {}, l = {WinError.ERROR_CORRUPT_SYSTEM_FILE}, m = "invokeSuspend", n = {}, s = {})
    ...
    static final class C04611 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return TextFieldDecoratorModifierNode.this.new C04611(continuation);
        }
    ...
    public final void startInputSession(boolean fromTap) {
        if (fromTap || this.keyboardOptions.getShowKeyboardOnFocusOrDefault$foundation_release()) {
            this.inputSessionJob = BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new C04631(ReceiveContentConfigurationKt.getReceiveContentConfiguration(this), null), 3, null);
        }
    }
    ...
    static final class C04631 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04631(ReceiveContentConfiguration receiveContentConfiguration, Continuation<? super C04631> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return TextFieldDecoratorModifierNode.this.new C04631(this.$receiveContentConfiguration, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                this.label = 1;
                if (PlatformTextInputModifierNodeKt.establishTextInputSession(TextFieldDecoratorModifierNode.this, new C00561(TextFieldDecoratorModifierNode.this, this.$receiveContentConfiguration, null), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (i != 1) {
        ...
        @DebugMetadata(c = "androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$startInputSession$1$1", f = "TextFieldDecoratorModifier.kt", i = {}, l = {WinError.ERROR_RECEIVE_EXPEDITED}, m = "invokeSuspend", n = {}, s = {})
        ...
        static final class C00561 extends SuspendLambda implements Function2<PlatformTextInputSessionScope, Continuation<?>, Object> {
            final /* synthetic */ ReceiveContentConfiguration $receiveContentConfiguration;
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00561(TextFieldDecoratorModifierNode textFieldDecoratorModifierNode, ReceiveContentConfiguration receiveContentConfiguration, Continuation<? super C00561> continuation) {
                super(2, continuation);
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                C00561 c00561 = new C00561(this.this$0, this.$receiveContentConfiguration, continuation);
                c00561.L$0 = obj;
                return c00561;
            }
            ...
            public final Object invoke(PlatformTextInputSessionScope platformTextInputSessionScope, Continuation<?> continuation) {
                return ((C00561) create(platformTextInputSessionScope, continuation)).invokeSuspend(Unit.INSTANCE);
            }
            ...
            /* synthetic */ class C00571 extends FunctionReferenceImpl implements Function1<ImeAction, Unit> {
                C00571(Object obj) {
    ...
    public final void m1505onImeActionPerformedKlQnJC8(final int imeAction) {
        ...
        if (ImeAction.m6886equalsimpl0(imeAction, ImeAction.INSTANCE.m6903getNoneeUduSuo()) || ImeAction.m6886equalsimpl0(imeAction, ImeAction.INSTANCE.m6899getDefaulteUduSuo()) || (keyboardActionHandler = this.keyboardActionHandler) == null) {
            ...
            keyboardActionHandler.onKeyboardAction(new Function0<Unit>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$onImeActionPerformed$1
                ...
                /* renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2() {
                    this.this$0.keyboardActionScope.mo1302defaultKeyboardActionKlQnJC8(imeAction);
                }
            });
        }
    }
