...
public final class TextFieldBuffer implements Appendable {
    ...
    public interface ChangeList {
        ...
        long mo1409getOriginalRangejx7JFs(int changeIndex);

        /* renamed from: getRange--jx7JFs, reason: not valid java name */
        long mo1410getRangejx7JFs(int changeIndex);
    }
    ...
    public final long m1405getOriginalSelectiond9O1mEE() {
    ...
    public final boolean hasSelection() {
        return !TextRange.m6711getCollapsedimpl(getSelectionInChars());
    }
    ...
    public final void m1407setSelection5zctL8(long j) {
        m1403requireValidRange5zctL8(j);
    ...
    private final void onTextWillChange(int replaceStart, int replaceEnd, int newLength) {
        ...
        int iM6715getMinimpl = TextRange.m6715getMinimpl(getSelectionInChars());
        int iM6714getMaximpl = TextRange.m6714getMaximpl(getSelectionInChars());
        if (iM6714getMaximpl < iMin) {
            return;
        }
        if (iM6715getMinimpl <= iMin && iMax <= iM6714getMaximpl) {
            i = newLength - (iMax - iMin);
            if (iM6715getMinimpl == iM6714getMaximpl) {
                iM6715getMinimpl += i;
            }
            iMin = iM6714getMaximpl + i;
        } else if (iM6715getMinimpl > iMin && iM6714getMaximpl < iMax) {
            iMin += newLength;
            iM6715getMinimpl = iMin;
        } else if (iM6715getMinimpl >= iMax) {
            i = newLength - (iMax - iMin);
            iM6715getMinimpl += i;
            iMin = iM6714getMaximpl + i;
        } else if (iMin < iM6715getMinimpl) {
            iM6715getMinimpl = iMin + newLength;
            i = newLength - (iMax - iMin);
            iMin = iM6714getMaximpl + i;
        }
        this.selectionInChars = TextRangeKt.TextRange(iM6715getMinimpl, iMin);
    }
    ...
    public final void revertAllChanges() {
        ...
        m1407setSelection5zctL8(this.originalValue.getSelection());
        clearChangeList();
    }
    ...
    public static /* synthetic */ TextFieldCharSequence m1404toTextFieldCharSequenceudt6zUU$foundation_release$default(TextFieldBuffer textFieldBuffer, long j, TextRange textRange, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textFieldBuffer.m1408toTextFieldCharSequenceudt6zUU$foundation_release(j, textRange);
    }

    /* renamed from: toTextFieldCharSequence-udt6zUU$foundation_release, reason: not valid java name */
    public final TextFieldCharSequence m1408toTextFieldCharSequenceudt6zUU$foundation_release(long selection, TextRange composition) {
    ...
    private final void m1403requireValidRange5zctL8(long range) {
        long jTextRange = TextRangeKt.TextRange(0, getLength());
        if (!TextRange.m6707contains5zctL8(jTextRange, range)) {
            throw new IllegalArgumentException(("Expected " + ((Object) TextRange.m6720toStringimpl(range)) + " to be in " + ((Object) TextRange.m6720toStringimpl(jTextRange))).toString());
        }
    }
}
