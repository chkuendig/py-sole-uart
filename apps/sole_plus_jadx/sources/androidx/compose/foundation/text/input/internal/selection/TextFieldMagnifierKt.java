...
public final class TextFieldMagnifierKt {
    ...
    public static final long m1549calculateSelectionMagnifierCenterAndroidhUlJWOE(TransformedTextFieldState transformedTextFieldState, TextFieldSelectionState textFieldSelectionState, TextLayoutState textLayoutState, long j) {
        int iM6717getStartimpl;
        long jM1573getHandleDragPositionF1C5BW0 = textFieldSelectionState.m1573getHandleDragPositionF1C5BW0();
        if (OffsetKt.m4315isUnspecifiedk4lQ0M(jM1573getHandleDragPositionF1C5BW0) || transformedTextFieldState.getVisualText().length() == 0) {
        ...
        if (i == 1 || i == 2) {
            iM6717getStartimpl = TextRange.m6717getStartimpl(selection);
        } else {
            if (i != 3) {
                throw new NoWhenBranchMatchedException();
            }
            iM6717getStartimpl = TextRange.m6712getEndimpl(selection);
        }
        TextLayoutResult layoutResult = textLayoutState.getLayoutResult();
        if (layoutResult == null) {
            return Offset.INSTANCE.m4309getUnspecifiedF1C5BW0();
        }
        float fM4294getXimpl = Offset.m4294getXimpl(jM1573getHandleDragPositionF1C5BW0);
        int lineForOffset = layoutResult.getLineForOffset(iM6717getStartimpl);
        ...
        if (textLayoutNodeCoordinates != null) {
            ...
            if (textLayoutNodeCoordinates != null) {
                jOffset = TextLayoutStateKt.m1524coerceIn3MmeM6k(jOffset, SelectionManagerKt.visibleBounds(textLayoutNodeCoordinates));
            }
        }
        return TextLayoutStateKt.m1526fromTextLayoutToCoreUv8p0NA(textLayoutState, jOffset);
    }
}
