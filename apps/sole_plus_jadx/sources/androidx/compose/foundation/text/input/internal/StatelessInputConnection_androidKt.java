...
public final class StatelessInputConnection_androidKt {
    ...
    public static final ExtractedText toExtractedText(TextFieldCharSequence textFieldCharSequence) {
        ...
        extractedText.selectionStart = TextRange.m6715getMinimpl(textFieldCharSequence.getSelection());
        extractedText.selectionEnd = TextRange.m6714getMaximpl(textFieldCharSequence.getSelection());
    ...
    public static final TransferableContent toTransferableContent(InputContentInfoCompat inputContentInfoCompat, Bundle bundle) {
        ...
        int iM642getKeyboardkB6V9T0 = TransferableContent.Source.INSTANCE.m642getKeyboardkB6V9T0();
        ...
        return new TransferableContent(clipEntry, clipMetadata, iM642getKeyboardkB6V9T0, new PlatformTransferableContent(linkUri, bundle), null);
    }
}
