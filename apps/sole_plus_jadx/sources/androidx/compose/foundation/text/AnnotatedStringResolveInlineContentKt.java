    ...
    public static final void InlineChildren(final AnnotatedString annotatedString, final List<AnnotatedString.Range<Function3<String, Composer, Integer, Unit>>> list, Composer composer, final int i) {
        ...
        if ((i2 & 19) != 18 || !composerStartRestartGroup.getSkipping()) {
            ...
            while (i4 < size) {
                ...
                AnnotatedStringResolveInlineContentKt$InlineChildren$1$2 annotatedStringResolveInlineContentKt$InlineChildren$1$2 = new MeasurePolicy() { // from class: androidx.compose.foundation.text.AnnotatedStringResolveInlineContentKt$InlineChildren$1$2
                    ...
                    public final MeasureResult mo342measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list2, long j) {
                        ...
                        for (int i5 = 0; i5 < size2; i5++) {
                            arrayList.add(list2.get(i5).mo5957measureBRTryo0(j));
                        }
                        final ArrayList arrayList2 = arrayList;
                        return MeasureScope.layout$default(measureScope, Constraints.m7208getMaxWidthimpl(j), Constraints.m7207getMaxHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.AnnotatedStringResolveInlineContentKt$InlineChildren$1$2.1
                ...
                Updater.m3864setimpl(composerM3857constructorimpl, annotatedStringResolveInlineContentKt$InlineChildren$1$2, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
