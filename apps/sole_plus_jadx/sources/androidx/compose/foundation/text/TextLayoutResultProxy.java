...
public final class TextLayoutResultProxy {
    ...
    public static /* synthetic */ int m1394getOffsetForPosition3MmeM6k$default(TextLayoutResultProxy textLayoutResultProxy, long j, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        return textLayoutResultProxy.m1395getOffsetForPosition3MmeM6k(j, z);
    }

    /* renamed from: getOffsetForPosition-3MmeM6k, reason: not valid java name */
    public final int m1395getOffsetForPosition3MmeM6k(long position, boolean coerceInVisibleBounds) {
        if (coerceInVisibleBounds) {
            position = m1393coercedInVisibleBoundsOfInputTextMKHz9U(position);
        }
        return this.value.m6687getOffsetForPositionk4lQ0M(m1397translateDecorationToInnerCoordinatesMKHz9U$foundation_release(position));
    }

    public final int getLineForVerticalPosition(float vertical) {
        return this.value.getLineForVerticalPosition(Offset.m4295getYimpl(m1397translateDecorationToInnerCoordinatesMKHz9U$foundation_release(m1393coercedInVisibleBoundsOfInputTextMKHz9U(OffsetKt.Offset(0.0f, vertical)))));
    }
    ...
    public final boolean m1396isPositionOnTextk4lQ0M(long offset) {
        long jM1397translateDecorationToInnerCoordinatesMKHz9U$foundation_release = m1397translateDecorationToInnerCoordinatesMKHz9U$foundation_release(m1393coercedInVisibleBoundsOfInputTextMKHz9U(offset));
        int lineForVerticalPosition = this.value.getLineForVerticalPosition(Offset.m4295getYimpl(jM1397translateDecorationToInnerCoordinatesMKHz9U$foundation_release));
        return Offset.m4294getXimpl(jM1397translateDecorationToInnerCoordinatesMKHz9U$foundation_release) >= this.value.getLineLeft(lineForVerticalPosition) && Offset.m4294getXimpl(jM1397translateDecorationToInnerCoordinatesMKHz9U$foundation_release) <= this.value.getLineRight(lineForVerticalPosition);
    }

    /* renamed from: translateDecorationToInnerCoordinates-MK-Hz9U$foundation_release, reason: not valid java name */
    public final long m1397translateDecorationToInnerCoordinatesMKHz9U$foundation_release(long offset) {
        ...
        return layoutCoordinates3 == null ? offset : layoutCoordinates2.mo5966localPositionOfR5De75A(layoutCoordinates3, offset);
    }

    /* renamed from: translateInnerToDecorationCoordinates-MK-Hz9U$foundation_release, reason: not valid java name */
    public final long m1398translateInnerToDecorationCoordinatesMKHz9U$foundation_release(long offset) {
        LayoutCoordinates layoutCoordinates;
        LayoutCoordinates layoutCoordinates2 = this.innerTextFieldCoordinates;
        if (layoutCoordinates2 == null) {
            return offset;
        ...
        LayoutCoordinates layoutCoordinates3 = layoutCoordinates.isAttached() ? layoutCoordinates : null;
        return layoutCoordinates3 == null ? offset : layoutCoordinates3.mo5966localPositionOfR5De75A(layoutCoordinates2, offset);
    }
    ...
    */
    private final long m1393coercedInVisibleBoundsOfInputTextMKHz9U(long r6) {
        /*
            r5 = this;
        ...
        L1e:
            ...
            androidx.compose.ui.geometry.Rect r2 = r0.getZero()
        L24:
            long r6 = androidx.compose.foundation.text.TextLayoutResultProxyKt.m1399access$coerceIn3MmeM6k(r6, r2)
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.TextLayoutResultProxy.m1393coercedInVisibleBoundsOfInputTextMKHz9U(long):long");
    }
}
