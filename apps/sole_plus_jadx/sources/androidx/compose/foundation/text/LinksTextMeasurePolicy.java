...
final class LinksTextMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo342measure3p2s80s(MeasureScope measureScope, final List<? extends Measurable> list, long j) {
        return MeasureScope.layout$default(measureScope, Constraints.m7208getMaxWidthimpl(j), Constraints.m7207getMaxHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.LinksTextMeasurePolicy$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                if (listMeasureWithTextRangeMeasureConstraints != null) {
                    ...
                    for (int i = 0; i < size; i++) {
                        ...
                        Placeable.PlacementScope.m6022place70tqf50$default(placementScope, placeable, function0 != null ? ((IntOffset) function0.invoke()).m7392unboximpl() : IntOffset.INSTANCE.m7394getZeronOccac(), 0.0f, 2, null);
                    }
                }
            }
        }, 4, null);
