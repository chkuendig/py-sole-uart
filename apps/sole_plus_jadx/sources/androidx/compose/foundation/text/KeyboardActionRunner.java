...
public final class KeyboardActionRunner implements KeyboardActionScope {
    ...
    public final void m1303runActionKlQnJC8(int imeAction) {
        Function1<KeyboardActionScope, Unit> onSend;
        Unit unit = null;
        if (ImeAction.m6886equalsimpl0(imeAction, ImeAction.INSTANCE.m6900getDoneeUduSuo())) {
            ...
            if (!(ImeAction.m6886equalsimpl0(imeAction, ImeAction.INSTANCE.m6899getDefaulteUduSuo()) ? true : ImeAction.m6886equalsimpl0(imeAction, ImeAction.INSTANCE.m6903getNoneeUduSuo()))) {
        ...
        if (unit == null) {
            mo1302defaultKeyboardActionKlQnJC8(imeAction);
        }
    }

    @Override // androidx.compose.foundation.text.KeyboardActionScope
    /* renamed from: defaultKeyboardAction-KlQnJC8, reason: not valid java name */
    public void mo1302defaultKeyboardActionKlQnJC8(int imeAction) {
        if (ImeAction.m6886equalsimpl0(imeAction, ImeAction.INSTANCE.m6902getNexteUduSuo())) {
            getFocusManager().mo4187moveFocus3ESFkO8(FocusDirection.INSTANCE.m4181getNextdhqQ8s());
            return;
        }
        if (ImeAction.m6886equalsimpl0(imeAction, ImeAction.INSTANCE.m6904getPreviouseUduSuo())) {
            getFocusManager().mo4187moveFocus3ESFkO8(FocusDirection.INSTANCE.m4182getPreviousdhqQ8s());
            return;
        }
        if (!ImeAction.m6886equalsimpl0(imeAction, ImeAction.INSTANCE.m6900getDoneeUduSuo())) {
            if (ImeAction.m6886equalsimpl0(imeAction, ImeAction.INSTANCE.m6901getGoeUduSuo()) ? true : ImeAction.m6886equalsimpl0(imeAction, ImeAction.INSTANCE.m6905getSearcheUduSuo()) ? true : ImeAction.m6886equalsimpl0(imeAction, ImeAction.INSTANCE.m6906getSendeUduSuo()) ? true : ImeAction.m6886equalsimpl0(imeAction, ImeAction.INSTANCE.m6899getDefaulteUduSuo())) {
                return;
            }
            ImeAction.m6886equalsimpl0(imeAction, ImeAction.INSTANCE.m6903getNoneeUduSuo());
        } else {
