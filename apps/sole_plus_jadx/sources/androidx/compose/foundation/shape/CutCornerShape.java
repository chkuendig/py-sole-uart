...
public final class CutCornerShape extends CornerBasedShape {
    ...
    public Outline mo1251createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        ...
        Path.lineTo(Size.m4363getWidthimpl(size) - topStart, 0.0f);
        Path.lineTo(Size.m4363getWidthimpl(size), topStart);
        float f2 = layoutDirection == LayoutDirection.Ltr ? bottomEnd : bottomStart;
        Path.lineTo(Size.m4363getWidthimpl(size), Size.m4360getHeightimpl(size) - f2);
        Path.lineTo(Size.m4363getWidthimpl(size) - f2, Size.m4360getHeightimpl(size));
        if (layoutDirection == LayoutDirection.Ltr) {
            bottomEnd = bottomStart;
        }
        Path.lineTo(bottomEnd, Size.m4360getHeightimpl(size));
        Path.lineTo(0.0f, Size.m4360getHeightimpl(size) - bottomEnd);
        Path.close();
