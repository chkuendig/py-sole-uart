...
public final class RoundedCornerShapeKt {
    ...
    public static final RoundedCornerShape m1268RoundedCornerShape0680j_4(float f) {
        return RoundedCornerShape(CornerSizeKt.m1260CornerSize0680j_4(f));
    }
    ...
    public static final RoundedCornerShape m1269RoundedCornerShapea9UjIt4(float f, float f2, float f3, float f4) {
        return new RoundedCornerShape(CornerSizeKt.m1260CornerSize0680j_4(f), CornerSizeKt.m1260CornerSize0680j_4(f2), CornerSizeKt.m1260CornerSize0680j_4(f3), CornerSizeKt.m1260CornerSize0680j_4(f4));
    }
    ...
    public static /* synthetic */ RoundedCornerShape m1270RoundedCornerShapea9UjIt4$default(float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m1269RoundedCornerShapea9UjIt4(f, f2, f3, f4);
    }
}
