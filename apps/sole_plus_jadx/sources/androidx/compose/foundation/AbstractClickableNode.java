...
public abstract class AbstractClickableNode extends DelegatingNode implements PointerInputModifierNode, KeyInputModifierNode, FocusEventModifierNode, SemanticsModifierNode, TraversableNode {
    ...
    private AbstractClickableNode(MutableInteractionSource mutableInteractionSource, IndicationNodeFactory indicationNodeFactory, boolean z, String str, Role role, Function0<Unit> function0) {
        ...
        this.centerOffset = Offset.INSTANCE.m4310getZeroF1C5BW0();
    ...
    */
    protected final void m515updateCommonQzZPfjk(androidx.compose.foundation.interaction.MutableInteractionSource r3, androidx.compose.foundation.IndicationNodeFactory r4, boolean r5, java.lang.String r6, androidx.compose.ui.semantics.Role r7, kotlin.jvm.functions.Function0<kotlin.Unit> r8) {
        /*
            r2 = this;
    ...
    public final void mo513onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        long jM7432getCenterozmzZPI = IntSizeKt.m7432getCenterozmzZPI(bounds);
        this.centerOffset = OffsetKt.Offset(IntOffset.m7383getXimpl(jM7432getCenterozmzZPI), IntOffset.m7384getYimpl(jM7432getCenterozmzZPI));
        initializeIndicationAndInteractionSourceIfNeeded();
        if (this.enabled && pass == PointerEventPass.Main) {
            int type = pointerEvent.getType();
            if (PointerEventType.m5778equalsimpl0(type, PointerEventType.INSTANCE.m5782getEnter7fucELk())) {
            ...
            } else if (PointerEventType.m5778equalsimpl0(type, PointerEventType.INSTANCE.m5783getExit7fucELk())) {
    ...
    public final boolean mo512onKeyEventZmokQxo(KeyEvent event) {
        ...
        if (this.enabled && Clickable_androidKt.m587isPressZmokQxo(event)) {
            if (!this.currentKeyPressInteractions.containsKey(Key.m5373boximpl(KeyEvent_androidKt.m5684getKeyZmokQxo(event)))) {
                PressInteraction.Press press = new PressInteraction.Press(this.centerOffset, null);
                this.currentKeyPressInteractions.put(Key.m5373boximpl(KeyEvent_androidKt.m5684getKeyZmokQxo(event)), press);
                if (this.interactionSource == null) {
                    return true;
                }
            ...
            PressInteraction.Press pressRemove = this.currentKeyPressInteractions.remove(Key.m5373boximpl(KeyEvent_androidKt.m5684getKeyZmokQxo(event)));
    ...
    protected final Object m511handlePressInteractiond4ec7I(PressGestureScope pressGestureScope, long j, Continuation<? super Unit> continuation) {
