...
public final class TransferableContent {
    ...
    public static final class Source {
        ...
        private static final int Keyboard = m634constructorimpl(0);
        private static final int DragAndDrop = m634constructorimpl(1);
        private static final int Clipboard = m634constructorimpl(2);

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ Source m633boximpl(int i) {
            return new Source(i);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static int m634constructorimpl(int i) {
            return i;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m635equalsimpl(int i, Object obj) {
        ...
        public static int m637hashCodeimpl(int i) {
        ...
        public int hashCode() {
            return m637hashCodeimpl(this.value);
        }
        ...
        public static String m638toStringimpl(int i) {
            return m636equalsimpl0(i, Keyboard) ? "Source.Keyboard" : m636equalsimpl0(i, DragAndDrop) ? "Source.DragAndDrop" : m636equalsimpl0(i, Clipboard) ? "Source.Clipboard" : "Invalid (" + i + ')';
        }
    }
}
