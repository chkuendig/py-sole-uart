...
final class AndroidEmbeddedExternalSurfaceState extends BaseAndroidExternalSurfaceState implements TextureView.SurfaceTextureListener {
    ...
    public AndroidEmbeddedExternalSurfaceState(CoroutineScope coroutineScope) {
        ...
        this.surfaceSize = IntSize.INSTANCE.m7431getZeroYbymL2g();
    ...
    public final void m526setSurfaceSizeozmzZPI(long j) {
        this.surfaceSize = j;
    }
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int width, int height) {
        if (!IntSize.m7424equalsimpl0(this.surfaceSize, IntSize.INSTANCE.m7431getZeroYbymL2g())) {
            width = IntSize.m7426getWidthimpl(this.surfaceSize);
            height = IntSize.m7425getHeightimpl(this.surfaceSize);
