...
public final class ContextMenuGestures_androidKt {
    ...
    static final class C03441 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ ContextMenuState $state;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03441(ContextMenuState contextMenuState, Continuation<? super C03441> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C03441 c03441 = new C03441(this.$state, continuation);
            c03441.L$0 = obj;
            return c03441;
        }
        ...
        public final Object invoke(PointerInputScope pointerInputScope, Continuation<? super Unit> continuation) {
            return ((C03441) create(pointerInputScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
            ...
            if (i == 0) {
                ...
                if (ContextMenuGestures_androidKt.onRightClickDown(pointerInputScope, new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.contextmenu.ContextMenuGestures_androidKt.contextMenuGestures.1.1
                    ...
                    public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                        m648invokek4lQ0M(offset.m4304unboximpl());
                        return Unit.INSTANCE;
                    }

                    /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
                    public final void m648invokek4lQ0M(long j) {
    ...
    public static final Modifier contextMenuGestures(Modifier modifier, ContextMenuState contextMenuState) {
        return modifier.then(new SuspendPointerInputElement(ContextMenuKey.INSTANCE, null, null, new SuspendingPointerInputFilterKt$sam$androidx_compose_ui_input_pointer_PointerInputEventHandler$0(new C03441(contextMenuState, null)), 6, null));
    }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r8) {
            ...
            L38:
                ...
                androidx.compose.ui.geometry.Offset r8 = androidx.compose.ui.geometry.Offset.m4283boximpl(r5)
                r4.invoke(r8)
                r8 = r7
                kotlin.coroutines.Continuation r8 = (kotlin.coroutines.Continuation) r8
                r4 = 0
    ...
    */
    public static final java.lang.Object awaitFirstRightClickDown(androidx.compose.ui.input.pointer.AwaitPointerEventScope r8, kotlin.coroutines.Continuation<? super androidx.compose.ui.input.pointer.PointerInputChange> r9) {
        ...
        L45:
            ...
            boolean r2 = androidx.compose.ui.input.pointer.PointerEvent_androidKt.m5804isSecondaryPressedaHzCxE(r2)
            if (r2 == 0) goto L39
