...
public final class ContextMenuPopupPositionProvider implements PopupPositionProvider {
    ...
    public long mo649calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        return IntOffsetKt.IntOffset(ContextMenuPopupPositionProvider_androidKt.alignPopupAxis(anchorBounds.getLeft() + IntOffset.m7383getXimpl(this.localPosition), IntSize.m7426getWidthimpl(popupContentSize), IntSize.m7426getWidthimpl(windowSize), layoutDirection == LayoutDirection.Ltr), ContextMenuPopupPositionProvider_androidKt.alignPopupAxis$default(anchorBounds.getTop() + IntOffset.m7384getYimpl(this.localPosition), IntSize.m7425getHeightimpl(popupContentSize), IntSize.m7425getHeightimpl(windowSize), false, 8, null));
    }
}
