...
final class DrawStretchOverscrollModifier extends InspectorValueInfo implements DrawModifier {
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        this.overscrollEffect.m524updateSizeuvyYCjk$foundation_release(contentDrawScope.mo5117getSizeNHjbRc());
        if (Size.m4365isEmptyimpl(contentDrawScope.mo5117getSizeNHjbRc())) {
            contentDrawScope.drawContent();
            return;
        }
        this.overscrollEffect.getRedrawSignal$foundation_release().getValue();
        float f = contentDrawScope.mo677toPx0680j_4(ClipScrollableContainerKt.getMaxSupportedElevation());
        ...
        if (edgeEffectWrapper.isLeftAnimating()) {
            ...
            if (edgeEffectWrapper.isLeftStretched()) {
                EdgeEffectCompat.INSTANCE.onPullDistanceCompat(edgeEffectWrapper.getOrCreateLeftEffectNegation(), EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateLeftEffect), 1 - Offset.m4295getYimpl(this.overscrollEffect.m523displacementF1C5BW0$foundation_release()));
            }
        } else {
        ...
        if (edgeEffectWrapper.isTopAnimating()) {
            ...
            if (edgeEffectWrapper.isTopStretched()) {
                EdgeEffectCompat.INSTANCE.onPullDistanceCompat(edgeEffectWrapper.getOrCreateTopEffectNegation(), EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateTopEffect), Offset.m4294getXimpl(this.overscrollEffect.m523displacementF1C5BW0$foundation_release()));
            }
        }
        ...
        if (edgeEffectWrapper.isRightAnimating()) {
            ...
            if (edgeEffectWrapper.isRightStretched()) {
                EdgeEffectCompat.INSTANCE.onPullDistanceCompat(edgeEffectWrapper.getOrCreateRightEffectNegation(), EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateRightEffect), Offset.m4295getYimpl(this.overscrollEffect.m523displacementF1C5BW0$foundation_release()));
            }
        }
        ...
        if (edgeEffectWrapper.isBottomAnimating()) {
            ...
            if (edgeEffectWrapper.isBottomStretched()) {
                EdgeEffectCompat.INSTANCE.onPullDistanceCompat(edgeEffectWrapper.getOrCreateBottomEffectNegation(), EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateBottomEffect), 1 - Offset.m4294getXimpl(this.overscrollEffect.m523displacementF1C5BW0$foundation_release()));
            }
            zDrawLeftStretch = z;
        }
        if (zDrawLeftStretch) {
        ...
        long j = contentDrawScope.mo5117getSizeNHjbRc();
        ...
        long jMo5038getSizeNHjbRc = contentDrawScope2.getDrawContext().mo5038getSizeNHjbRc();
