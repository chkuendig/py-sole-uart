...
final class CombinedClickableElement extends ModifierNodeElement<CombinedClickableNodeImpl> {
    ...
    public void update(CombinedClickableNodeImpl node) {
        node.mo589updatenSzSaCc(this.onClick, this.onLongClickLabel, this.onLongClick, this.onDoubleClick, this.interactionSource, this.indicationNodeFactory, this.enabled, this.onClickLabel, this.role);
    }
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set(SdkConstants.ATTR_ON_CLICK, this.onClick);
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        int iM6461hashCodeimpl = (((iHashCode3 + (role != null ? Role.m6461hashCodeimpl(role.getValue()) : 0)) * 31) + this.onClick.hashCode()) * 31;
        String str2 = this.onLongClickLabel;
        int iHashCode4 = (iM6461hashCodeimpl + (str2 != null ? str2.hashCode() : 0)) * 31;
