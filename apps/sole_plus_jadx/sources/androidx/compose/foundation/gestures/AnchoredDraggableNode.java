...
final class AnchoredDraggableNode<T> extends DragGestureNode {
                ...
                Function1<DragEvent.DragDelta, Unit> function1 = new Function1<DragEvent.DragDelta, Unit>() { // from class: androidx.compose.foundation.gestures.AnchoredDraggableNode.drag.2.1
                    ...
                    public final void invoke2(DragEvent.DragDelta dragDelta) {
                        if (((AnchoredDraggableNode) anchoredDraggableNode).overscrollEffect != null) {
                            ...
                            long jM689reverseIfNeededMKHz9U = anchoredDraggableNode.m689reverseIfNeededMKHz9U(dragDelta.getDelta());
                            int iM5721getUserInputWNlRxjI = NestedScrollSource.INSTANCE.m5721getUserInputWNlRxjI();
                            ...
                            overscrollEffect.mo522applyToScrollRhakbz0(jM689reverseIfNeededMKHz9U, iM5721getUserInputWNlRxjI, new Function1<Offset, Offset>() { // from class: androidx.compose.foundation.gestures.AnchoredDraggableNode.drag.2.1.1
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                {
                                    super(1);
                                }
                                ...
                                public /* bridge */ /* synthetic */ Offset invoke(Offset offset) {
                                    return Offset.m4283boximpl(m696invokeMKHz9U(offset.m4304unboximpl()));
                                }

                                /* renamed from: invoke-MK-Hz9U, reason: not valid java name */
                                public final long m696invokeMKHz9U(long j) {
                                    float fNewOffsetForDelta$foundation_release = ((AnchoredDraggableNode) anchoredDraggableNode2).state.newOffsetForDelta$foundation_release(anchoredDraggableNode2.m691toFloatk4lQ0M(j));
                                    AnchoredDraggableNode<T> anchoredDraggableNode3 = anchoredDraggableNode2;
                                    long jM692toOffsettuRUvjQ = anchoredDraggableNode3.m692toOffsettuRUvjQ(fNewOffsetForDelta$foundation_release - ((AnchoredDraggableNode) anchoredDraggableNode3).state.requireOffset());
                                    AnchoredDragScope.dragTo$default(anchoredDragScope2, fNewOffsetForDelta$foundation_release, 0.0f, 2, null);
                                    return jM692toOffsettuRUvjQ;
                                }
                            });
                            return;
                        }
                        ...
                        AnchoredDragScope.dragTo$default(anchoredDragScope3, anchoredDraggableState.newOffsetForDelta$foundation_release(anchoredDraggableNode3.m691toFloatk4lQ0M(anchoredDraggableNode3.m689reverseIfNeededMKHz9U(dragDelta.getDelta()))), 0.0f, 2, null);
                    }
                };
                this.label = 1;
    ...
    public final float m690toFloatTH1AsA0(long j) {
        return this.orientation == Orientation.Vertical ? Velocity.m7494getYimpl(j) : Velocity.m7493getXimpl(j);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: toFloat-k-4lQ0M, reason: not valid java name */
    public final float m691toFloatk4lQ0M(long j) {
        return this.orientation == Orientation.Vertical ? Offset.m4295getYimpl(j) : Offset.m4294getXimpl(j);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: reverseIfNeeded-AH228Gc, reason: not valid java name */
    public final long m688reverseIfNeededAH228Gc(long j) {
        return Velocity.m7499timesadjELrA(j, isReverseDirection() ? -1.0f : 1.0f);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: reverseIfNeeded-MK-Hz9U, reason: not valid java name */
    public final long m689reverseIfNeededMKHz9U(long j) {
        return Offset.m4301timestuRUvjQ(j, isReverseDirection() ? -1.0f : 1.0f);
    }
}
