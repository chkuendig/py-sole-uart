...
final class AndroidConfig implements ScrollConfig {
    ...
    public long mo698calculateMouseWheelScroll8xgXZGE(Density density, PointerEvent pointerEvent, long j) {
        List<PointerInputChange> changes = pointerEvent.getChanges();
        Offset offsetM4283boximpl = Offset.m4283boximpl(Offset.INSTANCE.m4310getZeroF1C5BW0());
        int size = changes.size();
        for (int i = 0; i < size; i++) {
            offsetM4283boximpl = Offset.m4283boximpl(Offset.m4299plusMKHz9U(offsetM4283boximpl.m4304unboximpl(), changes.get(i).getScrollDelta()));
        }
        return Offset.m4301timestuRUvjQ(offsetM4283boximpl.m4304unboximpl(), -density.mo677toPx0680j_4(Dp.m7255constructorimpl(64)));
    }
}
