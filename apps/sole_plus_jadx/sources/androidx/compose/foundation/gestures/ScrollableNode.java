...
final class ScrollableNode extends DragGestureNode implements ObserverModifierNode, CompositionLocalConsumerModifierNode, FocusPropertiesModifierNode, KeyInputModifierNode, SemanticsModifierNode {
    ...
    public boolean mo512onKeyEventZmokQxo(KeyEvent event) {
        long jOffset;
        if (!getEnabled() || ((!Key.m5376equalsimpl0(KeyEvent_androidKt.m5684getKeyZmokQxo(event), Key.INSTANCE.m5564getPageDownEK5gGoQ()) && !Key.m5376equalsimpl0(KeyEvent_androidKt.m5684getKeyZmokQxo(event), Key.INSTANCE.m5565getPageUpEK5gGoQ())) || !KeyEventType.m5677equalsimpl0(KeyEvent_androidKt.m5685getTypeZmokQxo(event), KeyEventType.INSTANCE.m5681getKeyDownCS__XNY()) || KeyEvent_androidKt.m5688isCtrlPressedZmokQxo(event))) {
            return false;
        }
        if (this.scrollingLogic.isVertical()) {
            int iM7425getHeightimpl = IntSize.m7425getHeightimpl(this.contentInViewNode.getViewportSize());
            jOffset = OffsetKt.Offset(0.0f, Key.m5376equalsimpl0(KeyEvent_androidKt.m5684getKeyZmokQxo(event), Key.INSTANCE.m5565getPageUpEK5gGoQ()) ? iM7425getHeightimpl : -iM7425getHeightimpl);
        } else {
            int iM7426getWidthimpl = IntSize.m7426getWidthimpl(this.contentInViewNode.getViewportSize());
            jOffset = OffsetKt.Offset(Key.m5376equalsimpl0(KeyEvent_androidKt.m5684getKeyZmokQxo(event), Key.INSTANCE.m5565getPageUpEK5gGoQ()) ? iM7426getWidthimpl : -iM7426getWidthimpl, 0.0f);
        }
    ...
    public void mo513onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        ...
        if (pass == PointerEventPass.Main && PointerEventType.m5778equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m5787getScroll7fucELk())) {
            ...
            static final class C00261 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                public final Object invokeSuspend(Object obj) {
                    ...
                    if (i == 0) {
                        ...
                        this.label = 1;
                        if (ScrollableKt.m785semanticsScrollByd4ec7I(this.this$0.scrollingLogic, OffsetKt.Offset(this.$x, this.$y), this) == coroutine_suspended) {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<Offset, Continuation<? super Offset>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            ...
            anonymousClass2.J$0 = ((Offset) obj).m4304unboximpl();
            return anonymousClass2;
        }

        @Override // kotlin.jvm.functions.Function2
        public /* bridge */ /* synthetic */ Object invoke(Offset offset, Continuation<? super Offset> continuation) {
            return m789invoke3MmeM6k(offset.m4304unboximpl(), continuation);
        }

        /* renamed from: invoke-3MmeM6k, reason: not valid java name */
        public final Object m789invoke3MmeM6k(long j, Continuation<? super Offset> continuation) {
            return ((AnonymousClass2) create(Offset.m4283boximpl(j), continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                long j = this.J$0;
                this.label = 1;
                obj = ScrollableKt.m785semanticsScrollByd4ec7I(ScrollableNode.this.scrollingLogic, j, this);
