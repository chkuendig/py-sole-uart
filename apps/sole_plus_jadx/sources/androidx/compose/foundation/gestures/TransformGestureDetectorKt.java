...
public final class TransformGestureDetectorKt {
    ...
    public static final float calculateRotation(PointerEvent pointerEvent) {
        ...
        for (int i4 = 0; i4 < size2; i4++) {
            ...
            if (pointerInputChange2.getPressed() && pointerInputChange2.getPreviousPressed()) {
                ...
                long jM4298minusMKHz9U = Offset.m4298minusMKHz9U(pointerInputChange2.getPreviousPosition(), jCalculateCentroid2);
                long jM4298minusMKHz9U2 = Offset.m4298minusMKHz9U(position, jCalculateCentroid);
                float fM812anglek4lQ0M = m812anglek4lQ0M(jM4298minusMKHz9U2) - m812anglek4lQ0M(jM4298minusMKHz9U);
                float fM4292getDistanceimpl = Offset.m4292getDistanceimpl(Offset.m4299plusMKHz9U(jM4298minusMKHz9U2, jM4298minusMKHz9U)) / 2.0f;
                if (fM812anglek4lQ0M > 180.0f) {
                    fM812anglek4lQ0M -= 360.0f;
                } else if (fM812anglek4lQ0M < -180.0f) {
                    fM812anglek4lQ0M += 360.0f;
                }
                f2 += fM812anglek4lQ0M * fM4292getDistanceimpl;
                f += fM4292getDistanceimpl;
            }
        }
        if (f == 0.0f) {
            return 0.0f;
    ...
    private static final float m812anglek4lQ0M(long j) {
        if (Offset.m4294getXimpl(j) == 0.0f && Offset.m4295getYimpl(j) == 0.0f) {
            return 0.0f;
        }
        return ((-((float) Math.atan2(Offset.m4294getXimpl(j), Offset.m4295getYimpl(j)))) * 180.0f) / 3.1415927f;
    }
    ...
    public static final long calculatePan(PointerEvent pointerEvent) {
        long jCalculateCentroid = calculateCentroid(pointerEvent, true);
        if (Offset.m4291equalsimpl0(jCalculateCentroid, Offset.INSTANCE.m4309getUnspecifiedF1C5BW0())) {
            return Offset.INSTANCE.m4310getZeroF1C5BW0();
        }
        return Offset.m4298minusMKHz9U(jCalculateCentroid, calculateCentroid(pointerEvent, false));
    }
    ...
    public static final float calculateCentroidSize(PointerEvent pointerEvent, boolean z) {
        ...
        float fM4292getDistanceimpl = 0.0f;
        if (Offset.m4291equalsimpl0(jCalculateCentroid, Offset.INSTANCE.m4309getUnspecifiedF1C5BW0())) {
            return 0.0f;
        }
        List<PointerInputChange> changes = pointerEvent.getChanges();
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (pointerInputChange.getPressed() && pointerInputChange.getPreviousPressed()) {
                fM4292getDistanceimpl += Offset.m4292getDistanceimpl(Offset.m4298minusMKHz9U(z ? pointerInputChange.getPosition() : pointerInputChange.getPreviousPosition(), jCalculateCentroid));
                i++;
            }
        }
        return fM4292getDistanceimpl / i;
    }
    ...
    public static final long calculateCentroid(PointerEvent pointerEvent, boolean z) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            PointerInputChange pointerInputChange = changes.get(i2);
            if (pointerInputChange.getPressed() && pointerInputChange.getPreviousPressed()) {
                jM4310getZeroF1C5BW0 = Offset.m4299plusMKHz9U(jM4310getZeroF1C5BW0, z ? pointerInputChange.getPosition() : pointerInputChange.getPreviousPosition());
                i++;
            }
        }
        if (i == 0) {
        ...
        return Offset.m4289divtuRUvjQ(jM4310getZeroF1C5BW0, i);
    }
}
