...
@DebugMetadata(c = "androidx.compose.foundation.gestures.ScrollingLogic$doFlingAnimation$2", f = "Scrollable.kt", i = {}, l = {WinError.ERROR_SYSTEM_POWERSTATE_TRANSITION}, m = "invokeSuspend", n = {}, s = {})
...
final class ScrollingLogic$doFlingAnimation$2 extends SuspendLambda implements Function2<NestedScrollScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            ScrollScope scrollScope = new ScrollScope() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$doFlingAnimation$2$reverseScope$1
                ...
                public float scrollBy(float pixels) {
                    ...
                    return scrollingLogic4.reverseIfNeeded(scrollingLogic4.m802toFloatk4lQ0M(nestedScrollScope.mo759scrollByWithOverscrollOzD1aCk(scrollingLogic4.m800reverseIfNeededMKHz9U(scrollingLogic4.m803toOffsettuRUvjQ(pixels)), NestedScrollSource.INSTANCE.m5720getSideEffectWNlRxjI())));
                }
            };
            ...
            float fReverseIfNeeded = scrollingLogic.reverseIfNeeded(scrollingLogic.m795toFloatTH1AsA0(j2));
        ...
        longRef.element = scrollingLogic.m796updateQWom1Mo(j, scrollingLogic2.reverseIfNeeded(((Number) obj).floatValue()));
