...
public final class FinalSnappingItem {
    ...
    private static final int ClosestItem = m822constructorimpl(0);
    private static final int NextItem = m822constructorimpl(1);
    private static final int PreviousItem = m822constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FinalSnappingItem m821boximpl(int i) {
        return new FinalSnappingItem(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m822constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m823equalsimpl(int i, Object obj) {
    ...
    public boolean equals(Object obj) {
        return m823equalsimpl(this.value, obj);
    }
