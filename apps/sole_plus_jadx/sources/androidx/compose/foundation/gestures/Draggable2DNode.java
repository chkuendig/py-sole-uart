...
public final class Draggable2DNode extends DragGestureNode {
            ...
            if (i == 0) {
                ...
                Function1<DragEvent.DragDelta, Unit> function1 = new Function1<DragEvent.DragDelta, Unit>() { // from class: androidx.compose.foundation.gestures.Draggable2DNode.drag.2.1
                    ...
                    public final void invoke2(DragEvent.DragDelta dragDelta) {
                        drag2DScope.mo707dragByk4lQ0M(draggable2DNode.m746reverseIfNeededMKHz9U(dragDelta.getDelta()));
                    }
                };
                this.label = 1;
    ...
    public void mo694onDragStartedk4lQ0M(long startedPosition) {
        this.onDragStart.invoke(Offset.m4283boximpl(startedPosition));
    ...
    public void mo695onDragStoppedTH1AsA0(long velocity) {
        this.onDragStop.invoke(Velocity.m7484boximpl(velocity));
    ...
    public final long m745reverseIfNeededAH228Gc(long j) {
        return Velocity.m7499timesadjELrA(j, this.reverseDirection ? -1.0f : 1.0f);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: reverseIfNeeded-MK-Hz9U, reason: not valid java name */
    public final long m746reverseIfNeededMKHz9U(long j) {
