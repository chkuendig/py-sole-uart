...
public final class DraggableNode extends DragGestureNode {
            ...
            if (i == 0) {
                ...
                Function1<DragEvent.DragDelta, Unit> function1 = new Function1<DragEvent.DragDelta, Unit>() { // from class: androidx.compose.foundation.gestures.DraggableNode.drag.2.1
                    ...
                    public final void invoke2(DragEvent.DragDelta dragDelta) {
                        dragScope.dragBy(DraggableKt.m750toFloat3MmeM6k(draggableNode.m757reverseIfNeededMKHz9U(dragDelta.getDelta()), draggableNode.orientation));
                    }
                };
                this.label = 1;
    ...
    public final long m756reverseIfNeededAH228Gc(long j) {
        return Velocity.m7499timesadjELrA(j, this.reverseDirection ? -1.0f : 1.0f);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: reverseIfNeeded-MK-Hz9U, reason: not valid java name */
    public final long m757reverseIfNeededMKHz9U(long j) {
        return Offset.m4301timestuRUvjQ(j, this.reverseDirection ? -1.0f : 1.0f);
    }
}
