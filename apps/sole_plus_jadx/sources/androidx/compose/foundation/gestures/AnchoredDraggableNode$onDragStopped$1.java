...
@DebugMetadata(c = "androidx.compose.foundation.gestures.AnchoredDraggableNode$onDragStopped$1", f = "AnchoredDraggable.kt", i = {}, l = {275, WinError.ERROR_EA_TABLE_FULL}, m = "invokeSuspend", n = {}, s = {})
...
final class AnchoredDraggableNode$onDragStopped$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (((AnchoredDraggableNode) this.this$0).overscrollEffect != null) {
                ...
                this.label = 2;
                if (overscrollEffect.mo521applyToFlingBMRW4eQ(this.this$0.m688reverseIfNeededAH228Gc(this.$velocity), new AnonymousClass1(this.this$0, null), this) == coroutine_suspended) {
                ...
                this.label = 1;
                Object obj2 = anchoredDraggableState.settle(anchoredDraggableNode3.m690toFloatTH1AsA0(anchoredDraggableNode3.m688reverseIfNeededAH228Gc(this.$velocity)), this);
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<Velocity, Continuation<? super Velocity>, Object> {
        ...
        public final Object m697invokesFctU(long j, Continuation<? super Velocity> continuation) {
            return ((AnonymousClass1) create(Velocity.m7484boximpl(j), continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                this.J$0 = j2;
                this.label = 1;
                Object obj2 = anchoredDraggableNode2.state.settle(this.this$0.m690toFloatTH1AsA0(j2), this);
                if (obj2 == coroutine_suspended) {
                    return coroutine_suspended;
                }
                anchoredDraggableNode = anchoredDraggableNode2;
            ...
            long jM693toVelocityadjELrA = anchoredDraggableNode.m693toVelocityadjELrA(((Number) obj).floatValue());
