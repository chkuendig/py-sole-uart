...
final class Draggable2DNode$onDragStopped$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Velocity velocityM7484boximpl = Velocity.m7484boximpl(this.this$0.m745reverseIfNeededAH228Gc(this.$velocity));
            this.label = 1;
            if (function3.invoke(coroutineScope, velocityM7484boximpl, this) == coroutine_suspended) {
