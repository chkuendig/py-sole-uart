...
public final class DraggableKt {
    ...
    public static final float m750toFloat3MmeM6k(long j, Orientation orientation) {
        return orientation == Orientation.Vertical ? Offset.m4295getYimpl(j) : Offset.m4294getXimpl(j);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: toFloat-sF-c-tU, reason: not valid java name */
    public static final float m751toFloatsFctU(long j, Orientation orientation) {
        return orientation == Orientation.Vertical ? Velocity.m7494getYimpl(j) : Velocity.m7493getXimpl(j);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: toValidVelocity-TH1AsA0, reason: not valid java name */
    public static final long m752toValidVelocityTH1AsA0(long j) {
        return VelocityKt.Velocity(Float.isNaN(Velocity.m7493getXimpl(j)) ? 0.0f : Velocity.m7493getXimpl(j), Float.isNaN(Velocity.m7494getYimpl(j)) ? 0.0f : Velocity.m7494getYimpl(j));
    }
}
