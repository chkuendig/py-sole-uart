...
public final class Draggable2DElement extends ModifierNodeElement<Draggable2DNode> {
    ...
    public void update(Draggable2DNode node) {
        node.update(this.state, CanDrag, this.enabled, this.interactionSource, this.startDragImmediately, this.reverseDirection, (192 & 64) != 0 ? node.onDragStarted : null, (192 & 128) != 0 ? node.onDragStopped : null, (192 & 256) != 0 ? node.onDragStart : this.onDragStarted, (192 & 512) != 0 ? node.onDragStop : this.onDragStopped);
    }
