...
public final class ScrollingLogic {
    ...
    private int latestScrollSource = NestedScrollSource.INSTANCE.m5721getUserInputWNlRxjI();
    ...
    private final ScrollingLogic$nestedScrollScope$1 nestedScrollScope = new NestedScrollScope() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$nestedScrollScope$1
        ...
        public long mo758scrollByOzD1aCk(long offset, int source) {
            return this.this$0.m793performScroll3eAAhYA(this.this$0.outerStateScope, offset, source);
        }
        ...
        public long mo759scrollByWithOverscrollOzD1aCk(long offset, int source) {
            ...
            return overscrollEffect.mo522applyToScrollRhakbz0(offset, this.this$0.latestScrollSource, this.this$0.performScrollForOverscroll);
        }
    };
    private final Function1<Offset, Offset> performScrollForOverscroll = new Function1<Offset, Offset>() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$performScrollForOverscroll$1
        ...
        public /* bridge */ /* synthetic */ Offset invoke(Offset offset) {
            return Offset.m4283boximpl(m805invokeMKHz9U(offset.m4304unboximpl()));
        }
        ...
        public final long m805invokeMKHz9U(long j) {
            ...
            return scrollingLogic.m793performScroll3eAAhYA(scrollScope, j, scrollingLogic.latestScrollSource);
        }
    };
    ...
    public final long m801singleAxisOffsetMKHz9U(long j) {
        return this.orientation == Orientation.Horizontal ? Offset.m4288copydBAh8RU$default(j, 0.0f, 0.0f, 1, null) : Offset.m4288copydBAh8RU$default(j, 0.0f, 0.0f, 2, null);
    }
    ...
    private final long m794singleAxisVelocityAH228Gc(long j) {
        return this.orientation == Orientation.Horizontal ? Velocity.m7489copyOhffZ5M$default(j, 0.0f, 0.0f, 1, null) : Velocity.m7489copyOhffZ5M$default(j, 0.0f, 0.0f, 2, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: update-QWom1Mo, reason: not valid java name */
    public final long m796updateQWom1Mo(long j, float f) {
        return this.orientation == Orientation.Horizontal ? Velocity.m7489copyOhffZ5M$default(j, f, 0.0f, 2, null) : Velocity.m7489copyOhffZ5M$default(j, 0.0f, f, 1, null);
    }
    ...
    public final long m800reverseIfNeededMKHz9U(long j) {
        return this.reverseDirection ? Offset.m4301timestuRUvjQ(j, -1.0f) : j;
    }
    ...
    public final long m793performScroll3eAAhYA(ScrollScope scrollScope, long j, int i) {
        long jM5705dispatchPreScrollOzD1aCk = this.nestedScrollDispatcher.m5705dispatchPreScrollOzD1aCk(j, i);
        long jM4298minusMKHz9U = Offset.m4298minusMKHz9U(j, jM5705dispatchPreScrollOzD1aCk);
        long jM800reverseIfNeededMKHz9U = m800reverseIfNeededMKHz9U(m803toOffsettuRUvjQ(scrollScope.scrollBy(m802toFloatk4lQ0M(m800reverseIfNeededMKHz9U(m801singleAxisOffsetMKHz9U(jM4298minusMKHz9U))))));
        return Offset.m4299plusMKHz9U(Offset.m4299plusMKHz9U(jM5705dispatchPreScrollOzD1aCk, jM800reverseIfNeededMKHz9U), this.nestedScrollDispatcher.m5703dispatchPostScrollDzOQY0M(jM800reverseIfNeededMKHz9U, Offset.m4298minusMKHz9U(jM4298minusMKHz9U, jM800reverseIfNeededMKHz9U), i));
    }
    ...
    public final Object m798onDragStoppedsFctU(long j, Continuation<? super Unit> continuation) {
        long jM794singleAxisVelocityAH228Gc = m794singleAxisVelocityAH228Gc(j);
        ...
        if (overscrollEffect != null && getShouldDispatchOverscroll()) {
            Object objMo521applyToFlingBMRW4eQ = overscrollEffect.mo521applyToFlingBMRW4eQ(jM794singleAxisVelocityAH228Gc, scrollingLogic$onDragStopped$performFling$1, continuation);
            return objMo521applyToFlingBMRW4eQ == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objMo521applyToFlingBMRW4eQ : Unit.INSTANCE;
        }
        Object objInvoke = scrollingLogic$onDragStopped$performFling$1.invoke(Velocity.m7484boximpl(jM794singleAxisVelocityAH228Gc), continuation);
    ...
    */
    public final java.lang.Object m797doFlingAnimationQWom1Mo(long r12, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r14) {
        ...
        L5a:
            ...
            androidx.compose.ui.unit.Velocity r12 = androidx.compose.ui.unit.Velocity.m7484boximpl(r12)
            return r12
        */
