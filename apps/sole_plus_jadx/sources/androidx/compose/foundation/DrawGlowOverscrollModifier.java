...
final class DrawGlowOverscrollModifier extends InspectorValueInfo implements DrawModifier {
    ...
    private final boolean drawLeftGlow(DrawScope drawScope, EdgeEffect edgeEffect, Canvas canvas) {
        return m594drawWithRotationAndOffsetubNVwUQ(270.0f, OffsetKt.Offset(-Size.m4360getHeightimpl(drawScope.mo5117getSizeNHjbRc()), drawScope.mo677toPx0680j_4(this.overscrollConfig.getDrawPadding().mo936calculateLeftPaddingu2uoSUM(drawScope.getLayoutDirection()))), edgeEffect, canvas);
    }
    ...
    private final boolean drawRightGlow(DrawScope drawScope, EdgeEffect edgeEffect, Canvas canvas) {
        return m594drawWithRotationAndOffsetubNVwUQ(90.0f, OffsetKt.Offset(0.0f, (-MathKt.roundToInt(Size.m4363getWidthimpl(drawScope.mo5117getSizeNHjbRc()))) + drawScope.mo677toPx0680j_4(this.overscrollConfig.getDrawPadding().mo937calculateRightPaddingu2uoSUM(drawScope.getLayoutDirection()))), edgeEffect, canvas);
    }

    private final boolean drawBottomGlow(DrawScope drawScope, EdgeEffect edgeEffect, Canvas canvas) {
        return m594drawWithRotationAndOffsetubNVwUQ(180.0f, OffsetKt.Offset(-Size.m4363getWidthimpl(drawScope.mo5117getSizeNHjbRc()), (-Size.m4360getHeightimpl(drawScope.mo5117getSizeNHjbRc())) + drawScope.mo677toPx0680j_4(this.overscrollConfig.getDrawPadding().getBottom())), edgeEffect, canvas);
    }
    ...
    private final boolean m594drawWithRotationAndOffsetubNVwUQ(float rotationDegrees, long offset, EdgeEffect edgeEffect, Canvas canvas) {
        ...
        canvas.translate(Offset.m4294getXimpl(offset), Offset.m4295getYimpl(offset));
