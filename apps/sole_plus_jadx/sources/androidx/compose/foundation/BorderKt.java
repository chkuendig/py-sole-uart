...
public final class BorderKt {
    ...
    public static final Modifier border(Modifier modifier, BorderStroke borderStroke, Shape shape) {
        return m553borderziNgDLE(modifier, borderStroke.getWidth(), borderStroke.getBrush(), shape);
    }

    /* renamed from: border-xT4_qwU$default, reason: not valid java name */
    public static /* synthetic */ Modifier m552borderxT4_qwU$default(Modifier modifier, float f, long j, Shape shape, int i, Object obj) {
        if ((i & 4) != 0) {
            shape = RectangleShapeKt.getRectangleShape();
        }
        return m551borderxT4_qwU(modifier, f, j, shape);
    }

    /* renamed from: border-xT4_qwU, reason: not valid java name */
    public static final Modifier m551borderxT4_qwU(Modifier modifier, float f, long j, Shape shape) {
        return m553borderziNgDLE(modifier, f, new SolidColor(j, null), shape);
    }

    /* renamed from: border-ziNgDLE, reason: not valid java name */
    public static final Modifier m553borderziNgDLE(Modifier modifier, float f, Brush brush, Shape shape) {
    ...
    public static final DrawResult m554drawRectBorderNsqcLGU(CacheDrawScope cacheDrawScope, final Brush brush, long j, long j2, boolean z, float f) {
        final long jM4310getZeroF1C5BW0 = z ? Offset.INSTANCE.m4310getZeroF1C5BW0() : j;
        final long jM4078getSizeNHjbRc = z ? cacheDrawScope.m4078getSizeNHjbRc() : j2;
        ...
        return cacheDrawScope.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.BorderKt$drawRectBorder$1
            ...
            public final void invoke2(ContentDrawScope contentDrawScope) {
                contentDrawScope.drawContent();
                DrawScope.m5110drawRectAsUm42w$default(contentDrawScope, brush, jM4310getZeroF1C5BW0, jM4078getSizeNHjbRc, 0.0f, stroke, null, 0, 104, null);
            }
        });
    }
    ...
    public static final Path createRoundRectPath(Path path, RoundRect roundRect, float f, boolean z) {
        ...
        if (!z) {
            ...
            path.mo4428opN5in7k0(path, Path, PathOperation.INSTANCE.m4842getDifferenceb3I0S0c());
        }
        return path;
    }

    private static final RoundRect createInsetRoundedRect(float f, RoundRect roundRect) {
        return new RoundRect(f, f, roundRect.getWidth() - f, roundRect.getHeight() - f, m555shrinkKibmq7A(roundRect.m4344getTopLeftCornerRadiuskKHJgLs(), f), m555shrinkKibmq7A(roundRect.m4345getTopRightCornerRadiuskKHJgLs(), f), m555shrinkKibmq7A(roundRect.m4343getBottomRightCornerRadiuskKHJgLs(), f), m555shrinkKibmq7A(roundRect.m4342getBottomLeftCornerRadiuskKHJgLs(), f), null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: shrink-Kibmq7A, reason: not valid java name */
    public static final long m555shrinkKibmq7A(long j, float f) {
        return CornerRadiusKt.CornerRadius(Math.max(0.0f, CornerRadius.m4254getXimpl(j) - f), Math.max(0.0f, CornerRadius.m4255getYimpl(j) - f));
    }
}
