...
public final class PagerMeasureKt {
    ...
    public static final PagerMeasureResult m1227measurePagerbmk8ZPk(final LazyLayoutMeasureScope lazyLayoutMeasureScope, int i, final PagerLazyLayoutItemProvider pagerLazyLayoutItemProvider, int i2, int i3, int i4, int i5, int i6, int i7, long j, final Orientation orientation, final Alignment.Vertical vertical, final Alignment.Horizontal horizontal, final boolean z, final long j2, final int i8, int i9, List<Integer> list, SnapPosition snapPosition, final MutableState<Unit> mutableState, CoroutineScope coroutineScope, Function3<? super Integer, ? super Integer, ? super Function1<? super Placeable.PlacementScope, Unit>, ? extends MeasureResult> function3) {
        ...
        if (i <= 0) {
            return new PagerMeasureResult(CollectionsKt.emptyList(), i8, i5, i4, orientation, -i3, i2 + i4, false, i9, null, null, 0.0f, 0, false, snapPosition, function3.invoke(Integer.valueOf(Constraints.m7210getMinWidthimpl(j)), Integer.valueOf(Constraints.m7209getMinHeightimpl(j)), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$4
        ...
        final long jConstraints$default = ConstraintsKt.Constraints$default(0, orientation == Orientation.Vertical ? Constraints.m7208getMaxWidthimpl(j) : i8, 0, orientation != Orientation.Vertical ? Constraints.m7207getMaxHeightimpl(j) : i8, 5, null);
        int i18 = i6;
        int i19 = i7;
        while (i18 > 0 && i19 > 0) {
            i18--;
        ...
        while (i23 < 0 && i18 > 0) {
            ...
            MeasuredPage measuredPageM1226getAndMeasureSGf7dI0 = m1226getAndMeasureSGf7dI0(lazyLayoutMeasureScope, i24, jConstraints$default, pagerLazyLayoutItemProvider, j2, orientation, horizontal, vertical, lazyLayoutMeasureScope.getLayoutDirection(), z, i8);
            arrayDeque2.add(i25, measuredPageM1226getAndMeasureSGf7dI0);
            iMax = Math.max(iMax, measuredPageM1226getAndMeasureSGf7dI0.getCrossAxisSize());
            i23 += i26;
            i18 = i24;
            i22 = i22;
        ...
        while (i41 < i && (i42 < iCoerceAtLeast2 || i42 <= 0 || arrayDeque3.isEmpty())) {
            ...
            int i47 = i42;
            int i48 = i31;
            MeasuredPage measuredPageM1226getAndMeasureSGf7dI02 = m1226getAndMeasureSGf7dI0(lazyLayoutMeasureScope, i41, jConstraints$default, pagerLazyLayoutItemProvider, j2, orientation, horizontal, vertical, lazyLayoutMeasureScope.getLayoutDirection(), z, i8);
            int i49 = i - 1;
            i42 = (i44 == i49 ? i8 : i48) + i47;
            if (i42 > i29 || i44 == i49) {
                iMax = Math.max(iMax, measuredPageM1226getAndMeasureSGf7dI02.getCrossAxisSize());
                arrayDeque3.add(measuredPageM1226getAndMeasureSGf7dI02);
                i38 = i45;
            } else {
                i39 -= i48;
                i38 = i44 + 1;
        ...
        if (i53 < i2) {
            ...
            while (i60 < i58 && i14 > 0) {
                i14--;
                int i61 = i59;
                MeasuredPage measuredPageM1226getAndMeasureSGf7dI03 = m1226getAndMeasureSGf7dI0(lazyLayoutMeasureScope, i14, jConstraints$default, pagerLazyLayoutItemProvider, j2, orientation, horizontal, vertical, lazyLayoutMeasureScope.getLayoutDirection(), z, i8);
                arrayDeque3.add(0, measuredPageM1226getAndMeasureSGf7dI03);
                iMax = Math.max(iMax, measuredPageM1226getAndMeasureSGf7dI03.getCrossAxisSize());
                i60 += i61;
                i58 = i3;
                i59 = i61;
            }
        ...
        List<MeasuredPage> listCreatePagesBeforeList = createPagesBeforeList(i14, i9, list, new Function1<Integer, MeasuredPage>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$extraPagesBefore$1
            ...
            public final MeasuredPage invoke(int i66) {
                ...
                return PagerMeasureKt.m1226getAndMeasureSGf7dI0(lazyLayoutMeasureScope2, i66, jConstraints$default, pagerLazyLayoutItemProvider, j2, orientation, horizontal, vertical, lazyLayoutMeasureScope2.getLayoutDirection(), z, i8);
            }
        });
        ...
        List<MeasuredPage> listCreatePagesAfterList = createPagesAfterList(((MeasuredPage) arrayDeque3.last()).getIndex(), i, i9, list, new Function1<Integer, MeasuredPage>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$extraPagesAfter$1
            ...
            public final MeasuredPage invoke(int i69) {
                LazyLayoutMeasureScope lazyLayoutMeasureScope2 = lazyLayoutMeasureScope;
                return PagerMeasureKt.m1226getAndMeasureSGf7dI0(lazyLayoutMeasureScope2, i69, jConstraints$default, pagerLazyLayoutItemProvider, j2, orientation, horizontal, vertical, lazyLayoutMeasureScope2.getLayoutDirection(), z, i8);
            }
        });
        ...
        int iM7225constrainWidthK40F9xA = ConstraintsKt.m7225constrainWidthK40F9xA(j3, i16);
        if (orientation == Orientation.Vertical) {
            iMax2 = i12;
        }
        int iM7224constrainHeightK40F9xA = ConstraintsKt.m7224constrainHeightK40F9xA(j3, iMax2);
        final List<MeasuredPage> listCalculatePagesOffsets = calculatePagesOffsets(lazyLayoutMeasureScope, arrayDeque3, listCreatePagesBeforeList, listCreatePagesAfterList, iM7225constrainWidthK40F9xA, iM7224constrainHeightK40F9xA, i12, i2, i62, orientation, z, lazyLayoutMeasureScope, i5, i8);
        if (i70 != 0) {
        ...
        int i74 = i12;
        MeasuredPage measuredPageCalculateNewCurrentPage = calculateNewCurrentPage(orientation == Orientation.Vertical ? iM7224constrainHeightK40F9xA : iM7225constrainWidthK40F9xA, list2, i3, i4, i68, snapPosition, i);
        return new PagerMeasureResult(list2, i8, i5, i4, orientation, i28, i51, z, i9, measuredPage3, measuredPageCalculateNewCurrentPage, i68 == 0 ? 0.0f : RangesKt.coerceIn((snapPosition.position(i2, i8, i3, i4, measuredPageCalculateNewCurrentPage != null ? measuredPageCalculateNewCurrentPage.getIndex() : i65, i) - (measuredPageCalculateNewCurrentPage != null ? measuredPageCalculateNewCurrentPage.getOffset() : i65)) / i68, -0.5f, 0.5f), i15, (i52 < i || i74 > i2) ? 1 : i65, snapPosition, function3.invoke(Integer.valueOf(iM7225constrainWidthK40F9xA), Integer.valueOf(iM7224constrainHeightK40F9xA), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$14
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
    ...
    private static final List<MeasuredPage> calculatePagesOffsets(LazyLayoutMeasureScope lazyLayoutMeasureScope, List<MeasuredPage> list, List<MeasuredPage> list2, List<MeasuredPage> list3, int i, int i2, int i3, int i4, int i5, Orientation orientation, boolean z, Density density, int i6, int i7) {
        ...
        if (z2) {
            ...
            Arrangement.HorizontalOrVertical horizontalOrVerticalM868spacedBy0680j_4 = Arrangement.Absolute.INSTANCE.m868spacedBy0680j_4(lazyLayoutMeasureScope.mo674toDpu2uoSUM(i6));
            if (orientation == Orientation.Vertical) {
                horizontalOrVerticalM868spacedBy0680j_4.arrange(density, i9, iArr, iArr2);
            } else {
                horizontalOrVerticalM868spacedBy0680j_4.arrange(density, i9, iArr, LayoutDirection.Ltr, iArr2);
            }
