...
public final class PagerStateKt {
    ...
    private static final float DefaultPositionThreshold = Dp.m7255constructorimpl(56);
    ...
    public static final PagerState rememberPagerState(final int i, final float f, final Function0<Integer> function0, Composer composer, int i2, int i3) {
        ...
        DefaultPagerState defaultPagerState = (DefaultPagerState) RememberSaveableKt.m3983rememberSaveable(objArr, (Saver) saver, (String) null, (Function0) objRememberedValue, composer, 0, 4);
    ...
    public static final long calculateNewMaxScrollOffset(PagerLayoutInfo pagerLayoutInfo, int i) {
        ...
        int iM7426getWidthimpl = pagerLayoutInfo.getOrientation() == Orientation.Horizontal ? IntSize.m7426getWidthimpl(pagerLayoutInfo.mo1224getViewportSizeYbymL2g()) : IntSize.m7425getHeightimpl(pagerLayoutInfo.mo1224getViewportSizeYbymL2g());
        return RangesKt.coerceAtLeast(pageSpacing - (iM7426getWidthimpl - RangesKt.coerceIn(pagerLayoutInfo.getSnapPosition().position(iM7426getWidthimpl, pagerLayoutInfo.getPageSize(), pagerLayoutInfo.getBeforeContentPadding(), pagerLayoutInfo.getAfterContentPadding(), i - 1, i), 0, iM7426getWidthimpl)), 0L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long calculateNewMinScrollOffset(PagerMeasureResult pagerMeasureResult, int i) {
        int iM7426getWidthimpl = pagerMeasureResult.getOrientation() == Orientation.Horizontal ? IntSize.m7426getWidthimpl(pagerMeasureResult.mo1224getViewportSizeYbymL2g()) : IntSize.m7425getHeightimpl(pagerMeasureResult.mo1224getViewportSizeYbymL2g());
        return RangesKt.coerceIn(pagerMeasureResult.getSnapPosition().position(iM7426getWidthimpl, pagerMeasureResult.getPageSize(), pagerMeasureResult.getBeforeContentPadding(), pagerMeasureResult.getAfterContentPadding(), 0, i), 0, iM7426getWidthimpl);
    }
