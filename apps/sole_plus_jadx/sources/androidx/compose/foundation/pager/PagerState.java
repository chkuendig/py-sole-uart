...
public abstract class PagerState implements ScrollableState {
    ...
    @DebugMetadata(c = "androidx.compose.foundation.pager.PagerState", f = "PagerState.kt", i = {0, 0, 0, 0}, l = {605, WinError.ERROR_REGISTRY_QUOTA_LIMIT}, m = "animateScrollToPage", n = {"this", "animationSpec", "page", "pageOffsetFraction"}, s = {"L$0", "L$1", "I$0", "F$0"})
    ...
    /* compiled from: PagerState.kt */
    @Metadata(k = 3, mv = {1, 8, 0}, xi = 48)
    @DebugMetadata(c = "androidx.compose.foundation.pager.PagerState", f = "PagerState.kt", i = {0, 0, 0, 1}, l = {WinError.ERROR_CANT_ENABLE_DENY_ONLY, WinError.ERROR_CORRUPT_SYSTEM_FILE}, m = "scroll$suspendImpl", n = {"$this", "scrollPriority", "block", "$this"}, s = {"L$0", "L$1", "L$2", "L$0"})
    ...
    public PagerState(int i, float f, PrefetchScheduler prefetchScheduler) {
        double d = f;
        if (-0.5d <= d && d <= 0.5d) {
            this.upDownDifference = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m4283boximpl(Offset.INSTANCE.m4310getZeroF1C5BW0()), null, 2, null);
    ...
    public final long m1233getUpDownDifferenceF1C5BW0$foundation_release() {
        return ((Offset) this.upDownDifference.getValue()).m4304unboximpl();
    }

    /* renamed from: setUpDownDifference-k-4lQ0M$foundation_release, reason: not valid java name */
    public final void m1235setUpDownDifferencek4lQ0M$foundation_release(long j) {
        this.upDownDifference.setValue(Offset.m4283boximpl(j));
    }
    ...
    public final float getPositionThresholdFraction$foundation_release() {
        return Math.min(this.density.mo677toPx0680j_4(PagerStateKt.getDefaultPositionThreshold()), getPageSize$foundation_release() / 2.0f) / getPageSize$foundation_release();
    }
    ...
    public final void m1234setPremeasureConstraintsBRTryo0$foundation_release(long j) {
    ...
    public final MutableState<Unit> m1231getPlacementScopeInvalidatorzYiylxw$foundation_release() {
    ...
    public final MutableState<Unit> m1230getMeasurementScopeInvalidatorzYiylxw$foundation_release() {
    ...
    @DebugMetadata(c = "androidx.compose.foundation.pager.PagerState$requestScrollToPage$1", f = "PagerState.kt", i = {}, l = {WinError.ERROR_PAGEFILE_CREATE_FAILED}, m = "invokeSuspend", n = {}, s = {})
    ...
    static final class C04391 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return PagerState.this.new C04391(continuation);
        }
    ...
    public final void requestScrollToPage(int page, float pageOffsetFraction) {
        if (isScrollInProgress()) {
            BuildersKt__Builders_commonKt.launch$default(this.pagerLayoutInfoState.getValue().getCoroutineScope(), null, null, new C04391(null), 3, null);
        }
    ...
    */
    static /* synthetic */ java.lang.Object scroll$suspendImpl(androidx.compose.foundation.pager.PagerState r5, androidx.compose.foundation.MutatePriority r6, kotlin.jvm.functions.Function2<? super androidx.compose.foundation.gestures.ScrollScope, ? super kotlin.coroutines.Continuation<? super kotlin.Unit>, ? extends java.lang.Object> r7, kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
        /*
            boolean r0 = r8 instanceof androidx.compose.foundation.pager.PagerState.C04401
            if (r0 == 0) goto L14
            r0 = r8
            androidx.compose.foundation.pager.PagerState$scroll$1 r0 = (androidx.compose.foundation.pager.PagerState.C04401) r0
            int r1 = r0.label
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r1 = r1 & r2
            if (r1 == 0) goto L14
    ...
    private final boolean isGestureActionMatchesScroll(float scrollDelta) {
        if (getLayoutInfo().getOrientation() != Orientation.Vertical ? Math.signum(scrollDelta) != Math.signum(-Offset.m4294getXimpl(m1233getUpDownDifferenceF1C5BW0$foundation_release())) : Math.signum(scrollDelta) != Math.signum(-Offset.m4295getYimpl(m1233getUpDownDifferenceF1C5BW0$foundation_release()))) {
    ...
    private final boolean isNotGestureAction() {
        return ((int) Offset.m4294getXimpl(m1233getUpDownDifferenceF1C5BW0$foundation_release())) == 0 && ((int) Offset.m4295getYimpl(m1233getUpDownDifferenceF1C5BW0$foundation_release())) == 0;
    }
    ...
    private final void notifyPrefetch(float delta, PagerLayoutInfo info) {
        ...
        if (this.prefetchingEnabled && !info.getVisiblePagesInfo().isEmpty()) {
            ...
            if (index != this.indexToPrefetch) {
                ...
                this.currentPrefetchHandle = this.prefetchState.m1157schedulePrefetch0kLqBqw(index, this.premeasureConstraints);
            }
            if (z) {
