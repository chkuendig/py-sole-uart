...
final class MarqueeModifierNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, FocusEventModifierNode {
    ...
    private MarqueeModifierNode(int i, int i2, int i3, int i4, final MarqueeSpacing marqueeSpacing, float f) {
        ...
        this.animationMode = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(MarqueeAnimationMode.m611boximpl(i2), null, 2, null);
    ...
    public final int m625getAnimationModeZbEOnfQ() {
    ...
    public final void m626setAnimationMode97h66l8(int i) {
        this.animationMode.setValue(MarqueeAnimationMode.m611boximpl(i));
    }
    ...
    public final void m627updatelWfNwf4(int iterations, int animationMode, int delayMillis, int initialDelayMillis, MarqueeSpacing spacing, float velocity) {
        setSpacing(spacing);
        m626setAnimationMode97h66l8(animationMode);
        if (this.iterations == iterations && this.delayMillis == delayMillis && this.initialDelayMillis == initialDelayMillis && Dp.m7260equalsimpl0(this.velocity, velocity)) {
            return;
        }
    ...
    public MeasureResult mo395measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        setContainerWidth(ConstraintsKt.m7225constrainWidthK40F9xA(j, placeableMo5957measureBRTryo0.getWidth()));
        setContentWidth(placeableMo5957measureBRTryo0.getWidth());
        return MeasureScope.layout$default(measureScope, getContainerWidth(), placeableMo5957measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.MarqueeModifierNode$measure$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.placeWithLayer$default(placementScope, placeableMo5957measureBRTryo0, MathKt.roundToInt((-((Number) this.offset.getValue()).floatValue()) * this.getDirection()), 0, 0.0f, (Function1) null, 12, (Object) null);
            }
        }, 4, null);
    }
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        float fM4360getHeightimpl = Size.m4360getHeightimpl(contentDrawScope2.mo5117getSizeNHjbRc());
        ...
        try {
            drawContext.getTransform().mo5041clipRectN_I0leg(fFloatValue, 0.0f, containerWidth, fM4360getHeightimpl, iM4527getIntersectrtfAjoo);
            if (z) {
    ...
    @DebugMetadata(c = "androidx.compose.foundation.MarqueeModifierNode$restartAnimation$1", f = "BasicMarquee.kt", i = {}, l = {349, WinError.ERROR_FAIL_NOACTION_REBOOT}, m = "invokeSuspend", n = {}, s = {})
            ...
            if (i == 0) {
                ...
                if (FlowKt.collectLatest(SnapshotStateKt.snapshotFlow(new Function0<Float>() { // from class: androidx.compose.foundation.MarqueeModifierNode.runAnimation.2.1
                    ...
                    public final Float invoke() {
                        ...
                        if (!MarqueeAnimationMode.m614equalsimpl0(marqueeModifierNode.m625getAnimationModeZbEOnfQ(), MarqueeAnimationMode.INSTANCE.m619getWhileFocusedZbEOnfQ()) || marqueeModifierNode.getHasFocus()) {
