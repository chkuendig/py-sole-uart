...
public interface LazyLayoutMeasureScope extends MeasureScope {
    ...
    List<Placeable> mo1156measure0kLqBqw(int index, long constraints);
    ...
    default long mo678toSizeXkaWNTQ(long j) {
        if (j != InlineClassHelperKt.UnspecifiedPackedFloats) {
            return SizeKt.Size(mo677toPx0680j_4(DpSize.m7353getWidthD9Ej5fM(j)), mo677toPx0680j_4(DpSize.m7351getHeightD9Ej5fM(j)));
        }
    ...
    default long mo675toDpSizekrfVVM(long j) {
        if (j != InlineClassHelperKt.UnspecifiedPackedFloats) {
            return DpKt.m7277DpSizeYgX7TsA(mo673toDpu2uoSUM(Size.m4363getWidthimpl(j)), mo673toDpu2uoSUM(Size.m4360getHeightimpl(j)));
        }
