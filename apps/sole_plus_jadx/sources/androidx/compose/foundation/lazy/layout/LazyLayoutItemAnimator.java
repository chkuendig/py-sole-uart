...
public final class LazyLayoutItemAnimator<T extends LazyLayoutMeasuredItem> {
            ...
            if (getHasAnimations(t)) {
                ...
                if (itemInfo == null) {
                    ...
                    if (t.getIndex() == index || index == -1) {
                        long jMo1097getOffsetBjo55l4 = t.mo1097getOffsetBjo55l4(0);
                        initializeAnimation(t, t.getIsVertical() ? IntOffset.m7384getYimpl(jMo1097getOffsetBjo55l4) : IntOffset.m7383getXimpl(jMo1097getOffsetBjo55l4), itemInfo2);
                        if (z3) {
                    ...
                    while (i11 < length2) {
                        ...
                        if (lazyLayoutItemAnimation2 != null) {
                            ...
                            if (!IntOffset.m7382equalsimpl0(lazyLayoutItemAnimation2.getRawOffset(), LazyLayoutItemAnimation.INSTANCE.m1149getNotInitializednOccac())) {
                                lazyLayoutItemAnimation2.m1148setRawOffsetgyyYBs(IntOffset.m7387plusqkQi6aY(lazyLayoutItemAnimation2.getRawOffset(), jIntOffset));
                            }
                        } else {
                            lazyLayoutKeyIndexMap4 = lazyLayoutKeyIndexMap5;
                        }
                    ...
                    while (i19 < i18) {
                        if ((j2 & 255) < 128) {
                            ...
                            if (index2 == -1) {
                                ...
                                LazyLayoutMeasuredItem lazyLayoutMeasuredItemMo1099getAndMeasurehBUhpc = itemProvider.mo1099getAndMeasurehBUhpc(index2, itemInfo4.getLane(), itemInfo4.getSpan(), constraints.getValue());
                                lazyLayoutMeasuredItemMo1099getAndMeasurehBUhpc.setNonScrollableItem(true);
                                ...
                                itemInfo4.updateAnimation(lazyLayoutMeasuredItemMo1099getAndMeasurehBUhpc, coroutineScope, graphicsContext, layoutMinOffset, layoutMaxOffset, itemInfo4.getCrossAxisOffset());
                                if (index2 < this.firstVisibleIndex) {
                                    this.movingAwayToStartBound.add(lazyLayoutMeasuredItemMo1099getAndMeasurehBUhpc);
                                } else {
                                    this.movingAwayToEndBound.add(lazyLayoutMeasuredItemMo1099getAndMeasurehBUhpc);
                                }
                                j2 >>= 8;
                                i19++;
                                jArr6 = jArr2;
    ...
    */
    ...
    private final void initializeAnimation(T item, int mainAxisOffset, LazyLayoutItemAnimator<T>.ItemInfo itemInfo) {
        long jM7379copyiSbpLlY$default;
        int i = 0;
        long jMo1097getOffsetBjo55l4 = item.mo1097getOffsetBjo55l4(0);
        if (item.getIsVertical()) {
            jM7379copyiSbpLlY$default = IntOffset.m7379copyiSbpLlY$default(jMo1097getOffsetBjo55l4, 0, mainAxisOffset, 1, null);
        } else {
            jM7379copyiSbpLlY$default = IntOffset.m7379copyiSbpLlY$default(jMo1097getOffsetBjo55l4, mainAxisOffset, 0, 2, null);
        }
        ...
        while (i < length) {
            ...
            int i3 = i2 + 1;
            if (lazyLayoutItemAnimation != null) {
                lazyLayoutItemAnimation.m1148setRawOffsetgyyYBs(IntOffset.m7387plusqkQi6aY(jM7379copyiSbpLlY$default, IntOffset.m7386minusqkQi6aY(item.mo1097getOffsetBjo55l4(i2), jMo1097getOffsetBjo55l4)));
            }
            i++;
            i2 = i3;
        }
    ...
    private final void startPlacementAnimationsIfNeeded(T item, boolean isMovingAway) {
        ...
        while (i < length) {
            ...
            int i3 = i2 + 1;
            if (lazyLayoutItemAnimation != null) {
                long jMo1097getOffsetBjo55l4 = item.mo1097getOffsetBjo55l4(i2);
                long rawOffset = lazyLayoutItemAnimation.getRawOffset();
                if (!IntOffset.m7382equalsimpl0(rawOffset, LazyLayoutItemAnimation.INSTANCE.m1149getNotInitializednOccac()) && !IntOffset.m7382equalsimpl0(rawOffset, jMo1097getOffsetBjo55l4)) {
                    lazyLayoutItemAnimation.m1141animatePlacementDeltaar5cAso(IntOffset.m7386minusqkQi6aY(jMo1097getOffsetBjo55l4, rawOffset), isMovingAway);
                }
                lazyLayoutItemAnimation.m1148setRawOffsetgyyYBs(jMo1097getOffsetBjo55l4);
            }
            i++;
            i2 = i3;
        }
    ...
    public final long m1150getMinSizeToFitDisappearingItemsYbymL2g() {
        long jM7431getZeroYbymL2g = IntSize.INSTANCE.m7431getZeroYbymL2g();
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (layer != null) {
                jM7431getZeroYbymL2g = IntSizeKt.IntSize(Math.max(IntSize.m7426getWidthimpl(jM7431getZeroYbymL2g), IntOffset.m7383getXimpl(lazyLayoutItemAnimation.getRawOffset()) + IntSize.m7426getWidthimpl(layer.getSize())), Math.max(IntSize.m7425getHeightimpl(jM7431getZeroYbymL2g), IntOffset.m7384getYimpl(lazyLayoutItemAnimation.getRawOffset()) + IntSize.m7425getHeightimpl(layer.getSize())));
            }
        }
        return jM7431getZeroYbymL2g;
    }
    ...
    private final int getMainAxisOffset(LazyLayoutMeasuredItem lazyLayoutMeasuredItem) {
        long jMo1097getOffsetBjo55l4 = lazyLayoutMeasuredItem.mo1097getOffsetBjo55l4(0);
        return lazyLayoutMeasuredItem.getIsVertical() ? IntOffset.m7384getYimpl(jMo1097getOffsetBjo55l4) : IntOffset.m7383getXimpl(jMo1097getOffsetBjo55l4);
    }
    ...
    private final class ItemInfo {
        ...
        public final void updateAnimation(T positionedItem, CoroutineScope coroutineScope, GraphicsContext graphicsContext, int layoutMinOffset, int layoutMaxOffset, int crossAxisOffset) {
            ...
            this.constraints = Constraints.m7195boximpl(positionedItem.getConstraints());
    ...
    /* compiled from: LazyLayoutItemAnimator.kt */
    @Metadata(d1 = {"\u0000<\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\b\u0082\b\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0011\u0012\n\u0010\u0003\u001a\u0006\u0012\u0002\b\u00030\u0004¢\u0006\u0002\u0010\u0005J\r\u0010\u0006\u001a\u0006\u0012\u0002\b\u00030\u0004HÂ\u0003J\u0017\u0010\u0007\u001a\u00020\u00002\f\b\u0002\u0010\u0003\u001a\u0006\u0012\u0002\b\u00030\u0004HÆ\u0001J\b\u0010\b\u001a\u00020\u0002H\u0016J\u0013\u0010\t\u001a\u00020\n2\b\u0010\u000b\u001a\u0004\u0018\u00010\fHÖ\u0003J\t\u0010\r\u001a\u00020\u000eHÖ\u0001J\t\u0010\u000f\u001a\u00020\u0010HÖ\u0001J\u0010\u0010\u0011\u001a\u00020\u00122\u0006\u0010\u0013\u001a\u00020\u0002H\u0016J\f\u0010\u0014\u001a\u00020\u0012*\u00020\u0015H\u0016R\u0012\u0010\u0003\u001a\u0006\u0012\u0002\b\u00030\u0004X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0016"}, d2 = {"Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator$DisplayingDisappearingItemsElement;", "Landroidx/compose/ui/node/ModifierNodeElement;", "Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator$DisplayingDisappearingItemsNode;", SdkConstants.FD_RES_ANIMATOR, "Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;", "(Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;)V", "component1", "copy", "create", "equals", "", "other", "", "hashCode", "", "toString", "", "update", "", "node", "inspectableProperties", "Landroidx/compose/ui/platform/InspectorInfo;", "foundation_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    ...
    /* compiled from: LazyLayoutItemAnimator.kt */
    @Metadata(d1 = {"\u0000<\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0082\b\u0018\u00002\u00020\u00012\u00020\u0002B\u0011\u0012\n\u0010\u0003\u001a\u0006\u0012\u0002\b\u00030\u0004¢\u0006\u0002\u0010\u0005J\r\u0010\u0006\u001a\u0006\u0012\u0002\b\u00030\u0004HÂ\u0003J\u0017\u0010\u0007\u001a\u00020\u00002\f\b\u0002\u0010\u0003\u001a\u0006\u0012\u0002\b\u00030\u0004HÆ\u0001J\u0013\u0010\b\u001a\u00020\t2\b\u0010\n\u001a\u0004\u0018\u00010\u000bHÖ\u0003J\t\u0010\f\u001a\u00020\rHÖ\u0001J\b\u0010\u000e\u001a\u00020\u000fH\u0016J\b\u0010\u0010\u001a\u00020\u000fH\u0016J\u0012\u0010\u0011\u001a\u00020\u000f2\n\u0010\u0003\u001a\u0006\u0012\u0002\b\u00030\u0004J\t\u0010\u0012\u001a\u00020\u0013HÖ\u0001J\f\u0010\u0014\u001a\u00020\u000f*\u00020\u0015H\u0016R\u0012\u0010\u0003\u001a\u0006\u0012\u0002\b\u00030\u0004X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0016"}, d2 = {"Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator$DisplayingDisappearingItemsNode;", "Landroidx/compose/ui/Modifier$Node;", "Landroidx/compose/ui/node/DrawModifierNode;", SdkConstants.FD_RES_ANIMATOR, "Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;", "(Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;)V", "component1", "copy", "equals", "", "other", "", "hashCode", "", "onAttach", "", "onDetach", "setAnimator", "toString", "", "draw", "Landroidx/compose/ui/graphics/drawscope/ContentDrawScope;", "foundation_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    private static final /* data */ class DisplayingDisappearingItemsNode extends Modifier.Node implements DrawModifierNode {
        ...
        public void draw(ContentDrawScope contentDrawScope) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                GraphicsLayer layer = lazyLayoutItemAnimation.getLayer();
                if (layer != null) {
                    float fM7383getXimpl = IntOffset.m7383getXimpl(lazyLayoutItemAnimation.getFinalOffset());
                    ContentDrawScope contentDrawScope2 = contentDrawScope;
                    float fM7383getXimpl2 = fM7383getXimpl - IntOffset.m7383getXimpl(layer.getTopLeft());
                    float fM7384getYimpl = IntOffset.m7384getYimpl(lazyLayoutItemAnimation.getFinalOffset()) - IntOffset.m7384getYimpl(layer.getTopLeft());
                    contentDrawScope2.getDrawContext().getTransform().translate(fM7383getXimpl2, fM7384getYimpl);
                    try {
