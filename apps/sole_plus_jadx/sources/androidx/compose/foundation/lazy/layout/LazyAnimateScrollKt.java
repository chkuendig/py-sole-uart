...
public final class LazyAnimateScrollKt {
    ...
    private static final float TargetDistance = Dp.m7255constructorimpl(2500);
    private static final float BoundDistance = Dp.m7255constructorimpl(1500);
    private static final float MinimumDistance = Dp.m7255constructorimpl(50);
    ...
    @DebugMetadata(c = "androidx.compose.foundation.lazy.layout.LazyAnimateScrollKt$animateScrollToItem$2", f = "LazyAnimateScroll.kt", i = {0, 0, 0, 0, 0, 0, 0, 0, 1}, l = {174, 272}, m = "invokeSuspend", n = {"$this$scroll", "loop", SdkConstants.FD_RES_ANIM, "loops", "targetDistancePx", "boundDistancePx", "minDistancePx", "forward", "$this$scroll"}, s = {"L$0", "L$1", "L$2", "L$3", "F$0", "F$1", "F$2", "I$0", "L$0"})
