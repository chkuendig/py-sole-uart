...
public final class LazyLayoutItemAnimation {
    ...
    public LazyLayoutItemAnimation(CoroutineScope coroutineScope, GraphicsContext graphicsContext, Function0<Unit> function0) {
        ...
        this.rawOffset = j;
        this.finalOffset = IntOffset.INSTANCE.m7394getZeronOccac();
        this.layer = graphicsContext != null ? graphicsContext.createGraphicsLayer() : null;
        this.placementDeltaAnimation = new Animatable<>(IntOffset.m7374boximpl(IntOffset.INSTANCE.m7394getZeronOccac()), VectorConvertersKt.getVectorConverter(IntOffset.INSTANCE), null, null, 12, null);
        ...
        this.placementDelta = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntOffset.m7374boximpl(IntOffset.INSTANCE.m7394getZeronOccac()), null, 2, null);
    ...
    public final void m1148setRawOffsetgyyYBs(long j) {
        this.rawOffset = j;
    }
    ...
    public final void m1146setFinalOffsetgyyYBs(long j) {
        this.finalOffset = j;
    }
    ...
    public final void m1140setPlacementDeltagyyYBs(long j) {
        this.placementDelta.setValue(IntOffset.m7374boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getPlacementDelta-nOcc-ac, reason: not valid java name */
    public final long m1144getPlacementDeltanOccac() {
        return ((IntOffset) this.placementDelta.getValue()).m7392unboximpl();
    }
    ...
    static final class C04281 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return LazyLayoutItemAnimation.this.new C04281(continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                this.label = 1;
                if (LazyLayoutItemAnimation.this.placementDeltaAnimation.snapTo(IntOffset.m7374boximpl(IntOffset.INSTANCE.m7394getZeronOccac()), this) == coroutine_suspended) {
            ...
            LazyLayoutItemAnimation.this.m1140setPlacementDeltagyyYBs(IntOffset.INSTANCE.m7394getZeronOccac());
    ...
    public final void cancelPlacementAnimation() {
        if (isPlacementAnimationInProgress()) {
            BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, null, new C04281(null), 3, null);
        }
    }
    ...
    public final void m1147setLookaheadOffsetgyyYBs(long j) {
        this.lookaheadOffset = j;
    }

    /* renamed from: animatePlacementDelta-ar5cAso, reason: not valid java name */
    public final void m1141animatePlacementDeltaar5cAso(long delta, boolean isMovingAway) {
        FiniteAnimationSpec<IntOffset> finiteAnimationSpec = this.placementSpec;
        if (finiteAnimationSpec == null) {
            return;
        }
        long jM7386minusqkQi6aY = IntOffset.m7386minusqkQi6aY(m1144getPlacementDeltanOccac(), delta);
        m1140setPlacementDeltagyyYBs(jM7386minusqkQi6aY);
        setPlacementAnimationInProgress(true);
        this.isRunningMovingAwayAnimation = isMovingAway;
        BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, null, new LazyLayoutItemAnimation$animatePlacementDelta$1(this, finiteAnimationSpec, jM7386minusqkQi6aY, null), 3, null);
    }
    ...
    public final void animateAppearance() {
        ...
        if (isAppearanceAnimationInProgress() || finiteAnimationSpec == null || graphicsLayer == null) {
            if (isDisappearanceAnimationInProgress()) {
                ...
                BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, null, new C04261(null), 3, null);
                return;
            }
            return;
        }
    ...
    static final class C04261 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return LazyLayoutItemAnimation.this.new C04261(continuation);
        }
    ...
    public final void animateDisappearance() {
        ...
        BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, null, new C04271(finiteAnimationSpec, graphicsLayer, null), 3, null);
    }

    /* compiled from: LazyLayoutItemAnimation.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {1, 8, 0}, xi = 48)
    @DebugMetadata(c = "androidx.compose.foundation.lazy.layout.LazyLayoutItemAnimation$animateDisappearance$1", f = "LazyLayoutItemAnimation.kt", i = {}, l = {WinError.ERROR_EXE_MACHINE_TYPE_MISMATCH}, m = "invokeSuspend", n = {}, s = {})
    ...
    static final class C04271 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04271(FiniteAnimationSpec<Float> finiteAnimationSpec, GraphicsLayer graphicsLayer, Continuation<? super C04271> continuation) {
            super(2, continuation);
            this.$spec = finiteAnimationSpec;
            this.$layer = graphicsLayer;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return LazyLayoutItemAnimation.this.new C04271(this.$spec, this.$layer, continuation);
        }
    ...
    public final void release() {
        ...
        if (isPlacementAnimationInProgress()) {
            ...
            BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, null, new C04291(null), 3, null);
        }
        if (isAppearanceAnimationInProgress()) {
            setAppearanceAnimationInProgress(false);
            BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, null, new C04302(null), 3, null);
        }
        if (isDisappearanceAnimationInProgress()) {
        ...
        m1140setPlacementDeltagyyYBs(IntOffset.INSTANCE.m7394getZeronOccac());
    ...
    /* compiled from: LazyLayoutItemAnimation.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {1, 8, 0}, xi = 48)
    @DebugMetadata(c = "androidx.compose.foundation.lazy.layout.LazyLayoutItemAnimation$release$1", f = "LazyLayoutItemAnimation.kt", i = {}, l = {WinError.ERROR_PIPE_BUSY}, m = "invokeSuspend", n = {}, s = {})
    ...
    static final class C04291 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return LazyLayoutItemAnimation.this.new C04291(continuation);
        }
    ...
    static final class C04302 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return LazyLayoutItemAnimation.this.new C04302(continuation);
        }
    ...
    public static final class Companion {
        ...
        public final long m1149getNotInitializednOccac() {
