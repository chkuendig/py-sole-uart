    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        for (int i = 0; i < placeablesCount; i++) {
            ...
            if (animation != null) {
                ...
                if ((m1128getMainAxisgyyYBs(offset) <= mainAxisSize && m1128getMainAxisgyyYBs(jM7387plusqkQi6aY) <= mainAxisSize) || (m1128getMainAxisgyyYBs(offset) >= i2 && m1128getMainAxisgyyYBs(jM7387plusqkQi6aY) >= i2)) {
            ...
            if (this.reverseLayout) {
                int iM7383getXimpl = getIsVertical() ? IntOffset.m7383getXimpl(offset) : (this.mainAxisLayoutSize - IntOffset.m7383getXimpl(offset)) - getMainAxisSize(placeable);
                if (getIsVertical()) {
                    iM7384getYimpl = (this.mainAxisLayoutSize - IntOffset.m7384getYimpl(offset)) - getMainAxisSize(placeable);
                } else {
                    iM7384getYimpl = IntOffset.m7384getYimpl(offset);
                }
                offset = IntOffsetKt.IntOffset(iM7383getXimpl, iM7384getYimpl);
            }
            long jM7387plusqkQi6aY2 = IntOffset.m7387plusqkQi6aY(offset, this.visualOffset);
            if (animation != null) {
