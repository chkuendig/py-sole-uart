...
public final class GridItemSpan {
    ...
    public static final /* synthetic */ GridItemSpan m1104boximpl(long j) {
        return new GridItemSpan(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m1105constructorimpl(long j) {
        return j;
    }
    ...
    public static final int m1108getCurrentLineSpanimpl(long j) {
        return (int) j;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m1109hashCodeimpl(long j) {
        return Long.hashCode(j);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m1110toStringimpl(long j) {
        return "GridItemSpan(packedValue=" + j + ')';
    }

    public boolean equals(Object obj) {
        return m1106equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m1109hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m1110toStringimpl(this.packedValue);
    }
