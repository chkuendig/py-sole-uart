...
public final class LazyGridMeasureKt {
    ...
    public static final LazyGridMeasureResult m1126measureLazyGridOZKpZRA(int i, LazyGridMeasuredLineProvider lazyGridMeasuredLineProvider, LazyGridMeasuredItemProvider lazyGridMeasuredItemProvider, int i2, int i3, int i4, int i5, int i6, int i7, float f, long j, boolean z, Arrangement.Vertical vertical, Arrangement.Horizontal horizontal, boolean z2, Density density, LazyLayoutItemAnimator<LazyGridMeasuredItem> lazyLayoutItemAnimator, int i8, List<Integer> list, CoroutineScope coroutineScope, final MutableState<Unit> mutableState, GraphicsContext graphicsContext, Function1<? super Integer, ? extends List<Pair<Integer, Constraints>>> function1, Function3<? super Integer, ? super Integer, ? super Function1<? super Placeable.PlacementScope, Unit>, ? extends MeasureResult> function3) {
        ...
        int iM7225constrainWidthK40F9xA;
        int iM7207getMaxHeightimpl;
        int iM7224constrainHeightK40F9xA;
        int i13;
        ...
        if (i <= 0) {
            ...
            lazyLayoutItemAnimator.onMeasured(0, iM7210getMinWidthimpl, iM7209getMinHeightimpl, new ArrayList(), lazyGridMeasuredItemProvider.getKeyIndexMap(), lazyGridMeasuredItemProvider, z, false, i8, false, 0, 0, coroutineScope, graphicsContext);
            long jM1150getMinSizeToFitDisappearingItemsYbymL2g = lazyLayoutItemAnimator.m1150getMinSizeToFitDisappearingItemsYbymL2g();
            if (!IntSize.m7424equalsimpl0(jM1150getMinSizeToFitDisappearingItemsYbymL2g, IntSize.INSTANCE.m7431getZeroYbymL2g())) {
                iM7210getMinWidthimpl = ConstraintsKt.m7225constrainWidthK40F9xA(j, IntSize.m7426getWidthimpl(jM1150getMinSizeToFitDisappearingItemsYbymL2g));
                iM7209getMinHeightimpl = ConstraintsKt.m7224constrainHeightK40F9xA(j, IntSize.m7425getHeightimpl(jM1150getMinSizeToFitDisappearingItemsYbymL2g));
            }
            return new LazyGridMeasureResult(null, 0, false, 0.0f, function3.invoke(Integer.valueOf(iM7210getMinWidthimpl), Integer.valueOf(iM7209getMinHeightimpl), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridMeasureKt$measureLazyGrid$3
        ...
        while (i42 < size) {
            ...
            if (iIntValue < 0 || iIntValue >= index2) {
                ...
                i19 = i31;
                i20 = i10;
                LazyGridMeasuredItem lazyGridMeasuredItemMo1099getAndMeasurehBUhpc = lazyGridMeasuredItemProvider.mo1099getAndMeasurehBUhpc(iIntValue, 0, iSpanOf, lazyGridMeasuredLineProvider.m1130childConstraintsJhjzzOo$foundation_release(0, iSpanOf));
                ArrayList arrayList = listEmptyList == null ? new ArrayList() : listEmptyList;
                arrayList.add(lazyGridMeasuredItemMo1099getAndMeasurehBUhpc);
        ...
        while (i49 < size2) {
            ...
            if (i44 + 1 > iIntValue2 || iIntValue2 >= i) {
                ...
                i14 = i49;
                LazyGridMeasuredItem lazyGridMeasuredItemMo1099getAndMeasurehBUhpc2 = lazyGridMeasuredItemProvider.mo1099getAndMeasurehBUhpc(iIntValue2, 0, iSpanOf2, lazyGridMeasuredLineProvider.m1130childConstraintsJhjzzOo$foundation_release(0, iSpanOf2));
                if (arrayListEmptyList == null) {
                    arrayListEmptyList = new ArrayList();
                }
                List list4 = arrayListEmptyList;
                list4.add(lazyGridMeasuredItemMo1099getAndMeasurehBUhpc2);
        ...
        if (z) {
            iM7225constrainWidthK40F9xA = Constraints.m7208getMaxWidthimpl(j);
        } else {
            iM7225constrainWidthK40F9xA = ConstraintsKt.m7225constrainWidthK40F9xA(j, i9);
        }
        int i52 = iM7225constrainWidthK40F9xA;
        if (z) {
            iM7207getMaxHeightimpl = ConstraintsKt.m7224constrainHeightK40F9xA(j, i9);
        } else {
            iM7207getMaxHeightimpl = Constraints.m7207getMaxHeightimpl(j);
        }
        int i53 = iM7207getMaxHeightimpl;
        int i54 = i9;
        ...
        long jM1150getMinSizeToFitDisappearingItemsYbymL2g2 = lazyLayoutItemAnimator.m1150getMinSizeToFitDisappearingItemsYbymL2g();
        if (IntSize.m7424equalsimpl0(jM1150getMinSizeToFitDisappearingItemsYbymL2g2, IntSize.INSTANCE.m7431getZeroYbymL2g())) {
            iM7224constrainHeightK40F9xA = i53;
            i13 = i52;
        } else {
            int i55 = z ? i53 : i52;
            int iM7225constrainWidthK40F9xA2 = ConstraintsKt.m7225constrainWidthK40F9xA(j, Math.max(i52, IntSize.m7426getWidthimpl(jM1150getMinSizeToFitDisappearingItemsYbymL2g2)));
            iM7224constrainHeightK40F9xA = ConstraintsKt.m7224constrainHeightK40F9xA(j, Math.max(i53, IntSize.m7425getHeightimpl(jM1150getMinSizeToFitDisappearingItemsYbymL2g2)));
            int i56 = z ? iM7224constrainHeightK40F9xA : iM7225constrainWidthK40F9xA2;
            if (i56 != i55) {
            ...
            i13 = iM7225constrainWidthK40F9xA2;
        }
        if (i44 == i - 1 && i54 <= i2) {
            z3 = false;
        }
        MeasureResult measureResultInvoke = function3.invoke(Integer.valueOf(i13), Integer.valueOf(iM7224constrainHeightK40F9xA), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridMeasureKt$measureLazyGrid$6
