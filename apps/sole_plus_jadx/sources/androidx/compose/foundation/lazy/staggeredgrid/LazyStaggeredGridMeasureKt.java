...
public final class LazyStaggeredGridMeasureKt {
    ...
    public static final LazyStaggeredGridMeasureResult m1196measureStaggeredGridXtK8cYQ(LazyLayoutMeasureScope lazyLayoutMeasureScope, LazyStaggeredGridState lazyStaggeredGridState, List<Integer> list, LazyStaggeredGridItemProvider lazyStaggeredGridItemProvider, LazyStaggeredGridSlots lazyStaggeredGridSlots, long j, boolean z, boolean z2, long j2, int i, int i2, int i3, int i4, CoroutineScope coroutineScope, GraphicsContext graphicsContext) {
        ...
        if (iArrUpdateScrollPositionIfTheFirstItemWasMoved$foundation_release.length != lazyStaggeredGridMeasureContext.getLaneCount()) {
            ...
            int i6 = 0;
            while (i6 < laneCount) {
                if (i6 >= iArrUpdateScrollPositionIfTheFirstItemWasMoved$foundation_release.length || (iM1195maxInRangejy6DScQ = iArrUpdateScrollPositionIfTheFirstItemWasMoved$foundation_release[i6]) == -1) {
                    iM1195maxInRangejy6DScQ = i6 == 0 ? 0 : m1195maxInRangejy6DScQ(iArr, SpanRange.m1206constructorimpl(0, i6)) + 1;
                }
                iArr[i6] = iM1195maxInRangejy6DScQ;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:172:0x0355, code lost:
        ...
        r13 = r31;
        r47 = r5;
        r5 = r0.m1191getSpanRangelOCCd4c(r46.getItemProvider(), r7, r6);
        r15 = r46.getLaneInfo();
        r48 = r3;
        r32 = r4;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:179:0x038b, code lost:
        ...
        r15.setLane(r7, r12);
        r12 = r46.getMeasuredItemProvider().m1200getAndMeasurejy6DScQ(r7, r5);
        r5 = m1195maxInRangejy6DScQ(r8, r5);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:194:0x03c0, code lost:
        ...
        r4 = r4 + 1;
     */
    /* JADX WARN: Removed duplicated region for block: B:304:0x061a  */
            ...
            for (ArrayDeque<LazyStaggeredGridMeasuredItem> arrayDeque2 : arrayDequeArr) {
                if (!arrayDeque2.isEmpty()) {
                    ...
                    if (lazyStaggeredGridMeasuredItemRemoveFirst.getLane() == i2) {
                        long jM1206constructorimpl = SpanRange.m1206constructorimpl(lazyStaggeredGridMeasuredItemRemoveFirst.getLane(), lazyStaggeredGridMeasuredItemRemoveFirst.getSpan());
                        int iM1195maxInRangejy6DScQ = m1195maxInRangejy6DScQ(iArr, jM1206constructorimpl);
                        lazyStaggeredGridMeasuredItemRemoveFirst.position(iM1195maxInRangejy6DScQ, lazyStaggeredGridMeasureContext.getResolvedSlots().getPositions()[i2], i);
                        arrayList.add(lazyStaggeredGridMeasuredItemRemoveFirst);
                        int i5 = (int) (jM1206constructorimpl & 4294967295L);
                        for (int i6 = (int) (jM1206constructorimpl >> 32); i6 < i5; i6++) {
                            iArr[i6] = lazyStaggeredGridMeasuredItemRemoveFirst.getMainAxisSizeWithSpacings() + iM1195maxInRangejy6DScQ;
                        }
                    }
                }
            }
        ...
        if (z) {
            ...
            if (size >= 0) {
                while (true) {
                    ...
                    if (function12.invoke(Integer.valueOf(iIntValue)).booleanValue()) {
                        long jM1191getSpanRangelOCCd4c = lazyStaggeredGridMeasureContext.m1191getSpanRangelOCCd4c(lazyStaggeredGridMeasureContext.getItemProvider(), iIntValue, 0);
                        if (arrayList == null) {
                            arrayList = new ArrayList();
                        }
                        LazyStaggeredGridMeasuredItem lazyStaggeredGridMeasuredItemM1200getAndMeasurejy6DScQ = lazyStaggeredGridMeasureContext.getMeasuredItemProvider().m1200getAndMeasurejy6DScQ(iIntValue, jM1191getSpanRangelOCCd4c);
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (function12.invoke(Integer.valueOf(iIntValue2)).booleanValue()) {
                    long jM1191getSpanRangelOCCd4c2 = lazyStaggeredGridMeasureContext.m1191getSpanRangelOCCd4c(lazyStaggeredGridMeasureContext.getItemProvider(), iIntValue2, 0);
                    if (arrayList == null) {
                        arrayList = new ArrayList();
                    }
                    LazyStaggeredGridMeasuredItem lazyStaggeredGridMeasuredItemM1200getAndMeasurejy6DScQ2 = lazyStaggeredGridMeasureContext.getMeasuredItemProvider().m1200getAndMeasurejy6DScQ(iIntValue2, jM1191getSpanRangelOCCd4c2);
