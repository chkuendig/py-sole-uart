...
public abstract class LazyStaggeredGridMeasureProvider implements LazyLayoutMeasuredItemProvider<LazyStaggeredGridMeasuredItem> {
    ...
    public abstract LazyStaggeredGridMeasuredItem mo1193createItempitSLOA(int index, int lane, int span, Object key, Object contentType, List<? extends Placeable> placeables, long constraints);
    ...
    private final long m1199childConstraintsJhjzzOo(int slot, int span) {
        int i;
        if (span == 1) {
        ...
        if (this.isVertical) {
            return Constraints.INSTANCE.m7220fixedWidthOenEA2s(i);
        }
        return Constraints.INSTANCE.m7219fixedHeightOenEA2s(i);
    }

    /* renamed from: getAndMeasure-jy6DScQ, reason: not valid java name */
    public final LazyStaggeredGridMeasuredItem m1200getAndMeasurejy6DScQ(int index, long span) {
        ...
        long jM1199childConstraintsJhjzzOo = m1199childConstraintsJhjzzOo(iCoerceAtMost, iCoerceAtMost2);
        return mo1193createItempitSLOA(index, iCoerceAtMost, iCoerceAtMost2, key, contentType, this.measureScope.mo1156measure0kLqBqw(index, jM1199childConstraintsJhjzzOo), jM1199childConstraintsJhjzzOo);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasuredItemProvider
    /* renamed from: getAndMeasure--hBUhpc */
    public LazyStaggeredGridMeasuredItem mo1099getAndMeasurehBUhpc(int index, int lane, int span, long constraints) {
        return mo1193createItempitSLOA(index, lane, span, this.itemProvider.getKey(index), this.itemProvider.getContentType(index), this.measureScope.mo1156measure0kLqBqw(index, constraints), constraints);
    }
