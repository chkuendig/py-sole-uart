        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = (Function2) new Function2<LazyLayoutMeasureScope, Constraints, LazyStaggeredGridMeasureResult>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridMeasurePolicyKt$rememberStaggeredGridMeasurePolicy$1$1
                ...
                public final LazyStaggeredGridMeasureResult m1198invoke0kLqBqw(LazyLayoutMeasureScope lazyLayoutMeasureScope, long j) {
                    long jIntOffset;
                    ObservableScopeInvalidator.m1159attachToScopeimpl(lazyStaggeredGridState.m1203getMeasurementScopeInvalidatorzYiylxw$foundation_release());
                    CheckScrollableContainerConstraintsKt.m568checkScrollableContainerConstraintsK40F9xA(j, orientation);
                    LazyStaggeredGridSlots lazyStaggeredGridSlotsMo1179invoke0kLqBqw = lazyGridStaggeredGridSlotsProvider.mo1179invoke0kLqBqw(lazyLayoutMeasureScope, j);
                    ...
                    int i2 = lazyLayoutMeasureScope.mo671roundToPx0680j_4(LazyStaggeredGridMeasurePolicyKt.beforePadding(paddingValues, orientation, z, lazyLayoutMeasureScope.getLayoutDirection()));
                    int i3 = lazyLayoutMeasureScope.mo671roundToPx0680j_4(LazyStaggeredGridMeasurePolicyKt.afterPadding(paddingValues, orientation, z, lazyLayoutMeasureScope.getLayoutDirection()));
                    int i4 = lazyLayoutMeasureScope.mo671roundToPx0680j_4(LazyStaggeredGridMeasurePolicyKt.startPadding(paddingValues, orientation, lazyLayoutMeasureScope.getLayoutDirection()));
                    int iM7207getMaxHeightimpl = ((z2 ? Constraints.m7207getMaxHeightimpl(j) : Constraints.m7208getMaxWidthimpl(j)) - i2) - i3;
                    if (z2) {
                    ...
                    int i5 = lazyLayoutMeasureScope.mo671roundToPx0680j_4(Dp.m7255constructorimpl(PaddingKt.calculateStartPadding(paddingValues2, lazyLayoutMeasureScope.getLayoutDirection()) + PaddingKt.calculateEndPadding(paddingValues2, lazyLayoutMeasureScope.getLayoutDirection())));
                    PaddingValues paddingValues3 = paddingValues;
                    boolean z3 = z2;
                    LazyStaggeredGridMeasureResult lazyStaggeredGridMeasureResultM1196measureStaggeredGridXtK8cYQ = LazyStaggeredGridMeasureKt.m1196measureStaggeredGridXtK8cYQ(lazyLayoutMeasureScope, lazyStaggeredGridState, LazyLayoutBeyondBoundsStateKt.calculateLazyLayoutPinnedIndices(lazyStaggeredGridItemProviderInvoke, lazyStaggeredGridState.getPinnedItems(), lazyStaggeredGridState.getBeyondBoundsInfo()), lazyStaggeredGridItemProviderInvoke, lazyStaggeredGridSlotsMo1179invoke0kLqBqw, Constraints.m7198copyZbe2FdA$default(j, ConstraintsKt.m7225constrainWidthK40F9xA(j, i5), 0, ConstraintsKt.m7224constrainHeightK40F9xA(j, lazyLayoutMeasureScope.mo671roundToPx0680j_4(Dp.m7255constructorimpl(paddingValues3.getTop() + paddingValues3.getBottom()))), 0, 10, null), z3, z, j2, iM7207getMaxHeightimpl, lazyLayoutMeasureScope.mo671roundToPx0680j_4(f), i2, i3, coroutineScope, graphicsContext);
                    LazyStaggeredGridState.applyMeasureResult$foundation_release$default(lazyStaggeredGridState, lazyStaggeredGridMeasureResultM1196measureStaggeredGridXtK8cYQ, false, 2, null);
                    return lazyStaggeredGridMeasureResultM1196measureStaggeredGridXtK8cYQ;
                }
            };
