...
final class LazyStaggeredGridSlotCache implements LazyGridStaggeredGridSlotsProvider {
    ...
    public LazyStaggeredGridSlots mo1179invoke0kLqBqw(Density density, long constraints) {
        if (this.cachedSizes != null && Constraints.m7201equalsimpl0(this.cachedConstraints, constraints) && this.cachedDensity == density.getDensity()) {
        ...
        LazyStaggeredGridSlots lazyStaggeredGridSlotsInvoke = this.calculation.invoke(density, Constraints.m7195boximpl(constraints));
