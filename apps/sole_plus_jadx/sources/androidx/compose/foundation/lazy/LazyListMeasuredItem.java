...
public final class LazyListMeasuredItem implements LazyListItemInfo, LazyLayoutMeasuredItem {
        ...
        if (updateAnimations) {
            ...
            for (int i2 = 0; i2 < placeablesCount; i2++) {
                ...
                if (animation != null) {
                    ...
                    int iM7383getXimpl = getIsVertical() ? IntOffset.m7383getXimpl(rawOffset) : Integer.valueOf(IntOffset.m7383getXimpl(rawOffset) + delta).intValue();
                    boolean isVertical = getIsVertical();
                    int iM7384getYimpl = IntOffset.m7384getYimpl(rawOffset);
                    if (isVertical) {
                        iM7384getYimpl += delta;
                    }
                    animation.m1148setRawOffsetgyyYBs(IntOffsetKt.IntOffset(iM7383getXimpl, iM7384getYimpl));
                }
            }
        }
    }
    ...
    public final void place(Placeable.PlacementScope scope, boolean isLookingAhead) {
        ...
        for (int i = 0; i < placeablesCount; i++) {
            ...
            long jMo1097getOffsetBjo55l4 = mo1097getOffsetBjo55l4(i);
            LazyLayoutItemAnimation animation = this.animator.getAnimation(getKey(), i);
            if (animation != null) {
                if (isLookingAhead) {
                    animation.m1147setLookaheadOffsetgyyYBs(jMo1097getOffsetBjo55l4);
                } else {
                    if (!IntOffset.m7382equalsimpl0(animation.getLookaheadOffset(), LazyLayoutItemAnimation.INSTANCE.m1149getNotInitializednOccac())) {
                        jMo1097getOffsetBjo55l4 = animation.getLookaheadOffset();
                    }
                    long jM7387plusqkQi6aY = IntOffset.m7387plusqkQi6aY(jMo1097getOffsetBjo55l4, animation.m1144getPlacementDeltanOccac());
                    if ((m1095getMainAxisgyyYBs(jMo1097getOffsetBjo55l4) <= mainAxisSize && m1095getMainAxisgyyYBs(jM7387plusqkQi6aY) <= mainAxisSize) || (m1095getMainAxisgyyYBs(jMo1097getOffsetBjo55l4) >= i2 && m1095getMainAxisgyyYBs(jM7387plusqkQi6aY) >= i2)) {
                        animation.cancelPlacementAnimation();
                    }
                    jMo1097getOffsetBjo55l4 = jM7387plusqkQi6aY;
                }
            ...
            if (this.reverseLayout) {
                int iM7383getXimpl = getIsVertical() ? IntOffset.m7383getXimpl(jMo1097getOffsetBjo55l4) : (this.mainAxisLayoutSize - IntOffset.m7383getXimpl(jMo1097getOffsetBjo55l4)) - getMainAxisSize(placeable);
                if (getIsVertical()) {
                    iM7384getYimpl = (this.mainAxisLayoutSize - IntOffset.m7384getYimpl(jMo1097getOffsetBjo55l4)) - getMainAxisSize(placeable);
                } else {
                    iM7384getYimpl = IntOffset.m7384getYimpl(jMo1097getOffsetBjo55l4);
                }
                jMo1097getOffsetBjo55l4 = IntOffsetKt.IntOffset(iM7383getXimpl, iM7384getYimpl);
            }
            long jM7387plusqkQi6aY2 = IntOffset.m7387plusqkQi6aY(jMo1097getOffsetBjo55l4, this.visualOffset);
            if (!isLookingAhead && animation != null) {
                animation.m1146setFinalOffsetgyyYBs(jM7387plusqkQi6aY2);
            }
            if (getIsVertical()) {
                if (layer != null) {
                    Placeable.PlacementScope.m6027placeWithLayeraW9wM$default(scope, placeable, jM7387plusqkQi6aY2, layer, 0.0f, 4, (Object) null);
                } else {
                    Placeable.PlacementScope.m6026placeWithLayeraW9wM$default(scope, placeable, jM7387plusqkQi6aY2, 0.0f, (Function1) null, 6, (Object) null);
                }
            } else if (layer != null) {
