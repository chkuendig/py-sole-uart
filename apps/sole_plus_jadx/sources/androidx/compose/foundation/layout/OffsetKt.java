...
public final class OffsetKt {
    ...
    public static final Modifier m945offsetVpY3zN4(Modifier modifier, final float f, final float f2) {
        return modifier.then(new OffsetElement(f, f2, true, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.OffsetKt.offset.1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set("x", Dp.m7253boximpl(f));
                inspectorInfo.getProperties().set("y", Dp.m7253boximpl(f2));
            }
        }, null));
    }

    /* renamed from: absoluteOffset-VpY3zN4, reason: not valid java name */
    public static final Modifier m943absoluteOffsetVpY3zN4(Modifier modifier, final float f, final float f2) {
    ...
    public static /* synthetic */ Modifier m946offsetVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m945offsetVpY3zN4(modifier, f, f2);
    }

    /* renamed from: absoluteOffset-VpY3zN4$default, reason: not valid java name */
    public static /* synthetic */ Modifier m944absoluteOffsetVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.m7255constructorimpl(0);
        }
        if ((i & 2) != 0) {
        ...
        return m943absoluteOffsetVpY3zN4(modifier, f, f2);
    }
}
