...
public final class FlowLayoutKt {
    ...
    */
    ...
    public static final int minIntrinsicMainAxisSize(List<? extends IntrinsicMeasurable> list, Function3<? super IntrinsicMeasurable, ? super Integer, ? super Integer, Integer> function3, Function3<? super IntrinsicMeasurable, ? super Integer, ? super Integer, Integer> function32, int i, int i2, int i3, int i4, int i5, FlowLayoutOverflowState flowLayoutOverflowState) {
        ...
        if (size2 != 0) {
            ...
            if (size != 0) {
                ...
                int i13 = i11;
                int i14 = iSum;
                while (i13 <= i14 && iM332getFirstimpl != i) {
                    int i15 = (i13 + i14) / 2;
                    int i16 = i14;
                    int i17 = i13;
                    long jIntrinsicCrossAxisSize = intrinsicCrossAxisSize(list, iArr, iArr2, i15, i2, i3, i4, i5, flowLayoutOverflowState);
                    iM332getFirstimpl = IntIntPair.m332getFirstimpl(jIntrinsicCrossAxisSize);
                    int iM333getSecondimpl = IntIntPair.m333getSecondimpl(jIntrinsicCrossAxisSize);
                    if (iM332getFirstimpl > i || iM333getSecondimpl < iMin) {
                        i13 = i15 + 1;
                        if (i13 > i16) {
                            return i13;
                        }
    ...
    public static final long intrinsicCrossAxisSize(List<? extends IntrinsicMeasurable> list, Function3<? super IntrinsicMeasurable, ? super Integer, ? super Integer, Integer> function3, Function3<? super IntrinsicMeasurable, ? super Integer, ? super Integer, Integer> function32, int i, int i2, int i3, int i4, int i5, FlowLayoutOverflowState flowLayoutOverflowState) {
        ...
        int i9 = 0;
        int iM333getSecondimpl = 0;
        int i10 = 0;
        if (flowLayoutBuildingBlocks.m908getWrapInfoOpUlnko(list.size() > 1, 0, IntIntPair.m328constructorimpl(i, Integer.MAX_VALUE), intrinsicMeasurable == null ? null : IntIntPair.m325boximpl(IntIntPair.m328constructorimpl(iIntValue2, iIntValue)), 0, 0, 0, false, false).getIsLastItemInContainer()) {
            IntIntPair intIntPairM913ellipsisSizeF35zmw$foundation_layout_release = flowLayoutOverflowState.m913ellipsisSizeF35zmw$foundation_layout_release(intrinsicMeasurable != null, 0, 0);
            return IntIntPair.m328constructorimpl(intIntPairM913ellipsisSizeF35zmw$foundation_layout_release != null ? IntIntPair.m333getSecondimpl(intIntPairM913ellipsisSizeF35zmw$foundation_layout_release.getPackedValue()) : 0, 0);
        }
        int size = list.size();
        int i11 = i;
        int i12 = 0;
        ...
        while (true) {
            ...
            int i16 = i6 - i14;
            FlowLayoutBuildingBlocks.WrapInfo wrapInfoM908getWrapInfoOpUlnko = flowLayoutBuildingBlocks.m908getWrapInfoOpUlnko(z, i16, IntIntPair.m328constructorimpl(i15, Integer.MAX_VALUE), intrinsicMeasurable2 == null ? null : IntIntPair.m325boximpl(IntIntPair.m328constructorimpl(iIntValue4, iIntValue3)), i9, iM333getSecondimpl, iMax, false, false);
            if (wrapInfoM908getWrapInfoOpUlnko.getIsLastItemInLine()) {
                iM333getSecondimpl += iMax + i3;
                FlowLayoutBuildingBlocks.WrapEllipsisInfo wrapEllipsisInfo = flowLayoutBuildingBlocks.getWrapEllipsisInfo(wrapInfoM908getWrapInfoOpUlnko, intrinsicMeasurable2 != null, i9, iM333getSecondimpl, i15, i16);
                int i17 = iIntValue4 - i2;
                i9++;
                if (!wrapInfoM908getWrapInfoOpUlnko.getIsLastItemInContainer()) {
                    i7 = i;
                    iIntValue2 = i17;
                    i14 = i6;
                    i10 = 0;
                    ...
                    if (!wrapEllipsisInfo.getPlaceEllipsisOnLastContentLine()) {
                        iM333getSecondimpl += IntIntPair.m333getSecondimpl(ellipsisSize) + i3;
                    }
                }
            } else {
                i10 = iMax;
        ...
        return IntIntPair.m328constructorimpl(iM333getSecondimpl - i3, i6);
    }
    ...
    public static final long m911measureAndCacherqJ1uqs(Measurable measurable, FlowLineMeasurePolicy flowLineMeasurePolicy, long j, Function1<? super Placeable, Unit> function1) {
        ...
        if (RowColumnImplKt.getWeight(RowColumnImplKt.getRowColumnParentData(measurable2)) == 0.0f) {
            ...
            if (((rowColumnParentData == null || (flowLayoutData = rowColumnParentData.getFlowLayoutData()) == null) ? null : Float.valueOf(flowLayoutData.getFillCrossAxisFraction())) == null) {
                Placeable placeableMo5957measureBRTryo0 = measurable.mo5957measureBRTryo0(j);
                function1.invoke(placeableMo5957measureBRTryo0);
                return IntIntPair.m328constructorimpl(flowLineMeasurePolicy.mainAxisSize(placeableMo5957measureBRTryo0), flowLineMeasurePolicy.crossAxisSize(placeableMo5957measureBRTryo0));
            }
        }
        int iMainAxisMin = mainAxisMin(measurable2, flowLineMeasurePolicy.isHorizontal(), Integer.MAX_VALUE);
        return IntIntPair.m328constructorimpl(iMainAxisMin, crossAxisMin(measurable2, flowLineMeasurePolicy.isHorizontal(), iMainAxisMin));
    }
    ...
    public static final MeasureResult m912placeHelperBmaY500(MeasureScope measureScope, long j, int i, int i2, int[] iArr, final MutableVector<MeasureResult> mutableVector, FlowLineMeasurePolicy flowLineMeasurePolicy, int[] iArr2) {
        ...
        if (zIsHorizontal) {
            ...
            iCoerceIn = RangesKt.coerceIn((measureScope.mo671roundToPx0680j_4(verticalArrangement.getSpacing()) * (mutableVector.getSize() - 1)) + i2, Constraints.m7209getMinHeightimpl(j), Constraints.m7207getMaxHeightimpl(j));
            verticalArrangement.arrange(measureScope, iCoerceIn, iArr, iArr2);
        } else {
            if (horizontalArrangement == null) {
                throw new IllegalArgumentException("null horizontalArrangement".toString());
            }
            int iCoerceIn2 = RangesKt.coerceIn((measureScope.mo671roundToPx0680j_4(horizontalArrangement.getSpacing()) * (mutableVector.getSize() - 1)) + i2, Constraints.m7209getMinHeightimpl(j), Constraints.m7207getMaxHeightimpl(j));
            horizontalArrangement.arrange(measureScope, iCoerceIn2, iArr, measureScope.getLayoutDirection(), iArr2);
            iCoerceIn = iCoerceIn2;
        }
        int iCoerceIn3 = RangesKt.coerceIn(i, Constraints.m7210getMinWidthimpl(j), Constraints.m7208getMaxWidthimpl(j));
        if (!zIsHorizontal) {
            int i3 = iCoerceIn;
    ...
    public static final MeasureResult m910breakDownItemsdi9J0FM(MeasureScope measureScope, FlowLineMeasurePolicy flowLineMeasurePolicy, Iterator<? extends Measurable> it, float f, float f2, long j, int i, int i2, FlowLayoutOverflowState flowLayoutOverflowState) {
        ...
        int i12;
        long j3;
        IntIntPair intIntPairM325boximpl;
        FlowLineInfo flowLineInfo2;
        IntIntPair intIntPairM325boximpl2;
        ...
        int iCeil = (int) Math.ceil(measureScope.mo677toPx0680j_4(f));
        int iCeil2 = (int) Math.ceil(measureScope.mo677toPx0680j_4(f2));
        long jM952constructorimpl = OrientationIndependentConstraints.m952constructorimpl(0, iM7208getMaxWidthimpl, 0, iM7207getMaxHeightimpl);
        long jM967toBoxConstraintsOenEA2s = OrientationIndependentConstraints.m967toBoxConstraintsOenEA2s(OrientationIndependentConstraints.m956copyyUG9Ft0$default(jM952constructorimpl, 0, 0, 0, 0, 14, null), flowLineMeasurePolicy.isHorizontal() ? LayoutOrientation.Horizontal : LayoutOrientation.Vertical);
        final Ref.ObjectRef objectRef2 = new Ref.ObjectRef();
        int i21 = 0;
        FlowLineInfo flowLineInfo3 = it2 instanceof ContextualFlowItemIterator ? new FlowLineInfo(0, 0, measureScope.mo674toDpu2uoSUM(iM7208getMaxWidthimpl), measureScope.mo674toDpu2uoSUM(iM7207getMaxHeightimpl), null) : null;
        Measurable measurableSafeNext = !it.hasNext() ? null : safeNext(it2, flowLineInfo3);
        IntIntPair intIntPairM325boximpl3 = measurableSafeNext != null ? IntIntPair.m325boximpl(m911measureAndCacherqJ1uqs(measurableSafeNext, flowLineMeasurePolicy, jM967toBoxConstraintsOenEA2s, new Function1<Placeable, Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutKt$breakDownItems$nextSize$1$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
        ...
        Integer numValueOf3 = intIntPairM325boximpl3 != null ? Integer.valueOf(IntIntPair.m332getFirstimpl(intIntPairM325boximpl3.getPackedValue())) : null;
        if (intIntPairM325boximpl3 != null) {
            measurable = measurableSafeNext;
            numValueOf = Integer.valueOf(IntIntPair.m333getSecondimpl(intIntPairM325boximpl3.getPackedValue()));
        } else {
            measurable = measurableSafeNext;
            numValueOf = null;
        }
        ...
        FlowLayoutBuildingBlocks.WrapInfo wrapInfoM908getWrapInfoOpUlnko = flowLayoutBuildingBlocks.m908getWrapInfoOpUlnko(it.hasNext(), 0, IntIntPair.m328constructorimpl(iM7208getMaxWidthimpl, iM7207getMaxHeightimpl), intIntPairM325boximpl3, 0, 0, 0, false, false);
        if (wrapInfoM908getWrapInfoOpUlnko.getIsLastItemInContainer()) {
            flowLineInfo = flowLineInfo4;
            objectRef = objectRef2;
            j2 = jM967toBoxConstraintsOenEA2s;
            boolean z = intIntPairM325boximpl3 != null;
            i3 = iCeil2;
            i4 = iCeil;
            measurable2 = measurable;
            i5 = iM7210getMinWidthimpl;
            mutableVector = mutableVector2;
            arrayList = arrayList4;
            mutableIntList = mutableIntList5;
            mutableIntList2 = mutableIntList6;
            wrapEllipsisInfo = flowLayoutBuildingBlocks.getWrapEllipsisInfo(wrapInfoM908getWrapInfoOpUlnko, z, -1, 0, iM7208getMaxWidthimpl, 0);
        } else {
            flowLineInfo = flowLineInfo4;
            measurable2 = measurable;
            objectRef = objectRef2;
        ...
        int i22 = iM7207getMaxHeightimpl;
        ...
        while (!wrapInfoM908getWrapInfoOpUlnko.getIsLastItemInContainer() && measurable3 != null) {
            ...
            if (flowLineInfo5 != null) {
                ...
                float f3 = measureScope.mo674toDpu2uoSUM(iCoerceAtLeast);
                if (z2) {
                    i10 = i23;
                    iCoerceAtLeast2 = i22;
                } else {
                ...
                flowLineInfo5.m921update4j6BHR0$foundation_layout_release(i37, i38, f3, measureScope.mo674toDpu2uoSUM(iCoerceAtLeast2));
            } else {
                i10 = i23;
                mutableIntObjectMap2 = mutableIntObjectMapMutableIntObjectMapOf;
                arrayList3 = arrayList;
            ...
            if (measurableSafeNext2 != null) {
                i12 = i31;
                j3 = j2;
                intIntPairM325boximpl = IntIntPair.m325boximpl(m911measureAndCacherqJ1uqs(measurableSafeNext2, flowLineMeasurePolicy, j3, new Function1<Placeable, Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutKt$breakDownItems$1$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    }
                ...
                i12 = i31;
                j3 = j2;
                intIntPairM325boximpl = null;
            }
            Integer numValueOf4 = intIntPairM325boximpl != null ? Integer.valueOf(IntIntPair.m332getFirstimpl(intIntPairM325boximpl.getPackedValue()) + i4) : null;
            Integer numValueOf5 = intIntPairM325boximpl != null ? Integer.valueOf(IntIntPair.m333getSecondimpl(intIntPairM325boximpl.getPackedValue())) : null;
            boolean zHasNext = it.hasNext();
            long jM328constructorimpl = IntIntPair.m328constructorimpl(i32, i22);
            if (intIntPairM325boximpl == null) {
                flowLineInfo2 = flowLineInfo5;
                intIntPairM325boximpl2 = null;
            } else {
                Intrinsics.checkNotNull(numValueOf4);
                int iIntValue2 = numValueOf4.intValue();
                Intrinsics.checkNotNull(numValueOf5);
                flowLineInfo2 = flowLineInfo5;
                intIntPairM325boximpl2 = IntIntPair.m325boximpl(IntIntPair.m328constructorimpl(iIntValue2, numValueOf5.intValue()));
            }
            FlowLayoutBuildingBlocks.WrapInfo wrapInfoM908getWrapInfoOpUlnko2 = flowLayoutBuildingBlocks.m908getWrapInfoOpUlnko(zHasNext, i35, jM328constructorimpl, intIntPairM325boximpl2, i21, i25, iMax, false, false);
            if (wrapInfoM908getWrapInfoOpUlnko2.getIsLastItemInLine()) {
                int iMin = Math.min(Math.max(i10, i12), i34);
                int i39 = i25 + iMax;
                FlowLayoutBuildingBlocks.WrapEllipsisInfo wrapEllipsisInfo4 = flowLayoutBuildingBlocks.getWrapEllipsisInfo(wrapInfoM908getWrapInfoOpUlnko2, intIntPairM325boximpl != null, i21, i39, i32, i35);
                ...
                i21++;
                i25 = i39 + i3;
                wrapInfoM908getWrapInfoOpUlnko = wrapInfoM908getWrapInfoOpUlnko2;
                i14 = i34;
                ...
                iM7208getMaxWidthimpl = i14;
            } else {
                wrapInfoM908getWrapInfoOpUlnko = wrapInfoM908getWrapInfoOpUlnko2;
                int i41 = i12;
                int i42 = i10;
                mutableIntList3 = mutableIntList8;
                iM7208getMaxWidthimpl = i34;
        ...
        if (wrapEllipsisInfo3 != null) {
            ...
            if (wrapEllipsisInfo3.getPlaceEllipsisOnLastContentLine()) {
                ...
                mutableIntList10.set(i44, Math.max(mutableIntList10.get(i44), IntIntPair.m333getSecondimpl(wrapEllipsisInfo3.getEllipsisSize())));
        ...
        while (i50 < i49) {
            ...
            int i57 = i47;
            int i58 = i50;
            MeasureResult measureResultMeasure = RowColumnMeasurePolicyKt.measure(flowLineMeasurePolicy, iMax2, Constraints.m7209getMinHeightimpl(jM952constructorimpl), Constraints.m7208getMaxWidthimpl(jM952constructorimpl), mutableIntList10.get(i50), i4, measureScope, arrayList2, placeableArr2, i56, i53, iArr6, i50);
