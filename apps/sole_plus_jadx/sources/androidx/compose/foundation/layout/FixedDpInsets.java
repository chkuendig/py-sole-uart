...
final class FixedDpInsets implements WindowInsets {
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        return density.mo671roundToPx0680j_4(this.leftDp);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getTop(Density density) {
        return density.mo671roundToPx0680j_4(this.topDp);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getRight(Density density, LayoutDirection layoutDirection) {
        return density.mo671roundToPx0680j_4(this.rightDp);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getBottom(Density density) {
        return density.mo671roundToPx0680j_4(this.bottomDp);
    }

    public String toString() {
        return "Insets(left=" + ((Object) Dp.m7266toStringimpl(this.leftDp)) + ", top=" + ((Object) Dp.m7266toStringimpl(this.topDp)) + ", right=" + ((Object) Dp.m7266toStringimpl(this.rightDp)) + ", bottom=" + ((Object) Dp.m7266toStringimpl(this.bottomDp)) + ')';
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m7260equalsimpl0(this.leftDp, fixedDpInsets.leftDp) && Dp.m7260equalsimpl0(this.topDp, fixedDpInsets.topDp) && Dp.m7260equalsimpl0(this.rightDp, fixedDpInsets.rightDp) && Dp.m7260equalsimpl0(this.bottomDp, fixedDpInsets.bottomDp);
    }

    public int hashCode() {
        return (((((Dp.m7261hashCodeimpl(this.leftDp) * 31) + Dp.m7261hashCodeimpl(this.topDp)) * 31) + Dp.m7261hashCodeimpl(this.rightDp)) * 31) + Dp.m7261hashCodeimpl(this.bottomDp);
    }
}
