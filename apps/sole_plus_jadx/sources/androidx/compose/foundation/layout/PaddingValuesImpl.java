...
public final class PaddingValuesImpl implements PaddingValues {
    ...
    public static /* synthetic */ void m1002getBottomD9Ej5fM$annotations() {
    }

    /* renamed from: getEnd-D9Ej5fM$annotations, reason: not valid java name */
    public static /* synthetic */ void m1003getEndD9Ej5fM$annotations() {
    }

    /* renamed from: getStart-D9Ej5fM$annotations, reason: not valid java name */
    public static /* synthetic */ void m1004getStartD9Ej5fM$annotations() {
    }

    /* renamed from: getTop-D9Ej5fM$annotations, reason: not valid java name */
    public static /* synthetic */ void m1005getTopD9Ej5fM$annotations() {
    }
    ...
    public final float m1009getTopD9Ej5fM() {
        return this.top;
    }
    ...
    public final float m1006getBottomD9Ej5fM() {
        return this.bottom;
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m7260equalsimpl0(this.start, paddingValuesImpl.start) && Dp.m7260equalsimpl0(this.top, paddingValuesImpl.top) && Dp.m7260equalsimpl0(this.end, paddingValuesImpl.end) && Dp.m7260equalsimpl0(this.bottom, paddingValuesImpl.bottom);
    }

    public int hashCode() {
        return (((((Dp.m7261hashCodeimpl(this.start) * 31) + Dp.m7261hashCodeimpl(this.top)) * 31) + Dp.m7261hashCodeimpl(this.end)) * 31) + Dp.m7261hashCodeimpl(this.bottom);
    }

    public String toString() {
        return "PaddingValues(start=" + ((Object) Dp.m7266toStringimpl(this.start)) + ", top=" + ((Object) Dp.m7266toStringimpl(this.top)) + ", end=" + ((Object) Dp.m7266toStringimpl(this.end)) + ", bottom=" + ((Object) Dp.m7266toStringimpl(this.bottom)) + ')';
    }
    ...
    public /* synthetic */ PaddingValuesImpl(float f, float f2, float f3, float f4, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.m7255constructorimpl(0) : f, (i & 2) != 0 ? Dp.m7255constructorimpl(0) : f2, (i & 4) != 0 ? Dp.m7255constructorimpl(0) : f3, (i & 8) != 0 ? Dp.m7255constructorimpl(0) : f4, null);
    }
}
