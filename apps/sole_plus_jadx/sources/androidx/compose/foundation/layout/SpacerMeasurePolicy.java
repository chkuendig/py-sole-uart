...
final class SpacerMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo342measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        return MeasureScope.layout$default(measureScope, Constraints.m7206getHasFixedWidthimpl(j) ? Constraints.m7208getMaxWidthimpl(j) : 0, Constraints.m7205getHasFixedHeightimpl(j) ? Constraints.m7207getMaxHeightimpl(j) : 0, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.SpacerMeasurePolicy$measure$1$1
