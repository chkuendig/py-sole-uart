...
final class OffsetElement extends ModifierNodeElement<OffsetNode> {
    ...
    public void update(OffsetNode node) {
        node.m949setX0680j_4(this.x);
        node.m950setY0680j_4(this.y);
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m7260equalsimpl0(this.x, offsetElement.x) && Dp.m7260equalsimpl0(this.y, offsetElement.y) && this.rtlAware == offsetElement.rtlAware;
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((Dp.m7261hashCodeimpl(this.x) * 31) + Dp.m7261hashCodeimpl(this.y)) * 31) + Boolean.hashCode(this.rtlAware);
    }

    public String toString() {
        return "OffsetModifierElement(x=" + ((Object) Dp.m7266toStringimpl(this.x)) + ", y=" + ((Object) Dp.m7266toStringimpl(this.y)) + ", rtlAware=" + this.rtlAware + ')';
    }
