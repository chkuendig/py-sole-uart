...
final class WrapContentNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo395measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        final Placeable placeableMo5957measureBRTryo0 = measurable.mo5957measureBRTryo0(ConstraintsKt.Constraints(this.direction != Direction.Vertical ? 0 : Constraints.m7210getMinWidthimpl(j), (this.direction == Direction.Vertical || !this.unbounded) ? Constraints.m7208getMaxWidthimpl(j) : Integer.MAX_VALUE, this.direction == Direction.Horizontal ? Constraints.m7209getMinHeightimpl(j) : 0, (this.direction == Direction.Horizontal || !this.unbounded) ? Constraints.m7207getMaxHeightimpl(j) : Integer.MAX_VALUE));
        final int iCoerceIn = RangesKt.coerceIn(placeableMo5957measureBRTryo0.getWidth(), Constraints.m7210getMinWidthimpl(j), Constraints.m7208getMaxWidthimpl(j));
        final int iCoerceIn2 = RangesKt.coerceIn(placeableMo5957measureBRTryo0.getHeight(), Constraints.m7209getMinHeightimpl(j), Constraints.m7207getMaxHeightimpl(j));
        return MeasureScope.layout$default(measureScope, iCoerceIn, iCoerceIn2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.WrapContentNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.m6022place70tqf50$default(placementScope, placeableMo5957measureBRTryo0, this.this$0.getAlignmentCallback().invoke(IntSize.m7418boximpl(IntSizeKt.IntSize(iCoerceIn - placeableMo5957measureBRTryo0.getWidth(), iCoerceIn2 - placeableMo5957measureBRTryo0.getHeight())), measureScope.getLayoutDirection()).m7392unboximpl(), 0.0f, 2, null);
            }
        }, 4, null);
    }
}
