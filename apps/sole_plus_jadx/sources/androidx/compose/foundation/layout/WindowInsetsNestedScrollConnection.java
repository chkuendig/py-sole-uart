...
final class WindowInsetsNestedScrollConnection implements NestedScrollConnection, WindowInsetsAnimationControlListener {
    ...
    public long mo1061onPreScrollOzD1aCk(long available, int source) {
        return m1059scroll8S9VItk(available, this.sideCalculator.hideMotion(Offset.m4294getXimpl(available), Offset.m4295getYimpl(available)));
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostScroll-DzOQY0M */
    public long mo787onPostScrollDzOQY0M(long consumed, long available, int source) {
        return m1059scroll8S9VItk(available, this.sideCalculator.showMotion(Offset.m4294getXimpl(available), Offset.m4295getYimpl(available)));
    }

    /* renamed from: scroll-8S9VItk, reason: not valid java name */
    private final long m1059scroll8S9VItk(long available, float scrollAmount) {
        ...
        if (scrollAmount != 0.0f) {
            if (this.windowInsets.isVisible() != (scrollAmount > 0.0f) || windowInsetsAnimationController != null) {
                if (windowInsetsAnimationController == null) {
                    ...
                    requestAnimationController();
                    return this.sideCalculator.mo1011consumedOffsetsMKHz9U(available);
                }
    ...
    public Object mo1060onPreFlingQWom1Mo(long j, Continuation<? super Velocity> continuation) {
        return m1058flinghuYlsQE(j, this.sideCalculator.hideMotion(Velocity.m7493getXimpl(j), Velocity.m7494getYimpl(j)), false, continuation);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostFling-RZ2iAVY */
    public Object mo786onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        return m1058flinghuYlsQE(j2, this.sideCalculator.showMotion(Velocity.m7493getXimpl(j2), Velocity.m7494getYimpl(j2)), true, continuation);
    }
    ...
    */
    public final java.lang.Object m1058flinghuYlsQE(long r26, float r28, boolean r29, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r30) {
        /*
            Method dump skipped, instructions count: 410
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.layout.WindowInsetsNestedScrollConnection.m1058flinghuYlsQE(long, float, boolean, kotlin.coroutines.Continuation):java.lang.Object");
    }
