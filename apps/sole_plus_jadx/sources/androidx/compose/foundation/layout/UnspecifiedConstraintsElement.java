...
final class UnspecifiedConstraintsElement extends ModifierNodeElement<UnspecifiedConstraintsNode> {
    ...
    public void update(UnspecifiedConstraintsNode node) {
        node.m1052setMinWidth0680j_4(this.minWidth);
        node.m1051setMinHeight0680j_4(this.minHeight);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        inspectorInfo.setName("defaultMinSize");
        inspectorInfo.getProperties().set(SdkConstants.ATTR_MIN_WIDTH, Dp.m7253boximpl(this.minWidth));
        inspectorInfo.getProperties().set("minHeight", Dp.m7253boximpl(this.minHeight));
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m7260equalsimpl0(this.minWidth, unspecifiedConstraintsElement.minWidth) && Dp.m7260equalsimpl0(this.minHeight, unspecifiedConstraintsElement.minHeight);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (Dp.m7261hashCodeimpl(this.minWidth) * 31) + Dp.m7261hashCodeimpl(this.minHeight);
    }
}
