...
final class OffsetPxNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo395measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measureScope, placeableMo5957measureBRTryo0.getWidth(), placeableMo5957measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.OffsetPxNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                long jM7392unboximpl = this.this$0.getOffset().invoke(measureScope).m7392unboximpl();
                if (this.this$0.getRtlAware()) {
                    Placeable.PlacementScope.placeRelativeWithLayer$default(placementScope, placeableMo5957measureBRTryo0, IntOffset.m7383getXimpl(jM7392unboximpl), IntOffset.m7384getYimpl(jM7392unboximpl), 0.0f, (Function1) null, 12, (Object) null);
                } else {
                    Placeable.PlacementScope.placeWithLayer$default(placementScope, placeableMo5957measureBRTryo0, IntOffset.m7383getXimpl(jM7392unboximpl), IntOffset.m7384getYimpl(jM7392unboximpl), 0.0f, (Function1) null, 12, (Object) null);
                }
            }
        }, 4, null);
    }
