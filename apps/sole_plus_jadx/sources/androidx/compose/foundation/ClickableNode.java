...
public class ClickableNode extends AbstractClickableNode {
    ...
    @DebugMetadata(c = "androidx.compose.foundation.ClickableNode$clickPointerInput$2", f = "Clickable.kt", i = {}, l = {WinError.ERROR_PNP_RESTART_ENUMERATION}, m = "invokeSuspend", n = {}, s = {})
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> {
        ...
        public /* bridge */ /* synthetic */ Object invoke(PressGestureScope pressGestureScope, Offset offset, Continuation<? super Unit> continuation) {
            return m582invoked4ec7I(pressGestureScope, offset.m4304unboximpl(), continuation);
        }

        /* renamed from: invoke-d-4ec7I, reason: not valid java name */
        public final Object m582invoked4ec7I(PressGestureScope pressGestureScope, long j, Continuation<? super Unit> continuation) {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                if (ClickableNode.this.getEnabled()) {
                    this.label = 1;
                    if (ClickableNode.this.m511handlePressInteractiond4ec7I(pressGestureScope, j, this) == coroutine_suspended) {
    ...
    static /* synthetic */ Object clickPointerInput$suspendImpl(ClickableNode clickableNode, PointerInputScope pointerInputScope, Continuation<? super Unit> continuation) {
        Object objDetectTapAndPress = TapGestureDetectorKt.detectTapAndPress(pointerInputScope, clickableNode.new AnonymousClass2(null), new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.ClickableNode.clickPointerInput.3
            ...
            public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                m583invokek4lQ0M(offset.m4304unboximpl());
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
            public final void m583invokek4lQ0M(long j) {
                if (ClickableNode.this.getEnabled()) {
    ...
    public final void m581updateQzZPfjk(MutableInteractionSource interactionSource, IndicationNodeFactory indicationNodeFactory, boolean enabled, String onClickLabel, Role role, Function0<Unit> onClick) {
