...
@DebugMetadata(c = "androidx.compose.foundation.AbstractClickableNode$handlePressInteraction$2$1", f = "Clickable.kt", i = {0, 1, 2}, l = {1139, WinError.ERROR_SET_POWER_STATE_FAILED, 1148, 1149, WinError.ERROR_NO_MORE_USER_HANDLES}, m = "invokeSuspend", n = {"delayJob", "success", "release"}, s = {"L$0", "Z$0", "L$0"})
