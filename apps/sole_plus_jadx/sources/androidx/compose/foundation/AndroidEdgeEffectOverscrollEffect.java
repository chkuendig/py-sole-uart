...
public final class AndroidEdgeEffectOverscrollEffect implements OverscrollEffect {
    ...
    public AndroidEdgeEffectOverscrollEffect(Context context, OverscrollConfiguration overscrollConfiguration) {
        ...
        EdgeEffectWrapper edgeEffectWrapper = new EdgeEffectWrapper(context, ColorKt.m4592toArgb8_81llA(overscrollConfiguration.getGlowColor()));
        this.edgeEffectWrapper = edgeEffectWrapper;
        this.redrawSignal = SnapshotStateKt.mutableStateOf(Unit.INSTANCE, SnapshotStateKt.neverEqualPolicy());
        this.invalidationEnabled = true;
        this.containerSize = Size.INSTANCE.m4372getZeroNHjbRc();
    ...
    */
    ...
    private final boolean stopOverscrollAnimation() {
        ...
        if (this.edgeEffectWrapper.isLeftStretched()) {
            m517pullLeftk4lQ0M(Offset.INSTANCE.m4310getZeroF1C5BW0());
            z = true;
        } else {
            z = false;
        }
        if (this.edgeEffectWrapper.isRightStretched()) {
            m518pullRightk4lQ0M(Offset.INSTANCE.m4310getZeroF1C5BW0());
            z = true;
        }
        if (this.edgeEffectWrapper.isTopStretched()) {
            m519pullTopk4lQ0M(Offset.INSTANCE.m4310getZeroF1C5BW0());
            z = true;
        }
        if (!this.edgeEffectWrapper.isBottomStretched()) {
            return z;
        }
        m516pullBottomk4lQ0M(Offset.INSTANCE.m4310getZeroF1C5BW0());
        return true;
    }
    ...
    public final void m524updateSizeuvyYCjk$foundation_release(long size) {
        boolean zM4359equalsimpl0 = Size.m4359equalsimpl0(this.containerSize, Size.INSTANCE.m4372getZeroNHjbRc());
        boolean zM4359equalsimpl02 = Size.m4359equalsimpl0(size, this.containerSize);
        this.containerSize = size;
        if (!zM4359equalsimpl02) {
            this.edgeEffectWrapper.m595setSizeozmzZPI(IntSizeKt.IntSize(MathKt.roundToInt(Size.m4363getWidthimpl(size)), MathKt.roundToInt(Size.m4360getHeightimpl(size))));
        }
        if (zM4359equalsimpl0 || zM4359equalsimpl02) {
            return;
        }
    ...
    public final long m523displacementF1C5BW0$foundation_release() {
        ...
        long jM4304unboximpl = offset != null ? offset.m4304unboximpl() : SizeKt.m4373getCenteruvyYCjk(this.containerSize);
        return OffsetKt.Offset(Offset.m4294getXimpl(jM4304unboximpl) / Size.m4363getWidthimpl(this.containerSize), Offset.m4295getYimpl(jM4304unboximpl) / Size.m4360getHeightimpl(this.containerSize));
    }
    ...
    private final boolean m520releaseOppositeOverscrollk4lQ0M(long delta) {
        boolean z;
        boolean z2 = true;
        if (!this.edgeEffectWrapper.isLeftAnimating() || Offset.m4294getXimpl(delta) >= 0.0f) {
            z = false;
        } else {
            EdgeEffectCompat.INSTANCE.onReleaseWithOppositeDelta(this.edgeEffectWrapper.getOrCreateLeftEffect(), Offset.m4294getXimpl(delta));
            z = !this.edgeEffectWrapper.isLeftAnimating();
        }
        if (this.edgeEffectWrapper.isRightAnimating() && Offset.m4294getXimpl(delta) > 0.0f) {
            EdgeEffectCompat.INSTANCE.onReleaseWithOppositeDelta(this.edgeEffectWrapper.getOrCreateRightEffect(), Offset.m4294getXimpl(delta));
            z = z || !this.edgeEffectWrapper.isRightAnimating();
        }
        if (this.edgeEffectWrapper.isTopAnimating() && Offset.m4295getYimpl(delta) < 0.0f) {
            EdgeEffectCompat.INSTANCE.onReleaseWithOppositeDelta(this.edgeEffectWrapper.getOrCreateTopEffect(), Offset.m4295getYimpl(delta));
            z = z || !this.edgeEffectWrapper.isTopAnimating();
        }
        if (!this.edgeEffectWrapper.isBottomAnimating() || Offset.m4295getYimpl(delta) <= 0.0f) {
            return z;
        }
        EdgeEffectCompat.INSTANCE.onReleaseWithOppositeDelta(this.edgeEffectWrapper.getOrCreateBottomEffect(), Offset.m4295getYimpl(delta));
    ...
    private final float m519pullTopk4lQ0M(long scroll) {
        float fM4294getXimpl = Offset.m4294getXimpl(m523displacementF1C5BW0$foundation_release());
        float fM4295getYimpl = Offset.m4295getYimpl(scroll) / Size.m4360getHeightimpl(this.containerSize);
        EdgeEffect orCreateTopEffect = this.edgeEffectWrapper.getOrCreateTopEffect();
        return EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateTopEffect) == 0.0f ? EdgeEffectCompat.INSTANCE.onPullDistanceCompat(orCreateTopEffect, fM4295getYimpl, fM4294getXimpl) * Size.m4360getHeightimpl(this.containerSize) : Offset.m4295getYimpl(scroll);
    }
    ...
    private final float m516pullBottomk4lQ0M(long scroll) {
        ...
        return EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateBottomEffect) == 0.0f ? (-EdgeEffectCompat.INSTANCE.onPullDistanceCompat(orCreateBottomEffect, -fM4295getYimpl, 1 - fM4294getXimpl)) * Size.m4360getHeightimpl(this.containerSize) : Offset.m4295getYimpl(scroll);
    }

    /* renamed from: pullLeft-k-4lQ0M, reason: not valid java name */
    private final float m517pullLeftk4lQ0M(long scroll) {
        float fM4295getYimpl = Offset.m4295getYimpl(m523displacementF1C5BW0$foundation_release());
        float fM4294getXimpl = Offset.m4294getXimpl(scroll) / Size.m4363getWidthimpl(this.containerSize);
        EdgeEffect orCreateLeftEffect = this.edgeEffectWrapper.getOrCreateLeftEffect();
        return EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateLeftEffect) == 0.0f ? EdgeEffectCompat.INSTANCE.onPullDistanceCompat(orCreateLeftEffect, fM4294getXimpl, 1 - fM4295getYimpl) * Size.m4363getWidthimpl(this.containerSize) : Offset.m4294getXimpl(scroll);
    }
    ...
    private final float m518pullRightk4lQ0M(long scroll) {
        ...
        return EdgeEffectCompat.INSTANCE.getDistanceCompat(orCreateRightEffect) == 0.0f ? (-EdgeEffectCompat.INSTANCE.onPullDistanceCompat(orCreateRightEffect, -fM4294getXimpl, fM4295getYimpl)) * Size.m4363getWidthimpl(this.containerSize) : Offset.m4294getXimpl(scroll);
    }
}
