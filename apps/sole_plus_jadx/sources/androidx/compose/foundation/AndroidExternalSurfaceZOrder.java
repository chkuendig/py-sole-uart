...
public final class AndroidExternalSurfaceZOrder {
    ...
    private static final int Behind = m528constructorimpl(0);
    private static final int MediaOverlay = m528constructorimpl(1);
    private static final int OnTop = m528constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ AndroidExternalSurfaceZOrder m527boximpl(int i) {
    ...
    public static boolean m529equalsimpl(int i, Object obj) {
        return (obj instanceof AndroidExternalSurfaceZOrder) && i == ((AndroidExternalSurfaceZOrder) obj).m533unboximpl();
    }
    ...
    public boolean equals(Object obj) {
        return m529equalsimpl(this.zOrder, obj);
    }

    public int hashCode() {
        return m531hashCodeimpl(this.zOrder);
    }

    public String toString() {
        return m532toStringimpl(this.zOrder);
    }
