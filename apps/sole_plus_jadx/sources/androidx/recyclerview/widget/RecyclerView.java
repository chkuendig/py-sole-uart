...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    */
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Removed duplicated region for block: B:47:0x00de A[PHI: r0
    ...
    */
    ...
    private float getSplineFlingDistance(int i) {
        ...
        return (float) (this.mPhysicalCoef * SCROLL_FRICTION * Math.exp((f / (f - 1.0d)) * dLog));
    }
    ...
    class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                int i5 = iConsumeFlingInHorizontalStretch - RecyclerView.this.mReusableIntPair[0];
                int i6 = iConsumeFlingInVerticalStretch - RecyclerView.this.mReusableIntPair[1];
                if (i != 0 || i2 != 0) {
    ...
    public final class Recycler {
        ...
        /* JADX WARN: Removed duplicated region for block: B:117:0x027e A[ADDED_TO_REGION] */
    ...
    public static abstract class ViewHolder {
        ...
        public final void setIsRecyclable(boolean z) {
            ...
            if (i2 < 0) {
                ...
                Log.e(SdkConstants.VIEW, "isRecyclable decremented below 0: unmatched pair of setIsRecyable() calls for " + this);
            } else if (!z && i2 == 1) {
                this.mFlags |= 16;
            } else if (z && i2 == 0) {
                this.mFlags &= -17;
