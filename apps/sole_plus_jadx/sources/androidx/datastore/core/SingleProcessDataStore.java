...
public final class SingleProcessDataStore<T> implements DataStore<T> {
    ...
    static final class C07551 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C07551(SingleProcessDataStore<T> singleProcessDataStore, Continuation<? super C07551> continuation) {
            super(continuation);
            this.this$0 = singleProcessDataStore;
        }
    ...
    static final class C07561 extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
        final /* synthetic */ SingleProcessDataStore<T> this$0;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C07561(SingleProcessDataStore<T> singleProcessDataStore, Continuation<? super C07561> continuation) {
            super(continuation);
            this.this$0 = singleProcessDataStore;
        }
    ...
    static final class C07571 extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
        final /* synthetic */ SingleProcessDataStore<T> this$0;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C07571(SingleProcessDataStore<T> singleProcessDataStore, Continuation<? super C07571> continuation) {
            super(continuation);
            this.this$0 = singleProcessDataStore;
        }
    ...
    static final class C07581 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C07581(SingleProcessDataStore<T> singleProcessDataStore, Continuation<? super C07581> continuation) {
            super(continuation);
            this.this$0 = singleProcessDataStore;
        }
    ...
    static final class C07591 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C07591(SingleProcessDataStore<T> singleProcessDataStore, Continuation<? super C07591> continuation) {
            super(continuation);
            this.this$0 = singleProcessDataStore;
        }
    ...
    static final class C07601 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        Object L$2;
        int label;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C07601(SingleProcessDataStore<T> singleProcessDataStore, Continuation<? super C07601> continuation) {
            super(continuation);
            this.this$0 = singleProcessDataStore;
        }
    ...
    */
    public final java.lang.Object readAndInitOrPropagateAndThrowFailure(kotlin.coroutines.Continuation<? super kotlin.Unit> r5) throws java.lang.Throwable {
        /*
            r4 = this;
            boolean r0 = r5 instanceof androidx.datastore.core.SingleProcessDataStore.C07561
            if (r0 == 0) goto L14
            r0 = r5
            androidx.datastore.core.SingleProcessDataStore$readAndInitOrPropagateAndThrowFailure$1 r0 = (androidx.datastore.core.SingleProcessDataStore.C07561) r0
            int r1 = r0.label
    ...
    */
    public final java.lang.Object readAndInitOrPropagateFailure(kotlin.coroutines.Continuation<? super kotlin.Unit> r5) {
        /*
            r4 = this;
            boolean r0 = r5 instanceof androidx.datastore.core.SingleProcessDataStore.C07571
            if (r0 == 0) goto L14
            r0 = r5
            androidx.datastore.core.SingleProcessDataStore$readAndInitOrPropagateFailure$1 r0 = (androidx.datastore.core.SingleProcessDataStore.C07571) r0
            int r1 = r0.label
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r1 = r1 & r2
            if (r1 == 0) goto L14
    ...
    */
    public final java.lang.Object readDataOrHandleCorruption(kotlin.coroutines.Continuation<? super T> r8) throws androidx.datastore.core.CorruptionException, java.io.FileNotFoundException {
        /*
            r7 = this;
            boolean r0 = r8 instanceof androidx.datastore.core.SingleProcessDataStore.C07591
            if (r0 == 0) goto L14
            r0 = r8
            androidx.datastore.core.SingleProcessDataStore$readDataOrHandleCorruption$1 r0 = (androidx.datastore.core.SingleProcessDataStore.C07591) r0
            int r1 = r0.label
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r1 = r1 & r2
            if (r1 == 0) goto L14
    ...
    */
    public final java.lang.Object readData(kotlin.coroutines.Continuation<? super T> r7) throws java.io.FileNotFoundException {
        /*
            r6 = this;
            boolean r0 = r7 instanceof androidx.datastore.core.SingleProcessDataStore.C07581
            if (r0 == 0) goto L14
            r0 = r7
            androidx.datastore.core.SingleProcessDataStore$readData$1 r0 = (androidx.datastore.core.SingleProcessDataStore.C07581) r0
            int r1 = r0.label
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r1 = r1 & r2
            if (r1 == 0) goto L14
    ...
    */
    public final java.lang.Object transformAndWrite(kotlin.jvm.functions.Function2<? super T, ? super kotlin.coroutines.Continuation<? super T>, ? extends java.lang.Object> r8, kotlin.coroutines.CoroutineContext r9, kotlin.coroutines.Continuation<? super T> r10) throws java.lang.Throwable {
        /*
            r7 = this;
            boolean r0 = r10 instanceof androidx.datastore.core.SingleProcessDataStore.C07601
            if (r0 == 0) goto L14
            r0 = r10
            androidx.datastore.core.SingleProcessDataStore$transformAndWrite$1 r0 = (androidx.datastore.core.SingleProcessDataStore.C07601) r0
            int r1 = r0.label
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r1 = r1 & r2
            if (r1 == 0) goto L14
