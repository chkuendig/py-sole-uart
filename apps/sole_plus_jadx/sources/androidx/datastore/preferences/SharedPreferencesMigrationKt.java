...
public final class SharedPreferencesMigrationKt {
    ...
    static final class C07621 extends SuspendLambda implements Function2<Preferences, Continuation<? super Boolean>, Object> {
        final /* synthetic */ Set<String> $keysToMigrate;
        /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C07621(Set<String> set, Continuation<? super C07621> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C07621 c07621 = new C07621(this.$keysToMigrate, continuation);
            c07621.L$0 = obj;
            return c07621;
        }
        ...
        public final Object invoke(Preferences preferences, Continuation<? super Boolean> continuation) {
            return ((C07621) create(preferences, continuation)).invokeSuspend(Unit.INSTANCE);
        }
