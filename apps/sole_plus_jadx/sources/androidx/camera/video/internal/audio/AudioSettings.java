...
public abstract class AudioSettings {
    public static final List<Integer> COMMON_SAMPLE_RATES = Collections.unmodifiableList(Arrays.asList(48000, 44100, 22050, Integer.valueOf(WinError.WSA_QOS_EPOLICYOBJ), 8000, Integer.valueOf(WinBase.CBR_4800)));
