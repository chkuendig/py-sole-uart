...
final class AutoValue_AudioSettings extends AudioSettings {
    ...
    public String toString() {
        return "AudioSettings{audioSource=" + this.audioSource + ", sampleRate=" + this.sampleRate + ", channelCount=" + this.channelCount + ", audioFormat=" + this.audioFormat + SdkConstants.MANIFEST_PLACEHOLDER_SUFFIX;
    }
