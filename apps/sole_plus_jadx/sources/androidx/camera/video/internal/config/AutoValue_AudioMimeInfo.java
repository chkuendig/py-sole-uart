...
final class AutoValue_AudioMimeInfo extends AudioMimeInfo {
    ...
    public String toString() {
        return "AudioMimeInfo{mimeType=" + this.mimeType + ", profile=" + this.profile + ", compatibleAudioProfile=" + this.compatibleAudioProfile + SdkConstants.MANIFEST_PLACEHOLDER_SUFFIX;
    }
