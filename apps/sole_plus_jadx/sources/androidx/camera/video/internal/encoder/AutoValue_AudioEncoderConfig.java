...
final class AutoValue_AudioEncoderConfig extends AudioEncoderConfig {
    ...
    public String toString() {
        return "AudioEncoderConfig{mimeType=" + this.mimeType + ", profile=" + this.profile + ", inputTimebase=" + this.inputTimebase + ", bitrate=" + this.bitrate + ", sampleRate=" + this.sampleRate + ", channelCount=" + this.channelCount + SdkConstants.MANIFEST_PLACEHOLDER_SUFFIX;
    }
