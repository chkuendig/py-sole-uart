...
public class Quality {
    ...
    static {
        ConstantQuality constantQualityOf = ConstantQuality.of(4, "SD", Collections.unmodifiableList(Arrays.asList(new Size(WinError.ERROR_IMAGE_MACHINE_TYPE_MISMATCH_EXE, 480), new Size(WinError.ERROR_MULTIPLE_FAULT_VIOLATION, 480))));
        SD = constantQualityOf;
        ConstantQuality constantQualityOf2 = ConstantQuality.of(5, "HD", Collections.singletonList(new Size(1280, WinError.ERROR_IMAGE_MACHINE_TYPE_MISMATCH_EXE)));
        HD = constantQualityOf2;
        ConstantQuality constantQualityOf3 = ConstantQuality.of(6, "FHD", Collections.singletonList(new Size(WinError.ERROR_CANT_ACCESS_FILE, WinError.ERROR_CANNOT_DETECT_DRIVER_FAILURE)));
        FHD = constantQualityOf3;
        ConstantQuality constantQualityOf4 = ConstantQuality.of(8, "UHD", Collections.singletonList(new Size(WinBase.LMEM_DISCARDABLE, LMErr.NERR_ProcNoRespond)));
