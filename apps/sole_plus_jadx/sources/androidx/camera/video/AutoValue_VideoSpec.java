...
final class AutoValue_VideoSpec extends VideoSpec {
    ...
    public String toString() {
        return "VideoSpec{qualitySelector=" + this.qualitySelector + ", frameRate=" + this.frameRate + ", bitrate=" + this.bitrate + ", aspectRatio=" + this.aspectRatio + SdkConstants.MANIFEST_PLACEHOLDER_SUFFIX;
    }
