...
final class AutoValue_Recorder_RecordingRecord extends Recorder.RecordingRecord {
    ...
    public String toString() {
        return "RecordingRecord{getOutputOptions=" + this.getOutputOptions + ", getCallbackExecutor=" + this.getCallbackExecutor + ", getEventListener=" + this.getEventListener + ", hasAudioEnabled=" + this.hasAudioEnabled + ", isPersistent=" + this.isPersistent + ", getRecordingId=" + this.getRecordingId + SdkConstants.MANIFEST_PLACEHOLDER_SUFFIX;
    }
    ...
    public int hashCode() {
        ...
        boolean z = this.hasAudioEnabled;
        int i = WinError.ERROR_NETWORK_UNREACHABLE;
        int i2 = (iHashCode3 ^ (z ? 1231 : 1237)) * 1000003;
