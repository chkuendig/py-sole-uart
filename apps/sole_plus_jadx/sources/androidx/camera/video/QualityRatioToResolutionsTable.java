...
class QualityRatioToResolutionsTable {
    ...
    static {
        ...
        map.put(Quality.UHD, Range.create(Integer.valueOf(LMErr.NERR_ProcNoRespond), Integer.valueOf(WinError.ERROR_DEVICE_NOT_AVAILABLE)));
        map.put(Quality.FHD, Range.create(Integer.valueOf(WinError.ERROR_CANNOT_DETECT_DRIVER_FAILURE), Integer.valueOf(WinError.ERROR_INVALID_SPI_VALUE)));
        map.put(Quality.HD, Range.create(Integer.valueOf(WinError.ERROR_IMAGE_MACHINE_TYPE_MISMATCH_EXE), Integer.valueOf(WinError.ERROR_DIFFERENT_SERVICE_ACCOUNT)));
