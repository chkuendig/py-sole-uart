...
public final class VideoCapture<T extends VideoOutput> extends UseCase {
    ...
    private SessionConfig.Builder createPipeline(final VideoCaptureConfig<T> videoCaptureConfig, StreamSpec streamSpec) {
        ...
        Rect rectCalculateCropRect = calculateCropRect(resolution, videoEncoderInfoResolveVideoEncoderInfo);
        ...
        Rect rectAdjustCropRectByQuirk = adjustCropRectByQuirk(rect, this.mRotationDegrees, isCreateNodeNeeded(cameraInternal, videoCaptureConfig, rect, resolution), videoEncoderInfoResolveVideoEncoderInfo);
        this.mCropRect = rectAdjustCropRectByQuirk;
        SurfaceProcessorNode surfaceProcessorNodeCreateNodeIfNeeded = createNodeIfNeeded(cameraInternal, videoCaptureConfig, rectAdjustCropRectByQuirk, resolution, dynamicRange);
        ...
        if (this.mNode != null) {
            ...
            surfaceEdge2.addOnInvalidatedListener(new Runnable() { // from class: androidx.camera.video.VideoCapture$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m241lambda$createPipeline$1$androidxcameravideoVideoCapture(surfaceEdge2, cameraInternal, videoCaptureConfig, timebaseResolveTimebase);
                }
            });
            ...
            deferrableSurface.getTerminationFuture().addListener(new Runnable() { // from class: androidx.camera.video.VideoCapture$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m242lambda$createPipeline$2$androidxcameravideoVideoCapture(deferrableSurface);
                }
        ...
        videoCaptureConfig.getVideoOutput().onSurfaceRequested(this.mSurfaceRequest, timebaseResolveTimebase);
        sendTransformationInfoIfReady();
        ...
        SessionConfig.CloseableErrorListener closeableErrorListener2 = new SessionConfig.CloseableErrorListener(new SessionConfig.ErrorListener() { // from class: androidx.camera.video.VideoCapture$$ExternalSyntheticLambda5
            ...
            public final void onError(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
                this.f$0.m243lambda$createPipeline$3$androidxcameravideoVideoCapture(sessionConfig, sessionError);
            }
        });
    ...
    /* synthetic */ void m242lambda$createPipeline$2$androidxcameravideoVideoCapture(DeferrableSurface deferrableSurface) {
    ...
    /* synthetic */ void m243lambda$createPipeline$3$androidxcameravideoVideoCapture(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
        resetPipeline();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: onAppEdgeInvalidated, reason: merged with bridge method [inline-methods] */
    public void m241lambda$createPipeline$1$androidxcameravideoVideoCapture(SurfaceEdge surfaceEdge, CameraInternal cameraInternal, VideoCaptureConfig<T> videoCaptureConfig, Timebase timebase) {
    ...
    private static Rect adjustCropRectToValidSize(final Rect rect, Size size, VideoEncoderInfo videoEncoderInfo) {
        ...
        Collections.sort(arrayList, new Comparator() { // from class: androidx.camera.video.VideoCapture$$ExternalSyntheticLambda7
    ...
    private void setupSurfaceUpdateNotifier(final SessionConfig.Builder builder, final boolean z) {
        ...
        final ListenableFuture<Void> future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.video.VideoCapture$$ExternalSyntheticLambda1
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.m244xc7537f7(builder, completer);
            }
        });
    ...
    /* synthetic */ Object m244xc7537f7(final SessionConfig.Builder builder, CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    class AnonymousClass2 extends CameraCaptureCallback {
        ...
        public void onCaptureCompleted(int i, CameraCaptureResult cameraCaptureResult) {
            ...
            scheduledExecutorServiceMainThreadExecutor.execute(new Runnable() { // from class: androidx.camera.video.VideoCapture$2$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m245lambda$onCaptureCompleted$0$androidxcameravideoVideoCapture$2(builder);
                }
            });
        }

        /* renamed from: lambda$onCaptureCompleted$0$androidx-camera-video-VideoCapture$2, reason: not valid java name */
        /* synthetic */ void m245lambda$onCaptureCompleted$0$androidxcameravideoVideoCapture$2(SessionConfig.Builder builder) {
    ...
    private static List<Size> filterOutEncoderUnsupportedResolutions(VideoCaptureConfig<?> videoCaptureConfig, MediaSpec mediaSpec, DynamicRange dynamicRange, VideoCapabilities videoCapabilities, List<Size> list, Map<Quality, Size> map) {
        ...
        while (it.hasNext()) {
            Size next = it.next();
            if (!map.containsValue(next) && (videoValidatedEncoderProfilesProxyFindNearestHigherSupportedEncoderProfilesFor = videoCapabilities.findNearestHigherSupportedEncoderProfilesFor(next, dynamicRange)) != null && (videoEncoderInfoFindLargestSupportedSizeVideoEncoderInfo = findLargestSupportedSizeVideoEncoderInfo(videoCaptureConfig.getVideoEncoderInfoFinder(), videoValidatedEncoderProfilesProxyFindNearestHigherSupportedEncoderProfilesFor, dynamicRange, mediaSpec, next, (Range) Objects.requireNonNull(videoCaptureConfig.getTargetFrameRate(Defaults.DEFAULT_FPS_RANGE)))) != null && !videoEncoderInfoFindLargestSupportedSizeVideoEncoderInfo.isSizeSupportedAllowSwapping(next.getWidth(), next.getHeight())) {
                it.remove();
            }
        }
        return list;
    ...
    public static final class Builder<T extends VideoOutput> implements UseCaseConfig.Builder<VideoCapture<T>, VideoCaptureConfig<T>, Builder<T>>, ImageOutputConfig.Builder<Builder<T>>, ImageInputConfig.Builder<Builder<T>>, ThreadConfig.Builder<Builder<T>> {
        ...
        public Builder<T> setTargetClass(Class<VideoCapture<T>> cls) {
            ...
            if (getMutableConfig().retrieveOption(TargetConfig.OPTION_TARGET_NAME, null) == null) {
                setTargetName(cls.getCanonicalName() + SdkConstants.RES_QUALIFIER_SEP + UUID.randomUUID());
            }
            return this;
        }
