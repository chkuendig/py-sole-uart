...
public class DisplayInfoManager {
    ...
    private static final Size MAX_PREVIEW_SIZE = new Size(WinError.ERROR_CANT_ACCESS_FILE, WinError.ERROR_CANNOT_DETECT_DRIVER_FAILURE);
    private static final Size ABNORMAL_DISPLAY_SIZE_THRESHOLD = new Size(320, 240);
    private static final Size FALLBACK_DISPLAY_SIZE = new Size(WinError.ERROR_MULTIPLE_FAULT_VIOLATION, 480);
