...
public class ExcludedSupportedSizesQuirk implements Quirk {
    ...
    private List<Size> getHuaweiP20LiteExcludedSizes(String str, int i, Class<?> cls) {
        ...
        if (str.equals("0") && (i == 34 || i == 35 || cls != null)) {
            arrayList.add(new Size(WinError.ERROR_IMAGE_MACHINE_TYPE_MISMATCH_EXE, WinError.ERROR_IMAGE_MACHINE_TYPE_MISMATCH_EXE));
    ...
    private List<Size> getSamsungJ7PrimeApi27AboveExcludedSizes(String str, int i, Class<?> cls) {
        ...
        if (str.equals("0")) {
            if (i == 34 || cls != null) {
                ...
                arrayList.add(new Size(2048, CoreFoundation.kCFStringEncodingASCII));
                arrayList.add(new Size(2048, WinError.ERROR_SINGLE_INSTANCE_APP));
                arrayList.add(new Size(WinError.ERROR_CANT_ACCESS_FILE, WinError.ERROR_CANNOT_DETECT_DRIVER_FAILURE));
            } else if (i == 35) {
                arrayList.add(new Size(4128, 2322));
                arrayList.add(new Size(3088, 3088));
                arrayList.add(new Size(3264, 2448));
            ...
            arrayList.add(new Size(WinError.ERROR_CANT_ACCESS_FILE, WinError.ERROR_CANT_ACCESS_FILE));
            arrayList.add(new Size(2048, CoreFoundation.kCFStringEncodingASCII));
            arrayList.add(new Size(2048, WinError.ERROR_SINGLE_INSTANCE_APP));
            arrayList.add(new Size(WinError.ERROR_CANT_ACCESS_FILE, WinError.ERROR_CANNOT_DETECT_DRIVER_FAILURE));
        }
    ...
    private List<Size> getSamsungJ7Api27AboveExcludedSizes(String str, int i, Class<?> cls) {
        ...
        if (str.equals("0")) {
            ...
            arrayList.add(new Size(2576, WinError.ERROR_PER_USER_TRUST_QUOTA_EXCEEDED));
            arrayList.add(new Size(2560, WinError.ERROR_SCREEN_ALREADY_LOCKED));
            arrayList.add(new Size(WinError.ERROR_CANT_ACCESS_FILE, WinError.ERROR_CANT_ACCESS_FILE));
            arrayList.add(new Size(2048, CoreFoundation.kCFStringEncodingASCII));
            arrayList.add(new Size(2048, WinError.ERROR_SINGLE_INSTANCE_APP));
            arrayList.add(new Size(WinError.ERROR_CANT_ACCESS_FILE, WinError.ERROR_CANNOT_DETECT_DRIVER_FAILURE));
