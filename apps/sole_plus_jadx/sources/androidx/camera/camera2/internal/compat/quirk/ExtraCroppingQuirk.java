...
public class ExtraCroppingQuirk implements Quirk {
    ...
    public Size getVerifiedResolution(SurfaceConfig.ConfigType configType) {
        ...
        if (i == 1) {
            return new Size(WinError.ERROR_CANT_ACCESS_FILE, WinError.ERROR_CANNOT_DETECT_DRIVER_FAILURE);
        }
        if (i == 2) {
            return new Size(1280, WinError.ERROR_IMAGE_MACHINE_TYPE_MISMATCH_EXE);
        }
        if (i != 3) {
            return null;
        }
