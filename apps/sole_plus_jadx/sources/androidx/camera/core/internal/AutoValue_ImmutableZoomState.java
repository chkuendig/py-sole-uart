...
final class AutoValue_ImmutableZoomState extends ImmutableZoomState {
    ...
    public String toString() {
        return "ImmutableZoomState{zoomRatio=" + this.zoomRatio + ", maxZoomRatio=" + this.maxZoomRatio + ", minZoomRatio=" + this.minZoomRatio + ", linearZoom=" + this.linearZoom + SdkConstants.MANIFEST_PLACEHOLDER_SUFFIX;
    }
