...
public final class DynamicRange {
    ...
    public String toString() {
        return "DynamicRange@" + Integer.toHexString(System.identityHashCode(this)) + "{encoding=" + getEncodingLabel(this.mEncoding) + ", bitDepth=" + this.mBitDepth + SdkConstants.MANIFEST_PLACEHOLDER_SUFFIX;
    }
