...
final class AutoValue_StreamSpec extends StreamSpec {
    ...
    public String toString() {
        return "StreamSpec{resolution=" + this.resolution + ", dynamicRange=" + this.dynamicRange + ", expectedFrameRateRange=" + this.expectedFrameRateRange + ", implementationOptions=" + this.implementationOptions + ", zslDisabled=" + this.zslDisabled + SdkConstants.MANIFEST_PLACEHOLDER_SUFFIX;
    }
    ...
    public int hashCode() {
        ...
        return ((iHashCode ^ (config == null ? 0 : config.hashCode())) * 1000003) ^ (this.zslDisabled ? WinError.ERROR_NETWORK_UNREACHABLE : WinError.ERROR_RETRY);
    }
