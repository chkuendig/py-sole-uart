...
public class QuirkSettingsLoader implements Function<Context, QuirkSettings> {
    ...
    public QuirkSettings apply(Context context) {
        try {
            Bundle bundle = context.getPackageManager().getServiceInfo(new ComponentName(context, (Class<?>) MetadataHolderService.class), WinError.ERROR_MULTIPLE_FAULT_VIOLATION).metaData;
            if (bundle == null) {
