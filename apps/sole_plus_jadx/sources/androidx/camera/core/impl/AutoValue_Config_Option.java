...
final class AutoValue_Config_Option<T> extends Config.Option<T> {
    ...
    public String toString() {
        return "Option{id=" + this.f87id + ", valueClass=" + this.valueClass + ", token=" + this.token + SdkConstants.MANIFEST_PLACEHOLDER_SUFFIX;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f87id.equals(option.getId()) && this.valueClass.equals(option.getValueClass())) {
    ...
    public int hashCode() {
        int iHashCode = (((this.f87id.hashCode() ^ 1000003) * 1000003) ^ this.valueClass.hashCode()) * 1000003;
