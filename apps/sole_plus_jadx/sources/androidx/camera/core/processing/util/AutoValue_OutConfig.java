...
final class AutoValue_OutConfig extends OutConfig {
    ...
    public String toString() {
        return "OutConfig{getUuid=" + this.getUuid + ", getTargets=" + this.getTargets + ", getFormat=" + this.getFormat + ", getCropRect=" + this.getCropRect + ", getSize=" + this.getSize + ", getRotationDegrees=" + this.getRotationDegrees + ", isMirroring=" + this.isMirroring + ", shouldRespectInputCropRect=" + this.shouldRespectInputCropRect + SdkConstants.MANIFEST_PLACEHOLDER_SUFFIX;
    }
    ...
    public int hashCode() {
        int iHashCode = (((((((((((this.getUuid.hashCode() ^ 1000003) * 1000003) ^ this.getTargets) * 1000003) ^ this.getFormat) * 1000003) ^ this.getCropRect.hashCode()) * 1000003) ^ this.getSize.hashCode()) * 1000003) ^ this.getRotationDegrees) * 1000003;
        boolean z = this.isMirroring;
        int i = WinError.ERROR_NETWORK_UNREACHABLE;
        int i2 = (iHashCode ^ (z ? 1231 : 1237)) * 1000003;
