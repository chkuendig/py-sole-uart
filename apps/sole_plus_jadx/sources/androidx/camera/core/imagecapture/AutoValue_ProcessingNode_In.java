...
final class AutoValue_ProcessingNode_In extends ProcessingNode.In {
    ...
    public String toString() {
        return "In{edge=" + this.edge + ", postviewEdge=" + this.postviewEdge + ", inputFormat=" + this.inputFormat + ", outputFormat=" + this.outputFormat + SdkConstants.MANIFEST_PLACEHOLDER_SUFFIX;
    }
