...
class CaptureNode implements Node<In, ProcessingNode.In> {
    ...
    public ProcessingNode.In transform(In in) {
        ...
        if (!zIsVirtualCamera && in.getImageReaderProxyProvider() == null) {
            ...
            consumer = new Consumer() { // from class: androidx.camera.core.imagecapture.CaptureNode$$ExternalSyntheticLambda1
                @Override // androidx.core.util.Consumer
                public final void accept(Object obj) {
                    this.f$0.m155lambda$transform$0$androidxcameracoreimagecaptureCaptureNode((ProcessingRequest) obj);
                }
            };
        ...
        noMetadataImageReader.setOnImageAvailableListener(new ImageReaderProxy.OnImageAvailableListener() { // from class: androidx.camera.core.imagecapture.CaptureNode$$ExternalSyntheticLambda2
            ...
            public final void onImageAvailable(ImageReaderProxy imageReaderProxy) {
                this.f$0.m156lambda$transform$1$androidxcameracoreimagecaptureCaptureNode(imageReaderProxy);
            }
        ...
        if (in.getPostviewSize() != null) {
            ...
            imageReaderProxyCreateImageReaderProxy.setOnImageAvailableListener(new ImageReaderProxy.OnImageAvailableListener() { // from class: androidx.camera.core.imagecapture.CaptureNode$$ExternalSyntheticLambda3
                @Override // androidx.camera.core.impl.ImageReaderProxy.OnImageAvailableListener
                public final void onImageAvailable(ImageReaderProxy imageReaderProxy) {
                    this.f$0.m157lambda$transform$2$androidxcameracoreimagecaptureCaptureNode(imageReaderProxy);
                }
            }, CameraXExecutors.mainThreadExecutor());
    ...
    class AnonymousClass1 extends CameraCaptureCallback {
        ...
        /* synthetic */ void m158xa945b317(int i) {
            if (CaptureNode.this.mCurrentRequest != null) {
    ...
    /* synthetic */ void m155lambda$transform$0$androidxcameracoreimagecaptureCaptureNode(ProcessingRequest processingRequest) {
    ...
    /* synthetic */ void m156lambda$transform$1$androidxcameracoreimagecaptureCaptureNode(ImageReaderProxy imageReaderProxy) {
        try {
    ...
    /* synthetic */ void m157lambda$transform$2$androidxcameracoreimagecaptureCaptureNode(ImageReaderProxy imageReaderProxy) {
        try {
            ImageProxy imageProxyAcquireLatestImage = imageReaderProxy.acquireLatestImage();
            if (imageProxyAcquireLatestImage != null) {
