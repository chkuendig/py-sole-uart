...
final class AutoValue_SurfaceRequest_TransformationInfo extends SurfaceRequest.TransformationInfo {
    ...
    public String toString() {
        return "TransformationInfo{getCropRect=" + this.getCropRect + ", getRotationDegrees=" + this.getRotationDegrees + ", getTargetRotation=" + this.getTargetRotation + ", hasCameraTransform=" + this.hasCameraTransform + ", getSensorToBufferTransform=" + this.getSensorToBufferTransform + ", isMirroring=" + this.isMirroring + SdkConstants.MANIFEST_PLACEHOLDER_SUFFIX;
    }
    ...
    public int hashCode() {
        int iHashCode = (((((this.getCropRect.hashCode() ^ 1000003) * 1000003) ^ this.getRotationDegrees) * 1000003) ^ this.getTargetRotation) * 1000003;
        boolean z = this.hasCameraTransform;
        int i = WinError.ERROR_NETWORK_UNREACHABLE;
        int iHashCode2 = (((iHashCode ^ (z ? 1231 : 1237)) * 1000003) ^ this.getSensorToBufferTransform.hashCode()) * 1000003;
        if (!this.isMirroring) {
            i = 1237;
        }
        return iHashCode2 ^ i;
