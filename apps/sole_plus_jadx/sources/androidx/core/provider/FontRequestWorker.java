...
class FontRequestWorker {
    ...
    static Typeface requestFontSync(final Context context, final FontRequest fontRequest, CallbackWrapper callbackWrapper, final int i, int i2) {
        final String strCreateCacheId = createCacheId(Preview$$ExternalSyntheticBackport0.m(new Object[]{fontRequest}), i);
        ...
        if (i2 == -1) {
            TypefaceResult fontSync = getFontSync(strCreateCacheId, context, Preview$$ExternalSyntheticBackport0.m(new Object[]{fontRequest}), i);
        ...
        try {
            TypefaceResult typefaceResult = (TypefaceResult) RequestExecutor.submit(DEFAULT_EXECUTOR_SERVICE, new Callable<TypefaceResult>() { // from class: androidx.core.provider.FontRequestWorker.1
                ...
                public TypefaceResult call() {
                    return FontRequestWorker.getFontSync(strCreateCacheId, context, Preview$$ExternalSyntheticBackport0.m(new Object[]{fontRequest}), i);
                }
            }, i2);
    ...
    private static String createCacheId(List<FontRequest> list, int i) {
        ...
        for (int i2 = 0; i2 < list.size(); i2++) {
            sb.append(list.get(i2).getId()).append(SdkConstants.RES_QUALIFIER_SEP).append(i);
            if (i2 < list.size() - 1) {
                sb.append(";");
            }
        }
