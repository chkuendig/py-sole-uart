...
public class TypefaceCompatUtil {
    ...
    public static File getTempFile(Context context) {
        ...
        String str = CACHE_FILE_PREFIX + Process.myPid() + SdkConstants.RES_QUALIFIER_SEP + Process.myTid() + SdkConstants.RES_QUALIFIER_SEP;
        for (int i = 0; i < 100; i++) {
    ...
    public static ByteBuffer mmap(Context context, CancellationSignal cancellationSignal, Uri uri) throws IOException {
        try {
            ParcelFileDescriptor parcelFileDescriptorOpenFileDescriptor = context.getContentResolver().openFileDescriptor(uri, SdkConstants.FD_RES_CLASS, cancellationSignal);
