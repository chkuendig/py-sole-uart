...
public final class StringArrayNavType extends CollectionNavType<String[]> {
    ...
    public void put(Bundle bundle, String key, String[] value) {
        ...
        if (value != null) {
            SavedStateWriter.m7926putStringArrayimpl(bundleM7892constructorimpl, key, value);
        } else {
    ...
    public String[] get(Bundle bundle, String key) {
        ...
        return SavedStateReader.m7878getStringArrayimpl(bundleM7806constructorimpl, key);
    }
