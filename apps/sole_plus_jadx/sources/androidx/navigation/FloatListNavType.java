...
public final class FloatListNavType extends CollectionNavType<List<? extends Float>> {
    ...
    public void put(Bundle bundle, String key, List<Float> value) {
        ...
        if (value != null) {
            SavedStateWriter.m7908putFloatArrayimpl(bundleM7892constructorimpl, key, CollectionsKt.toFloatArray(value));
        } else {
    ...
    public List<Float> get(Bundle bundle, String key) {
        ...
        return ArraysKt.toList(SavedStateReader.m7834getFloatArrayimpl(bundleM7806constructorimpl, key));
    }
}
