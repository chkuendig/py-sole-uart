...
public final class BoolListNavType extends CollectionNavType<List<? extends Boolean>> {
    ...
    public void put(Bundle bundle, String key, List<Boolean> value) {
        ...
        if (value != null) {
            SavedStateWriter.m7899putBooleanArrayimpl(bundleM7892constructorimpl, key, CollectionsKt.toBooleanArray(value));
        } else {
    ...
    public List<Boolean> get(Bundle bundle, String key) {
        ...
        return ArraysKt.toList(SavedStateReader.m7816getBooleanArrayimpl(bundleM7806constructorimpl, key));
    }
}
