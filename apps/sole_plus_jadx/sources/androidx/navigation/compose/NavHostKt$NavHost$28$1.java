...
@DebugMetadata(c = "androidx.navigation.compose.NavHostKt$NavHost$28$1", f = "NavHost.kt", i = {}, l = {WinError.ERROR_PNP_RESTART_ENUMERATION}, m = "invokeSuspend", n = {}, s = {})
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (NavHostKt.NavHost$lambda$38(this.$currentBackStack$delegate).size() > 1) {
                ...
                this.label = 1;
                if (this.$transitionState.seekTo(NavHostKt.NavHost$lambda$40(this.$progress$delegate), navBackStackEntry, this) == coroutine_suspended) {
