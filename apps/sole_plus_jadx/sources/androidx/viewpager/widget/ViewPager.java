...
public class ViewPager extends ViewGroup {
    ...
    */
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            return "FragmentPager.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " position=" + this.position + SdkConstants.MANIFEST_PLACEHOLDER_SUFFIX;
        }
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public boolean arrowScroll(int r6) throws android.content.res.Resources.NotFoundException {
        /*
            r5 = this;
