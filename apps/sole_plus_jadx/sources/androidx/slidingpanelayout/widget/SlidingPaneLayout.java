...
public class SlidingPaneLayout extends ViewGroup implements Openable {
    ...
    /* JADX WARN: Removed duplicated region for block: B:23:0x0089 A[PHI: r15
      0x0089: PHI (r15v5 float) = (r15v1 float), (r15v6 float) binds: [B:19:0x007e, B:21:0x0085] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        while (i12 < childCount) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.slideable) {
                    ...
                    int iMin = (Math.min(paddingRight, i13) - i11) - (layoutParams.leftMargin + layoutParams.rightMargin);
