...
public class ChangeScroll extends Transition {
    ...
    public Animator createAnimator(ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        if (iIntValue != iIntValue2) {
            ...
            objectAnimatorOfInt = ObjectAnimator.ofInt(view, SdkConstants.ATTR_SCROLLX, iIntValue, iIntValue2);
        } else {
            objectAnimatorOfInt = null;
        }
        if (iIntValue3 != iIntValue4) {
            view.setScrollY(iIntValue3);
            objectAnimatorOfInt2 = ObjectAnimator.ofInt(view, SdkConstants.ATTR_SCROLLY, iIntValue3, iIntValue4);
        }
