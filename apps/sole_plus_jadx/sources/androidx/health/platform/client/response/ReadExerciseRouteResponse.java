...
/* compiled from: ReadExerciseRouteResponse.kt */
...
public final class ReadExerciseRouteResponse extends ProtoParcelable<ResponseProto.ReadExerciseRouteResponse> {
    public static final Parcelable.Creator<ReadExerciseRouteResponse> CREATOR;
    ...
    public ReadExerciseRouteResponse(ResponseProto.ReadExerciseRouteResponse proto) {
    ...
    static {
        ...
        CREATOR = new Parcelable.Creator<ReadExerciseRouteResponse>() { // from class: androidx.health.platform.client.response.ReadExerciseRouteResponse$special$$inlined$newCreator$connect_client_release$1
            ...
            public ReadExerciseRouteResponse createFromParcel(Parcel source) throws InvalidProtocolBufferException {
                ...
                if (i != 0) {
                    if (i == 1) {
                        return (ProtoParcelable) SharedMemory27Impl.INSTANCE.parseParcelUsingSharedMemory(source, new Function1<byte[], ReadExerciseRouteResponse>() { // from class: androidx.health.platform.client.response.ReadExerciseRouteResponse$special$$inlined$newCreator$connect_client_release$1.1
                            ...
                            public final ReadExerciseRouteResponse invoke(byte[] it) throws InvalidProtocolBufferException {
