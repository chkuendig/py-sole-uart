...
@Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0007\u0018\u0000 \u00072\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0001\u0007B\r\u0012\u0006\u0010\u0003\u001a\u00020\u0002¢\u0006\u0002\u0010\u0004R\u0014\u0010\u0003\u001a\u00020\u0002X\u0096\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006¨\u0006\b"}, d2 = {"Landroidx/health/platform/client/response/ReadDataResponse;", "Landroidx/health/platform/client/impl/data/ProtoParcelable;", "Landroidx/health/platform/client/proto/ResponseProto$ReadDataResponse;", "proto", "(Landroidx/health/platform/client/proto/ResponseProto$ReadDataResponse;)V", "getProto", "()Landroidx/health/platform/client/proto/ResponseProto$ReadDataResponse;", "Companion", "connect-client_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
...
public final class ReadDataResponse extends ProtoParcelable<ResponseProto.ReadDataResponse> {
    ...
    static {
        ...
        CREATOR = new Parcelable.Creator<ReadDataResponse>() { // from class: androidx.health.platform.client.response.ReadDataResponse$special$$inlined$newCreator$connect_client_release$1
            ...
            /* JADX WARN: Type inference failed for: r4v6, types: [androidx.health.platform.client.impl.data.ProtoParcelable, androidx.health.platform.client.response.ReadDataResponse] */
            @Override // android.os.Parcelable.Creator
            public ReadDataResponse createFromParcel(Parcel source) throws InvalidProtocolBufferException {
                ...
                if (i != 0) {
                    if (i == 1) {
                        return (ProtoParcelable) SharedMemory27Impl.INSTANCE.parseParcelUsingSharedMemory(source, new Function1<byte[], ReadDataResponse>() { // from class: androidx.health.platform.client.response.ReadDataResponse$special$$inlined$newCreator$connect_client_release$1.1
                            ...
                            public final ReadDataResponse invoke(byte[] it) throws InvalidProtocolBufferException {
                                Intrinsics.checkNotNullParameter(it, "it");
                                ResponseProto.ReadDataResponse proto = ResponseProto.ReadDataResponse.parseFrom(it);
                ...
                ResponseProto.ReadDataResponse proto = ResponseProto.ReadDataResponse.parseFrom(bArrCreateByteArray);
                Intrinsics.checkNotNullExpressionValue(proto, "proto");
                return new ReadDataResponse(proto);
            }
