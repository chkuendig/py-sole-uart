...
public final class ReadDataRangeResponse extends ProtoParcelable<ResponseProto.ReadDataRangeResponse> {
    public static final Parcelable.Creator<ReadDataRangeResponse> CREATOR;
    ...
    static {
        ...
        CREATOR = new Parcelable.Creator<ReadDataRangeResponse>() { // from class: androidx.health.platform.client.response.ReadDataRangeResponse$special$$inlined$newCreator$connect_client_release$1
            ...
            public ReadDataRangeResponse createFromParcel(Parcel source) throws InvalidProtocolBufferException {
                ...
                if (i != 0) {
                    if (i == 1) {
                        return (ProtoParcelable) SharedMemory27Impl.INSTANCE.parseParcelUsingSharedMemory(source, new Function1<byte[], ReadDataRangeResponse>() { // from class: androidx.health.platform.client.response.ReadDataRangeResponse$special$$inlined$newCreator$connect_client_release$1.1
                            ...
                            public final ReadDataRangeResponse invoke(byte[] it) throws InvalidProtocolBufferException {
