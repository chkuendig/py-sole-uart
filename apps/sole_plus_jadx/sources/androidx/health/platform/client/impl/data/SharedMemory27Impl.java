...
public final class SharedMemory27Impl {
    ...
    public final void writeToParcelUsingSharedMemory(String name, byte[] bytes, Parcel dest, int flags) {
        ...
        try {
            SharedMemory sharedMemory = sharedMemoryCreate;
