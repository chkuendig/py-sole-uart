...
public abstract class ByteString implements Iterable<Byte>, Serializable {
    ...
    static {
        ...
        UNSIGNED_LEXICOGRAPHICAL_COMPARATOR = new Comparator<ByteString>() { // from class: androidx.health.platform.client.proto.ByteString.2
            /* JADX WARN: Type inference failed for: r0v0, types: [androidx.health.platform.client.proto.ByteString$ByteIterator] */
            /* JADX WARN: Type inference failed for: r1v0, types: [androidx.health.platform.client.proto.ByteString$ByteIterator] */
    ...
    private static final class SystemByteArrayCopier implements ByteArrayCopier {
        ...
        @Override // androidx.health.platform.client.proto.ByteString.ByteArrayCopier
    ...
    public Iterator<Byte> iterator2() {
        return new AbstractByteIterator() { // from class: androidx.health.platform.client.proto.ByteString.1
