...
final class TextFormatEscaper {
    ...
    static String escapeBytes(final ByteString input) {
        return escapeBytes(new ByteSequence() { // from class: androidx.health.platform.client.proto.TextFormatEscaper.1
    ...
    static String escapeBytes(final byte[] input) {
        return escapeBytes(new ByteSequence() { // from class: androidx.health.platform.client.proto.TextFormatEscaper.2
            @Override // androidx.health.platform.client.proto.TextFormatEscaper.ByteSequence
            public int size() {
                return input.length;
            }
