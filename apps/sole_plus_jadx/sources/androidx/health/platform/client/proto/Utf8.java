...
final class Utf8 {
        ...
        */
        final int partialIsValidUtf8Default(final int r7, final java.nio.ByteBuffer r8, int r9, final int r10) {
            ...
            L1e:
                ...
                byte r9 = r8.get(r9)
                if (r7 < r10) goto L35
                int r7 = androidx.health.platform.client.proto.Utf8.access$000(r0, r9)
                return r7
            L35:
                r5 = r9
                r9 = r7
            ...
            L4f:
                ...
                byte r1 = r8.get(r9)
                if (r7 < r10) goto L62
                int r7 = androidx.health.platform.client.proto.Utf8.access$000(r0, r1)
                return r7
            L62:
                r9 = 0
                goto L6a
            ...
            L6a:
                ...
                byte r7 = r8.get(r7)
                if (r9 < r10) goto L79
                int r7 = androidx.health.platform.client.proto.Utf8.access$100(r0, r1, r7)
                return r7
            L79:
                r5 = r9
                r9 = r7
            ...
            L92:
                ...
                return r7
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.health.platform.client.proto.Utf8.Processor.partialIsValidUtf8Default(int, java.nio.ByteBuffer, int, int):int");
        }
        ...
        */
        int partialIsValidUtf8(int r7, byte[] r8, int r9, int r10) {
            ...
            L86:
                ...
                return r7
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.health.platform.client.proto.Utf8.SafeProcessor.partialIsValidUtf8(int, byte[], int, int):int");
        }
    ...
    static final class UnsafeProcessor extends Processor {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:35:0x0058, code lost:
            ...
            if (androidx.health.platform.client.proto.UnsafeUtil.getByte(r12, r0) > (-65)) goto L38;
         */
        /* JADX WARN: Code restructure failed: missing block: B:58:0x009e, code lost:
        
            if (androidx.health.platform.client.proto.UnsafeUtil.getByte(r12, r0) > (-65)) goto L59;
         */
        @Override // androidx.health.platform.client.proto.Utf8.Processor
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        ...
        */
        int partialIsValidUtf8(int r11, byte[] r12, final int r13, final int r14) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.health.platform.client.proto.Utf8.UnsafeProcessor.partialIsValidUtf8(int, byte[], int, int):int");
        }

        /* JADX WARN: Code restructure failed: missing block: B:14:0x002d, code lost:
        
            if (androidx.health.platform.client.proto.UnsafeUtil.getByte(r0) > (-65)) goto L17;
         */
        /* JADX WARN: Code restructure failed: missing block: B:35:0x0061, code lost:
        
            if (androidx.health.platform.client.proto.UnsafeUtil.getByte(r0) > (-65)) goto L36;
         */
        /* JADX WARN: Code restructure failed: missing block: B:56:0x00a3, code lost:
        
            if (androidx.health.platform.client.proto.UnsafeUtil.getByte(r0) > (-65)) goto L57;
         */
        @Override // androidx.health.platform.client.proto.Utf8.Processor
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        ...
        */
        int partialIsValidUtf8Direct(final int r10, java.nio.ByteBuffer r11, final int r12, final int r13) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.health.platform.client.proto.Utf8.UnsafeProcessor.partialIsValidUtf8Direct(int, java.nio.ByteBuffer, int, int):int");
        }
            ...
            while (i2 < length2) {
                ...
                if (cCharAt2 >= 128 || j4 >= j5) {
                    if (cCharAt2 >= 2048 || j4 > j5 - 2) {
                        ...
                        long j7 = j4 + 2;
                        UnsafeUtil.putByte(out, j4 + 1, (byte) (((cCharAt2 >>> 6) & 63) | 128));
                        j4 += 3;
        ...
        */
        private static int partialIsValidUtf8(final byte[] r10, long r11, int r13) {
            ...
            L9:
                ...
                if (r13 <= 0) goto L1a
                long r4 = r11 + r2
                byte r1 = androidx.health.platform.client.proto.UnsafeUtil.getByte(r10, r11)
                if (r1 < 0) goto L19
                int r13 = r13 + (-1)
                r11 = r4
                goto L9
            ...
            L29:
                ...
                if (r1 < r0) goto L39
                long r2 = r2 + r11
                byte r11 = androidx.health.platform.client.proto.UnsafeUtil.getByte(r10, r11)
                if (r11 <= r6) goto L37
                goto L39
            L37:
                r11 = r2
            ...
            L48:
                int r13 = r13 + (-3)
                long r2 = r2 + r11
                byte r0 = androidx.health.platform.client.proto.UnsafeUtil.getByte(r10, r11)
                if (r0 > r6) goto L64
                r7 = -96
                if (r1 != r4) goto L57
                if (r0 < r7) goto L64
            ...
            L5d:
                long r11 = r11 + r8
                byte r0 = androidx.health.platform.client.proto.UnsafeUtil.getByte(r10, r2)
                if (r0 <= r6) goto L7
            L64:
                return r5
            L65:
            ...
            L6d:
                ...
                r0 = 3
                long r11 = r11 + r0
                byte r0 = androidx.health.platform.client.proto.UnsafeUtil.getByte(r10, r8)
                if (r0 <= r6) goto L7
            L8f:
                return r5
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.health.platform.client.proto.Utf8.UnsafeProcessor.partialIsValidUtf8(byte[], long, int):int");
        }
        ...
        */
        private static int partialIsValidUtf8(long r10, int r12) {
            ...
            L9:
                ...
                if (r12 <= 0) goto L1a
                long r4 = r10 + r2
                byte r1 = androidx.health.platform.client.proto.UnsafeUtil.getByte(r10)
                if (r1 < 0) goto L19
                int r12 = r12 + (-1)
                r10 = r4
                goto L9
            ...
            L29:
                ...
                if (r1 < r0) goto L39
                long r2 = r2 + r10
                byte r10 = androidx.health.platform.client.proto.UnsafeUtil.getByte(r10)
                if (r10 <= r6) goto L37
                goto L39
            L37:
                r10 = r2
            ...
            L48:
                int r12 = r12 + (-3)
                long r2 = r2 + r10
                byte r0 = androidx.health.platform.client.proto.UnsafeUtil.getByte(r10)
                if (r0 > r6) goto L64
                r7 = -96
                if (r1 != r4) goto L57
                if (r0 < r7) goto L64
            ...
            L5d:
                long r10 = r10 + r8
                byte r0 = androidx.health.platform.client.proto.UnsafeUtil.getByte(r2)
                if (r0 <= r6) goto L7
            L64:
                return r5
            L65:
            ...
            L6d:
                ...
                r0 = 3
                long r10 = r10 + r0
                byte r0 = androidx.health.platform.client.proto.UnsafeUtil.getByte(r8)
                if (r0 <= r6) goto L7
            L8f:
                return r5
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.health.platform.client.proto.Utf8.UnsafeProcessor.partialIsValidUtf8(long, int):int");
        }
