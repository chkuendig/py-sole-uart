...
class SmallSortedMap<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    static <FieldDescriptorType extends FieldSet.FieldDescriptorLite<FieldDescriptorType>> SmallSortedMap<FieldDescriptorType, Object> newFieldMap(int i) {
        return (SmallSortedMap<FieldDescriptorType, Object>) new SmallSortedMap<FieldDescriptorType, Object>(i) { // from class: androidx.health.platform.client.proto.SmallSortedMap.1
            @Override // androidx.health.platform.client.proto.SmallSortedMap
    ...
    */
    private int binarySearchInArray(K r5) {
        /*
            r4 = this;
            java.util.List<androidx.health.platform.client.proto.SmallSortedMap<K, V>$Entry> r0 = r4.entryList
            int r0 = r0.size()
            int r1 = r0 + (-1)
            if (r1 < 0) goto L23
            java.util.List<androidx.health.platform.client.proto.SmallSortedMap<K, V>$Entry> r2 = r4.entryList
            java.lang.Object r2 = r2.get(r1)
            androidx.health.platform.client.proto.SmallSortedMap$Entry r2 = (androidx.health.platform.client.proto.SmallSortedMap.Entry) r2
        ...
        L24:
            ...
            int r2 = r0 + r1
            int r2 = r2 / 2
            java.util.List<androidx.health.platform.client.proto.SmallSortedMap<K, V>$Entry> r3 = r4.entryList
            java.lang.Object r3 = r3.get(r2)
            androidx.health.platform.client.proto.SmallSortedMap$Entry r3 = (androidx.health.platform.client.proto.SmallSortedMap.Entry) r3
        ...
        L47:
            ...
            goto L1e
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.health.platform.client.proto.SmallSortedMap.binarySearchInArray(java.lang.Comparable):int");
    }
    ...
    private class DescendingEntrySet extends SmallSortedMap<K, V>.EntrySet {
        ...
        @Override // androidx.health.platform.client.proto.SmallSortedMap.EntrySet, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, java.util.Set
        public Iterator<Map.Entry<K, V>> iterator() {
    ...
    private static class EmptySet {
        private static final Iterator<Object> ITERATOR = new Iterator<Object>() { // from class: androidx.health.platform.client.proto.SmallSortedMap.EmptySet.1
            @Override // java.util.Iterator
            public boolean hasNext() {
                return false;
            }
        ...
        private static final Iterable<Object> ITERABLE = new Iterable<Object>() { // from class: androidx.health.platform.client.proto.SmallSortedMap.EmptySet.2
