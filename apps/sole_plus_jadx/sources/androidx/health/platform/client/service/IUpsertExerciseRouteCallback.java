...
public interface IUpsertExerciseRouteCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IUpsertExerciseRouteCallback {
        ...
        public static IUpsertExerciseRouteCallback asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(IUpsertExerciseRouteCallback.DESCRIPTOR);
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IUpsertExerciseRouteCallback)) {
                return (IUpsertExerciseRouteCallback) iInterfaceQueryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i >= 1 && i <= 16777215) {
                parcel.enforceInterface(IUpsertExerciseRouteCallback.DESCRIPTOR);
            }
            if (i == 1598968902) {
                parcel2.writeString(IUpsertExerciseRouteCallback.DESCRIPTOR);
                return true;
            }
            if (i == 1) {
                onSuccess();
        ...
        private static class Proxy implements IUpsertExerciseRouteCallback {
            ...
            public void onSuccess() throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(IUpsertExerciseRouteCallback.DESCRIPTOR);
