...
public final class BodyFatRecord implements InstantaneousRecord {
    ...
    public BodyFatRecord(Instant time, ZoneOffset zoneOffset, Percentage percentage, androidx.health.connect.client.records.metadata.Metadata metadata) {
    ...
    public /* synthetic */ BodyFatRecord(Instant instant, ZoneOffset zoneOffset, Percentage percentage, androidx.health.connect.client.records.metadata.Metadata metadata, int i, DefaultConstructorMarker defaultConstructorMarker) {
