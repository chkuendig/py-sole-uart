...
public final class WheelchairPushesRecord implements IntervalRecord {
    ...
    public WheelchairPushesRecord(Instant startTime, ZoneOffset zoneOffset, Instant endTime, ZoneOffset zoneOffset2, long j, androidx.health.connect.client.records.metadata.Metadata metadata) {
    ...
    public /* synthetic */ WheelchairPushesRecord(Instant instant, ZoneOffset zoneOffset, Instant instant2, ZoneOffset zoneOffset2, long j, androidx.health.connect.client.records.metadata.Metadata metadata, int i, DefaultConstructorMarker defaultConstructorMarker) {
