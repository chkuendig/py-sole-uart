...
public final class BasalBodyTemperatureRecord implements InstantaneousRecord {
    ...
    public BasalBodyTemperatureRecord(Instant time, ZoneOffset zoneOffset, Temperature temperature, int i, androidx.health.connect.client.records.metadata.Metadata metadata) {
    ...
    public /* synthetic */ BasalBodyTemperatureRecord(Instant instant, ZoneOffset zoneOffset, Temperature temperature, int i, androidx.health.connect.client.records.metadata.Metadata metadata, int i2, DefaultConstructorMarker defaultConstructorMarker) {
