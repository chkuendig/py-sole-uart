...
public final class SpeedRecord implements SeriesRecord<Sample> {
    ...
    public static final AggregateMetric<Velocity> SPEED_AVG = AggregateMetric.INSTANCE.doubleMetric$connect_client_release(SPEED_TYPE_NAME, AggregateMetric.AggregationType.AVERAGE, "speed", new SpeedRecord$Companion$SPEED_AVG$1(Velocity.INSTANCE));
    public static final AggregateMetric<Velocity> SPEED_MIN = AggregateMetric.INSTANCE.doubleMetric$connect_client_release(SPEED_TYPE_NAME, AggregateMetric.AggregationType.MINIMUM, "speed", new SpeedRecord$Companion$SPEED_MIN$1(Velocity.INSTANCE));
    public static final AggregateMetric<Velocity> SPEED_MAX = AggregateMetric.INSTANCE.doubleMetric$connect_client_release(SPEED_TYPE_NAME, AggregateMetric.AggregationType.MAXIMUM, "speed", new SpeedRecord$Companion$SPEED_MAX$1(Velocity.INSTANCE));

    public SpeedRecord(Instant startTime, ZoneOffset zoneOffset, Instant endTime, ZoneOffset zoneOffset2, List<Sample> samples, androidx.health.connect.client.records.metadata.Metadata metadata) {
    ...
    public /* synthetic */ SpeedRecord(Instant instant, ZoneOffset zoneOffset, Instant instant2, ZoneOffset zoneOffset2, List list, androidx.health.connect.client.records.metadata.Metadata metadata, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    /* compiled from: SpeedRecord.kt */
    @Metadata(d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0000\u0018\u00002\u00020\u0001B\u0015\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\u0013\u0010\u000b\u001a\u00020\f2\b\u0010\r\u001a\u0004\u0018\u00010\u0001H\u0096\u0002J\b\u0010\u000e\u001a\u00020\u000fH\u0016J\b\u0010\u0010\u001a\u00020\u0011H\u0016R\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\bR\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\n¨\u0006\u0012"}, d2 = {"Landroidx/health/connect/client/records/SpeedRecord$Sample;", "", "time", "Ljava/time/Instant;", "speed", "Landroidx/health/connect/client/units/Velocity;", "(Ljava/time/Instant;Landroidx/health/connect/client/units/Velocity;)V", "getSpeed", "()Landroidx/health/connect/client/units/Velocity;", "getTime", "()Ljava/time/Instant;", "equals", "", "other", "hashCode", "", "toString", "", "connect-client_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
