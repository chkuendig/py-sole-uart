...
public final class BodyWaterMassRecord implements InstantaneousRecord {
    ...
    public BodyWaterMassRecord(Instant time, ZoneOffset zoneOffset, Mass mass, androidx.health.connect.client.records.metadata.Metadata metadata) {
        ...
        UtilsKt.requireNotMore(mass, MAX_BODY_WATER_MASS, "mass");
    }
    ...
    public /* synthetic */ BodyWaterMassRecord(Instant instant, ZoneOffset zoneOffset, Mass mass, androidx.health.connect.client.records.metadata.Metadata metadata, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof BodyWaterMassRecord)) {
            return false;
        }
        BodyWaterMassRecord bodyWaterMassRecord = (BodyWaterMassRecord) other;
        return Intrinsics.areEqual(this.mass, bodyWaterMassRecord.mass) && Intrinsics.areEqual(getTime(), bodyWaterMassRecord.getTime()) && Intrinsics.areEqual(getZoneOffset(), bodyWaterMassRecord.getZoneOffset()) && Intrinsics.areEqual(getMetadata(), bodyWaterMassRecord.getMetadata());
    }
    ...
    /* compiled from: BodyWaterMassRecord.kt */
    @Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\b\u0082\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0005"}, d2 = {"Landroidx/health/connect/client/records/BodyWaterMassRecord$Companion;", "", "()V", "MAX_BODY_WATER_MASS", "Landroidx/health/connect/client/units/Mass;", "connect-client_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
