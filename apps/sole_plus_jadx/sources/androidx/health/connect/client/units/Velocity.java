...
public final class Velocity implements Comparable<Velocity> {
    ...
    @JvmStatic
    public static final Velocity kilometersPerHour(double d) {
        return INSTANCE.kilometersPerHour(d);
    }

    @JvmStatic
    public static final Velocity metersPerSecond(double d) {
        return INSTANCE.metersPerSecond(d);
    }

    @JvmStatic
    public static final Velocity milesPerHour(double d) {
        return INSTANCE.milesPerHour(d);
    }
    ...
    public int compareTo(Velocity other) {
        ...
        return Double.compare(getMetersPerSecond(), other.getMetersPerSecond());
    }
    ...
    static {
        ...
        for (Type type : typeArrValues) {
            linkedHashMap.put(type, new Velocity(AudioStats.AUDIO_AMPLITUDE_NONE, type));
        }
        ZEROS = linkedHashMap;
    }
    ...
    private static final class Type {
        ...
        static final class METERS_PER_SECOND extends Type {
            ...
            METERS_PER_SECOND(String str, int i) {
                super(str, i, null);
        ...
        static final class KILOMETERS_PER_HOUR extends Type {
            ...
            KILOMETERS_PER_HOUR(String str, int i) {
                super(str, i, null);
        ...
        static final class MILES_PER_HOUR extends Type {
            ...
            MILES_PER_HOUR(String str, int i) {
                super(str, i, null);
