            ...
            if (j3 != 128 && j3 == 254) {
                ...
                if (((iFindFirstAvailableSlot - i9) & i) / 8 == ((i5 - i9) & i) / 8) {
                    ...
                    if (((j4 >> i11) & 255) == 128) {
                        ...
                        fArr[i5] = 0.0f;
                        fArr2[iFindFirstAvailableSlot] = fArr2[i5];
                        fArr2[i5] = 0.0f;
                    } else {
                        ...
                        fArr[iFindFirstAvailableSlot] = fArr[i5];
                        fArr[i5] = f;
                        float f2 = fArr2[iFindFirstAvailableSlot];
                        fArr2[iFindFirstAvailableSlot] = fArr2[i5];
                        fArr2[i5] = f2;
                        i5--;
                    }
