...
public final class IntIntPair {
    ...
    public static final /* synthetic */ IntIntPair m325boximpl(long j) {
        return new IntIntPair(j);
    }

    /* renamed from: component1-impl, reason: not valid java name */
    public static final int m326component1impl(long j) {
        return (int) (j >> 32);
    }

    /* renamed from: component2-impl, reason: not valid java name */
    public static final int m327component2impl(long j) {
    ...
    public static boolean m330equalsimpl(long j, Object obj) {
    ...
    public static final int m332getFirstimpl(long j) {
        return (int) (j >> 32);
    }

    /* renamed from: getSecond-impl, reason: not valid java name */
    public static final int m333getSecondimpl(long j) {
        return (int) (j & 4294967295L);
    }
    ...
    public boolean equals(Object obj) {
        return m330equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m334hashCodeimpl(this.packedValue);
    }
    ...
    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m328constructorimpl(int i, int i2) {
        return m329constructorimpl((i2 & 4294967295L) | (i << 32));
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m335toStringimpl(long j) {
        return "(" + m332getFirstimpl(j) + ", " + m333getSecondimpl(j) + ')';
    }
