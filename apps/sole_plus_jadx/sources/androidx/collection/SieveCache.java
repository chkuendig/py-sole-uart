...
public final class SieveCache<K, V> {
    ...
    public final V put(K key, V value) {
        ...
        long[] jArr = this.nodes;
        int i = this.head;
        jArr[iFindInsertIndex] = (i & SieveCacheKt.NodeLinkMask) | 4611686016279904256L;
        if (i != Integer.MAX_VALUE) {
            jArr[i] = (jArr[i] & SieveCacheKt.NodeMetaAndNextMask) | ((SieveCacheKt.NodeLinkMask & iFindInsertIndex) << 31);
        }
    ...
    public final void trimToSize(int maxSize) {
        ...
        while (this._size > maxSize && get_count() != 0 && (iFindEvictionCandidate = findEvictionCandidate()) != Integer.MAX_VALUE) {
            ...
            if (vRemoveValueAt != null) {
                this._size -= ((Number) this.sizeOf.invoke(obj, vRemoveValueAt)).intValue();
                this.onEntryRemoved.invoke(obj, vRemoveValueAt, null, true);
            }
        }
    }
    ...
    */
    ...
    public final void adjustStorage$collection() {
        if (this._capacity > 8 && Long.compareUnsigned(ULong.m9261constructorimpl(ULong.m9261constructorimpl(get_count()) * 32), ULong.m9261constructorimpl(ULong.m9261constructorimpl(this._capacity) * 25)) <= 0) {
            ...
            if (j2 != 128 && j2 == 254) {
                ...
                if (((iFindFirstAvailableSlot - i10) & i) / 8 == ((i6 - i10) & i) / 8) {
                    ...
                    if (((j4 >> i12) & 255) == 128) {
                        ...
                        objArr[i6] = null;
                        objArr4[iFindFirstAvailableSlot] = objArr4[i6];
                        objArr4[i6] = null;
                        jArr5[iFindFirstAvailableSlot] = jArr5[i6];
                        jArr5[i6] = 4611686018427387903L;
                        int i13 = (int) ((jArr3[i6] >> 32) & 4294967295L);
                        if (i13 != Integer.MAX_VALUE) {
                            jArr3[i13] = (jArr3[i13] & (-4294967296L)) | iFindFirstAvailableSlot;
                            jArr3[i6] = (jArr3[i6] & 4294967295L) | (-4294967296L);
                            c = ' ';
                        } else {
                            c = ' ';
                            jArr3[i6] = (Integer.MAX_VALUE << 32) | iFindFirstAvailableSlot;
                        }
                        jArr3[iFindFirstAvailableSlot] = Integer.MAX_VALUE | (i6 << c);
                    } else {
                        jArr[i11] = ((r12 & 127) << i12) | (j4 & (~(255 << i12)));
                        Object obj2 = objArr[iFindFirstAvailableSlot];
                        objArr[iFindFirstAvailableSlot] = objArr[i6];
                        objArr[i6] = obj2;
                        Object obj3 = objArr4[iFindFirstAvailableSlot];
                        objArr4[iFindFirstAvailableSlot] = objArr4[i6];
                        objArr4[i6] = obj3;
                        long j5 = jArr5[iFindFirstAvailableSlot];
                        jArr5[iFindFirstAvailableSlot] = jArr5[i6];
                        jArr5[i6] = j5;
                        ...
                        jArr3[iFindFirstAvailableSlot] = (i14 << 32) | i6;
                        i6--;
                    }
                    jArr[jArr.length - 1] = jArr[0];
                    i6++;
    ...
    public final void resizeStorage$collection(int newCapacity) {
        ...
        while (i4 < i2) {
            if (((jArr2[i4 >> 3] >> ((i4 & 7) << 3)) & 255) < 128) {
                ...
                jArr4[i6] = j2;
                jArr4[(((iFindFirstAvailableSlot - 7) & i3) + (i3 & 7)) >> 3] = j2;
                objArr4[iFindFirstAvailableSlot] = obj;
                objArr5[iFindFirstAvailableSlot] = objArr3[i4];
                jArr5[iFindFirstAvailableSlot] = jArr3[i4];
                iArr[i4] = iFindFirstAvailableSlot;
            } else {
                jArr = jArr2;
                objArr = objArr2;
                i = i2;
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        ...
                        if (predicate.invoke(obj, obj2).booleanValue()) {
                            ...
                            this._size -= ((Number) this.sizeOf.invoke(obj, vRemoveValueAt)).intValue();
                            this.onEntryRemoved.invoke(obj, vRemoveValueAt, null, false);
                        } else {
                            continue;
                        }
                    }
