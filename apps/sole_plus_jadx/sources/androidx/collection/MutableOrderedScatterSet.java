...
public final class MutableOrderedScatterSet<E> extends OrderedScatterSet<E> {
    ...
    public final boolean add(E element) {
        ...
        this.nodes[iFindAbsoluteInsertIndex] = (this.head & SieveCacheKt.NodeLinkMask) | 4611686016279904256L;
        if (this.head != Integer.MAX_VALUE) {
            this.nodes[this.head] = ((SieveCacheKt.NodeLinkMask & iFindAbsoluteInsertIndex) << 31) | (this.nodes[this.head] & SieveCacheKt.NodeMetaAndNextMask);
        }
                ...
                if (((iFindFirstAvailableSlot - i10) & i) / 8 == ((i6 - i10) & i) / 8) {
                    ...
                    if (((j4 >> i12) & 255) == 128) {
                        ...
                        if (i13 != Integer.MAX_VALUE) {
                            jArr2[i13] = (jArr2[i13] & (-4294967296L)) | iFindFirstAvailableSlot;
                            jArr2[i6] = (jArr2[i6] & 4294967295L) | (-4294967296L);
                            c = ' ';
                        } else {
                            c = ' ';
                            jArr2[i6] = (Integer.MAX_VALUE << 32) | iFindFirstAvailableSlot;
                        }
                        jArr2[iFindFirstAvailableSlot] = Integer.MAX_VALUE | (i6 << c);
                    } else {
                        jArr = jArr4;
                        jArr2 = jArr5;
                        ...
                        jArr2[iFindFirstAvailableSlot] = (i14 << 32) | i6;
                        i6--;
                    }
                    jArr3[jArr3.length - 1] = jArr3[0];
                    i6++;
