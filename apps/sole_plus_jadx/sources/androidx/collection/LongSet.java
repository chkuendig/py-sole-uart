...
public abstract class LongSet {
    ...
    /* JADX WARN: Removed duplicated region for block: B:41:0x00b9 A[PHI: r11
      0x00b9: PHI (r11v2 int) = (r11v1 int), (r11v3 int) binds: [B:28:0x0079, B:40:0x00b7] A[DONT_GENERATE, DONT_INLINE]] */
    /*
    ...
    */
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i4 = 0; i4 < i3; i4++) {
                        if ((255 & j) < 128) {
                            iHashCode += Long.hashCode(jArr[(i2 << 3) + i4]);
                        }
                        j >>= 8;
                    }
                    if (i3 != 8) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:19:0x0089 A[PHI: r11
      0x0089: PHI (r11v2 int) = (r11v1 int), (r11v3 int) binds: [B:6:0x0048, B:18:0x0087] A[DONT_GENERATE, DONT_INLINE]] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:19:0x0086 A[PHI: r11
      0x0086: PHI (r11v2 int) = (r11v1 int), (r11v3 int) binds: [B:6:0x0045, B:18:0x0084] A[DONT_GENERATE, DONT_INLINE]] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:19:0x0082 A[PHI: r11
      0x0082: PHI (r11v2 int) = (r11v1 int), (r11v3 int) binds: [B:6:0x0041, B:18:0x0080] A[DONT_GENERATE, DONT_INLINE]] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
