...
public final class SplitPairFilter {
    ...
    public SplitPairFilter(ComponentName primaryActivityName, ComponentName secondaryActivityName, String str) {
        ...
        if (StringsKt.contains$default((CharSequence) str2, (CharSequence) Marker.ANY_MARKER, false, 2, (Object) null) && StringsKt.indexOf$default((CharSequence) str2, Marker.ANY_MARKER, 0, false, 6, (Object) null) != packageName.length() - 1) {
            throw new IllegalArgumentException("Wildcard in package name is only allowed at the end.".toString());
        }
        if (StringsKt.contains$default((CharSequence) str3, (CharSequence) Marker.ANY_MARKER, false, 2, (Object) null)) {
            obj = null;
            if (StringsKt.indexOf$default((CharSequence) str3, Marker.ANY_MARKER, 0, false, 6, (Object) null) != className.length() - 1) {
        ...
        if (StringsKt.contains$default((CharSequence) str4, (CharSequence) Marker.ANY_MARKER, false, 2, obj) && StringsKt.indexOf$default((CharSequence) str4, Marker.ANY_MARKER, 0, false, 6, (Object) null) != packageName2.length() - 1) {
            throw new IllegalArgumentException("Wildcard in package name is only allowed at the end.".toString());
        }
        String str5 = className2;
        if (StringsKt.contains$default((CharSequence) str5, (CharSequence) Marker.ANY_MARKER, false, 2, obj) && StringsKt.indexOf$default((CharSequence) str5, Marker.ANY_MARKER, 0, false, 6, (Object) null) != className2.length() - 1) {
            throw new IllegalArgumentException("Wildcard in class name is only allowed at the end.".toString());
        }
    }
