...
public final class SplitRuleParser {
    ...
    private final ComponentName buildClassName(String pkg, CharSequence clsSeq) {
        ...
        if (!Intrinsics.areEqual(string, Marker.ANY_MARKER) && StringsKt.indexOf$default((CharSequence) string, '.', 0, false, 6, (Object) null) < 0) {
