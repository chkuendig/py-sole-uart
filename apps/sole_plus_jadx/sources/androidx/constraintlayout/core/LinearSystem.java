...
public class LinearSystem {
    ...
    public SolverVariable createObjectVariable(Object obj) {
        ...
        if (obj instanceof ConstraintAnchor) {
            ...
            if (solverVariable.f99id == -1 || solverVariable.f99id > this.mVariablesID || this.mCache.mIndexedVariables[solverVariable.f99id] == null) {
                if (solverVariable.f99id != -1) {
                    solverVariable.reset();
                }
                int i = this.mVariablesID + 1;
                this.mVariablesID = i;
                this.mNumColumns++;
                solverVariable.f99id = i;
    ...
    public SolverVariable createSlackVariable() {
        ...
        this.mVariablesID = i;
        this.mNumColumns++;
        solverVariableAcquireSolverVariable.f99id = i;
    ...
    public SolverVariable createErrorVariable(int i, String str) {
        ...
        this.mNumColumns++;
        solverVariableAcquireSolverVariable.f99id = i2;
    ...
    */
    ...
    private int optimize(Row row, boolean z) {
        ...
        while (!z2) {
            ...
            if (row.getKey() != null) {
                this.mAlreadyTestedCandidates[row.getKey().f99id] = true;
            }
            SolverVariable pivotCandidate = row.getPivotCandidate(this, this.mAlreadyTestedCandidates);
            if (pivotCandidate != null) {
                if (this.mAlreadyTestedCandidates[pivotCandidate.f99id]) {
                    return i2;
                }
                this.mAlreadyTestedCandidates[pivotCandidate.f99id] = true;
            }
            if (pivotCandidate != null) {
    ...
    public void addEquality(SolverVariable solverVariable, int i) {
        ...
        if (USE_BASIC_SYNONYMS && solverVariable.mDefinitionId == -1) {
            ...
            for (int i2 = 0; i2 < this.mVariablesID + 1; i2++) {
                SolverVariable solverVariable2 = this.mCache.mIndexedVariables[i2];
                if (solverVariable2 != null && solverVariable2.mIsSynonym && solverVariable2.mSynonym == solverVariable.f99id) {
