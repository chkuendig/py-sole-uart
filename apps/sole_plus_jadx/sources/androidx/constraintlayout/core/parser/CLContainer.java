...
public class CLContainer extends CLElement {
    ...
    @Override // androidx.constraintlayout.core.parser.CLElement
    /* renamed from: clone */
    public CLContainer mo7513clone() {
        CLContainer cLContainer = (CLContainer) super.mo7513clone();
        ArrayList<CLElement> arrayList = new ArrayList<>(this.mElements.size());
        Iterator<CLElement> it = this.mElements.iterator();
        while (it.hasNext()) {
            CLElement cLElementMo7513clone = it.next().mo7513clone();
            cLElementMo7513clone.setContainer(cLContainer);
            arrayList.add(cLElementMo7513clone);
        }
