    ...
    public static void dumpPoc(Object obj) throws IllegalAccessException, SecurityException, IllegalArgumentException {
        ...
        for (Field field : cls.getFields()) {
            try {
                ...
                if (field.getName().startsWith("layout_constraint") && ((!(obj2 instanceof Integer) || !obj2.toString().equals(HealthConstants.FoodIntake.UNIT_TYPE_NOT_DEFINED)) && ((!(obj2 instanceof Integer) || !obj2.toString().equals("0")) && ((!(obj2 instanceof Float) || !obj2.toString().equals("1.0")) && (!(obj2 instanceof Float) || !obj2.toString().equals("0.5")))))) {
    ...
    public static String getName(Context context, int i) {
        if (i != -1) {
            try {
                ...
                return SdkConstants.PREFIX_THEME_REF + i;
            }
        }
        return DeviceTypes.UNKNOWN;
    }
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            for (Field field : layoutParams.getClass().getFields()) {
                try {
                    ...
                    if (field.getName().contains("To") && !obj.toString().equals(HealthConstants.FoodIntake.UNIT_TYPE_NOT_DEFINED)) {
    ...
    public static void dumpLayoutParams(ViewGroup.LayoutParams layoutParams, String str) throws IllegalAccessException, SecurityException, IllegalArgumentException {
        ...
        for (Field field : layoutParams.getClass().getFields()) {
            try {
                ...
                if (name.contains("To") && !obj.toString().equals(HealthConstants.FoodIntake.UNIT_TYPE_NOT_DEFINED)) {
