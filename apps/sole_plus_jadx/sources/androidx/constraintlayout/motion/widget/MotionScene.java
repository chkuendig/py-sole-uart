...
public class MotionScene {
    ...
    */
    ...
    public static class Transition {
        ...
        Transition(MotionScene motionScene, Context context, XmlPullParser xmlPullParser) throws Resources.NotFoundException, NumberFormatException {
            this.mId = -1;
            this.mIsAbstract = false;
            this.mConstraintSetEnd = -1;
            this.mConstraintSetStart = -1;
        ...
        private void fillFromAttributeList(MotionScene motionScene, Context context, AttributeSet attributeSet) throws Resources.NotFoundException, NumberFormatException {
        ...
        private void fill(MotionScene motionScene, Context context, TypedArray typedArray) throws Resources.NotFoundException, NumberFormatException {
    ...
    MotionScene(Context context, MotionLayout motionLayout, int i) throws Resources.NotFoundException {
        this.mMotionLayout = motionLayout;
        this.mViewTransitionController = new ViewTransitionController(motionLayout);
        load(context, i);
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private void load(android.content.Context r10, int r11) throws android.content.res.Resources.NotFoundException {
        /*
    ...
    private void parseInclude(Context context, XmlPullParser xmlPullParser) throws Resources.NotFoundException {
    ...
    public int parseInclude(Context context, int i) throws Resources.NotFoundException {
