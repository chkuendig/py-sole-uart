...
public class ConstraintLayout extends ViewGroup {
    ...
    public ConstraintLayout(Context context) throws NumberFormatException {
        super(context);
    ...
    public ConstraintLayout(Context context, AttributeSet attributeSet) throws NumberFormatException {
    ...
    public ConstraintLayout(Context context, AttributeSet attributeSet, int i) throws NumberFormatException {
    ...
    public ConstraintLayout(Context context, AttributeSet attributeSet, int i, int i2) throws NumberFormatException {
    ...
    private void init(AttributeSet attributeSet, int i, int i2) throws NumberFormatException {
    ...
    public String getSceneString() {
        ...
        if (this.mLayoutWidget.stringId == null) {
            ...
            if (id3 != -1) {
                ...
                this.mLayoutWidget.stringId = SdkConstants.ATTR_PARENT;
            }
        }
