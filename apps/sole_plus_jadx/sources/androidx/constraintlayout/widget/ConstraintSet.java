...
public class ConstraintSet {
    ...
    */
    static void parseDimensionConstraints(java.lang.Object r4, android.content.res.TypedArray r5, int r6, int r7) throws java.lang.NumberFormatException {
        /*
            if (r4 != 0) goto L3
            return
        L3:
    ...
    */
    ...
    public void clone(ConstraintSet constraintSet) {
        ...
        for (Integer num : constraintSet.mConstraints.keySet()) {
            Constraint constraint = constraintSet.mConstraints.get(num);
            if (constraint != null) {
                this.mConstraints.put(num, constraint.m7518clone());
            }
        }
    }
    ...
    private String sideToString(int i) {
        switch (i) {
            ...
            case 4:
                return "bottom";
            case 5:
                return SdkConstants.FlowAlignment.BASELINE;
            case 6:
                return "start";
            case 7:
                return "end";
    ...
    public void load(Context context, int i) throws Resources.NotFoundException, NumberFormatException {
    ...
    class WriteXmlEngine {
        ...
        String getName(int i) {
            if (this.mIdMap.containsKey(Integer.valueOf(i))) {
                return SdkConstants.NEW_ID_PREFIX + this.mIdMap.get(Integer.valueOf(i)) + "";
            }
            if (i == 0) {
                return "parent";
            }
            ...
            return SdkConstants.NEW_ID_PREFIX + strLookup + "";
        }
