...
public class Placeholder extends View {
    ...
    public void onDraw(Canvas canvas) {
        if (isInEditMode()) {
            ...
            paint.getTextBounds(SdkConstants.PREFIX_THEME_REF, 0, SdkConstants.PREFIX_THEME_REF.length(), rect);
            canvas.drawText(SdkConstants.PREFIX_THEME_REF, ((iWidth / 2.0f) - (rect.width() / 2.0f)) - rect.left, ((iHeight / 2.0f) + (rect.height() / 2.0f)) - rect.bottom, paint);
        }
    }
