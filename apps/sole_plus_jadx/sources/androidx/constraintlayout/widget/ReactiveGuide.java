        ...
        if (id2 > 0 && (getParent() instanceof MotionLayout)) {
            ...
            if (this.mApplyToAllConstraintSets) {
                ...
                while (i5 < constraintSetIds2.length) {
                    changeValue(i2, id2, motionLayout, constraintSetIds2[i5]);
                    i5++;
                }
                return;
            }
            changeValue(i2, id2, motionLayout, currentState);
        }
    }
