...
class BluetoothLeScannerImplOreo extends BluetoothLeScannerImplMarshmallow {
    ...
    void startScanInternal(List<ScanFilter> list, ScanSettings scanSettings, Context context, PendingIntent pendingIntent, int i) {
        ...
        bluetoothLeScanner.startScan(nativeScanFilters, nativeScanSettings, createStartingPendingIntent(listEmptyList, scanSettings2, context, pendingIntent, i));
    }
    ...
    static class PendingIntentExecutorWrapper extends BluetoothLeScannerCompat.ScanCallbackWrapper {
        ...
        PendingIntentExecutorWrapper(boolean z, boolean z2, List<ScanFilter> list, ScanSettings scanSettings, PendingIntentExecutor pendingIntentExecutor) {
