...
public final class AsyncImagePainterKt {
    ...
    public static final AsyncImagePainter m7956rememberAsyncImagePainter3HmZ8SU(Object obj, ImageLoader imageLoader, Painter painter, Painter painter2, Painter painter3, Function1<? super AsyncImagePainter.State.Loading, Unit> function1, Function1<? super AsyncImagePainter.State.Success, Unit> function12, Function1<? super AsyncImagePainter.State.Error, Unit> function13, ContentScale contentScale, int i, Composer composer, int i2, int i3) {
        ...
        int iM5120getDefaultFilterQualityfv9h1I = (i3 & 512) != 0 ? DrawScope.INSTANCE.m5120getDefaultFilterQualityfv9h1I() : i;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(2140758544, i2, -1, "coil.compose.rememberAsyncImagePainter (AsyncImagePainter.kt:83)");
        }
        int i4 = i2 >> 12;
        AsyncImagePainter asyncImagePainterM7957rememberAsyncImagePainter5jETZwI = m7957rememberAsyncImagePainter5jETZwI(obj, imageLoader, UtilsKt.transformOf(painter4, painter5, painter6), UtilsKt.onStateOf(function14, function15, function16), fit, iM5120getDefaultFilterQualityfv9h1I, composer, (57344 & i4) | 72 | (i4 & 458752), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return asyncImagePainterM7957rememberAsyncImagePainter5jETZwI;
    }

    /* renamed from: rememberAsyncImagePainter-5jETZwI, reason: not valid java name */
    public static final AsyncImagePainter m7957rememberAsyncImagePainter5jETZwI(Object obj, ImageLoader imageLoader, Function1<? super AsyncImagePainter.State, ? extends AsyncImagePainter.State> function1, Function1<? super AsyncImagePainter.State, Unit> function12, ContentScale contentScale, int i, Composer composer, int i2, int i3) {
        ...
        if ((i3 & 32) != 0) {
            i = DrawScope.INSTANCE.m5120getDefaultFilterQualityfv9h1I();
        }
        if (ComposerKt.isTraceInProgress()) {
        ...
        asyncImagePainter.m7953setFilterQualityvDHp3xo$coil_compose_base_release(i);
    ...
    private static final boolean m7955isPositiveuvyYCjk(long j) {
        return ((double) Size.m4363getWidthimpl(j)) >= 0.5d && ((double) Size.m4360getHeightimpl(j)) >= 0.5d;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: toSizeOrNull-uvyYCjk, reason: not valid java name */
    public static final coil.size.Size m7958toSizeOrNulluvyYCjk(long j) {
        if (j == Size.INSTANCE.m4371getUnspecifiedNHjbRc()) {
            return coil.size.Size.ORIGINAL;
        }
        if (!m7955isPositiveuvyYCjk(j)) {
            return null;
        }
        float fM4363getWidthimpl = Size.m4363getWidthimpl(j);
        Dimension Dimension = (Float.isInfinite(fM4363getWidthimpl) || Float.isNaN(fM4363getWidthimpl)) ? Dimension.Undefined.INSTANCE : Dimensions.Dimension(MathKt.roundToInt(Size.m4363getWidthimpl(j)));
        float fM4360getHeightimpl = Size.m4360getHeightimpl(j);
        return new coil.size.Size(Dimension, (Float.isInfinite(fM4360getHeightimpl) || Float.isNaN(fM4360getHeightimpl)) ? Dimension.Undefined.INSTANCE : Dimensions.Dimension(MathKt.roundToInt(Size.m4360getHeightimpl(j))));
    }
}
