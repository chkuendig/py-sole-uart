...
public final class ImageLoaderProvidableCompositionLocal {
    ...
    public static final /* synthetic */ ImageLoaderProvidableCompositionLocal m7966boximpl(ProvidableCompositionLocal providableCompositionLocal) {
        return new ImageLoaderProvidableCompositionLocal(providableCompositionLocal);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static ProvidableCompositionLocal<ImageLoader> m7967constructorimpl(ProvidableCompositionLocal<ImageLoader> providableCompositionLocal) {
        return providableCompositionLocal;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m7969equalsimpl(ProvidableCompositionLocal<ImageLoader> providableCompositionLocal, Object obj) {
    ...
    public static final boolean m7970equalsimpl0(ProvidableCompositionLocal<ImageLoader> providableCompositionLocal, ProvidableCompositionLocal<ImageLoader> providableCompositionLocal2) {
    ...
    public static int m7971hashCodeimpl(ProvidableCompositionLocal<ImageLoader> providableCompositionLocal) {
        return providableCompositionLocal.hashCode();
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m7973toStringimpl(ProvidableCompositionLocal<ImageLoader> providableCompositionLocal) {
        return "ImageLoaderProvidableCompositionLocal(delegate=" + providableCompositionLocal + ')';
    }

    public boolean equals(Object obj) {
        return m7969equalsimpl(this.delegate, obj);
    }

    public int hashCode() {
        return m7971hashCodeimpl(this.delegate);
    }

    public String toString() {
        return m7973toStringimpl(this.delegate);
    }
    ...
    public static /* synthetic */ ProvidableCompositionLocal m7968constructorimpl$default(ProvidableCompositionLocal providableCompositionLocal, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
        ...
        return m7967constructorimpl(providableCompositionLocal);
    }
    ...
    public static final ProvidedValue<ImageLoader> m7972providesimpl(ProvidableCompositionLocal<ImageLoader> providableCompositionLocal, ImageLoader imageLoader) {
