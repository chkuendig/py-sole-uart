...
public final class RoundedCornersTransformation implements Transformation {
    ...
    public RoundedCornersTransformation(float f, float f2, float f3, float f4) {
        ...
        this.cacheKey = getClass().getName() + SignatureVisitor.SUPER + f + AbstractJsonLexerKt.COMMA + f2 + AbstractJsonLexerKt.COMMA + f3 + AbstractJsonLexerKt.COMMA + f4;
    }
    ...
    private final Pair<Integer, Integer> calculateOutputSize(Bitmap input, Size size) {
        ...
        return TuplesKt.to(Integer.valueOf(MathKt.roundToInt(input.getWidth() * dComputeSizeMultiplier)), Integer.valueOf(MathKt.roundToInt(dComputeSizeMultiplier * input.getHeight())));
    }
