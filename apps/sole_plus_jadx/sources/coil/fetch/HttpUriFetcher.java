...
public final class HttpUriFetcher implements Fetcher {
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private final coil.disk.DiskCache.Snapshot writeToDiskCache(coil.disk.DiskCache.Snapshot r6, okhttp3.Request r7, okhttp3.Response r8, coil.network.CacheResponse r9) throws java.io.IOException {
        /*
    ...
    */
    ...
    public static final class Factory implements Fetcher.Factory<Uri> {
        ...
        private final boolean isApplicable(Uri data) {
            return Intrinsics.areEqual(data.getScheme(), "http") || Intrinsics.areEqual(data.getScheme(), TournamentShareDialogURIBuilder.scheme);
        }
    }
}
